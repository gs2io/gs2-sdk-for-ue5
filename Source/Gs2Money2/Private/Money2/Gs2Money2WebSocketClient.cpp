...
namespace Gs2::Money2
{
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FGetServiceVersionTask>> FGs2Money2WebSocketClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FPreUpdateCurrentModelMasterTask>> FGs2Money2WebSocketClient::PreUpdateCurrentModelMaster(
