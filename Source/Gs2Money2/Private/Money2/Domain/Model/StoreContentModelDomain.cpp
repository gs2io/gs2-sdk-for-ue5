...
namespace Gs2::Money2::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::Money2::Model::Cache::FStoreContentModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Money2::Model::Cache::FStoreContentModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Money2::Model::FStoreContentModelPtr Value;
                const auto CacheHit = Gs2::Money2::Model::Cache::FStoreContentModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Money2::Model::Cache::FStoreContentModelCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->ContentName,
                    TOptional<int32>(),
                    [Self](Gs2::Money2::Model::FStoreContentModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FStoreContentModelDomain::Invalidate()
    {
        Gs2::Money2::Model::Cache::FStoreContentModelCache::Delete(
            Gs2->Cache,
    ...
    FStoreContentModelDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FStoreContentModelDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FStoreContentModelDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FStoreContentModelDomain::FSubscribeWithInitialCallTask>> FStoreContentModelDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Money2::Model::FStoreContentModelPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Money2::Model::Cache::FStoreContentModelCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Money2::Model::Cache::FStoreContentModelCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryContentName]()
            {
                ...
                const auto Domain = MakeShared<FStoreContentModelDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryContentName
