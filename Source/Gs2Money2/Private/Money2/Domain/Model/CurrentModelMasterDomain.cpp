...
namespace Gs2::Money2::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Money2::Model::Cache::FCurrentModelMasterCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Money2::Model::FCurrentModelMasterPtr Value;
                const auto CacheHit = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Money2::Model::FCurrentModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        Gs2::Money2::Model::Cache::FCurrentModelMasterCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Money2::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(
