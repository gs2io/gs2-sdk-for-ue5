...
namespace Gs2::Money2::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::Delete(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Money2::Model::FStoreContentModelMasterPtr Value;
                const auto CacheHit = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->ContentName,
                    TOptional<int32>(),
                    [Self](Gs2::Money2::Model::FStoreContentModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FStoreContentModelMasterDomain::Invalidate()
    {
        Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::Delete(
            Gs2->Cache,
    ...
    FStoreContentModelMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FStoreContentModelMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FStoreContentModelMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FStoreContentModelMasterDomain::FSubscribeWithInitialCallTask>> FStoreContentModelMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Money2::Model::FStoreContentModelMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Money2::Model::Cache::FStoreContentModelMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryContentName]()
            {
                ...
                const auto Domain = MakeShared<FStoreContentModelMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryContentName
