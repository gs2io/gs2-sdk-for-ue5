...
namespace Gs2::Money2::Domain::Model
{
    ...
    )
    {
        ...
        const auto Future = Self->Client->GetEventByTransactionId(
            Request
        );
    ...
    )
    {
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            [Self = Self, Result]() -> Gs2::Core::Model::FGs2ErrorPtr
            {
                ...
                const auto Error = Gs2::Money2::Model::Cache::FEventCache::Fetch(
                    Self->Gs2->Cache,
                    ...
                    Self->TransactionId,
                    TOptional<int32>(),
                    [Self](Gs2::Money2::Model::FEventPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Money2::Request::FGetEventByTransactionIdRequest>()
                        );
                        Future->StartSynchronousTask();
