...
namespace Gs2::Money2::Model::Cache
{
    ...
    bool FEventCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentTransactionId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Money2::Model::FEventPtr* CacheOwnerArgumentOutItem
    )
    {
    ...
    void FEventCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentTransactionId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Money2::Model::FEventPtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Money2::Model::FEventPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Money2::Model::FEvent>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEventCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentTransactionId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Money2::Model::FEventPtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Money2::Model::FEventPtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
    ...
    Gs2::Core::Domain::CallbackID FEventCache::ListSubscribe(
        ...
        TOptional<FString> CacheOwnerArgumentUserId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Money2::Model::FEventPtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Money2::Model::FEvent::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Money2::Model::FEventPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Money2::Model::FEvent>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Money2::Model::FEvent::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentTimeOffset
