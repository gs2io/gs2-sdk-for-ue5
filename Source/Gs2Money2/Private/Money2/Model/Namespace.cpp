...
namespace Gs2::Money2::Model
{
    ...
    TSharedPtr<FJsonObject> FNamespace::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("currencyUsagePriority"), CurrencyUsagePriorityValue.GetValue());
        }
        if (SharedFreeCurrencyValue.IsSet())
        {
        ...
        {
            JsonRootObject->SetObjectField(TEXT("platformSetting"), PlatformSettingValue->ToJson());
        }
        if (DepositBalanceScriptValue != nullptr && DepositBalanceScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("depositBalanceScript"), DepositBalanceScriptValue->ToJson());
        }
        if (WithdrawBalanceScriptValue != nullptr && WithdrawBalanceScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("withdrawBalanceScript"), WithdrawBalanceScriptValue->ToJson());
        }
        if (VerifyReceiptScriptValue != nullptr && VerifyReceiptScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("verifyReceiptScript"), VerifyReceiptScriptValue->ToJson());
        }
        if (SubscribeScriptValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("subscribeScript"), SubscribeScriptValue.GetValue());
        }
        if (RenewScriptValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("renewScript"), RenewScriptValue.GetValue());
        }
        if (UnsubscribeScriptValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("unsubscribeScript"), UnsubscribeScriptValue.GetValue());
        }
        if (TakeOverScriptValue != nullptr && TakeOverScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("takeOverScript"), TakeOverScriptValue->ToJson());
        }
        if (ChangeSubscriptionStatusNotificationValue != nullptr && ChangeSubscriptionStatusNotificationValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("changeSubscriptionStatusNotification"), ChangeSubscriptionStatusNotificationValue->ToJson());
        }
...
namespace Gs2::Money2::Model::Cache
{
    ...
    bool FNamespaceCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Money2::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Money2::Model::FNamespacePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Money2::Model::FNamespace>(
    ...
    void FNamespaceCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Money2::Model::FNamespacePtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Money2::Model::FNamespacePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Money2::Model::FNamespace>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Money2::Model::FNamespace::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    FString FNamespaceCache::PutUserData(
        ...
        const Gs2::Money2::Model::FNamespacePtr& Item
    )
    {
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Money2::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentNamespaceName
        ));
    ...
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Money2::Model::FNamespacePtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Money2::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Money2::Model::FNamespacePtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FNamespaceCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Money2::Model::FNamespacePtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Money2::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Money2::Model::FNamespacePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Money2::Model::FNamespace>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Money2::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
