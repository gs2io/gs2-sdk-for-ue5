...
namespace Gs2::Money2::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithVerifyReceiptScript(
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetVerifyReceiptScript() const
    {
