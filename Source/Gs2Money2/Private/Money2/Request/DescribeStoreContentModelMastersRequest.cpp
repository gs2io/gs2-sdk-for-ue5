...
namespace Gs2::Money2::Request
{
    ...
    TSharedPtr<FDescribeStoreContentModelMastersRequest> FDescribeStoreContentModelMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeStoreContentModelMastersRequest::GetNamePrefix() const
    {
