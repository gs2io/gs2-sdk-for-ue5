...
#include "Money2/Task/WebSocket/VerifyReceiptByUserIdTask.h"
...
namespace Gs2::Money2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("money2"), TEXT("event"), TEXT("verifyReceiptByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FVerifyReceiptByUserIdResult::FromJson(WebSocketResult->Body());
