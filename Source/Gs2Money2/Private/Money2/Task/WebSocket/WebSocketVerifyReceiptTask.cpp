...
#include "Money2/Task/WebSocket/VerifyReceiptTask.h"
...
namespace Gs2::Money2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("money2"), TEXT("event"), TEXT("verifyReceipt"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FVerifyReceiptResult::FromJson(WebSocketResult->Body());
