...
#include "Money2/Task/WebSocket/UpdateCurrentModelMasterTask.h"
...
namespace Gs2::Money2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("money2"), TEXT("currentModelMaster"), TEXT("updateCurrentModelMaster"), ToCStr(RequestPayload->Payload()));
