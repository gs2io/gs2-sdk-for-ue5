...
#include "Money2/Task/Rest/DescribeDailyTransactionHistoriesTask.h"
...
{
    FDescribeDailyTransactionHistoriesTask::FDescribeDailyTransactionHistoriesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeDailyTransactionHistoriesTask::Action(
        const TSharedPtr<Result::FDescribeDailyTransactionHistoriesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/transaction/daily/{year}");
            ...
            if (this->Request->GetDay().IsSet()) {
                queryStrings.Add("day=" + this->Request->GetDayString());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeDailyTransactionHistoriesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
