...
#include "Money2/Task/Rest/GetStoreSubscriptionContentModelTask.h"
...
{
    FGetStoreSubscriptionContentModelTask::FGetStoreSubscriptionContentModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStoreSubscriptionContentModelTask::Action(
        const TSharedPtr<Result::FGetStoreSubscriptionContentModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/subscription/content/{contentName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStoreSubscriptionContentModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
