...
#include "Money2/Task/Rest/VerifyReceiptByUserIdTask.h"
...
{
    FVerifyReceiptByUserIdTask::FVerifyReceiptByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyReceiptByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyReceiptByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/content/{contentName}/receipt/verify");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyReceiptByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
