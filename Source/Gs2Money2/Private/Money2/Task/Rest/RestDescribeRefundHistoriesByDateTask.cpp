...
#include "Money2/Task/Rest/DescribeRefundHistoriesByDateTask.h"
...
{
    FDescribeRefundHistoriesByDateTask::FDescribeRefundHistoriesByDateTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeRefundHistoriesByDateTask::Action(
        const TSharedPtr<Result::FDescribeRefundHistoriesByDateResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/refund/date/{year}/{month}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeRefundHistoriesByDateResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
