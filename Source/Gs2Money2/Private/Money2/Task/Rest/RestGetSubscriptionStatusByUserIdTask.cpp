...
#include "Money2/Task/Rest/GetSubscriptionStatusByUserIdTask.h"
...
{
    FGetSubscriptionStatusByUserIdTask::FGetSubscriptionStatusByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSubscriptionStatusByUserIdTask::Action(
        const TSharedPtr<Result::FGetSubscriptionStatusByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/subscription/{contentName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSubscriptionStatusByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
