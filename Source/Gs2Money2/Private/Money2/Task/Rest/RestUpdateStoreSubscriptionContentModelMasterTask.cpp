...
#include "Money2/Task/Rest/UpdateStoreSubscriptionContentModelMasterTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/subscription/{contentName}");
            ...
            Url = Url.Replace(
                TEXT("{contentName}"),
                !this->Request->GetContentName().IsSet() || this->Request->GetContentName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetContentName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateStoreSubscriptionContentModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
