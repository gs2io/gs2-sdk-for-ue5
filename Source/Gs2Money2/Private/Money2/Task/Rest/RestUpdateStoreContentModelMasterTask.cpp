...
#include "Money2/Task/Rest/UpdateStoreContentModelMasterTask.h"
...
{
    FUpdateStoreContentModelMasterTask::FUpdateStoreContentModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateStoreContentModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateStoreContentModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateStoreContentModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
