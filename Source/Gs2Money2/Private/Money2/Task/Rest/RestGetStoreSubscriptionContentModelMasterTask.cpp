...
#include "Money2/Task/Rest/GetStoreSubscriptionContentModelMasterTask.h"
...
{
    FGetStoreSubscriptionContentModelMasterTask::FGetStoreSubscriptionContentModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStoreSubscriptionContentModelMasterTask::Action(
        const TSharedPtr<Result::FGetStoreSubscriptionContentModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStoreSubscriptionContentModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
