...
#include "Money2/Task/Rest/GetEventByTransactionIdTask.h"
...
{
    FGetEventByTransactionIdTask::FGetEventByTransactionIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetEventByTransactionIdTask::Action(
        const TSharedPtr<Result::FGetEventByTransactionIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/event/{transactionId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEventByTransactionIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
