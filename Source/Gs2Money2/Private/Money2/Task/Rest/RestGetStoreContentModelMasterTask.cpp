...
#include "Money2/Task/Rest/GetStoreContentModelMasterTask.h"
...
{
    FGetStoreContentModelMasterTask::FGetStoreContentModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStoreContentModelMasterTask::Action(
        const TSharedPtr<Result::FGetStoreContentModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/{contentName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStoreContentModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
