...
#include "Money2/Task/Rest/GetSubscriptionStatusTask.h"
...
{
    FGetSubscriptionStatusTask::FGetSubscriptionStatusTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSubscriptionStatusTask::Action(
        const TSharedPtr<Result::FGetSubscriptionStatusResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/subscription/{contentName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSubscriptionStatusResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
