...
#include "Money2/Task/Rest/GetUnusedBalanceTask.h"
...
{
    FGetUnusedBalanceTask::FGetUnusedBalanceTask(
    ...
    FGetUnusedBalanceTask::FGetUnusedBalanceTask(
        const FGetUnusedBalanceTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetUnusedBalanceTask::Action(
        const TSharedPtr<Result::FGetUnusedBalanceResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/balance/unused/{currency}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetUnusedBalanceResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
