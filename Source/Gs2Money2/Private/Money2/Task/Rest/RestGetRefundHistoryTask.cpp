...
#include "Money2/Task/Rest/GetRefundHistoryTask.h"
...
{
    FGetRefundHistoryTask::FGetRefundHistoryTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRefundHistoryTask::Action(
        const TSharedPtr<Result::FGetRefundHistoryResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/refund/{transactionId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRefundHistoryResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
