...
#include "Money2/Task/Rest/GetStoreContentModelTask.h"
...
{
    FGetStoreContentModelTask::FGetStoreContentModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStoreContentModelTask::Action(
        const TSharedPtr<Result::FGetStoreContentModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/content/{contentName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStoreContentModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
