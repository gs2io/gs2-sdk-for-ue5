...
#include "Money2/Task/Rest/VerifyReceiptTask.h"
...
{
    FVerifyReceiptTask::FVerifyReceiptTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyReceiptTask::Action(
        const TSharedPtr<Result::FVerifyReceiptResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/content/{contentName}/receipt/verify");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyReceiptResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
