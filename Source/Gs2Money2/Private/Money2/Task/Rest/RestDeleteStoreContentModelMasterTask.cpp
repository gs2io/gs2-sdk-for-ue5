...
#include "Money2/Task/Rest/DeleteStoreContentModelMasterTask.h"
...
{
    FDeleteStoreContentModelMasterTask::FDeleteStoreContentModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteStoreContentModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteStoreContentModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteStoreContentModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
