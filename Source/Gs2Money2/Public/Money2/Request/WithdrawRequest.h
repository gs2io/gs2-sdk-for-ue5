...
namespace Gs2::Money2::Request
{
    ...
    class GS2MONEY2_API FWithdrawRequest final : public TSharedFromThis<FWithdrawRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FWithdrawRequest> WithWithdrawCount(const TOptional<int32> WithdrawCount);
    ...
    typedef TSharedPtr<FWithdrawRequest, ESPMode::ThreadSafe> FWithdrawRequestPtr;
}