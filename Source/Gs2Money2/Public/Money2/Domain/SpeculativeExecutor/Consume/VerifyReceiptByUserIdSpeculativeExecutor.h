...
namespace Gs2::Money2::Domain::SpeculativeExecutor
{
    ...
    class GS2MONEY2_API FVerifyReceiptByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2MONEY2_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Money2::Domain::FGs2Money2DomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Money2::Request::FVerifyReceiptByUserIdRequestPtr& Request
            ...
            GS2MONEY2_API FCommitTask(
                const FCommitTask& From
            );

            GS2MONEY2_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Money2::Request::FVerifyReceiptByUserIdRequestPtr Rate(
            const Gs2::Money2::Request::FVerifyReceiptByUserIdRequestPtr& Request,
            const double Rate
        );
