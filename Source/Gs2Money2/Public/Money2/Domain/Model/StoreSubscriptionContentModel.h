...
namespace Gs2::Money2::Domain::Model
{
    ...
    class GS2MONEY2_API FStoreSubscriptionContentModelDomain:
        public TSharedFromThis<FStoreSubscriptionContentModelDomain>
    {
    ...
    public:
        ...
        FStoreSubscriptionContentModelDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Money2::Domain::FGs2Money2DomainPtr& Service,
        ...
        {
            const TSharedPtr<FStoreSubscriptionContentModelDomain> Self;
            const TFunction<void(Gs2::Money2::Model::FStoreSubscriptionContentModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FStoreSubscriptionContentModelDomain> FStoreSubscriptionContentModelDomainPtr;
}
