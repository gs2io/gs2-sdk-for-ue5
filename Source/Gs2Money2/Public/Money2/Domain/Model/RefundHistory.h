...
namespace Gs2::Money2::Domain::Model
{
    ...
    class GS2MONEY2_API FRefundHistoryDomain:
        public TSharedFromThis<FRefundHistoryDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FRefundHistoryDomain> Self;
            const TFunction<void(Gs2::Money2::Model::FRefundHistoryPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FRefundHistoryDomain> FRefundHistoryDomainPtr;
}
