...
namespace Gs2::Money2::Domain::Model
{
    ...
    class GS2MONEY2_API FSubscriptionStatusAccessTokenDomain:
        public TSharedFromThis<FSubscriptionStatusAccessTokenDomain>
    {
    ...
    public:
        ...
        FSubscriptionStatusAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Money2::Domain::FGs2Money2DomainPtr& Service,
    ...
    typedef TSharedPtr<FSubscriptionStatusAccessTokenDomain> FSubscriptionStatusAccessTokenDomainPtr;
}
