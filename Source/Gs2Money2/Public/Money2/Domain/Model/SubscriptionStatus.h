...
namespace Gs2::Money2::Domain::Model
{
    ...
    class GS2MONEY2_API FSubscriptionStatusDomain:
        public TSharedFromThis<FSubscriptionStatusDomain>
    {
    ...
    typedef TSharedPtr<FSubscriptionStatusDomain> FSubscriptionStatusDomainPtr;
}
