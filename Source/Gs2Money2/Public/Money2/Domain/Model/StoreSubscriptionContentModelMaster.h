...
namespace Gs2::Money2::Domain::Model
{
    ...
    class GS2MONEY2_API FStoreSubscriptionContentModelMasterDomain:
        public TSharedFromThis<FStoreSubscriptionContentModelMasterDomain>
    {
    ...
    public:
        ...
        FStoreSubscriptionContentModelMasterDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Money2::Domain::FGs2Money2DomainPtr& Service,
        ...
        {
            const TSharedPtr<FStoreSubscriptionContentModelMasterDomain> Self;
            const TFunction<void(Gs2::Money2::Model::FStoreSubscriptionContentModelMasterPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FStoreSubscriptionContentModelMasterDomain> FStoreSubscriptionContentModelMasterDomainPtr;
}
