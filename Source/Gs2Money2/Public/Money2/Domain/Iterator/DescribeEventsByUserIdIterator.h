...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeEventsByUserIdIterator :
        public TSharedFromThis<FDescribeEventsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FEvent>> Result) override;
        ...
        {
            TSharedRef<FDescribeEventsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Money2::Model::FEventPtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FEventPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FEventPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeEventsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeEventsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeEventsByUserIdIterator> Iterable)
            {
