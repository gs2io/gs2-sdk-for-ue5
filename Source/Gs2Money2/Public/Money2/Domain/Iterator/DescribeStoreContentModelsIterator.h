...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeStoreContentModelsIterator :
        public TSharedFromThis<FDescribeStoreContentModelsIterator>
    {
    ...
    public:
        FDescribeStoreContentModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FStoreContentModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeStoreContentModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Money2::Model::FStoreContentModelPtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FStoreContentModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FStoreContentModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStoreContentModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStoreContentModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStoreContentModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeStoreContentModelsIterator> FDescribeStoreContentModelsIteratorPtr;
}
