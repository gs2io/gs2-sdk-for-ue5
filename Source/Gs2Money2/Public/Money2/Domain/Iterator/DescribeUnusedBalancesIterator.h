...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeUnusedBalancesIterator :
        public TSharedFromThis<FDescribeUnusedBalancesIterator>
    {
    ...
    public:
        FDescribeUnusedBalancesIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FUnusedBalance>> Result) override;
        ...
        {
            TSharedRef<FDescribeUnusedBalancesIterator> Self;
            TSharedPtr<TArray<Gs2::Money2::Model::FUnusedBalancePtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FUnusedBalancePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FUnusedBalancePtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeUnusedBalancesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeUnusedBalancesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeUnusedBalancesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeUnusedBalancesIterator> FDescribeUnusedBalancesIteratorPtr;
}
