...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeSubscriptionStatusesByUserIdIterator :
        public TSharedFromThis<FDescribeSubscriptionStatusesByUserIdIterator>
    {
    ...
    public:
        FDescribeSubscriptionStatusesByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        class GS2MONEY2_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Money2::Model::FSubscriptionStatus>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FSubscriptionStatus>> Result) override;
        ...
        {
            TSharedRef<FDescribeSubscriptionStatusesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Money2::Model::FSubscriptionStatusPtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FSubscriptionStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FSubscriptionStatusPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscriptionStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscriptionStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscriptionStatusesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscriptionStatusesByUserIdIterator> FDescribeSubscriptionStatusesByUserIdIteratorPtr;
}
