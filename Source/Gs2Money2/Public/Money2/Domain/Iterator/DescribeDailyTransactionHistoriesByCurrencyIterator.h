...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeDailyTransactionHistoriesByCurrencyIterator :
        public TSharedFromThis<FDescribeDailyTransactionHistoriesByCurrencyIterator>
    {
    ...
    public:
        FDescribeDailyTransactionHistoriesByCurrencyIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> Currency,
        ...
        {
            TSharedRef<FDescribeDailyTransactionHistoriesByCurrencyIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDailyTransactionHistoriesByCurrencyIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDailyTransactionHistoriesByCurrencyIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDailyTransactionHistoriesByCurrencyIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeDailyTransactionHistoriesByCurrencyIterator> FDescribeDailyTransactionHistoriesByCurrencyIteratorPtr;
}
