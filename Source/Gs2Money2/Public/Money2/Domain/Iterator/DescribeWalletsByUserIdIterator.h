...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeWalletsByUserIdIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FWallet>> Result) override;
        ...
        class GS2MONEY2_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Money2::Model::FWalletPtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FWalletPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FWalletPtr& Current()
            {
