...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeSubscriptionStatusesIterator :
        public TSharedFromThis<FDescribeSubscriptionStatusesIterator>
    {
    ...
    public:
        FDescribeSubscriptionStatusesIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        {
            TSharedRef<FDescribeSubscriptionStatusesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscriptionStatusesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscriptionStatusesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscriptionStatusesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscriptionStatusesIterator> FDescribeSubscriptionStatusesIteratorPtr;
}
