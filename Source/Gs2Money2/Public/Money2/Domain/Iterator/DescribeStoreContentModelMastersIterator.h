...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeStoreContentModelMastersIterator :
        public TSharedFromThis<FDescribeStoreContentModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FStoreContentModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeStoreContentModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Money2::Model::FStoreContentModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FStoreContentModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FStoreContentModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStoreContentModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStoreContentModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStoreContentModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeStoreContentModelMastersIterator> FDescribeStoreContentModelMastersIteratorPtr;
}
