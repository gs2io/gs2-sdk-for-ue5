...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money2::Model::FNamespace>> Result) override;
        ...
        class GS2MONEY2_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Money2::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Money2::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Money2::Model::FNamespacePtr& Current()
            {
