...
namespace Gs2::Money2::Domain::Iterator
{
    ...
    class GS2MONEY2_API FDescribeRefundHistoriesByUserIdIterator :
        public TSharedFromThis<FDescribeRefundHistoriesByUserIdIterator>
    {
    ...
    public:
        FDescribeRefundHistoriesByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Money2::FGs2Money2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        {
            TSharedRef<FDescribeRefundHistoriesByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRefundHistoriesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRefundHistoriesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRefundHistoriesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRefundHistoriesByUserIdIterator> FDescribeRefundHistoriesByUserIdIteratorPtr;
}
