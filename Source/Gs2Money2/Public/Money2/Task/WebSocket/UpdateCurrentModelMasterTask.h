...
#include "Money2/Request/UpdateCurrentModelMasterRequest.h"
#include "Money2/Result/UpdateCurrentModelMasterResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateCurrentModelMasterResult>
    {
