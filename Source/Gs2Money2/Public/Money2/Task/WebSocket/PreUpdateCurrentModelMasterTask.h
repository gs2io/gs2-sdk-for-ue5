...
#include "Money2/Request/PreUpdateCurrentModelMasterRequest.h"
#include "Money2/Result/PreUpdateCurrentModelMasterResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FPreUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FPreUpdateCurrentModelMasterResult>
    {
