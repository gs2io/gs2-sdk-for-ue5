...
#include "Money2/Request/DescribeNamespacesRequest.h"
#include "Money2/Result/DescribeNamespacesResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
