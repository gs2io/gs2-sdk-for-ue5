...
#include "Money2/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Money2/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
