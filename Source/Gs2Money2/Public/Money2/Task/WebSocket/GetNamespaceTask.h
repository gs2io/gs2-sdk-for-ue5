...
#include "Money2/Request/GetNamespaceRequest.h"
#include "Money2/Result/GetNamespaceResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
