...
#include "Money2/Request/ImportUserDataByUserIdRequest.h"
#include "Money2/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
