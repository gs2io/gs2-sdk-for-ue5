...
#include "Money2/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Money2/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
