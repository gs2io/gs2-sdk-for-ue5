...
#include "Money2/Request/DeleteNamespaceRequest.h"
#include "Money2/Result/DeleteNamespaceResult.h"

namespace Gs2::Money2::Task::WebSocket
{
    class GS2MONEY2_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
