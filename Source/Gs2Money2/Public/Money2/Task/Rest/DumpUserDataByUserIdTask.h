...
#include "Money2/Request/DumpUserDataByUserIdRequest.h"
#include "Money2/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
