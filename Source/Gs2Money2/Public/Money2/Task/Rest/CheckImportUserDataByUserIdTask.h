...
#include "Money2/Request/CheckImportUserDataByUserIdRequest.h"
#include "Money2/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
