...
#include "Money2/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Money2/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
