...
#include "Money2/Result/UpdateNamespaceResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
