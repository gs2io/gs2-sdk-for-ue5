...
#include "Money2/Request/GetNamespaceStatusRequest.h"
#include "Money2/Result/GetNamespaceStatusResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
