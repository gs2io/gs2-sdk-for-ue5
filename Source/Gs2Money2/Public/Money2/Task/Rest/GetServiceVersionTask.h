...
#include "Money2/Request/GetServiceVersionRequest.h"
#include "Money2/Result/GetServiceVersionResult.h"

namespace Gs2::Money2::Task::Rest
{
    class GS2MONEY2_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
