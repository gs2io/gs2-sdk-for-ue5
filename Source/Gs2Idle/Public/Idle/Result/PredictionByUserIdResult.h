...
{
    class GS2IDLE_API FPredictionByUserIdResult final : public TSharedFromThis<FPredictionByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FPredictionByUserIdResult> WithItems(const TSharedPtr<TArray<TSharedPtr<Model::FAcquireAction>>> Items);
        TSharedPtr<FPredictionByUserIdResult> WithStatus(const TSharedPtr<Model::FStatus> Status);
