...
{
    class GS2IDLE_API FExportMasterResult final : public TSharedFromThis<FExportMasterResult>
    {
    ...
    public:
        ...
        TSharedPtr<FExportMasterResult> WithItem(const TSharedPtr<Model::FCurrentCategoryMaster> Item);
