...
#include "Idle/Request/GetNamespaceStatusRequest.h"
#include "Idle/Result/GetNamespaceStatusResult.h"

namespace Gs2::Idle::Task::Rest
{
    class GS2IDLE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
