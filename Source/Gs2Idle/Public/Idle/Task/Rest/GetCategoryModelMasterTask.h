...
#include "Idle/Request/GetCategoryModelMasterRequest.h"
#include "Idle/Result/GetCategoryModelMasterResult.h"

namespace Gs2::Idle::Task::Rest
{
    class GS2IDLE_API FGetCategoryModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FGetCategoryModelMasterResult>
    {
