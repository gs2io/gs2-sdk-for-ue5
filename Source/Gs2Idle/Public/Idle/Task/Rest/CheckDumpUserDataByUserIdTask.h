...
#include "Idle/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Idle/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::Rest
{
    class GS2IDLE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
