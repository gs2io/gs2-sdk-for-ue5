...
#include "Idle/Request/DeleteNamespaceRequest.h"
#include "Idle/Result/DeleteNamespaceResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
