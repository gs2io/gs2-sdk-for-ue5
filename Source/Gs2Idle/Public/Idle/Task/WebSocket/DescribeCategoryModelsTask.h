...
#include "Idle/Result/DescribeCategoryModelsResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FDescribeCategoryModelsTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeCategoryModelsResult>
    {
