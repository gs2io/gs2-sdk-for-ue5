...
#include "Idle/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Idle/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
