...
#include "Idle/Request/DescribeNamespacesRequest.h"
#include "Idle/Result/DescribeNamespacesResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
