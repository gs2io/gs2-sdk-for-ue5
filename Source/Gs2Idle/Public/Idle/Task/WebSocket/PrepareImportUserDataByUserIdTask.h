...
#include "Idle/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Idle/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
