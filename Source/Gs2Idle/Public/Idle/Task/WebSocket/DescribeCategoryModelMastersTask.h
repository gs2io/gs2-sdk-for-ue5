...
#include "Idle/Result/DescribeCategoryModelMastersResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FDescribeCategoryModelMastersTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeCategoryModelMastersResult>
    {
