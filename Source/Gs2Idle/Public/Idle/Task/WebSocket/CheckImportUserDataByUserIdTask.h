...
#include "Idle/Request/CheckImportUserDataByUserIdRequest.h"
#include "Idle/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
