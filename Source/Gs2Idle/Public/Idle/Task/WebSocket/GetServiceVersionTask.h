...
#include "Idle/Request/GetServiceVersionRequest.h"
#include "Idle/Result/GetServiceVersionResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
