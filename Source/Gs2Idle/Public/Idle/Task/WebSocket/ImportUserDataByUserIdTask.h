...
#include "Idle/Request/ImportUserDataByUserIdRequest.h"
#include "Idle/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
