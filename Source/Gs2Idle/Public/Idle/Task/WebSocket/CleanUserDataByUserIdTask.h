...
#include "Idle/Request/CleanUserDataByUserIdRequest.h"
#include "Idle/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
