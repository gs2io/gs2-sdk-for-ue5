...
#include "Idle/Request/GetNamespaceRequest.h"
#include "Idle/Result/GetNamespaceResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
