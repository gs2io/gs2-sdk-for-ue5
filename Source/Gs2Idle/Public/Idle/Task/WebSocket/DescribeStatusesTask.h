...
#include "Idle/Result/DescribeStatusesResult.h"

namespace Gs2::Idle::Task::WebSocket
{
    class GS2IDLE_API FDescribeStatusesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeStatusesResult>
    {
