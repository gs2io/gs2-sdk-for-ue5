...
namespace Gs2::Idle::Domain::Iterator
{
    ...
    class GS2IDLE_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Idle::Model::FNamespace>> Result) override;
        ...
        class GS2IDLE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Idle::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Idle::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Idle::Model::FNamespacePtr& Current()
            {
