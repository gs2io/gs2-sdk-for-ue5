...
namespace Gs2::Idle::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Idle::Model::FCategoryModel>> Result) override;
        ...
        class GS2IDLE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Idle::Model::FCategoryModelPtr>> Range;
            TOptional<TArray<Gs2::Idle::Model::FCategoryModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Idle::Model::FCategoryModelPtr& Current()
            {
