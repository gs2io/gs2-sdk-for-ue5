...
namespace Gs2::Idle::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Idle::Model::FStatus>> Result) override;
        ...
        class GS2IDLE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Idle::Model::FStatusPtr>> Range;
            TOptional<TArray<Gs2::Idle::Model::FStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Idle::Model::FStatusPtr& Current()
            {
