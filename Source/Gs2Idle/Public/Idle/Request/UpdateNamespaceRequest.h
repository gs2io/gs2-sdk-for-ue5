...
namespace Gs2::Idle::Request
{
    ...
    class GS2IDLE_API FUpdateNamespaceRequest final : public TSharedFromThis<FUpdateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FUpdateNamespaceRequest> WithReceiveScript(const TSharedPtr<Model::FScriptSetting> ReceiveScript);
        TSharedPtr<FUpdateNamespaceRequest> WithOverrideAcquireActionsScriptId(const TOptional<FString> OverrideAcquireActionsScriptId);
