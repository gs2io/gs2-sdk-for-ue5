...
namespace Gs2::Idle::Result
{
    ...
    TSharedPtr<FReceiveResult> FReceiveResult::WithAtomicCommit(
    ...
    TSharedPtr<FReceiveResult> FReceiveResult::WithTransaction(
    ...
    TSharedPtr<FReceiveResult> FReceiveResult::WithTransactionResult(
    ...
    TOptional<bool> FReceiveResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReceiveResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReceiveResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReceiveResult::GetTransactionResult() const
    {
