...
#include "Idle/Model/Namespace.h"
...
namespace Gs2::Idle::Model
{
    ...
    TSharedPtr<FNamespace> FNamespace::WithReceiveScript(
        const TSharedPtr<FScriptSetting> ReceiveScript
    )
    {
    ...
    TSharedPtr<FNamespace> FNamespace::WithOverrideAcquireActionsScriptId(
    ...
    TSharedPtr<FScriptSetting> FNamespace::GetReceiveScript() const
    {
        return ReceiveScriptValue;
    }
    TOptional<FString> FNamespace::GetOverrideAcquireActionsScriptId() const
    {
    ...
    TSharedPtr<FNamespace> FNamespace::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FNamespace>()
            ...
            ->WithReceiveScript(Data->HasField(ANSI_TO_TCHAR("receiveScript")) ? [Data]() -> Model::FScriptSettingPtr
                {
                    if (Data->HasTypedField<EJson::Null>(ANSI_TO_TCHAR("receiveScript")))
                    {
                        return nullptr;
                    }
    ...
    TSharedPtr<FJsonObject> FNamespace::ToJson() const
    {
        ...
        {
            JsonRootObject->SetObjectField(TEXT("receiveScript"), ReceiveScriptValue->ToJson());
        }
        if (OverrideAcquireActionsScriptIdValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("overrideAcquireActionsScriptId"), OverrideAcquireActionsScriptIdValue.GetValue());
        }
...
namespace Gs2::Idle::Model::Cache
{
    ...
    bool FNamespaceCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Idle::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Idle::Model::FNamespacePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Idle::Model::FNamespace>(
    ...
    void FNamespaceCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Idle::Model::FNamespacePtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Idle::Model::FNamespacePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Idle::Model::FNamespace>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Idle::Model::FNamespace::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    FString FNamespaceCache::PutUserData(
        ...
        const Gs2::Idle::Model::FNamespacePtr& Item
    )
    {
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Idle::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentNamespaceName
        ));
    ...
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Idle::Model::FNamespacePtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Idle::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Idle::Model::FNamespacePtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FNamespaceCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Idle::Model::FNamespacePtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Idle::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Idle::Model::FNamespacePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Idle::Model::FNamespace>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Idle::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
