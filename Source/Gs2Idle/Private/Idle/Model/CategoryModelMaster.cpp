...
namespace Gs2::Idle::Model::Cache
{
    ...
    bool FCategoryModelMasterCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentCategoryName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Idle::Model::FCategoryModelMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Idle::Model::FCategoryModelMasterPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Idle::Model::FCategoryModelMaster>(
    ...
    void FCategoryModelMasterCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentCategoryName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Idle::Model::FCategoryModelMasterPtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Idle::Model::FCategoryModelMasterPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Idle::Model::FCategoryModelMaster>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Idle::Model::FCategoryModelMaster::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    FString FCategoryModelMasterCache::PutUserData(
        ...
        const Gs2::Idle::Model::FCategoryModelMasterPtr& Item
    )
    {
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Idle::Model::FCategoryModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentCategoryName
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCategoryModelMasterCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentCategoryName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Idle::Model::FCategoryModelMasterPtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Idle::Model::FCategoryModelMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Idle::Model::FCategoryModelMasterPtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FCategoryModelMasterCache::ListSubscribe(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Idle::Model::FCategoryModelMasterPtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Idle::Model::FCategoryModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Idle::Model::FCategoryModelMasterPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Idle::Model::FCategoryModelMaster>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Idle::Model::FCategoryModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
