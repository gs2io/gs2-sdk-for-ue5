...
#include "Idle/Task/WebSocket/CreateCategoryModelMasterTask.h"
...
namespace Gs2::Idle::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("idle"), TEXT("categoryModelMaster"), TEXT("createCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
