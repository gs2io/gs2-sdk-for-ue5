...
#include "Idle/Task/WebSocket/UpdateCategoryModelMasterTask.h"
...
namespace Gs2::Idle::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("idle"), TEXT("categoryModelMaster"), TEXT("updateCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
