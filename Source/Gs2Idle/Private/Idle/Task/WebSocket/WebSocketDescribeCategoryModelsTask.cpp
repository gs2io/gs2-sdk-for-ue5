...
#include "Idle/Task/WebSocket/DescribeCategoryModelsTask.h"
...
namespace Gs2::Idle::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("idle"), TEXT("categoryModel"), TEXT("describeCategoryModels"), ToCStr(RequestPayload->Payload()));
