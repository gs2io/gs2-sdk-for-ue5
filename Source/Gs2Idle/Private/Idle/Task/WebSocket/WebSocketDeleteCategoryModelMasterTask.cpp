...
#include "Idle/Task/WebSocket/DeleteCategoryModelMasterTask.h"
...
namespace Gs2::Idle::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("idle"), TEXT("categoryModelMaster"), TEXT("deleteCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
