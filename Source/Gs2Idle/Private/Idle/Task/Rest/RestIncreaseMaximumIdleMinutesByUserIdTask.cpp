...
#include "Idle/Task/Rest/IncreaseMaximumIdleMinutesByUserIdTask.h"
...
{
    FIncreaseMaximumIdleMinutesByUserIdTask::FIncreaseMaximumIdleMinutesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FIncreaseMaximumIdleMinutesByUserIdTask::Action(
        const TSharedPtr<Result::FIncreaseMaximumIdleMinutesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/model/{categoryName}/maximumIdle/increase");
            ...
            if (this->Request->GetIncreaseMinutes().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("increaseMinutes"), this->Request->GetIncreaseMinutes().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIncreaseMaximumIdleMinutesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
