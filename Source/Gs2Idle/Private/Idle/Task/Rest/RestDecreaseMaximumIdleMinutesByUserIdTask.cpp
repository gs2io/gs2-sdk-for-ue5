...
#include "Idle/Task/Rest/DecreaseMaximumIdleMinutesByUserIdTask.h"
...
{
    FDecreaseMaximumIdleMinutesByUserIdTask::FDecreaseMaximumIdleMinutesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDecreaseMaximumIdleMinutesByUserIdTask::Action(
        const TSharedPtr<Result::FDecreaseMaximumIdleMinutesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/model/{categoryName}/maximumIdle/decrease");
            ...
            if (this->Request->GetDecreaseMinutes().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("decreaseMinutes"), this->Request->GetDecreaseMinutes().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDecreaseMaximumIdleMinutesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
