...
#include "Idle/Task/Rest/DecreaseMaximumIdleMinutesTask.h"
...
{
    FDecreaseMaximumIdleMinutesTask::FDecreaseMaximumIdleMinutesTask(
    ...
    Core::Model::FGs2ErrorPtr FDecreaseMaximumIdleMinutesTask::Action(
        const TSharedPtr<Result::FDecreaseMaximumIdleMinutesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/model/{categoryName}/maximumIdle/decrease");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDecreaseMaximumIdleMinutesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
