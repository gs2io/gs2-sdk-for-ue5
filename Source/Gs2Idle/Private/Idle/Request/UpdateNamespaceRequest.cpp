...
#include "Idle/Request/UpdateNamespaceRequest.h"
...
namespace Gs2::Idle::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithReceiveScript(
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithOverrideAcquireActionsScriptId(
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetReceiveScript() const
    {
    ...
    TOptional<FString> FUpdateNamespaceRequest::GetOverrideAcquireActionsScriptId() const
    {
