...
namespace Gs2::Idle::Request
{
    ...
    TSharedPtr<FDeleteCategoryModelMasterRequest> FDeleteCategoryModelMasterRequest::WithCategoryName(
    ...
    TOptional<FString> FDeleteCategoryModelMasterRequest::GetCategoryName() const
    {
