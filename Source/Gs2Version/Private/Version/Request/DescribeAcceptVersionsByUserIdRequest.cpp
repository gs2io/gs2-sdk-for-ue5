...
namespace Gs2::Version::Request
{
    ...
    TSharedPtr<FDescribeAcceptVersionsByUserIdRequest> FDescribeAcceptVersionsByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDescribeAcceptVersionsByUserIdRequest::GetTimeOffsetToken() const
    {
