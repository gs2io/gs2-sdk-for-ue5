...
namespace Gs2::Version::Request
{
    ...
    TSharedPtr<FGetAcceptVersionByUserIdRequest> FGetAcceptVersionByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FGetAcceptVersionByUserIdRequest::GetTimeOffsetToken() const
    {
