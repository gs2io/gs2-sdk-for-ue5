...
#include "Version/Task/Rest/CalculateSignatureTask.h"
...
{
    FCalculateSignatureTask::FCalculateSignatureTask(
    ...
    Core::Model::FGs2ErrorPtr FCalculateSignatureTask::Action(
        const TSharedPtr<Result::FCalculateSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/version/{versionName}/calculate/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCalculateSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
