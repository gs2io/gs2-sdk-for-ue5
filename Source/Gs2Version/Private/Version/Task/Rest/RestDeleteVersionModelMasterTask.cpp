...
#include "Version/Task/Rest/DeleteVersionModelMasterTask.h"
...
{
    FDeleteVersionModelMasterTask::FDeleteVersionModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteVersionModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteVersionModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteVersionModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
