...
#include "Version/Task/Rest/CheckVersionByUserIdTask.h"
...
{
    FCheckVersionByUserIdTask::FCheckVersionByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCheckVersionByUserIdTask::Action(
        const TSharedPtr<Result::FCheckVersionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/check");
            ...
            if (this->Request->GetTargetVersions() != nullptr && this->Request->GetTargetVersions().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetTargetVersions())
                {
                    v.Add(MakeShared<FJsonValueObject>(JsonObjectValue->ToJson()));
                }
                JsonRootObject->SetArrayField(TEXT("targetVersions"), v);
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCheckVersionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
