...
#include "Version/Task/Rest/AcceptByUserIdTask.h"
...
{
    FAcceptByUserIdTask::FAcceptByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAcceptByUserIdTask::Action(
        const TSharedPtr<Result::FAcceptByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/acceptVersion");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcceptByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
