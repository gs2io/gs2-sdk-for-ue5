...
#include "Version/Task/Rest/UpdateVersionModelMasterTask.h"
...
{
    FUpdateVersionModelMasterTask::FUpdateVersionModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateVersionModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateVersionModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateVersionModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
