...
#include "Version/Task/Rest/GetVersionModelMasterTask.h"
...
{
    FGetVersionModelMasterTask::FGetVersionModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetVersionModelMasterTask::Action(
        const TSharedPtr<Result::FGetVersionModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/version/{versionName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetVersionModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
