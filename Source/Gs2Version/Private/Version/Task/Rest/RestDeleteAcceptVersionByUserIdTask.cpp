...
#include "Version/Task/Rest/DeleteAcceptVersionByUserIdTask.h"
...
{
    FDeleteAcceptVersionByUserIdTask::FDeleteAcceptVersionByUserIdTask(
    ...
    FDeleteAcceptVersionByUserIdTask::FDeleteAcceptVersionByUserIdTask(
        const FDeleteAcceptVersionByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteAcceptVersionByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteAcceptVersionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/{versionName}");
            ...
            Url = Url.Replace(
                TEXT("{versionName}"),
                !this->Request->GetVersionName().IsSet() || this->Request->GetVersionName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetVersionName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteAcceptVersionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
