...
#include "Version/Task/Rest/DeleteAcceptVersionTask.h"
...
{
    FDeleteAcceptVersionTask::FDeleteAcceptVersionTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteAcceptVersionTask::Action(
        const TSharedPtr<Result::FDeleteAcceptVersionResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/{versionName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteAcceptVersionResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
