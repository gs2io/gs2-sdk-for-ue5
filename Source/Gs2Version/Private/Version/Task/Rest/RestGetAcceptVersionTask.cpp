...
#include "Version/Task/Rest/GetAcceptVersionTask.h"
...
{
    FGetAcceptVersionTask::FGetAcceptVersionTask(
    ...
    Core::Model::FGs2ErrorPtr FGetAcceptVersionTask::Action(
        const TSharedPtr<Result::FGetAcceptVersionResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetAcceptVersionResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
