...
#include "Version/Task/Rest/GetVersionModelTask.h"
...
{
    FGetVersionModelTask::FGetVersionModelTask(
    ...
    FGetVersionModelTask::FGetVersionModelTask(
        const FGetVersionModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetVersionModelTask::Action(
        const TSharedPtr<Result::FGetVersionModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/version/{versionName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetVersionModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
