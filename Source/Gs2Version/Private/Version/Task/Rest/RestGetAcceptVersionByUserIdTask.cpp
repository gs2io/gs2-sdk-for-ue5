...
#include "Version/Task/Rest/GetAcceptVersionByUserIdTask.h"
...
{
    FGetAcceptVersionByUserIdTask::FGetAcceptVersionByUserIdTask(
    ...
    FGetAcceptVersionByUserIdTask::FGetAcceptVersionByUserIdTask(
        const FGetAcceptVersionByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetAcceptVersionByUserIdTask::Action(
        const TSharedPtr<Result::FGetAcceptVersionByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetAcceptVersionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
