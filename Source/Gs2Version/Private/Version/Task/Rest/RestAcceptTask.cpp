...
#include "Version/Task/Rest/AcceptTask.h"
...
namespace Gs2::Version::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FAcceptTask::Action(
        const TSharedPtr<Result::FAcceptResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/acceptVersion");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcceptResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
