...
#include "Version/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Version::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("version"), TEXT("currentVersionMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
