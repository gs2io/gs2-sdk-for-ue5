...
#include "Version/Task/WebSocket/AcceptTask.h"
...
namespace Gs2::Version::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("version"), TEXT("acceptVersion"), TEXT("accept"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FAcceptResult::FromJson(WebSocketResult->Body());
