...
namespace Gs2::Version
{
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FGetServiceVersionTask>> FGs2VersionWebSocketClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FDumpUserDataByUserIdTask>> FGs2VersionWebSocketClient::DumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FCheckDumpUserDataByUserIdTask>> FGs2VersionWebSocketClient::CheckDumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FCleanUserDataByUserIdTask>> FGs2VersionWebSocketClient::CleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FCheckCleanUserDataByUserIdTask>> FGs2VersionWebSocketClient::CheckCleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FPrepareImportUserDataByUserIdTask>> FGs2VersionWebSocketClient::PrepareImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FImportUserDataByUserIdTask>> FGs2VersionWebSocketClient::ImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FCheckImportUserDataByUserIdTask>> FGs2VersionWebSocketClient::CheckImportUserDataByUserId(
