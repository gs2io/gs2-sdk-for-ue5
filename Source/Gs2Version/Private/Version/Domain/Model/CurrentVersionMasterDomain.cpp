...
namespace Gs2::Version::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Version::Model::Cache::FCurrentVersionMasterCache::Put(
            Self->Gs2->Cache,
    ...
    FCurrentVersionMasterDomain::FPreUpdateTask::FPreUpdateTask(
        const TSharedPtr<FCurrentVersionMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentVersionMasterDomain::FPreUpdateTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Version::Domain::Model::FCurrentVersionMasterDomain>> Result
    )
    {
        Request
            ->WithContextStack((!Request->GetContextStack().IsSet() || Request->GetContextStack()->IsEmpty()) ? Self->Gs2->DefaultContextStack : Request->GetContextStack())
            ->WithNamespaceName(Self->NamespaceName);
        const auto Future = Self->Client->PreUpdateCurrentVersionMaster(
            Request
        );
        Future->StartSynchronousTask();
        if (Future->GetTask().IsError())
    ...
    TSharedPtr<FAsyncTask<FCurrentVersionMasterDomain::FPreUpdateTask>> FCurrentVersionMasterDomain::PreUpdate(
    ...
    {
        const auto CacheParentKey = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Version::Model::FCurrentVersionMasterPtr Value;
                const auto CacheHit = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Version::Model::FCurrentVersionMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FCurrentVersionMasterDomain::Invalidate()
    {
        Gs2::Version::Model::Cache::FCurrentVersionMasterCache::Delete(
            Gs2->Cache,
    ...
    FCurrentVersionMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCurrentVersionMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentVersionMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCurrentVersionMasterDomain::FSubscribeWithInitialCallTask>> FCurrentVersionMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Version::Model::FCurrentVersionMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Version::Model::Cache::FCurrentVersionMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName]()
            {
                ...
                const auto Domain = MakeShared<FCurrentVersionMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName
                );
