...
namespace Gs2::Version::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Version::Model::Cache::FVersionModelCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Version::Model::Cache::FVersionModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Version::Model::Cache::FVersionModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Version::Model::FVersionModelPtr Value;
                const auto CacheHit = Gs2::Version::Model::Cache::FVersionModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Version::Model::Cache::FVersionModelCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->VersionName,
                    TOptional<int32>(),
                    [Self](Gs2::Version::Model::FVersionModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FVersionModelDomain::Invalidate()
    {
        Gs2::Version::Model::Cache::FVersionModelCache::Delete(
            Gs2->Cache,
    ...
    FVersionModelDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FVersionModelDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FVersionModelDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FVersionModelDomain::FSubscribeWithInitialCallTask>> FVersionModelDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Version::Model::FVersionModelPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Version::Model::Cache::FVersionModelCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Version::Model::Cache::FVersionModelCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryVersionName]()
            {
                ...
                const auto Domain = MakeShared<FVersionModelDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryVersionName
