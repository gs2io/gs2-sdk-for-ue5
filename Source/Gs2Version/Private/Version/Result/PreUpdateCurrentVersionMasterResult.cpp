...
{
    FPreUpdateCurrentVersionMasterResult::FPreUpdateCurrentVersionMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentVersionMasterResult> FPreUpdateCurrentVersionMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentVersionMasterResult> FPreUpdateCurrentVersionMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentVersionMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentVersionMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentVersionMasterResult> FPreUpdateCurrentVersionMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentVersionMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentVersionMasterResult::ToJson() const
    {
