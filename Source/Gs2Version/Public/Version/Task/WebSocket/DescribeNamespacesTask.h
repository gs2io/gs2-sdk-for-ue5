...
#include "Version/Request/DescribeNamespacesRequest.h"
#include "Version/Result/DescribeNamespacesResult.h"

namespace Gs2::Version::Task::WebSocket
{
    class GS2VERSION_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
