...
#include "Version/Request/CleanUserDataByUserIdRequest.h"
#include "Version/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Version::Task::WebSocket
{
    class GS2VERSION_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
