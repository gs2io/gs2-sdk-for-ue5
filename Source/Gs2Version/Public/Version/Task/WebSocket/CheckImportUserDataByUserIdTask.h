...
#include "Version/Request/CheckImportUserDataByUserIdRequest.h"
#include "Version/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Version::Task::WebSocket
{
    class GS2VERSION_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
