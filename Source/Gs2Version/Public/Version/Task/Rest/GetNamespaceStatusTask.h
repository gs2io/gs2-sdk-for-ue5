...
#include "Version/Request/GetNamespaceStatusRequest.h"
#include "Version/Result/GetNamespaceStatusResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
