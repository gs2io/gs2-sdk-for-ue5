...
#include "Version/Request/GetServiceVersionRequest.h"
#include "Version/Result/GetServiceVersionResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
