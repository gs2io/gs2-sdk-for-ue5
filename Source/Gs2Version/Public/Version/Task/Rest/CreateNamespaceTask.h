...
#include "Version/Result/CreateNamespaceResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
