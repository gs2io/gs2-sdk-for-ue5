...
#include "Version/Request/DumpUserDataByUserIdRequest.h"
#include "Version/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
