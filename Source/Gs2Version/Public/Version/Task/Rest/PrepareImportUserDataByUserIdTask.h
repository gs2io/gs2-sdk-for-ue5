...
#include "Version/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Version/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
