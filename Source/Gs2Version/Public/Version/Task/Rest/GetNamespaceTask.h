...
#include "Version/Request/GetNamespaceRequest.h"
#include "Version/Result/GetNamespaceResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
