...
#include "Version/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Version/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
