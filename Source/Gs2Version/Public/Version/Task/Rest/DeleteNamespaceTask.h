...
#include "Version/Request/DeleteNamespaceRequest.h"
#include "Version/Result/DeleteNamespaceResult.h"

namespace Gs2::Version::Task::Rest
{
    class GS2VERSION_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
