...
namespace Gs2::Version::Domain
{
    ...
    public:
        ...
        class GS2VERSION_API FDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FCheckDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FCheckCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        class GS2VERSION_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2VersionDomain>,
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Version::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2VERSION_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2VersionDomain> Self;
            const TFunction<void(TArray<Gs2::Version::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2VersionDomain>& Self, TFunction<void(TArray<Gs2::Version::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
