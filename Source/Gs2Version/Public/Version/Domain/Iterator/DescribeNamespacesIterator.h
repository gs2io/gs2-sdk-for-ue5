...
namespace Gs2::Version::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Version::Model::FNamespace>> Result) override;
        ...
        class GS2VERSION_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Version::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Version::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
