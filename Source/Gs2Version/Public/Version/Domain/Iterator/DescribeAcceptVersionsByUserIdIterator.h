...
namespace Gs2::Version::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Version::Model::FAcceptVersion>> Result) override;
        ...
        {
            TSharedRef<FDescribeAcceptVersionsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Version::Model::FAcceptVersionPtr>> Range;
            TOptional<TArray<Gs2::Version::Model::FAcceptVersionPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAcceptVersionsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAcceptVersionsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAcceptVersionsByUserIdIterator> Iterable)
            {
