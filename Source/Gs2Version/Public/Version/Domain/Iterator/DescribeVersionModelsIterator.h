...
namespace Gs2::Version::Domain::Iterator
{
    ...
    class GS2VERSION_API FDescribeVersionModelsIterator :
        public TSharedFromThis<FDescribeVersionModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Version::Model::FVersionModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeVersionModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Version::Model::FVersionModelPtr>> Range;
            TOptional<TArray<Gs2::Version::Model::FVersionModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeVersionModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeVersionModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeVersionModelsIterator> Iterable)
            {
