...
#include "Inbox/Result/DescribeMessagesByUserIdResult.h"
...
namespace Gs2::Inbox::Result
{
    ...
    TSharedPtr<FDescribeMessagesByUserIdResult> FDescribeMessagesByUserIdResult::WithNextPageToken(
    ...
    TOptional<FString> FDescribeMessagesByUserIdResult::GetNextPageToken() const
    {
