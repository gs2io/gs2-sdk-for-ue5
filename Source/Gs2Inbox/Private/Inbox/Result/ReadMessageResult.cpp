...
#include "Inbox/Result/ReadMessageResult.h"

namespace Gs2::Inbox::Result
{
    FReadMessageResult::FReadMessageResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithItem(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithTransactionId(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithStampSheet(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithAtomicCommit(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithTransaction(
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FMessage> FReadMessageResult::GetItem() const
    {
    ...
    TOptional<FString> FReadMessageResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FReadMessageResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FReadMessageResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FReadMessageResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FReadMessageResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FReadMessageResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReadMessageResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReadMessageResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReadMessageResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FReadMessageResult> FReadMessageResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FReadMessageResult>()
    ...
    TSharedPtr<FJsonObject> FReadMessageResult::ToJson() const
    {
