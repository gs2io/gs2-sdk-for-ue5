...
namespace Gs2::Inbox::Result
{
    ...
    TSharedPtr<FReadMessageByUserIdResult> FReadMessageByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FReadMessageByUserIdResult> FReadMessageByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FReadMessageByUserIdResult> FReadMessageByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FReadMessageByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReadMessageByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReadMessageByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReadMessageByUserIdResult::GetTransactionResult() const
    {
