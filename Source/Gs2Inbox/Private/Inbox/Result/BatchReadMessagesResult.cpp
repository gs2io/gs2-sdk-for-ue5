...
{
    FBatchReadMessagesResult::FBatchReadMessagesResult():
        ItemsValue(nullptr),
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithItems(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithTransactionId(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithStampSheet(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithAtomicCommit(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithTransaction(
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::WithTransactionResult(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FMessage>>> FBatchReadMessagesResult::GetItems() const
    {
    ...
    TOptional<FString> FBatchReadMessagesResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FBatchReadMessagesResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FBatchReadMessagesResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FBatchReadMessagesResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FBatchReadMessagesResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FBatchReadMessagesResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FBatchReadMessagesResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FBatchReadMessagesResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FBatchReadMessagesResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FBatchReadMessagesResult> FBatchReadMessagesResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FBatchReadMessagesResult>()
    ...
    TSharedPtr<FJsonObject> FBatchReadMessagesResult::ToJson() const
    {
