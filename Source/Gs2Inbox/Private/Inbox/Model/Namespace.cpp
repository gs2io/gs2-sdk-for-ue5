...
namespace Gs2::Inbox::Model
{
    ...
    TSharedPtr<FNamespace> FNamespace::WithIsAutomaticDeletingEnabled(
    ...
    TSharedPtr<FNamespace> FNamespace::WithReceiveMessageScript(
        const TSharedPtr<FScriptSetting> ReceiveMessageScript
    )
    {
    ...
    TSharedPtr<FNamespace> FNamespace::WithReadMessageScript(
        const TSharedPtr<FScriptSetting> ReadMessageScript
    )
    {
    ...
    TSharedPtr<FNamespace> FNamespace::WithDeleteMessageScript(
        const TSharedPtr<FScriptSetting> DeleteMessageScript
    )
    {
    ...
    TSharedPtr<FNamespace> FNamespace::WithReceiveNotification(
        const TSharedPtr<FNotificationSetting> ReceiveNotification
    )
    {
    ...
    TOptional<bool> FNamespace::GetIsAutomaticDeletingEnabled() const
    {
        return IsAutomaticDeletingEnabledValue;
    }

    FString FNamespace::GetIsAutomaticDeletingEnabledString() const
    {
    ...
    TSharedPtr<FScriptSetting> FNamespace::GetReceiveMessageScript() const
    {
        return ReceiveMessageScriptValue;
    }
    TSharedPtr<FScriptSetting> FNamespace::GetReadMessageScript() const
    {
        return ReadMessageScriptValue;
    }
    TSharedPtr<FScriptSetting> FNamespace::GetDeleteMessageScript() const
    {
        return DeleteMessageScriptValue;
    }
    TSharedPtr<FNotificationSetting> FNamespace::GetReceiveNotification() const
    {
    ...
    TSharedPtr<FJsonObject> FNamespace::ToJson() const
    {
        ...
        if (IsAutomaticDeletingEnabledValue.IsSet())
        {
            JsonRootObject->SetBoolField(TEXT("isAutomaticDeletingEnabled"), IsAutomaticDeletingEnabledValue.GetValue());
        }
        ...
        {
            JsonRootObject->SetObjectField(TEXT("receiveMessageScript"), ReceiveMessageScriptValue->ToJson());
        }
        if (ReadMessageScriptValue != nullptr && ReadMessageScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("readMessageScript"), ReadMessageScriptValue->ToJson());
        }
        if (DeleteMessageScriptValue != nullptr && DeleteMessageScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("deleteMessageScript"), DeleteMessageScriptValue->ToJson());
        }
        if (ReceiveNotificationValue != nullptr && ReceiveNotificationValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("receiveNotification"), ReceiveNotificationValue->ToJson());
        }
...
namespace Gs2::Inbox::Model::Cache
{
    ...
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Inbox::Model::FNamespacePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Inbox::Model::FNamespace>(
    ...
    )
    {
        ...
        Gs2::Inbox::Model::FNamespacePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Inbox::Model::FNamespace>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Inbox::Model::FNamespace::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Inbox::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentNamespaceName
        ));
    ...
    )
    {
        ...
        Gs2::Inbox::Model::FNamespacePtr CacheOwnerFetchedItem;
    ...
    )
    {
        ...
        return CacheSnapshot->ListSubscribeTyped(Gs2::Inbox::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Inbox::Model::FNamespacePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Inbox::Model::FNamespace>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Inbox::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
