...
#include "Inbox/Task/Rest/DeleteGlobalMessageMasterTask.h"
...
{
    FDeleteGlobalMessageMasterTask::FDeleteGlobalMessageMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteGlobalMessageMasterTask::Action(
        const TSharedPtr<Result::FDeleteGlobalMessageMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteGlobalMessageMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
