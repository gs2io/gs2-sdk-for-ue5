...
#include "Inbox/Task/Rest/GetGlobalMessageTask.h"
...
{
    FGetGlobalMessageTask::FGetGlobalMessageTask(
    ...
    Core::Model::FGs2ErrorPtr FGetGlobalMessageTask::Action(
        const TSharedPtr<Result::FGetGlobalMessageResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/globalMessage/{globalMessageName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetGlobalMessageResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
