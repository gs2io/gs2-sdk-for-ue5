...
#include "Inbox/Task/Rest/UpdateReceivedByUserIdTask.h"
...
{
    FUpdateReceivedByUserIdTask::FUpdateReceivedByUserIdTask(
    ...
    FUpdateReceivedByUserIdTask::FUpdateReceivedByUserIdTask(
        const FUpdateReceivedByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateReceivedByUserIdTask::Action(
        const TSharedPtr<Result::FUpdateReceivedByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/received");
            ...
            if (this->Request->GetReceivedGlobalMessageNames() != nullptr && this->Request->GetReceivedGlobalMessageNames().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetReceivedGlobalMessageNames())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateReceivedByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
