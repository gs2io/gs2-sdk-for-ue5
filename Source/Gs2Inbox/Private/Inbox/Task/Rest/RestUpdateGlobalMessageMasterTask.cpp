...
#include "Inbox/Task/Rest/UpdateGlobalMessageMasterTask.h"
...
{
    FUpdateGlobalMessageMasterTask::FUpdateGlobalMessageMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateGlobalMessageMasterTask::Action(
        const TSharedPtr<Result::FUpdateGlobalMessageMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/globalMessage/{globalMessageName}");
            ...
            Url = Url.Replace(
                ...
                !this->Request->GetGlobalMessageName().IsSet() || this->Request->GetGlobalMessageName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetGlobalMessageName())
            );
            ...
            if (this->Request->GetReadAcquireActions() != nullptr && this->Request->GetReadAcquireActions().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetReadAcquireActions())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateGlobalMessageMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
