...
#include "Inbox/Task/Rest/GetGlobalMessageMasterTask.h"
...
{
    FGetGlobalMessageMasterTask::FGetGlobalMessageMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetGlobalMessageMasterTask::Action(
        const TSharedPtr<Result::FGetGlobalMessageMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetGlobalMessageMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
