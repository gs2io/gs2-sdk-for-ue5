...
#include "Inbox/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Inbox::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inbox"), TEXT("currentMessageMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
