...
#include "Inbox/Task/WebSocket/GetMessageByUserIdTask.h"
...
namespace Gs2::Inbox::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inbox"), TEXT("message"), TEXT("getMessageByUserId"), ToCStr(RequestPayload->Payload()));
