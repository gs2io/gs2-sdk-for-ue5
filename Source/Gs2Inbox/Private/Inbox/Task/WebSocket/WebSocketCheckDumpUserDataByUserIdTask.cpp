...
#include "Inbox/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Inbox::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inbox"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
