...
namespace Gs2::Inbox::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Cache->Delete(Gs2::Inbox::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::Inbox::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::Inbox::Model::FNamespace>(
                ParentKey,
                Gs2::Inbox::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
