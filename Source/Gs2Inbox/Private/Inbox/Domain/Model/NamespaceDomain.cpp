...
namespace Gs2::Inbox::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Gs2->Cache->Delete(Gs2::Inbox::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Inbox::Domain::Model::FNamespaceDomain::CreateCacheParentKey(
                NamespaceName,
                "GlobalMessage"
            ),
            Callback
    ...
    )
    {
        ...
        TSharedPtr<Gs2::Inbox::Model::FNamespace> Value;
        auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::Inbox::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Gs2->Cache->TryGet<Gs2::Inbox::Model::FNamespace>(
                ParentKey,
                Gs2::Inbox::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
