...
namespace Gs2::Inbox::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FOpenMessageByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FOpenMessageByUserIdRequest::FromJson(RequestModelJson);
            Request = FOpenMessageByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FOpenMessageByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
