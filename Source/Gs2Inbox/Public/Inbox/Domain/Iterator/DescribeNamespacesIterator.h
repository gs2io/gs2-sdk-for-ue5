...
namespace Gs2::Inbox::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inbox::Model::FNamespace>> Result) override;
        ...
        class GS2INBOX_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Inbox::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Inbox::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
