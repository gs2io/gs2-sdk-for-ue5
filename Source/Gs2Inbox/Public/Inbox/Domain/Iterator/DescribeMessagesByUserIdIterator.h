...
namespace Gs2::Inbox::Domain::Iterator
{
    ...
    class GS2INBOX_API FDescribeMessagesByUserIdIterator :
        public TSharedFromThis<FDescribeMessagesByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inbox::Model::FMessage>> Result) override;
        ...
        {
            TSharedRef<FDescribeMessagesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Inbox::Model::FMessagePtr>> Range;
            TOptional<TArray<Gs2::Inbox::Model::FMessagePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMessagesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMessagesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMessagesByUserIdIterator> Iterable)
            {
