...
namespace Gs2::Inbox::Domain::Iterator
{
    ...
    class GS2INBOX_API FDescribeGlobalMessageMastersIterator :
        public TSharedFromThis<FDescribeGlobalMessageMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inbox::Model::FGlobalMessageMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeGlobalMessageMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Inbox::Model::FGlobalMessageMasterPtr>> Range;
            TOptional<TArray<Gs2::Inbox::Model::FGlobalMessageMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalMessageMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalMessageMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalMessageMastersIterator> Iterable)
            {
