...
{
    class GS2INBOX_API FBatchReadMessagesByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FBatchReadMessagesByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Inbox::Domain::FGs2InboxDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Inbox::Request::FBatchReadMessagesByUserIdRequestPtr& Request
