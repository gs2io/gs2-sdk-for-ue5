...
namespace Gs2::Inbox::Domain::SpeculativeExecutor
{
    ...
    class GS2INBOX_API FSendMessageByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        class GS2INBOX_API FCommitTask final :
        ...
        static Gs2::Inbox::Request::FSendMessageByUserIdRequestPtr Rate(
            const Gs2::Inbox::Request::FSendMessageByUserIdRequestPtr& Request,
            const double Rate
        );
