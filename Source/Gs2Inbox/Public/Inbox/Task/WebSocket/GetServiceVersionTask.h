...
#include "Inbox/Request/GetServiceVersionRequest.h"
#include "Inbox/Result/GetServiceVersionResult.h"

namespace Gs2::Inbox::Task::WebSocket
{
    class GS2INBOX_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
