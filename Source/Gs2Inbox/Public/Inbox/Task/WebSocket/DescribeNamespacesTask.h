...
#include "Inbox/Request/DescribeNamespacesRequest.h"
#include "Inbox/Result/DescribeNamespacesResult.h"

namespace Gs2::Inbox::Task::WebSocket
{
    class GS2INBOX_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
