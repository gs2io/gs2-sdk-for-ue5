...
#include "Inbox/Request/DumpUserDataByUserIdRequest.h"
#include "Inbox/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::WebSocket
{
    class GS2INBOX_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
