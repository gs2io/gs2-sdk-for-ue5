...
#include "Inbox/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Inbox/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::WebSocket
{
    class GS2INBOX_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
