...
#include "Inbox/Result/CreateNamespaceResult.h"

namespace Gs2::Inbox::Task::WebSocket
{
    class GS2INBOX_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
