...
#include "Inbox/Request/CheckImportUserDataByUserIdRequest.h"
#include "Inbox/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
