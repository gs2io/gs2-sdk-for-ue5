...
#include "Inbox/Result/GetMessageByUserIdResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FGetMessageByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FGetMessageByUserIdResult>
    {
