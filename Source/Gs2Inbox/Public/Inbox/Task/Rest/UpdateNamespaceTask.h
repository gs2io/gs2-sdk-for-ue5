...
#include "Inbox/Result/UpdateNamespaceResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
