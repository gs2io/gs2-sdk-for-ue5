...
#include "Inbox/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Inbox/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
