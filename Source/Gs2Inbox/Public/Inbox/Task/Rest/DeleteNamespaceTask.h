...
#include "Inbox/Request/DeleteNamespaceRequest.h"
#include "Inbox/Result/DeleteNamespaceResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
