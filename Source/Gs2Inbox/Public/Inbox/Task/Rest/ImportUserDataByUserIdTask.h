...
#include "Inbox/Request/ImportUserDataByUserIdRequest.h"
#include "Inbox/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
