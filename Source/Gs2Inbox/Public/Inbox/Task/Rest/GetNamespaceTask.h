...
#include "Inbox/Request/GetNamespaceRequest.h"
#include "Inbox/Result/GetNamespaceResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
