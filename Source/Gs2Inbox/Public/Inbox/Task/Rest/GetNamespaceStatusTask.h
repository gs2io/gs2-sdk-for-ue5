...
#include "Inbox/Request/GetNamespaceStatusRequest.h"
#include "Inbox/Result/GetNamespaceStatusResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
