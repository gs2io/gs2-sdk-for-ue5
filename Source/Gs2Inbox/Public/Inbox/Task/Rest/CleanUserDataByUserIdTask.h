...
#include "Inbox/Request/CleanUserDataByUserIdRequest.h"
#include "Inbox/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Inbox::Task::Rest
{
    class GS2INBOX_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
