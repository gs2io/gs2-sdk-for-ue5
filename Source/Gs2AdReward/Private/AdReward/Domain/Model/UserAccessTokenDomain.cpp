...
namespace Gs2::AdReward::Domain::Model
{
    ...
    FUserAccessTokenDomain::FUserAccessTokenDomain(
        ...
        ParentKey(Gs2::AdReward::Domain::Model::FNamespaceDomain::CreateCacheParentKey(
            NamespaceName,
            "User"
        ))
    {
    ...
    TSharedPtr<Gs2::AdReward::Domain::Model::FPointAccessTokenDomain> FUserAccessTokenDomain::Point(
    )
    {
        return MakeShared<Gs2::AdReward::Domain::Model::FPointAccessTokenDomain>(
            Gs2,
            Service,
            NamespaceName,
            AccessToken
