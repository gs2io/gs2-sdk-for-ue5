...
namespace Gs2::AdReward::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FAcquirePointByUserIdSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FAcquirePointByUserIdRequest::FromJson(RequestModelJson);
            Request = FAcquirePointByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FAcquirePointByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
