...
namespace Gs2::AdReward::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FConsumePointByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FConsumePointByUserIdRequest::FromJson(RequestModelJson);
            Request = FConsumePointByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FConsumePointByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
