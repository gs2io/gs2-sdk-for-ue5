...
namespace Gs2::AdReward::Request
{
    ...
    TSharedPtr<FAcquirePointByUserIdRequest> FAcquirePointByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FAcquirePointByUserIdRequest::GetTimeOffsetToken() const
    {
