...
#include "AdReward/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::AdReward::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("adReward"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
