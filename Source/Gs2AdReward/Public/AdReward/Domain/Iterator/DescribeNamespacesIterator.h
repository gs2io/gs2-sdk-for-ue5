...
namespace Gs2::AdReward::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::AdReward::Model::FNamespace>> Result) override;
        ...
        class GS2ADREWARD_API FIterator
        {
            TSharedRef<FDescribeNamespacesIterator> Self;
            TSharedPtr<TArray<Gs2::AdReward::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::AdReward::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::AdReward::Model::FNamespacePtr& Current()
            {
