...
namespace Gs2::AdReward::Domain::SpeculativeExecutor
{
    ...
    class GS2ADREWARD_API FAcquirePointByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2ADREWARD_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::AdReward::Domain::FGs2AdRewardDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::AdReward::Request::FAcquirePointByUserIdRequestPtr& Request
            ...
            GS2ADREWARD_API FCommitTask(
                const FCommitTask& From
            );

            GS2ADREWARD_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::AdReward::Request::FAcquirePointByUserIdRequestPtr Rate(
            const Gs2::AdReward::Request::FAcquirePointByUserIdRequestPtr& Request,
            const double Rate
        );
