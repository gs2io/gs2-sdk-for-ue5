...
#include "AdReward/Request/CheckDumpUserDataByUserIdRequest.h"
#include "AdReward/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
