...
#include "AdReward/Result/CreateNamespaceResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
