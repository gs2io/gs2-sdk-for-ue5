...
#include "AdReward/Request/ImportUserDataByUserIdRequest.h"
#include "AdReward/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
