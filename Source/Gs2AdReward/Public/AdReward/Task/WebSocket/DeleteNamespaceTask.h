...
#include "AdReward/Request/DeleteNamespaceRequest.h"
#include "AdReward/Result/DeleteNamespaceResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
