...
#include "AdReward/Request/CheckCleanUserDataByUserIdRequest.h"
#include "AdReward/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
