...
#include "AdReward/Request/GetServiceVersionRequest.h"
#include "AdReward/Result/GetServiceVersionResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
