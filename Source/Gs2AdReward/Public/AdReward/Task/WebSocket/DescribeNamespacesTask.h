...
#include "AdReward/Result/DescribeNamespacesResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
