...
#include "AdReward/Request/GetNamespaceStatusRequest.h"
#include "AdReward/Result/GetNamespaceStatusResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
