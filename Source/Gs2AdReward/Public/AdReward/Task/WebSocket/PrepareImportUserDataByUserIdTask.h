...
#include "AdReward/Request/PrepareImportUserDataByUserIdRequest.h"
#include "AdReward/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
