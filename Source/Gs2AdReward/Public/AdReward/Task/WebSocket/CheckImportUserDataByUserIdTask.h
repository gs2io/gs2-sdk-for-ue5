...
#include "AdReward/Request/CheckImportUserDataByUserIdRequest.h"
#include "AdReward/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
