...
#include "AdReward/Result/UpdateNamespaceResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
