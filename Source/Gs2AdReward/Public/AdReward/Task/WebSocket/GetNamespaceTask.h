...
#include "AdReward/Request/GetNamespaceRequest.h"
#include "AdReward/Result/GetNamespaceResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
