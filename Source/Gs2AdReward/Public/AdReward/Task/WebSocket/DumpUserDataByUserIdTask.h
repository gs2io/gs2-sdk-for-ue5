...
#include "AdReward/Request/DumpUserDataByUserIdRequest.h"
#include "AdReward/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::AdReward::Task::WebSocket
{
    class GS2ADREWARD_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
