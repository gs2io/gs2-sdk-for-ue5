...
#include "Stamina/Request/VerifyStaminaValueRequest.h"

namespace Gs2::Stamina::Request
{
    FVerifyStaminaValueRequest::FVerifyStaminaValueRequest():
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithContextStack(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithNamespaceName(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithAccessToken(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithStaminaName(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithVerifyType(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithValue(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithMultiplyValueSpecifyingQuantity(
    ...
    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::WithDuplicationAvoider(
    ...
    TOptional<FString> FVerifyStaminaValueRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FVerifyStaminaValueRequest::GetNamespaceName() const
    {
        return NamespaceNameValue;
    }

    TOptional<FString> FVerifyStaminaValueRequest::GetAccessToken() const
    {
        return AccessTokenValue;
    }

    TOptional<FString> FVerifyStaminaValueRequest::GetStaminaName() const
    {
        return StaminaNameValue;
    }

    TOptional<FString> FVerifyStaminaValueRequest::GetVerifyType() const
    {
        return VerifyTypeValue;
    }

    TOptional<int32> FVerifyStaminaValueRequest::GetValue() const
    {
        return ValueValue;
    }

    FString FVerifyStaminaValueRequest::GetValueString() const
    {
        if (!ValueValue.IsSet())
        {
            return FString("null");
    ...
    TOptional<bool> FVerifyStaminaValueRequest::GetMultiplyValueSpecifyingQuantity() const
    {
        return MultiplyValueSpecifyingQuantityValue;
    }

    FString FVerifyStaminaValueRequest::GetMultiplyValueSpecifyingQuantityString() const
    {
    ...
    TOptional<FString> FVerifyStaminaValueRequest::GetDuplicationAvoider() const
    {
        return DuplicationAvoiderValue;
    }

    TSharedPtr<FVerifyStaminaValueRequest> FVerifyStaminaValueRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FVerifyStaminaValueRequest>()
    ...
    TSharedPtr<FJsonObject> FVerifyStaminaValueRequest::ToJson() const
    {
