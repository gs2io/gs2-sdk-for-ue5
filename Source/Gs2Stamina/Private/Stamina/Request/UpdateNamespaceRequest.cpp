...
#include "Stamina/Request/UpdateNamespaceRequest.h"
...
namespace Gs2::Stamina::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithOverflowTriggerScript(
    ...
    TOptional<FString> FUpdateNamespaceRequest::GetOverflowTriggerScript() const
    {
