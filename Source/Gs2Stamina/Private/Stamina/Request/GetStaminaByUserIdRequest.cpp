...
#include "Stamina/Request/GetStaminaByUserIdRequest.h"
...
namespace Gs2::Stamina::Request
{
    ...
    TSharedPtr<FGetStaminaByUserIdRequest> FGetStaminaByUserIdRequest::WithContextStack(
    ...
    TSharedPtr<FGetStaminaByUserIdRequest> FGetStaminaByUserIdRequest::WithNamespaceName(
    ...
    TSharedPtr<FGetStaminaByUserIdRequest> FGetStaminaByUserIdRequest::WithStaminaName(
    ...
    TSharedPtr<FGetStaminaByUserIdRequest> FGetStaminaByUserIdRequest::WithUserId(
    ...
    TOptional<FString> FGetStaminaByUserIdRequest::GetNamespaceName() const
    {
        return NamespaceNameValue;
    }

    TOptional<FString> FGetStaminaByUserIdRequest::GetStaminaName() const
    {
    ...
    TSharedPtr<FGetStaminaByUserIdRequest> FGetStaminaByUserIdRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FGetStaminaByUserIdRequest>()
    ...
    TSharedPtr<FJsonObject> FGetStaminaByUserIdRequest::ToJson() const
    {
