...
namespace
{
    bool StaminaVerifyRecoverValuePredicate(
    ...
    )
    {
        if (!Item.IsValid() || !Item->GetStaminaId().IsSet() || Item->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Item->GetRecoverValue().IsSet()) return false;
        const int32 Current = Item->GetRecoverValue().Get(0);
    ...
    Gs2::Core::Model::FGs2ErrorPtr StaminaVerifyRecoverValueError(const FString& VerifyType)
    {
        FString Reason;
    ...
    )
    {
        ...
        return Satisfied ? nullptr : StaminaVerifyRecoverValueError(VerifyType);
    }
    ...
    )
    {
        *Result = nullptr;
        ...
        Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequestPtr PreparedRequest = nullptr;
        if (Request.IsValid()) PreparedRequest = MakeShared<Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequest>(*Request);
        ...
        if (!Cached->GetStaminaId().IsSet() || Cached->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Cached->GetRecoverValue().IsSet()) return nullptr;
            ...
            ExpectedId, VerifyType, RequestValue]()
        {
            ...
            return StaminaVerifyRecoverValuePredicate(Current, ExpectedId, UserId, StaminaName, VerifyType, RequestValue);
        };
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaRecoverValueByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaRecoverValueByUserIdSpeculativeExecutor::ExecuteInverse(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequestPtr& Request
    )
    {
        ...
        auto Inverse = Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequest::FromJson(Request->ToJson());
