...
namespace
{
    bool StaminaVerifyOverflowValuePredicate(
    ...
    )
    {
        if (!Item.IsValid() || !Item->GetStaminaId().IsSet() || Item->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Item->GetOverflowValue().IsSet()) return false;
        const int32 Current = Item->GetOverflowValue().Get(0);
    ...
    Gs2::Core::Model::FGs2ErrorPtr StaminaVerifyOverflowValueError(const FString& VerifyType)
    {
        FString Reason;
    ...
    FString FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Stamina:VerifyStaminaOverflowValueByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::Transform(
    ...
    )
    {
        ...
        return Satisfied ? nullptr : StaminaVerifyOverflowValueError(VerifyType);
    }

    FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::FCommitTask::Action(
    ...
    )
    {
        *Result = nullptr;
        ...
        Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequestPtr PreparedRequest = nullptr;
        if (Request.IsValid()) PreparedRequest = MakeShared<Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequest>(*Request);
        ...
        if (!Cached->GetStaminaId().IsSet() || Cached->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Cached->GetOverflowValue().IsSet()) return nullptr;
            ...
            ExpectedId, VerifyType, RequestValue]()
        {
            ...
            return StaminaVerifyOverflowValuePredicate(Current, ExpectedId, UserId, StaminaName, VerifyType, RequestValue);
        };
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequestPtr& Request
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::ExecuteInverse(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequestPtr& Request
    )
    {
        ...
        auto Inverse = Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequest::FromJson(Request->ToJson());
    ...
    Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequestPtr FVerifyStaminaOverflowValueByUserIdSpeculativeExecutor::Rate(
        const Gs2::Stamina::Request::FVerifyStaminaOverflowValueByUserIdRequestPtr& Request,
        const double Rate
    )
    {
