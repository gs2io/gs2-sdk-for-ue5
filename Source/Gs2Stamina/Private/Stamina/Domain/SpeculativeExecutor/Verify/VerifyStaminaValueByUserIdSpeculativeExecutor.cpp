...
namespace
{
    bool StaminaVerifyValuePredicate(
    ...
    )
    {
        if (!Item.IsValid() || !Item->GetStaminaId().IsSet() || Item->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Item->GetValue().IsSet()) return false;
        const int32 Current = Item->GetValue().Get(0);
    ...
    Gs2::Core::Model::FGs2ErrorPtr StaminaVerifyValueError(const FString& VerifyType)
    {
        FString Reason;
    ...
    FString FVerifyStaminaValueByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Stamina:VerifyStaminaValueByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaValueByUserIdSpeculativeExecutor::Transform(
        const Gs2::Core::Domain::FGs2Ptr&,
        const Gs2::Auth::Model::FAccessTokenPtr&,
        const Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr& Request,
    ...
    )
    {
        ...
        return StaminaVerifyValueError(VerifyType);
    }

    FVerifyStaminaValueByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaValueByUserIdSpeculativeExecutor::FCommitTask::Action(
    ...
    )
    {
        *Result = nullptr;
        ...
        Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr PreparedRequest = nullptr;
        if (Request.IsValid()) PreparedRequest = MakeShared<Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequest>(*Request);
        ...
        if (!Cached->GetStaminaId().IsSet() || Cached->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Cached->GetValue().IsSet()) return nullptr;
            ...
            ExpectedId, VerifyType, RequestValue]()
        {
            ...
            return StaminaVerifyValuePredicate(Current, ExpectedId, UserId, StaminaName, VerifyType, RequestValue);
        };
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaValueByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaValueByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr& Request
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaValueByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaValueByUserIdSpeculativeExecutor::ExecuteInverse(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr& Request
    )
    {
        ...
        auto Inverse = Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequest::FromJson(Request->ToJson());
    ...
    Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr FVerifyStaminaValueByUserIdSpeculativeExecutor::Rate(
        const Gs2::Stamina::Request::FVerifyStaminaValueByUserIdRequestPtr& Request,
        const double Rate
    )
    {
