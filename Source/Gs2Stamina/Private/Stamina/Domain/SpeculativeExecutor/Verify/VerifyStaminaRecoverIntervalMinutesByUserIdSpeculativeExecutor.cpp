...
namespace
{
    bool StaminaVerifyRecoverIntervalMinutesPredicate(
    ...
    )
    {
        if (!Item.IsValid() || !Item->GetStaminaId().IsSet() || Item->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Item->GetRecoverIntervalMinutes().IsSet()) return false;
        const int32 Current = Item->GetRecoverIntervalMinutes().Get(0);
    ...
    Gs2::Core::Model::FGs2ErrorPtr StaminaVerifyRecoverIntervalMinutesError(const FString& VerifyType)
    {
        FString Reason;
    ...
    FString FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Stamina:VerifyStaminaRecoverIntervalMinutesByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::Transform(
    ...
    )
    {
        ...
        return Satisfied ? nullptr : StaminaVerifyRecoverIntervalMinutesError(VerifyType);
    }

    FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::FCommitTask::Action(
    ...
    )
    {
        *Result = nullptr;
        ...
        Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequestPtr PreparedRequest = nullptr;
        if (Request.IsValid()) PreparedRequest = MakeShared<Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequest>(*Request);
        ...
        if (!Cached->GetStaminaId().IsSet() || Cached->GetStaminaId().Get(FString()) != ExpectedId ||
            ...
            !Cached->GetRecoverIntervalMinutes().IsSet()) return nullptr;
            ...
            ExpectedId, VerifyType, RequestValue]()
        {
            ...
            return StaminaVerifyRecoverIntervalMinutesPredicate(Current, ExpectedId, UserId, StaminaName, VerifyType, RequestValue);
        };
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequestPtr& Request
    ...
    TSharedPtr<FAsyncTask<FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::FCommitTask>> FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::ExecuteInverse(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequestPtr& Request
    )
    {
        ...
        auto Inverse = Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequest::FromJson(Request->ToJson());
    ...
    Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequestPtr FVerifyStaminaRecoverIntervalMinutesByUserIdSpeculativeExecutor::Rate(
        const Gs2::Stamina::Request::FVerifyStaminaRecoverIntervalMinutesByUserIdRequestPtr& Request,
        const double Rate
    )
    {
