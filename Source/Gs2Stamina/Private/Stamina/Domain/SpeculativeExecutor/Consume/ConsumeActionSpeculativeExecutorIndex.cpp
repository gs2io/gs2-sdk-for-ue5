...
namespace Gs2::Stamina::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FDecreaseMaxValueByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FDecreaseMaxValueByUserIdRequest::FromJson(RequestModelJson);
            Request = FDecreaseMaxValueByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FDecreaseMaxValueByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
        ...
        if (FConsumeStaminaByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            TSharedPtr<FJsonObject> RequestModelJson;
            if (const TSharedRef<TJsonReader<>> JsonReader = TJsonReaderFactory<>::Create(NewConsumeAction->GetRequest().IsSet() ? *NewConsumeAction->GetRequest() : "{}");
                !FJsonSerializer::Deserialize(JsonReader, RequestModelJson))
            {
            ...
            auto Request = Request::FConsumeStaminaByUserIdRequest::FromJson(RequestModelJson);
            Request = FConsumeStaminaByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FConsumeStaminaByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
