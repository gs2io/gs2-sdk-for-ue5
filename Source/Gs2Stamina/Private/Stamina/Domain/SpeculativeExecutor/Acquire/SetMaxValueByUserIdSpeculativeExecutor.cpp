...
namespace Gs2::Stamina::Domain::SpeculativeExecutor
{
    ...
    FString FSetMaxValueByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Stamina:SetMaxValueByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FSetMaxValueByUserIdSpeculativeExecutor::Transform(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FSetMaxValueByUserIdRequestPtr& Request,
    ...
    FSetMaxValueByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSetMaxValueByUserIdSpeculativeExecutor::FCommitTask::Action(
    ...
    )
    {
        *Result = nullptr;
        ...
        const auto Prepared = MakeShared<Gs2::Stamina::Request::FSetMaxValueByUserIdRequest>(*Request);
        ...
        if (!Prepared->GetUserId().IsSet() || Prepared->GetUserId().Get(FString()) != Token->GetUserId().Get(FString()) ||
            !Prepared->GetMaxValue().IsSet()) return nullptr;
        ...
        const int64 MaxValue = Prepared->GetMaxValue().Get(0);
        *Result = FStaminaMutationSpeculativeCommit::Create(
            ...
            [MaxValue](const Gs2::Stamina::Model::FStaminaPtr& Current, const TOptional<int32>& MaxCapacity)
            {
                Current->WithMaxValue(FStaminaMutationSpeculativeCommit::Clamp(MaxValue, MaxCapacity));
                return true;
            }
        );
        return nullptr;
    ...
    TSharedPtr<FAsyncTask<FSetMaxValueByUserIdSpeculativeExecutor::FCommitTask>> FSetMaxValueByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Stamina::Domain::FGs2StaminaDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Stamina::Request::FSetMaxValueByUserIdRequestPtr& Request
    ...
    Gs2::Stamina::Request::FSetMaxValueByUserIdRequestPtr FSetMaxValueByUserIdSpeculativeExecutor::Rate(
        const Gs2::Stamina::Request::FSetMaxValueByUserIdRequestPtr& Request,
        const double Rate
    )
    {
