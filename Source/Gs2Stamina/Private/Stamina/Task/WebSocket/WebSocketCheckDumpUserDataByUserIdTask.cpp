...
#include "Stamina/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Stamina::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stamina"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
