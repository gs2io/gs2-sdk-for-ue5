...
#include "Stamina/Task/WebSocket/UpdateStaminaModelMasterTask.h"
...
namespace Gs2::Stamina::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stamina"), TEXT("staminaModelMaster"), TEXT("updateStaminaModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateStaminaModelMasterResult::FromJson(WebSocketResult->Body());
