...
#include "Stamina/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Stamina::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stamina"), TEXT("currentStaminaMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
