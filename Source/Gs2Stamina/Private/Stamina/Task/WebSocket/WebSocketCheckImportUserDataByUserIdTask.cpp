...
#include "Stamina/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::Stamina::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stamina"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
