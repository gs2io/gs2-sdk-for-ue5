...
#include "Stamina/Task/Rest/RaiseMaxValueByUserIdTask.h"
...
{
    FRaiseMaxValueByUserIdTask::FRaiseMaxValueByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FRaiseMaxValueByUserIdTask::Action(
        const TSharedPtr<Result::FRaiseMaxValueByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/stamina/{staminaName}/raise");
            ...
            if (this->Request->GetRaiseValue().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("raiseValue"), this->Request->GetRaiseValue().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRaiseMaxValueByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
