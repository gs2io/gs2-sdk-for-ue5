...
#include "Stamina/Task/Rest/DeleteRecoverValueTableMasterTask.h"
...
{
    FDeleteRecoverValueTableMasterTask::FDeleteRecoverValueTableMasterTask(
    ...
    FDeleteRecoverValueTableMasterTask::FDeleteRecoverValueTableMasterTask(
        const FDeleteRecoverValueTableMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteRecoverValueTableMasterTask::Action(
        const TSharedPtr<Result::FDeleteRecoverValueTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRecoverValueTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
