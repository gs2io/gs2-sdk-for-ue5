...
#include "Stamina/Task/Rest/UpdateMaxStaminaTableMasterTask.h"
...
{
    FUpdateMaxStaminaTableMasterTask::FUpdateMaxStaminaTableMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateMaxStaminaTableMasterTask::Action(
        const TSharedPtr<Result::FUpdateMaxStaminaTableMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/maxStaminaTable/{maxStaminaTableName}");
            ...
            Url = Url.Replace(
                TEXT("{maxStaminaTableName}"),
                !this->Request->GetMaxStaminaTableName().IsSet() || this->Request->GetMaxStaminaTableName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetMaxStaminaTableName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateMaxStaminaTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
