...
#include "Stamina/Task/Rest/SetMaxValueByUserIdTask.h"
...
{
    FSetMaxValueByUserIdTask::FSetMaxValueByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FSetMaxValueByUserIdTask::Action(
        const TSharedPtr<Result::FSetMaxValueByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/stamina/{staminaName}/set");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetMaxValueByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
