...
#include "Stamina/Task/Rest/UpdateNamespaceTask.h"
...
namespace Gs2::Stamina::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetStringField(TEXT("overflowTriggerScript"), this->Request->GetOverflowTriggerScript().GetValue());
            }
