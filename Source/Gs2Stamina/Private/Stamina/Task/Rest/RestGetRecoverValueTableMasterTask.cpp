...
#include "Stamina/Task/Rest/GetRecoverValueTableMasterTask.h"
...
{
    FGetRecoverValueTableMasterTask::FGetRecoverValueTableMasterTask(
    ...
    FGetRecoverValueTableMasterTask::FGetRecoverValueTableMasterTask(
        const FGetRecoverValueTableMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetRecoverValueTableMasterTask::Action(
        const TSharedPtr<Result::FGetRecoverValueTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRecoverValueTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
