...
#include "Stamina/Task/Rest/DecreaseMaxValueByUserIdTask.h"
...
{
    FDecreaseMaxValueByUserIdTask::FDecreaseMaxValueByUserIdTask(
    ...
    FDecreaseMaxValueByUserIdTask::FDecreaseMaxValueByUserIdTask(
        const FDecreaseMaxValueByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDecreaseMaxValueByUserIdTask::Action(
        const TSharedPtr<Result::FDecreaseMaxValueByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/stamina/{staminaName}/decrease");
            ...
            if (this->Request->GetDecreaseValue().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("decreaseValue"), this->Request->GetDecreaseValue().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDecreaseMaxValueByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
