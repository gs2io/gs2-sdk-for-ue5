...
#include "Stamina/Task/Rest/GetMaxStaminaTableMasterTask.h"
...
{
    FGetMaxStaminaTableMasterTask::FGetMaxStaminaTableMasterTask(
    ...
    FGetMaxStaminaTableMasterTask::FGetMaxStaminaTableMasterTask(
        const FGetMaxStaminaTableMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetMaxStaminaTableMasterTask::Action(
        const TSharedPtr<Result::FGetMaxStaminaTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetMaxStaminaTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
