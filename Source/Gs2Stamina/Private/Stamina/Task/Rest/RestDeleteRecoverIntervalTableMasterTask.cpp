...
#include "Stamina/Task/Rest/DeleteRecoverIntervalTableMasterTask.h"
...
{
    FDeleteRecoverIntervalTableMasterTask::FDeleteRecoverIntervalTableMasterTask(
    ...
    FDeleteRecoverIntervalTableMasterTask::FDeleteRecoverIntervalTableMasterTask(
        const FDeleteRecoverIntervalTableMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteRecoverIntervalTableMasterTask::Action(
        const TSharedPtr<Result::FDeleteRecoverIntervalTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRecoverIntervalTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
