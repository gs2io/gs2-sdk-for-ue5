...
#include "Stamina/Task/Rest/GetRecoverIntervalTableMasterTask.h"
...
{
    FGetRecoverIntervalTableMasterTask::FGetRecoverIntervalTableMasterTask(
    ...
    FGetRecoverIntervalTableMasterTask::FGetRecoverIntervalTableMasterTask(
        const FGetRecoverIntervalTableMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetRecoverIntervalTableMasterTask::Action(
        const TSharedPtr<Result::FGetRecoverIntervalTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRecoverIntervalTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
