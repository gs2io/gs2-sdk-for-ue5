...
#include "Stamina/Task/Rest/DeleteMaxStaminaTableMasterTask.h"
...
{
    FDeleteMaxStaminaTableMasterTask::FDeleteMaxStaminaTableMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteMaxStaminaTableMasterTask::Action(
        const TSharedPtr<Result::FDeleteMaxStaminaTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteMaxStaminaTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
