...
{
    FConsumeStaminaByUserIdResult::FConsumeStaminaByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FConsumeStaminaByUserIdResult> FConsumeStaminaByUserIdResult::WithItem(
    ...
    TSharedPtr<FConsumeStaminaByUserIdResult> FConsumeStaminaByUserIdResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FConsumeStaminaByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStaminaModel> FConsumeStaminaByUserIdResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FConsumeStaminaByUserIdResult> FConsumeStaminaByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FConsumeStaminaByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FConsumeStaminaByUserIdResult::ToJson() const
    {
