...
#include "Stamina/Result/PreUpdateCurrentStaminaMasterResult.h"

namespace Gs2::Stamina::Result
{
    FPreUpdateCurrentStaminaMasterResult::FPreUpdateCurrentStaminaMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentStaminaMasterResult> FPreUpdateCurrentStaminaMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentStaminaMasterResult> FPreUpdateCurrentStaminaMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentStaminaMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentStaminaMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentStaminaMasterResult> FPreUpdateCurrentStaminaMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentStaminaMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentStaminaMasterResult::ToJson() const
    {
