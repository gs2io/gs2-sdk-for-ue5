...
#include "Stamina/Result/DecreaseMaxValueResult.h"

namespace Gs2::Stamina::Result
{
    FDecreaseMaxValueResult::FDecreaseMaxValueResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FDecreaseMaxValueResult> FDecreaseMaxValueResult::WithItem(
    ...
    TSharedPtr<FDecreaseMaxValueResult> FDecreaseMaxValueResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FDecreaseMaxValueResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStaminaModel> FDecreaseMaxValueResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FDecreaseMaxValueResult> FDecreaseMaxValueResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDecreaseMaxValueResult>()
    ...
    TSharedPtr<FJsonObject> FDecreaseMaxValueResult::ToJson() const
    {
