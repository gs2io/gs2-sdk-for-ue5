...
namespace Gs2::Stamina::Result
{
    ...
    TSharedPtr<FVerifyStaminaRecoverIntervalMinutesByStampTaskResult> FVerifyStaminaRecoverIntervalMinutesByStampTaskResult::WithItem(
    ...
    TSharedPtr<Model::FStamina> FVerifyStaminaRecoverIntervalMinutesByStampTaskResult::GetItem() const
    {
