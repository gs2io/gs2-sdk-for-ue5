...
{
    FRaiseMaxValueByUserIdResult::FRaiseMaxValueByUserIdResult():
        ItemValue(nullptr),
    ...
    FRaiseMaxValueByUserIdResult::FRaiseMaxValueByUserIdResult(
        const FRaiseMaxValueByUserIdResult& From
    ):
    ...
    TSharedPtr<FRaiseMaxValueByUserIdResult> FRaiseMaxValueByUserIdResult::WithItem(
    ...
    TSharedPtr<FRaiseMaxValueByUserIdResult> FRaiseMaxValueByUserIdResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FRaiseMaxValueByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStaminaModel> FRaiseMaxValueByUserIdResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FRaiseMaxValueByUserIdResult> FRaiseMaxValueByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FRaiseMaxValueByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FRaiseMaxValueByUserIdResult::ToJson() const
    {
