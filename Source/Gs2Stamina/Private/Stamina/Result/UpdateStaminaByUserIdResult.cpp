...
#include "Stamina/Result/UpdateStaminaByUserIdResult.h"

namespace Gs2::Stamina::Result
{
    FUpdateStaminaByUserIdResult::FUpdateStaminaByUserIdResult():
        ItemValue(nullptr),
    ...
    FUpdateStaminaByUserIdResult::FUpdateStaminaByUserIdResult(
        const FUpdateStaminaByUserIdResult& From
    ):
    ...
    TSharedPtr<FUpdateStaminaByUserIdResult> FUpdateStaminaByUserIdResult::WithItem(
    ...
    TSharedPtr<FUpdateStaminaByUserIdResult> FUpdateStaminaByUserIdResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FUpdateStaminaByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStaminaModel> FUpdateStaminaByUserIdResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FUpdateStaminaByUserIdResult> FUpdateStaminaByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FUpdateStaminaByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FUpdateStaminaByUserIdResult::ToJson() const
    {
