...
namespace Gs2::Stamina::Result
{
    ...
    TSharedPtr<FSetRecoverIntervalByStatusResult> FSetRecoverIntervalByStatusResult::WithOld(
    ...
    TSharedPtr<Model::FStamina> FSetRecoverIntervalByStatusResult::GetOld() const
    {
        if (!OldValue.IsValid())
        {
            return nullptr;
