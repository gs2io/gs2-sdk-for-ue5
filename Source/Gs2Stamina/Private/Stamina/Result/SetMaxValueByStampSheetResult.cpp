...
{
    FSetMaxValueByStampSheetResult::FSetMaxValueByStampSheetResult():
        ItemValue(nullptr),
        OldValue(nullptr),
    ...
    TSharedPtr<FSetMaxValueByStampSheetResult> FSetMaxValueByStampSheetResult::WithItem(
    ...
    TSharedPtr<FSetMaxValueByStampSheetResult> FSetMaxValueByStampSheetResult::WithOld(
    ...
    TSharedPtr<FSetMaxValueByStampSheetResult> FSetMaxValueByStampSheetResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FSetMaxValueByStampSheetResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStamina> FSetMaxValueByStampSheetResult::GetOld() const
    {
        if (!OldValue.IsValid())
        {
            return nullptr;
    ...
    TSharedPtr<Model::FStaminaModel> FSetMaxValueByStampSheetResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FSetMaxValueByStampSheetResult> FSetMaxValueByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSetMaxValueByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FSetMaxValueByStampSheetResult::ToJson() const
    {
