...
#include "Stamina/Result/SetRecoverIntervalByUserIdResult.h"

namespace Gs2::Stamina::Result
{
    FSetRecoverIntervalByUserIdResult::FSetRecoverIntervalByUserIdResult():
        ItemValue(nullptr),
        OldValue(nullptr),
    ...
    FSetRecoverIntervalByUserIdResult::FSetRecoverIntervalByUserIdResult(
        const FSetRecoverIntervalByUserIdResult& From
    ):
    ...
    TSharedPtr<FSetRecoverIntervalByUserIdResult> FSetRecoverIntervalByUserIdResult::WithItem(
    ...
    TSharedPtr<FSetRecoverIntervalByUserIdResult> FSetRecoverIntervalByUserIdResult::WithOld(
    ...
    TSharedPtr<FSetRecoverIntervalByUserIdResult> FSetRecoverIntervalByUserIdResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FSetRecoverIntervalByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStamina> FSetRecoverIntervalByUserIdResult::GetOld() const
    {
        if (!OldValue.IsValid())
        {
            return nullptr;
    ...
    TSharedPtr<Model::FStaminaModel> FSetRecoverIntervalByUserIdResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FSetRecoverIntervalByUserIdResult> FSetRecoverIntervalByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSetRecoverIntervalByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FSetRecoverIntervalByUserIdResult::ToJson() const
    {
