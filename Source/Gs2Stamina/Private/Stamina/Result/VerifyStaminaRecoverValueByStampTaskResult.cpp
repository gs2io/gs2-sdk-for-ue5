...
namespace Gs2::Stamina::Result
{
    ...
    TSharedPtr<FVerifyStaminaRecoverValueByStampTaskResult> FVerifyStaminaRecoverValueByStampTaskResult::WithItem(
    ...
    TSharedPtr<Model::FStamina> FVerifyStaminaRecoverValueByStampTaskResult::GetItem() const
    {
