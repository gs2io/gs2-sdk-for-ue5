...
#include "Stamina/Result/SetRecoverValueByStatusResult.h"

namespace Gs2::Stamina::Result
{
    FSetRecoverValueByStatusResult::FSetRecoverValueByStatusResult():
        ItemValue(nullptr),
        OldValue(nullptr),
    ...
    FSetRecoverValueByStatusResult::FSetRecoverValueByStatusResult(
        const FSetRecoverValueByStatusResult& From
    ):
    ...
    TSharedPtr<FSetRecoverValueByStatusResult> FSetRecoverValueByStatusResult::WithItem(
    ...
    TSharedPtr<FSetRecoverValueByStatusResult> FSetRecoverValueByStatusResult::WithOld(
    ...
    TSharedPtr<FSetRecoverValueByStatusResult> FSetRecoverValueByStatusResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FSetRecoverValueByStatusResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStamina> FSetRecoverValueByStatusResult::GetOld() const
    {
        if (!OldValue.IsValid())
        {
            return nullptr;
    ...
    TSharedPtr<Model::FStaminaModel> FSetRecoverValueByStatusResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FSetRecoverValueByStatusResult> FSetRecoverValueByStatusResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSetRecoverValueByStatusResult>()
    ...
    TSharedPtr<FJsonObject> FSetRecoverValueByStatusResult::ToJson() const
    {
