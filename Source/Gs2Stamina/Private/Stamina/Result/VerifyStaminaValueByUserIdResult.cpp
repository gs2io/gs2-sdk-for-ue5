...
namespace Gs2::Stamina::Result
{
    ...
    TSharedPtr<FVerifyStaminaValueByUserIdResult> FVerifyStaminaValueByUserIdResult::WithItem(
    ...
    TSharedPtr<Model::FStamina> FVerifyStaminaValueByUserIdResult::GetItem() const
    {
