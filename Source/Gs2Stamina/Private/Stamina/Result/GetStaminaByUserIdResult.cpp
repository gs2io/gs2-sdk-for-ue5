...
#include "Stamina/Result/GetStaminaByUserIdResult.h"

namespace Gs2::Stamina::Result
{
    FGetStaminaByUserIdResult::FGetStaminaByUserIdResult():
        ItemValue(nullptr),
    ...
    FGetStaminaByUserIdResult::FGetStaminaByUserIdResult(
        const FGetStaminaByUserIdResult& From
    ):
    ...
    TSharedPtr<FGetStaminaByUserIdResult> FGetStaminaByUserIdResult::WithItem(
    ...
    TSharedPtr<FGetStaminaByUserIdResult> FGetStaminaByUserIdResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FGetStaminaByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStaminaModel> FGetStaminaByUserIdResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FGetStaminaByUserIdResult> FGetStaminaByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
    ...
    TSharedPtr<FJsonObject> FGetStaminaByUserIdResult::ToJson() const
    {
