...
#include "Stamina/Result/SetRecoverIntervalByStampSheetResult.h"

namespace Gs2::Stamina::Result
{
    FSetRecoverIntervalByStampSheetResult::FSetRecoverIntervalByStampSheetResult():
        ItemValue(nullptr),
        OldValue(nullptr),
    ...
    TSharedPtr<FSetRecoverIntervalByStampSheetResult> FSetRecoverIntervalByStampSheetResult::WithItem(
    ...
    TSharedPtr<FSetRecoverIntervalByStampSheetResult> FSetRecoverIntervalByStampSheetResult::WithOld(
    ...
    TSharedPtr<FSetRecoverIntervalByStampSheetResult> FSetRecoverIntervalByStampSheetResult::WithStaminaModel(
    ...
    TSharedPtr<Model::FStamina> FSetRecoverIntervalByStampSheetResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FStamina> FSetRecoverIntervalByStampSheetResult::GetOld() const
    {
        if (!OldValue.IsValid())
        {
            return nullptr;
    ...
    TSharedPtr<Model::FStaminaModel> FSetRecoverIntervalByStampSheetResult::GetStaminaModel() const
    {
    ...
    TSharedPtr<FSetRecoverIntervalByStampSheetResult> FSetRecoverIntervalByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSetRecoverIntervalByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FSetRecoverIntervalByStampSheetResult::ToJson() const
    {
