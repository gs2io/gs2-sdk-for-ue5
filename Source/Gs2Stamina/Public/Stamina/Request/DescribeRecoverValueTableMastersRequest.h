...
namespace Gs2::Stamina::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeRecoverValueTableMastersRequest> WithNamePrefix(const TOptional<FString> NamePrefix);
    ...
    typedef TSharedPtr<FDescribeRecoverValueTableMastersRequest> FDescribeRecoverValueTableMastersRequestPtr;
}