...
namespace Gs2::Stamina::Domain::SpeculativeExecutor
{
    ...
    class GS2STAMINA_API FVerifyStaminaRecoverValueByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequestPtr Rate(
            const Gs2::Stamina::Request::FVerifyStaminaRecoverValueByUserIdRequestPtr& Request,
            const double Rate
        );
