...
namespace Gs2::Stamina::Domain
{
    ...
    public:
        ...
        class GS2STAMINA_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2StaminaDomain>,
        ...
        class GS2STAMINA_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2StaminaDomain>,
        ...
        class GS2STAMINA_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2StaminaDomain>,
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Stamina::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2STAMINA_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2StaminaDomain> Self;
            const TFunction<void(TArray<Gs2::Stamina::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2StaminaDomain>& Self, TFunction<void(TArray<Gs2::Stamina::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
