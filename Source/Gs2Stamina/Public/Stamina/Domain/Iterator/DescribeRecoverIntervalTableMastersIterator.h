...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class GS2STAMINA_API FDescribeRecoverIntervalTableMastersIterator :
        public TSharedFromThis<FDescribeRecoverIntervalTableMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Stamina::Model::FRecoverIntervalTableMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeRecoverIntervalTableMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Stamina::Model::FRecoverIntervalTableMasterPtr>> Range;
            TOptional<TArray<Gs2::Stamina::Model::FRecoverIntervalTableMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRecoverIntervalTableMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRecoverIntervalTableMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRecoverIntervalTableMastersIterator> Iterable)
            {
