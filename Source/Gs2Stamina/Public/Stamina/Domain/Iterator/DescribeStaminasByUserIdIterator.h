...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class GS2STAMINA_API FDescribeStaminasByUserIdIterator :
        public TSharedFromThis<FDescribeStaminasByUserIdIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeStaminasByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStaminasByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStaminasByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStaminasByUserIdIterator> Iterable)
            {
