...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class GS2STAMINA_API FDescribeStaminasIterator :
        public TSharedFromThis<FDescribeStaminasIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Stamina::Model::FStamina>> Result) override;
        ...
        {
            TSharedRef<FDescribeStaminasIterator> Self;
            TSharedPtr<TArray<Gs2::Stamina::Model::FStaminaPtr>> Range;
            TOptional<TArray<Gs2::Stamina::Model::FStaminaPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStaminasIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStaminasIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStaminasIterator> Iterable)
            {
