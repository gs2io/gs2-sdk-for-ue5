...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class GS2STAMINA_API FDescribeRecoverValueTableMastersIterator :
        public TSharedFromThis<FDescribeRecoverValueTableMastersIterator>
    {
    ...
    public:
        ...
        FDescribeRecoverValueTableMastersIterator(
            const FDescribeRecoverValueTableMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Stamina::Model::FRecoverValueTableMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeRecoverValueTableMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Stamina::Model::FRecoverValueTableMasterPtr>> Range;
            TOptional<TArray<Gs2::Stamina::Model::FRecoverValueTableMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRecoverValueTableMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRecoverValueTableMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRecoverValueTableMastersIterator> Iterable)
            {
