...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class GS2STAMINA_API FDescribeStaminaModelMastersIterator :
        public TSharedFromThis<FDescribeStaminaModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Stamina::Model::FStaminaModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeStaminaModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Stamina::Model::FStaminaModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Stamina::Model::FStaminaModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStaminaModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStaminaModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStaminaModelMastersIterator> Iterable)
            {
