...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    class FDescribeStaminaModelsIteratorLoadTask;

    class GS2STAMINA_API FDescribeStaminaModelsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Stamina::Model::FStaminaModel, FDescribeStaminaModelsIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Stamina::FGs2StaminaRestClientPtr Client;

        friend FDescribeStaminaModelsIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeStaminaModelsIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeStaminaModelsIterator;
        ...
        public:
            ...
            const Gs2::Stamina::Model::FStaminaModelPtr& operator*() const;
            Gs2::Stamina::Model::FStaminaModelPtr operator->();
    ...
    class FDescribeStaminaModelsIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Stamina::Model::FStaminaModelPtr>>,
        public TSharedFromThis<FDescribeStaminaModelsIteratorLoadTask>
    {
        TSharedPtr<FDescribeStaminaModelsIterator> Self;
