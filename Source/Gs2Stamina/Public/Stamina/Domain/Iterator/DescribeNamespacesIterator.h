...
namespace Gs2::Stamina::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Stamina::Model::FNamespace>> Result) override;
        ...
        class GS2STAMINA_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Stamina::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Stamina::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
