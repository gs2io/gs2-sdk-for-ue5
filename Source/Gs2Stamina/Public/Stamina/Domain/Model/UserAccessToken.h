...
namespace Gs2::Stamina::Domain::Model
{
    ...
    public:
        ...
        public:
            FSubscribeStaminasWithInitialCallTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::Stamina::Model::FStaminaPtr>)> Callback);
