...
namespace Gs2::Stamina::Domain::Model
{
    ...
    class GS2STAMINA_API FRecoverIntervalTableDomain:
    ...
    public:
        ...
        class GS2STAMINA_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Stamina::Model::FRecoverIntervalTable>,
        ...
        {
            const TSharedPtr<FRecoverIntervalTableDomain> Self;
            const TFunction<void(Gs2::Stamina::Model::FRecoverIntervalTablePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FRecoverIntervalTableDomain> FRecoverIntervalTableDomainPtr;
}
