...
{
    class GS2STAMINA_API FMaxStaminaTableMaster final : public FGs2Object, public TSharedFromThis<FMaxStaminaTableMaster>
    {
    ...
    public:
        ...
        virtual ~FMaxStaminaTableMaster() override = default;
        ...
        TSharedPtr<FMaxStaminaTableMaster> WithRevision(const TOptional<int64> Revision);
