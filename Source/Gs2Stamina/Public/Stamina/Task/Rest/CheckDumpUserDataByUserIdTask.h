...
#include "Stamina/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Stamina/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
