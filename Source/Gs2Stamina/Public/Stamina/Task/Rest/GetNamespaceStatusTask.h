...
#include "Stamina/Request/GetNamespaceStatusRequest.h"
#include "Stamina/Result/GetNamespaceStatusResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
