...
#include "Stamina/Result/CreateNamespaceResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
