...
#include "Stamina/Request/ImportUserDataByUserIdRequest.h"
#include "Stamina/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
