...
#include "Stamina/Request/DeleteNamespaceRequest.h"
#include "Stamina/Result/DeleteNamespaceResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
