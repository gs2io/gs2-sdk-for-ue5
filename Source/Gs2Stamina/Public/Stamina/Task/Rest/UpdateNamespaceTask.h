...
#include "Stamina/Result/UpdateNamespaceResult.h"

namespace Gs2::Stamina::Task::Rest
{
    class GS2STAMINA_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
