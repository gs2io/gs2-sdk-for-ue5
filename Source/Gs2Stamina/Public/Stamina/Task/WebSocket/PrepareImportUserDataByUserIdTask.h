...
#include "Stamina/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Stamina/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
