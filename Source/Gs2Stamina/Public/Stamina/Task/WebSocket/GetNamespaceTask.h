...
#include "Stamina/Request/GetNamespaceRequest.h"
#include "Stamina/Result/GetNamespaceResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
