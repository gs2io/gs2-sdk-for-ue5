...
#include "Stamina/Request/DescribeNamespacesRequest.h"
#include "Stamina/Result/DescribeNamespacesResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
