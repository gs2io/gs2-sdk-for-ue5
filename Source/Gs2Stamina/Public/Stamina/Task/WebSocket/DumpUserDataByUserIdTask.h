...
#include "Stamina/Request/DumpUserDataByUserIdRequest.h"
#include "Stamina/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
