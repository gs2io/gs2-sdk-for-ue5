...
#include "Stamina/Request/GetServiceVersionRequest.h"
#include "Stamina/Result/GetServiceVersionResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
