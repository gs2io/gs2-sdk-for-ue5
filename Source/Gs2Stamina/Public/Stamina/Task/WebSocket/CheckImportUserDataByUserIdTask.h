...
#include "Stamina/Request/CheckImportUserDataByUserIdRequest.h"
#include "Stamina/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
