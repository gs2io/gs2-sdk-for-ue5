...
#include "Stamina/Request/CleanUserDataByUserIdRequest.h"
#include "Stamina/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Stamina::Task::WebSocket
{
    class GS2STAMINA_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
