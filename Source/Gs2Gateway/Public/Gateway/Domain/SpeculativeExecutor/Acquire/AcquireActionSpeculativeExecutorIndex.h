...
namespace Gs2::Gateway::Domain::SpeculativeExecutor
{
    class GS2GATEWAY_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Gateway::Domain::FGs2GatewayDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2GATEWAY_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Gateway::Domain::FGs2GatewayDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2GATEWAY_API FCommitTask(
                const FCommitTask& From
            );

            GS2GATEWAY_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
