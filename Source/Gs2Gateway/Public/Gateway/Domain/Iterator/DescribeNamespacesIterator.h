...
namespace Gs2::Gateway::Domain::Iterator
{
    ...
    class GS2GATEWAY_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Gateway::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2GATEWAY_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Gateway::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::Gateway::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Gateway::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Gateway::Model::FNamespacePtr& operator*() const;
            Gs2::Gateway::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Gateway::Model::FNamespacePtr>>,
