...
namespace Gs2::Gateway::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Gateway::Model::FNamespace>> Result) override;
        ...
        class GS2GATEWAY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Gateway::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Gateway::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
