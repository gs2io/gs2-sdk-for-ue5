...
namespace Gs2::Gateway::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Gateway::Model::FWebSocketSession>> Result) override;
        ...
        class GS2GATEWAY_API FIterator
        {
            TSharedRef<FDescribeWebSocketSessionsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Gateway::Model::FWebSocketSessionPtr>> Range;
            TOptional<TArray<Gs2::Gateway::Model::FWebSocketSessionPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeWebSocketSessionsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeWebSocketSessionsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeWebSocketSessionsByUserIdIterator> Iterable)
            {
