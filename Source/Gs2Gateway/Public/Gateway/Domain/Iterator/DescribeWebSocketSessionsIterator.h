...
namespace Gs2::Gateway::Domain::Iterator
{
    ...
    class GS2GATEWAY_API FDescribeWebSocketSessionsIterator :
        public TSharedFromThis<FDescribeWebSocketSessionsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeWebSocketSessionsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeWebSocketSessionsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeWebSocketSessionsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeWebSocketSessionsIterator> Iterable)
            {
