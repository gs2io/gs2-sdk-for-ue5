...
#include "Gateway/Request/DescribeNamespacesRequest.h"
#include "Gateway/Result/DescribeNamespacesResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
