...
#include "Gateway/Request/DumpUserDataByUserIdRequest.h"
#include "Gateway/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
