...
#include "Gateway/Request/DeleteNamespaceRequest.h"
#include "Gateway/Result/DeleteNamespaceResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
