...
#include "Gateway/Request/CheckImportUserDataByUserIdRequest.h"
#include "Gateway/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
