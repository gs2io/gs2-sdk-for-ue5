...
#include "Gateway/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
