...
#include "Gateway/Request/ImportUserDataByUserIdRequest.h"
#include "Gateway/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::WebSocket
{
    class GS2GATEWAY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
