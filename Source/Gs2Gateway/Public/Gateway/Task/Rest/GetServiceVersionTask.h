...
#include "Gateway/Request/GetServiceVersionRequest.h"
#include "Gateway/Result/GetServiceVersionResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
