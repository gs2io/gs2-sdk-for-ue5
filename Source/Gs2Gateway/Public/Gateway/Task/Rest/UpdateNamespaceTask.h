...
#include "Gateway/Request/UpdateNamespaceRequest.h"
#include "Gateway/Result/UpdateNamespaceResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
