...
#include "Gateway/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Gateway/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
