...
#include "Gateway/Result/CreateNamespaceResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
