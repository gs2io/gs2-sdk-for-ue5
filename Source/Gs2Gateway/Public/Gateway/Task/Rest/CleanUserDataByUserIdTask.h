...
#include "Gateway/Request/CleanUserDataByUserIdRequest.h"
#include "Gateway/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
