...
#include "Gateway/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Gateway/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
