...
#include "Gateway/Request/GetNamespaceRequest.h"
#include "Gateway/Result/GetNamespaceResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
