...
#include "Gateway/Request/GetNamespaceStatusRequest.h"
#include "Gateway/Result/GetNamespaceStatusResult.h"

namespace Gs2::Gateway::Task::Rest
{
    class GS2GATEWAY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
