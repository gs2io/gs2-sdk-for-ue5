...
#include "Gateway/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::Gateway::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("gateway"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
