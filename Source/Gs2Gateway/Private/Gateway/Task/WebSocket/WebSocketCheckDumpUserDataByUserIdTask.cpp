...
#include "Gateway/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Gateway::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("gateway"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
