...
#include "Gateway/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::Gateway::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("gateway"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
