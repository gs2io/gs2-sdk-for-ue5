...
#include "Gateway/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Gateway::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetFirebaseSecret().IsSet() && !this->Request->GetFirebaseSecret().GetValue().IsEmpty())
            {
                JsonRootObject->SetStringField("firebaseSecret", this->Request->GetFirebaseSecret().GetValue());
            }
