...
#include "Auth/Request/GetServiceVersionRequest.h"
#include "Auth/Result/GetServiceVersionResult.h"

namespace Gs2::Auth::Task::WebSocket
{
    class GS2AUTH_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
