...
{
    class GS2AUTH_API FLoginResult final : public TSharedFromThis<FLoginResult>
    {
    ...
    public:
        ...
        TSharedPtr<FLoginResult> WithToken(const TOptional<FString> Token);
        TSharedPtr<FLoginResult> WithUserId(const TOptional<FString> UserId);
        TSharedPtr<FLoginResult> WithExpire(const TOptional<int64> Expire);
