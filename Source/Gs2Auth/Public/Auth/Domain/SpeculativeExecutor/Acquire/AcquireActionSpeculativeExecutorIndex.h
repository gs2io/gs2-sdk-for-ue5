...
namespace Gs2::Auth::Domain::SpeculativeExecutor
{
    class GS2AUTH_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Auth::Domain::FGs2AuthDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2AUTH_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Auth::Domain::FGs2AuthDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2AUTH_API FCommitTask(
                const FCommitTask& From
            );

            GS2AUTH_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
