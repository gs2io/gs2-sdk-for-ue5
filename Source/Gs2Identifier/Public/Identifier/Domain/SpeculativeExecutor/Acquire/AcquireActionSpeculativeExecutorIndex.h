...
namespace Gs2::Identifier::Domain::SpeculativeExecutor
{
    class GS2IDENTIFIER_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Identifier::Domain::FGs2IdentifierDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2IDENTIFIER_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Identifier::Domain::FGs2IdentifierDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2IDENTIFIER_API FCommitTask(
                const FCommitTask& From
            );

            GS2IDENTIFIER_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
