...
namespace Gs2::Identifier::Domain::Iterator
{
    ...
    public:
        ...
        FDescribeCommonSecurityPoliciesIterator(
            const FDescribeCommonSecurityPoliciesIterator& From
        );
        ...
        {
            TSharedRef<FDescribeCommonSecurityPoliciesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCommonSecurityPoliciesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCommonSecurityPoliciesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCommonSecurityPoliciesIterator> Iterable)
            {
