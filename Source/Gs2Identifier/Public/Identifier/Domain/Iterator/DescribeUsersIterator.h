...
namespace Gs2::Identifier::Domain::Iterator
{
    ...
    class GS2IDENTIFIER_API FDescribeUsersIterator :
        public TSharedFromThis<FDescribeUsersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Identifier::Model::FUser>> Result) override;
        ...
        {
            TSharedRef<FDescribeUsersIterator> Self;
            TSharedPtr<TArray<Gs2::Identifier::Model::FUserPtr>> Range;
            TOptional<TArray<Gs2::Identifier::Model::FUserPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeUsersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeUsersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeUsersIterator> Iterable)
            {
