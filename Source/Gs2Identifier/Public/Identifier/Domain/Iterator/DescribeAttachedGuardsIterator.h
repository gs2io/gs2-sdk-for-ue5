...
namespace Gs2::Identifier::Domain::Iterator
{
    ...
    class GS2IDENTIFIER_API FDescribeAttachedGuardsIterator :
        public TSharedFromThis<FDescribeAttachedGuardsIterator>
    {
    ...
    public:
        FDescribeAttachedGuardsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Identifier::FGs2IdentifierRestClientPtr Client,
            const TOptional<FString> UserName,
        ...
        class GS2IDENTIFIER_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Identifier::Model::FIdentifierEntry>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Identifier::Model::FIdentifierEntry>> Result) override;
        ...
        {
            TSharedRef<FDescribeAttachedGuardsIterator> Self;
            TSharedPtr<TArray<Gs2::Identifier::Model::FIdentifierEntryPtr>> Range;
            TOptional<TArray<Gs2::Identifier::Model::FIdentifierEntryPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Identifier::Model::FIdentifierEntryPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAttachedGuardsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAttachedGuardsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAttachedGuardsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeAttachedGuardsIterator> FDescribeAttachedGuardsIteratorPtr;
}
