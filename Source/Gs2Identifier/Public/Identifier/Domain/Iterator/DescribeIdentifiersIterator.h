...
namespace Gs2::Identifier::Domain::Iterator
{
    ...
    class GS2IDENTIFIER_API FDescribeIdentifiersIterator :
        public TSharedFromThis<FDescribeIdentifiersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Identifier::Model::FIdentifier>> Result) override;
        ...
        {
            TSharedRef<FDescribeIdentifiersIterator> Self;
            TSharedPtr<TArray<Gs2::Identifier::Model::FIdentifierPtr>> Range;
            TOptional<TArray<Gs2::Identifier::Model::FIdentifierPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeIdentifiersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeIdentifiersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeIdentifiersIterator> Iterable)
            {
