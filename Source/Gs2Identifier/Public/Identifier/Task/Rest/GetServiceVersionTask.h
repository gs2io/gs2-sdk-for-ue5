...
#include "Identifier/Request/GetServiceVersionRequest.h"
#include "Identifier/Result/GetServiceVersionResult.h"

namespace Gs2::Identifier::Task::Rest
{
    class GS2IDENTIFIER_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
