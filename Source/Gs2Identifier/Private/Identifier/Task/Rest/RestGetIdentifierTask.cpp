...
#include "Identifier/Task/Rest/GetIdentifierTask.h"
...
{
    FGetIdentifierTask::FGetIdentifierTask(
    ...
    Core::Model::FGs2ErrorPtr FGetIdentifierTask::Action(
        const TSharedPtr<Result::FGetIdentifierResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetIdentifierResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
