...
#include "Identifier/Task/Rest/DetachSecurityPolicyTask.h"
...
{
    FDetachSecurityPolicyTask::FDetachSecurityPolicyTask(
    ...
    Core::Model::FGs2ErrorPtr FDetachSecurityPolicyTask::Action(
        const TSharedPtr<Result::FDetachSecurityPolicyResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/user/{userName}/securityPolicy/{securityPolicyId}");
            ...
            Url = Url.Replace(
                TEXT("{securityPolicyId}"),
                !this->Request->GetSecurityPolicyId().IsSet() || this->Request->GetSecurityPolicyId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetSecurityPolicyId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDetachSecurityPolicyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
