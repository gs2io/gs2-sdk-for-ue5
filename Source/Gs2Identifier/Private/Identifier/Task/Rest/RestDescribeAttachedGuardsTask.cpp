...
#include "Identifier/Task/Rest/DescribeAttachedGuardsTask.h"
...
{
    FDescribeAttachedGuardsTask::FDescribeAttachedGuardsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeAttachedGuardsTask::Action(
        const TSharedPtr<Result::FDescribeAttachedGuardsResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeAttachedGuardsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
