...
#include "Identifier/Task/Rest/DeleteIdentifierTask.h"
...
{
    FDeleteIdentifierTask::FDeleteIdentifierTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteIdentifierTask::Action(
        const TSharedPtr<Result::FDeleteIdentifierResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/user/{userName}/identifier/{clientId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteIdentifierResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
