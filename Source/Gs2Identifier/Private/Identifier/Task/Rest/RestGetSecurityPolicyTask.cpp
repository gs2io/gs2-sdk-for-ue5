...
#include "Identifier/Task/Rest/GetSecurityPolicyTask.h"
...
{
    FGetSecurityPolicyTask::FGetSecurityPolicyTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSecurityPolicyTask::Action(
        const TSharedPtr<Result::FGetSecurityPolicyResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSecurityPolicyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
