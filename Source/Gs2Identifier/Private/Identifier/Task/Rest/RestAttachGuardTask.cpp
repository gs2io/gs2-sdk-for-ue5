...
#include "Identifier/Task/Rest/AttachGuardTask.h"
...
{
    FAttachGuardTask::FAttachGuardTask(
    ...
    Core::Model::FGs2ErrorPtr FAttachGuardTask::Action(
        const TSharedPtr<Result::FAttachGuardResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/user/{userName}/identifier/{clientId}/guard");
            ...
            if (this->Request->GetGuardNamespaceId().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("guardNamespaceId"), this->Request->GetGuardNamespaceId().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAttachGuardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
