...
#include "Identifier/Task/WebSocket/ChallengeMfaTask.h"
...
namespace Gs2::Identifier::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("identifier"), TEXT("password"), TEXT("challengeMfa"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FChallengeMfaResult::FromJson(WebSocketResult->Body());
