...
#include "Identifier/Task/WebSocket/LoginByUserTask.h"
...
namespace Gs2::Identifier::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("identifier"), TEXT("projectToken"), TEXT("loginByUser"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FLoginByUserResult::FromJson(WebSocketResult->Body());
