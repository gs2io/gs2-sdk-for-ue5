...
{
    FPreUpdateCurrentEntryMasterResult::FPreUpdateCurrentEntryMasterResult():
    ...
    FPreUpdateCurrentEntryMasterResult::FPreUpdateCurrentEntryMasterResult(
        const FPreUpdateCurrentEntryMasterResult& From
    ):
    ...
    TSharedPtr<FPreUpdateCurrentEntryMasterResult> FPreUpdateCurrentEntryMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentEntryMasterResult> FPreUpdateCurrentEntryMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentEntryMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentEntryMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentEntryMasterResult> FPreUpdateCurrentEntryMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentEntryMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentEntryMasterResult::ToJson() const
    {
