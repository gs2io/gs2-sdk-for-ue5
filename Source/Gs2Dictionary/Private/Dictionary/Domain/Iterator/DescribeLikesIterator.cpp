...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    FDescribeLikesIterator::FDescribeLikesIterator(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeLikesIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Dictionary::Model::FLike>> Result)
    {
        ++Iterator;
    ...
    FDescribeLikesIterator::FIterator::FIterator(
    ...
    FDescribeLikesIterator::FIterator FDescribeLikesIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeLikesIterator::FIterator FDescribeLikesIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeLikesIterator::FIterator FDescribeLikesIterator::end()
    {
