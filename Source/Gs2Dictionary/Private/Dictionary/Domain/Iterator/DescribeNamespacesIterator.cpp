...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    const Gs2::Dictionary::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Dictionary::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
