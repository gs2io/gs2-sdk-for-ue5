...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    FDescribeEntriesByUserIdIterator::FIterator& FDescribeEntriesByUserIdIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Dictionary::Model::Cache::FEntryCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->UserId,
                TOptional<int32>()
            );
            ...
            const auto Request =
                MakeShared<Gs2::Dictionary::Request::FDescribeEntriesByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeEntriesByUserId(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Dictionary::Model::FEntryPtr>>();
