...
namespace Gs2::Dictionary::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FAddEntriesByUserIdSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FAddEntriesByUserIdRequest::FromJson(RequestModelJson);
            Request = FAddEntriesByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FAddEntriesByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
