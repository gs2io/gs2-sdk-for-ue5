...
namespace Gs2::Dictionary::Domain::Model
{
    ...
    )
    {
        Request
            ...
            ->WithEntryName(Self->EntryModelName);
    ...
    {
        const FString CacheKey = Gs2::Dictionary::Domain::Model::FEntryModelMasterDomain::CreateCacheKey(
            Self->EntryModelName
        );
            ...
            [this, Result, CacheKey]() -> Gs2::Core::Model::FGs2ErrorPtr
            {
                ...
                if (!bCacheHit) {
                    ...
                    if (Future->GetTask().IsError())
                    {
                        ...
                        if (!Error->GetErrors().IsValid() || Error->Count() == 0 || !Error->Detail(0).IsValid() || Error->Detail(0)->GetComponent() != "entryModelMaster")
                        {
                            return Error;
                        }
                    }
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryEntryModelName]()
            {
                ...
                const auto Domain = MakeShared<FEntryModelMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryEntryModelName
