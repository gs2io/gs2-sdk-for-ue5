...
#include "Dictionary/Task/Rest/GetEntryByUserIdTask.h"
...
{
    FGetEntryByUserIdTask::FGetEntryByUserIdTask(
    ...
    FGetEntryByUserIdTask::FGetEntryByUserIdTask(
        const FGetEntryByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetEntryByUserIdTask::Action(
        const TSharedPtr<Result::FGetEntryByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/entry/{entryModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEntryByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
