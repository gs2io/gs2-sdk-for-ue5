...
#include "Dictionary/Task/Rest/GetEntryTask.h"
...
namespace Gs2::Dictionary::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetEntryTask::Action(
        const TSharedPtr<Result::FGetEntryResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/entry/{entryModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEntryResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
