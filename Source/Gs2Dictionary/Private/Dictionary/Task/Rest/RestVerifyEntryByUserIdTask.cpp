...
#include "Dictionary/Task/Rest/VerifyEntryByUserIdTask.h"
...
{
    FVerifyEntryByUserIdTask::FVerifyEntryByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyEntryByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyEntryByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/entry/{entryModelName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyEntryByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
