...
#include "Dictionary/Task/Rest/GetLikeByUserIdTask.h"
...
{
    FGetLikeByUserIdTask::FGetLikeByUserIdTask(
    ...
    FGetLikeByUserIdTask::FGetLikeByUserIdTask(
        const FGetLikeByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetLikeByUserIdTask::Action(
        const TSharedPtr<Result::FGetLikeByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/like/{entryModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLikeByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
