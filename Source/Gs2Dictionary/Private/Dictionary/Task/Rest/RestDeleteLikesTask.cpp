...
#include "Dictionary/Task/Rest/DeleteLikesTask.h"
...
{
    FDeleteLikesTask::FDeleteLikesTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteLikesTask::Action(
        const TSharedPtr<Result::FDeleteLikesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/like/delete");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteLikesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
