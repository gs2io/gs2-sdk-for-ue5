...
#include "Dictionary/Task/Rest/AddLikesByUserIdTask.h"
...
{
    FAddLikesByUserIdTask::FAddLikesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAddLikesByUserIdTask::Action(
        const TSharedPtr<Result::FAddLikesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/like");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddLikesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
