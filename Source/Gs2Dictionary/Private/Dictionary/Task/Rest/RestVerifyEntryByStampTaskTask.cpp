...
#include "Dictionary/Task/Rest/VerifyEntryByStampTaskTask.h"
...
{
    FVerifyEntryByStampTaskTask::FVerifyEntryByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyEntryByStampTaskTask::Action(
        const TSharedPtr<Result::FVerifyEntryByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyEntryByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
