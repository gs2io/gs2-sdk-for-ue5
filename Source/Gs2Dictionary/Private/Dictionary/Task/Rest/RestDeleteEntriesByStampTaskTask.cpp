...
#include "Dictionary/Task/Rest/DeleteEntriesByStampTaskTask.h"
...
{
    FDeleteEntriesByStampTaskTask::FDeleteEntriesByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteEntriesByStampTaskTask::Action(
        const TSharedPtr<Result::FDeleteEntriesByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteEntriesByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
