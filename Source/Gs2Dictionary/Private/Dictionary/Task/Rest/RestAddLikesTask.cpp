...
#include "Dictionary/Task/Rest/AddLikesTask.h"
...
namespace Gs2::Dictionary::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FAddLikesTask::Action(
        const TSharedPtr<Result::FAddLikesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/like");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddLikesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
