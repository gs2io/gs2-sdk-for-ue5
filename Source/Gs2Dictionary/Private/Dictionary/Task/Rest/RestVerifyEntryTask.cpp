...
#include "Dictionary/Task/Rest/VerifyEntryTask.h"
...
{
    FVerifyEntryTask::FVerifyEntryTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyEntryTask::Action(
        const TSharedPtr<Result::FVerifyEntryResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/entry/{entryModelName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyEntryResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
