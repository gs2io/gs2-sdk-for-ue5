...
#include "Dictionary/Task/Rest/UpdateEntryModelMasterTask.h"
...
{
    FUpdateEntryModelMasterTask::FUpdateEntryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateEntryModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateEntryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/{entryName}");
            ...
            Url = Url.Replace(
                TEXT("{entryName}"),
                !this->Request->GetEntryName().IsSet() || this->Request->GetEntryName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetEntryName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateEntryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
