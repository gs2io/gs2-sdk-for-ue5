...
#include "Dictionary/Task/Rest/GetEntryModelMasterTask.h"
...
{
    FGetEntryModelMasterTask::FGetEntryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetEntryModelMasterTask::Action(
        const TSharedPtr<Result::FGetEntryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEntryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
