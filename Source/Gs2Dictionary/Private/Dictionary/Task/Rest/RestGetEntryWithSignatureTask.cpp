...
#include "Dictionary/Task/Rest/GetEntryWithSignatureTask.h"
...
{
    FGetEntryWithSignatureTask::FGetEntryWithSignatureTask(
    ...
    FGetEntryWithSignatureTask::FGetEntryWithSignatureTask(
        const FGetEntryWithSignatureTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetEntryWithSignatureTask::Action(
        const TSharedPtr<Result::FGetEntryWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/entry/{entryModelName}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEntryWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
