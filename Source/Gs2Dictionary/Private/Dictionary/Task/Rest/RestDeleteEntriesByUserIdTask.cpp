...
#include "Dictionary/Task/Rest/DeleteEntriesByUserIdTask.h"
...
{
    FDeleteEntriesByUserIdTask::FDeleteEntriesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteEntriesByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteEntriesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/entry/delete");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteEntriesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
