...
#include "Dictionary/Task/Rest/DeleteEntriesTask.h"
...
{
    FDeleteEntriesTask::FDeleteEntriesTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteEntriesTask::Action(
        const TSharedPtr<Result::FDeleteEntriesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/entry/delete");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteEntriesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
