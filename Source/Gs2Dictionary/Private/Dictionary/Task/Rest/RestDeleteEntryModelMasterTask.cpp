...
#include "Dictionary/Task/Rest/DeleteEntryModelMasterTask.h"
...
{
    FDeleteEntryModelMasterTask::FDeleteEntryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteEntryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteEntryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteEntryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
