...
#include "Dictionary/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Dictionary::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("dictionary"), TEXT("currentEntryMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
