...
#include "Dictionary/Request/CreateNamespaceRequest.h"
...
namespace Gs2::Dictionary::Request
{
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithEntryScript(
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithDuplicateEntryScript(
    ...
    TSharedPtr<Model::FScriptSetting> FCreateNamespaceRequest::GetEntryScript() const
    {
    ...
    TOptional<FString> FCreateNamespaceRequest::GetDuplicateEntryScript() const
    {
