...
namespace Gs2::Dictionary::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithDuplicateEntryScript(
        const TSharedPtr<Model::FScriptSetting> DuplicateEntryScript
    )
    {
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetDuplicateEntryScript() const
    {
        if (!DuplicateEntryScriptValue.IsValid())
        {
            return nullptr;
        }
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FUpdateNamespaceRequest>()
          ...
          ->WithEntryScript(Data->HasField("entryScript") ? [Data]() -> Model::FScriptSettingPtr
              {
                  if (Data->HasTypedField<EJson::Null>("entryScript"))
                  {
                      return nullptr;
                  }
