...
#include "Dictionary/Request/UpdateNamespaceRequest.h"
...
namespace Gs2::Dictionary::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithEntryScript(
        const TSharedPtr<Model::FScriptSetting> EntryScript
    )
    {
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithDuplicateEntryScript(
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetEntryScript() const
    {
        if (!EntryScriptValue.IsValid())
        {
            return nullptr;
        }
    ...
    TOptional<FString> FUpdateNamespaceRequest::GetDuplicateEntryScript() const
    {
