...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    class GS2DICTIONARY_API FDescribeLikesByUserIdIterator :
        public TSharedFromThis<FDescribeLikesByUserIdIterator>
    {
    ...
    public:
        FDescribeLikesByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Dictionary::FGs2DictionaryRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        FDescribeLikesByUserIdIterator(
            const FDescribeLikesByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Dictionary::Model::FLike>> Result) override;
        ...
        {
            TSharedRef<FDescribeLikesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Dictionary::Model::FLikePtr>> Range;
            TOptional<TArray<Gs2::Dictionary::Model::FLikePtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeLikesByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Dictionary::Model::FLikePtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLikesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLikesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLikesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeLikesByUserIdIterator> FDescribeLikesByUserIdIteratorPtr;
}
