...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Dictionary::Model::FNamespace>> Result) override;
        ...
        class GS2DICTIONARY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Dictionary::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Dictionary::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
