...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    class GS2DICTIONARY_API FDescribeEntriesIterator :
        public TSharedFromThis<FDescribeEntriesIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeEntriesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeEntriesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeEntriesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeEntriesIterator> Iterable)
            {
