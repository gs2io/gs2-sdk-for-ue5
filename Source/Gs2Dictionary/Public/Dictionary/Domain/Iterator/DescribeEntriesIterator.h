...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    class FDescribeEntriesIteratorLoadTask;

    class GS2DICTIONARY_API FDescribeEntriesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Dictionary::Model::FEntry, FDescribeEntriesIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Dictionary::FGs2DictionaryRestClientPtr Client;

        friend FDescribeEntriesIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeEntriesIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeEntriesIterator;
    ...
    typedef TSharedPtr<FDescribeEntriesIterator> FDescribeEntriesIteratorPtr;
    ...
    {
        TSharedPtr<FDescribeEntriesIterator> Self;
