...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    class GS2DICTIONARY_API FDescribeLikesIterator :
        public TSharedFromThis<FDescribeLikesIterator>
    {
    ...
    public:
        ...
        FDescribeLikesIterator(
            const FDescribeLikesIterator& From
        );
        ...
        {
            TSharedRef<FDescribeLikesIterator> Self;
            ...
            FIterator(
                const TSharedRef<FDescribeLikesIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLikesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLikesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLikesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeLikesIterator> FDescribeLikesIteratorPtr;
}
