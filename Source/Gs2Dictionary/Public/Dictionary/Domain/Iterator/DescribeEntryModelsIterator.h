...
namespace Gs2::Dictionary::Domain::Iterator
{
    ...
    class GS2DICTIONARY_API FDescribeEntryModelsIterator :
        public TSharedFromThis<FDescribeEntryModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Dictionary::Model::FEntryModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeEntryModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Dictionary::Model::FEntryModelPtr>> Range;
            TOptional<TArray<Gs2::Dictionary::Model::FEntryModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeEntryModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeEntryModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeEntryModelsIterator> Iterable)
            {
