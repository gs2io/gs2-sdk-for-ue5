...
namespace Gs2::Dictionary::Domain::Model
{
    ...
    class GS2DICTIONARY_API FLikeAccessTokenDomain:
        public TSharedFromThis<FLikeAccessTokenDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FLikeAccessTokenDomain> Self;
            const TFunction<void(Gs2::Dictionary::Model::FLikePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FLikeAccessTokenDomain> FLikeAccessTokenDomainPtr;
}
