...
#include "Dictionary/Result/UpdateNamespaceResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
