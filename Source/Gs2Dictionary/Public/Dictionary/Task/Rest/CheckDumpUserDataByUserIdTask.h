...
#include "Dictionary/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
