...
#include "Dictionary/Request/DeleteNamespaceRequest.h"
#include "Dictionary/Result/DeleteNamespaceResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
