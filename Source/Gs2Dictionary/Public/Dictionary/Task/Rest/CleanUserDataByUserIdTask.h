...
#include "Dictionary/Request/CleanUserDataByUserIdRequest.h"
#include "Dictionary/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
