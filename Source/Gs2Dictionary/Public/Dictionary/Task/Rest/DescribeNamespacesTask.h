...
#include "Dictionary/Request/DescribeNamespacesRequest.h"
#include "Dictionary/Result/DescribeNamespacesResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
