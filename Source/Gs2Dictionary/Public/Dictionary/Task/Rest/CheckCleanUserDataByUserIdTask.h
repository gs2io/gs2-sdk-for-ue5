...
#include "Dictionary/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Dictionary/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
