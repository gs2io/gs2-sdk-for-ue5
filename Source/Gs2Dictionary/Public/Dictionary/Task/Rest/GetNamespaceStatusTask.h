...
#include "Dictionary/Request/GetNamespaceStatusRequest.h"
#include "Dictionary/Result/GetNamespaceStatusResult.h"

namespace Gs2::Dictionary::Task::Rest
{
    class GS2DICTIONARY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
