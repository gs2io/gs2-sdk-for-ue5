...
#include "Dictionary/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Dictionary/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::WebSocket
{
    class GS2DICTIONARY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
