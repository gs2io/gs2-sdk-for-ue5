...
#include "Dictionary/Request/ImportUserDataByUserIdRequest.h"
#include "Dictionary/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::WebSocket
{
    class GS2DICTIONARY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
