...
#include "Dictionary/Request/DumpUserDataByUserIdRequest.h"
#include "Dictionary/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Dictionary::Task::WebSocket
{
    class GS2DICTIONARY_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
