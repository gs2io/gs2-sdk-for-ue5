...
#include "Dictionary/Request/GetNamespaceRequest.h"
#include "Dictionary/Result/GetNamespaceResult.h"

namespace Gs2::Dictionary::Task::WebSocket
{
    class GS2DICTIONARY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
