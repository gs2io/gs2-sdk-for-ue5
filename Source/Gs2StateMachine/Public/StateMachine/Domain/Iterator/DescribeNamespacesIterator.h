...
namespace Gs2::StateMachine::Domain::Iterator
{
    ...
    class GS2STATEMACHINE_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::StateMachine::Model::FNamespace>> Result) override;
        ...
        class GS2STATEMACHINE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::StateMachine::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::StateMachine::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::StateMachine::Model::FNamespacePtr& Current()
            {
