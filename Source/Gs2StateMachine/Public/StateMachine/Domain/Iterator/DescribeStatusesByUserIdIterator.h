...
namespace Gs2::StateMachine::Domain::Iterator
{
    ...
    class GS2STATEMACHINE_API FDescribeStatusesByUserIdIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::StateMachine::Model::FStatus>> Result) override;
        ...
        {
            TSharedRef<FDescribeStatusesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::StateMachine::Model::FStatusPtr>> Range;
            TOptional<TArray<Gs2::StateMachine::Model::FStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::StateMachine::Model::FStatusPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStatusesByUserIdIterator> Iterable)
            {
