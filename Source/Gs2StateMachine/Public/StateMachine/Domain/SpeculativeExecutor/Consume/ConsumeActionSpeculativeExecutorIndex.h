...
{
    class GS2STATEMACHINE_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
        ...
        public:
            GS2STATEMACHINE_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::StateMachine::Domain::FGs2StateMachineDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2STATEMACHINE_API FCommitTask(
                const FCommitTask& From
            );

            GS2STATEMACHINE_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
