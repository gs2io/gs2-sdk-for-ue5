...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FGetNamespaceRequest final : public TSharedFromThis<FGetNamespaceRequest>
    {
    ...
    typedef TSharedPtr<FGetNamespaceRequest, ESPMode::ThreadSafe> FGetNamespaceRequestPtr;
}