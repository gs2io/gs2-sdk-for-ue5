...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FGetStatusByUserIdRequest final : public TSharedFromThis<FGetStatusByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetStatusByUserIdRequest> WithStatusName(const TOptional<FString> StatusName);
