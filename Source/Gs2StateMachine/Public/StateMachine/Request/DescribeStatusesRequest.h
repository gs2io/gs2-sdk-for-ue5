...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FDescribeStatusesRequest final : public TSharedFromThis<FDescribeStatusesRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeStatusesRequest> WithStatus(const TOptional<FString> Status);
