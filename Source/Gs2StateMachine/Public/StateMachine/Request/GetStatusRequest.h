...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FGetStatusRequest final : public TSharedFromThis<FGetStatusRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetStatusRequest> WithStatusName(const TOptional<FString> StatusName);
