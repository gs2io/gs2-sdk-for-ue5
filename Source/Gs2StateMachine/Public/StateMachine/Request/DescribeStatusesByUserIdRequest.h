...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FDescribeStatusesByUserIdRequest final : public TSharedFromThis<FDescribeStatusesByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeStatusesByUserIdRequest> WithStatus(const TOptional<FString> Status);
