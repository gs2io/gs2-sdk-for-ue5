...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FGetNamespaceStatusRequest final : public TSharedFromThis<FGetNamespaceStatusRequest>
    {
    ...
    typedef TSharedPtr<FGetNamespaceStatusRequest, ESPMode::ThreadSafe> FGetNamespaceStatusRequestPtr;
}