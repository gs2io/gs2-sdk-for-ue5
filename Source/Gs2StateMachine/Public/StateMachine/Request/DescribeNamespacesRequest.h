...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FDescribeNamespacesRequest final : public TSharedFromThis<FDescribeNamespacesRequest>
    {
    ...
    typedef TSharedPtr<FDescribeNamespacesRequest, ESPMode::ThreadSafe> FDescribeNamespacesRequestPtr;
}