...
namespace Gs2::StateMachine::Request
{
    ...
    class GS2STATEMACHINE_API FCheckCleanUserDataByUserIdRequest final : public TSharedFromThis<FCheckCleanUserDataByUserIdRequest>
    {
    ...
    typedef TSharedPtr<FCheckCleanUserDataByUserIdRequest> FCheckCleanUserDataByUserIdRequestPtr;
}