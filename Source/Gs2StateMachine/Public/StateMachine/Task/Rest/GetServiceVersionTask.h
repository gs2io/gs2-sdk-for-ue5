...
#include "StateMachine/Request/GetServiceVersionRequest.h"
#include "StateMachine/Result/GetServiceVersionResult.h"

namespace Gs2::StateMachine::Task::Rest
{
    class GS2STATEMACHINE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
