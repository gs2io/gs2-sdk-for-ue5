...
#include "StateMachine/Request/CheckImportUserDataByUserIdRequest.h"
#include "StateMachine/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::StateMachine::Task::Rest
{
    class GS2STATEMACHINE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
