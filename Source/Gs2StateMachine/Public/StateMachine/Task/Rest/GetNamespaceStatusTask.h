...
#include "StateMachine/Request/GetNamespaceStatusRequest.h"
#include "StateMachine/Result/GetNamespaceStatusResult.h"

namespace Gs2::StateMachine::Task::Rest
{
    class GS2STATEMACHINE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
