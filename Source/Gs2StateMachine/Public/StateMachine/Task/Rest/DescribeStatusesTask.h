...
#include "StateMachine/Result/DescribeStatusesResult.h"

namespace Gs2::StateMachine::Task::Rest
{
    class GS2STATEMACHINE_API FDescribeStatusesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeStatusesResult>
    {
