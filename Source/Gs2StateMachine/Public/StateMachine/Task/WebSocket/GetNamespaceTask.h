...
#include "StateMachine/Request/GetNamespaceRequest.h"
#include "StateMachine/Result/GetNamespaceResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
