...
#include "StateMachine/Request/DumpUserDataByUserIdRequest.h"
#include "StateMachine/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
