...
#include "StateMachine/Request/CheckDumpUserDataByUserIdRequest.h"
#include "StateMachine/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
