...
#include "StateMachine/Request/DescribeNamespacesRequest.h"
#include "StateMachine/Result/DescribeNamespacesResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
