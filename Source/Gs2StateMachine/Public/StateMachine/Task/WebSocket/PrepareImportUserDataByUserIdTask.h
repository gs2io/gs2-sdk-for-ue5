...
#include "StateMachine/Request/PrepareImportUserDataByUserIdRequest.h"
#include "StateMachine/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
