...
#include "StateMachine/Request/DeleteNamespaceRequest.h"
#include "StateMachine/Result/DeleteNamespaceResult.h"

namespace Gs2::StateMachine::Task::WebSocket
{
    class GS2STATEMACHINE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
