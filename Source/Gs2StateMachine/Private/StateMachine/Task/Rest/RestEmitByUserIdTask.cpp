...
#include "StateMachine/Task/Rest/EmitByUserIdTask.h"
...
{
    FEmitByUserIdTask::FEmitByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FEmitByUserIdTask::Action(
        const TSharedPtr<Result::FEmitByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/{statusName}/emit");
            ...
            if (this->Request->GetEventName().IsSet() && !this->Request->GetEventName().GetValue().IsEmpty())
            {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FEmitByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
