...
#include "StateMachine/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::StateMachine::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stateMachine"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
