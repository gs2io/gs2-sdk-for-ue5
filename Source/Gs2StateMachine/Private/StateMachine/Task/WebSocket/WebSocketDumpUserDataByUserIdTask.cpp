...
#include "StateMachine/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::StateMachine::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("stateMachine"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
