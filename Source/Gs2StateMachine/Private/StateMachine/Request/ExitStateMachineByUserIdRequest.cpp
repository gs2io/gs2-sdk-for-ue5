...
namespace Gs2::StateMachine::Request
{
    ...
    TSharedPtr<FExitStateMachineByUserIdRequest> FExitStateMachineByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FExitStateMachineByUserIdRequest::GetTimeOffsetToken() const
    {
