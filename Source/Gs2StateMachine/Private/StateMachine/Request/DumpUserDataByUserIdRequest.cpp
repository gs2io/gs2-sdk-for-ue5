...
namespace Gs2::StateMachine::Request
{
    ...
    TSharedPtr<FDumpUserDataByUserIdRequest> FDumpUserDataByUserIdRequest::WithDuplicationAvoider(
    ...
    TOptional<FString> FDumpUserDataByUserIdRequest::GetDuplicationAvoider() const
    {
