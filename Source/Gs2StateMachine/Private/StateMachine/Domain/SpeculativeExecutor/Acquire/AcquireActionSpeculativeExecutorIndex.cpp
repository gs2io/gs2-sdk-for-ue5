...
namespace Gs2::StateMachine::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FStartStateMachineByUserIdSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FStartStateMachineByUserIdRequest::FromJson(RequestModelJson);
            Request = FStartStateMachineByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FStartStateMachineByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
