...
{
    FPromoteSeniorMemberResult::FPromoteSeniorMemberResult():
        ItemValue(nullptr),
        GuildValue(nullptr)
    {
    }
    ...
    TSharedPtr<FPromoteSeniorMemberResult> FPromoteSeniorMemberResult::WithItem(
    ...
    TSharedPtr<FPromoteSeniorMemberResult> FPromoteSeniorMemberResult::WithGuild(
    ...
    TSharedPtr<Model::FLastGuildMasterActivity> FPromoteSeniorMemberResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FGuild> FPromoteSeniorMemberResult::GetGuild() const
    {
    ...
    TSharedPtr<FPromoteSeniorMemberResult> FPromoteSeniorMemberResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPromoteSeniorMemberResult>()
    ...
    TSharedPtr<FJsonObject> FPromoteSeniorMemberResult::ToJson() const
    {
