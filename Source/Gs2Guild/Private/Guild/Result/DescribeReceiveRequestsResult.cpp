...
namespace Gs2::Guild::Result
{
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FReceiveMemberRequest>>> FDescribeReceiveRequestsResult::GetItems() const
    {
    ...
    TSharedPtr<FDescribeReceiveRequestsResult> FDescribeReceiveRequestsResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FDescribeReceiveRequestsResult>()
            ->WithItems(Data->HasField("items") ? [Data]() -> TSharedPtr<TArray<Model::FReceiveMemberRequestPtr>>
                 {
