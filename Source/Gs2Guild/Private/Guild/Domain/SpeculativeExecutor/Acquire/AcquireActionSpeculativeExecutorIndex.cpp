...
namespace Gs2::Guild::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FIncreaseMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FIncreaseMaximumCurrentMaximumMemberCountByGuildNameRequest::FromJson(RequestModelJson);
            Request = FIncreaseMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FIncreaseMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
        ...
        if (FSetMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            TSharedPtr<FJsonObject> RequestModelJson;
            if (const TSharedRef<TJsonReader<>> JsonReader = TJsonReaderFactory<>::Create(NewAcquireAction->GetRequest().IsSet() ? *NewAcquireAction->GetRequest() : "{}");
                !FJsonSerializer::Deserialize(JsonReader, RequestModelJson))
            {
            ...
            auto Request = Request::FSetMaximumCurrentMaximumMemberCountByGuildNameRequest::FromJson(RequestModelJson);
            Request = FSetMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FSetMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
