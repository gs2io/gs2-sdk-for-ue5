...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    FDescribeJoinedGuildsByUserIdIterator::FDescribeJoinedGuildsByUserIdIterator(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeJoinedGuildsByUserIdIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FJoinedGuild>> Result)
    {
        ++Iterator;
    ...
    FDescribeJoinedGuildsByUserIdIterator::FIterator::FIterator(
    ...
    FDescribeJoinedGuildsByUserIdIterator::FIterator FDescribeJoinedGuildsByUserIdIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeJoinedGuildsByUserIdIterator::FIterator FDescribeJoinedGuildsByUserIdIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeJoinedGuildsByUserIdIterator::FIterator FDescribeJoinedGuildsByUserIdIterator::end()
    {
