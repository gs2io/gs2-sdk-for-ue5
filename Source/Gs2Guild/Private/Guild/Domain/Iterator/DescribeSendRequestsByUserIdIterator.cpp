...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeSendRequestsByUserIdIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FSendMemberRequest>> Result)
    {
        ++Iterator;
