...
namespace Gs2::Guild::Domain::Model
{
    ...
    FIgnoreUserAccessTokenDomain::FIgnoreUserAccessTokenDomain(
    ...
    FIgnoreUserAccessTokenDomain::FGetTask::FGetTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FIgnoreUserAccessTokenDomain::FGetTask::Action(
    ...
    TSharedPtr<FAsyncTask<FIgnoreUserAccessTokenDomain::FGetTask>> FIgnoreUserAccessTokenDomain::Get(
        Request::FGetIgnoreUserRequestPtr Request
    ) {
        return Gs2::Core::Util::New<FAsyncTask<FGetTask>>(this->AsShared(), Request);
    }

    FIgnoreUserAccessTokenDomain::FDeleteTask::FDeleteTask(
        const TSharedPtr<FIgnoreUserAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FIgnoreUserAccessTokenDomain::FDeleteTask::Action(
    ...
    TSharedPtr<FAsyncTask<FIgnoreUserAccessTokenDomain::FDeleteTask>> FIgnoreUserAccessTokenDomain::Delete(
        Request::FDeleteIgnoreUserRequestPtr Request
    ) {
        return Gs2::Core::Util::New<FAsyncTask<FDeleteTask>>(this->AsShared(), Request);
    }

    FString FIgnoreUserAccessTokenDomain::CreateCacheParentKey(
    ...
    FString FIgnoreUserAccessTokenDomain::CreateCacheKey(
    )
    {
        return "Singleton";
    }

    FIgnoreUserAccessTokenDomain::FModelTask::FModelTask(
        const TSharedPtr<FIgnoreUserAccessTokenDomain> Self
    ): Self(Self)
    {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FIgnoreUserAccessTokenDomain::FModelTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Guild::Model::FIgnoreUser>> Result
    )
    {
                ...
                const auto Error = Gs2::Guild::Model::Cache::FIgnoreUserCache::Fetch(
                    ...
                    [Self](Gs2::Guild::Model::FIgnoreUserPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Guild::Request::FGetIgnoreUserRequest>()
                        );
                        Future->StartSynchronousTask();
    ...
    TSharedPtr<FAsyncTask<FIgnoreUserAccessTokenDomain::FModelTask>> FIgnoreUserAccessTokenDomain::Model() {
        return Gs2::Core::Util::New<FAsyncTask<FIgnoreUserAccessTokenDomain::FModelTask>>(this->AsShared());
    }

    void FIgnoreUserAccessTokenDomain::Invalidate()
    {
        Gs2::Guild::Model::Cache::FIgnoreUserCache::Delete(
            Gs2->Cache,
    ...
    FIgnoreUserAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FIgnoreUserAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FIgnoreUserAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FIgnoreUserAccessTokenDomain::FSubscribeWithInitialCallTask>> FIgnoreUserAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Guild::Model::FIgnoreUserPtr)> Callback
    )
    {
    ...
    Gs2::Core::Domain::CallbackID FIgnoreUserAccessTokenDomain::Subscribe(
        TFunction<void(Gs2::Guild::Model::FIgnoreUserPtr)> Callback
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryGuildModelName, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FIgnoreUserAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryGuildModelName,
    ...
    void FIgnoreUserAccessTokenDomain::Unsubscribe(
