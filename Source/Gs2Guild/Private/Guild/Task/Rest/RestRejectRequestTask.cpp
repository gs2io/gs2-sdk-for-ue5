...
#include "Guild/Task/Rest/RejectRequestTask.h"
...
{
    FRejectRequestTask::FRejectRequestTask(
    ...
    FRejectRequestTask::FRejectRequestTask(
        const FRejectRequestTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FRejectRequestTask::Action(
        const TSharedPtr<Result::FRejectRequestResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/me/inbox/{fromUserId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRejectRequestResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
