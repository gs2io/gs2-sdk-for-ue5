...
#include "Guild/Task/Rest/DeleteRequestTask.h"
...
{
    FDeleteRequestTask::FDeleteRequestTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteRequestTask::Action(
        const TSharedPtr<Result::FDeleteRequestResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRequestResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
