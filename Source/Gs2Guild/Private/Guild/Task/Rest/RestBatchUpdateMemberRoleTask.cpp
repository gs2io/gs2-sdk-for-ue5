...
#include "Guild/Task/Rest/BatchUpdateMemberRoleTask.h"
...
{
    FBatchUpdateMemberRoleTask::FBatchUpdateMemberRoleTask(
    ...
    Core::Model::FGs2ErrorPtr FBatchUpdateMemberRoleTask::Action(
        const TSharedPtr<Result::FBatchUpdateMemberRoleResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/me/batch/member/role");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FBatchUpdateMemberRoleResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
