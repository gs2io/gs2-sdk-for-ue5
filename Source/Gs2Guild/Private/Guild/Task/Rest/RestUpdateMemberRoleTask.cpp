...
#include "Guild/Task/Rest/UpdateMemberRoleTask.h"
...
{
    FUpdateMemberRoleTask::FUpdateMemberRoleTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateMemberRoleTask::Action(
        const TSharedPtr<Result::FUpdateMemberRoleResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/me/member/{targetUserId}/role");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateMemberRoleResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
