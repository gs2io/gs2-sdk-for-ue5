...
#include "Guild/Task/Rest/GetReceiveRequestByGuildNameTask.h"
...
{
    FGetReceiveRequestByGuildNameTask::FGetReceiveRequestByGuildNameTask(
    ...
    Core::Model::FGs2ErrorPtr FGetReceiveRequestByGuildNameTask::Action(
        const TSharedPtr<Result::FGetReceiveRequestByGuildNameResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/{guildName}/inbox/{fromUserId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetReceiveRequestByGuildNameResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
