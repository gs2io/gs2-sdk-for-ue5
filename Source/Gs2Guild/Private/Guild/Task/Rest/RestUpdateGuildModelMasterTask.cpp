...
#include "Guild/Task/Rest/UpdateGuildModelMasterTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/{guildModelName}");
            ...
            if (this->Request->GetRoles() != nullptr && this->Request->GetRoles().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetRoles())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateGuildModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
