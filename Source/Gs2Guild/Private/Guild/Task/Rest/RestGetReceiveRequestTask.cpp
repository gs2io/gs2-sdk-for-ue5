...
#include "Guild/Task/Rest/GetReceiveRequestTask.h"
...
{
    FGetReceiveRequestTask::FGetReceiveRequestTask(
    ...
    Core::Model::FGs2ErrorPtr FGetReceiveRequestTask::Action(
        const TSharedPtr<Result::FGetReceiveRequestResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetReceiveRequestResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
