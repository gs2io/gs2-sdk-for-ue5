...
#include "Guild/Task/Rest/UpdateMemberRoleByGuildNameTask.h"
...
{
    FUpdateMemberRoleByGuildNameTask::FUpdateMemberRoleByGuildNameTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateMemberRoleByGuildNameTask::Action(
        const TSharedPtr<Result::FUpdateMemberRoleByGuildNameResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/{guildName}/member/{targetUserId}/role");
            ...
            if (this->Request->GetRoleName().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("roleName"), this->Request->GetRoleName().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateMemberRoleByGuildNameResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
