...
#include "Guild/Task/Rest/GetSendRequestByUserIdTask.h"
...
{
    FGetSendRequestByUserIdTask::FGetSendRequestByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSendRequestByUserIdTask::Action(
        const TSharedPtr<Result::FGetSendRequestByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/sendBox/guild/{guildModelName}/{targetGuildName}");
            ...
            Url = Url.Replace(
                TEXT("{targetGuildName}"),
                !this->Request->GetTargetGuildName().IsSet() || this->Request->GetTargetGuildName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetTargetGuildName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSendRequestByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
