...
#include "Guild/Task/Rest/DescribeJoinedGuildsTask.h"
...
{
    FDescribeJoinedGuildsTask::FDescribeJoinedGuildsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeJoinedGuildsTask::Action(
        const TSharedPtr<Result::FDescribeJoinedGuildsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/joined");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeJoinedGuildsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
