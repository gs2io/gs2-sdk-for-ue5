...
#include "Guild/Task/Rest/RejectRequestByGuildNameTask.h"
...
{
    FRejectRequestByGuildNameTask::FRejectRequestByGuildNameTask(
    ...
    Core::Model::FGs2ErrorPtr FRejectRequestByGuildNameTask::Action(
        const TSharedPtr<Result::FRejectRequestByGuildNameResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRejectRequestByGuildNameResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
