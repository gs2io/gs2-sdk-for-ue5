...
#include "Guild/Task/Rest/DescribeJoinedGuildsByUserIdTask.h"
...
{
    FDescribeJoinedGuildsByUserIdTask::FDescribeJoinedGuildsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeJoinedGuildsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeJoinedGuildsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/joined");
            ...
            if (this->Request->GetGuildModelName().IsSet()) {
                queryStrings.Add("guildModelName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetGuildModelName().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeJoinedGuildsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
