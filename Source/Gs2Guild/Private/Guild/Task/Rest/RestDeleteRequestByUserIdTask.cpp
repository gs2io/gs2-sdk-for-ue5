...
#include "Guild/Task/Rest/DeleteRequestByUserIdTask.h"
...
{
    FDeleteRequestByUserIdTask::FDeleteRequestByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteRequestByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteRequestByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRequestByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
