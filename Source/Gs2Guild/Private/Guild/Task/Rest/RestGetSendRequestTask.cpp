...
#include "Guild/Task/Rest/GetSendRequestTask.h"
...
{
    FGetSendRequestTask::FGetSendRequestTask(
    ...
    FGetSendRequestTask::FGetSendRequestTask(
        const FGetSendRequestTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetSendRequestTask::Action(
        const TSharedPtr<Result::FGetSendRequestResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/sendBox/guild/{guildModelName}/{targetGuildName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSendRequestResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
