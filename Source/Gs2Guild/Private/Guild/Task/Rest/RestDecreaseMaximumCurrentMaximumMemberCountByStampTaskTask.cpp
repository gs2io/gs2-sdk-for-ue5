...
#include "Guild/Task/Rest/DecreaseMaximumCurrentMaximumMemberCountByStampTaskTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/stamp/guild/currentMaximumMemberCount/sub");
            ...
            {
                JsonRootObject->SetStringField(TEXT("stampTask"), this->Request->GetStampTask().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDecreaseMaximumCurrentMaximumMemberCountByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
