...
#include "Guild/Task/Rest/CreateGuildByUserIdTask.h"
...
{
    FCreateGuildByUserIdTask::FCreateGuildByUserIdTask(
    ...
    FCreateGuildByUserIdTask::FCreateGuildByUserIdTask(
        const FCreateGuildByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FCreateGuildByUserIdTask::Action(
        const TSharedPtr<Result::FCreateGuildByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/guild/{guildModelName}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("memberMetadata"), this->Request->GetMemberMetadata().GetValue());
            }
            ...
            if (this->Request->GetCustomRoles() != nullptr && this->Request->GetCustomRoles().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetCustomRoles())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateGuildByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
