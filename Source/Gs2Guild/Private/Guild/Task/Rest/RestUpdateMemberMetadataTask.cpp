...
#include "Guild/Task/Rest/UpdateMemberMetadataTask.h"
...
{
    FUpdateMemberMetadataTask::FUpdateMemberMetadataTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateMemberMetadataTask::Action(
        const TSharedPtr<Result::FUpdateMemberMetadataResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/guild/{guildModelName}/guild/{guildName}/member/me/metadata");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateMemberMetadataResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
