...
#include "Guild/Task/Rest/AcceptRequestByGuildNameTask.h"
...
{
    FAcceptRequestByGuildNameTask::FAcceptRequestByGuildNameTask(
    ...
    Core::Model::FGs2ErrorPtr FAcceptRequestByGuildNameTask::Action(
        const TSharedPtr<Result::FAcceptRequestByGuildNameResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcceptRequestByGuildNameResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
