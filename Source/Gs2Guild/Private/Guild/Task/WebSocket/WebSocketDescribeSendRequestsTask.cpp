...
#include "Guild/Task/WebSocket/DescribeSendRequestsTask.h"
...
namespace Gs2::Guild::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("guild"), TEXT("sendMemberRequest"), TEXT("describeSendRequests"), ToCStr(RequestPayload->Payload()));
