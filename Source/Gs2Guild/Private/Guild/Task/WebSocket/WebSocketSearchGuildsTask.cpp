...
#include "Guild/Task/WebSocket/SearchGuildsTask.h"
...
namespace Gs2::Guild::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("guild"), TEXT("guild"), TEXT("searchGuilds"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FSearchGuildsResult::FromJson(WebSocketResult->Body());
