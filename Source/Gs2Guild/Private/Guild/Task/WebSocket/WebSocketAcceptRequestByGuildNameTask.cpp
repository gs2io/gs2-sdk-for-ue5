...
#include "Guild/Task/WebSocket/AcceptRequestByGuildNameTask.h"
...
namespace Gs2::Guild::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("guild"), TEXT("receiveMemberRequest"), TEXT("acceptRequestByGuildName"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FAcceptRequestByGuildNameResult::FromJson(WebSocketResult->Body());
