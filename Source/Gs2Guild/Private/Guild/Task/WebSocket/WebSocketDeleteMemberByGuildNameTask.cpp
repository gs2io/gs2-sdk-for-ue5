...
#include "Guild/Task/WebSocket/DeleteMemberByGuildNameTask.h"
...
namespace Gs2::Guild::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("guild"), TEXT("guild"), TEXT("deleteMemberByGuildName"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDeleteMemberByGuildNameResult::FromJson(WebSocketResult->Body());
