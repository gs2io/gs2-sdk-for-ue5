...
#include "Guild/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Guild::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("guild"), TEXT("currentGuildMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
