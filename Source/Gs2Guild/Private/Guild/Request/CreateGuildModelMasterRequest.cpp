...
namespace Gs2::Guild::Request
{
    ...
    TSharedPtr<FCreateGuildModelMasterRequest> FCreateGuildModelMasterRequest::WithInactivityPeriodDays(
    ...
    TSharedPtr<FCreateGuildModelMasterRequest> FCreateGuildModelMasterRequest::WithMaxConcurrentJoinGuilds(
    ...
    TSharedPtr<FCreateGuildModelMasterRequest> FCreateGuildModelMasterRequest::WithMaxConcurrentGuildMasterCount(
    ...
    TOptional<int32> FCreateGuildModelMasterRequest::GetInactivityPeriodDays() const
    {
        return InactivityPeriodDaysValue;
    }

    FString FCreateGuildModelMasterRequest::GetInactivityPeriodDaysString() const
    {
    ...
    TOptional<int32> FCreateGuildModelMasterRequest::GetMaxConcurrentJoinGuilds() const
    {
        return MaxConcurrentJoinGuildsValue;
    }

    FString FCreateGuildModelMasterRequest::GetMaxConcurrentJoinGuildsString() const
    {
    ...
    TOptional<int32> FCreateGuildModelMasterRequest::GetMaxConcurrentGuildMasterCount() const
    {
        return MaxConcurrentGuildMasterCountValue;
    }

    FString FCreateGuildModelMasterRequest::GetMaxConcurrentGuildMasterCountString() const
    {
