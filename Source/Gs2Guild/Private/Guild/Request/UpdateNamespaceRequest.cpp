...
namespace Gs2::Guild::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithChangeMemberNotificationIgnoreChangeMetadata(
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithReceiveJoinRequestScript(
    ...
    TOptional<bool> FUpdateNamespaceRequest::GetChangeMemberNotificationIgnoreChangeMetadata() const
    {
        return ChangeMemberNotificationIgnoreChangeMetadataValue;
    }

    FString FUpdateNamespaceRequest::GetChangeMemberNotificationIgnoreChangeMetadataString() const
    {
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetReceiveJoinRequestScript() const
    {
