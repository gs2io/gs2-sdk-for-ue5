...
namespace Gs2::Guild::Result
{
    ...
    public:
        ...
        FVerifyIncludeMemberByStampTaskResult();
        FVerifyIncludeMemberByStampTaskResult(
    ...
    typedef TSharedPtr<FVerifyIncludeMemberByStampTaskResult, ESPMode::ThreadSafe> FVerifyIncludeMemberByStampTaskResultPtr;
}