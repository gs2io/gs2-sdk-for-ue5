...
{
    class GS2GUILD_API FGetReceiveRequestResult final : public TSharedFromThis<FGetReceiveRequestResult>
    {
    ...
    public:
        ...
        TSharedPtr<FGetReceiveRequestResult> WithItem(const TSharedPtr<Model::FReceiveMemberRequest> Item);
