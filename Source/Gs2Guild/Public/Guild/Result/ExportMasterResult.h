...
{
    class GS2GUILD_API FExportMasterResult final : public TSharedFromThis<FExportMasterResult>
    {
    ...
    public:
        ...
        TSharedPtr<FExportMasterResult> WithItem(const TSharedPtr<Model::FCurrentGuildMaster> Item);
