...
{
    class GS2GUILD_API FGuildModel final : public FGs2Object, public TSharedFromThis<FGuildModel>
    {
    ...
    public:
        ...
        TSharedPtr<FGuildModel> WithInactivityPeriodDays(const TOptional<int32> InactivityPeriodDays);
