...
{
	class GS2GUILD_API FReceiveRequestNotification : public TSharedFromThis<FReceiveRequestNotification>
	{
	public:
        ...
        TSharedPtr<FReceiveRequestNotification> WithGuildModelName(
            const TOptional<FString> GuildModelName
        );
        TOptional<FString> GetGuildModelName() const;

        TSharedPtr<FReceiveRequestNotification> WithGuildName(
