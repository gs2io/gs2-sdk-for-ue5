...
namespace Gs2::Guild::Request
{
    ...
    typedef TSharedPtr<FIncreaseMaximumCurrentMaximumMemberCountByGuildNameRequest, ESPMode::ThreadSafe> FIncreaseMaximumCurrentMaximumMemberCountByGuildNameRequestPtr;
}