...
namespace Gs2::Guild::Request
{
    ...
    class GS2GUILD_API FGetSendRequestByUserIdRequest final : public TSharedFromThis<FGetSendRequestByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSendRequestByUserIdRequest> WithGuildModelName(const TOptional<FString> GuildModelName);
        TSharedPtr<FGetSendRequestByUserIdRequest> WithTargetGuildName(const TOptional<FString> TargetGuildName);
    ...
    typedef TSharedPtr<FGetSendRequestByUserIdRequest, ESPMode::ThreadSafe> FGetSendRequestByUserIdRequestPtr;
}