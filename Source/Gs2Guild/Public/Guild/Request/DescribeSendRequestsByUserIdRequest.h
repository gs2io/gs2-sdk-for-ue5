...
namespace Gs2::Guild::Request
{
    ...
    class GS2GUILD_API FDescribeSendRequestsByUserIdRequest final : public TSharedFromThis<FDescribeSendRequestsByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeSendRequestsByUserIdRequest> WithGuildModelName(const TOptional<FString> GuildModelName);
