...
namespace Gs2::Guild::Request
{
    ...
    class GS2GUILD_API FGetReceiveRequestRequest final : public TSharedFromThis<FGetReceiveRequestRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetReceiveRequestRequest> WithGuildModelName(const TOptional<FString> GuildModelName);
    ...
    typedef TSharedPtr<FGetReceiveRequestRequest> FGetReceiveRequestRequestPtr;
}