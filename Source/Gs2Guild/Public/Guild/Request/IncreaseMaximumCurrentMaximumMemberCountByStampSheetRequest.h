...
namespace Gs2::Guild::Request
{
    ...
    typedef TSharedPtr<FIncreaseMaximumCurrentMaximumMemberCountByStampSheetRequest, ESPMode::ThreadSafe> FIncreaseMaximumCurrentMaximumMemberCountByStampSheetRequestPtr;
}