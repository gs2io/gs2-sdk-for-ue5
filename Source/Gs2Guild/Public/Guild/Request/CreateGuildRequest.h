...
namespace Gs2::Guild::Request
{
    ...
    public:
        ...
        TSharedPtr<FCreateGuildRequest> WithMetadata(const TOptional<FString> Metadata);
        TSharedPtr<FCreateGuildRequest> WithMemberMetadata(const TOptional<FString> MemberMetadata);
