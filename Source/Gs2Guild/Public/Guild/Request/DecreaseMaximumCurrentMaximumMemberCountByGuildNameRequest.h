...
namespace Gs2::Guild::Request
{
    ...
    typedef TSharedPtr<FDecreaseMaximumCurrentMaximumMemberCountByGuildNameRequest, ESPMode::ThreadSafe> FDecreaseMaximumCurrentMaximumMemberCountByGuildNameRequestPtr;
}