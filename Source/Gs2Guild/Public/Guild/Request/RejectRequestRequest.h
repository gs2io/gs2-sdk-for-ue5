...
namespace Gs2::Guild::Request
{
    ...
    class GS2GUILD_API FRejectRequestRequest final : public TSharedFromThis<FRejectRequestRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FRejectRequestRequest> WithGuildModelName(const TOptional<FString> GuildModelName);
    ...
    typedef TSharedPtr<FRejectRequestRequest> FRejectRequestRequestPtr;
}