...
namespace Gs2::Guild::Domain::SpeculativeExecutor
{
    ...
    class GS2GUILD_API FVerifyCurrentMaximumMemberCountByGuildNameSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Guild::Request::FVerifyCurrentMaximumMemberCountByGuildNameRequestPtr Rate(
            const Gs2::Guild::Request::FVerifyCurrentMaximumMemberCountByGuildNameRequestPtr& Request,
            const double Rate
        );
