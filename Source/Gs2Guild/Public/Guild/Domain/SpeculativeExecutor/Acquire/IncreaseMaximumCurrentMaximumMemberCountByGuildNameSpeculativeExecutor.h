...
namespace Gs2::Guild::Domain::SpeculativeExecutor
{
    ...
    class GS2GUILD_API FIncreaseMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Guild::Request::FIncreaseMaximumCurrentMaximumMemberCountByGuildNameRequestPtr Rate(
            const Gs2::Guild::Request::FIncreaseMaximumCurrentMaximumMemberCountByGuildNameRequestPtr& Request,
            const double Rate
        );
