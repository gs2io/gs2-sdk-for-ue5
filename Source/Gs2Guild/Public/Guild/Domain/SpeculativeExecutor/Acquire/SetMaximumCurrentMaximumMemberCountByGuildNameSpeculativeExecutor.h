...
namespace Gs2::Guild::Domain::SpeculativeExecutor
{
    ...
    class GS2GUILD_API FSetMaximumCurrentMaximumMemberCountByGuildNameSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Guild::Request::FSetMaximumCurrentMaximumMemberCountByGuildNameRequestPtr Rate(
            const Gs2::Guild::Request::FSetMaximumCurrentMaximumMemberCountByGuildNameRequestPtr& Request,
            const double Rate
        );
