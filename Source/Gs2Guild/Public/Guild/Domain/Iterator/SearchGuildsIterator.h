...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FSearchGuildsIterator :
        public TSharedFromThis<FSearchGuildsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FSearchGuildsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FSearchGuildsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FSearchGuildsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FSearchGuildsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FSearchGuildsIterator> FSearchGuildsIteratorPtr;
}
