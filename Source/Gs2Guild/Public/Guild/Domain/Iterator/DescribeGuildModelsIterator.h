...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeGuildModelsIterator :
        public TSharedFromThis<FDescribeGuildModelsIterator>
    {
    ...
    public:
        ...
        class GS2GUILD_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Guild::Model::FGuildModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FGuildModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeGuildModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FGuildModelPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FGuildModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guild::Model::FGuildModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGuildModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGuildModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGuildModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGuildModelsIterator> FDescribeGuildModelsIteratorPtr;
}
