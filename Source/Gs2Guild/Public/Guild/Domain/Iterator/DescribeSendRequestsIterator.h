...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeSendRequestsIterator :
        public TSharedFromThis<FDescribeSendRequestsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FSendMemberRequest>> Result) override;
        ...
        {
            TSharedRef<FDescribeSendRequestsIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FSendMemberRequestPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FSendMemberRequestPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guild::Model::FSendMemberRequestPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSendRequestsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSendRequestsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSendRequestsIterator> Iterable)
            {
