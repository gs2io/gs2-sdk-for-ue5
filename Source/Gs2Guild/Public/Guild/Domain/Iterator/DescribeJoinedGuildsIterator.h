...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeJoinedGuildsIterator :
        public TSharedFromThis<FDescribeJoinedGuildsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeJoinedGuildsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeJoinedGuildsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeJoinedGuildsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeJoinedGuildsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeJoinedGuildsIterator> FDescribeJoinedGuildsIteratorPtr;
}
