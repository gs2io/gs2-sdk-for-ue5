...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeJoinedGuildsByUserIdIterator :
        public TSharedFromThis<FDescribeJoinedGuildsByUserIdIterator>
    {
    ...
    public:
        FDescribeJoinedGuildsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Guild::FGs2GuildRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        FDescribeJoinedGuildsByUserIdIterator(
            const FDescribeJoinedGuildsByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FJoinedGuild>> Result) override;
        ...
        {
            TSharedRef<FDescribeJoinedGuildsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FJoinedGuildPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FJoinedGuildPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeJoinedGuildsByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Guild::Model::FJoinedGuildPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeJoinedGuildsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeJoinedGuildsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeJoinedGuildsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeJoinedGuildsByUserIdIterator> FDescribeJoinedGuildsByUserIdIteratorPtr;
}
