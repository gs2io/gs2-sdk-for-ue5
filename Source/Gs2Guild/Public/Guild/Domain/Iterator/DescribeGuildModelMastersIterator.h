...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeGuildModelMastersIterator :
        public TSharedFromThis<FDescribeGuildModelMastersIterator>
    {
    ...
    public:
        FDescribeGuildModelMastersIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Guild::FGs2GuildRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FGuildModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeGuildModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FGuildModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FGuildModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guild::Model::FGuildModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGuildModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGuildModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGuildModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGuildModelMastersIterator> FDescribeGuildModelMastersIteratorPtr;
}
