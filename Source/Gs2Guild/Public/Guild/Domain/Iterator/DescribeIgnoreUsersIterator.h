...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeIgnoreUsersIterator :
        public TSharedFromThis<FDescribeIgnoreUsersIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeIgnoreUsersIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeIgnoreUsersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeIgnoreUsersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeIgnoreUsersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeIgnoreUsersIterator> FDescribeIgnoreUsersIteratorPtr;
}
