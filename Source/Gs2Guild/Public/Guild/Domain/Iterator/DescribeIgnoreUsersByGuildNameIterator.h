...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeIgnoreUsersByGuildNameIterator :
        public TSharedFromThis<FDescribeIgnoreUsersByGuildNameIterator>
    {
    ...
    public:
        FDescribeIgnoreUsersByGuildNameIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Guild::FGs2GuildRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> GuildModelName,
        ...
        FDescribeIgnoreUsersByGuildNameIterator(
            const FDescribeIgnoreUsersByGuildNameIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FIgnoreUser>> Result) override;
        ...
        {
            TSharedRef<FDescribeIgnoreUsersByGuildNameIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FIgnoreUserPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FIgnoreUserPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeIgnoreUsersByGuildNameIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Guild::Model::FIgnoreUserPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeIgnoreUsersByGuildNameIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeIgnoreUsersByGuildNameIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeIgnoreUsersByGuildNameIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeIgnoreUsersByGuildNameIterator> FDescribeIgnoreUsersByGuildNameIteratorPtr;
}
