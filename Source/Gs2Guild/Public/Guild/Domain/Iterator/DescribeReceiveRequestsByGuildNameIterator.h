...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeReceiveRequestsByGuildNameIterator :
        public TSharedFromThis<FDescribeReceiveRequestsByGuildNameIterator>
    {
    ...
    public:
        FDescribeReceiveRequestsByGuildNameIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Guild::FGs2GuildRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> GuildModelName,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FReceiveMemberRequest>> Result) override;
        ...
        {
            TSharedRef<FDescribeReceiveRequestsByGuildNameIterator> Self;
            TSharedPtr<TArray<Gs2::Guild::Model::FReceiveMemberRequestPtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FReceiveMemberRequestPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guild::Model::FReceiveMemberRequestPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeReceiveRequestsByGuildNameIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeReceiveRequestsByGuildNameIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeReceiveRequestsByGuildNameIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeReceiveRequestsByGuildNameIterator> FDescribeReceiveRequestsByGuildNameIteratorPtr;
}
