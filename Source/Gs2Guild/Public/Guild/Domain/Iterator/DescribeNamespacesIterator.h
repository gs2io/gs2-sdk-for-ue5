...
namespace Gs2::Guild::Domain::Iterator
{
    ...
    class GS2GUILD_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guild::Model::FNamespace>> Result) override;
        ...
        class GS2GUILD_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Guild::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Guild::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guild::Model::FNamespacePtr& Current()
            {
