...
namespace Gs2::Guild::Domain::Model
{
    ...
    class GS2GUILD_API FRoleModelDomain:
        public TSharedFromThis<FRoleModelDomain>
    {
    ...
    public:
        ...
        class GS2GUILD_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Guild::Model::FRoleModel>,
        ...
        {
            const TSharedPtr<FRoleModelDomain> Self;
            const TFunction<void(Gs2::Guild::Model::FRoleModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FRoleModelDomain> FRoleModelDomainPtr;
}
