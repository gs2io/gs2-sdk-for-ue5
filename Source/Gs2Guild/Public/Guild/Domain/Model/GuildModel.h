...
namespace Gs2::Guild::Domain::Model
{
    ...
    class GS2GUILD_API FGuildModelDomain:
        public TSharedFromThis<FGuildModelDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FGuildModelDomain> Self;
            const TFunction<void(Gs2::Guild::Model::FGuildModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FGuildModelDomain> FGuildModelDomainPtr;
}
