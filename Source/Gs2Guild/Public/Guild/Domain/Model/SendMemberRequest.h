...
namespace Gs2::Guild::Domain::Model
{
    ...
    class GS2GUILD_API FSendMemberRequestDomain:
        public TSharedFromThis<FSendMemberRequestDomain>
    {
    ...
    typedef TSharedPtr<FSendMemberRequestDomain> FSendMemberRequestDomainPtr;
}
