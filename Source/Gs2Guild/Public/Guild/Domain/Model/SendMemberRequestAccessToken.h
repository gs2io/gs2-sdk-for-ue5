...
namespace Gs2::Guild::Domain::Model
{
    ...
    class GS2GUILD_API FSendMemberRequestAccessTokenDomain:
        public TSharedFromThis<FSendMemberRequestAccessTokenDomain>
    {
    ...
    public:
        ...
        FSendMemberRequestAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Guild::Domain::FGs2GuildDomainPtr& Service,
    ...
    typedef TSharedPtr<FSendMemberRequestAccessTokenDomain> FSendMemberRequestAccessTokenDomainPtr;
}
