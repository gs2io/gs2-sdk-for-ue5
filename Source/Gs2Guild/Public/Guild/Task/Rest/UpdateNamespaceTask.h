...
#include "Guild/Result/UpdateNamespaceResult.h"

namespace Gs2::Guild::Task::Rest
{
    class GS2GUILD_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
