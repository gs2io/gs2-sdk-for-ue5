...
#include "Guild/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Guild/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::Rest
{
    class GS2GUILD_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
