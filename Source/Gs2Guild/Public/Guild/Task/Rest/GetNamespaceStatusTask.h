...
#include "Guild/Request/GetNamespaceStatusRequest.h"
#include "Guild/Result/GetNamespaceStatusResult.h"

namespace Gs2::Guild::Task::Rest
{
    class GS2GUILD_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
