...
#include "Guild/Request/GetNamespaceRequest.h"
#include "Guild/Result/GetNamespaceResult.h"

namespace Gs2::Guild::Task::Rest
{
    class GS2GUILD_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
