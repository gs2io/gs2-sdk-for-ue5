...
#include "Guild/Request/DescribeNamespacesRequest.h"
#include "Guild/Result/DescribeNamespacesResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
