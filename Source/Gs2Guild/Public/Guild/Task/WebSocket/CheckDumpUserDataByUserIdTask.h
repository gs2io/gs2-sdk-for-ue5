...
#include "Guild/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Guild/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
