...
#include "Guild/Result/CreateNamespaceResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
