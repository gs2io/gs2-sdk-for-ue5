...
#include "Guild/Request/DeleteNamespaceRequest.h"
#include "Guild/Result/DeleteNamespaceResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
