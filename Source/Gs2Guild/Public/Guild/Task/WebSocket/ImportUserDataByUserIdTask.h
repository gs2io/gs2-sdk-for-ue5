...
#include "Guild/Request/ImportUserDataByUserIdRequest.h"
#include "Guild/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
