...
#include "Guild/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Guild/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
