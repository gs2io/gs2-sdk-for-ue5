...
#include "Guild/Request/GetServiceVersionRequest.h"
#include "Guild/Result/GetServiceVersionResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
