...
#include "Guild/Request/CleanUserDataByUserIdRequest.h"
#include "Guild/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
