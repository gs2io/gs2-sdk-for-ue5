...
#include "Guild/Request/CheckImportUserDataByUserIdRequest.h"
#include "Guild/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Guild::Task::WebSocket
{
    class GS2GUILD_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
