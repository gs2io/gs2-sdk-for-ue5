...
namespace Gs2::Realtime::Request
{
    ...
    class GS2REALTIME_API FDeleteRoomRequest final : public TSharedFromThis<FDeleteRoomRequest>
    {
    ...
    typedef TSharedPtr<FDeleteRoomRequest, ESPMode::ThreadSafe> FDeleteRoomRequestPtr;
}