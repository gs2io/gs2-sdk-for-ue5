...
namespace Gs2::Realtime::Request
{
    ...
    class GS2REALTIME_API FGetRoomRequest final : public TSharedFromThis<FGetRoomRequest>
    {
    ...
    typedef TSharedPtr<FGetRoomRequest, ESPMode::ThreadSafe> FGetRoomRequestPtr;
}