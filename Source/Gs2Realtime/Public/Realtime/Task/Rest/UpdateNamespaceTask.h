...
#include "Realtime/Result/UpdateNamespaceResult.h"

namespace Gs2::Realtime::Task::Rest
{
    class GS2REALTIME_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
