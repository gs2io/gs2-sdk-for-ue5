...
#include "Realtime/Result/CreateNamespaceResult.h"

namespace Gs2::Realtime::Task::WebSocket
{
    class GS2REALTIME_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
