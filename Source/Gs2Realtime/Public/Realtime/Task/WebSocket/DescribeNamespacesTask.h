...
#include "Realtime/Request/DescribeNamespacesRequest.h"
#include "Realtime/Result/DescribeNamespacesResult.h"

namespace Gs2::Realtime::Task::WebSocket
{
    class GS2REALTIME_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
