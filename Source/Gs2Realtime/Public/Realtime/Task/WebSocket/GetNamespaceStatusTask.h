...
#include "Realtime/Request/GetNamespaceStatusRequest.h"
#include "Realtime/Result/GetNamespaceStatusResult.h"

namespace Gs2::Realtime::Task::WebSocket
{
    class GS2REALTIME_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
