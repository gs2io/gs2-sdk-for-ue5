...
#include "Realtime/Request/GetNamespaceRequest.h"
#include "Realtime/Result/GetNamespaceResult.h"

namespace Gs2::Realtime::Task::WebSocket
{
    class GS2REALTIME_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
