...
#include "Realtime/Request/GetServiceVersionRequest.h"
#include "Realtime/Result/GetServiceVersionResult.h"

namespace Gs2::Realtime::Task::WebSocket
{
    class GS2REALTIME_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
