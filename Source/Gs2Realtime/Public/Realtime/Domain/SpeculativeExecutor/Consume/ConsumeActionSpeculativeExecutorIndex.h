...
namespace Gs2::Realtime::Domain::SpeculativeExecutor
{
    class GS2REALTIME_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Realtime::Domain::FGs2RealtimeDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2REALTIME_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Realtime::Domain::FGs2RealtimeDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2REALTIME_API FCommitTask(
                const FCommitTask& From
            );

            GS2REALTIME_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
