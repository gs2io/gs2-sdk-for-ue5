...
namespace Gs2::Realtime::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Realtime::Model::FRoom>> Result) override;
        ...
        class GS2REALTIME_API FIterator
        {
            TSharedRef<FDescribeRoomsIterator> Self;
            TSharedPtr<TArray<Gs2::Realtime::Model::FRoomPtr>> Range;
            TOptional<TArray<Gs2::Realtime::Model::FRoomPtr>::TIterator> RangeIteratorOpt;
