...
namespace Gs2::Realtime::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Realtime::Model::FNamespace>> Result) override;
        ...
        class GS2REALTIME_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Realtime::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Realtime::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
