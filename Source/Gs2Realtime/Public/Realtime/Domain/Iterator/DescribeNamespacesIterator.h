...
namespace Gs2::Realtime::Domain::Iterator
{
    ...
    class GS2REALTIME_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Realtime::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2REALTIME_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Realtime::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::Realtime::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Realtime::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Realtime::Model::FNamespacePtr& operator*() const;
            Gs2::Realtime::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Realtime::Model::FNamespacePtr>>,
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(
            TSharedPtr<TSharedPtr<TArray<Gs2::Realtime::Model::FNamespacePtr>>> Result
        ) override;
    };
}
