...
namespace Gs2::Lottery::Model
{
    ...
    TSharedPtr<FPrizeLimit> FPrizeLimit::WithRevision(
    ...
    TOptional<int64> FPrizeLimit::GetRevision() const
    {
        return RevisionValue;
    }

    FString FPrizeLimit::GetRevisionString() const
    {
    ...
    TSharedPtr<FPrizeLimit> FPrizeLimit::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FPrizeLimit>()
            ->WithPrizeLimitId(Data->HasField(ANSI_TO_TCHAR("prizeLimitId")) ? [Data]() -> TOptional<FString>
                {
                    FString v("");
            ...
            ->WithDrawnCount(Data->HasField(ANSI_TO_TCHAR("drawnCount")) ? [Data]() -> TOptional<int32>
                {
                    int32 v;
                    if (Data->TryGetNumberField(ANSI_TO_TCHAR("drawnCount"), v))
                    {
                        return TOptional(v);
                    }
    ...
    TSharedPtr<FJsonObject> FPrizeLimit::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("prizeLimitId"), PrizeLimitIdValue.GetValue());
        }
        ...
        if (DrawnCountValue.IsSet())
        {
            JsonRootObject->SetNumberField(TEXT("drawnCount"), DrawnCountValue.GetValue());
        }
        if (CreatedAtValue.IsSet())
        {
...
{
    FString FPrizeLimitCache::CreateCacheParentKey(
    ...
    )
    {
        return FString("lottery:")
            ...
            + CacheOwnerArgumentPrizeTableName.Get(FString()) + FString(":")
            + FString::FromInt(CacheOwnerArgumentTimeOffset.Get(0)) + FString(":PrizeLimit");
    }

    FString FPrizeLimitCache::CreateCacheKey(
    ...
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Lottery::Model::FPrizeLimitPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Lottery::Model::FPrizeLimit>(
    ...
    )
    {
        ...
        Gs2::Lottery::Model::FPrizeLimitPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Lottery::Model::FPrizeLimit>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Lottery::Model::FPrizeLimit::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Lottery::Model::FPrizeLimit::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentPrizeTableName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FPrizeLimitCache::Fetch(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentPrizeTableName,
        TOptional<FString> CacheOwnerArgumentPrizeId,
    ...
    )
    {
        ...
        Gs2::Lottery::Model::FPrizeLimitPtr CacheOwnerFetchedItem;
        ...
        if (CacheOwnerDetails.IsValid() && CacheOwnerDetails->Num() > 0 && (*CacheOwnerDetails)[0].IsValid() && (*CacheOwnerDetails)[0]->GetComponent() == TEXT("prizeLimit"))
        {
            return nullptr;
        }
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
    ...
    Gs2::Core::Domain::CallbackID FPrizeLimitCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentPrizeTableName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        ...
        return CacheSnapshot->ListSubscribeTyped(Gs2::Lottery::Model::FPrizeLimit::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentPrizeTableName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Lottery::Model::FPrizeLimitPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Lottery::Model::FPrizeLimit>(CacheOwnerValue));
            if (CacheOwnerArgumentCallback) CacheOwnerArgumentCallback(CacheOwnerTypedValues);
        });
    }

    void FPrizeLimitCache::ListUnsubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentPrizeTableName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Lottery::Model::FPrizeLimit::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentPrizeTableName,
            CacheOwnerArgumentTimeOffset
