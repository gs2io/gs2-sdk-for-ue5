...
namespace Gs2::Lottery::Domain::SpeculativeExecutor
{
    ...
    FString FDrawByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Lottery:DrawByUserId");
    }

    FDrawByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
    ...
    TSharedPtr<FAsyncTask<FDrawByUserIdSpeculativeExecutor::FCommitTask>> FDrawByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Lottery::Domain::FGs2LotteryDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Lottery::Request::FDrawByUserIdRequestPtr& Request
    ...
    Gs2::Lottery::Request::FDrawByUserIdRequestPtr FDrawByUserIdSpeculativeExecutor::Rate(
        const Gs2::Lottery::Request::FDrawByUserIdRequestPtr& Request,
        const double Rate
    )
    {
