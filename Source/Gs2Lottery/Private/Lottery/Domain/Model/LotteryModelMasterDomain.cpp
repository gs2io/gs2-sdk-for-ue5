...
namespace Gs2::Lottery::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Lottery::Model::FLotteryModelMaster>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete<Gs2::Lottery::Model::FLotteryModelMaster>(ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Lottery::Model::FLotteryModelMaster>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Lottery::Model::FLotteryModelMaster>(
                            Self->ParentKey,
                            Gs2::Lottery::Domain::Model::FLotteryModelMasterDomain::CreateCacheKey(
                                Self->LotteryName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Lottery::Model::FLotteryModelMaster>(
                Self->ParentKey,
                Gs2::Lottery::Domain::Model::FLotteryModelMasterDomain::CreateCacheKey(
                    Self->LotteryName
                )
