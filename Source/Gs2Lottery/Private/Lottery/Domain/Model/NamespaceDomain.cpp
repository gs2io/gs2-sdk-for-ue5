...
namespace Gs2::Lottery::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Cache->Delete<Gs2::Lottery::Model::FNamespace>(ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Lottery::Model::FNamespace>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Lottery::Model::FNamespace>(
                            Self->ParentKey,
                            Gs2::Lottery::Domain::Model::FNamespaceDomain::CreateCacheKey(
                                Self->NamespaceName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Lottery::Model::FNamespace>(
                Self->ParentKey,
                Gs2::Lottery::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                )
