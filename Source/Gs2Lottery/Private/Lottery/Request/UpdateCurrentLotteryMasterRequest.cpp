...
namespace Gs2::Lottery::Request
{
    ...
    TSharedPtr<FUpdateCurrentLotteryMasterRequest> FUpdateCurrentLotteryMasterRequest::WithMode(
    ...
    TSharedPtr<FUpdateCurrentLotteryMasterRequest> FUpdateCurrentLotteryMasterRequest::WithUploadToken(
    ...
    TOptional<FString> FUpdateCurrentLotteryMasterRequest::GetMode() const
    {
        return ModeValue;
    }
    ...
    TOptional<FString> FUpdateCurrentLotteryMasterRequest::GetUploadToken() const
    {
