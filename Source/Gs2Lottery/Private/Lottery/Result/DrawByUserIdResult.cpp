...
namespace Gs2::Lottery::Result
{
    ...
    TSharedPtr<FDrawByUserIdResult> FDrawByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FDrawByUserIdResult> FDrawByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FDrawByUserIdResult> FDrawByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FDrawByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FDrawByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FDrawByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FDrawByUserIdResult::GetTransactionResult() const
    {
