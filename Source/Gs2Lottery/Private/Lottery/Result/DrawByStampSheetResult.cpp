...
#include "Lottery/Result/DrawByStampSheetResult.h"

namespace Gs2::Lottery::Result
{
    FDrawByStampSheetResult::FDrawByStampSheetResult():
        ItemsValue(nullptr),
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithItems(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithBoxItems(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithTransactionId(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithStampSheet(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithTransaction(
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::WithTransactionResult(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FDrawnPrize>>> FDrawByStampSheetResult::GetItems() const
    {
    ...
    TSharedPtr<Model::FBoxItems> FDrawByStampSheetResult::GetBoxItems() const
    {
    ...
    TOptional<FString> FDrawByStampSheetResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FDrawByStampSheetResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FDrawByStampSheetResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FDrawByStampSheetResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FDrawByStampSheetResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FDrawByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FDrawByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FDrawByStampSheetResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FDrawByStampSheetResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FDrawByStampSheetResult> FDrawByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDrawByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FDrawByStampSheetResult::ToJson() const
    {
        ...
        {
            JsonRootObject->SetObjectField(TEXT("boxItems"), BoxItemsValue->ToJson());
        }
