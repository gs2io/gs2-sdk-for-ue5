...
#include "Lottery/Task/Rest/GetBoxByUserIdTask.h"
...
{
    FGetBoxByUserIdTask::FGetBoxByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetBoxByUserIdTask::Action(
        const TSharedPtr<Result::FGetBoxByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBoxByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
