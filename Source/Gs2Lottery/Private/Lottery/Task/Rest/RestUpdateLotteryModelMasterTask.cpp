...
#include "Lottery/Task/Rest/UpdateLotteryModelMasterTask.h"
...
{
    FUpdateLotteryModelMasterTask::FUpdateLotteryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateLotteryModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateLotteryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/lottery/{lotteryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateLotteryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
