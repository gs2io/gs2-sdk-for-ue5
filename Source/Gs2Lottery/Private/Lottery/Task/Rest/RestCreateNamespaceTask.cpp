...
#include "Lottery/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Lottery::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetStringField(TEXT("lotteryTriggerScriptId"), this->Request->GetLotteryTriggerScriptId().GetValue());
            }
