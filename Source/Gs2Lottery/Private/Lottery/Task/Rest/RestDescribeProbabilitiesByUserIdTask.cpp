...
#include "Lottery/Task/Rest/DescribeProbabilitiesByUserIdTask.h"
...
{
    FDescribeProbabilitiesByUserIdTask::FDescribeProbabilitiesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeProbabilitiesByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeProbabilitiesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/lottery/{lotteryName}/probability");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeProbabilitiesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
