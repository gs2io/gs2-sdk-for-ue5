...
#include "Lottery/Task/Rest/PredictionByUserIdTask.h"
...
{
    FPredictionByUserIdTask::FPredictionByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FPredictionByUserIdTask::Action(
        const TSharedPtr<Result::FPredictionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/lottery/{lotteryName}/prediction");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPredictionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
