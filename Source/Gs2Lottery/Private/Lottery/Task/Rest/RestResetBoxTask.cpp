...
#include "Lottery/Task/Rest/ResetBoxTask.h"
...
namespace Gs2::Lottery::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FResetBoxTask::Action(
        const TSharedPtr<Result::FResetBoxResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/box/{prizeTableName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FResetBoxResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
