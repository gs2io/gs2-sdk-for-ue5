...
#include "Lottery/Task/Rest/DeleteLotteryModelMasterTask.h"
...
{
    FDeleteLotteryModelMasterTask::FDeleteLotteryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteLotteryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteLotteryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteLotteryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
