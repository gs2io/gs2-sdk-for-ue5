...
#include "Lottery/Task/Rest/PredictionTask.h"
...
{
    FPredictionTask::FPredictionTask(
    ...
    Core::Model::FGs2ErrorPtr FPredictionTask::Action(
        const TSharedPtr<Result::FPredictionResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/lottery/{lotteryName}/prediction");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPredictionResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
