...
#include "Lottery/Task/Rest/GetPrizeTableMasterTask.h"
...
{
    FGetPrizeTableMasterTask::FGetPrizeTableMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetPrizeTableMasterTask::Action(
        const TSharedPtr<Result::FGetPrizeTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPrizeTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
