...
#include "Lottery/Task/Rest/DescribeProbabilitiesTask.h"
...
{
    FDescribeProbabilitiesTask::FDescribeProbabilitiesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeProbabilitiesTask::Action(
        const TSharedPtr<Result::FDescribeProbabilitiesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/lottery/{lotteryName}/probability");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeProbabilitiesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
