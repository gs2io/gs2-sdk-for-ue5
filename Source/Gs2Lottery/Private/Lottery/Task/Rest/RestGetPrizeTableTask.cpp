...
#include "Lottery/Task/Rest/GetPrizeTableTask.h"
...
{
    FGetPrizeTableTask::FGetPrizeTableTask(
    ...
    FGetPrizeTableTask::FGetPrizeTableTask(
        const FGetPrizeTableTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPrizeTableTask::Action(
        const TSharedPtr<Result::FGetPrizeTableResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/table/{prizeTableName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPrizeTableResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
