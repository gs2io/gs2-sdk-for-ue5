...
#include "Lottery/Task/Rest/ResetPrizeLimitTask.h"
...
{
    FResetPrizeLimitTask::FResetPrizeLimitTask(
    ...
    Core::Model::FGs2ErrorPtr FResetPrizeLimitTask::Action(
        const TSharedPtr<Result::FResetPrizeLimitResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/prizeLimit/{prizeTableName}/{prizeId}");
            ...
            Url = Url.Replace(
                TEXT("{prizeId}"),
                !this->Request->GetPrizeId().IsSet() || this->Request->GetPrizeId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetPrizeId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FResetPrizeLimitResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
