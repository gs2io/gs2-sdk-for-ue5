...
#include "Lottery/Task/Rest/DescribePrizeLimitsTask.h"
...
{
    FDescribePrizeLimitsTask::FDescribePrizeLimitsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribePrizeLimitsTask::Action(
        const TSharedPtr<Result::FDescribePrizeLimitsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/prizeLimit/{prizeTableName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribePrizeLimitsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
