...
#include "Lottery/Task/Rest/GetPrizeLimitTask.h"
...
{
    FGetPrizeLimitTask::FGetPrizeLimitTask(
    ...
    Core::Model::FGs2ErrorPtr FGetPrizeLimitTask::Action(
        const TSharedPtr<Result::FGetPrizeLimitResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPrizeLimitResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
