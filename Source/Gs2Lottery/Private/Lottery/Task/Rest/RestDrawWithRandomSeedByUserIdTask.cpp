...
#include "Lottery/Task/Rest/DrawWithRandomSeedByUserIdTask.h"
...
{
    FDrawWithRandomSeedByUserIdTask::FDrawWithRandomSeedByUserIdTask(
    ...
    FDrawWithRandomSeedByUserIdTask::FDrawWithRandomSeedByUserIdTask(
        const FDrawWithRandomSeedByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDrawWithRandomSeedByUserIdTask::Action(
        const TSharedPtr<Result::FDrawWithRandomSeedByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/lottery/{lotteryName}/draw/withSeed");
            ...
            Url = Url.Replace(
                TEXT("{lotteryName}"),
                !this->Request->GetLotteryName().IsSet() || this->Request->GetLotteryName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetLotteryName())
            );
            Url = Url.Replace(
                TEXT("{userId}"),
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDrawWithRandomSeedByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
