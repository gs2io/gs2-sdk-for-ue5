...
#include "Lottery/Task/Rest/GetBoxTask.h"
...
namespace Gs2::Lottery::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetBoxTask::Action(
        const TSharedPtr<Result::FGetBoxResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBoxResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
