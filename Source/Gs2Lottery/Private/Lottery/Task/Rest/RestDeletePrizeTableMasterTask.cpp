...
#include "Lottery/Task/Rest/DeletePrizeTableMasterTask.h"
...
{
    FDeletePrizeTableMasterTask::FDeletePrizeTableMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeletePrizeTableMasterTask::Action(
        const TSharedPtr<Result::FDeletePrizeTableMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePrizeTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
