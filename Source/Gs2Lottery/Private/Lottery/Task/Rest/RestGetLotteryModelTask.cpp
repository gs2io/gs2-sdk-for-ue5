...
#include "Lottery/Task/Rest/GetLotteryModelTask.h"
...
{
    FGetLotteryModelTask::FGetLotteryModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetLotteryModelTask::Action(
        const TSharedPtr<Result::FGetLotteryModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/lottery/{lotteryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLotteryModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
