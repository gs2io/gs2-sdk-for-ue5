...
#include "Lottery/Task/Rest/GetLotteryModelMasterTask.h"
...
{
    FGetLotteryModelMasterTask::FGetLotteryModelMasterTask(
    ...
    FGetLotteryModelMasterTask::FGetLotteryModelMasterTask(
        const FGetLotteryModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetLotteryModelMasterTask::Action(
        const TSharedPtr<Result::FGetLotteryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLotteryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
