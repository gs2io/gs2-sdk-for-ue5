...
#include "Lottery/Task/Rest/CreatePrizeTableMasterTask.h"
...
{
    FCreatePrizeTableMasterTask::FCreatePrizeTableMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreatePrizeTableMasterTask::Action(
        const TSharedPtr<Result::FCreatePrizeTableMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/table");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreatePrizeTableMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
