...
#include "Lottery/Task/Rest/ResetBoxByUserIdTask.h"
...
{
    FResetBoxByUserIdTask::FResetBoxByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FResetBoxByUserIdTask::Action(
        const TSharedPtr<Result::FResetBoxByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/box/{prizeTableName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FResetBoxByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
