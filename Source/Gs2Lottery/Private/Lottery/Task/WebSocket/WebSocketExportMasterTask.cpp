...
#include "Lottery/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Lottery::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("lottery"), TEXT("currentLotteryMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
