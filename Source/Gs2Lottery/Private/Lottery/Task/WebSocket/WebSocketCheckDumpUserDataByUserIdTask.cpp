...
#include "Lottery/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Lottery::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("lottery"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
