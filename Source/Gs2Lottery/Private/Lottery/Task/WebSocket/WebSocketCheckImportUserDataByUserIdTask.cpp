...
#include "Lottery/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::Lottery::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("lottery"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
