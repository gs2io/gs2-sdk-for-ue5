...
#include "Lottery/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Lottery/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::WebSocket
{
    class GS2LOTTERY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
