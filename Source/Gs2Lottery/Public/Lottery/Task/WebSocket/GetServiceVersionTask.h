...
#include "Lottery/Request/GetServiceVersionRequest.h"
#include "Lottery/Result/GetServiceVersionResult.h"

namespace Gs2::Lottery::Task::WebSocket
{
    class GS2LOTTERY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
