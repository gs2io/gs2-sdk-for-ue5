...
#include "Lottery/Request/DeleteNamespaceRequest.h"
#include "Lottery/Result/DeleteNamespaceResult.h"

namespace Gs2::Lottery::Task::WebSocket
{
    class GS2LOTTERY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
