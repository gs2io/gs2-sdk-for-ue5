...
#include "Lottery/Request/DescribeNamespacesRequest.h"
#include "Lottery/Result/DescribeNamespacesResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
