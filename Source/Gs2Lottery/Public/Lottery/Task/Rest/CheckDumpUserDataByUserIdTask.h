...
#include "Lottery/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Lottery/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
