...
#include "Lottery/Request/ImportUserDataByUserIdRequest.h"
#include "Lottery/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
