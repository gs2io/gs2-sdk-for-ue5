...
#include "Lottery/Result/CreateNamespaceResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
