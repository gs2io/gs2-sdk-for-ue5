...
#include "Lottery/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Lottery/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
