...
#include "Lottery/Request/CleanUserDataByUserIdRequest.h"
#include "Lottery/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
