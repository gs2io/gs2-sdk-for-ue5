...
#include "Lottery/Request/GetNamespaceRequest.h"
#include "Lottery/Result/GetNamespaceResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
