...
#include "Lottery/Request/CheckImportUserDataByUserIdRequest.h"
#include "Lottery/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
