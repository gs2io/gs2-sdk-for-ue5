...
#include "Lottery/Request/GetNamespaceStatusRequest.h"
#include "Lottery/Result/GetNamespaceStatusResult.h"

namespace Gs2::Lottery::Task::Rest
{
    class GS2LOTTERY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
