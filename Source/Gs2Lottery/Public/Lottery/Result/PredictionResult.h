...
{
    class GS2LOTTERY_API FPredictionResult final : public TSharedFromThis<FPredictionResult>
    {
    ...
    public:
        ...
        TSharedPtr<FPredictionResult> WithItems(const TSharedPtr<TArray<TSharedPtr<Model::FDrawnPrize>>> Items);
