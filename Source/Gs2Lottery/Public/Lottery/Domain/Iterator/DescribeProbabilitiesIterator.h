...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribeProbabilitiesIterator :
        public TSharedFromThis<FDescribeProbabilitiesIterator>
    {
    ...
    public:
        ...
        class GS2LOTTERY_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Lottery::Model::FProbability>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FProbability>> Result) override;
        ...
        {
            TSharedRef<FDescribeProbabilitiesIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FProbabilityPtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FProbabilityPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeProbabilitiesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeProbabilitiesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeProbabilitiesIterator> Iterable)
            {
