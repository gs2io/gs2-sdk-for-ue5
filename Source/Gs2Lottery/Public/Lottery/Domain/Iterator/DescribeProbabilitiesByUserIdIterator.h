...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeProbabilitiesByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeProbabilitiesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeProbabilitiesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeProbabilitiesByUserIdIterator> Iterable)
            {
