...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribeLotteryModelsIterator :
        public TSharedFromThis<FDescribeLotteryModelsIterator>
    {
    ...
    public:
        FDescribeLotteryModelsIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Lottery::FGs2LotteryRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FLotteryModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeLotteryModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FLotteryModelPtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FLotteryModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Lottery::Model::FLotteryModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLotteryModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLotteryModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLotteryModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeLotteryModelsIterator> FDescribeLotteryModelsIteratorPtr;
}
