...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribePrizeTableMastersIterator :
        public TSharedFromThis<FDescribePrizeTableMastersIterator>
    {
    ...
    public:
        ...
        FDescribePrizeTableMastersIterator(
            const FDescribePrizeTableMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FPrizeTableMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribePrizeTableMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FPrizeTableMasterPtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FPrizeTableMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribePrizeTableMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribePrizeTableMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribePrizeTableMastersIterator> Iterable)
            {
