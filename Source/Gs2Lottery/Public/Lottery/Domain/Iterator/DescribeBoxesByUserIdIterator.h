...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribeBoxesByUserIdIterator :
        public TSharedFromThis<FDescribeBoxesByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FBoxItems>> Result) override;
        ...
        {
            TSharedRef<FDescribeBoxesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FBoxItemsPtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FBoxItemsPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBoxesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBoxesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBoxesByUserIdIterator> Iterable)
            {
