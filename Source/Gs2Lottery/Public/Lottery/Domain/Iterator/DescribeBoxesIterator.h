...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeBoxesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBoxesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBoxesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBoxesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBoxesIterator> FDescribeBoxesIteratorPtr;
}
