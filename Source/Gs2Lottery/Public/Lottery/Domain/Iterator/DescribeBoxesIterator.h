...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class FDescribeBoxesIteratorLoadTask;

    class GS2LOTTERY_API FDescribeBoxesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Lottery::Model::FBoxItems, FDescribeBoxesIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Lottery::FGs2LotteryRestClientPtr Client;

        friend FDescribeBoxesIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeBoxesIteratorLoadTask>> Load() override;
...
public:
    ...
    {
        TSharedPtr<FDescribeBoxesIterator> Self;
