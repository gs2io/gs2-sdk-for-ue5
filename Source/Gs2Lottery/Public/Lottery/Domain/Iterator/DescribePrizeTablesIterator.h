...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribePrizeTablesIterator :
        public TSharedFromThis<FDescribePrizeTablesIterator>
    {
    ...
    public:
        ...
        FDescribePrizeTablesIterator(
            const FDescribePrizeTablesIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FPrizeTable>> Result) override;
        ...
        {
            TSharedRef<FDescribePrizeTablesIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FPrizeTablePtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FPrizeTablePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribePrizeTablesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribePrizeTablesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribePrizeTablesIterator> Iterable)
            {
