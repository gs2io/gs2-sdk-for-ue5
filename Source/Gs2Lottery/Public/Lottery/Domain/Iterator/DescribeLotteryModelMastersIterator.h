...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FLotteryModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeLotteryModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Lottery::Model::FLotteryModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FLotteryModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLotteryModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLotteryModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLotteryModelMastersIterator> Iterable)
            {
