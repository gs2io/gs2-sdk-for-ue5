...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    class GS2LOTTERY_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Lottery::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2LOTTERY_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Lottery::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::Lottery::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Lottery::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Lottery::Model::FNamespacePtr& operator*() const;
            Gs2::Lottery::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Lottery::Model::FNamespacePtr>>,
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(
            TSharedPtr<TSharedPtr<TArray<Gs2::Lottery::Model::FNamespacePtr>>> Result
        ) override;
    };
}
