...
namespace Gs2::Lottery::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lottery::Model::FNamespace>> Result) override;
        ...
        class GS2LOTTERY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Lottery::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Lottery::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
