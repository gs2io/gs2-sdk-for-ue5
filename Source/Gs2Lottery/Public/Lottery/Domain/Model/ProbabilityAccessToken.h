...
namespace Gs2::Lottery::Domain::Model
{
    ...
    class GS2LOTTERY_API FProbabilityAccessTokenDomain:
        public TSharedFromThis<FProbabilityAccessTokenDomain>
    {
    ...
    typedef TSharedPtr<FProbabilityAccessTokenDomain> FProbabilityAccessTokenDomainPtr;
}
