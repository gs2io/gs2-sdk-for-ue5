...
namespace Gs2::Lottery::Domain::Model
{
    ...
    class GS2LOTTERY_API FDrawnPrizeDomain:
        public TSharedFromThis<FDrawnPrizeDomain>
    {
    ...
    public:
        ...
        class GS2LOTTERY_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Lottery::Model::FDrawnPrize>,
        ...
        {
            const TSharedPtr<FDrawnPrizeDomain> Self;
            const TFunction<void(Gs2::Lottery::Model::FDrawnPrizePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FDrawnPrizeDomain> FDrawnPrizeDomainPtr;
}
