...
{
    class GS2LOTTERY_API FDrawWithRandomSeedByUserIdSpeculativeExecutor
    {
    public:
        static FString Action();

        class GS2LOTTERY_API FCommitTask final :
        ...
        static TSharedPtr<FAsyncTask<FDrawWithRandomSeedByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Lottery::Domain::FGs2LotteryDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Lottery::Request::FDrawWithRandomSeedByUserIdRequestPtr& Request
