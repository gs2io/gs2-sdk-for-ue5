...
namespace Gs2::Lottery::Model
{
    ...
    public:
        ...
        static TSharedPtr<FCurrentLotteryMaster> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;

        static FString TypeName;
    };
    typedef TSharedPtr<FCurrentLotteryMaster, ESPMode::ThreadSafe> FCurrentLotteryMasterPtr;
}