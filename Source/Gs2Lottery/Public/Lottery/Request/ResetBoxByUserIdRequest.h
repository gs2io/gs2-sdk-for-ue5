...
{
    class FResetBoxByUserIdRequest;

    class GS2LOTTERY_API FResetBoxByUserIdRequest final : public TSharedFromThis<FResetBoxByUserIdRequest>
    {
    ...
    public:
        ...
        FResetBoxByUserIdRequest();
        FResetBoxByUserIdRequest(
            const FResetBoxByUserIdRequest& From
        );
        ~FResetBoxByUserIdRequest() = default;

        TSharedPtr<FResetBoxByUserIdRequest> WithContextStack(const TOptional<FString> ContextStack);
    ...
    typedef TSharedPtr<FResetBoxByUserIdRequest, ESPMode::ThreadSafe> FResetBoxByUserIdRequestPtr;
}