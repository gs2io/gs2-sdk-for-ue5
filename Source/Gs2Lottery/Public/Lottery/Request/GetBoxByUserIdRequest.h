...
namespace Gs2::Lottery::Request
{
    ...
    public:
        ...
        TSharedPtr<FGetBoxByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FGetBoxByUserIdRequest> FGetBoxByUserIdRequestPtr;
}