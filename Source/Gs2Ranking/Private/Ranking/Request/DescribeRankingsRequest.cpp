...
namespace Gs2::Ranking::Request
{
    ...
    TSharedPtr<FDescribeRankingsRequest> FDescribeRankingsRequest::WithAdditionalScopeName(
    ...
    TOptional<FString> FDescribeRankingsRequest::GetAdditionalScopeName() const
    {
    ...
    TSharedPtr<FDescribeRankingsRequest> FDescribeRankingsRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FDescribeRankingsRequest>()
            ...
            ->WithStartIndex(Data->HasField(ANSI_TO_TCHAR("startIndex")) ? [Data]() -> TOptional<int64>
              {
                  int64 v;
                    if (Data->TryGetNumberField(ANSI_TO_TCHAR("startIndex"), v))
                  {
                        return TOptional(v);
                  }
    ...
    TSharedPtr<FJsonObject> FDescribeRankingsRequest::ToJson() const
    {
        ...
        if (StartIndexValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("startIndex"), FString::Printf(TEXT("%lld"), StartIndexValue.GetValue()));
        }
