...
namespace Gs2::Ranking::Request
{
    ...
    TSharedPtr<FCreateCategoryModelMasterRequest> FCreateCategoryModelMasterRequest::WithGlobalRankingSetting(
    ...
    TSharedPtr<Model::FGlobalRankingSetting> FCreateCategoryModelMasterRequest::GetGlobalRankingSetting() const
    {
