...
namespace Gs2::Ranking::Request
{
    ...
    TSharedPtr<FUnsubscribeRequest> FUnsubscribeRequest::WithCategoryName(
    ...
    TSharedPtr<FUnsubscribeRequest> FUnsubscribeRequest::WithTargetUserId(
    ...
    TOptional<FString> FUnsubscribeRequest::GetCategoryName() const
    {
    ...
    TOptional<FString> FUnsubscribeRequest::GetTargetUserId() const
    {
