...
#include "Ranking/Request/DescribeNearRankingsRequest.h"
...
namespace Gs2::Ranking::Request
{
    ...
    TSharedPtr<FDescribeNearRankingsRequest> FDescribeNearRankingsRequest::WithContextStack(
    ...
    TSharedPtr<FDescribeNearRankingsRequest> FDescribeNearRankingsRequest::WithNamespaceName(
    ...
    TSharedPtr<FDescribeNearRankingsRequest> FDescribeNearRankingsRequest::WithCategoryName(
    ...
    TOptional<FString> FDescribeNearRankingsRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FDescribeNearRankingsRequest::GetNamespaceName() const
    {
    ...
    FString FDescribeNearRankingsRequest::GetScoreString() const
    {
        if (!ScoreValue.IsSet())
        {
            return FString("null");
    ...
    TSharedPtr<FDescribeNearRankingsRequest> FDescribeNearRankingsRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDescribeNearRankingsRequest>()
    ...
    TSharedPtr<FJsonObject> FDescribeNearRankingsRequest::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("additionalScopeName"), AdditionalScopeNameValue.GetValue());
        }
        if (ScoreValue.IsSet())
        {
