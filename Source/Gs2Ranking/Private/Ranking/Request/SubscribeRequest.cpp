...
namespace Gs2::Ranking::Request
{
    ...
    TSharedPtr<FSubscribeRequest> FSubscribeRequest::WithCategoryName(
    ...
    TSharedPtr<FSubscribeRequest> FSubscribeRequest::WithTargetUserId(
    ...
    TOptional<FString> FSubscribeRequest::GetCategoryName() const
    {
    ...
    TOptional<FString> FSubscribeRequest::GetTargetUserId() const
    {
