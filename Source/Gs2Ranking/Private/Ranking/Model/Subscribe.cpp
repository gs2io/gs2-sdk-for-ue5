...
namespace Gs2::Ranking::Model
{
    ...
    TSharedPtr<FJsonObject> FSubscribe::ToJson() const
    {
        ...
        if (SubscribedUserIdsValue != nullptr && SubscribedUserIdsValue.IsValid())
        {
            ...
            JsonRootObject->SetArrayField(TEXT("subscribedUserIds"), v);
        }
        if (CreatedAtValue.IsSet())
        {
...
namespace Gs2::Ranking::Model::Cache
{
    ...
    bool FSubscribeCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentAdditionalScopeName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Ranking::Model::FSubscribePtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        Gs2::Ranking::Model::FSubscribePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Ranking::Model::FSubscribe>(
    ...
    void FSubscribeCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentAdditionalScopeName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Ranking::Model::FSubscribePtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Ranking::Model::FSubscribePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Ranking::Model::FSubscribe>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
    ...
    )
    {
        ...
        if (!CacheSnapshot.IsValid()) return;
        if (!CacheOwnerArgumentUserId.IsSet()) return;
        CacheSnapshot->Delete(Gs2::Ranking::Model::FSubscribe::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentCategoryName,
            CacheOwnerArgumentAdditionalScopeName,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSubscribeCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentAdditionalScopeName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Ranking::Model::FSubscribePtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Ranking::Model::FSubscribePtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Ranking::Model::FSubscribePtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FSubscribeCache::ListSubscribe(
        ...
        TOptional<FString> CacheOwnerArgumentAdditionalScopeName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Ranking::Model::FSubscribePtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Ranking::Model::FSubscribe::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentCategoryName,
            CacheOwnerArgumentAdditionalScopeName,
        ...
        {
            TArray<Gs2::Ranking::Model::FSubscribePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Ranking::Model::FSubscribe>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Ranking::Model::FSubscribe::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentCategoryName,
            CacheOwnerArgumentAdditionalScopeName,
