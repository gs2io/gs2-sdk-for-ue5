...
#include "Ranking/Task/Rest/DescribeScoresByUserIdTask.h"
...
{
    FDescribeScoresByUserIdTask::FDescribeScoresByUserIdTask(
    ...
    FDescribeScoresByUserIdTask::FDescribeScoresByUserIdTask(
        const FDescribeScoresByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDescribeScoresByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeScoresByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/category/{categoryName}/scorer/{scorerUserId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeScoresByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
