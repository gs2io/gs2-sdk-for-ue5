...
#include "Ranking/Task/Rest/DescribeScoresTask.h"
...
{
    FDescribeScoresTask::FDescribeScoresTask(
    ...
    FDescribeScoresTask::FDescribeScoresTask(
        const FDescribeScoresTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDescribeScoresTask::Action(
        const TSharedPtr<Result::FDescribeScoresResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/category/{categoryName}/scorer/{scorerUserId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeScoresResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
