...
#include "Ranking/Task/Rest/GetScoreByUserIdTask.h"
...
{
    FGetScoreByUserIdTask::FGetScoreByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetScoreByUserIdTask::Action(
        const TSharedPtr<Result::FGetScoreByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/category/{categoryName}/scorer/{scorerUserId}/score/{uniqueId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetScoreByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
