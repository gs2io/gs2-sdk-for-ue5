...
#include "Ranking/Task/WebSocket/DescribeCategoryModelsTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("categoryModel"), TEXT("describeCategoryModels"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDescribeCategoryModelsResult::FromJson(WebSocketResult->Body());
