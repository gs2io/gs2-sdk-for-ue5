...
#include "Ranking/Task/WebSocket/CreateCategoryModelMasterTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("categoryModelMaster"), TEXT("createCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateCategoryModelMasterResult::FromJson(WebSocketResult->Body());
