...
#include "Ranking/Task/WebSocket/UpdateCategoryModelMasterTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("categoryModelMaster"), TEXT("updateCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateCategoryModelMasterResult::FromJson(WebSocketResult->Body());
