...
#include "Ranking/Task/WebSocket/DeleteCategoryModelMasterTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("categoryModelMaster"), TEXT("deleteCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
