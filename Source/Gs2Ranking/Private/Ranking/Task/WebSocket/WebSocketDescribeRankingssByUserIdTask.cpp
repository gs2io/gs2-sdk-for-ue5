...
#include "Ranking/Task/WebSocket/DescribeRankingssByUserIdTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("ranking"), TEXT("describeRankingssByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDescribeRankingssByUserIdResult::FromJson(WebSocketResult->Body());
