...
#include "Ranking/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Ranking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking"), TEXT("currentRankingMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
