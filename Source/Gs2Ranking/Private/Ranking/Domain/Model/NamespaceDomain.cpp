...
namespace Gs2::Ranking::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Ranking::Model::Cache::FNamespaceCache::Delete(
            Self->Gs2->Cache,
    ...
    )
    {
        ...
        Gs2::Ranking::Model::Cache::FCategoryModelMasterCache::Put(
            Self->Gs2->Cache,
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Ranking::Model::Cache::FCategoryModelCache::CreateCacheParentKey(
                NamespaceName,
                TOptional<int32>()
            ),
            Callback,
    ...
    class FNamespaceDomain::FCollectCategoryModelsTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Ranking::Model::FCategoryModelPtr>>, public TSharedFromThis<FCollectCategoryModelsTask>
    {
        const TSharedPtr<FNamespaceDomain> Self;
        const TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelPtr>)> OnCollected;

    public:
        explicit FCollectCategoryModelsTask(const TSharedPtr<FNamespaceDomain>& Self, TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelPtr>)> OnCollected) : Self(Self), OnCollected(OnCollected) {}
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Ranking::Model::FCategoryModelPtr>>> Result) override
        {
            TArray<Gs2::Ranking::Model::FCategoryModelPtr> Items;
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::Ranking::Model::FCategoryModelPtr>>(Items);
    ...
    )
    {
        ...
        const auto Parent = Gs2::Ranking::Model::Cache::FCategoryModelCache::CreateCacheParentKey(
        NamespaceName,
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [Callback, WeakGs2](const TArray<FGs2ObjectPtr>& Values)
            {
                ...
                TArray<Gs2::Ranking::Model::FCategoryModelPtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::Ranking::Model::FCategoryModel>(Value));
    ...
    FNamespaceDomain::FSubscribeCategoryModelsWithInitialCallTask::FSubscribeCategoryModelsWithInitialCallTask(const TSharedPtr<FNamespaceDomain>& Self, TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelPtr>)> Callback) : Self(Self), Callback(Callback) {}
    ...
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectCategoryModelsTask>>(Self, TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelPtr>)>());
    ...
    TSharedPtr<FAsyncTask<FNamespaceDomain::FSubscribeCategoryModelsWithInitialCallTask>> FNamespaceDomain::SubscribeCategoryModelsWithInitialCall(TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelPtr>)> Callback)
    {
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Ranking::Model::Cache::FCategoryModelMasterCache::CreateCacheParentKey(
                NamespaceName,
                TOptional<int32>()
            ),
            Callback,
    ...
    class FNamespaceDomain::FCollectCategoryModelMastersTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>>, public TSharedFromThis<FCollectCategoryModelMastersTask>
    {
        const TSharedPtr<FNamespaceDomain> Self;
        const TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>)> OnCollected;
    const TOptional<FString> QueryNamePrefix;
    public:
        explicit FCollectCategoryModelMastersTask(const TSharedPtr<FNamespaceDomain>& Self, TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>)> OnCollected,const TOptional<FString> NamePrefix) : Self(Self), OnCollected(OnCollected), QueryNamePrefix(NamePrefix) {}
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>>> Result) override
        {
            TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr> Items;
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>>(Items);
            if (OnCollected) OnCollected(Items);
            return nullptr;
        }
    };
    ...
    Gs2::Core::Domain::CallbackID FNamespaceDomain::SubscribeCategoryModelMasters(
        TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>)> Callback,const TOptional<FString> NamePrefix
    )
    {
        const TWeakPtr<Gs2::Core::Domain::FGs2> WeakGs2 = this->Gs2;
        const TWeakPtr<Ranking::Domain::FGs2RankingDomain> WeakService = this->Service;
        ...
        const auto Parent = Gs2::Ranking::Model::Cache::FCategoryModelMasterCache::CreateCacheParentKey(
        NamespaceName,
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            {
                if (!WeakGs2.Pin().IsValid()) return;
                TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::Ranking::Model::FCategoryModelMaster>(Value));
                Callback(TypedValues);
            },
    ...
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectCategoryModelMastersTask>>(Self, TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>)>(), QueryNamePrefix);
        Task->StartSynchronousTask(); Task->EnsureCompletion();
        if (Task->GetTask().IsError()) return Task->GetTask().Error();
        const auto Values = Task->GetTask().Result();
    ...
    TSharedPtr<FAsyncTask<FNamespaceDomain::FSubscribeCategoryModelMastersWithInitialCallTask>> FNamespaceDomain::SubscribeCategoryModelMastersWithInitialCall(TFunction<void(TArray<Gs2::Ranking::Model::FCategoryModelMasterPtr>)> Callback,const TOptional<FString> NamePrefix)
    {
    ...
    {
        const auto CacheParentKey = Gs2::Ranking::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Ranking::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Ranking::Model::FNamespacePtr Value;
                const auto CacheHit = Gs2::Ranking::Model::Cache::FNamespaceCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Ranking::Model::Cache::FNamespaceCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Ranking::Model::FNamespacePtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Ranking::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Ranking::Model::Cache::FNamespaceCache::CreateCacheKey(
