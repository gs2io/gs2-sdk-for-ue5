...
namespace Gs2::Ranking::Domain::Model
{
    ...
    {
        const FString CacheKey = Gs2::Ranking::Domain::Model::FCategoryModelDomain::CreateCacheKey(
            Self->CategoryName
        );
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            [this, Result, CacheKey]() -> Gs2::Core::Model::FGs2ErrorPtr
            {
                ...
                auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::Ranking::Model::FCategoryModel>(
                    Self->ParentKey,
                    CacheKey,
                    &Value
                );
                if (!bCacheHit) {
                    ...
                    if (Future->GetTask().IsError())
                    {
                        ...
                        if (!Error->GetErrors().IsValid() || Error->Count() == 0 || !Error->Detail(0).IsValid() || Error->Detail(0)->GetComponent() != "categoryModel")
                        {
                            return Error;
                        }
                    }
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Ranking::Model::FCategoryModel>(obj));
            },
