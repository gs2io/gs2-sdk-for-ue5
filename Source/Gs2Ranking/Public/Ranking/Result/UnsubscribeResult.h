...
{
    class GS2RANKING_API FUnsubscribeResult final : public TSharedFromThis<FUnsubscribeResult>
    {
    ...
    public:
        ...
        TSharedPtr<FUnsubscribeResult> WithItem(const TSharedPtr<Model::FSubscribeUser> Item);
