...
#include "Ranking/Request/DumpUserDataByUserIdRequest.h"
#include "Ranking/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::Rest
{
    class GS2RANKING_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
