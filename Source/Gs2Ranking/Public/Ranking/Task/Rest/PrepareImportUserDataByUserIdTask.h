...
#include "Ranking/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Ranking/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::Rest
{
    class GS2RANKING_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
