...
#include "Ranking/Request/UpdateNamespaceRequest.h"
#include "Ranking/Result/UpdateNamespaceResult.h"

namespace Gs2::Ranking::Task::Rest
{
    class GS2RANKING_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
