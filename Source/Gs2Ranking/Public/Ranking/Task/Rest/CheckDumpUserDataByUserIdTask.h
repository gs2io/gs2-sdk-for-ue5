...
#include "Ranking/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Ranking/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::Rest
{
    class GS2RANKING_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
