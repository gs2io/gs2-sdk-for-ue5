...
#include "Ranking/Request/DeleteNamespaceRequest.h"
#include "Ranking/Result/DeleteNamespaceResult.h"

namespace Gs2::Ranking::Task::Rest
{
    class GS2RANKING_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
