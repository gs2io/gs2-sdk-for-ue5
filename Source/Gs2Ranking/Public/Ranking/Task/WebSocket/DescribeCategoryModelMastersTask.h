...
#include "Ranking/Request/DescribeCategoryModelMastersRequest.h"
#include "Ranking/Result/DescribeCategoryModelMastersResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FDescribeCategoryModelMastersTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeCategoryModelMastersResult>
    {
