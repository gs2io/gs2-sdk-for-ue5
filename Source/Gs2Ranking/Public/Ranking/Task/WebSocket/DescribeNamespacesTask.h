...
#include "Ranking/Request/DescribeNamespacesRequest.h"
#include "Ranking/Result/DescribeNamespacesResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
