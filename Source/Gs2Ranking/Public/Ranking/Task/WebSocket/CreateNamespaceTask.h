...
#include "Ranking/Request/CreateNamespaceRequest.h"
#include "Ranking/Result/CreateNamespaceResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
