...
#include "Ranking/Request/GetNamespaceStatusRequest.h"
#include "Ranking/Result/GetNamespaceStatusResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
