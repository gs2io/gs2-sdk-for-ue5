...
#include "Ranking/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Ranking/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
