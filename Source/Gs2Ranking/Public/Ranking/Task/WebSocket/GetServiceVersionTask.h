...
#include "Ranking/Request/GetServiceVersionRequest.h"
#include "Ranking/Result/GetServiceVersionResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
