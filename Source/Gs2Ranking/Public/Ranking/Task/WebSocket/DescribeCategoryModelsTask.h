...
#include "Ranking/Result/DescribeCategoryModelsResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FDescribeCategoryModelsTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeCategoryModelsResult>
    {
