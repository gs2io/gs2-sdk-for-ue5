...
#include "Ranking/Request/ImportUserDataByUserIdRequest.h"
#include "Ranking/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
