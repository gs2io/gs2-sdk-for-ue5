...
#include "Ranking/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
