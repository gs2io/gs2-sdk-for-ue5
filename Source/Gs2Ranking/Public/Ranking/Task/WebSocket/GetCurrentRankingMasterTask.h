...
#include "Ranking/Request/GetCurrentRankingMasterRequest.h"
#include "Ranking/Result/GetCurrentRankingMasterResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FGetCurrentRankingMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FGetCurrentRankingMasterResult>
    {
