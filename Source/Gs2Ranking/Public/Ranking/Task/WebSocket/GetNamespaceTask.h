...
#include "Ranking/Request/GetNamespaceRequest.h"
#include "Ranking/Result/GetNamespaceResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
