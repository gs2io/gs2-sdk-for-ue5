...
#include "Ranking/Request/CleanUserDataByUserIdRequest.h"
#include "Ranking/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
