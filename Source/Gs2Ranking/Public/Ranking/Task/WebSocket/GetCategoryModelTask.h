...
#include "Ranking/Request/GetCategoryModelRequest.h"
#include "Ranking/Result/GetCategoryModelResult.h"

namespace Gs2::Ranking::Task::WebSocket
{
    class GS2RANKING_API FGetCategoryModelTask final : public Gs2::Core::Util::TGs2Future<Result::FGetCategoryModelResult>
    {
