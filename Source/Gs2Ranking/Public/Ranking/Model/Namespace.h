...
#include "CalculatedAt.h"
#include "LogSetting.h"

namespace Gs2::Ranking::Model
{
    class GS2RANKING_API FNamespace final : public FGs2Object, public TSharedFromThis<FNamespace>
    {
        TOptional<FString> NamespaceIdValue;
        TOptional<FString> NameValue;
        TOptional<FString> DescriptionValue;
        TSharedPtr<TArray<TSharedPtr<FCalculatedAt>>> LastCalculatedAtsValue;
    ...
    public:
        ...
        TSharedPtr<FNamespace> WithLastCalculatedAts(const TSharedPtr<TArray<TSharedPtr<FCalculatedAt>>> LastCalculatedAts);
        ...
        TSharedPtr<TArray<TSharedPtr<FCalculatedAt>>> GetLastCalculatedAts() const;
