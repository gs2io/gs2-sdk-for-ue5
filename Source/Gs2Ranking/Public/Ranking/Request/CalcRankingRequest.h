...
{
    class FCalcRankingRequest;

    class GS2RANKING_API FCalcRankingRequest final : public TSharedFromThis<FCalcRankingRequest>
    {
    ...
    typedef TSharedPtr<FCalcRankingRequest, ESPMode::ThreadSafe> FCalcRankingRequestPtr;
}