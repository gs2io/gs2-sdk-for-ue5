...
namespace Gs2::Ranking::Request
{
    ...
    class GS2RANKING_API FUpdateCurrentRankingMasterFromGitHubRequest final : public TSharedFromThis<FUpdateCurrentRankingMasterFromGitHubRequest>
    {
    ...
    typedef TSharedPtr<FUpdateCurrentRankingMasterFromGitHubRequest> FUpdateCurrentRankingMasterFromGitHubRequestPtr;
}