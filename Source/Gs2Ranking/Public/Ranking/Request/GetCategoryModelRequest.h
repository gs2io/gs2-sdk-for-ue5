...
namespace Gs2::Ranking::Request
{
    ...
    class GS2RANKING_API FGetCategoryModelRequest final : public TSharedFromThis<FGetCategoryModelRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetCategoryModelRequest> WithCategoryName(const TOptional<FString> CategoryName);
    ...
    typedef TSharedPtr<FGetCategoryModelRequest, ESPMode::ThreadSafe> FGetCategoryModelRequestPtr;
}