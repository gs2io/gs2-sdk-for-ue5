...
namespace Gs2::Ranking::Request
{
    ...
    class GS2RANKING_API FSubscribeRequest final : public TSharedFromThis<FSubscribeRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FSubscribeRequest> WithCategoryName(const TOptional<FString> CategoryName);
        TSharedPtr<FSubscribeRequest> WithAccessToken(const TOptional<FString> AccessToken);
        TSharedPtr<FSubscribeRequest> WithTargetUserId(const TOptional<FString> TargetUserId);
    ...
    typedef TSharedPtr<FSubscribeRequest, ESPMode::ThreadSafe> FSubscribeRequestPtr;
}