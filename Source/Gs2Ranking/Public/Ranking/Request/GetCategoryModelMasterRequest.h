...
namespace Gs2::Ranking::Request
{
    ...
    class GS2RANKING_API FGetCategoryModelMasterRequest final : public TSharedFromThis<FGetCategoryModelMasterRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetCategoryModelMasterRequest> WithCategoryName(const TOptional<FString> CategoryName);
    ...
    typedef TSharedPtr<FGetCategoryModelMasterRequest, ESPMode::ThreadSafe> FGetCategoryModelMasterRequestPtr;
}