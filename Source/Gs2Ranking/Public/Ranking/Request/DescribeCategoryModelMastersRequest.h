...
namespace Gs2::Ranking::Request
{
    ...
    class GS2RANKING_API FDescribeCategoryModelMastersRequest final : public TSharedFromThis<FDescribeCategoryModelMastersRequest>
    {
    ...
    typedef TSharedPtr<FDescribeCategoryModelMastersRequest, ESPMode::ThreadSafe> FDescribeCategoryModelMastersRequestPtr;
}