...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking::Model::FCategoryModel>> Result) override;
        ...
        class GS2RANKING_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Ranking::Model::FCategoryModelPtr>> Range;
            TOptional<TArray<Gs2::Ranking::Model::FCategoryModelPtr>::TIterator> RangeIteratorOpt;
