...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class FDescribeSubscribesByCategoryNameIteratorLoadTask;

    class GS2RANKING_API FDescribeSubscribesByCategoryNameIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Ranking::Model::FSubscribeUser, FDescribeSubscribesByCategoryNameIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Ranking::FGs2RankingRestClientPtr Client;

        friend FDescribeSubscribesByCategoryNameIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeSubscribesByCategoryNameIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeSubscribesByCategoryNameIterator;
    ...
    typedef TSharedPtr<FDescribeSubscribesByCategoryNameIterator> FDescribeSubscribesByCategoryNameIteratorPtr;
    ...
    {
        TSharedPtr<FDescribeSubscribesByCategoryNameIterator> Self;
