...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class GS2RANKING_API FDescribeSubscribesByCategoryNameIterator :
        public TSharedFromThis<FDescribeSubscribesByCategoryNameIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeSubscribesByCategoryNameIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribesByCategoryNameIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribesByCategoryNameIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribesByCategoryNameIterator> Iterable)
            {
