...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class GS2RANKING_API FDescribeRankingsByUserIdIterator :
        public TSharedFromThis<FDescribeRankingsByUserIdIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeRankingsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRankingsByUserIdIterator> Iterable)
            {
