...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class GS2RANKING_API FDescribeScoresByUserIdIterator :
        public TSharedFromThis<FDescribeScoresByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking::Model::FScore>> Result) override;
        ...
        {
            TSharedRef<FDescribeScoresByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking::Model::FScorePtr>> Range;
            TOptional<TArray<Gs2::Ranking::Model::FScorePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeScoresByUserIdIterator> Iterable)
            {
