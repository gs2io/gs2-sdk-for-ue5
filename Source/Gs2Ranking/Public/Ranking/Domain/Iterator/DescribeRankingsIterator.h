...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class GS2RANKING_API FDescribeRankingsIterator :
        public TSharedFromThis<FDescribeRankingsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeRankingsIterator> Self;
            ...
            FIterator(
                const TSharedRef<FDescribeRankingsIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRankingsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRankingsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRankingsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRankingsIterator> FDescribeRankingsIteratorPtr;
}
