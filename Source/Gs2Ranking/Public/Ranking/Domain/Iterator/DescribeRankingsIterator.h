...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class FDescribeRankingsIteratorLoadTask;

    class GS2RANKING_API FDescribeRankingsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Ranking::Model::FRanking, FDescribeRankingsIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Ranking::FGs2RankingRestClientPtr Client;

        friend FDescribeRankingsIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeRankingsIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeRankingsIterator;
    ...
    {
        TSharedPtr<FDescribeRankingsIterator> Self;
