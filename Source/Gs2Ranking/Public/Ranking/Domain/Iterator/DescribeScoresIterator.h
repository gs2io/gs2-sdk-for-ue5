...
namespace Gs2::Ranking::Domain::Iterator
{
    ...
    class GS2RANKING_API FDescribeScoresIterator :
        public TSharedFromThis<FDescribeScoresIterator>
    {
    ...
    public:
        ...
        FDescribeScoresIterator(
            const FDescribeScoresIterator& From
        );
        ...
        {
            TSharedRef<FDescribeScoresIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeScoresIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeScoresIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeScoresIterator> Iterable)
            {
