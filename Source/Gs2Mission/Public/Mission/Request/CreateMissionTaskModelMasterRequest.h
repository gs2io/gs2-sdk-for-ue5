...
namespace Gs2::Mission::Request
{
    ...
    public:
        ...
        TSharedPtr<FCreateMissionTaskModelMasterRequest> WithVerifyCompleteConsumeActions(const TSharedPtr<TArray<TSharedPtr<Model::FConsumeAction>>> VerifyCompleteConsumeActions);
