...
{
    class FDescribeMissionTaskModelMastersRequest;

    class GS2MISSION_API FDescribeMissionTaskModelMastersRequest final : public TSharedFromThis<FDescribeMissionTaskModelMastersRequest>
    {
    ...
    public:
        ...
        FDescribeMissionTaskModelMastersRequest();
        FDescribeMissionTaskModelMastersRequest(
            const FDescribeMissionTaskModelMastersRequest& From
        );
        ~FDescribeMissionTaskModelMastersRequest() = default;
        ...
        static TSharedPtr<FDescribeMissionTaskModelMastersRequest> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;
    };
    typedef TSharedPtr<FDescribeMissionTaskModelMastersRequest, ESPMode::ThreadSafe> FDescribeMissionTaskModelMastersRequestPtr;
}