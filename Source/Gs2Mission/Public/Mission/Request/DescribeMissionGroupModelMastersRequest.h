...
namespace Gs2::Mission::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeMissionGroupModelMastersRequest> WithNamePrefix(const TOptional<FString> NamePrefix);
    ...
    typedef TSharedPtr<FDescribeMissionGroupModelMastersRequest> FDescribeMissionGroupModelMastersRequestPtr;
}