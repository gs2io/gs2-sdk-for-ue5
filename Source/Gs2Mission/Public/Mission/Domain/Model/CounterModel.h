...
namespace Gs2::Mission::Domain::Model
{
    ...
    class GS2MISSION_API FCounterModelDomain:
        public TSharedFromThis<FCounterModelDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FCounterModelDomain> Self;
            const TFunction<void(Gs2::Mission::Model::FCounterModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FCounterModelDomain> FCounterModelDomainPtr;
}
