...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeCompletesIterator :
        public TSharedFromThis<FDescribeCompletesIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FComplete>> Result) override;
        ...
        {
            TSharedRef<FDescribeCompletesIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FCompletePtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FCompletePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCompletesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCompletesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCompletesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeCompletesIterator> FDescribeCompletesIteratorPtr;
}
