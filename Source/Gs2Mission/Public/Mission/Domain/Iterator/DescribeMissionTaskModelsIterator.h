...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeMissionTaskModelsIterator :
        public TSharedFromThis<FDescribeMissionTaskModelsIterator>
    {
    ...
    public:
        ...
        FDescribeMissionTaskModelsIterator(
            const FDescribeMissionTaskModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FMissionTaskModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeMissionTaskModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FMissionTaskModelPtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FMissionTaskModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMissionTaskModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMissionTaskModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMissionTaskModelsIterator> Iterable)
            {
