...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeCounterModelMastersIterator :
        public TSharedFromThis<FDescribeCounterModelMastersIterator>
    {
    ...
    public:
        ...
        FDescribeCounterModelMastersIterator(
            const FDescribeCounterModelMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FCounterModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeCounterModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FCounterModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FCounterModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCounterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCounterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCounterModelMastersIterator> Iterable)
            {
