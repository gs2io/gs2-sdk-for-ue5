...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeCountersByUserIdIterator :
        public TSharedFromThis<FDescribeCountersByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FCounter>> Result) override;
        ...
        {
            TSharedRef<FDescribeCountersByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FCounterPtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FCounterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCountersByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCountersByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCountersByUserIdIterator> Iterable)
            {
