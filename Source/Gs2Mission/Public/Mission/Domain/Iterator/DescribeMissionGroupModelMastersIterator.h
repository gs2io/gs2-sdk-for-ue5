...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeMissionGroupModelMastersIterator :
        public TSharedFromThis<FDescribeMissionGroupModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FMissionGroupModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeMissionGroupModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FMissionGroupModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FMissionGroupModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMissionGroupModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMissionGroupModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMissionGroupModelMastersIterator> Iterable)
            {
