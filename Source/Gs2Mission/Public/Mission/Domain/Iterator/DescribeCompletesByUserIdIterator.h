...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeCompletesByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCompletesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCompletesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCompletesByUserIdIterator> Iterable)
            {
