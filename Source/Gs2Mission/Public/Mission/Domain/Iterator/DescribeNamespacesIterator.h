...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FNamespace>> Result) override;
        ...
        class GS2MISSION_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Mission::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
