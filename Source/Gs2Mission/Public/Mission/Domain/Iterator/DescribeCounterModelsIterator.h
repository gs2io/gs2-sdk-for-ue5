...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    class GS2MISSION_API FDescribeCounterModelsIterator :
        public TSharedFromThis<FDescribeCounterModelsIterator>
    {
    ...
    public:
        ...
        class GS2MISSION_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Mission::Model::FCounterModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Mission::Model::FCounterModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeCounterModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Mission::Model::FCounterModelPtr>> Range;
            TOptional<TArray<Gs2::Mission::Model::FCounterModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCounterModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCounterModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCounterModelsIterator> Iterable)
            {
