...
{
    class GS2MISSION_API FBatchCompleteByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FBatchCompleteByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Mission::Domain::FGs2MissionDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Mission::Request::FBatchCompleteByUserIdRequestPtr& Request
