...
namespace Gs2::Mission::Domain::SpeculativeExecutor
{
    ...
    class GS2MISSION_API FReceiveByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        class GS2MISSION_API FCommitTask final :
        ...
        static Gs2::Mission::Request::FReceiveByUserIdRequestPtr Rate(
            const Gs2::Mission::Request::FReceiveByUserIdRequestPtr& Request,
            const double Rate
        );
