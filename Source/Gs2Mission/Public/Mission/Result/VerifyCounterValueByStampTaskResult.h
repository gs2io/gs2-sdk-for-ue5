...
namespace Gs2::Mission::Result
{
    ...
    public:
        ...
        FVerifyCounterValueByStampTaskResult();
        FVerifyCounterValueByStampTaskResult(
    ...
    typedef TSharedPtr<FVerifyCounterValueByStampTaskResult, ESPMode::ThreadSafe> FVerifyCounterValueByStampTaskResultPtr;
}