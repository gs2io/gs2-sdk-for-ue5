...
{
    class GS2MISSION_API FReceiveByUserIdResult final : public TSharedFromThis<FReceiveByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FReceiveByUserIdResult> WithItem(const TSharedPtr<Model::FComplete> Item);
