...
#include "Mission/Request/GetNamespaceStatusRequest.h"
#include "Mission/Result/GetNamespaceStatusResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
