...
#include "Mission/Request/GetServiceVersionRequest.h"
#include "Mission/Result/GetServiceVersionResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
