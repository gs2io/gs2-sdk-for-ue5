...
#include "Mission/Request/DeleteNamespaceRequest.h"
#include "Mission/Result/DeleteNamespaceResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
