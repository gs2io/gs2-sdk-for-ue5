...
#include "Mission/Result/ReceiveByUserIdResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FReceiveByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FReceiveByUserIdResult>
    {
