...
#include "Mission/Result/UpdateNamespaceResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
