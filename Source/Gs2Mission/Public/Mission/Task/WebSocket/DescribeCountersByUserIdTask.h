...
#include "Mission/Request/DescribeCountersByUserIdRequest.h"
#include "Mission/Result/DescribeCountersByUserIdResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FDescribeCountersByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeCountersByUserIdResult>
    {
