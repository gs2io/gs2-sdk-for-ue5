...
#include "Mission/Request/GetNamespaceRequest.h"
#include "Mission/Result/GetNamespaceResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
