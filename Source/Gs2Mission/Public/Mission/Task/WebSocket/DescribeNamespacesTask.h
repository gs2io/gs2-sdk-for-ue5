...
#include "Mission/Request/DescribeNamespacesRequest.h"
#include "Mission/Result/DescribeNamespacesResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
