...
#include "Mission/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Mission/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Mission::Task::WebSocket
{
    class GS2MISSION_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
