...
#include "Mission/Result/CreateNamespaceResult.h"

namespace Gs2::Mission::Task::Rest
{
    class GS2MISSION_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
