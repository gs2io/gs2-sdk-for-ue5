...
#include "Mission/Request/ImportUserDataByUserIdRequest.h"
#include "Mission/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Mission::Task::Rest
{
    class GS2MISSION_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
