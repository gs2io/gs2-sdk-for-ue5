...
#include "Mission/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Mission/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Mission::Task::Rest
{
    class GS2MISSION_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
