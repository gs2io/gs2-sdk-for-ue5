...
#include "Mission/Request/DumpUserDataByUserIdRequest.h"
#include "Mission/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Mission::Task::Rest
{
    class GS2MISSION_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
