...
#include "Mission/Request/CleanUserDataByUserIdRequest.h"
#include "Mission/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Mission::Task::Rest
{
    class GS2MISSION_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
