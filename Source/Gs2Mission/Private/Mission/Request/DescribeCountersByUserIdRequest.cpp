...
namespace Gs2::Mission::Request
{
    ...
    TSharedPtr<FDescribeCountersByUserIdRequest> FDescribeCountersByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDescribeCountersByUserIdRequest::GetTimeOffsetToken() const
    {
