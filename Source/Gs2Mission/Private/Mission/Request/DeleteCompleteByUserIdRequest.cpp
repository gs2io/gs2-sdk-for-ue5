...
namespace Gs2::Mission::Request
{
    ...
    TSharedPtr<FDeleteCompleteByUserIdRequest> FDeleteCompleteByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDeleteCompleteByUserIdRequest::GetTimeOffsetToken() const
    {
