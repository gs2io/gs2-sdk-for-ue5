...
{
    FCompleteByUserIdResult::FCompleteByUserIdResult():
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::WithTransactionResult(
    ...
    TOptional<FString> FCompleteByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FCompleteByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FCompleteByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FCompleteByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FCompleteByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FCompleteByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FCompleteByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FCompleteByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FCompleteByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FCompleteByUserIdResult> FCompleteByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FCompleteByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FCompleteByUserIdResult::ToJson() const
    {
