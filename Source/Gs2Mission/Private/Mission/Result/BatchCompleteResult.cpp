...
#include "Mission/Result/BatchCompleteResult.h"

namespace Gs2::Mission::Result
{
    FBatchCompleteResult::FBatchCompleteResult():
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithTransactionId(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithStampSheet(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithAtomicCommit(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithTransaction(
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::WithTransactionResult(
    ...
    TOptional<FString> FBatchCompleteResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FBatchCompleteResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FBatchCompleteResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FBatchCompleteResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FBatchCompleteResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FBatchCompleteResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FBatchCompleteResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FBatchCompleteResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FBatchCompleteResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FBatchCompleteResult> FBatchCompleteResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FBatchCompleteResult>()
    ...
    TSharedPtr<FJsonObject> FBatchCompleteResult::ToJson() const
    {
