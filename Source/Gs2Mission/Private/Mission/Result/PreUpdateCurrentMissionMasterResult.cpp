...
{
    FPreUpdateCurrentMissionMasterResult::FPreUpdateCurrentMissionMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentMissionMasterResult> FPreUpdateCurrentMissionMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentMissionMasterResult> FPreUpdateCurrentMissionMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentMissionMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentMissionMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentMissionMasterResult> FPreUpdateCurrentMissionMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentMissionMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentMissionMasterResult::ToJson() const
    {
