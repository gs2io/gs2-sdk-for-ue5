...
namespace Gs2::Mission::Model
{
    ...
    TSharedPtr<FMissionTaskModelMaster> FMissionTaskModelMaster::WithVerifyCompleteType(
    ...
    TSharedPtr<FMissionTaskModelMaster> FMissionTaskModelMaster::WithTargetCounter(
    ...
    TSharedPtr<FMissionTaskModelMaster> FMissionTaskModelMaster::WithVerifyCompleteConsumeActions(
    ...
    TOptional<FString> FMissionTaskModelMaster::GetVerifyCompleteType() const
    {
        return VerifyCompleteTypeValue;
    }
    TSharedPtr<FTargetCounterModel> FMissionTaskModelMaster::GetTargetCounter() const
    {
        return TargetCounterValue;
    }
    TSharedPtr<TArray<TSharedPtr<Model::FVerifyAction>>> FMissionTaskModelMaster::GetVerifyCompleteConsumeActions() const
    {
...
{
    FString FMissionTaskModelMasterCache::CreateCacheParentKey(
    ...
    )
    {
        return FString("mission:")
            ...
            + FString::FromInt(CacheOwnerArgumentTimeOffset.Get(0)) + FString(":MissionTaskModelMaster");
    }

    FString FMissionTaskModelMasterCache::CreateCacheKey(
    ...
    bool FMissionTaskModelMasterCache::TryGet(
    ...
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Mission::Model::FMissionTaskModelMasterPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Mission::Model::FMissionTaskModelMaster>(
    ...
    void FMissionTaskModelMasterCache::Put(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentMissionGroupName,
        TOptional<FString> CacheOwnerArgumentMissionTaskName,
    ...
    )
    {
        ...
        Gs2::Mission::Model::FMissionTaskModelMasterPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Mission::Model::FMissionTaskModelMaster>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Mission::Model::FMissionTaskModelMaster::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
            FDateTime::Now() + FTimespan::FromMinutes(Gs2::Core::Domain::DefaultCacheMinutes)
        );
    }

    FString FMissionTaskModelMasterCache::PutUserData(
    ...
    )
    {
        ...
        Put(
            Cache,
            NamespaceName,
            (Item->GetMissionTaskId().IsSet() ? Gs2::Mission::Model::FMissionTaskModelMaster::GetMissionGroupNameFromGrn(*Item->GetMissionTaskId()) : TOptional<FString>()),
            Item->GetName(),
            TimeOffset,
            Item
        );
    ...
    void FMissionTaskModelMasterCache::Delete(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentMissionGroupName,
        TOptional<FString> CacheOwnerArgumentMissionTaskName,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Mission::Model::FMissionTaskModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentMissionGroupName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FMissionTaskModelMasterCache::Fetch(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentMissionGroupName,
        TOptional<FString> CacheOwnerArgumentMissionTaskName,
    ...
    )
    {
        ...
        Gs2::Mission::Model::FMissionTaskModelMasterPtr CacheOwnerFetchedItem;
        ...
        if (CacheOwnerDetails.IsValid() && CacheOwnerDetails->Num() > 0 && (*CacheOwnerDetails)[0].IsValid() && (*CacheOwnerDetails)[0]->GetComponent() == TEXT("missionTaskModelMaster"))
        {
            return nullptr;
        }
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
    ...
    Gs2::Core::Domain::CallbackID FMissionTaskModelMasterCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentMissionGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        ...
        return CacheSnapshot->ListSubscribeTyped(Gs2::Mission::Model::FMissionTaskModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentMissionGroupName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Mission::Model::FMissionTaskModelMasterPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Mission::Model::FMissionTaskModelMaster>(CacheOwnerValue));
            if (CacheOwnerArgumentCallback) CacheOwnerArgumentCallback(CacheOwnerTypedValues);
        });
    }

    void FMissionTaskModelMasterCache::ListUnsubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentMissionGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Mission::Model::FMissionTaskModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentMissionGroupName,
            CacheOwnerArgumentTimeOffset
