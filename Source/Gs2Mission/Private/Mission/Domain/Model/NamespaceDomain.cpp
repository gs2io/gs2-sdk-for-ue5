...
namespace Gs2::Mission::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Cache->Delete<Gs2::Mission::Model::FNamespace>(ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Mission::Model::FNamespace>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Mission::Model::FNamespace>(
                            Self->ParentKey,
                            Gs2::Mission::Domain::Model::FNamespaceDomain::CreateCacheKey(
                                Self->NamespaceName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Mission::Model::FNamespace>(
                Self->ParentKey,
                Gs2::Mission::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                )
