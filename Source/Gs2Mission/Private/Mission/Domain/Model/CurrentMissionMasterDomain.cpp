...
namespace Gs2::Mission::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::Put(
            Self->Gs2->Cache,
    ...
    FCurrentMissionMasterDomain::FPreUpdateTask::FPreUpdateTask(
        const TSharedPtr<FCurrentMissionMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentMissionMasterDomain::FPreUpdateTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Mission::Domain::Model::FCurrentMissionMasterDomain>> Result
    )
    {
        Request
            ->WithContextStack((!Request->GetContextStack().IsSet() || Request->GetContextStack()->IsEmpty()) ? Self->Gs2->DefaultContextStack : Request->GetContextStack())
            ->WithNamespaceName(Self->NamespaceName);
        const auto Future = Self->Client->PreUpdateCurrentMissionMaster(
            Request
        );
        Future->StartSynchronousTask();
        if (Future->GetTask().IsError())
    ...
    TSharedPtr<FAsyncTask<FCurrentMissionMasterDomain::FPreUpdateTask>> FCurrentMissionMasterDomain::PreUpdate(
    ...
    {
        const auto CacheParentKey = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Mission::Model::FCurrentMissionMasterPtr Value;
                const auto CacheHit = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Mission::Model::FCurrentMissionMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FCurrentMissionMasterDomain::Invalidate()
    {
        Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::Delete(
            Gs2->Cache,
    ...
    FCurrentMissionMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCurrentMissionMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentMissionMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCurrentMissionMasterDomain::FSubscribeWithInitialCallTask>> FCurrentMissionMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Mission::Model::FCurrentMissionMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Mission::Model::Cache::FCurrentMissionMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName]()
            {
                ...
                const auto Domain = MakeShared<FCurrentMissionMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName
                );
