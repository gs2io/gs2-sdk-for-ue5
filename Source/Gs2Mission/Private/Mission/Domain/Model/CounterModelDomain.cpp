...
namespace Gs2::Mission::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Mission::Model::Cache::FCounterModelCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Mission::Model::Cache::FCounterModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Mission::Model::Cache::FCounterModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Mission::Model::FCounterModelPtr Value;
                const auto CacheHit = Gs2::Mission::Model::Cache::FCounterModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Mission::Model::Cache::FCounterModelCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->CounterName,
                    TOptional<int32>(),
                    [Self](Gs2::Mission::Model::FCounterModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FCounterModelDomain::Invalidate()
    {
        Gs2::Mission::Model::Cache::FCounterModelCache::Delete(
            Gs2->Cache,
    ...
    FCounterModelDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCounterModelDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCounterModelDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCounterModelDomain::FSubscribeWithInitialCallTask>> FCounterModelDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Mission::Model::FCounterModelPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Mission::Model::Cache::FCounterModelCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Mission::Model::Cache::FCounterModelCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryCounterName]()
            {
                ...
                const auto Domain = MakeShared<FCounterModelDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryCounterName
