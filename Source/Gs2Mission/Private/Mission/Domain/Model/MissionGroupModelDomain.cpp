...
namespace Gs2::Mission::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Mission::Model::FMissionGroupModel>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Mission::Model::FMissionGroupModel>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Mission::Model::FMissionGroupModel>(
                            Self->ParentKey,
                            Gs2::Mission::Domain::Model::FMissionGroupModelDomain::CreateCacheKey(
                                Self->MissionGroupName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Mission::Model::FMissionGroupModel>(
                Self->ParentKey,
                Gs2::Mission::Domain::Model::FMissionGroupModelDomain::CreateCacheKey(
                    Self->MissionGroupName
                )
