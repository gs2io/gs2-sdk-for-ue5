...
Gs2::Core::Model::FGs2ErrorPtr FDecreaseCounterByUserIdSpeculativeExecutor::Transform(
    ...
    const Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr&, Gs2::Mission::Model::FCounterPtr
)
{
    return nullptr;
}
...
FDecreaseCounterByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(const FCommitTask& From):
...
)
{
    *Result = nullptr;
    ...
    Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr Prepared = nullptr;
    if (Request.IsValid()) Prepared = MakeShared<Gs2::Mission::Request::FDecreaseCounterByUserIdRequest>(*Request);
    ...
    const auto Commit = MakeShared<FCounterMutationSpeculativeCommit>(
        ...
        [RequestedValue, CurrentTimeMillis](const Gs2::Mission::Model::FCounterPtr& Current)
        {
            ...
            for (const auto& Existing : *Current->GetValues())
            {
                ...
                int64 Result = Base;
                if (RequestedValue >= 0)
                    Result = Base <= RequestedValue ? 0 : Base - RequestedValue;
                else if (Base > TNumericLimits<int64>::Max() + RequestedValue)
                    Result = TNumericLimits<int64>::Max();
                else
                    Result = Base - RequestedValue;
...
Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr FDecreaseCounterByUserIdSpeculativeExecutor::Rate(
    const Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr& Request, const double Rate)
{
...
Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr FDecreaseCounterByUserIdSpeculativeExecutor::Rate(
    const Gs2::Mission::Request::FDecreaseCounterByUserIdRequestPtr& Request, TBigInt<1024, false> Rate)
{
