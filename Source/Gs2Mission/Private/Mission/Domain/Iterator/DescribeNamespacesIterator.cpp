...
namespace Gs2::Mission::Domain::Iterator
{
    ...
    const Gs2::Mission::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Mission::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
