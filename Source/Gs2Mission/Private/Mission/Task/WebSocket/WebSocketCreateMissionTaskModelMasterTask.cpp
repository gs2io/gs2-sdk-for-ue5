...
#include "Mission/Task/WebSocket/CreateMissionTaskModelMasterTask.h"
...
namespace Gs2::Mission::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("missionTaskModelMaster"), TEXT("createMissionTaskModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateMissionTaskModelMasterResult::FromJson(WebSocketResult->Body());
