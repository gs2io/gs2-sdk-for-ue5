...
#include "Mission/Task/WebSocket/IncreaseCounterByUserIdTask.h"
...
{
    FIncreaseCounterByUserIdTask::FIncreaseCounterByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FIncreaseCounterByUserIdTask::Action(
        const TSharedPtr<Result::FIncreaseCounterByUserIdResultPtr> Result
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("counter"), TEXT("increaseCounterByUserId"), ToCStr(RequestPayload->Payload()));
