...
#include "Mission/Task/WebSocket/ResetByStampTaskTask.h"
...
namespace Gs2::Mission::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("counter"), TEXT("resetByStampTask"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FResetByStampTaskResult::FromJson(WebSocketResult->Body());
