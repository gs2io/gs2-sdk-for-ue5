...
#include "Mission/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Mission::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("currentMissionMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
