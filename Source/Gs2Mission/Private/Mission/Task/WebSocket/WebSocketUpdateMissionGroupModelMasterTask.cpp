...
#include "Mission/Task/WebSocket/UpdateMissionGroupModelMasterTask.h"
...
namespace Gs2::Mission::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("missionGroupModelMaster"), TEXT("updateMissionGroupModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateMissionGroupModelMasterResult::FromJson(WebSocketResult->Body());
