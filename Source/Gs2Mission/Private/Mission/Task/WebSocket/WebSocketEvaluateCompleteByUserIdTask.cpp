...
#include "Mission/Task/WebSocket/EvaluateCompleteByUserIdTask.h"
...
namespace Gs2::Mission::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("mission"), TEXT("complete"), TEXT("evaluateCompleteByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FEvaluateCompleteByUserIdResult::FromJson(WebSocketResult->Body());
