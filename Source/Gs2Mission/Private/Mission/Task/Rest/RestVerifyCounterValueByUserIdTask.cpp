...
#include "Mission/Task/Rest/VerifyCounterValueByUserIdTask.h"
...
{
    FVerifyCounterValueByUserIdTask::FVerifyCounterValueByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyCounterValueByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyCounterValueByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/counter/{counterName}/verify/counter/{verifyType}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("scopeType"), this->Request->GetScopeType().GetValue());
            }
            ...
            {
                JsonRootObject->SetStringField(TEXT("conditionName"), this->Request->GetConditionName().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyCounterValueByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
