...
#include "Mission/Task/Rest/GetMissionTaskModelTask.h"
...
{
    FGetMissionTaskModelTask::FGetMissionTaskModelTask(
    ...
    FGetMissionTaskModelTask::FGetMissionTaskModelTask(
        const FGetMissionTaskModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetMissionTaskModelTask::Action(
        const TSharedPtr<Result::FGetMissionTaskModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/group/{missionGroupName}/task/{missionTaskName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetMissionTaskModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
