...
#include "Mission/Task/Rest/VerifyCounterValueTask.h"
...
{
    FVerifyCounterValueTask::FVerifyCounterValueTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyCounterValueTask::Action(
        const TSharedPtr<Result::FVerifyCounterValueResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/counter/{counterName}/verify/counter/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyCounterValueResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
