...
#include "Mission/Task/Rest/GetMissionTaskModelMasterTask.h"
...
{
    FGetMissionTaskModelMasterTask::FGetMissionTaskModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetMissionTaskModelMasterTask::Action(
        const TSharedPtr<Result::FGetMissionTaskModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetMissionTaskModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
