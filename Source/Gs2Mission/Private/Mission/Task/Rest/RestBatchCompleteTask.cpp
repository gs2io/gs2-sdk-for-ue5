...
#include "Mission/Task/Rest/BatchCompleteTask.h"
...
{
    FBatchCompleteTask::FBatchCompleteTask(
    ...
    FBatchCompleteTask::FBatchCompleteTask(
        const FBatchCompleteTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FBatchCompleteTask::Action(
        const TSharedPtr<Result::FBatchCompleteResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/complete/group/{missionGroupName}/task/any/batch");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FBatchCompleteResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
