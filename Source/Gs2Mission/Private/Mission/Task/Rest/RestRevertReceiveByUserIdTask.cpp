...
#include "Mission/Task/Rest/RevertReceiveByUserIdTask.h"
...
{
    FRevertReceiveByUserIdTask::FRevertReceiveByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FRevertReceiveByUserIdTask::Action(
        const TSharedPtr<Result::FRevertReceiveByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/{missionTaskName}/revert");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRevertReceiveByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
