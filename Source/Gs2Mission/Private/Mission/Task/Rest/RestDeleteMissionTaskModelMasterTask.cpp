...
#include "Mission/Task/Rest/DeleteMissionTaskModelMasterTask.h"
...
{
    FDeleteMissionTaskModelMasterTask::FDeleteMissionTaskModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteMissionTaskModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteMissionTaskModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteMissionTaskModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
