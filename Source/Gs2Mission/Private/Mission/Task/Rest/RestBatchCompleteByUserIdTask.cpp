...
#include "Mission/Task/Rest/BatchCompleteByUserIdTask.h"
...
{
    FBatchCompleteByUserIdTask::FBatchCompleteByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FBatchCompleteByUserIdTask::Action(
        const TSharedPtr<Result::FBatchCompleteByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/any/batch");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FBatchCompleteByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
