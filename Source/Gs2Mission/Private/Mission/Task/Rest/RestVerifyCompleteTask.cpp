...
#include "Mission/Task/Rest/VerifyCompleteTask.h"
...
{
    FVerifyCompleteTask::FVerifyCompleteTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyCompleteTask::Action(
        const TSharedPtr<Result::FVerifyCompleteResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/complete/group/{missionGroupName}/task/{missionTaskName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyCompleteResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
