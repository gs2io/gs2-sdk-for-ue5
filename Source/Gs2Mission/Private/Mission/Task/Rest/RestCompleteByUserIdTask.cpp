...
#include "Mission/Task/Rest/CompleteByUserIdTask.h"
...
{
    FCompleteByUserIdTask::FCompleteByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCompleteByUserIdTask::Action(
        const TSharedPtr<Result::FCompleteByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/complete/group/{missionGroupName}/task/{missionTaskName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCompleteByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
