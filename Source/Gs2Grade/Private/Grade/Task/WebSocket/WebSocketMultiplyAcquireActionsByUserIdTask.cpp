...
#include "Grade/Task/WebSocket/MultiplyAcquireActionsByUserIdTask.h"
...
namespace Gs2::Grade::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("grade"), TEXT("status"), TEXT("multiplyAcquireActionsByUserId"), ToCStr(RequestPayload->Payload()));
