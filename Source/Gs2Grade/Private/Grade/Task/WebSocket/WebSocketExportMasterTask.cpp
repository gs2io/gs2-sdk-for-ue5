...
#include "Grade/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Grade::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("grade"), TEXT("currentGradeMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
