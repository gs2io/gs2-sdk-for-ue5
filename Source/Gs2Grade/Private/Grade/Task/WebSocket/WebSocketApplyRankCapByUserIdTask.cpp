...
#include "Grade/Task/WebSocket/ApplyRankCapByUserIdTask.h"
...
namespace Gs2::Grade::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("grade"), TEXT("status"), TEXT("applyRankCapByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FApplyRankCapByUserIdResult::FromJson(WebSocketResult->Body());
