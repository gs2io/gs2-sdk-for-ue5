...
#include "Grade/Task/Rest/DescribeStatusesByUserIdTask.h"
...
namespace Gs2::Grade::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetGradeName().IsSet()) {
                queryStrings.Add("gradeName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetGradeName().GetValue()));
            }
