...
#include "Grade/Task/Rest/UpdateGradeModelMasterTask.h"
...
{
    FUpdateGradeModelMasterTask::FUpdateGradeModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateGradeModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateGradeModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/{gradeName}");
            ...
            if (this->Request->GetDefaultGrades() != nullptr && this->Request->GetDefaultGrades().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetDefaultGrades())
                {
            ...
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetGradeEntries())
                {
                    v.Add(MakeShared<FJsonValueObject>(JsonObjectValue->ToJson()));
                }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateGradeModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
