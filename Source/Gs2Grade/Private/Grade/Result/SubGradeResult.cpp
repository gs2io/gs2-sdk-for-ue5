...
#include "Grade/Result/SubGradeResult.h"

namespace Gs2::Grade::Result
{
    FSubGradeResult::FSubGradeResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FSubGradeResult> FSubGradeResult::WithItem(
    ...
    TSharedPtr<FSubGradeResult> FSubGradeResult::WithExperienceNamespaceName(
    ...
    TSharedPtr<FSubGradeResult> FSubGradeResult::WithExperienceStatus(
    ...
    TSharedPtr<Model::FStatus> FSubGradeResult::GetItem() const
    {
    ...
    TOptional<FString> FSubGradeResult::GetExperienceNamespaceName() const
    {
        return ExperienceNamespaceNameValue;
    }

    TSharedPtr<Gs2::Experience::Model::FStatus> FSubGradeResult::GetExperienceStatus() const
    {
    ...
    TSharedPtr<FSubGradeResult> FSubGradeResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSubGradeResult>()
    ...
    TSharedPtr<FJsonObject> FSubGradeResult::ToJson() const
    {
