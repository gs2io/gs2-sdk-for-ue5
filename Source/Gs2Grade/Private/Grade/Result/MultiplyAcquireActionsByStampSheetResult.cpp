...
#include "Grade/Result/MultiplyAcquireActionsByStampSheetResult.h"

namespace Gs2::Grade::Result
{
    FMultiplyAcquireActionsByStampSheetResult::FMultiplyAcquireActionsByStampSheetResult():
        ItemsValue(nullptr),
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithItems(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithTransactionId(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithStampSheet(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithTransaction(
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::WithTransactionResult(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FAcquireAction>>> FMultiplyAcquireActionsByStampSheetResult::GetItems() const
    {
    ...
    TOptional<FString> FMultiplyAcquireActionsByStampSheetResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FMultiplyAcquireActionsByStampSheetResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FMultiplyAcquireActionsByStampSheetResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FMultiplyAcquireActionsByStampSheetResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FMultiplyAcquireActionsByStampSheetResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FMultiplyAcquireActionsByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FMultiplyAcquireActionsByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FMultiplyAcquireActionsByStampSheetResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FMultiplyAcquireActionsByStampSheetResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> FMultiplyAcquireActionsByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FMultiplyAcquireActionsByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FMultiplyAcquireActionsByStampSheetResult::ToJson() const
    {
