...
#include "Grade/Result/MultiplyAcquireActionsByUserIdResult.h"
...
namespace Gs2::Grade::Result
{
    ...
    TSharedPtr<FMultiplyAcquireActionsByUserIdResult> FMultiplyAcquireActionsByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FMultiplyAcquireActionsByUserIdResult> FMultiplyAcquireActionsByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FMultiplyAcquireActionsByUserIdResult> FMultiplyAcquireActionsByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FMultiplyAcquireActionsByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FMultiplyAcquireActionsByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FMultiplyAcquireActionsByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FMultiplyAcquireActionsByUserIdResult::GetTransactionResult() const
    {
