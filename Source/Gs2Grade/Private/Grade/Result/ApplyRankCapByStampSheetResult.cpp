...
{
    FApplyRankCapByStampSheetResult::FApplyRankCapByStampSheetResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FApplyRankCapByStampSheetResult> FApplyRankCapByStampSheetResult::WithItem(
    ...
    TSharedPtr<FApplyRankCapByStampSheetResult> FApplyRankCapByStampSheetResult::WithExperienceNamespaceName(
    ...
    TSharedPtr<FApplyRankCapByStampSheetResult> FApplyRankCapByStampSheetResult::WithExperienceStatus(
    ...
    TSharedPtr<Model::FStatus> FApplyRankCapByStampSheetResult::GetItem() const
    {
    ...
    TOptional<FString> FApplyRankCapByStampSheetResult::GetExperienceNamespaceName() const
    {
        return ExperienceNamespaceNameValue;
    }

    TSharedPtr<Gs2::Experience::Model::FStatus> FApplyRankCapByStampSheetResult::GetExperienceStatus() const
    {
    ...
    TSharedPtr<FApplyRankCapByStampSheetResult> FApplyRankCapByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FApplyRankCapByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FApplyRankCapByStampSheetResult::ToJson() const
    {
