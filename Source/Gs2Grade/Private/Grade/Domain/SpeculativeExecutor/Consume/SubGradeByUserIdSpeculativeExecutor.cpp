...
namespace Gs2::Grade::Domain::SpeculativeExecutor
{
    ...
    FString FSubGradeByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Grade:SubGradeByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FSubGradeByUserIdSpeculativeExecutor::Transform(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Grade::Request::FSubGradeByUserIdRequestPtr& Request,
    ...
    FSubGradeByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSubGradeByUserIdSpeculativeExecutor::FCommitTask::Action(
    ...
    )
    {
        *Result = nullptr;
        ...
        Gs2::Grade::Request::FSubGradeByUserIdRequestPtr PreparedRequest = nullptr;
        if (Request.IsValid()) PreparedRequest = MakeShared<Gs2::Grade::Request::FSubGradeByUserIdRequest>(*Request);
        ...
        *Result = FStatusSpeculativeCommit::Create(
            ...
            [PreparedRequest](const Gs2::Grade::Model::FStatusPtr& Source) -> Gs2::Grade::Model::FStatusPtr
            {
                ...
                if (Base < TNumericLimits<int64>::Min() + Delta) return nullptr;
    ...
    TSharedPtr<FAsyncTask<FSubGradeByUserIdSpeculativeExecutor::FCommitTask>> FSubGradeByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Grade::Domain::FGs2GradeDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Grade::Request::FSubGradeByUserIdRequestPtr& Request
    ...
    Gs2::Grade::Request::FSubGradeByUserIdRequestPtr FSubGradeByUserIdSpeculativeExecutor::Rate(
        const Gs2::Grade::Request::FSubGradeByUserIdRequestPtr& Request,
        const double Rate
    )
    {
