...
#include "Grade/Request/UpdateNamespaceRequest.h"
...
namespace Gs2::Grade::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithChangeGradeScript(
        const TSharedPtr<Model::FScriptSetting> ChangeGradeScript
    )
    {
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetChangeGradeScript() const
    {
        if (!ChangeGradeScriptValue.IsValid())
        {
            return nullptr;
        }
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FUpdateNamespaceRequest>()
          ...
          ->WithChangeGradeScript(Data->HasField("changeGradeScript") ? [Data]() -> Model::FScriptSettingPtr
              {
                  if (Data->HasTypedField<EJson::Null>("changeGradeScript"))
                  {
                      return nullptr;
                  }
                  return Model::FScriptSetting::FromJson(Data->GetObjectField("changeGradeScript"));
             }() : nullptr)
    ...
    TSharedPtr<FJsonObject> FUpdateNamespaceRequest::ToJson() const
    {
        ...
        {
            JsonRootObject->SetObjectField("changeGradeScript", ChangeGradeScriptValue->ToJson());
        }
