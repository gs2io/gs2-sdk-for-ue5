...
namespace Gs2::Grade::Domain::Iterator
{
    ...
    class GS2GRADE_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Grade::Model::FNamespace>> Result) override;
        ...
        class GS2GRADE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Grade::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Grade::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Grade::Model::FNamespacePtr& Current()
            {
