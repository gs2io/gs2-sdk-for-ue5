...
namespace Gs2::Grade::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Grade::Model::FGradeModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeGradeModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Grade::Model::FGradeModelPtr>> Range;
            TOptional<TArray<Gs2::Grade::Model::FGradeModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Grade::Model::FGradeModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGradeModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGradeModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGradeModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGradeModelsIterator> FDescribeGradeModelsIteratorPtr;
}
