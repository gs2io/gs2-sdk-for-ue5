...
namespace Gs2::Grade::Domain::Iterator
{
    ...
    class GS2GRADE_API FDescribeGradeModelMastersIterator :
        public TSharedFromThis<FDescribeGradeModelMastersIterator>
    {
    ...
    public:
        FDescribeGradeModelMastersIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Grade::FGs2GradeRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Grade::Model::FGradeModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeGradeModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Grade::Model::FGradeModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Grade::Model::FGradeModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Grade::Model::FGradeModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGradeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGradeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGradeModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGradeModelMastersIterator> FDescribeGradeModelMastersIteratorPtr;
}
