...
namespace Gs2::Grade::Domain::SpeculativeExecutor
{
    ...
    class GS2GRADE_API FSubGradeByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2GRADE_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Grade::Domain::FGs2GradeDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Grade::Request::FSubGradeByUserIdRequestPtr& Request
            ...
            GS2GRADE_API FCommitTask(
                const FCommitTask& From
            );

            GS2GRADE_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Grade::Request::FSubGradeByUserIdRequestPtr Rate(
            const Gs2::Grade::Request::FSubGradeByUserIdRequestPtr& Request,
            const double Rate
        );
