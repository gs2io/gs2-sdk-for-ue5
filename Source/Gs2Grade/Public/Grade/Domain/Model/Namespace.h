...
namespace Gs2::Grade::Domain::Model
{
    ...
    class GS2GRADE_API FNamespaceDomain:
    ...
    public:
        ...
        class GS2GRADE_API FCreateGradeModelMasterTask final :
            ...
            public TSharedFromThis<FCreateGradeModelMasterTask>
        {
            const TSharedPtr<FNamespaceDomain> Self;
            const Request::FCreateGradeModelMasterRequestPtr Request;
        public:
            explicit FCreateGradeModelMasterTask(
                const TSharedPtr<FNamespaceDomain>& Self,
                const Request::FCreateGradeModelMasterRequestPtr Request
            );

            FCreateGradeModelMasterTask(
        ...
        friend FCreateGradeModelMasterTask;

        TSharedPtr<FAsyncTask<FCreateGradeModelMasterTask>> CreateGradeModelMaster(
            Request::FCreateGradeModelMasterRequestPtr Request
        );

        TSharedPtr<Gs2::Grade::Domain::Model::FCurrentGradeMasterDomain> CurrentGradeMaster(
        );

        Gs2::Grade::Domain::Iterator::FDescribeGradeModelsIteratorPtr GradeModels(
        ) const;
        ...
        TSharedPtr<Gs2::Grade::Domain::Model::FGradeModelDomain> GradeModel(
        ...
        TSharedPtr<Gs2::Grade::Domain::Model::FGradeModelMasterDomain> GradeModelMaster(
            const FString GradeName
        );

        TSharedPtr<Gs2::Grade::Domain::Model::FUserDomain> User(
            const FString UserId
        );

        TSharedPtr<Gs2::Grade::Domain::Model::FUserAccessTokenDomain> AccessToken(
