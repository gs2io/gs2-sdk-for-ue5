...
namespace Gs2::Grade::Request
{
    ...
    class GS2GRADE_API FGetStatusRequest final : public TSharedFromThis<FGetStatusRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetStatusRequest> WithGradeName(const TOptional<FString> GradeName);
