...
namespace Gs2::Grade::Request
{
    ...
    class GS2GRADE_API FCreateNamespaceRequest final : public TSharedFromThis<FCreateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FCreateNamespaceRequest> WithChangeGradeScript(const TSharedPtr<Model::FScriptSetting> ChangeGradeScript);
