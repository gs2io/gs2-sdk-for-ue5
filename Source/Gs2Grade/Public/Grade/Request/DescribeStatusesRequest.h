...
namespace Gs2::Grade::Request
{
    ...
    class GS2GRADE_API FDescribeStatusesRequest final : public TSharedFromThis<FDescribeStatusesRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeStatusesRequest> WithGradeName(const TOptional<FString> GradeName);
