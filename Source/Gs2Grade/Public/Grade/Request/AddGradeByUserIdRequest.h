...
namespace Gs2::Grade::Request
{
    ...
    public:
        ...
        TSharedPtr<FAddGradeByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FAddGradeByUserIdRequest> FAddGradeByUserIdRequestPtr;
}