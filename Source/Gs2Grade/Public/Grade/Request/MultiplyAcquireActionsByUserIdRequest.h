...
namespace Gs2::Grade::Request
{
    ...
    class GS2GRADE_API FMultiplyAcquireActionsByUserIdRequest final : public TSharedFromThis<FMultiplyAcquireActionsByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FMultiplyAcquireActionsByUserIdRequest> WithGradeName(const TOptional<FString> GradeName);
