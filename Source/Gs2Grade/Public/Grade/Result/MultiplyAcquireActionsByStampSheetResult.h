...
{
    class GS2GRADE_API FMultiplyAcquireActionsByStampSheetResult final : public TSharedFromThis<FMultiplyAcquireActionsByStampSheetResult>
    {
    ...
    public:
        ...
        TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> WithAtomicCommit(const TOptional<bool> AtomicCommit);
        TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> WithTransaction(const TOptional<FString> Transaction);
        TSharedPtr<FMultiplyAcquireActionsByStampSheetResult> WithTransactionResult(const TSharedPtr<Gs2::Core::Model::FTransactionResult> TransactionResult);
