...
#include "Grade/Result/CreateNamespaceResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
