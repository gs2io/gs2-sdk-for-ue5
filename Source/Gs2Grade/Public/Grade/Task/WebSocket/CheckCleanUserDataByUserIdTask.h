...
#include "Grade/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Grade/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
