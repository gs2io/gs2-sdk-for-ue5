...
#include "Grade/Request/DescribeNamespacesRequest.h"
#include "Grade/Result/DescribeNamespacesResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
