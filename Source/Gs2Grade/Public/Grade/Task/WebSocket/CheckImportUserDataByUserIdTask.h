...
#include "Grade/Request/CheckImportUserDataByUserIdRequest.h"
#include "Grade/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
