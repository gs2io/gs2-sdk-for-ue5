...
#include "Grade/Result/UpdateNamespaceResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
