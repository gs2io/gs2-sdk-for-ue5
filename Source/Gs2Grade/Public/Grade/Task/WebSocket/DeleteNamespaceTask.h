...
#include "Grade/Request/DeleteNamespaceRequest.h"
#include "Grade/Result/DeleteNamespaceResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
