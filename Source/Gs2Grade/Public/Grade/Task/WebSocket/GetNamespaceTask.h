...
#include "Grade/Request/GetNamespaceRequest.h"
#include "Grade/Result/GetNamespaceResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
