...
#include "Grade/Request/CleanUserDataByUserIdRequest.h"
#include "Grade/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
