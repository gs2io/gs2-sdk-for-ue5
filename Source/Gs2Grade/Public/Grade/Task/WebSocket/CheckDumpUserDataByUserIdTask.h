...
#include "Grade/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Grade/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::WebSocket
{
    class GS2GRADE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
