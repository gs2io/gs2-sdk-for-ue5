...
#include "Grade/Request/GetServiceVersionRequest.h"
#include "Grade/Result/GetServiceVersionResult.h"

namespace Gs2::Grade::Task::Rest
{
    class GS2GRADE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
