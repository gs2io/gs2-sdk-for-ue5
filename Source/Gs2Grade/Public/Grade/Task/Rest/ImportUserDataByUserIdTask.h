...
#include "Grade/Request/ImportUserDataByUserIdRequest.h"
#include "Grade/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::Rest
{
    class GS2GRADE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
