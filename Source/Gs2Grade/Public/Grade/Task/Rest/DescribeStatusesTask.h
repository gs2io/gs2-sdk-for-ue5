...
#include "Grade/Result/DescribeStatusesResult.h"

namespace Gs2::Grade::Task::Rest
{
    class GS2GRADE_API FDescribeStatusesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeStatusesResult>
    {
