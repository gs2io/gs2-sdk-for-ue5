...
#include "Grade/Request/GetNamespaceStatusRequest.h"
#include "Grade/Result/GetNamespaceStatusResult.h"

namespace Gs2::Grade::Task::Rest
{
    class GS2GRADE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
