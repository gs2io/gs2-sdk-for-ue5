...
#include "Grade/Request/DumpUserDataByUserIdRequest.h"
#include "Grade/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Grade::Task::Rest
{
    class GS2GRADE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
