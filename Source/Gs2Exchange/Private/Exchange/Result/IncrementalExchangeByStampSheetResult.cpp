...
namespace Gs2::Exchange::Result
{
    ...
    TSharedPtr<FIncrementalExchangeByStampSheetResult> FIncrementalExchangeByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FIncrementalExchangeByStampSheetResult> FIncrementalExchangeByStampSheetResult::WithTransaction(
    ...
    TSharedPtr<FIncrementalExchangeByStampSheetResult> FIncrementalExchangeByStampSheetResult::WithTransactionResult(
    ...
    TOptional<bool> FIncrementalExchangeByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FIncrementalExchangeByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FIncrementalExchangeByStampSheetResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FIncrementalExchangeByStampSheetResult::GetTransactionResult() const
    {
