...
#include "Exchange/Result/PreUpdateCurrentRateMasterResult.h"

namespace Gs2::Exchange::Result
{
    FPreUpdateCurrentRateMasterResult::FPreUpdateCurrentRateMasterResult():
    ...
    FPreUpdateCurrentRateMasterResult::FPreUpdateCurrentRateMasterResult(
        const FPreUpdateCurrentRateMasterResult& From
    ):
    ...
    TSharedPtr<FPreUpdateCurrentRateMasterResult> FPreUpdateCurrentRateMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentRateMasterResult> FPreUpdateCurrentRateMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentRateMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentRateMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentRateMasterResult> FPreUpdateCurrentRateMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentRateMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentRateMasterResult::ToJson() const
    {
