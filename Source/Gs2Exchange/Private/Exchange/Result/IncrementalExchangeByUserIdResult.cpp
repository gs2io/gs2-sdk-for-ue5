...
{
    FIncrementalExchangeByUserIdResult::FIncrementalExchangeByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithItem(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FIncrementalRateModel> FIncrementalExchangeByUserIdResult::GetItem() const
    {
    ...
    TOptional<FString> FIncrementalExchangeByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FIncrementalExchangeByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FIncrementalExchangeByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FIncrementalExchangeByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FIncrementalExchangeByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FIncrementalExchangeByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FIncrementalExchangeByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FIncrementalExchangeByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FIncrementalExchangeByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FIncrementalExchangeByUserIdResult> FIncrementalExchangeByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FIncrementalExchangeByUserIdResult>()
            ->WithItem(Data->HasField(ANSI_TO_TCHAR("item")) ? [Data]() -> Model::FIncrementalRateModelPtr
                 {
                    if (Data->HasTypedField<EJson::Null>(ANSI_TO_TCHAR("item")))
                    {
                        return nullptr;
                    }
                    return Model::FIncrementalRateModel::FromJson(Data->GetObjectField(ANSI_TO_TCHAR("item")));
                 }() : nullptr)
    ...
    TSharedPtr<FJsonObject> FIncrementalExchangeByUserIdResult::ToJson() const
    {
