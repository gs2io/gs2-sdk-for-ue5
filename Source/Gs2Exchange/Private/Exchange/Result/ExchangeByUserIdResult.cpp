...
namespace Gs2::Exchange::Result
{
    ...
    TSharedPtr<FExchangeByUserIdResult> FExchangeByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FExchangeByUserIdResult> FExchangeByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FExchangeByUserIdResult> FExchangeByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FExchangeByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FExchangeByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FExchangeByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FExchangeByUserIdResult::GetTransactionResult() const
    {
