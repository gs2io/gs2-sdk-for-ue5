...
namespace Gs2::Exchange::Result
{
    ...
    TSharedPtr<FSkipResult> FSkipResult::WithItem(
    ...
    TSharedPtr<FSkipResult> FSkipResult::WithTransactionId(
    ...
    TSharedPtr<FSkipResult> FSkipResult::WithStampSheet(
    ...
    TSharedPtr<FSkipResult> FSkipResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FSkipResult> FSkipResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<Model::FAwait> FSkipResult::GetItem() const
    {
    ...
    TOptional<FString> FSkipResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FSkipResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FSkipResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FSkipResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FSkipResult::GetAutoRunStampSheetString() const
    {
    ...
    TSharedPtr<FSkipResult> FSkipResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSkipResult>()
    ...
    TSharedPtr<FJsonObject> FSkipResult::ToJson() const
    {
