...
namespace Gs2::Exchange::Result
{
    ...
    TSharedPtr<FAcquireForceByUserIdResult> FAcquireForceByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FAcquireForceByUserIdResult> FAcquireForceByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FAcquireForceByUserIdResult> FAcquireForceByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FAcquireForceByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FAcquireForceByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FAcquireForceByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FAcquireForceByUserIdResult::GetTransactionResult() const
    {
