...
namespace Gs2::Exchange::Request
{
    ...
    TSharedPtr<FCreateAwaitByUserIdRequest> FCreateAwaitByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FCreateAwaitByUserIdRequest::GetTimeOffsetToken() const
    {
