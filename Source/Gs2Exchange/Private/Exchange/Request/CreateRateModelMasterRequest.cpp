...
namespace Gs2::Exchange::Request
{
    ...
    TSharedPtr<FCreateRateModelMasterRequest> FCreateRateModelMasterRequest::WithEnableSkip(
    ...
    TSharedPtr<FCreateRateModelMasterRequest> FCreateRateModelMasterRequest::WithSkipConsumeActions(
    ...
    TOptional<bool> FCreateRateModelMasterRequest::GetEnableSkip() const
    {
        return EnableSkipValue;
    }

    FString FCreateRateModelMasterRequest::GetEnableSkipString() const
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FConsumeAction>>> FCreateRateModelMasterRequest::GetSkipConsumeActions() const
    {
