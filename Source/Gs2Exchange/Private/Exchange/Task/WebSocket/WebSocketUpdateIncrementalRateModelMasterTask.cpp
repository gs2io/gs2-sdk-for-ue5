...
#include "Exchange/Task/WebSocket/UpdateIncrementalRateModelMasterTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("incrementalRateModelMaster"), TEXT("updateIncrementalRateModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateIncrementalRateModelMasterResult::FromJson(WebSocketResult->Body());
