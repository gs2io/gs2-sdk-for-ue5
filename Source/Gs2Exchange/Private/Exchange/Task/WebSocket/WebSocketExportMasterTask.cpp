...
#include "Exchange/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("currentRateMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
