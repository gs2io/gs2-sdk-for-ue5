...
#include "Exchange/Task/WebSocket/CreateIncrementalRateModelMasterTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("incrementalRateModelMaster"), TEXT("createIncrementalRateModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateIncrementalRateModelMasterResult::FromJson(WebSocketResult->Body());
