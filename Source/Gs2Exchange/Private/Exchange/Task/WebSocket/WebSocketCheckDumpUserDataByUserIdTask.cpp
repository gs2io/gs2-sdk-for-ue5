...
#include "Exchange/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
