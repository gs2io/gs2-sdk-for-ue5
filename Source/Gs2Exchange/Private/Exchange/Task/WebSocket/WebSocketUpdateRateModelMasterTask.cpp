...
#include "Exchange/Task/WebSocket/UpdateRateModelMasterTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("rateModelMaster"), TEXT("updateRateModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateRateModelMasterResult::FromJson(WebSocketResult->Body());
