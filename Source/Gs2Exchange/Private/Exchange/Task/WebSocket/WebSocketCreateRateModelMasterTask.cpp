...
#include "Exchange/Task/WebSocket/CreateRateModelMasterTask.h"
...
namespace Gs2::Exchange::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("exchange"), TEXT("rateModelMaster"), TEXT("createRateModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateRateModelMasterResult::FromJson(WebSocketResult->Body());
