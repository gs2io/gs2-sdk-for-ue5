...
#include "Exchange/Task/Rest/DescribeAwaitsByUserIdTask.h"
...
{
    FDescribeAwaitsByUserIdTask::FDescribeAwaitsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeAwaitsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeAwaitsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/exchange/await");
            ...
            if (this->Request->GetRateName().IsSet()) {
                queryStrings.Add("rateName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetRateName().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeAwaitsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
