...
#include "Exchange/Task/Rest/DescribeAwaitsTask.h"
...
{
    FDescribeAwaitsTask::FDescribeAwaitsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeAwaitsTask::Action(
        const TSharedPtr<Result::FDescribeAwaitsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/exchange/await");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeAwaitsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
