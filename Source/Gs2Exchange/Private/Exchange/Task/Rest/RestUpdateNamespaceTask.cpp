...
namespace Gs2::Exchange::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetBoolField("enableAwaitExchange", this->Request->GetEnableAwaitExchange().GetValue());
            }
            if (this->Request->GetEnableDirectExchange().IsSet())
            {
                JsonRootObject->SetBoolField("enableDirectExchange", this->Request->GetEnableDirectExchange().GetValue());
            }
