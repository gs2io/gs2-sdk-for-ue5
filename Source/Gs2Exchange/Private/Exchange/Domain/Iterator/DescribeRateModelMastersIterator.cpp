...
namespace Gs2::Exchange::Domain::Iterator
{
    ...
    const Gs2::Exchange::Model::FRateModelMasterPtr& FDescribeRateModelMastersIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Exchange::Model::FRateModelMasterPtr FDescribeRateModelMastersIterator::IteratorImpl::operator->()
    {
        return Current;
    }
