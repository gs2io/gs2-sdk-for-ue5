...
namespace Gs2::Exchange::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FDeleteAwaitByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FDeleteAwaitByUserIdRequest::FromJson(RequestModelJson);
            Request = FDeleteAwaitByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FDeleteAwaitByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
