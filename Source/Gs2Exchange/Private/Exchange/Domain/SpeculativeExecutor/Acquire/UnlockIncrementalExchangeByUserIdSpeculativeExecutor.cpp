...
namespace Gs2::Exchange::Domain::SpeculativeExecutor
{
    ...
    FString FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2Exchange:UnlockIncrementalExchangeByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::Transform(
    ...
    FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
    ...
    TSharedPtr<FAsyncTask<FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::FCommitTask>> FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Exchange::Domain::FGs2ExchangeDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Exchange::Request::FUnlockIncrementalExchangeByUserIdRequestPtr& Request
    ...
    Gs2::Exchange::Request::FUnlockIncrementalExchangeByUserIdRequestPtr FUnlockIncrementalExchangeByUserIdSpeculativeExecutor::Rate(
        const Gs2::Exchange::Request::FUnlockIncrementalExchangeByUserIdRequestPtr& Request,
        const double Rate
    )
    {
