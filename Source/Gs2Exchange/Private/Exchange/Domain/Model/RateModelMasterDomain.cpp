...
namespace Gs2::Exchange::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete(Gs2::Exchange::Model::FRateModelMaster::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::Exchange::Model::FRateModelMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::Exchange::Model::FRateModelMaster>(
                Self->ParentKey,
                Gs2::Exchange::Domain::Model::FRateModelMasterDomain::CreateCacheKey(
                    Self->RateName
                ),
