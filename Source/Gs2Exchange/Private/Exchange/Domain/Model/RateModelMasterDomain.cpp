...
namespace Gs2::Exchange::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Exchange::Model::FRateModelMaster>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete<Gs2::Exchange::Model::FRateModelMaster>(ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Exchange::Model::FRateModelMaster>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Exchange::Model::FRateModelMaster>(
                            Self->ParentKey,
                            Gs2::Exchange::Domain::Model::FRateModelMasterDomain::CreateCacheKey(
                                Self->RateName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Exchange::Model::FRateModelMaster>(
                Self->ParentKey,
                Gs2::Exchange::Domain::Model::FRateModelMasterDomain::CreateCacheKey(
                    Self->RateName
                )
