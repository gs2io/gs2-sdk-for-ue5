...
namespace Gs2::Exchange::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Exchange::Model::FCurrentRateMaster>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Exchange::Model::FCurrentRateMaster>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Exchange::Model::FCurrentRateMaster>(
                            Self->ParentKey,
                            Gs2::Exchange::Domain::Model::FCurrentRateMasterDomain::CreateCacheKey(
                            )
                        );
            ...
            Value = Self->Cache->Get<Gs2::Exchange::Model::FCurrentRateMaster>(
                Self->ParentKey,
                Gs2::Exchange::Domain::Model::FCurrentRateMasterDomain::CreateCacheKey(
                )
            );
