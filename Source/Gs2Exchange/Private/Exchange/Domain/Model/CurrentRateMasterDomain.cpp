...
namespace Gs2::Exchange::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Exchange::Model::FCurrentRateMasterPtr Value;
                const auto CacheHit = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Exchange::Model::FCurrentRateMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FCurrentRateMasterDomain::Invalidate()
    {
        Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::Delete(
            Gs2->Cache,
    ...
    FCurrentRateMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCurrentRateMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentRateMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCurrentRateMasterDomain::FSubscribeWithInitialCallTask>> FCurrentRateMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Exchange::Model::FCurrentRateMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Exchange::Model::Cache::FCurrentRateMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName]()
            {
                ...
                const auto Domain = MakeShared<FCurrentRateMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName
                );
