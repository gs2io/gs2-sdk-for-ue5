...
namespace Gs2::Exchange
{
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FGetServiceVersionTask>> FGs2ExchangeRestClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FPreUpdateCurrentRateMasterTask>> FGs2ExchangeRestClient::PreUpdateCurrentRateMaster(
