...
#include "Exchange/Request/DeleteNamespaceRequest.h"
#include "Exchange/Result/DeleteNamespaceResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
