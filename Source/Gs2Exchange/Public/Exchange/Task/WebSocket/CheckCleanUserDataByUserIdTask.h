...
#include "Exchange/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Exchange/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
