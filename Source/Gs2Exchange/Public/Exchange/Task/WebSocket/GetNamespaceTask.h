...
#include "Exchange/Request/GetNamespaceRequest.h"
#include "Exchange/Result/GetNamespaceResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
