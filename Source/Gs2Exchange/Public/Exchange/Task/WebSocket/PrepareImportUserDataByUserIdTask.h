...
#include "Exchange/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Exchange/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
