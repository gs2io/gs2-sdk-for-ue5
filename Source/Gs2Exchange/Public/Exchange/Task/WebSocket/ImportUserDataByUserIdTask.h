...
#include "Exchange/Request/ImportUserDataByUserIdRequest.h"
#include "Exchange/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
