...
#include "Exchange/Request/GetServiceVersionRequest.h"
#include "Exchange/Result/GetServiceVersionResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
