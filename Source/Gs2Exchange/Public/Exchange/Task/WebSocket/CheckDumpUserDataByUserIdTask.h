...
#include "Exchange/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Exchange/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::WebSocket
{
    class GS2EXCHANGE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
