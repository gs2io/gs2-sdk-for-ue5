...
#include "Exchange/Request/CheckImportUserDataByUserIdRequest.h"
#include "Exchange/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::Rest
{
    class GS2EXCHANGE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
