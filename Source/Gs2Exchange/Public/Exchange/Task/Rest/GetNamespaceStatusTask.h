...
#include "Exchange/Request/GetNamespaceStatusRequest.h"
#include "Exchange/Result/GetNamespaceStatusResult.h"

namespace Gs2::Exchange::Task::Rest
{
    class GS2EXCHANGE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
