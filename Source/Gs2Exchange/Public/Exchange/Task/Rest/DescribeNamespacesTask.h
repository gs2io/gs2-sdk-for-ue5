...
#include "Exchange/Request/DescribeNamespacesRequest.h"
#include "Exchange/Result/DescribeNamespacesResult.h"

namespace Gs2::Exchange::Task::Rest
{
    class GS2EXCHANGE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
