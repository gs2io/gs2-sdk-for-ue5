...
#include "Exchange/Request/DumpUserDataByUserIdRequest.h"
#include "Exchange/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Exchange::Task::Rest
{
    class GS2EXCHANGE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
