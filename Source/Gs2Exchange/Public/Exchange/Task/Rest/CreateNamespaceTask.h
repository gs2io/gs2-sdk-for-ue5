...
#include "Exchange/Result/CreateNamespaceResult.h"

namespace Gs2::Exchange::Task::Rest
{
    class GS2EXCHANGE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
