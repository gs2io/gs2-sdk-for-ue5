...
namespace Gs2::Exchange::Request
{
    ...
    class GS2EXCHANGE_API FUpdateCurrentRateMasterRequest final : public TSharedFromThis<FUpdateCurrentRateMasterRequest>
    {
    ...
    typedef TSharedPtr<FUpdateCurrentRateMasterRequest, ESPMode::ThreadSafe> FUpdateCurrentRateMasterRequestPtr;
}