...
namespace Gs2::Exchange::Request
{
    ...
    class GS2EXCHANGE_API FGetRateModelRequest final : public TSharedFromThis<FGetRateModelRequest>
    {
    ...
    typedef TSharedPtr<FGetRateModelRequest, ESPMode::ThreadSafe> FGetRateModelRequestPtr;
}