...
namespace Gs2::Exchange::Request
{
    ...
    public:
        ...
        TSharedPtr<FCreateRateModelMasterRequest> WithEnableSkip(const TOptional<bool> EnableSkip);
        TSharedPtr<FCreateRateModelMasterRequest> WithSkipConsumeActions(const TSharedPtr<TArray<TSharedPtr<Model::FConsumeAction>>> SkipConsumeActions);
