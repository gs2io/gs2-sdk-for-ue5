...
namespace Gs2::Exchange::Domain::SpeculativeExecutor
{
    ...
    class GS2EXCHANGE_API FUnlockIncrementalExchangeByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Exchange::Request::FUnlockIncrementalExchangeByUserIdRequestPtr Rate(
            const Gs2::Exchange::Request::FUnlockIncrementalExchangeByUserIdRequestPtr& Request,
            const double Rate
        );
