...
namespace Gs2::Exchange::Domain::SpeculativeExecutor
{
    ...
    class GS2EXCHANGE_API FCreateAwaitByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2EXCHANGE_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Exchange::Domain::FGs2ExchangeDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Exchange::Request::FCreateAwaitByUserIdRequestPtr& Request
            ...
            GS2EXCHANGE_API FCommitTask(
                const FCommitTask& From
            );

            GS2EXCHANGE_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Exchange::Request::FCreateAwaitByUserIdRequestPtr Rate(
            const Gs2::Exchange::Request::FCreateAwaitByUserIdRequestPtr& Request,
            const double Rate
        );
