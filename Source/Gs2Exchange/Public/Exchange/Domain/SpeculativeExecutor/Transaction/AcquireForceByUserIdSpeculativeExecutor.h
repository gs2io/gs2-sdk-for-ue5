...
{
    class GS2EXCHANGE_API FAcquireForceByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FAcquireForceByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Exchange::Domain::FGs2ExchangeDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Exchange::Request::FAcquireForceByUserIdRequestPtr& Request
