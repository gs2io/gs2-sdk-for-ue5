...
{
    class GS2EXCHANGE_API FIncrementalExchangeByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FIncrementalExchangeByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Exchange::Domain::FGs2ExchangeDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Exchange::Request::FIncrementalExchangeByUserIdRequestPtr& Request
