...
namespace Gs2::Exchange::Domain::Iterator
{
    ...
    class GS2EXCHANGE_API FDescribeIncrementalRateModelsIterator :
        public TSharedFromThis<FDescribeIncrementalRateModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Exchange::Model::FIncrementalRateModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeIncrementalRateModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Exchange::Model::FIncrementalRateModelPtr>> Range;
            TOptional<TArray<Gs2::Exchange::Model::FIncrementalRateModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Exchange::Model::FIncrementalRateModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeIncrementalRateModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeIncrementalRateModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeIncrementalRateModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeIncrementalRateModelsIterator> FDescribeIncrementalRateModelsIteratorPtr;
}
