...
namespace Gs2::Exchange::Domain::Iterator
{
    ...
    class GS2EXCHANGE_API FDescribeAwaitsIterator :
        public TSharedFromThis<FDescribeAwaitsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeAwaitsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAwaitsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAwaitsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAwaitsIterator> Iterable)
            {
