...
namespace Gs2::Exchange::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Exchange::Model::FRateModelMaster>> Result) override;
        ...
        class GS2EXCHANGE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Exchange::Model::FRateModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Exchange::Model::FRateModelMasterPtr>::TIterator> RangeIteratorOpt;
