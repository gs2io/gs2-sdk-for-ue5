...
namespace Gs2::Exchange::Domain
{
    ...
    class GS2EXCHANGE_API FGs2ExchangeDomain:
    ...
    public:
        ...
        class GS2EXCHANGE_API FCreateNamespaceTask final :
        ...
        class GS2EXCHANGE_API FDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FCheckDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FCheckCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        class GS2EXCHANGE_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExchangeDomain>,
        ...
        Gs2::Exchange::Domain::Iterator::FDescribeNamespacesIteratorPtr Namespaces(
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Exchange::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2EXCHANGE_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2ExchangeDomain> Self;
            const TFunction<void(TArray<Gs2::Exchange::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2ExchangeDomain>& Self, TFunction<void(TArray<Gs2::Exchange::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
