...
namespace Gs2::Script::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Script::Model::FNamespace>> Result) override;
        ...
        class GS2SCRIPT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Script::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Script::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
