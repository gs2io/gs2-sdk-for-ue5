...
#include "Script/Request/GetServiceVersionRequest.h"
#include "Script/Result/GetServiceVersionResult.h"

namespace Gs2::Script::Task::WebSocket
{
    class GS2SCRIPT_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
