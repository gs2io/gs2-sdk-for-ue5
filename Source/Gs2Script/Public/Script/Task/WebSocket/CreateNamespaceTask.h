...
#include "Script/Request/CreateNamespaceRequest.h"
#include "Script/Result/CreateNamespaceResult.h"

namespace Gs2::Script::Task::WebSocket
{
    class GS2SCRIPT_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
