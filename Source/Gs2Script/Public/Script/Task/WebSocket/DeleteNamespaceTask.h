...
#include "Script/Request/DeleteNamespaceRequest.h"
#include "Script/Result/DeleteNamespaceResult.h"

namespace Gs2::Script::Task::WebSocket
{
    class GS2SCRIPT_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
