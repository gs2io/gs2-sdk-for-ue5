...
#include "Script/Request/UpdateNamespaceRequest.h"
#include "Script/Result/UpdateNamespaceResult.h"

namespace Gs2::Script::Task::Rest
{
    class GS2SCRIPT_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
