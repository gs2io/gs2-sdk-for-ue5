...
#include "Script/Request/GetNamespaceStatusRequest.h"
#include "Script/Result/GetNamespaceStatusResult.h"

namespace Gs2::Script::Task::Rest
{
    class GS2SCRIPT_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
