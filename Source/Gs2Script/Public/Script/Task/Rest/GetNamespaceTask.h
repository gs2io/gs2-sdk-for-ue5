...
#include "Script/Request/GetNamespaceRequest.h"
#include "Script/Result/GetNamespaceResult.h"

namespace Gs2::Script::Task::Rest
{
    class GS2SCRIPT_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
