...
#include "Script/Task/WebSocket/InvokeScriptTask.h"
...
namespace Gs2::Script::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("script"), TEXT("script"), TEXT("invokeScript"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FInvokeScriptResult::FromJson(WebSocketResult->Body());
