...
#include "Script/Task/Rest/DeleteScriptTask.h"
...
{
    FDeleteScriptTask::FDeleteScriptTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteScriptTask::Action(
        const TSharedPtr<Result::FDeleteScriptResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteScriptResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
