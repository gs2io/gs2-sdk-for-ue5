...
#include "Script/Task/Rest/GetScriptTask.h"
...
namespace Gs2::Script::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetScriptTask::Action(
        const TSharedPtr<Result::FGetScriptResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetScriptResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
