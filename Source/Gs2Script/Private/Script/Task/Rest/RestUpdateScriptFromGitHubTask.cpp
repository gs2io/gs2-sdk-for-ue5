...
#include "Script/Task/Rest/UpdateScriptFromGitHubTask.h"
...
{
    FUpdateScriptFromGitHubTask::FUpdateScriptFromGitHubTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateScriptFromGitHubTask::Action(
        const TSharedPtr<Result::FUpdateScriptFromGitHubResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/script/{scriptName}/from_git_hub");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateScriptFromGitHubResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
