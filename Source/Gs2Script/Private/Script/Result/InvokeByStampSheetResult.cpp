...
namespace Gs2::Script::Result
{
    ...
    TSharedPtr<FInvokeByStampSheetResult> FInvokeByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FInvokeByStampSheetResult> FInvokeByStampSheetResult::WithTransactionResult(
    ...
    TOptional<bool> FInvokeByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FInvokeByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TSharedPtr<Gs2::Core::Model::FTransactionResult> FInvokeByStampSheetResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FInvokeByStampSheetResult> FInvokeByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FInvokeByStampSheetResult>()
            ...
            ->WithOutput(Data->HasField(ANSI_TO_TCHAR("output")) ? [Data]() -> TSharedPtr<TArray<FString>>
                 {
                    if (!Data->HasTypedField<EJson::Array>(ANSI_TO_TCHAR("output")))
                    {
                        return nullptr;
                    }
