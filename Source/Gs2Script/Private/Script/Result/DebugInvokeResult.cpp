...
namespace Gs2::Script::Result
{
    ...
    TSharedPtr<FDebugInvokeResult> FDebugInvokeResult::WithAtomicCommit(
    ...
    TSharedPtr<FDebugInvokeResult> FDebugInvokeResult::WithTransactionResult(
    ...
    TOptional<bool> FDebugInvokeResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FDebugInvokeResult::GetAtomicCommitString() const
    {
    ...
    TSharedPtr<Gs2::Core::Model::FTransactionResult> FDebugInvokeResult::GetTransactionResult() const
    {
