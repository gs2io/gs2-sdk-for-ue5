...
namespace Gs2::Key::Result
{
    ...
    TSharedPtr<FDecryptResult> FDecryptResult::WithData(
    ...
    TOptional<FString> FDecryptResult::GetData() const
    {
        return DataValue;
    }

    TSharedPtr<FDecryptResult> FDecryptResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
    ...
    TSharedPtr<FJsonObject> FDecryptResult::ToJson() const
    {
