...
#include "Key/Task/Rest/DeleteKeyTask.h"
...
namespace Gs2::Key::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FDeleteKeyTask::Action(
        const TSharedPtr<Result::FDeleteKeyResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteKeyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
