...
#include "Key/Request/DeleteNamespaceRequest.h"
#include "Key/Result/DeleteNamespaceResult.h"

namespace Gs2::Key::Task::WebSocket
{
    class GS2KEY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
