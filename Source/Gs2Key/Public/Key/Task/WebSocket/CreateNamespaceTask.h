...
#include "Key/Request/CreateNamespaceRequest.h"
#include "Key/Result/CreateNamespaceResult.h"

namespace Gs2::Key::Task::WebSocket
{
    class GS2KEY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
