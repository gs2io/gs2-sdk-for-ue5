...
#include "Key/Request/GetNamespaceStatusRequest.h"
#include "Key/Result/GetNamespaceStatusResult.h"

namespace Gs2::Key::Task::WebSocket
{
    class GS2KEY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
