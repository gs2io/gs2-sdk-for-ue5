...
#include "Key/Request/GetServiceVersionRequest.h"
#include "Key/Result/GetServiceVersionResult.h"

namespace Gs2::Key::Task::Rest
{
    class GS2KEY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
