...
#include "Key/Request/UpdateNamespaceRequest.h"
#include "Key/Result/UpdateNamespaceResult.h"

namespace Gs2::Key::Task::Rest
{
    class GS2KEY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
