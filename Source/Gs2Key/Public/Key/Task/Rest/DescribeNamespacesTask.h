...
#include "Key/Request/DescribeNamespacesRequest.h"
#include "Key/Result/DescribeNamespacesResult.h"

namespace Gs2::Key::Task::Rest
{
    class GS2KEY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
