...
#include "Key/Request/GetNamespaceRequest.h"
#include "Key/Result/GetNamespaceResult.h"

namespace Gs2::Key::Task::Rest
{
    class GS2KEY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
