...
namespace Gs2::Key::Domain::SpeculativeExecutor
{
    class GS2KEY_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Key::Domain::FGs2KeyDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2KEY_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Key::Domain::FGs2KeyDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2KEY_API FCommitTask(
                const FCommitTask& From
            );

            GS2KEY_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
