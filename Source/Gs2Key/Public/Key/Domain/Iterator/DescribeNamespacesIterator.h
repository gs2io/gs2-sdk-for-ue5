...
namespace Gs2::Key::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Key::Model::FNamespace>> Result) override;
        ...
        class GS2KEY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Key::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Key::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
