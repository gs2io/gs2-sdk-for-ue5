...
namespace Gs2::Key::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Key::Model::FGitHubApiKey>> Result) override;
        ...
        class GS2KEY_API FIterator
        {
            TSharedRef<FDescribeGitHubApiKeysIterator> Self;
            TSharedPtr<TArray<Gs2::Key::Model::FGitHubApiKeyPtr>> Range;
            TOptional<TArray<Gs2::Key::Model::FGitHubApiKeyPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGitHubApiKeysIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGitHubApiKeysIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGitHubApiKeysIterator> Iterable)
            {
