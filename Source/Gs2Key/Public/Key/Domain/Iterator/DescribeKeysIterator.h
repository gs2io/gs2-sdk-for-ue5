...
namespace Gs2::Key::Domain::Iterator
{
    ...
    class GS2KEY_API FDescribeKeysIterator :
        public TSharedFromThis<FDescribeKeysIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Key::Model::FKey>> Result) override;
        ...
        {
            TSharedRef<FDescribeKeysIterator> Self;
            TSharedPtr<TArray<Gs2::Key::Model::FKeyPtr>> Range;
            TOptional<TArray<Gs2::Key::Model::FKeyPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeKeysIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeKeysIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeKeysIterator> Iterable)
            {
