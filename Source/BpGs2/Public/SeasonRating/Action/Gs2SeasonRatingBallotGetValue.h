...
public:
    ...
    UPROPERTY(Category = Gs2, BlueprintAssignable)
    FGs2SeasonRatingBallotGetValueErrorDelegate OnError;

    UGs2SeasonRatingBallotGetValueAsyncFunction(const FObjectInitializer& ObjectInitializer);

    UFUNCTION(BlueprintCallable, DisplayName="Gs2::SeasonRating::Fetch::GetValueOfBallot", Category="Game Server Services|GS2-SeasonRating|Namespace|User|Ballot|Fetch", meta=(WorldContext="WorldContextObject", BlueprintInternalUseOnly="true"))
    static UGs2SeasonRatingBallotGetValueAsyncFunction* BallotGetValue(
