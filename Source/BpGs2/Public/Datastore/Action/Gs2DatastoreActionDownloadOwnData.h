...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2DatastoreDownloadOwnDataSuccessDelegate, TArray<uint8>, Binary, const FGs2Error, Error);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2DatastoreDownloadOwnDataErrorDelegate, TArray<uint8>, Binary, const FGs2Error, Error);
