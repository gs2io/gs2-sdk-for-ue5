...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2AccountDeleteTakeOverSettingSuccessDelegate, FGs2AccountOwnTakeOver, TakeOver, const FGs2Error, Error);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2AccountDeleteTakeOverSettingErrorDelegate, FGs2AccountOwnTakeOver, TakeOver, const FGs2Error, Error);

UCLASS()
class BPGS2_API UGs2AccountDeleteTakeOverSettingAsyncFunction : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
