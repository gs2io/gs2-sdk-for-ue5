...
#include "Gs2FriendActionUnfollow.generated.h"


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2FriendUnfollowSuccessDelegate, FGs2FriendOwnFollowUser, FollowUser, const FGs2Error, Error);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2FriendUnfollowErrorDelegate, FGs2FriendOwnFollowUser, FollowUser, const FGs2Error, Error);

UCLASS()
class BPGS2_API UGs2FriendUnfollowAsyncFunction : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
