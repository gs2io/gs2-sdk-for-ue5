...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2QuestStartSuccessDelegate, FGs2CoreOwnTransaction, Transaction, const FGs2Error, Error);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2QuestStartErrorDelegate, FGs2CoreOwnTransaction, Transaction, const FGs2Error, Error);
