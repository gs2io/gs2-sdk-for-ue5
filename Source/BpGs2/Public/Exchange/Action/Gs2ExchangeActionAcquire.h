...
public:
	...
	UFUNCTION(BlueprintCallable, DisplayName="Gs2::Exchange::Await::Action::Acquire", Category="Game Server Services|GS2-Exchange|Namespace|User|Await|Action", meta=(WorldContext="WorldContextObject", BlueprintInternalUseOnly="true"))
    static UGs2ExchangeAcquireAsyncFunction* Acquire(
