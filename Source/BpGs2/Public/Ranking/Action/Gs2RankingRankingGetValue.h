...
#include "Gs2RankingRankingGetValue.generated.h"
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2RankingRankingGetValueSuccessDelegate, FGs2RankingRankingValue, Value, const FGs2Error, Error);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGs2RankingRankingGetValueErrorDelegate, FGs2RankingRankingValue, Value, const FGs2Error, Error);

UCLASS()
class BPGS2_API UGs2RankingRankingGetValueAsyncFunction : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(BlueprintAssignable)
    FGs2RankingRankingGetValueErrorDelegate OnError;
