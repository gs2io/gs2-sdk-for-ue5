...
#include "Gs2IdleAcquireActionResult.generated.h"

USTRUCT(BlueprintType)
struct FGs2IdleAcquireActionResult
{
    GENERATED_BODY()
...
inline FGs2IdleAcquireActionResult EzAcquireActionResultToFGs2IdleAcquireActionResult(
    const Gs2::UE5::Idle::Model::FEzAcquireActionResultPtr Model
)
{
    FGs2IdleAcquireActionResult Value;
...
inline Gs2::UE5::Idle::Model::FEzAcquireActionResultPtr FGs2IdleAcquireActionResultToEzAcquireActionResult(
    const FGs2IdleAcquireActionResult Model
)
{
    return MakeShared<Gs2::UE5::Idle::Model::FEzAcquireActionResult>()
