...
#include "Gs2IdleConsumeActionResult.generated.h"

USTRUCT(BlueprintType)
struct FGs2IdleConsumeActionResult
{
    GENERATED_BODY()
...
inline FGs2IdleConsumeActionResult EzConsumeActionResultToFGs2IdleConsumeActionResult(
    const Gs2::UE5::Idle::Model::FEzConsumeActionResultPtr Model
)
{
    FGs2IdleConsumeActionResult Value;
...
inline Gs2::UE5::Idle::Model::FEzConsumeActionResultPtr FGs2IdleConsumeActionResultToEzConsumeActionResult(
    const FGs2IdleConsumeActionResult Model
)
{
    return MakeShared<Gs2::UE5::Idle::Model::FEzConsumeActionResult>()
