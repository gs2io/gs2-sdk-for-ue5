...
{
    FGs2ShowcaseOwnShowcase Return;
    if (User.Value == nullptr) {
        UE_LOG(BpGs2Log, Error, TEXT("[UGs2ShowcaseUserFunctionLibrary::OwnShowcase] User parameter specification is missing."))
        return Return;
    }
    if (ShowcaseName == "") {
        UE_LOG(BpGs2Log, Error, TEXT("[UGs2ShowcaseUserFunctionLibrary::OwnShowcase] ShowcaseName parameter specification is missing."))
        return Return;
    }
