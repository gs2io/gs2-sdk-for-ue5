...
#include "Stamina/Action/Gs2StaminaActionSetRecoverInterval.h"
#include "Core/BpGs2Constant.h"

UGs2StaminaSetRecoverIntervalAsyncFunction::UGs2StaminaSetRecoverIntervalAsyncFunction(
...
)
{
    ...
    if (Stamina.Value == nullptr) {
        UE_LOG(BpGs2Log, Error, TEXT("[UGs2StaminaSetRecoverIntervalAsyncFunction::SetRecoverInterval] Stamina parameter specification is missing."))
        return Action;
    }
...
void UGs2StaminaSetRecoverIntervalAsyncFunction::Activate()
{
    if (Stamina.Value == nullptr) {
        UE_LOG(BpGs2Log, Error, TEXT("[UGs2StaminaSetRecoverIntervalAsyncFunction] Stamina parameter specification is missing."))
        return;
    }
