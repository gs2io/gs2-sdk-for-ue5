...
#include "Chat/Request/CreateCategoryModelMasterRequest.h"
...
namespace Gs2::Chat::Request
{
    ...
    TSharedPtr<FCreateCategoryModelMasterRequest> FCreateCategoryModelMasterRequest::WithCategory(
    ...
    TSharedPtr<FCreateCategoryModelMasterRequest> FCreateCategoryModelMasterRequest::WithRejectAccessTokenPost(
    ...
    TOptional<int32> FCreateCategoryModelMasterRequest::GetCategory() const
    {
        return CategoryValue;
    }

    FString FCreateCategoryModelMasterRequest::GetCategoryString() const
    {
    ...
    TOptional<FString> FCreateCategoryModelMasterRequest::GetRejectAccessTokenPost() const
    {
