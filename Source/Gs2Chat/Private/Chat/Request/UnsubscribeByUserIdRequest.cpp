...
namespace Gs2::Chat::Request
{
    ...
    TSharedPtr<FUnsubscribeByUserIdRequest> FUnsubscribeByUserIdRequest::WithRoomName(
    ...
    TSharedPtr<FUnsubscribeByUserIdRequest> FUnsubscribeByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FUnsubscribeByUserIdRequest::GetRoomName() const
    {
    ...
    TOptional<FString> FUnsubscribeByUserIdRequest::GetTimeOffsetToken() const
    {
