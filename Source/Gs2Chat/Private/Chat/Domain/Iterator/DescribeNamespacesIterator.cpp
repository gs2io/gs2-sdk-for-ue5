...
namespace Gs2::Chat::Domain::Iterator
{
        ...
        TSharedPtr<TSharedPtr<TArray<Gs2::Chat::Model::FNamespacePtr>>> Result)
    {
        ...
        if (Self->Cache->IsListCached<Gs2::Chat::Model::FNamespace>(
            ListParentKey
        )) {
            Self->Result = Self->Cache->List<Gs2::Chat::Model::FNamespace>(
                ListParentKey
            );
        ...
        *Result = R->GetItems();
        ...
        if (Self->Last) {
            Self->Cache->SetListCache<Gs2::Chat::Model::FNamespace>(
                ListParentKey
            );
        }
        return nullptr;
    ...
    const Gs2::Chat::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Chat::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
