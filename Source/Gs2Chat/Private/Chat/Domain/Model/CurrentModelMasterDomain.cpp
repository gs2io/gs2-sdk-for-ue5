...
namespace Gs2::Chat::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Chat::Model::Cache::FCurrentModelMasterCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(

        );
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            Gs2::Chat::Model::FCurrentModelMaster::TypeName,
            CacheParentKey,
            CacheKey,
            [Self = Self, Result]() -> Gs2::Core::Model::FGs2ErrorPtr
            {
                Gs2::Chat::Model::FCurrentModelMasterPtr Value;
                const auto CacheHit = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Chat::Model::FCurrentModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Chat::Request::FGetCurrentModelMasterRequest>()
                        );
                        Future->StartSynchronousTask();
    ...
    {
        Gs2::Chat::Model::Cache::FCurrentModelMasterCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Chat::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Chat::Model::FCurrentModelMaster>(obj));
            },
