...
#include "Chat/Task/WebSocket/DescribeCategoryModelsTask.h"
...
namespace Gs2::Chat::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("chat"), TEXT("categoryModel"), TEXT("describeCategoryModels"), ToCStr(RequestPayload->Payload()));
