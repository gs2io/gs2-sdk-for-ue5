...
#include "Chat/Task/WebSocket/PostTask.h"
...
namespace Gs2::Chat::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("chat"), TEXT("message"), TEXT("post"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FPostResult::FromJson(WebSocketResult->Body());
