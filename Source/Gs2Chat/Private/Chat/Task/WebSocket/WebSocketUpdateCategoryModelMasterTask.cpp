...
#include "Chat/Task/WebSocket/UpdateCategoryModelMasterTask.h"
...
namespace Gs2::Chat::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("chat"), TEXT("categoryModelMaster"), TEXT("updateCategoryModelMaster"), ToCStr(RequestPayload->Payload()));
