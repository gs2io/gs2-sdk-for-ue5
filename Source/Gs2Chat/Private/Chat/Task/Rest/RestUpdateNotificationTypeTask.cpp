...
#include "Chat/Task/Rest/UpdateNotificationTypeTask.h"
...
{
    FUpdateNotificationTypeTask::FUpdateNotificationTypeTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateNotificationTypeTask::Action(
        const TSharedPtr<Result::FUpdateNotificationTypeResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/room/{roomName}/subscribe/notification");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateNotificationTypeResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
