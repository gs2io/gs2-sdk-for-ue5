...
#include "Chat/Task/Rest/CreateRoomTask.h"
...
{
    FCreateRoomTask::FCreateRoomTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateRoomTask::Action(
        const TSharedPtr<Result::FCreateRoomResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/room/user");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateRoomResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
