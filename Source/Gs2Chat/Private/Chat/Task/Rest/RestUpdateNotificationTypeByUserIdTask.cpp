...
#include "Chat/Task/Rest/UpdateNotificationTypeByUserIdTask.h"
...
{
    FUpdateNotificationTypeByUserIdTask::FUpdateNotificationTypeByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateNotificationTypeByUserIdTask::Action(
        const TSharedPtr<Result::FUpdateNotificationTypeByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/room/{roomName}/subscribe/notification");
            ...
            if (this->Request->GetNotificationTypes() != nullptr && this->Request->GetNotificationTypes().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetNotificationTypes())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateNotificationTypeByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
