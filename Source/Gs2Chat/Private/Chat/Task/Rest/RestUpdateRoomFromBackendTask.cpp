...
#include "Chat/Task/Rest/UpdateRoomFromBackendTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/room/{roomName}");
            ...
            if (this->Request->GetWhiteListUserIds() != nullptr && this->Request->GetWhiteListUserIds().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetWhiteListUserIds())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateRoomFromBackendResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
