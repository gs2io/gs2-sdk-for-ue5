...
#include "Chat/Task/Rest/SubscribeTask.h"
...
namespace Gs2::Chat::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FSubscribeTask::Action(
        const TSharedPtr<Result::FSubscribeResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/room/{roomName}/subscribe");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSubscribeResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
