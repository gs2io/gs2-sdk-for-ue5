...
namespace Gs2::Chat::Request
{
    ...
    class GS2CHAT_API FDeleteCategoryModelMasterRequest final : public TSharedFromThis<FDeleteCategoryModelMasterRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDeleteCategoryModelMasterRequest> WithCategory(const TOptional<int32> Category);
