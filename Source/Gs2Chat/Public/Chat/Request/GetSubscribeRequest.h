...
namespace Gs2::Chat::Request
{
    ...
    class GS2CHAT_API FGetSubscribeRequest final : public TSharedFromThis<FGetSubscribeRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSubscribeRequest> WithRoomName(const TOptional<FString> RoomName);
