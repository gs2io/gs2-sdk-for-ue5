...
namespace Gs2::Chat::Error
{
    ...
    {
    public:
        inline static const FGs2ErrorType TypeString = "FPasswordRequiredError";
    ...
    typedef TSharedPtr<FPasswordRequiredError, ESPMode::ThreadSafe> FPasswordRequiredErrorPtr;
}