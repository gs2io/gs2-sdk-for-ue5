...
{
    class GS2CHAT_API FSubscribeByUserIdResult final : public TSharedFromThis<FSubscribeByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FSubscribeByUserIdResult> WithItem(const TSharedPtr<Model::FSubscribe> Item);
