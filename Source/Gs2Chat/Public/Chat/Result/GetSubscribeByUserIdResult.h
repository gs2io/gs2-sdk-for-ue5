...
{
    class GS2CHAT_API FGetSubscribeByUserIdResult final : public TSharedFromThis<FGetSubscribeByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSubscribeByUserIdResult> WithItem(const TSharedPtr<Model::FSubscribe> Item);
