...
{
    class GS2CHAT_API FUnsubscribeByUserIdResult final : public TSharedFromThis<FUnsubscribeByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FUnsubscribeByUserIdResult> WithItem(const TSharedPtr<Model::FSubscribe> Item);
