...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeSubscribesByRoomNameIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribesByRoomNameIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribesByRoomNameIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribesByRoomNameIterator> Iterable)
            {
