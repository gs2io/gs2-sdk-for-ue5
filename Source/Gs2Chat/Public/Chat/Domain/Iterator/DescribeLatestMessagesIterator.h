...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    class GS2CHAT_API FDescribeLatestMessagesIterator :
        public TSharedFromThis<FDescribeLatestMessagesIterator>
    {
    ...
    public:
        FDescribeLatestMessagesIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Chat::FGs2ChatRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> RoomName,
        ...
        {
            TSharedRef<FDescribeLatestMessagesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLatestMessagesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLatestMessagesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLatestMessagesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeLatestMessagesIterator> FDescribeLatestMessagesIteratorPtr;
}
