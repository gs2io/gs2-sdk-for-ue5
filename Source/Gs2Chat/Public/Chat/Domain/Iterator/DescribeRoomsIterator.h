...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    class GS2CHAT_API FDescribeRoomsIterator :
        public TSharedFromThis<FDescribeRoomsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Chat::Model::FRoom>> Result) override;
        ...
        {
            TSharedRef<FDescribeRoomsIterator> Self;
            TSharedPtr<TArray<Gs2::Chat::Model::FRoomPtr>> Range;
            TOptional<TArray<Gs2::Chat::Model::FRoomPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Chat::Model::FRoomPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRoomsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRoomsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRoomsIterator> Iterable)
            {
