...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    class GS2CHAT_API FDescribeRoomsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Chat::Model::FRoom, FDescribeRoomsIteratorLoadTask>
    {
...
public:
        ...
        class GS2CHAT_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Chat::Domain::Iterator::FDescribeRoomsIterator::FNextTask>> Task;
            Gs2::Chat::Model::FRoomPtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Chat::Domain::Iterator::FDescribeRoomsIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Chat::Model::FRoomPtr& operator*() const;
            Gs2::Chat::Model::FRoomPtr operator->();
    ...
    class FDescribeRoomsIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Chat::Model::FRoomPtr>>,
