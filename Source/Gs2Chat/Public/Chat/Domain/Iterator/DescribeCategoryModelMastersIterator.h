...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    class GS2CHAT_API FDescribeCategoryModelMastersIterator :
    ...
    public:
        ...
        class GS2CHAT_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Chat::Model::FCategoryModelMaster>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Chat::Model::FCategoryModelMaster>> Result) override;
        ...
        class GS2CHAT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Chat::Model::FCategoryModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Chat::Model::FCategoryModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Chat::Model::FCategoryModelMasterPtr& Current()
            {
