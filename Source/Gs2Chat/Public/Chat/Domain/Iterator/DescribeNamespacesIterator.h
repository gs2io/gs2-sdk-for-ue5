...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Chat::Model::FNamespace>> Result) override;
        ...
        class GS2CHAT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Chat::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Chat::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
