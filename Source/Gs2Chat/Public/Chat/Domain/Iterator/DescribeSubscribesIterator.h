...
namespace Gs2::Chat::Domain::Iterator
{
    ...
    class GS2CHAT_API FDescribeSubscribesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Chat::Model::FSubscribe>> Result) override;
        ...
        class GS2CHAT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Chat::Model::FSubscribePtr>> Range;
            TOptional<TArray<Gs2::Chat::Model::FSubscribePtr>::TIterator> RangeIteratorOpt;
