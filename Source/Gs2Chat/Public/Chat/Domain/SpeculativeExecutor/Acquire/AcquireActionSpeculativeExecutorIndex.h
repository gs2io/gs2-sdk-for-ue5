...
namespace Gs2::Chat::Domain::SpeculativeExecutor
{
    class GS2CHAT_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Chat::Domain::FGs2ChatDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2CHAT_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Chat::Domain::FGs2ChatDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2CHAT_API FCommitTask(
                const FCommitTask& From
            );

            GS2CHAT_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
