...
#include "Chat/Request/DescribeNamespacesRequest.h"
#include "Chat/Result/DescribeNamespacesResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
