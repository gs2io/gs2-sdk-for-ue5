...
#include "Chat/Request/GetNamespaceRequest.h"
#include "Chat/Result/GetNamespaceResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
