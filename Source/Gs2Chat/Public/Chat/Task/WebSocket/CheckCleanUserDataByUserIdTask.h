...
#include "Chat/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Chat/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
