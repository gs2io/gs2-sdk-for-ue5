...
#include "Chat/Request/GetServiceVersionRequest.h"
#include "Chat/Result/GetServiceVersionResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
