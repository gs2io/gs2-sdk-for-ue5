...
#include "Chat/Request/ImportUserDataByUserIdRequest.h"
#include "Chat/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
