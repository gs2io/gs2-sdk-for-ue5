...
#include "Chat/Request/DeleteNamespaceRequest.h"
#include "Chat/Result/DeleteNamespaceResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
