...
#include "Chat/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Chat/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::WebSocket
{
    class GS2CHAT_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
