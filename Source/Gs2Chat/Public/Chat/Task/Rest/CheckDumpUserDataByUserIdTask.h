...
#include "Chat/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Chat/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::Rest
{
    class GS2CHAT_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
