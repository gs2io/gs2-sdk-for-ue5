...
#include "Chat/Request/CleanUserDataByUserIdRequest.h"
#include "Chat/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::Rest
{
    class GS2CHAT_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
