...
#include "Chat/Request/CheckImportUserDataByUserIdRequest.h"
#include "Chat/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Chat::Task::Rest
{
    class GS2CHAT_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
