...
#include "Chat/Result/GetCategoryModelResult.h"

namespace Gs2::Chat::Task::Rest
{
    class GS2CHAT_API FGetCategoryModelTask final : public Gs2::Core::Util::TGs2Future<Result::FGetCategoryModelResult>
    {
