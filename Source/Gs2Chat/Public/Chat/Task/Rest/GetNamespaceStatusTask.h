...
#include "Chat/Request/GetNamespaceStatusRequest.h"
#include "Chat/Result/GetNamespaceStatusResult.h"

namespace Gs2::Chat::Task::Rest
{
    class GS2CHAT_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
