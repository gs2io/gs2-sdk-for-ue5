...
#include "LoginReward/Request/DescribeNamespacesRequest.h"
#include "LoginReward/Result/DescribeNamespacesResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
