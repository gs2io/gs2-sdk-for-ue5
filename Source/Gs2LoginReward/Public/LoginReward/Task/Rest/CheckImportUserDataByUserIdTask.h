...
#include "LoginReward/Request/CheckImportUserDataByUserIdRequest.h"
#include "LoginReward/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
