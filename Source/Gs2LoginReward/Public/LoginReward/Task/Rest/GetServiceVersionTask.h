...
#include "LoginReward/Request/GetServiceVersionRequest.h"
#include "LoginReward/Result/GetServiceVersionResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
