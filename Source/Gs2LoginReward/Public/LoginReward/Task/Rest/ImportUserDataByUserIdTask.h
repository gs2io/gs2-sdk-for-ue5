...
#include "LoginReward/Request/ImportUserDataByUserIdRequest.h"
#include "LoginReward/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
