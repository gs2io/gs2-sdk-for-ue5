...
#include "LoginReward/Request/CheckDumpUserDataByUserIdRequest.h"
#include "LoginReward/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
