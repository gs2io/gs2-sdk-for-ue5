...
#include "LoginReward/Request/GetNamespaceStatusRequest.h"
#include "LoginReward/Result/GetNamespaceStatusResult.h"

namespace Gs2::LoginReward::Task::Rest
{
    class GS2LOGINREWARD_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
