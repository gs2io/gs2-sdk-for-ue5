...
#include "LoginReward/Request/CheckCleanUserDataByUserIdRequest.h"
#include "LoginReward/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::WebSocket
{
    class GS2LOGINREWARD_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
