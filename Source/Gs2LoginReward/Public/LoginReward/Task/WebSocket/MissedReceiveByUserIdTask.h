...
{
    class GS2LOGINREWARD_API FMissedReceiveByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FMissedReceiveByUserIdResult>
    {
        Core::Net::WebSocket::FGs2WebSocketSessionPtr Session;
        Request::FMissedReceiveByUserIdRequestPtr Request;
    public:
        explicit FMissedReceiveByUserIdTask(
            const Core::Net::WebSocket::FGs2WebSocketSessionPtr Session,
            const Request::FMissedReceiveByUserIdRequestPtr Request
        );
        FMissedReceiveByUserIdTask(
