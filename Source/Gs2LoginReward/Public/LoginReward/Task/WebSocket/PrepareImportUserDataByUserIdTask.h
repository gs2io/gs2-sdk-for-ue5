...
#include "LoginReward/Request/PrepareImportUserDataByUserIdRequest.h"
#include "LoginReward/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::WebSocket
{
    class GS2LOGINREWARD_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
