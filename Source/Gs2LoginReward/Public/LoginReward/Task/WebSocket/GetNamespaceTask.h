...
#include "LoginReward/Request/GetNamespaceRequest.h"
#include "LoginReward/Result/GetNamespaceResult.h"

namespace Gs2::LoginReward::Task::WebSocket
{
    class GS2LOGINREWARD_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
