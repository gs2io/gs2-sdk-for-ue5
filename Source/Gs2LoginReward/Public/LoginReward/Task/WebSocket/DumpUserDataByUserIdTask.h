...
#include "LoginReward/Request/DumpUserDataByUserIdRequest.h"
#include "LoginReward/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::LoginReward::Task::WebSocket
{
    class GS2LOGINREWARD_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
