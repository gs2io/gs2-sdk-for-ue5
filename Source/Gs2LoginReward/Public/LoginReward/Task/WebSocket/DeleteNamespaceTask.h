...
#include "LoginReward/Request/DeleteNamespaceRequest.h"
#include "LoginReward/Result/DeleteNamespaceResult.h"

namespace Gs2::LoginReward::Task::WebSocket
{
    class GS2LOGINREWARD_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
