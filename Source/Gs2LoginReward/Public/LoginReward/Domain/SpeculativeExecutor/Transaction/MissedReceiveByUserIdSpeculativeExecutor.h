...
{
    class GS2LOGINREWARD_API FMissedReceiveByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FMissedReceiveByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::LoginReward::Domain::FGs2LoginRewardDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::LoginReward::Request::FMissedReceiveByUserIdRequestPtr& Request
