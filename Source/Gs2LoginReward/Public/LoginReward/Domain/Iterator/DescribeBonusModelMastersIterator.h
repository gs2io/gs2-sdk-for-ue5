...
namespace Gs2::LoginReward::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::LoginReward::Model::FBonusModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeBonusModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::LoginReward::Model::FBonusModelMasterPtr>> Range;
            TOptional<TArray<Gs2::LoginReward::Model::FBonusModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::LoginReward::Model::FBonusModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBonusModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBonusModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBonusModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBonusModelMastersIterator> FDescribeBonusModelMastersIteratorPtr;
}
