...
namespace Gs2::LoginReward::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeReceiveStatusesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeReceiveStatusesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeReceiveStatusesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeReceiveStatusesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeReceiveStatusesIterator> FDescribeReceiveStatusesIteratorPtr;
}
