...
namespace Gs2::LoginReward::Domain::Iterator
{
    ...
    class GS2LOGINREWARD_API FDescribeBonusModelsIterator :
        public TSharedFromThis<FDescribeBonusModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::LoginReward::Model::FBonusModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeBonusModelsIterator> Self;
            TSharedPtr<TArray<Gs2::LoginReward::Model::FBonusModelPtr>> Range;
            TOptional<TArray<Gs2::LoginReward::Model::FBonusModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::LoginReward::Model::FBonusModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBonusModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBonusModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBonusModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBonusModelsIterator> FDescribeBonusModelsIteratorPtr;
}
