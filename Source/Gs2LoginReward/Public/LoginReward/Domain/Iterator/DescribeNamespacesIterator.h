...
namespace Gs2::LoginReward::Domain::Iterator
{
    ...
    class GS2LOGINREWARD_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::LoginReward::Model::FNamespace>> Result) override;
        ...
        class GS2LOGINREWARD_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::LoginReward::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::LoginReward::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::LoginReward::Model::FNamespacePtr& Current()
            {
