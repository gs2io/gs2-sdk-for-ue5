...
namespace Gs2::LoginReward::Domain::Iterator
{
    ...
    class GS2LOGINREWARD_API FDescribeReceiveStatusesByUserIdIterator :
        public TSharedFromThis<FDescribeReceiveStatusesByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::LoginReward::Model::FReceiveStatus>> Result) override;
        ...
        class GS2LOGINREWARD_API FIterator
        {
            TSharedRef<FDescribeReceiveStatusesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::LoginReward::Model::FReceiveStatusPtr>> Range;
            TOptional<TArray<Gs2::LoginReward::Model::FReceiveStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeReceiveStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeReceiveStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeReceiveStatusesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeReceiveStatusesByUserIdIterator> FDescribeReceiveStatusesByUserIdIteratorPtr;
}
