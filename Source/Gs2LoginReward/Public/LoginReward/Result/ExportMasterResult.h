...
{
    class GS2LOGINREWARD_API FExportMasterResult final : public TSharedFromThis<FExportMasterResult>
    {
    ...
    public:
        ...
        TSharedPtr<FExportMasterResult> WithItem(const TSharedPtr<Model::FCurrentBonusMaster> Item);
