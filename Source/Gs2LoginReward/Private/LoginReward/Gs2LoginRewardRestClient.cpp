...
namespace Gs2::LoginReward
{
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FGetServiceVersionTask>> FGs2LoginRewardRestClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FDumpUserDataByUserIdTask>> FGs2LoginRewardRestClient::DumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckDumpUserDataByUserIdTask>> FGs2LoginRewardRestClient::CheckDumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCleanUserDataByUserIdTask>> FGs2LoginRewardRestClient::CleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckCleanUserDataByUserIdTask>> FGs2LoginRewardRestClient::CheckCleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FPrepareImportUserDataByUserIdTask>> FGs2LoginRewardRestClient::PrepareImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FImportUserDataByUserIdTask>> FGs2LoginRewardRestClient::ImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckImportUserDataByUserIdTask>> FGs2LoginRewardRestClient::CheckImportUserDataByUserId(
