...
namespace Gs2::LoginReward::Request
{
    ...
    TSharedPtr<FUpdateBonusModelMasterRequest> FUpdateBonusModelMasterRequest::WithMissedReceiveReliefVerifyActions(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FVerifyAction>>> FUpdateBonusModelMasterRequest::GetMissedReceiveReliefVerifyActions() const
    {
