...
namespace Gs2::LoginReward::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Gs2->Cache->Delete(Gs2::LoginReward::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::LoginReward::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Gs2->Cache->TryGet<Gs2::LoginReward::Model::FNamespace>(
                ParentKey,
                Gs2::LoginReward::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
