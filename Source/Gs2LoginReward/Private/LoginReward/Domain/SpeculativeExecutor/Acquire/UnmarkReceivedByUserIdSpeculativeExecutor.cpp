...
namespace Gs2::LoginReward::Domain::SpeculativeExecutor
{
    ...
    FString FUnmarkReceivedByUserIdSpeculativeExecutor::Action()
    {
        return FString("Gs2LoginReward:UnmarkReceivedByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FUnmarkReceivedByUserIdSpeculativeExecutor::Transform(
    ...
    FUnmarkReceivedByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
    ...
    TSharedPtr<FAsyncTask<FUnmarkReceivedByUserIdSpeculativeExecutor::FCommitTask>> FUnmarkReceivedByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::LoginReward::Domain::FGs2LoginRewardDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::LoginReward::Request::FUnmarkReceivedByUserIdRequestPtr& Request
    ...
    Gs2::LoginReward::Request::FUnmarkReceivedByUserIdRequestPtr FUnmarkReceivedByUserIdSpeculativeExecutor::Rate(
        const Gs2::LoginReward::Request::FUnmarkReceivedByUserIdRequestPtr& Request,
        const double Rate
    )
    {
