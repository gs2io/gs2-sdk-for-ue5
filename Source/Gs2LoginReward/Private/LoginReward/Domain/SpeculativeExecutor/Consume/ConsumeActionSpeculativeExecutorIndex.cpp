...
namespace Gs2::LoginReward::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FMarkReceivedByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FMarkReceivedByUserIdRequest::FromJson(RequestModelJson);
            Request = FMarkReceivedByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FMarkReceivedByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
