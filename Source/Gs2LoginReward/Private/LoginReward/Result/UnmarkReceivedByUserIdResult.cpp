...
#include "LoginReward/Result/UnmarkReceivedByUserIdResult.h"

namespace Gs2::LoginReward::Result
{
    FUnmarkReceivedByUserIdResult::FUnmarkReceivedByUserIdResult():
        ItemValue(nullptr),
    ...
    FUnmarkReceivedByUserIdResult::FUnmarkReceivedByUserIdResult(
        const FUnmarkReceivedByUserIdResult& From
    ):
    ...
    TSharedPtr<FUnmarkReceivedByUserIdResult> FUnmarkReceivedByUserIdResult::WithItem(
    ...
    TSharedPtr<FUnmarkReceivedByUserIdResult> FUnmarkReceivedByUserIdResult::WithBonusModel(
    ...
    TSharedPtr<Model::FReceiveStatus> FUnmarkReceivedByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FBonusModel> FUnmarkReceivedByUserIdResult::GetBonusModel() const
    {
    ...
    TSharedPtr<FUnmarkReceivedByUserIdResult> FUnmarkReceivedByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FUnmarkReceivedByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FUnmarkReceivedByUserIdResult::ToJson() const
    {
