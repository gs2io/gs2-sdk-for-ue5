...
{
    FGetReceiveStatusByUserIdResult::FGetReceiveStatusByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FGetReceiveStatusByUserIdResult> FGetReceiveStatusByUserIdResult::WithItem(
    ...
    TSharedPtr<FGetReceiveStatusByUserIdResult> FGetReceiveStatusByUserIdResult::WithBonusModel(
    ...
    TSharedPtr<Model::FReceiveStatus> FGetReceiveStatusByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FBonusModel> FGetReceiveStatusByUserIdResult::GetBonusModel() const
    {
    ...
    TSharedPtr<FGetReceiveStatusByUserIdResult> FGetReceiveStatusByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
    ...
    TSharedPtr<FJsonObject> FGetReceiveStatusByUserIdResult::ToJson() const
    {
