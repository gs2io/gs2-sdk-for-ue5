...
namespace Gs2::LoginReward::Result
{
    ...
    TSharedPtr<FMissedReceiveResult> FMissedReceiveResult::WithAtomicCommit(
    ...
    TSharedPtr<FMissedReceiveResult> FMissedReceiveResult::WithTransaction(
    ...
    TSharedPtr<FMissedReceiveResult> FMissedReceiveResult::WithTransactionResult(
    ...
    TOptional<bool> FMissedReceiveResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FMissedReceiveResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FMissedReceiveResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FMissedReceiveResult::GetTransactionResult() const
    {
