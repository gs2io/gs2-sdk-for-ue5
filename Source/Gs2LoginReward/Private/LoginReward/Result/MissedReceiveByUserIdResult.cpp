...
namespace Gs2::LoginReward::Result
{
    ...
    TSharedPtr<FMissedReceiveByUserIdResult> FMissedReceiveByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FMissedReceiveByUserIdResult> FMissedReceiveByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FMissedReceiveByUserIdResult> FMissedReceiveByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FMissedReceiveByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FMissedReceiveByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FMissedReceiveByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FMissedReceiveByUserIdResult::GetTransactionResult() const
    {
