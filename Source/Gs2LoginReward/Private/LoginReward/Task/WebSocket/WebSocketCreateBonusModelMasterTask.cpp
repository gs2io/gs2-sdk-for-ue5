...
#include "LoginReward/Task/WebSocket/CreateBonusModelMasterTask.h"
...
namespace Gs2::LoginReward::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("loginReward"), TEXT("bonusModelMaster"), TEXT("createBonusModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateBonusModelMasterResult::FromJson(WebSocketResult->Body());
