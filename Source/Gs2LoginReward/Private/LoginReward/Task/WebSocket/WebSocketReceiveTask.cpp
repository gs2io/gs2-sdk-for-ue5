...
#include "LoginReward/Task/WebSocket/ReceiveTask.h"
...
namespace Gs2::LoginReward::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("loginReward"), TEXT("bonus"), TEXT("receive"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FReceiveResult::FromJson(WebSocketResult->Body());
