...
#include "LoginReward/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::LoginReward::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("loginReward"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
