...
#include "LoginReward/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::LoginReward::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("loginReward"), TEXT("currentBonusMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
