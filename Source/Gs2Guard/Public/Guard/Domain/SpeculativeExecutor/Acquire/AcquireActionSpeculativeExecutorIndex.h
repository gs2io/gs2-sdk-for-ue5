...
namespace Gs2::Guard::Domain::SpeculativeExecutor
{
    class GS2GUARD_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Guard::Domain::FGs2GuardDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2GUARD_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Guard::Domain::FGs2GuardDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2GUARD_API FCommitTask(
                const FCommitTask& From
            );

            GS2GUARD_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
