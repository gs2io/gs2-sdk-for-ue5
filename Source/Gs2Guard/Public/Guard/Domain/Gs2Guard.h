...
namespace Gs2::Guard::Domain
{
    ...
    public:
        ...
        class GS2GUARD_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2GuardDomain> Self;
            const TFunction<void(TArray<Gs2::Guard::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2GuardDomain>& Self, TFunction<void(TArray<Gs2::Guard::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
