...
namespace Gs2::Guard::Domain::Iterator
{
    ...
    class GS2GUARD_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        class GS2GUARD_API FIteratorNextTask :
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Guard::Model::FNamespace>> Result) override;
        ...
        class GS2GUARD_API FIterator
        {
            TSharedRef<FDescribeNamespacesIterator> Self;
            TSharedPtr<TArray<Gs2::Guard::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Guard::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Guard::Model::FNamespacePtr& Current()
            {
