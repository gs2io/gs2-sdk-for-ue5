...
#include "BlockingPolicyModel.h"

namespace Gs2::Guard::Model
{
    class GS2GUARD_API FNamespace final : public FGs2Object, public TSharedFromThis<FNamespace>
    {
        TOptional<FString> NamespaceIdValue;
        TOptional<FString> NameValue;
        TOptional<FString> DescriptionValue;
        TSharedPtr<FBlockingPolicyModel> BlockingPolicyValue;
    ...
    public:
        ...
        TSharedPtr<FNamespace> WithBlockingPolicy(const TSharedPtr<FBlockingPolicyModel> BlockingPolicy);
        ...
        TSharedPtr<FBlockingPolicyModel> GetBlockingPolicy() const;
