...
namespace Gs2::Guard
{
    class GS2GUARD_API FGs2GuardWebSocketClient : Core::Net::FAbstractWebSocketGs2Client
    {
    public:
        explicit FGs2GuardWebSocketClient(
    ...
    typedef TSharedPtr<FGs2GuardWebSocketClient, ESPMode::ThreadSafe> FGs2GuardWebSocketClientPtr;
}