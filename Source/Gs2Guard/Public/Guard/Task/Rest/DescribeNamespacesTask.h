...
#include "Guard/Request/DescribeNamespacesRequest.h"
#include "Guard/Result/DescribeNamespacesResult.h"

namespace Gs2::Guard::Task::Rest
{
    class GS2GUARD_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
