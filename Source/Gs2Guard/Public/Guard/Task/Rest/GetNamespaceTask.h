...
#include "Guard/Request/GetNamespaceRequest.h"
#include "Guard/Result/GetNamespaceResult.h"

namespace Gs2::Guard::Task::Rest
{
    class GS2GUARD_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
