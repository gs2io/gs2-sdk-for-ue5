...
#include "Guard/Request/GetServiceVersionRequest.h"
#include "Guard/Result/GetServiceVersionResult.h"

namespace Gs2::Guard::Task::Rest
{
    class GS2GUARD_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
