...
#include "Guard/Result/UpdateNamespaceResult.h"

namespace Gs2::Guard::Task::Rest
{
    class GS2GUARD_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
