...
namespace Gs2::Guard::Request
{
    ...
    class GS2GUARD_API FUpdateNamespaceRequest final : public TSharedFromThis<FUpdateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FUpdateNamespaceRequest> WithBlockingPolicy(const TSharedPtr<Model::FBlockingPolicyModel> BlockingPolicy);
