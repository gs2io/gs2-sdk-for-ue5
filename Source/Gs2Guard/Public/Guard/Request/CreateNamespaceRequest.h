...
#include "../Model/BlockingPolicyModel.h"

namespace Gs2::Guard::Request
{
    class FCreateNamespaceRequest;

    class GS2GUARD_API FCreateNamespaceRequest final : public TSharedFromThis<FCreateNamespaceRequest>
    {
        TOptional<FString> ContextStackValue;
        TOptional<FString> NameValue;
        TOptional<FString> DescriptionValue;
        TSharedPtr<Model::FBlockingPolicyModel> BlockingPolicyValue;
    ...
    public:
        ...
        TSharedPtr<FCreateNamespaceRequest> WithBlockingPolicy(const TSharedPtr<Model::FBlockingPolicyModel> BlockingPolicy);

        TOptional<FString> GetContextStack() const;
        TOptional<FString> GetName() const;
        TOptional<FString> GetDescription() const;
        TSharedPtr<Model::FBlockingPolicyModel> GetBlockingPolicy() const;
