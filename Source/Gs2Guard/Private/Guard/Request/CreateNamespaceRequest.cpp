...
namespace Gs2::Guard::Request
{
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithBlockingPolicy(
    ...
    TSharedPtr<Model::FBlockingPolicyModel> FCreateNamespaceRequest::GetBlockingPolicy() const
    {
