...
#include "Guard/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Guard::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetBlockingPolicy() != nullptr && this->Request->GetBlockingPolicy().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("blockingPolicy"), this->Request->GetBlockingPolicy()->ToJson());
            }
