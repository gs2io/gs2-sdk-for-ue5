...
#include "Schedule/Task/WebSocket/CreateEventMasterTask.h"
...
namespace Gs2::Schedule::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("schedule"), TEXT("eventMaster"), TEXT("createEventMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateEventMasterResult::FromJson(WebSocketResult->Body());
