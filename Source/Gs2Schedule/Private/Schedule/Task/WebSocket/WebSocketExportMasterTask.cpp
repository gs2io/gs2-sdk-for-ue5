...
#include "Schedule/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Schedule::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("schedule"), TEXT("currentEventMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
