...
#include "Schedule/Task/Rest/ExtendTriggerByUserIdTask.h"
...
{
    FExtendTriggerByUserIdTask::FExtendTriggerByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FExtendTriggerByUserIdTask::Action(
        const TSharedPtr<Result::FExtendTriggerByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/trigger/{triggerName}/extend");
            ...
            if (this->Request->GetExtendSeconds().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("extendSeconds"), this->Request->GetExtendSeconds().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FExtendTriggerByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
