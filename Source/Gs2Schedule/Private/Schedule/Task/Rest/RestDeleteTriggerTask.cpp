...
#include "Schedule/Task/Rest/DeleteTriggerTask.h"
...
{
    FDeleteTriggerTask::FDeleteTriggerTask(
    ...
    FDeleteTriggerTask::FDeleteTriggerTask(
        const FDeleteTriggerTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteTriggerTask::Action(
        const TSharedPtr<Result::FDeleteTriggerResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/trigger/{triggerName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteTriggerResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
