...
#include "Schedule/Task/Rest/UpdateEventMasterTask.h"
...
{
    FUpdateEventMasterTask::FUpdateEventMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateEventMasterTask::Action(
        const TSharedPtr<Result::FUpdateEventMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/event/{eventName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateEventMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
