...
#include "Schedule/Task/Rest/DeleteEventMasterTask.h"
...
{
    FDeleteEventMasterTask::FDeleteEventMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteEventMasterTask::Action(
        const TSharedPtr<Result::FDeleteEventMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteEventMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
