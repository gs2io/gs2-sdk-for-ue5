...
#include "Schedule/Task/Rest/VerifyEventByUserIdTask.h"
...
{
    FVerifyEventByUserIdTask::FVerifyEventByUserIdTask(
    ...
    FVerifyEventByUserIdTask::FVerifyEventByUserIdTask(
        const FVerifyEventByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifyEventByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyEventByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/event/{eventName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyEventByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
