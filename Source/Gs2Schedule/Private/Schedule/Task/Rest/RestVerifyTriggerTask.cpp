...
#include "Schedule/Task/Rest/VerifyTriggerTask.h"
...
{
    FVerifyTriggerTask::FVerifyTriggerTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyTriggerTask::Action(
        const TSharedPtr<Result::FVerifyTriggerResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/trigger/{triggerName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyTriggerResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
