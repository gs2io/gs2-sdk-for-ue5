...
#include "Schedule/Task/Rest/GetTriggerByUserIdTask.h"
...
{
    FGetTriggerByUserIdTask::FGetTriggerByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetTriggerByUserIdTask::Action(
        const TSharedPtr<Result::FGetTriggerByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/trigger/{triggerName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetTriggerByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
