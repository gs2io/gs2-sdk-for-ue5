...
#include "Schedule/Task/Rest/GetRawEventTask.h"
...
{
    FGetRawEventTask::FGetRawEventTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRawEventTask::Action(
        const TSharedPtr<Result::FGetRawEventResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/event/{eventName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRawEventResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
