...
#include "Schedule/Task/Rest/GetEventByUserIdTask.h"
...
{
    FGetEventByUserIdTask::FGetEventByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetEventByUserIdTask::Action(
        const TSharedPtr<Result::FGetEventByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/event/{eventName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEventByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
