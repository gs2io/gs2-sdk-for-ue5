...
#include "Schedule/Task/Rest/DeleteTriggerByUserIdTask.h"
...
{
    FDeleteTriggerByUserIdTask::FDeleteTriggerByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteTriggerByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteTriggerByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteTriggerByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
