...
#include "Schedule/Task/Rest/GetEventMasterTask.h"
...
{
    FGetEventMasterTask::FGetEventMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetEventMasterTask::Action(
        const TSharedPtr<Result::FGetEventMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetEventMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
