...
#include "Schedule/Task/Rest/VerifyEventTask.h"
...
{
    FVerifyEventTask::FVerifyEventTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyEventTask::Action(
        const TSharedPtr<Result::FVerifyEventResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/event/{eventName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyEventResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
