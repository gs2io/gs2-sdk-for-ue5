...
{
    FVerifyEventResult::FVerifyEventResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithItem(
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithInSchedule(
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithScheduleStartAt(
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithScheduleEndAt(
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithRepeatSchedule(
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::WithIsGlobalSchedule(
    ...
    TSharedPtr<Model::FEvent> FVerifyEventResult::GetItem() const
    {
    ...
    TOptional<bool> FVerifyEventResult::GetInSchedule() const
    {
        return InScheduleValue;
    }

    FString FVerifyEventResult::GetInScheduleString() const
    {
    ...
    TOptional<int64> FVerifyEventResult::GetScheduleStartAt() const
    {
        return ScheduleStartAtValue;
    }

    FString FVerifyEventResult::GetScheduleStartAtString() const
    {
    ...
    TOptional<int64> FVerifyEventResult::GetScheduleEndAt() const
    {
        return ScheduleEndAtValue;
    }

    FString FVerifyEventResult::GetScheduleEndAtString() const
    {
    ...
    TSharedPtr<Model::FRepeatSchedule> FVerifyEventResult::GetRepeatSchedule() const
    {
    ...
    TOptional<bool> FVerifyEventResult::GetIsGlobalSchedule() const
    {
        return IsGlobalScheduleValue;
    }

    FString FVerifyEventResult::GetIsGlobalScheduleString() const
    {
    ...
    TSharedPtr<FVerifyEventResult> FVerifyEventResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FVerifyEventResult>()
    ...
    TSharedPtr<FJsonObject> FVerifyEventResult::ToJson() const
    {
