...
namespace Gs2::Schedule::Result
{
    ...
    TSharedPtr<FVerifyTriggerByStampTaskResult> FVerifyTriggerByStampTaskResult::WithItem(
    ...
    TSharedPtr<Model::FTrigger> FVerifyTriggerByStampTaskResult::GetItem() const
    {
