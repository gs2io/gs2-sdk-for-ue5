...
{
    FPreUpdateCurrentEventMasterResult::FPreUpdateCurrentEventMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentEventMasterResult> FPreUpdateCurrentEventMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentEventMasterResult> FPreUpdateCurrentEventMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentEventMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentEventMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentEventMasterResult> FPreUpdateCurrentEventMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentEventMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentEventMasterResult::ToJson() const
    {
