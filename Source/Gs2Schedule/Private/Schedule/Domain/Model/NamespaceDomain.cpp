...
namespace Gs2::Schedule::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Schedule::Model::Cache::FNamespaceCache::Delete(
            Self->Gs2->Cache,
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Schedule::Model::Cache::FEventMasterCache::CreateCacheParentKey(
                NamespaceName,
                TOptional<int32>()
            ),
            Callback,
    ...
    class FNamespaceDomain::FCollectEventMastersTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Schedule::Model::FEventMasterPtr>>, public TSharedFromThis<FCollectEventMastersTask>
    {
        const TSharedPtr<FNamespaceDomain> Self;
        const TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)> OnCollected;
    const TOptional<FString> QueryNamePrefix;
    public:
        explicit FCollectEventMastersTask(const TSharedPtr<FNamespaceDomain>& Self, TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)> OnCollected,const TOptional<FString> NamePrefix) : Self(Self), OnCollected(OnCollected), QueryNamePrefix(NamePrefix) {}
        FCollectEventMastersTask(const FCollectEventMastersTask& From) : TGs2Future(From), Self(From.Self), OnCollected(From.OnCollected), QueryNamePrefix(From.QueryNamePrefix) {}
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Schedule::Model::FEventMasterPtr>>> Result) override
        {
            TArray<Gs2::Schedule::Model::FEventMasterPtr> Items;
            auto Iterator = Self->EventMasters(QueryNamePrefix)->begin();
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::Schedule::Model::FEventMasterPtr>>(Items);
    ...
    Gs2::Core::Domain::CallbackID FNamespaceDomain::SubscribeEventMasters(
        TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)> Callback,const TOptional<FString> NamePrefix
    )
    {
        ...
        const auto Parent = Gs2::Schedule::Model::Cache::FEventMasterCache::CreateCacheParentKey(
        NamespaceName,
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [Callback, WeakGs2](const TArray<FGs2ObjectPtr>& Values)
            {
                ...
                TArray<Gs2::Schedule::Model::FEventMasterPtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::Schedule::Model::FEventMaster>(Value));
            ...
            [WeakGs2, WeakService, Callback, QueryNamespaceName, QueryNamePrefix]()
            {
                ...
                const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectEventMastersTask>>(Domain, Callback, QueryNamePrefix);
                Task->StartBackgroundTask();
            }
        );
    }

    void FNamespaceDomain::InvalidateEventMasters(const TOptional<FString> NamePrefix)
    {
    ...
    FNamespaceDomain::FSubscribeEventMastersWithInitialCallTask::FSubscribeEventMastersWithInitialCallTask(const TSharedPtr<FNamespaceDomain>& Self, TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)> Callback,const TOptional<FString> NamePrefix) : Self(Self), Callback(Callback), QueryNamePrefix(NamePrefix) {}
    FNamespaceDomain::FSubscribeEventMastersWithInitialCallTask::FSubscribeEventMastersWithInitialCallTask(const FSubscribeEventMastersWithInitialCallTask& From) : TGs2Future(From), Self(From.Self), Callback(From.Callback), QueryNamePrefix(From.QueryNamePrefix) {}
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceDomain::FSubscribeEventMastersWithInitialCallTask::Action(TSharedPtr<TSharedPtr<Gs2::Core::Domain::CallbackID>> Result)
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectEventMastersTask>>(Self, TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)>(), QueryNamePrefix);
        Task->StartSynchronousTask(); Task->EnsureCompletion();
        if (Task->GetTask().IsError()) return Task->GetTask().Error();
        const auto Values = Task->GetTask().Result();
        const auto CallbackId = Self->SubscribeEventMasters(Callback, QueryNamePrefix);
        Callback(*Values); *Result = MakeShared<Gs2::Core::Domain::CallbackID>(CallbackId);
        return nullptr;
    }
    TSharedPtr<FAsyncTask<FNamespaceDomain::FSubscribeEventMastersWithInitialCallTask>> FNamespaceDomain::SubscribeEventMastersWithInitialCall(TFunction<void(TArray<Gs2::Schedule::Model::FEventMasterPtr>)> Callback,const TOptional<FString> NamePrefix)
    {
        return Gs2::Core::Util::New<FAsyncTask<FSubscribeEventMastersWithInitialCallTask>>(this->AsShared(), Callback, NamePrefix);
    }
    ...
    {
        const auto CacheParentKey = Gs2::Schedule::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Schedule::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Schedule::Model::FNamespacePtr Value;
                const auto CacheHit = Gs2::Schedule::Model::Cache::FNamespaceCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Schedule::Model::Cache::FNamespaceCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Schedule::Model::FNamespacePtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Schedule::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Schedule::Model::Cache::FNamespaceCache::CreateCacheKey(
