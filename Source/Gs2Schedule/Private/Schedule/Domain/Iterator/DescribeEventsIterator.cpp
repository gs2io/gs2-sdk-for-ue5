...
namespace Gs2::Schedule::Domain::Iterator
{
    ...
    const Gs2::Schedule::Model::FEventPtr& FDescribeEventsIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Schedule::Model::FEventPtr FDescribeEventsIterator::IteratorImpl::operator->()
    {
        return Current;
    }
