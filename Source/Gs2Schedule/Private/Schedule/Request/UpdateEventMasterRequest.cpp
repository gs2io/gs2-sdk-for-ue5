...
namespace Gs2::Schedule::Request
{
    ...
    TSharedPtr<FUpdateEventMasterRequest> FUpdateEventMasterRequest::WithRelativeDuration(
    ...
    TOptional<int32> FUpdateEventMasterRequest::GetRelativeDuration() const
    {
        return RelativeDurationValue;
    }

    FString FUpdateEventMasterRequest::GetRelativeDurationString() const
    {
