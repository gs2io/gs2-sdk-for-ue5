...
namespace Gs2::Schedule::Request
{
    ...
    TSharedPtr<FVerifyEventByUserIdRequest> FVerifyEventByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FVerifyEventByUserIdRequest::GetTimeOffsetToken() const
    {
