...
namespace Gs2::Schedule::Domain::SpeculativeExecutor
{
    ...
    class GS2SCHEDULE_API FTriggerByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        class GS2SCHEDULE_API FCommitTask final :
        ...
        static Gs2::Schedule::Request::FTriggerByUserIdRequestPtr Rate(
            const Gs2::Schedule::Request::FTriggerByUserIdRequestPtr& Request,
            const double Rate
        );
