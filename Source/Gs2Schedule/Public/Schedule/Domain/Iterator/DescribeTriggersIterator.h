...
namespace Gs2::Schedule::Domain::Iterator
{
    ...
    class GS2SCHEDULE_API FDescribeTriggersIterator :
        public TSharedFromThis<FDescribeTriggersIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeTriggersIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTriggersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTriggersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTriggersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeTriggersIterator> FDescribeTriggersIteratorPtr;
}
