...
namespace Gs2::Schedule::Domain::Iterator
{
    ...
    class GS2SCHEDULE_API FDescribeTriggersByUserIdIterator :
        public TSharedFromThis<FDescribeTriggersByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Schedule::Model::FTrigger>> Result) override;
        ...
        {
            TSharedRef<FDescribeTriggersByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Schedule::Model::FTriggerPtr>> Range;
            TOptional<TArray<Gs2::Schedule::Model::FTriggerPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTriggersByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTriggersByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTriggersByUserIdIterator> Iterable)
            {
