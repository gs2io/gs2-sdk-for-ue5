...
namespace Gs2::Schedule::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Schedule::Model::FNamespace>> Result) override;
        ...
        class GS2SCHEDULE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Schedule::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Schedule::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
