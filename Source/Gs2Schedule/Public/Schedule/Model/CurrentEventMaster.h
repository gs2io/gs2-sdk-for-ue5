...
{
    class GS2SCHEDULE_API FCurrentEventMaster final : public FGs2Object, public TSharedFromThis<FCurrentEventMaster>
    {
    ...
    public:
        ...
        static TSharedPtr<FCurrentEventMaster> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;

        static FString TypeName;
    };
    typedef TSharedPtr<FCurrentEventMaster, ESPMode::ThreadSafe> FCurrentEventMasterPtr;
}