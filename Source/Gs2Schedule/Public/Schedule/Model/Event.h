...
{
    class GS2SCHEDULE_API FEvent final : public FGs2Object, public TSharedFromThis<FEvent>
    {
    ...
    public:
        ...
        TSharedPtr<FEvent> WithRepeatSetting(const TSharedPtr<FRepeatSetting> RepeatSetting);
