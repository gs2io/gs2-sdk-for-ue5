...
#include "Schedule/Request/UpdateNamespaceRequest.h"
#include "Schedule/Result/UpdateNamespaceResult.h"

namespace Gs2::Schedule::Task::WebSocket
{
    class GS2SCHEDULE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
