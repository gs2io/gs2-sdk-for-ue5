...
#include "Schedule/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Schedule/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::WebSocket
{
    class GS2SCHEDULE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
