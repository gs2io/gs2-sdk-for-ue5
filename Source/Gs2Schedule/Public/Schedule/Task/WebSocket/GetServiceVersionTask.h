...
#include "Schedule/Request/GetServiceVersionRequest.h"
#include "Schedule/Result/GetServiceVersionResult.h"

namespace Gs2::Schedule::Task::WebSocket
{
    class GS2SCHEDULE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
