...
#include "Schedule/Request/GetNamespaceRequest.h"
#include "Schedule/Result/GetNamespaceResult.h"

namespace Gs2::Schedule::Task::WebSocket
{
    class GS2SCHEDULE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
