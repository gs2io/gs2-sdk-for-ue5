...
#include "Schedule/Request/DumpUserDataByUserIdRequest.h"
#include "Schedule/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
