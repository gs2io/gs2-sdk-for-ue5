...
#include "Schedule/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Schedule/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
