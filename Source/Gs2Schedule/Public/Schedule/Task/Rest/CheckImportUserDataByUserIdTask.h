...
#include "Schedule/Request/CheckImportUserDataByUserIdRequest.h"
#include "Schedule/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
