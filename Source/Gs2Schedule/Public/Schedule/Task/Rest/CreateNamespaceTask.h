...
#include "Schedule/Request/CreateNamespaceRequest.h"
#include "Schedule/Result/CreateNamespaceResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
