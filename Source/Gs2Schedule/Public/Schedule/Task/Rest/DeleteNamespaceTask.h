...
#include "Schedule/Request/DeleteNamespaceRequest.h"
#include "Schedule/Result/DeleteNamespaceResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
