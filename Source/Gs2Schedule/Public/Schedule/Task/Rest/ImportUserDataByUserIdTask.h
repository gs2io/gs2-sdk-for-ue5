...
#include "Schedule/Request/ImportUserDataByUserIdRequest.h"
#include "Schedule/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
