...
#include "Schedule/Request/DescribeNamespacesRequest.h"
#include "Schedule/Result/DescribeNamespacesResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
