...
#include "Schedule/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Schedule/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
