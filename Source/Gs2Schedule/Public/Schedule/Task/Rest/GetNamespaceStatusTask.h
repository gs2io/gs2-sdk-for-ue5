...
#include "Schedule/Request/GetNamespaceStatusRequest.h"
#include "Schedule/Result/GetNamespaceStatusResult.h"

namespace Gs2::Schedule::Task::Rest
{
    class GS2SCHEDULE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
