...
{
    class GS2MONEY_API FWithdrawByUserIdResult final : public TSharedFromThis<FWithdrawByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FWithdrawByUserIdResult> WithPrice(const TOptional<float> Price);
