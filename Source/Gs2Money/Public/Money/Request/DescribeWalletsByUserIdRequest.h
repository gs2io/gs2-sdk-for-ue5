...
namespace Gs2::Money::Request
{
    ...
    class GS2MONEY_API FDescribeWalletsByUserIdRequest final : public TSharedFromThis<FDescribeWalletsByUserIdRequest>
    {
    ...
    typedef TSharedPtr<FDescribeWalletsByUserIdRequest, ESPMode::ThreadSafe> FDescribeWalletsByUserIdRequestPtr;
}