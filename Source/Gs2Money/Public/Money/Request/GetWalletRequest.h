...
namespace Gs2::Money::Request
{
    ...
    class GS2MONEY_API FGetWalletRequest final : public TSharedFromThis<FGetWalletRequest>
    {
    ...
    typedef TSharedPtr<FGetWalletRequest, ESPMode::ThreadSafe> FGetWalletRequestPtr;
}