...
namespace Gs2::Money::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Money::Model::FNamespace>> Result) override;
        ...
        class GS2MONEY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Money::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Money::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
