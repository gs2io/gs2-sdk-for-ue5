...
#include "Money/Request/DescribeNamespacesRequest.h"
#include "Money/Result/DescribeNamespacesResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
