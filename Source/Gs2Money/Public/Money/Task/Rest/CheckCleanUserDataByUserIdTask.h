...
#include "Money/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Money/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
