...
#include "Money/Result/UpdateNamespaceResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
