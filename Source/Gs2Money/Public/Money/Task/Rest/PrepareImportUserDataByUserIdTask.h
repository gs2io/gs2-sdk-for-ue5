...
#include "Money/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Money/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
