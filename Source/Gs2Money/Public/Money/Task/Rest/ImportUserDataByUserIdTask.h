...
#include "Money/Request/ImportUserDataByUserIdRequest.h"
#include "Money/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
