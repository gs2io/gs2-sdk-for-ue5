...
#include "Money/Result/CreateNamespaceResult.h"

namespace Gs2::Money::Task::Rest
{
    class GS2MONEY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
