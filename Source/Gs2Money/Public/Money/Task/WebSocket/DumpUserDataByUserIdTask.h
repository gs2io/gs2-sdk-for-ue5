...
#include "Money/Request/DumpUserDataByUserIdRequest.h"
#include "Money/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
