...
#include "Money/Request/CheckImportUserDataByUserIdRequest.h"
#include "Money/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
