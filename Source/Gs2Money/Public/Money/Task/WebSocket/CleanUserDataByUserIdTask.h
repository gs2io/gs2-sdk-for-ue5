...
#include "Money/Request/CleanUserDataByUserIdRequest.h"
#include "Money/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
