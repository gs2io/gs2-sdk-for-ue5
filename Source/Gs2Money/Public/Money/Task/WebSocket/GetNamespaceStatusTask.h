...
#include "Money/Request/GetNamespaceStatusRequest.h"
#include "Money/Result/GetNamespaceStatusResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
