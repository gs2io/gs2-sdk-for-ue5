...
#include "Money/Request/GetNamespaceRequest.h"
#include "Money/Result/GetNamespaceResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
