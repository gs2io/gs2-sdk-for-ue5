...
#include "Money/Request/DeleteNamespaceRequest.h"
#include "Money/Result/DeleteNamespaceResult.h"

namespace Gs2::Money::Task::WebSocket
{
    class GS2MONEY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
