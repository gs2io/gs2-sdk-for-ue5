...
#include "Money/Task/WebSocket/RecordReceiptTask.h"
...
namespace Gs2::Money::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("money"), TEXT("receipt"), TEXT("recordReceipt"), ToCStr(RequestPayload->Payload()));
