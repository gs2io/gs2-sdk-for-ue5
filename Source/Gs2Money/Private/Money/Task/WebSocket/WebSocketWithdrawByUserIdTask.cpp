...
#include "Money/Task/WebSocket/WithdrawByUserIdTask.h"
...
namespace Gs2::Money::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("money"), TEXT("wallet"), TEXT("withdrawByUserId"), ToCStr(RequestPayload->Payload()));
