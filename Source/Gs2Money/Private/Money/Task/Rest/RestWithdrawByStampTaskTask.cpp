...
#include "Money/Task/Rest/WithdrawByStampTaskTask.h"
...
{
    FWithdrawByStampTaskTask::FWithdrawByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FWithdrawByStampTaskTask::Action(
        const TSharedPtr<Result::FWithdrawByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FWithdrawByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
