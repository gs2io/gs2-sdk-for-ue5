...
#include "Money/Task/Rest/DescribeReceiptsTask.h"
...
{
    FDescribeReceiptsTask::FDescribeReceiptsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeReceiptsTask::Action(
        const TSharedPtr<Result::FDescribeReceiptsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetSlot().IsSet()) {
                queryStrings.Add("slot=" + this->Request->GetSlotString());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeReceiptsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
