...
#include "Money/Task/Rest/RecordReceiptByStampTaskTask.h"
...
{
    FRecordReceiptByStampTaskTask::FRecordReceiptByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FRecordReceiptByStampTaskTask::Action(
        const TSharedPtr<Result::FRecordReceiptByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRecordReceiptByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
