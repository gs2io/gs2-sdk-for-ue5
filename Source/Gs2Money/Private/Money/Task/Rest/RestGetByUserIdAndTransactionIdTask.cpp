...
#include "Money/Task/Rest/GetByUserIdAndTransactionIdTask.h"
...
{
    FGetByUserIdAndTransactionIdTask::FGetByUserIdAndTransactionIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetByUserIdAndTransactionIdTask::Action(
        const TSharedPtr<Result::FGetByUserIdAndTransactionIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/receipt/{transactionId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetByUserIdAndTransactionIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
