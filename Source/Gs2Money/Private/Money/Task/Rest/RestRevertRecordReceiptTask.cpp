...
#include "Money/Task/Rest/RevertRecordReceiptTask.h"
...
{
    FRevertRecordReceiptTask::FRevertRecordReceiptTask(
    ...
    Core::Model::FGs2ErrorPtr FRevertRecordReceiptTask::Action(
        const TSharedPtr<Result::FRevertRecordReceiptResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/receipt/revert");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRevertRecordReceiptResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
