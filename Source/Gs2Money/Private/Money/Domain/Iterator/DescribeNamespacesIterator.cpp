...
namespace Gs2::Money::Domain::Iterator
{
    ...
    const Gs2::Money::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Money::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
