...
namespace Gs2::Money::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FWithdrawByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FWithdrawByUserIdRequest::FromJson(RequestModelJson);
            Request = FWithdrawByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FWithdrawByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
