...
namespace Gs2::Money::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FDepositByUserIdSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FDepositByUserIdRequest::FromJson(RequestModelJson);
            Request = FDepositByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FDepositByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
