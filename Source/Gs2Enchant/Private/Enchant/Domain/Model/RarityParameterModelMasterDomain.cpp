...
namespace Gs2::Enchant::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete(Gs2::Enchant::Model::FRarityParameterModelMaster::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::Enchant::Model::FRarityParameterModelMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::Enchant::Model::FRarityParameterModelMaster>(
                Self->ParentKey,
                Gs2::Enchant::Domain::Model::FRarityParameterModelMasterDomain::CreateCacheKey(
                    Self->ParameterName
                ),
