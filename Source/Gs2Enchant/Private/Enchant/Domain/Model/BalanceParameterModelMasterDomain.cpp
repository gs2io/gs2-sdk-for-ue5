...
namespace Gs2::Enchant::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::Delete(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Enchant::Model::FBalanceParameterModelMasterPtr Value;
                const auto CacheHit = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->ParameterName,
                    TOptional<int32>(),
                    [Self](Gs2::Enchant::Model::FBalanceParameterModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FBalanceParameterModelMasterDomain::Invalidate()
    {
        Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::Delete(
            Gs2->Cache,
    ...
    FBalanceParameterModelMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FBalanceParameterModelMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FBalanceParameterModelMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FBalanceParameterModelMasterDomain::FSubscribeWithInitialCallTask>> FBalanceParameterModelMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Enchant::Model::FBalanceParameterModelMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Enchant::Model::Cache::FBalanceParameterModelMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryParameterName]()
            {
                ...
                const auto Domain = MakeShared<FBalanceParameterModelMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryParameterName
