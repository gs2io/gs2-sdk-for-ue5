...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    FDescribeBalanceParameterStatusesByUserIdIterator::FIterator::FIterator(
    ...
    FDescribeBalanceParameterStatusesByUserIdIterator::FIterator& FDescribeBalanceParameterStatusesByUserIdIterator::FIterator::operator++()
    {
        ...
        if (!RangeIteratorOpt || (!*RangeIteratorOpt && !bLast))
        {
            ...
            const auto Request =
                MakeShared<Gs2::Enchant::Request::FDescribeBalanceParameterStatusesByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeBalanceParameterStatusesByUserId(Request);
    ...
    FDescribeBalanceParameterStatusesByUserIdIterator::FIterator FDescribeBalanceParameterStatusesByUserIdIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeBalanceParameterStatusesByUserIdIterator::FIterator FDescribeBalanceParameterStatusesByUserIdIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeBalanceParameterStatusesByUserIdIterator::FIterator FDescribeBalanceParameterStatusesByUserIdIterator::end()
    {
