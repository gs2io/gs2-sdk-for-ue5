...
namespace Gs2::Enchant::Result
{
    ...
    TSharedPtr<FSetRarityParameterStatusByUserIdResult> FSetRarityParameterStatusByUserIdResult::WithItem(
    ...
    TSharedPtr<FSetRarityParameterStatusByUserIdResult> FSetRarityParameterStatusByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FSetRarityParameterStatusByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FSetRarityParameterStatusByUserIdResult::ToJson() const
    {
