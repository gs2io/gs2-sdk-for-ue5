...
namespace Gs2::Enchant::Request
{
    ...
    TSharedPtr<FDescribeBalanceParameterModelMastersRequest> FDescribeBalanceParameterModelMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeBalanceParameterModelMastersRequest::GetNamePrefix() const
    {
