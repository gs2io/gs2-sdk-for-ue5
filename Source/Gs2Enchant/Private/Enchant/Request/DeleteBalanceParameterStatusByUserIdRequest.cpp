...
namespace Gs2::Enchant::Request
{
    ...
    TSharedPtr<FDeleteBalanceParameterStatusByUserIdRequest> FDeleteBalanceParameterStatusByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDeleteBalanceParameterStatusByUserIdRequest::GetTimeOffsetToken() const
    {
