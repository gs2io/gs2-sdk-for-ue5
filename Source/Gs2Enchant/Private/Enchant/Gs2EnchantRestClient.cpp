...
namespace Gs2::Enchant
{
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FGetServiceVersionTask>> FGs2EnchantRestClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FDumpUserDataByUserIdTask>> FGs2EnchantRestClient::DumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckDumpUserDataByUserIdTask>> FGs2EnchantRestClient::CheckDumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCleanUserDataByUserIdTask>> FGs2EnchantRestClient::CleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckCleanUserDataByUserIdTask>> FGs2EnchantRestClient::CheckCleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FPrepareImportUserDataByUserIdTask>> FGs2EnchantRestClient::PrepareImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FImportUserDataByUserIdTask>> FGs2EnchantRestClient::ImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckImportUserDataByUserIdTask>> FGs2EnchantRestClient::CheckImportUserDataByUserId(
