...
#include "Enchant/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::Enchant::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enchant"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
