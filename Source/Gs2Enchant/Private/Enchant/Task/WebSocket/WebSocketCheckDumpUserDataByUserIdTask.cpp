...
#include "Enchant/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Enchant::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enchant"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
