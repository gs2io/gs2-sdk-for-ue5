...
#include "Enchant/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Enchant::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enchant"), TEXT("currentParameterMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
