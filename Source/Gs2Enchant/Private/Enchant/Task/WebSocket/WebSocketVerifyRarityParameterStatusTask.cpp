...
#include "Enchant/Task/WebSocket/VerifyRarityParameterStatusTask.h"
...
namespace Gs2::Enchant::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enchant"), TEXT("rarityParameterStatus"), TEXT("verifyRarityParameterStatus"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FVerifyRarityParameterStatusResult::FromJson(WebSocketResult->Body());
