...
#include "Enchant/Task/Rest/UpdateBalanceParameterModelMasterTask.h"
...
{
    FUpdateBalanceParameterModelMasterTask::FUpdateBalanceParameterModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateBalanceParameterModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateBalanceParameterModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/balance/{parameterName}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("totalValue"), FString::Printf(TEXT("%lld"), this->Request->GetTotalValue().GetValue()));
            }
            if (this->Request->GetInitialValueStrategy().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("initialValueStrategy"), this->Request->GetInitialValueStrategy().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateBalanceParameterModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
