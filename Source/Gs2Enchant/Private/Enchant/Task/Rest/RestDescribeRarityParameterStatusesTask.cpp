...
#include "Enchant/Task/Rest/DescribeRarityParameterStatusesTask.h"
...
{
    FDescribeRarityParameterStatusesTask::FDescribeRarityParameterStatusesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeRarityParameterStatusesTask::Action(
        const TSharedPtr<Result::FDescribeRarityParameterStatusesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/rarity");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeRarityParameterStatusesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
