...
#include "Enchant/Task/Rest/AddRarityParameterStatusByStampSheetTask.h"
...
{
    FAddRarityParameterStatusByStampSheetTask::FAddRarityParameterStatusByStampSheetTask(
    ...
    Core::Model::FGs2ErrorPtr FAddRarityParameterStatusByStampSheetTask::Action(
        const TSharedPtr<Result::FAddRarityParameterStatusByStampSheetResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/stamp/rarity/parameter/add");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddRarityParameterStatusByStampSheetResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
