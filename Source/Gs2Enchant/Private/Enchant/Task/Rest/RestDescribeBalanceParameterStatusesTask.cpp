...
#include "Enchant/Task/Rest/DescribeBalanceParameterStatusesTask.h"
...
{
    FDescribeBalanceParameterStatusesTask::FDescribeBalanceParameterStatusesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBalanceParameterStatusesTask::Action(
        const TSharedPtr<Result::FDescribeBalanceParameterStatusesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/balance");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBalanceParameterStatusesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
