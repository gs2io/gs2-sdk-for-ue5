...
#include "Enchant/Task/Rest/SetRarityParameterStatusByUserIdTask.h"
...
{
    FSetRarityParameterStatusByUserIdTask::FSetRarityParameterStatusByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FSetRarityParameterStatusByUserIdTask::Action(
        const TSharedPtr<Result::FSetRarityParameterStatusByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/rarity/{parameterName}/{propertyId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetRarityParameterStatusByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
