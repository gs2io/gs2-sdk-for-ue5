...
#include "Enchant/Task/Rest/ReDrawRarityParameterStatusByUserIdTask.h"
...
{
    FReDrawRarityParameterStatusByUserIdTask::FReDrawRarityParameterStatusByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FReDrawRarityParameterStatusByUserIdTask::Action(
        const TSharedPtr<Result::FReDrawRarityParameterStatusByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/rarity/{parameterName}/{propertyId}/redraw");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReDrawRarityParameterStatusByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
