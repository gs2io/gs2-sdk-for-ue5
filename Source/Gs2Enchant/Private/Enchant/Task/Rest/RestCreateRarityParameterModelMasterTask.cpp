...
#include "Enchant/Task/Rest/CreateRarityParameterModelMasterTask.h"
...
{
    FCreateRarityParameterModelMasterTask::FCreateRarityParameterModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateRarityParameterModelMasterTask::Action(
        const TSharedPtr<Result::FCreateRarityParameterModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/rarity");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateRarityParameterModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
