...
#include "Enchant/Task/Rest/DescribeBalanceParameterStatusesByUserIdTask.h"
...
{
    FDescribeBalanceParameterStatusesByUserIdTask::FDescribeBalanceParameterStatusesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBalanceParameterStatusesByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeBalanceParameterStatusesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/balance");
            ...
            if (this->Request->GetParameterName().IsSet()) {
                queryStrings.Add("parameterName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetParameterName().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBalanceParameterStatusesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
