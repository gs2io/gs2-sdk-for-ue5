...
#include "Enchant/Task/Rest/ReDrawBalanceParameterStatusByUserIdTask.h"
...
{
    FReDrawBalanceParameterStatusByUserIdTask::FReDrawBalanceParameterStatusByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FReDrawBalanceParameterStatusByUserIdTask::Action(
        const TSharedPtr<Result::FReDrawBalanceParameterStatusByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/balance/{parameterName}/{propertyId}/redraw");
            ...
            if (this->Request->GetFixedParameterNames() != nullptr && this->Request->GetFixedParameterNames().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetFixedParameterNames())
                {
                    v.Add(MakeShared<FJsonValueString>(JsonObjectValue));
                }
                JsonRootObject->SetArrayField(TEXT("fixedParameterNames"), v);
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReDrawBalanceParameterStatusByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
