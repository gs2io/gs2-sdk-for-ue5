...
namespace Gs2::Enchant::Domain::SpeculativeExecutor
{
    ...
    class GS2ENCHANT_API FReDrawBalanceParameterStatusByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Enchant::Request::FReDrawBalanceParameterStatusByUserIdRequestPtr Rate(
            const Gs2::Enchant::Request::FReDrawBalanceParameterStatusByUserIdRequestPtr& Request,
            const double Rate
        );
