...
namespace Gs2::Enchant::Domain::SpeculativeExecutor
{
    ...
    class GS2ENCHANT_API FReDrawRarityParameterStatusByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Enchant::Request::FReDrawRarityParameterStatusByUserIdRequestPtr Rate(
            const Gs2::Enchant::Request::FReDrawRarityParameterStatusByUserIdRequestPtr& Request,
            const double Rate
        );
