...
namespace Gs2::Enchant::Domain::SpeculativeExecutor
{
    ...
    class GS2ENCHANT_API FSetBalanceParameterStatusByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Enchant::Request::FSetBalanceParameterStatusByUserIdRequestPtr Rate(
            const Gs2::Enchant::Request::FSetBalanceParameterStatusByUserIdRequestPtr& Request,
            const double Rate
        );
