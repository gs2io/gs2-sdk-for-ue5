...
namespace Gs2::Enchant::Domain::Model
{
    ...
    class GS2ENCHANT_API FRarityParameterStatusAccessTokenDomain:
    ...
    typedef TSharedPtr<FRarityParameterStatusAccessTokenDomain> FRarityParameterStatusAccessTokenDomainPtr;
}
