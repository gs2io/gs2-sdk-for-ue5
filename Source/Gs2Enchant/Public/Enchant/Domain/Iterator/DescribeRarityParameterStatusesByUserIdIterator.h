...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeRarityParameterStatusesByUserIdIterator :
        public TSharedFromThis<FDescribeRarityParameterStatusesByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FRarityParameterStatus>> Result) override;
        ...
        {
            TSharedRef<FDescribeRarityParameterStatusesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FRarityParameterStatusPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FRarityParameterStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRarityParameterStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRarityParameterStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRarityParameterStatusesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRarityParameterStatusesByUserIdIterator> FDescribeRarityParameterStatusesByUserIdIteratorPtr;
}
