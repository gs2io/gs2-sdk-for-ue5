...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FNamespace>> Result) override;
        ...
        class GS2ENCHANT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Enchant::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FNamespacePtr& Current()
            {
