...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    public:
        ...
        FDescribeRarityParameterModelsIterator(
            const FDescribeRarityParameterModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FRarityParameterModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeRarityParameterModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FRarityParameterModelPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FRarityParameterModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FRarityParameterModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRarityParameterModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRarityParameterModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRarityParameterModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRarityParameterModelsIterator> FDescribeRarityParameterModelsIteratorPtr;
}
