...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeBalanceParameterStatusesIterator :
        public TSharedFromThis<FDescribeBalanceParameterStatusesIterator>
    {
    ...
    public:
        FDescribeBalanceParameterStatusesIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Enchant::FGs2EnchantRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FBalanceParameterStatus>> Result) override;
        ...
        {
            TSharedRef<FDescribeBalanceParameterStatusesIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FBalanceParameterStatusPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FBalanceParameterStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FBalanceParameterStatusPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBalanceParameterStatusesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBalanceParameterStatusesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBalanceParameterStatusesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBalanceParameterStatusesIterator> FDescribeBalanceParameterStatusesIteratorPtr;
}
