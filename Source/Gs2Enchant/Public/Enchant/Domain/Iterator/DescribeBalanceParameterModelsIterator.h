...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeBalanceParameterModelsIterator :
        public TSharedFromThis<FDescribeBalanceParameterModelsIterator>
    {
    ...
    public:
        FDescribeBalanceParameterModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Enchant::FGs2EnchantRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        FDescribeBalanceParameterModelsIterator(
            const FDescribeBalanceParameterModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FBalanceParameterModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeBalanceParameterModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FBalanceParameterModelPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FBalanceParameterModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FBalanceParameterModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBalanceParameterModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBalanceParameterModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBalanceParameterModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBalanceParameterModelsIterator> FDescribeBalanceParameterModelsIteratorPtr;
}
