...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeBalanceParameterModelMastersIterator :
        public TSharedFromThis<FDescribeBalanceParameterModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FBalanceParameterModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeBalanceParameterModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FBalanceParameterModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FBalanceParameterModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FBalanceParameterModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBalanceParameterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBalanceParameterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBalanceParameterModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBalanceParameterModelMastersIterator> FDescribeBalanceParameterModelMastersIteratorPtr;
}
