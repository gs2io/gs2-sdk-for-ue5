...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeBalanceParameterStatusesByUserIdIterator> Self;
            ...
            FIterator(
                const TSharedRef<FDescribeBalanceParameterStatusesByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBalanceParameterStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBalanceParameterStatusesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBalanceParameterStatusesByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBalanceParameterStatusesByUserIdIterator> FDescribeBalanceParameterStatusesByUserIdIteratorPtr;
}
