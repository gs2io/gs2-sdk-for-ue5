...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeRarityParameterStatusesIterator :
        public TSharedFromThis<FDescribeRarityParameterStatusesIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeRarityParameterStatusesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRarityParameterStatusesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRarityParameterStatusesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRarityParameterStatusesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRarityParameterStatusesIterator> FDescribeRarityParameterStatusesIteratorPtr;
}
