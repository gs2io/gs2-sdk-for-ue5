...
namespace Gs2::Enchant::Domain::Iterator
{
    ...
    class GS2ENCHANT_API FDescribeRarityParameterModelMastersIterator :
        public TSharedFromThis<FDescribeRarityParameterModelMastersIterator>
    {
    ...
    public:
        FDescribeRarityParameterModelMastersIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Enchant::FGs2EnchantRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enchant::Model::FRarityParameterModelMaster>> Result) override;
        ...
        class GS2ENCHANT_API FIterator
        {
            TSharedRef<FDescribeRarityParameterModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Enchant::Model::FRarityParameterModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Enchant::Model::FRarityParameterModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enchant::Model::FRarityParameterModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRarityParameterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRarityParameterModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRarityParameterModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRarityParameterModelMastersIterator> FDescribeRarityParameterModelMastersIteratorPtr;
}
