...
#include "Enchant/Request/DescribeNamespacesRequest.h"
#include "Enchant/Result/DescribeNamespacesResult.h"

namespace Gs2::Enchant::Task::Rest
{
    class GS2ENCHANT_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
