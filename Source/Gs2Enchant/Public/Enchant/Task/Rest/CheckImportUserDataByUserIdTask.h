...
#include "Enchant/Request/CheckImportUserDataByUserIdRequest.h"
#include "Enchant/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Enchant::Task::Rest
{
    class GS2ENCHANT_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
