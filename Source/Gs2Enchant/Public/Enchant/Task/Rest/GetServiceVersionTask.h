...
#include "Enchant/Request/GetServiceVersionRequest.h"
#include "Enchant/Result/GetServiceVersionResult.h"

namespace Gs2::Enchant::Task::Rest
{
    class GS2ENCHANT_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
