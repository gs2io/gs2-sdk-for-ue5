...
#include "Enchant/Request/CreateNamespaceRequest.h"
#include "Enchant/Result/CreateNamespaceResult.h"

namespace Gs2::Enchant::Task::Rest
{
    class GS2ENCHANT_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
