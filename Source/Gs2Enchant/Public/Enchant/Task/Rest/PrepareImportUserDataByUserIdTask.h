...
#include "Enchant/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Enchant/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Enchant::Task::Rest
{
    class GS2ENCHANT_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
