...
#include "Enchant/Request/ImportUserDataByUserIdRequest.h"
#include "Enchant/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
