...
#include "Enchant/Request/GetNamespaceRequest.h"
#include "Enchant/Result/GetNamespaceResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
