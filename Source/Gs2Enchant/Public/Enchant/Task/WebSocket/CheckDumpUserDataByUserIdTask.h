...
#include "Enchant/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Enchant/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
