...
#include "Enchant/Request/UpdateNamespaceRequest.h"
#include "Enchant/Result/UpdateNamespaceResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
