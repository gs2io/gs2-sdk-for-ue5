...
#include "Enchant/Request/DumpUserDataByUserIdRequest.h"
#include "Enchant/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
