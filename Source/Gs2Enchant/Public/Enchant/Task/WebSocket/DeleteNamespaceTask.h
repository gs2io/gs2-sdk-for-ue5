...
#include "Enchant/Request/DeleteNamespaceRequest.h"
#include "Enchant/Result/DeleteNamespaceResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
