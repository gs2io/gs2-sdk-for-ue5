...
#include "Enchant/Request/GetNamespaceStatusRequest.h"
#include "Enchant/Result/GetNamespaceStatusResult.h"

namespace Gs2::Enchant::Task::WebSocket
{
    class GS2ENCHANT_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
