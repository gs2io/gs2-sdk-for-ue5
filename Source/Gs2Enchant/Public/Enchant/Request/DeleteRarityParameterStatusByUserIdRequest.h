...
namespace Gs2::Enchant::Request
{
    ...
    public:
        ...
        TSharedPtr<FDeleteRarityParameterStatusByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FDeleteRarityParameterStatusByUserIdRequest> FDeleteRarityParameterStatusByUserIdRequestPtr;
}