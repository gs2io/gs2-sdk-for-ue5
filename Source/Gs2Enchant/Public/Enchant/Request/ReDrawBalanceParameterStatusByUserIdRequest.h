...
namespace Gs2::Enchant::Request
{
    ...
    public:
        ...
        TSharedPtr<FReDrawBalanceParameterStatusByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FReDrawBalanceParameterStatusByUserIdRequest> FReDrawBalanceParameterStatusByUserIdRequestPtr;
}