...
namespace Gs2::Enchant::Request
{
    ...
    public:
        ...
        TSharedPtr<FVerifyRarityParameterStatusByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FVerifyRarityParameterStatusByUserIdRequest> FVerifyRarityParameterStatusByUserIdRequestPtr;
}