...
{
    class FDeleteBalanceParameterStatusByUserIdRequest;

    class GS2ENCHANT_API FDeleteBalanceParameterStatusByUserIdRequest final : public TSharedFromThis<FDeleteBalanceParameterStatusByUserIdRequest>
    {
    ...
    public:
        ...
        FDeleteBalanceParameterStatusByUserIdRequest();
        FDeleteBalanceParameterStatusByUserIdRequest(
            const FDeleteBalanceParameterStatusByUserIdRequest& From
        );
        ~FDeleteBalanceParameterStatusByUserIdRequest() = default;

        TSharedPtr<FDeleteBalanceParameterStatusByUserIdRequest> WithContextStack(const TOptional<FString> ContextStack);
        TSharedPtr<FDeleteBalanceParameterStatusByUserIdRequest> WithNamespaceName(const TOptional<FString> NamespaceName);
    ...
    typedef TSharedPtr<FDeleteBalanceParameterStatusByUserIdRequest, ESPMode::ThreadSafe> FDeleteBalanceParameterStatusByUserIdRequestPtr;
}