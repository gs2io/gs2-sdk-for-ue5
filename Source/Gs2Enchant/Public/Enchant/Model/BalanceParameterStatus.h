...
{
    class GS2ENCHANT_API FBalanceParameterStatus final : public FGs2Object, public TSharedFromThis<FBalanceParameterStatus>
    {
    ...
    public:
        ...
        TSharedPtr<FBalanceParameterStatus> WithRevision(const TOptional<int64> Revision);
