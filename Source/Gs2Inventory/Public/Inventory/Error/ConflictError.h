...
namespace Gs2::Inventory::Error
{
    class GS2INVENTORY_API FConflictError : public Core::Model::FConflictError
    {
    public:
        ...
        {
            return Core::Model::FConflictError::SuperType() + ":" + TypeString;
        }
    };
