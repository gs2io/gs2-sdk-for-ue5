...
{
    class GS2INVENTORY_API FSetCapacityByStampSheetResult final : public TSharedFromThis<FSetCapacityByStampSheetResult>
    {
    ...
    public:
        ...
        TSharedPtr<FSetCapacityByStampSheetResult> WithItem(const TSharedPtr<Model::FInventory> Item);
