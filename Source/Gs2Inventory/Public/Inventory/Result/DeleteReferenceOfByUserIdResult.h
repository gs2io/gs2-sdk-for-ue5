...
namespace Gs2::Inventory::Result
{
    ...
    public:
        ...
        FDeleteReferenceOfByUserIdResult();
        FDeleteReferenceOfByUserIdResult(
        ...
        static TSharedPtr<FDeleteReferenceOfByUserIdResult> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;
    };
    typedef TSharedPtr<FDeleteReferenceOfByUserIdResult, ESPMode::ThreadSafe> FDeleteReferenceOfByUserIdResultPtr;
}