...
namespace Gs2::Inventory::Result
{
    ...
    public:
        ...
        FVerifyInventoryCurrentMaxCapacityResult();
        FVerifyInventoryCurrentMaxCapacityResult(
    ...
    typedef TSharedPtr<FVerifyInventoryCurrentMaxCapacityResult, ESPMode::ThreadSafe> FVerifyInventoryCurrentMaxCapacityResultPtr;
}