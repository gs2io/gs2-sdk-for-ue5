...
{
    class GS2INVENTORY_API FAddCapacityByStampSheetResult final : public TSharedFromThis<FAddCapacityByStampSheetResult>
    {
    ...
    public:
        ...
        TSharedPtr<FAddCapacityByStampSheetResult> WithItem(const TSharedPtr<Model::FInventory> Item);
