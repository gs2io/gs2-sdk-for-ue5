...
#include "Inventory/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Inventory/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
