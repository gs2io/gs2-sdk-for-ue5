...
#include "Inventory/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Inventory/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
