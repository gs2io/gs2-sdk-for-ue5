...
#include "Inventory/Request/CleanUserDataByUserIdRequest.h"
#include "Inventory/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
