...
#include "Inventory/Result/CreateNamespaceResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
