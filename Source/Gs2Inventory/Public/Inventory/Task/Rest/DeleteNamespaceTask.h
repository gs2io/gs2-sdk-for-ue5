...
#include "Inventory/Request/DeleteNamespaceRequest.h"
#include "Inventory/Result/DeleteNamespaceResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
