...
#include "Inventory/Request/GetNamespaceRequest.h"
#include "Inventory/Result/GetNamespaceResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
