...
#include "Inventory/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Inventory/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
