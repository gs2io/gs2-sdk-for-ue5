...
#include "Inventory/Result/UpdateNamespaceResult.h"

namespace Gs2::Inventory::Task::Rest
{
    class GS2INVENTORY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
