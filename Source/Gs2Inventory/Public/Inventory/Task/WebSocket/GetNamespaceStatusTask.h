...
#include "Inventory/Request/GetNamespaceStatusRequest.h"
#include "Inventory/Result/GetNamespaceStatusResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
