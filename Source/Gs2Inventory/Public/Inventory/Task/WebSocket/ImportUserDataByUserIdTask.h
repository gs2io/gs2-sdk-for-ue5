...
#include "Inventory/Request/ImportUserDataByUserIdRequest.h"
#include "Inventory/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
