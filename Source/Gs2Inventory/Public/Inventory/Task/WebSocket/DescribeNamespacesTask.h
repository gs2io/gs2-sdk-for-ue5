...
#include "Inventory/Request/DescribeNamespacesRequest.h"
#include "Inventory/Result/DescribeNamespacesResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
