...
#include "Inventory/Request/GetServiceVersionRequest.h"
#include "Inventory/Result/GetServiceVersionResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
