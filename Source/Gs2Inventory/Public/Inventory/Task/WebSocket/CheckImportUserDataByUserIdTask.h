...
#include "Inventory/Request/CheckImportUserDataByUserIdRequest.h"
#include "Inventory/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
