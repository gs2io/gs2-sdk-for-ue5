...
#include "Inventory/Request/DumpUserDataByUserIdRequest.h"
#include "Inventory/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Inventory::Task::WebSocket
{
    class GS2INVENTORY_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
