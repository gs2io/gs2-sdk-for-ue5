...
namespace Gs2::Inventory::Domain::SpeculativeExecutor
{
    ...
    class GS2INVENTORY_API FAcquireItemSetWithGradeByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Inventory::Request::FAcquireItemSetWithGradeByUserIdRequestPtr Rate(
            const Gs2::Inventory::Request::FAcquireItemSetWithGradeByUserIdRequestPtr& Request,
            const double Rate
        );
