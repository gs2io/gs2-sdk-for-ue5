...
namespace Gs2::Inventory::Domain::SpeculativeExecutor
{
    ...
    class GS2INVENTORY_API FSetCapacityByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2INVENTORY_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Inventory::Domain::FGs2InventoryDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Inventory::Request::FSetCapacityByUserIdRequestPtr& Request
            ...
            GS2INVENTORY_API FCommitTask(
                const FCommitTask& From
            );

            GS2INVENTORY_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Inventory::Request::FSetCapacityByUserIdRequestPtr Rate(
            const Gs2::Inventory::Request::FSetCapacityByUserIdRequestPtr& Request,
            const double Rate
        );
