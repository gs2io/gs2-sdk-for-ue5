...
namespace Gs2::Inventory::Domain::SpeculativeExecutor
{
    ...
    class GS2INVENTORY_API FVerifyInventoryCurrentMaxCapacityByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Inventory::Request::FVerifyInventoryCurrentMaxCapacityByUserIdRequestPtr Rate(
            const Gs2::Inventory::Request::FVerifyInventoryCurrentMaxCapacityByUserIdRequestPtr& Request,
            const double Rate
        );
