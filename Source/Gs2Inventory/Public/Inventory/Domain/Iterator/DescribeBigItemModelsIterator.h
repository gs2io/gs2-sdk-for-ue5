...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeBigItemModelsIterator :
        public TSharedFromThis<FDescribeBigItemModelsIterator>
    {
    ...
    public:
        FDescribeBigItemModelsIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Inventory::FGs2InventoryRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> InventoryName
        ...
        class GS2INVENTORY_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Inventory::Model::FBigItemModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FBigItemModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeBigItemModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FBigItemModelPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FBigItemModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Inventory::Model::FBigItemModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBigItemModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBigItemModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBigItemModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBigItemModelsIterator> FDescribeBigItemModelsIteratorPtr;
}
