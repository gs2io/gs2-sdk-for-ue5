...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FNamespace>> Result) override;
        ...
        class GS2INVENTORY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Inventory::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
