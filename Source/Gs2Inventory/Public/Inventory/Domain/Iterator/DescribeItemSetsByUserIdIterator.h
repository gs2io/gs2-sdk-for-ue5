...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeItemSetsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeItemSetsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeItemSetsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeItemSetsByUserIdIterator> Iterable)
            {
