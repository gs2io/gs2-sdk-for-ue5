...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeSimpleItemsIterator :
        public TSharedFromThis<FDescribeSimpleItemsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeSimpleItemsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSimpleItemsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSimpleItemsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSimpleItemsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSimpleItemsIterator> FDescribeSimpleItemsIteratorPtr;
}
