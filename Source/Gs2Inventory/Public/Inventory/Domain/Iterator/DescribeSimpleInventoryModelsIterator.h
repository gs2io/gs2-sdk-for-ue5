...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeSimpleInventoryModelsIterator :
        public TSharedFromThis<FDescribeSimpleInventoryModelsIterator>
    {
    ...
    public:
        FDescribeSimpleInventoryModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Inventory::FGs2InventoryRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FSimpleInventoryModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeSimpleInventoryModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FSimpleInventoryModelPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FSimpleInventoryModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Inventory::Model::FSimpleInventoryModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSimpleInventoryModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSimpleInventoryModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSimpleInventoryModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSimpleInventoryModelsIterator> FDescribeSimpleInventoryModelsIteratorPtr;
}
