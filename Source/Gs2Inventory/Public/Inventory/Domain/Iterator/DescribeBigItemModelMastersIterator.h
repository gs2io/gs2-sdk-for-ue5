...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FBigItemModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeBigItemModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FBigItemModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FBigItemModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Inventory::Model::FBigItemModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBigItemModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBigItemModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBigItemModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBigItemModelMastersIterator> FDescribeBigItemModelMastersIteratorPtr;
}
