...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeBigItemsByUserIdIterator :
        public TSharedFromThis<FDescribeBigItemsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FBigItem>> Result) override;
        ...
        {
            TSharedRef<FDescribeBigItemsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FBigItemPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FBigItemPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeBigItemsByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBigItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBigItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBigItemsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBigItemsByUserIdIterator> FDescribeBigItemsByUserIdIteratorPtr;
}
