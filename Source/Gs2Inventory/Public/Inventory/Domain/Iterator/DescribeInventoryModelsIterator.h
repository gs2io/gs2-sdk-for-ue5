...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class FDescribeInventoryModelsIteratorLoadTask;

    class GS2INVENTORY_API FDescribeInventoryModelsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Inventory::Model::FInventoryModel, FDescribeInventoryModelsIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Inventory::FGs2InventoryRestClientPtr Client;

        friend FDescribeInventoryModelsIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeInventoryModelsIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeInventoryModelsIterator;
        ...
        public:
            ...
            const Gs2::Inventory::Model::FInventoryModelPtr& operator*() const;
            Gs2::Inventory::Model::FInventoryModelPtr operator->();
    ...
    class FDescribeInventoryModelsIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Inventory::Model::FInventoryModelPtr>>,
        public TSharedFromThis<FDescribeInventoryModelsIteratorLoadTask>
    {
        TSharedPtr<FDescribeInventoryModelsIterator> Self;
