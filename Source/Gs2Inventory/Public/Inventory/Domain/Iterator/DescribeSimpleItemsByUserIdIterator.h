...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeSimpleItemsByUserIdIterator :
        public TSharedFromThis<FDescribeSimpleItemsByUserIdIterator>
    {
    ...
    public:
        FDescribeSimpleItemsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Inventory::FGs2InventoryRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> InventoryName,
        ...
        FDescribeSimpleItemsByUserIdIterator(
            const FDescribeSimpleItemsByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FSimpleItem>> Result) override;
        ...
        {
            TSharedRef<FDescribeSimpleItemsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FSimpleItemPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FSimpleItemPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSimpleItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSimpleItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSimpleItemsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSimpleItemsByUserIdIterator> FDescribeSimpleItemsByUserIdIteratorPtr;
}
