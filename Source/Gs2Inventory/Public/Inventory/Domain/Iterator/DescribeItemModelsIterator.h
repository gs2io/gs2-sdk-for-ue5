...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeItemModelsIterator :
        public TSharedFromThis<FDescribeItemModelsIterator>
    {
    ...
    public:
        ...
        FDescribeItemModelsIterator(
            const FDescribeItemModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Inventory::Model::FItemModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeItemModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Inventory::Model::FItemModelPtr>> Range;
            TOptional<TArray<Gs2::Inventory::Model::FItemModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeItemModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeItemModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeItemModelsIterator> Iterable)
            {
