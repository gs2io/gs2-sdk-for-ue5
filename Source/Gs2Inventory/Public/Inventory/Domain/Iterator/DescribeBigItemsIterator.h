...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    class GS2INVENTORY_API FDescribeBigItemsIterator :
        public TSharedFromThis<FDescribeBigItemsIterator>
    {
    ...
    public:
        ...
        FDescribeBigItemsIterator(
            const FDescribeBigItemsIterator& From
        );
        ...
        {
            TSharedRef<FDescribeBigItemsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBigItemsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBigItemsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBigItemsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBigItemsIterator> FDescribeBigItemsIteratorPtr;
}
