...
namespace Gs2::Inventory::Domain::Model
{
    ...
    class GS2INVENTORY_API FSimpleItemModelDomain:
        public TSharedFromThis<FSimpleItemModelDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FSimpleItemModelDomain> Self;
            const TFunction<void(Gs2::Inventory::Model::FSimpleItemModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FSimpleItemModelDomain> FSimpleItemModelDomainPtr;
}
