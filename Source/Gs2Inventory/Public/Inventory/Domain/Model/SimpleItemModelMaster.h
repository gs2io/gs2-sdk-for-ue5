...
namespace Gs2::Inventory::Domain::Model
{
    ...
    class GS2INVENTORY_API FSimpleItemModelMasterDomain:
        public TSharedFromThis<FSimpleItemModelMasterDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FSimpleItemModelMasterDomain> Self;
            const TFunction<void(Gs2::Inventory::Model::FSimpleItemModelMasterPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FSimpleItemModelMasterDomain> FSimpleItemModelMasterDomainPtr;
}
