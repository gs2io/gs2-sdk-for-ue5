...
namespace Gs2::Inventory::Domain::Model
{
    ...
    public:
        ...
        public:
            FSubscribeSimpleItemsWithInitialCallTask(const TSharedPtr<FSimpleInventoryAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::Inventory::Model::FSimpleItemPtr>)> Callback);
