...
namespace Gs2::Inventory::Domain::Model
{
    ...
    public:
        ...
        class FCollectSimpleItemModelsTask;

        Gs2::Core::Domain::CallbackID SubscribeSimpleItemModels(
            TFunction<void(TArray<Gs2::Inventory::Model::FSimpleItemModelPtr>)> Callback
        );

        void InvalidateSimpleItemModels();

        class GS2INVENTORY_API FSubscribeSimpleItemModelsWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeSimpleItemModelsWithInitialCallTask>
        {
            const TSharedPtr<FSimpleInventoryModelDomain> Self;
            const TFunction<void(TArray<Gs2::Inventory::Model::FSimpleItemModelPtr>)> Callback;

        public:
            FSubscribeSimpleItemModelsWithInitialCallTask(const TSharedPtr<FSimpleInventoryModelDomain>& Self, TFunction<void(TArray<Gs2::Inventory::Model::FSimpleItemModelPtr>)> Callback);
            FSubscribeSimpleItemModelsWithInitialCallTask(const FSubscribeSimpleItemModelsWithInitialCallTask& From);
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Core::Domain::CallbackID>> Result) override;
        };

        TSharedPtr<FAsyncTask<FSubscribeSimpleItemModelsWithInitialCallTask>> SubscribeSimpleItemModelsWithInitialCall(
            TFunction<void(TArray<Gs2::Inventory::Model::FSimpleItemModelPtr>)> Callback
        );
        ...
        {
            const TSharedPtr<FSimpleInventoryModelDomain> Self;
            const TFunction<void(Gs2::Inventory::Model::FSimpleInventoryModelPtr)> Callback;
        public:
