...
namespace Gs2::Inventory::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeSimpleInventoryModelMastersRequest> WithNamePrefix(const TOptional<FString> NamePrefix);
    ...
    typedef TSharedPtr<FDescribeSimpleInventoryModelMastersRequest> FDescribeSimpleInventoryModelMastersRequestPtr;
}