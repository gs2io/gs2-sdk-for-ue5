...
namespace Gs2::Inventory::Request
{
    ...
    class GS2INVENTORY_API FAddCapacityByStampSheetRequest final : public TSharedFromThis<FAddCapacityByStampSheetRequest>
    {
    ...
    typedef TSharedPtr<FAddCapacityByStampSheetRequest, ESPMode::ThreadSafe> FAddCapacityByStampSheetRequestPtr;
}