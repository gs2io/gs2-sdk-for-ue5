...
namespace Gs2::Inventory::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeSimpleItemModelMastersRequest> WithNamePrefix(const TOptional<FString> NamePrefix);
    ...
    typedef TSharedPtr<FDescribeSimpleItemModelMastersRequest> FDescribeSimpleItemModelMastersRequestPtr;
}