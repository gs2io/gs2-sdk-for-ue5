...
#include "Inventory/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Inventory::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inventory"), TEXT("currentItemModelMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
