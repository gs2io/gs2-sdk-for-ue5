...
#include "Inventory/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::Inventory::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inventory"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
