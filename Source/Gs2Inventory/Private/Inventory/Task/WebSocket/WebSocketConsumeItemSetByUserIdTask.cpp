...
#include "Inventory/Task/WebSocket/ConsumeItemSetByUserIdTask.h"
...
namespace Gs2::Inventory::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("inventory"), TEXT("itemSet"), TEXT("consumeItemSetByUserId"), ToCStr(RequestPayload->Payload()));
