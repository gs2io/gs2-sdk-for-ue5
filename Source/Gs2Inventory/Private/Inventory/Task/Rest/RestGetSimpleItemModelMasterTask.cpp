...
#include "Inventory/Task/Rest/GetSimpleItemModelMasterTask.h"
...
{
    FGetSimpleItemModelMasterTask::FGetSimpleItemModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSimpleItemModelMasterTask::Action(
        const TSharedPtr<Result::FGetSimpleItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
