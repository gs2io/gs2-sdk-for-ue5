...
#include "Inventory/Task/Rest/GetSimpleInventoryModelTask.h"
...
{
    FGetSimpleInventoryModelTask::FGetSimpleInventoryModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSimpleInventoryModelTask::Action(
        const TSharedPtr<Result::FGetSimpleInventoryModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/simple/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleInventoryModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
