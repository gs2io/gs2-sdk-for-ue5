...
#include "Inventory/Task/Rest/VerifyBigItemByUserIdTask.h"
...
{
    FVerifyBigItemByUserIdTask::FVerifyBigItemByUserIdTask(
    ...
    FVerifyBigItemByUserIdTask::FVerifyBigItemByUserIdTask(
        const FVerifyBigItemByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifyBigItemByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyBigItemByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/big/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyBigItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
