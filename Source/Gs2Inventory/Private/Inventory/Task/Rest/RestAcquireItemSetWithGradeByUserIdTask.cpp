...
#include "Inventory/Task/Rest/AcquireItemSetWithGradeByUserIdTask.h"
...
{
    FAcquireItemSetWithGradeByUserIdTask::FAcquireItemSetWithGradeByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAcquireItemSetWithGradeByUserIdTask::Action(
        const TSharedPtr<Result::FAcquireItemSetWithGradeByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/acquire/grade");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcquireItemSetWithGradeByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
    ...
    void FAcquireItemSetWithGradeByUserIdTask::OnError(Core::Model::FGs2ErrorPtr Error)
    {
        if (Error->Count() > 0 && Error->Detail(0)->Code() == "itemSet.operation.conflict") {
            TGs2Future<Result::FAcquireItemSetWithGradeByUserIdResult>::OnError(MakeShared<Inventory::Error::FConflictError>(Error));
        }
        else {
            TGs2Future<Result::FAcquireItemSetWithGradeByUserIdResult>::OnError(Error);
        }
    }
}