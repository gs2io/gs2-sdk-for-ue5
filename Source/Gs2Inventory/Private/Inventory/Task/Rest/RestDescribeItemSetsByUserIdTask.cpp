...
#include "Inventory/Task/Rest/DescribeItemSetsByUserIdTask.h"
...
{
    FDescribeItemSetsByUserIdTask::FDescribeItemSetsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeItemSetsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeItemSetsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeItemSetsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
