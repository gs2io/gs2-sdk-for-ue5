...
#include "Inventory/Task/Rest/VerifyReferenceOfTask.h"
...
{
    FVerifyReferenceOfTask::FVerifyReferenceOfTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyReferenceOfTask::Action(
        const TSharedPtr<Result::FVerifyReferenceOfResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item/{itemName}/{itemSetName}/reference/{referenceOf}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyReferenceOfResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
