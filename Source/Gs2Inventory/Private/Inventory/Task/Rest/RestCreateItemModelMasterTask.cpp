...
#include "Inventory/Task/Rest/CreateItemModelMasterTask.h"
...
{
    FCreateItemModelMasterTask::FCreateItemModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateItemModelMasterTask::Action(
        const TSharedPtr<Result::FCreateItemModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
