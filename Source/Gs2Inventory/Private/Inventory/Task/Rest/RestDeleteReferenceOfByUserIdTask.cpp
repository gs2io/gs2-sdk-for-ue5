...
#include "Inventory/Task/Rest/DeleteReferenceOfByUserIdTask.h"
...
{
    FDeleteReferenceOfByUserIdTask::FDeleteReferenceOfByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteReferenceOfByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteReferenceOfByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/{itemSetName}/reference/{referenceOf}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteReferenceOfByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
