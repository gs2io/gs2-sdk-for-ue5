...
#include "Inventory/Task/Rest/CreateSimpleItemModelMasterTask.h"
...
{
    FCreateSimpleItemModelMasterTask::FCreateSimpleItemModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateSimpleItemModelMasterTask::Action(
        const TSharedPtr<Result::FCreateSimpleItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateSimpleItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
