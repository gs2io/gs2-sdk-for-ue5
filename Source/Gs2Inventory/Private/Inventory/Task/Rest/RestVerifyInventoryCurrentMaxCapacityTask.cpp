...
#include "Inventory/Task/Rest/VerifyInventoryCurrentMaxCapacityTask.h"
...
{
    FVerifyInventoryCurrentMaxCapacityTask::FVerifyInventoryCurrentMaxCapacityTask(
    ...
    FVerifyInventoryCurrentMaxCapacityTask::FVerifyInventoryCurrentMaxCapacityTask(
        const FVerifyInventoryCurrentMaxCapacityTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifyInventoryCurrentMaxCapacityTask::Action(
        const TSharedPtr<Result::FVerifyInventoryCurrentMaxCapacityResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyInventoryCurrentMaxCapacityResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
