...
#include "Inventory/Task/Rest/DeleteSimpleItemModelMasterTask.h"
...
{
    FDeleteSimpleItemModelMasterTask::FDeleteSimpleItemModelMasterTask(
    ...
    FDeleteSimpleItemModelMasterTask::FDeleteSimpleItemModelMasterTask(
        const FDeleteSimpleItemModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteSimpleItemModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteSimpleItemModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/simple/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteSimpleItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
