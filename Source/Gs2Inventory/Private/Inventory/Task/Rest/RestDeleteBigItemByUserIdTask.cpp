...
#include "Inventory/Task/Rest/DeleteBigItemByUserIdTask.h"
...
{
    FDeleteBigItemByUserIdTask::FDeleteBigItemByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteBigItemByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteBigItemByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteBigItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
