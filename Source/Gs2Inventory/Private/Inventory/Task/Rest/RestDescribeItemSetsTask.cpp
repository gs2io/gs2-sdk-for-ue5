...
#include "Inventory/Task/Rest/DescribeItemSetsTask.h"
...
{
    FDescribeItemSetsTask::FDescribeItemSetsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeItemSetsTask::Action(
        const TSharedPtr<Result::FDescribeItemSetsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeItemSetsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
