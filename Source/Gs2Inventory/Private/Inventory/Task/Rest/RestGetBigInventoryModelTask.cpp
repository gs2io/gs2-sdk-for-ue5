...
#include "Inventory/Task/Rest/GetBigInventoryModelTask.h"
...
{
    FGetBigInventoryModelTask::FGetBigInventoryModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetBigInventoryModelTask::Action(
        const TSharedPtr<Result::FGetBigInventoryModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/big/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigInventoryModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
