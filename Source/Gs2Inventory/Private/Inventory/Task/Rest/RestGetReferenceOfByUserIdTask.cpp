...
#include "Inventory/Task/Rest/GetReferenceOfByUserIdTask.h"
...
{
    FGetReferenceOfByUserIdTask::FGetReferenceOfByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetReferenceOfByUserIdTask::Action(
        const TSharedPtr<Result::FGetReferenceOfByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetReferenceOfByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
