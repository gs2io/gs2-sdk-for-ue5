...
#include "Inventory/Task/Rest/AddCapacityByUserIdTask.h"
...
{
    FAddCapacityByUserIdTask::FAddCapacityByUserIdTask(
    ...
    FAddCapacityByUserIdTask::FAddCapacityByUserIdTask(
        const FAddCapacityByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FAddCapacityByUserIdTask::Action(
        const TSharedPtr<Result::FAddCapacityByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/capacity");
            ...
            if (this->Request->GetAddCapacityValue().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("addCapacityValue"), this->Request->GetAddCapacityValue().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddCapacityByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
