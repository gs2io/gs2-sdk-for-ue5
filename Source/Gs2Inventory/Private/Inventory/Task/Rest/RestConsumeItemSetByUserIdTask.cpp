...
#include "Inventory/Task/Rest/ConsumeItemSetByUserIdTask.h"
...
{
    FConsumeItemSetByUserIdTask::FConsumeItemSetByUserIdTask(
    ...
    FConsumeItemSetByUserIdTask::FConsumeItemSetByUserIdTask(
        const FConsumeItemSetByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FConsumeItemSetByUserIdTask::Action(
        const TSharedPtr<Result::FConsumeItemSetByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/consume");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FConsumeItemSetByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
