...
#include "Inventory/Task/Rest/DescribeItemModelMastersTask.h"
...
{
    FDescribeItemModelMastersTask::FDescribeItemModelMastersTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeItemModelMastersTask::Action(
        const TSharedPtr<Result::FDescribeItemModelMastersResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeItemModelMastersResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
