...
#include "Inventory/Task/Rest/DescribeBigItemModelMastersTask.h"
...
{
    FDescribeBigItemModelMastersTask::FDescribeBigItemModelMastersTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBigItemModelMastersTask::Action(
        const TSharedPtr<Result::FDescribeBigItemModelMastersResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/big/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBigItemModelMastersResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
