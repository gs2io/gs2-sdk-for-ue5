...
#include "Inventory/Task/Rest/DeleteSimpleItemsByUserIdTask.h"
...
{
    FDeleteSimpleItemsByUserIdTask::FDeleteSimpleItemsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteSimpleItemsByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteSimpleItemsByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteSimpleItemsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
