...
#include "Inventory/Task/Rest/DescribeSimpleItemsByUserIdTask.h"
...
{
    FDescribeSimpleItemsByUserIdTask::FDescribeSimpleItemsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSimpleItemsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeSimpleItemsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/simple/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSimpleItemsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
