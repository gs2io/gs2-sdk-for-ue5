...
#include "Inventory/Task/Rest/GetSimpleInventoryModelMasterTask.h"
...
{
    FGetSimpleInventoryModelMasterTask::FGetSimpleInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSimpleInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FGetSimpleInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
