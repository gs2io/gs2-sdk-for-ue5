...
#include "Inventory/Task/Rest/DeleteBigInventoryModelMasterTask.h"
...
{
    FDeleteBigInventoryModelMasterTask::FDeleteBigInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteBigInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteBigInventoryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/big/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteBigInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
