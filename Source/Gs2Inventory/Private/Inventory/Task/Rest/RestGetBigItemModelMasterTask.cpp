...
#include "Inventory/Task/Rest/GetBigItemModelMasterTask.h"
...
{
    FGetBigItemModelMasterTask::FGetBigItemModelMasterTask(
    ...
    FGetBigItemModelMasterTask::FGetBigItemModelMasterTask(
        const FGetBigItemModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetBigItemModelMasterTask::Action(
        const TSharedPtr<Result::FGetBigItemModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/big/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
