...
#include "Inventory/Task/Rest/DeleteInventoryByUserIdTask.h"
...
{
    FDeleteInventoryByUserIdTask::FDeleteInventoryByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteInventoryByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteInventoryByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteInventoryByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
