...
#include "Inventory/Task/Rest/DescribeBigItemsTask.h"
...
{
    FDescribeBigItemsTask::FDescribeBigItemsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBigItemsTask::Action(
        const TSharedPtr<Result::FDescribeBigItemsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/big/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBigItemsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
