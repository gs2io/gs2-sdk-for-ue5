...
#include "Inventory/Task/Rest/VerifyBigItemTask.h"
...
{
    FVerifyBigItemTask::FVerifyBigItemTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyBigItemTask::Action(
        const TSharedPtr<Result::FVerifyBigItemResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/big/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyBigItemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
