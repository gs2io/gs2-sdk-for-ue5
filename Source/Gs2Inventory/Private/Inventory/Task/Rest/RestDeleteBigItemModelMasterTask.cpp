...
#include "Inventory/Task/Rest/DeleteBigItemModelMasterTask.h"
...
{
    FDeleteBigItemModelMasterTask::FDeleteBigItemModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteBigItemModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteBigItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteBigItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
