...
#include "Inventory/Task/Rest/DeleteInventoryModelMasterTask.h"
...
{
    FDeleteInventoryModelMasterTask::FDeleteInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
