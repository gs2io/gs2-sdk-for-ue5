...
#include "Inventory/Task/Rest/GetBigItemModelTask.h"
...
{
    FGetBigItemModelTask::FGetBigItemModelTask(
    ...
    FGetBigItemModelTask::FGetBigItemModelTask(
        const FGetBigItemModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetBigItemModelTask::Action(
        const TSharedPtr<Result::FGetBigItemModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/big/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigItemModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
