...
#include "Inventory/Task/Rest/GetItemModelMasterTask.h"
...
{
    FGetItemModelMasterTask::FGetItemModelMasterTask(
    ...
    FGetItemModelMasterTask::FGetItemModelMasterTask(
        const FGetItemModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetItemModelMasterTask::Action(
        const TSharedPtr<Result::FGetItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
