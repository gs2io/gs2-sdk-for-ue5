...
#include "Inventory/Task/Rest/VerifySimpleItemByUserIdTask.h"
...
{
    FVerifySimpleItemByUserIdTask::FVerifySimpleItemByUserIdTask(
    ...
    FVerifySimpleItemByUserIdTask::FVerifySimpleItemByUserIdTask(
        const FVerifySimpleItemByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifySimpleItemByUserIdTask::Action(
        const TSharedPtr<Result::FVerifySimpleItemByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/simple/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("count"), FString::Printf(TEXT("%lld"), this->Request->GetCount().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifySimpleItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
