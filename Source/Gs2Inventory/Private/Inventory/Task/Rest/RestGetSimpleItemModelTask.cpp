...
#include "Inventory/Task/Rest/GetSimpleItemModelTask.h"
...
{
    FGetSimpleItemModelTask::FGetSimpleItemModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSimpleItemModelTask::Action(
        const TSharedPtr<Result::FGetSimpleItemModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/simple/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleItemModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
