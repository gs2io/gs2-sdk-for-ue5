...
#include "Inventory/Task/Rest/DescribeSimpleItemsTask.h"
...
{
    FDescribeSimpleItemsTask::FDescribeSimpleItemsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSimpleItemsTask::Action(
        const TSharedPtr<Result::FDescribeSimpleItemsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/simple/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSimpleItemsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
