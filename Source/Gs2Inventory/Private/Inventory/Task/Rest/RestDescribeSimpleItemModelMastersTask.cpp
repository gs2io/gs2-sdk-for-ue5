...
#include "Inventory/Task/Rest/DescribeSimpleItemModelMastersTask.h"
...
{
    FDescribeSimpleItemModelMastersTask::FDescribeSimpleItemModelMastersTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSimpleItemModelMastersTask::Action(
        const TSharedPtr<Result::FDescribeSimpleItemModelMastersResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/simple/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSimpleItemModelMastersResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
