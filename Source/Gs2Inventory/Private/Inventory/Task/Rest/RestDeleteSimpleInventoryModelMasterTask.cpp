...
#include "Inventory/Task/Rest/DeleteSimpleInventoryModelMasterTask.h"
...
{
    FDeleteSimpleInventoryModelMasterTask::FDeleteSimpleInventoryModelMasterTask(
    ...
    FDeleteSimpleInventoryModelMasterTask::FDeleteSimpleInventoryModelMasterTask(
        const FDeleteSimpleInventoryModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteSimpleInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteSimpleInventoryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/simple/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteSimpleInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
