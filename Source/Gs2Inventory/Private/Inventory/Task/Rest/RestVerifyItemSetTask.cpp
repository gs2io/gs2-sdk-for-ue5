...
#include "Inventory/Task/Rest/VerifyItemSetTask.h"
...
{
    FVerifyItemSetTask::FVerifyItemSetTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyItemSetTask::Action(
        const TSharedPtr<Result::FVerifyItemSetResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyItemSetResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
