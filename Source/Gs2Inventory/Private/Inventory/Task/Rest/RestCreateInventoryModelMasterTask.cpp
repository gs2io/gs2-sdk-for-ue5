...
#include "Inventory/Task/Rest/CreateInventoryModelMasterTask.h"
...
{
    FCreateInventoryModelMasterTask::FCreateInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FCreateInventoryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/inventory");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
