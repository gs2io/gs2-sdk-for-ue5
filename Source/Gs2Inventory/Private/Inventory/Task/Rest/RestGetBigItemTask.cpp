...
#include "Inventory/Task/Rest/GetBigItemTask.h"
...
{
    FGetBigItemTask::FGetBigItemTask(
    ...
    FGetBigItemTask::FGetBigItemTask(
        const FGetBigItemTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetBigItemTask::Action(
        const TSharedPtr<Result::FGetBigItemResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/big/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigItemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
