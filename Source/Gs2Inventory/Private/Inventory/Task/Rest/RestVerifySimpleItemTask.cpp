...
#include "Inventory/Task/Rest/VerifySimpleItemTask.h"
...
{
    FVerifySimpleItemTask::FVerifySimpleItemTask(
    ...
    FVerifySimpleItemTask::FVerifySimpleItemTask(
        const FVerifySimpleItemTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifySimpleItemTask::Action(
        const TSharedPtr<Result::FVerifySimpleItemResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/simple/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifySimpleItemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
