...
#include "Inventory/Task/Rest/GetBigItemByUserIdTask.h"
...
{
    FGetBigItemByUserIdTask::FGetBigItemByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetBigItemByUserIdTask::Action(
        const TSharedPtr<Result::FGetBigItemByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
