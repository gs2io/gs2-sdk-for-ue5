...
#include "Inventory/Task/Rest/GetItemSetByUserIdTask.h"
...
{
    FGetItemSetByUserIdTask::FGetItemSetByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetItemSetByUserIdTask::Action(
        const TSharedPtr<Result::FGetItemSetByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetItemSetByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
