...
#include "Inventory/Task/Rest/GetItemSetTask.h"
...
{
    FGetItemSetTask::FGetItemSetTask(
    ...
    Core::Model::FGs2ErrorPtr FGetItemSetTask::Action(
        const TSharedPtr<Result::FGetItemSetResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetItemSetResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
