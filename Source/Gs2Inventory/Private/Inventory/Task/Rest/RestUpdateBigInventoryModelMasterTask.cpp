...
#include "Inventory/Task/Rest/UpdateBigInventoryModelMasterTask.h"
...
{
    FUpdateBigInventoryModelMasterTask::FUpdateBigInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateBigInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateBigInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateBigInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
