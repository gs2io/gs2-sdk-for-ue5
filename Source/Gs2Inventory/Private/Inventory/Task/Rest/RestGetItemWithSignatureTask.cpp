...
#include "Inventory/Task/Rest/GetItemWithSignatureTask.h"
...
{
    FGetItemWithSignatureTask::FGetItemWithSignatureTask(
    ...
    Core::Model::FGs2ErrorPtr FGetItemWithSignatureTask::Action(
        const TSharedPtr<Result::FGetItemWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item/{itemName}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetItemWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
