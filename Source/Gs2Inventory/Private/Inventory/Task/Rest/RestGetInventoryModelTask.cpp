...
#include "Inventory/Task/Rest/GetInventoryModelTask.h"
...
{
    FGetInventoryModelTask::FGetInventoryModelTask(
    ...
    FGetInventoryModelTask::FGetInventoryModelTask(
        const FGetInventoryModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetInventoryModelTask::Action(
        const TSharedPtr<Result::FGetInventoryModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/inventory/{inventoryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetInventoryModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
