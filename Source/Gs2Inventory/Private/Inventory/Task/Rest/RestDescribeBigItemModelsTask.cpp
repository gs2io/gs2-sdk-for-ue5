...
#include "Inventory/Task/Rest/DescribeBigItemModelsTask.h"
...
{
    FDescribeBigItemModelsTask::FDescribeBigItemModelsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBigItemModelsTask::Action(
        const TSharedPtr<Result::FDescribeBigItemModelsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/big/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBigItemModelsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
