...
#include "Inventory/Task/Rest/DescribeSimpleItemModelsTask.h"
...
{
    FDescribeSimpleItemModelsTask::FDescribeSimpleItemModelsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSimpleItemModelsTask::Action(
        const TSharedPtr<Result::FDescribeSimpleItemModelsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/simple/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSimpleItemModelsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
