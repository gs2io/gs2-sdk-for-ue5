...
#include "Inventory/Task/Rest/GetItemWithSignatureByUserIdTask.h"
...
{
    FGetItemWithSignatureByUserIdTask::FGetItemWithSignatureByUserIdTask(
    ...
    FGetItemWithSignatureByUserIdTask::FGetItemWithSignatureByUserIdTask(
        const FGetItemWithSignatureByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetItemWithSignatureByUserIdTask::Action(
        const TSharedPtr<Result::FGetItemWithSignatureByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/signature");
            ...
            if (this->Request->GetItemSetName().IsSet()) {
                queryStrings.Add("itemSetName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetItemSetName().GetValue()));
            }
            if (this->Request->GetKeyId().IsSet()) {
                queryStrings.Add("keyId=" + FGenericPlatformHttp::UrlEncode(this->Request->GetKeyId().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetItemWithSignatureByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
