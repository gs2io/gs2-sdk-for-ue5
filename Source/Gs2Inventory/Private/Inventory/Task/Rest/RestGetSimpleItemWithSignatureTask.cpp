...
#include "Inventory/Task/Rest/GetSimpleItemWithSignatureTask.h"
...
{
    FGetSimpleItemWithSignatureTask::FGetSimpleItemWithSignatureTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSimpleItemWithSignatureTask::Action(
        const TSharedPtr<Result::FGetSimpleItemWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/simple/inventory/{inventoryName}/item/{itemName}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleItemWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
