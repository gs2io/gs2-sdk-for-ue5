...
#include "Inventory/Task/Rest/CreateBigItemModelMasterTask.h"
...
{
    FCreateBigItemModelMasterTask::FCreateBigItemModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateBigItemModelMasterTask::Action(
        const TSharedPtr<Result::FCreateBigItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateBigItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
