...
#include "Inventory/Task/Rest/DescribeBigItemsByUserIdTask.h"
...
{
    FDescribeBigItemsByUserIdTask::FDescribeBigItemsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeBigItemsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeBigItemsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/big/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeBigItemsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
