...
#include "Inventory/Task/Rest/GetBigInventoryModelMasterTask.h"
...
{
    FGetBigInventoryModelMasterTask::FGetBigInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetBigInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FGetBigInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBigInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
