...
#include "Inventory/Task/Rest/GetInventoryByUserIdTask.h"
...
{
    FGetInventoryByUserIdTask::FGetInventoryByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetInventoryByUserIdTask::Action(
        const TSharedPtr<Result::FGetInventoryByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetInventoryByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
