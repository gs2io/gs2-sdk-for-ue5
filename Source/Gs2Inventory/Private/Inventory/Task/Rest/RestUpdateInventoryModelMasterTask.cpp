...
#include "Inventory/Task/Rest/UpdateInventoryModelMasterTask.h"
...
{
    FUpdateInventoryModelMasterTask::FUpdateInventoryModelMasterTask(
    ...
    FUpdateInventoryModelMasterTask::FUpdateInventoryModelMasterTask(
        const FUpdateInventoryModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateInventoryModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/inventory/{inventoryName}");
            ...
            if (this->Request->GetProtectReferencedItem().IsSet())
            {
                JsonRootObject->SetBoolField(TEXT("protectReferencedItem"), this->Request->GetProtectReferencedItem().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
