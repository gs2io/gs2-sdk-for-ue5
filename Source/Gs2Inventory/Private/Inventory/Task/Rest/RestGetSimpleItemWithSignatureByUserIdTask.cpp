...
#include "Inventory/Task/Rest/GetSimpleItemWithSignatureByUserIdTask.h"
...
{
    FGetSimpleItemWithSignatureByUserIdTask::FGetSimpleItemWithSignatureByUserIdTask(
    ...
    FGetSimpleItemWithSignatureByUserIdTask::FGetSimpleItemWithSignatureByUserIdTask(
        const FGetSimpleItemWithSignatureByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetSimpleItemWithSignatureByUserIdTask::Action(
        const TSharedPtr<Result::FGetSimpleItemWithSignatureByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/simple/inventory/{inventoryName}/item/{itemName}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleItemWithSignatureByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
