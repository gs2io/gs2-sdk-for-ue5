...
#include "Inventory/Task/Rest/AddReferenceOfByUserIdTask.h"
...
{
    FAddReferenceOfByUserIdTask::FAddReferenceOfByUserIdTask(
    ...
    FAddReferenceOfByUserIdTask::FAddReferenceOfByUserIdTask(
        const FAddReferenceOfByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FAddReferenceOfByUserIdTask::Action(
        const TSharedPtr<Result::FAddReferenceOfByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/{itemSetName}/reference");
            ...
            {
                JsonRootObject->SetStringField(TEXT("referenceOf"), this->Request->GetReferenceOf().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddReferenceOfByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
