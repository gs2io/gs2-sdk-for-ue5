...
#include "Inventory/Task/Rest/UpdateSimpleInventoryModelMasterTask.h"
...
{
    FUpdateSimpleInventoryModelMasterTask::FUpdateSimpleInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateSimpleInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateSimpleInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateSimpleInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
