...
#include "Inventory/Task/Rest/GetSimpleItemByUserIdTask.h"
...
{
    FGetSimpleItemByUserIdTask::FGetSimpleItemByUserIdTask(
    ...
    FGetSimpleItemByUserIdTask::FGetSimpleItemByUserIdTask(
        const FGetSimpleItemByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetSimpleItemByUserIdTask::Action(
        const TSharedPtr<Result::FGetSimpleItemByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/simple/inventory/{inventoryName}/item/{itemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSimpleItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
