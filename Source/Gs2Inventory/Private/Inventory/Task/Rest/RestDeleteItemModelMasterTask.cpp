...
#include "Inventory/Task/Rest/DeleteItemModelMasterTask.h"
...
{
    FDeleteItemModelMasterTask::FDeleteItemModelMasterTask(
    ...
    FDeleteItemModelMasterTask::FDeleteItemModelMasterTask(
        const FDeleteItemModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteItemModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
