...
#include "Inventory/Task/Rest/UpdateCurrentItemModelMasterTask.h"
...
namespace Gs2::Inventory::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetStringField(TEXT("settings"), this->Request->GetSettings().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateCurrentItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
