...
#include "Inventory/Task/Rest/GetInventoryModelMasterTask.h"
...
{
    FGetInventoryModelMasterTask::FGetInventoryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetInventoryModelMasterTask::Action(
        const TSharedPtr<Result::FGetInventoryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetInventoryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
