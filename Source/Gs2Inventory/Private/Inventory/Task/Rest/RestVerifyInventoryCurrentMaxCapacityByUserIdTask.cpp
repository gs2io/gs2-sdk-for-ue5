...
#include "Inventory/Task/Rest/VerifyInventoryCurrentMaxCapacityByUserIdTask.h"
...
{
    FVerifyInventoryCurrentMaxCapacityByUserIdTask::FVerifyInventoryCurrentMaxCapacityByUserIdTask(
    ...
    FVerifyInventoryCurrentMaxCapacityByUserIdTask::FVerifyInventoryCurrentMaxCapacityByUserIdTask(
        const FVerifyInventoryCurrentMaxCapacityByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifyInventoryCurrentMaxCapacityByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyInventoryCurrentMaxCapacityByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/verify/{verifyType}");
            ...
            if (this->Request->GetCurrentInventoryMaxCapacity().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("currentInventoryMaxCapacity"), this->Request->GetCurrentInventoryMaxCapacity().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyInventoryCurrentMaxCapacityByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
