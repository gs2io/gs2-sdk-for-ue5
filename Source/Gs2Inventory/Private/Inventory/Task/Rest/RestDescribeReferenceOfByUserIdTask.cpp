...
#include "Inventory/Task/Rest/DescribeReferenceOfByUserIdTask.h"
...
{
    FDescribeReferenceOfByUserIdTask::FDescribeReferenceOfByUserIdTask(
    ...
    FDescribeReferenceOfByUserIdTask::FDescribeReferenceOfByUserIdTask(
        const FDescribeReferenceOfByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDescribeReferenceOfByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeReferenceOfByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeReferenceOfByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
