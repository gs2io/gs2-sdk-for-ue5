...
#include "Inventory/Task/Rest/VerifyItemSetByUserIdTask.h"
...
{
    FVerifyItemSetByUserIdTask::FVerifyItemSetByUserIdTask(
    ...
    FVerifyItemSetByUserIdTask::FVerifyItemSetByUserIdTask(
        const FVerifyItemSetByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FVerifyItemSetByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyItemSetByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyItemSetByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
