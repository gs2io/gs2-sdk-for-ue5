...
#include "Inventory/Task/Rest/DescribeItemModelsTask.h"
...
{
    FDescribeItemModelsTask::FDescribeItemModelsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeItemModelsTask::Action(
        const TSharedPtr<Result::FDescribeItemModelsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/inventory/{inventoryName}/item");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeItemModelsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
