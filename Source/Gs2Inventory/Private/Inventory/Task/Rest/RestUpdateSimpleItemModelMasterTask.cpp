...
#include "Inventory/Task/Rest/UpdateSimpleItemModelMasterTask.h"
...
{
    FUpdateSimpleItemModelMasterTask::FUpdateSimpleItemModelMasterTask(
    ...
    FUpdateSimpleItemModelMasterTask::FUpdateSimpleItemModelMasterTask(
        const FUpdateSimpleItemModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateSimpleItemModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateSimpleItemModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateSimpleItemModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
