...
#include "Inventory/Task/Rest/AddReferenceOfTask.h"
...
{
    FAddReferenceOfTask::FAddReferenceOfTask(
    ...
    Core::Model::FGs2ErrorPtr FAddReferenceOfTask::Action(
        const TSharedPtr<Result::FAddReferenceOfResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/inventory/{inventoryName}/item/{itemName}/{itemSetName}/reference");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddReferenceOfResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
