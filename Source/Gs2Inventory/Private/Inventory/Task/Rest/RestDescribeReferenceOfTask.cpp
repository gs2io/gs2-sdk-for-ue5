...
#include "Inventory/Task/Rest/DescribeReferenceOfTask.h"
...
{
    FDescribeReferenceOfTask::FDescribeReferenceOfTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeReferenceOfTask::Action(
        const TSharedPtr<Result::FDescribeReferenceOfResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeReferenceOfResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
