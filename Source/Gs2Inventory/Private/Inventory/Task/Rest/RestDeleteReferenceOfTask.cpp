...
#include "Inventory/Task/Rest/DeleteReferenceOfTask.h"
...
{
    FDeleteReferenceOfTask::FDeleteReferenceOfTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteReferenceOfTask::Action(
        const TSharedPtr<Result::FDeleteReferenceOfResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteReferenceOfResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
