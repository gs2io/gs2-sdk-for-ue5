...
#include "Inventory/Task/Rest/AcquireItemSetByUserIdTask.h"
...
{
    FAcquireItemSetByUserIdTask::FAcquireItemSetByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAcquireItemSetByUserIdTask::Action(
        const TSharedPtr<Result::FAcquireItemSetByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inventory/{inventoryName}/item/{itemName}/acquire");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcquireItemSetByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
