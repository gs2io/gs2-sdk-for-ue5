...
#include "Inventory/Result/GetSimpleItemResult.h"

namespace Gs2::Inventory::Result
{
    FGetSimpleItemResult::FGetSimpleItemResult():
        ItemValue(nullptr),
    ...
    FGetSimpleItemResult::FGetSimpleItemResult(
        const FGetSimpleItemResult& From
    ):
    ...
    TSharedPtr<FGetSimpleItemResult> FGetSimpleItemResult::WithItem(
    ...
    TSharedPtr<FGetSimpleItemResult> FGetSimpleItemResult::WithItemModel(
    ...
    TSharedPtr<Model::FSimpleItem> FGetSimpleItemResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FSimpleItemModel> FGetSimpleItemResult::GetItemModel() const
    {
    ...
    TSharedPtr<FGetSimpleItemResult> FGetSimpleItemResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
    ...
    TSharedPtr<FJsonObject> FGetSimpleItemResult::ToJson() const
    {
