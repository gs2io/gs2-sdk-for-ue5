...
#include "Inventory/Result/GetReferenceOfResult.h"

namespace Gs2::Inventory::Result
{
    FGetReferenceOfResult::FGetReferenceOfResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FGetReferenceOfResult> FGetReferenceOfResult::WithItem(
    ...
    TSharedPtr<FGetReferenceOfResult> FGetReferenceOfResult::WithItemSet(
    ...
    TSharedPtr<FGetReferenceOfResult> FGetReferenceOfResult::WithItemModel(
    ...
    TSharedPtr<FGetReferenceOfResult> FGetReferenceOfResult::WithInventory(
    ...
    TSharedPtr<TArray<FString>> FGetReferenceOfResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FItemSet> FGetReferenceOfResult::GetItemSet() const
    {
    ...
    TSharedPtr<Model::FItemModel> FGetReferenceOfResult::GetItemModel() const
    {
    ...
    TSharedPtr<Model::FInventory> FGetReferenceOfResult::GetInventory() const
    {
    ...
    TSharedPtr<FGetReferenceOfResult> FGetReferenceOfResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FGetReferenceOfResult>()
    ...
    TSharedPtr<FJsonObject> FGetReferenceOfResult::ToJson() const
    {
