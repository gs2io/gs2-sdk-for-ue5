...
{
    FGetItemSetByUserIdResult::FGetItemSetByUserIdResult():
        ItemsValue(nullptr),
    ...
    TSharedPtr<FGetItemSetByUserIdResult> FGetItemSetByUserIdResult::WithItems(
    ...
    TSharedPtr<FGetItemSetByUserIdResult> FGetItemSetByUserIdResult::WithItemModel(
    ...
    TSharedPtr<FGetItemSetByUserIdResult> FGetItemSetByUserIdResult::WithInventory(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FItemSet>>> FGetItemSetByUserIdResult::GetItems() const
    {
    ...
    TSharedPtr<Model::FItemModel> FGetItemSetByUserIdResult::GetItemModel() const
    {
    ...
    TSharedPtr<Model::FInventory> FGetItemSetByUserIdResult::GetInventory() const
    {
    ...
    TSharedPtr<FGetItemSetByUserIdResult> FGetItemSetByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FGetItemSetByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FGetItemSetByUserIdResult::ToJson() const
    {
