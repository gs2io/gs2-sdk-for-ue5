...
{
    FDeleteItemSetByUserIdResult::FDeleteItemSetByUserIdResult():
        ItemsValue(nullptr),
    ...
    FDeleteItemSetByUserIdResult::FDeleteItemSetByUserIdResult(
        const FDeleteItemSetByUserIdResult& From
    ):
    ...
    TSharedPtr<FDeleteItemSetByUserIdResult> FDeleteItemSetByUserIdResult::WithItems(
    ...
    TSharedPtr<FDeleteItemSetByUserIdResult> FDeleteItemSetByUserIdResult::WithItemModel(
    ...
    TSharedPtr<FDeleteItemSetByUserIdResult> FDeleteItemSetByUserIdResult::WithInventory(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FItemSet>>> FDeleteItemSetByUserIdResult::GetItems() const
    {
    ...
    TSharedPtr<Model::FItemModel> FDeleteItemSetByUserIdResult::GetItemModel() const
    {
    ...
    TSharedPtr<Model::FInventory> FDeleteItemSetByUserIdResult::GetInventory() const
    {
    ...
    TSharedPtr<FDeleteItemSetByUserIdResult> FDeleteItemSetByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDeleteItemSetByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FDeleteItemSetByUserIdResult::ToJson() const
    {
