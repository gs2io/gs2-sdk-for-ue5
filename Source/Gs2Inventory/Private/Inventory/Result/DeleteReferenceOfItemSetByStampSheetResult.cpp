...
{
    FDeleteReferenceOfItemSetByStampSheetResult::FDeleteReferenceOfItemSetByStampSheetResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FDeleteReferenceOfItemSetByStampSheetResult> FDeleteReferenceOfItemSetByStampSheetResult::WithItem(
    ...
    TSharedPtr<FDeleteReferenceOfItemSetByStampSheetResult> FDeleteReferenceOfItemSetByStampSheetResult::WithItemSet(
    ...
    TSharedPtr<FDeleteReferenceOfItemSetByStampSheetResult> FDeleteReferenceOfItemSetByStampSheetResult::WithItemModel(
    ...
    TSharedPtr<FDeleteReferenceOfItemSetByStampSheetResult> FDeleteReferenceOfItemSetByStampSheetResult::WithInventory(
    ...
    TSharedPtr<TArray<FString>> FDeleteReferenceOfItemSetByStampSheetResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FItemSet> FDeleteReferenceOfItemSetByStampSheetResult::GetItemSet() const
    {
    ...
    TSharedPtr<Model::FItemModel> FDeleteReferenceOfItemSetByStampSheetResult::GetItemModel() const
    {
    ...
    TSharedPtr<Model::FInventory> FDeleteReferenceOfItemSetByStampSheetResult::GetInventory() const
    {
    ...
    TSharedPtr<FDeleteReferenceOfItemSetByStampSheetResult> FDeleteReferenceOfItemSetByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDeleteReferenceOfItemSetByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FDeleteReferenceOfItemSetByStampSheetResult::ToJson() const
    {
