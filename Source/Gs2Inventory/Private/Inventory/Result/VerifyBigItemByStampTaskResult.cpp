...
namespace Gs2::Inventory::Result
{
    ...
    TSharedPtr<FVerifyBigItemByStampTaskResult> FVerifyBigItemByStampTaskResult::WithItem(
    ...
    TSharedPtr<Model::FBigItem> FVerifyBigItemByStampTaskResult::GetItem() const
    {
