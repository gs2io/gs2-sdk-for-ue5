...
#include "Inventory/Result/ConsumeItemSetResult.h"

namespace Gs2::Inventory::Result
{
    FConsumeItemSetResult::FConsumeItemSetResult():
        ItemsValue(nullptr),
    ...
    TSharedPtr<FConsumeItemSetResult> FConsumeItemSetResult::WithItems(
    ...
    TSharedPtr<FConsumeItemSetResult> FConsumeItemSetResult::WithItemModel(
    ...
    TSharedPtr<FConsumeItemSetResult> FConsumeItemSetResult::WithInventory(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FItemSet>>> FConsumeItemSetResult::GetItems() const
    {
    ...
    TSharedPtr<Model::FItemModel> FConsumeItemSetResult::GetItemModel() const
    {
    ...
    TSharedPtr<Model::FInventory> FConsumeItemSetResult::GetInventory() const
    {
    ...
    TSharedPtr<FConsumeItemSetResult> FConsumeItemSetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FConsumeItemSetResult>()
    ...
    TSharedPtr<FJsonObject> FConsumeItemSetResult::ToJson() const
    {
