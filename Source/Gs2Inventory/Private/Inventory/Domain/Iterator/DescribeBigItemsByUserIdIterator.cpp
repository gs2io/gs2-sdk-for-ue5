...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    FDescribeBigItemsByUserIdIterator::FIterator::FIterator(
    ...
    FDescribeBigItemsByUserIdIterator::FIterator& FDescribeBigItemsByUserIdIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Inventory::Model::Cache::FBigItemCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->UserId,
                Self->InventoryName,
                TOptional<int32>()
            ...
            const auto Request =
                MakeShared<Gs2::Inventory::Request::FDescribeBigItemsByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeBigItemsByUserId(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Inventory::Model::FBigItemPtr>>();
    ...
    FDescribeBigItemsByUserIdIterator::FIterator FDescribeBigItemsByUserIdIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeBigItemsByUserIdIterator::FIterator FDescribeBigItemsByUserIdIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeBigItemsByUserIdIterator::FIterator FDescribeBigItemsByUserIdIterator::end()
    {
