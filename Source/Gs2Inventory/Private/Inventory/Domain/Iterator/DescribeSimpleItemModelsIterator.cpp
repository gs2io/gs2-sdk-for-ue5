...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    FDescribeSimpleItemModelsIterator::FIterator& FDescribeSimpleItemModelsIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Inventory::Model::Cache::FSimpleItemModelCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->InventoryName,
                TOptional<int32>()
            );
            ...
            ;
            const auto Future = Self->Client->DescribeSimpleItemModels(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Inventory::Model::FSimpleItemModelPtr>>();
