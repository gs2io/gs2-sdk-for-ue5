...
namespace Gs2::Inventory::Domain::Iterator
{
    ...
    FDescribeSimpleItemsByUserIdIterator::FIterator& FDescribeSimpleItemsByUserIdIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Inventory::Model::Cache::FSimpleItemCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->UserId,
                Self->InventoryName,
                TOptional<int32>()
            ...
            const auto Request =
                MakeShared<Gs2::Inventory::Request::FDescribeSimpleItemsByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeSimpleItemsByUserId(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Inventory::Model::FSimpleItemPtr>>();
