...
namespace Gs2::Inventory::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete(Gs2::Inventory::Model::FSimpleInventoryModelMaster::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::Inventory::Model::FSimpleInventoryModelMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::Inventory::Model::FSimpleInventoryModelMaster>(
                Self->ParentKey,
                Gs2::Inventory::Domain::Model::FSimpleInventoryModelMasterDomain::CreateCacheKey(
                    Self->InventoryName
                ),
