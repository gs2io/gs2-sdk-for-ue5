...
namespace Gs2::Inventory::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::Inventory::Model::Cache::FItemModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            Self->InventoryName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Inventory::Model::Cache::FItemModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Inventory::Model::FItemModelPtr Value;
                const auto CacheHit = Gs2::Inventory::Model::Cache::FItemModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Inventory::Model::Cache::FItemModelCache::Fetch(
                    Self->Gs2->Cache,
                    ...
                    Self->ItemName,
                    TOptional<int32>(),
                    [Self](Gs2::Inventory::Model::FItemModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FItemModelDomain::Invalidate()
    {
    ...
    FItemModelDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FItemModelDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FItemModelDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FItemModelDomain::FSubscribeWithInitialCallTask>> FItemModelDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Inventory::Model::FItemModelPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Inventory::Model::Cache::FItemModelCache::CreateCacheParentKey(

            NamespaceName,
            InventoryName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Inventory::Model::Cache::FItemModelCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryInventoryName, QueryItemName]()
            {
                ...
                const auto Domain = MakeShared<FItemModelDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryInventoryName,
