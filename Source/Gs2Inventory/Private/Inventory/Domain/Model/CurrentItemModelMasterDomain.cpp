...
namespace Gs2::Inventory::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Inventory::Model::FCurrentItemModelMaster>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Inventory::Model::FCurrentItemModelMaster>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Inventory::Model::FCurrentItemModelMaster>(
                            Self->ParentKey,
                            Gs2::Inventory::Domain::Model::FCurrentItemModelMasterDomain::CreateCacheKey(
                            )
                        );
            ...
            Value = Self->Cache->Get<Gs2::Inventory::Model::FCurrentItemModelMaster>(
                Self->ParentKey,
                Gs2::Inventory::Domain::Model::FCurrentItemModelMasterDomain::CreateCacheKey(
                )
            );
