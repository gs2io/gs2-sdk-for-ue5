...
namespace Gs2::Inventory::Request
{
    ...
    TSharedPtr<FAcquireItemSetByUserIdRequest> FAcquireItemSetByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FAcquireItemSetByUserIdRequest::GetTimeOffsetToken() const
    {
    ...
    TSharedPtr<FAcquireItemSetByUserIdRequest> FAcquireItemSetByUserIdRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FAcquireItemSetByUserIdRequest>()
            ...
            ->WithAcquireCount(Data->HasField(ANSI_TO_TCHAR("acquireCount")) ? [Data]() -> TOptional<int64>
              {
                  int64 v;
                    if (Data->TryGetNumberField(ANSI_TO_TCHAR("acquireCount"), v))
                  {
                        return TOptional(v);
                  }
            ...
            ->WithCreateNewItemSet(Data->HasField(ANSI_TO_TCHAR("createNewItemSet")) ? [Data]() -> TOptional<bool>
              {
                  bool v;
                    if (Data->TryGetBoolField(ANSI_TO_TCHAR("createNewItemSet"), v))
                  {
                        return TOptional(v);
                  }
    ...
    TSharedPtr<FJsonObject> FAcquireItemSetByUserIdRequest::ToJson() const
    {
        ...
        if (AcquireCountValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("acquireCount"), FString::Printf(TEXT("%lld"), AcquireCountValue.GetValue()));
        }
        if (ExpiresAtValue.IsSet())
        {
        ...
        if (CreateNewItemSetValue.IsSet())
        {
            JsonRootObject->SetBoolField(TEXT("createNewItemSet"), CreateNewItemSetValue.GetValue());
        }
