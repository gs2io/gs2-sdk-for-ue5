...
#include "Inventory/Request/AddReferenceOfByUserIdRequest.h"

namespace Gs2::Inventory::Request
{
    FAddReferenceOfByUserIdRequest::FAddReferenceOfByUserIdRequest():
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithContextStack(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithNamespaceName(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithInventoryName(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithUserId(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithItemName(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithItemSetName(
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::WithReferenceOf(
    ...
    TOptional<FString> FAddReferenceOfByUserIdRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FAddReferenceOfByUserIdRequest::GetNamespaceName() const
    {
        return NamespaceNameValue;
    }

    TOptional<FString> FAddReferenceOfByUserIdRequest::GetInventoryName() const
    {
        return InventoryNameValue;
    }

    TOptional<FString> FAddReferenceOfByUserIdRequest::GetUserId() const
    {
        return UserIdValue;
    }

    TOptional<FString> FAddReferenceOfByUserIdRequest::GetItemName() const
    {
        return ItemNameValue;
    }

    TOptional<FString> FAddReferenceOfByUserIdRequest::GetItemSetName() const
    {
    ...
    TSharedPtr<FAddReferenceOfByUserIdRequest> FAddReferenceOfByUserIdRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FAddReferenceOfByUserIdRequest>()
    ...
    TSharedPtr<FJsonObject> FAddReferenceOfByUserIdRequest::ToJson() const
    {
