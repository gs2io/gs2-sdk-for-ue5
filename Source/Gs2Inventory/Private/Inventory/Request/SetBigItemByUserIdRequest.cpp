...
namespace Gs2::Inventory::Request
{
    ...
    TSharedPtr<FSetBigItemByUserIdRequest> FSetBigItemByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FSetBigItemByUserIdRequest::GetTimeOffsetToken() const
    {
