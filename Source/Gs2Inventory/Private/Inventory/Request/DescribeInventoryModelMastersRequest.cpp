...
namespace Gs2::Inventory::Request
{
    ...
    TSharedPtr<FDescribeInventoryModelMastersRequest> FDescribeInventoryModelMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeInventoryModelMastersRequest::GetNamePrefix() const
    {
