...
namespace Gs2::Inventory::Request
{
    ...
    TSharedPtr<FUpdateCurrentItemModelMasterRequest> FUpdateCurrentItemModelMasterRequest::WithMode(
    ...
    TSharedPtr<FUpdateCurrentItemModelMasterRequest> FUpdateCurrentItemModelMasterRequest::WithUploadToken(
    ...
    TOptional<FString> FUpdateCurrentItemModelMasterRequest::GetMode() const
    {
        return ModeValue;
    }
    ...
    TOptional<FString> FUpdateCurrentItemModelMasterRequest::GetUploadToken() const
    {
