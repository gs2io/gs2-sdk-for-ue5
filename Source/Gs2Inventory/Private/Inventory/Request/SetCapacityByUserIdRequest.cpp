...
namespace Gs2::Inventory::Request
{
    ...
    TSharedPtr<FSetCapacityByUserIdRequest> FSetCapacityByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FSetCapacityByUserIdRequest::GetTimeOffsetToken() const
    {
    ...
    TSharedPtr<FSetCapacityByUserIdRequest> FSetCapacityByUserIdRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FSetCapacityByUserIdRequest>()
            ...
            ->WithNewCapacityValue(Data->HasField(ANSI_TO_TCHAR("newCapacityValue")) ? [Data]() -> TOptional<int32>
              {
                  int32 v;
                    if (Data->TryGetNumberField(ANSI_TO_TCHAR("newCapacityValue"), v))
                  {
                        return TOptional(v);
                  }
    ...
    TSharedPtr<FJsonObject> FSetCapacityByUserIdRequest::ToJson() const
    {
        ...
        if (NewCapacityValueValue.IsSet())
        {
            JsonRootObject->SetNumberField(TEXT("newCapacityValue"), NewCapacityValueValue.GetValue());
        }
