...
namespace Gs2::Friend::Request
{
    ...
    TSharedPtr<FDeleteRequestByUserIdRequest> FDeleteRequestByUserIdRequest::WithTargetUserId(
    ...
    TOptional<FString> FDeleteRequestByUserIdRequest::GetTargetUserId() const
    {
