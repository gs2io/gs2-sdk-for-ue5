...
namespace Gs2::Friend::Request
{
    ...
    TSharedPtr<FRejectRequestByUserIdRequest> FRejectRequestByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FRejectRequestByUserIdRequest::GetTimeOffsetToken() const
    {
