...
namespace Gs2::Friend::Request
{
    ...
    TSharedPtr<FDescribeFollowsByUserIdRequest> FDescribeFollowsByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDescribeFollowsByUserIdRequest::GetTimeOffsetToken() const
    {
