...
namespace Gs2::Friend::Request
{
    ...
    TSharedPtr<FDeleteFriendByUserIdRequest> FDeleteFriendByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDeleteFriendByUserIdRequest::GetTimeOffsetToken() const
    {
