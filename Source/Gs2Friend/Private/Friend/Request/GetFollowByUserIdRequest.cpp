...
namespace Gs2::Friend::Request
{
    ...
    TSharedPtr<FGetFollowByUserIdRequest> FGetFollowByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FGetFollowByUserIdRequest::GetTimeOffsetToken() const
    {
