...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FFollowUserDomain::Invalidate()
    {
        Gs2::Friend::Model::Cache::FFollowUserCache::Delete(
            Gs2->Cache,
    ...
    FFollowUserDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FFollowUserDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FFollowUserDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FFollowUserDomain::FSubscribeWithInitialCallTask>> FFollowUserDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FFollowUserPtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryUserId, QueryWithProfile, QueryTargetUserId]()
            {
                ...
                const auto Domain = MakeShared<FFollowUserDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryUserId,
