...
namespace Gs2::Friend::Domain::Model
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSendFriendRequestAccessTokenDomain::FModelTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Friend::Model::FSendFriendRequest>> Result
    )
    {
        const auto CacheParentKey = Gs2::Friend::Model::Cache::FSendFriendRequestCache::CreateCacheParentKey(

            Self->NamespaceName,
            Self->AccessToken.IsValid() ? Self->UserId() : TOptional<FString>(),
            Self->AccessToken.IsValid() ? Self->AccessToken->GetTimeOffset() : TOptional<int32>()
        );
        const auto CacheKey = Gs2::Friend::Model::Cache::FSendFriendRequestCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Friend::Model::FSendFriendRequestPtr Value;
                const auto CacheHit = Gs2::Friend::Model::Cache::FSendFriendRequestCache::TryGet(
                    Self->Gs2->Cache,
                ...
                if (!CacheHit)
                {
                    ...
                    else
                    {
                        ...
                        if (RawValue.IsValid())
                        {
                            Value = MakeShared<Gs2::Friend::Model::FSendFriendRequest>()
    ...
    void FSendFriendRequestAccessTokenDomain::Invalidate()
    {
        Gs2::Friend::Model::Cache::FSendFriendRequestCache::Delete(
            Gs2->Cache,
    ...
    FSendFriendRequestAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FSendFriendRequestAccessTokenDomain>& Self,
        TFunction<void(Gs2::Friend::Model::FSendFriendRequestPtr)> Callback
    ):
        Self(Self),
        Callback(Callback)
    {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSendFriendRequestAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSendFriendRequestAccessTokenDomain::FSubscribeWithInitialCallTask>> FSendFriendRequestAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FSendFriendRequestPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Friend::Model::Cache::FSendFriendRequestCache::CreateCacheParentKey(

            NamespaceName,
            AccessToken.IsValid() ? UserId() : TOptional<FString>(),
            AccessToken.IsValid() ? AccessToken->GetTimeOffset() : TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Friend::Model::Cache::FSendFriendRequestCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Friend::Model::FSendFriendRequest>(obj));
            },
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryTargetUserId, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FSendFriendRequestAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot,
