...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FSendFriendRequestDomain::Invalidate()
    {
        Gs2::Friend::Model::Cache::FSendFriendRequestCache::Delete(
            Gs2->Cache,
    ...
    FSendFriendRequestDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FSendFriendRequestDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSendFriendRequestDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSendFriendRequestDomain::FSubscribeWithInitialCallTask>> FSendFriendRequestDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FSendFriendRequestPtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryUserId, QueryTargetUserId]()
            {
                ...
                const auto Domain = MakeShared<FSendFriendRequestDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryUserId,
