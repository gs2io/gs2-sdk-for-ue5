...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FSendBoxAccessTokenDomain::Invalidate()
    {
    ...
    FSendBoxAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FSendBoxAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSendBoxAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSendBoxAccessTokenDomain::FSubscribeWithInitialCallTask>> FSendBoxAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FSendBoxPtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FSendBoxAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot
