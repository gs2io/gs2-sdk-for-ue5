...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FPublicProfileAccessTokenDomain::Invalidate()
    {
    ...
    FPublicProfileAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FPublicProfileAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FPublicProfileAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FPublicProfileAccessTokenDomain::FSubscribeWithInitialCallTask>> FPublicProfileAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FPublicProfilePtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FPublicProfileAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot
