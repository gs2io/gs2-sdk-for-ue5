...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FInboxAccessTokenDomain::Invalidate()
    {
    ...
    FInboxAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FInboxAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FInboxAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FInboxAccessTokenDomain::FSubscribeWithInitialCallTask>> FInboxAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FInboxPtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FInboxAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot
