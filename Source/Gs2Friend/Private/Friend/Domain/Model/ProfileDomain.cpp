...
namespace Gs2::Friend::Domain::Model
{
    ...
    void FProfileDomain::Invalidate()
    {
        Gs2::Friend::Model::Cache::FProfileCache::Delete(
            Gs2->Cache,
    ...
    FProfileDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FProfileDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FProfileDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FProfileDomain::FSubscribeWithInitialCallTask>> FProfileDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FProfilePtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryUserId]()
            {
                ...
                const auto Domain = MakeShared<FProfileDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryUserId
