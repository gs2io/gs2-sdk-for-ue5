...
namespace Gs2::Friend::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::Friend::Model::Cache::FSendBoxCache::CreateCacheParentKey(

            Self->NamespaceName,
            Self->UserId,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Friend::Model::Cache::FSendBoxCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Friend::Model::FSendBoxPtr Value;
                const auto CacheHit = Gs2::Friend::Model::Cache::FSendBoxCache::TryGet(
                    Self->Gs2->Cache,
    ...
    void FSendBoxDomain::Invalidate()
    {
        Gs2::Friend::Model::Cache::FSendBoxCache::Delete(
            Gs2->Cache,
    ...
    FSendBoxDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FSendBoxDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSendBoxDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSendBoxDomain::FSubscribeWithInitialCallTask>> FSendBoxDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Friend::Model::FSendBoxPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Friend::Model::Cache::FSendBoxCache::CreateCacheParentKey(

            NamespaceName,
            UserId,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Friend::Model::Cache::FSendBoxCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryUserId]()
            {
                ...
                const auto Domain = MakeShared<FSendBoxDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryUserId
