...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeSendRequestsByUserIdIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Friend::Model::FFriendRequest>> Result)
    {
        ++Iterator;
    ...
    FDescribeSendRequestsByUserIdIterator::FIterator& FDescribeSendRequestsByUserIdIterator::FIterator::operator++()
    {
        ...
        if (!RangeIteratorOpt || (!*RangeIteratorOpt && !bLast))
        {
            ...
            if (Self->Cache->IsListCached(
                ...
                Range = MakeShared<TArray<Gs2::Friend::Model::FFriendRequestPtr>>();
                *Range = Self->Cache->List<Gs2::Friend::Model::FFriendRequest>(
                    ListParentKey
                );
