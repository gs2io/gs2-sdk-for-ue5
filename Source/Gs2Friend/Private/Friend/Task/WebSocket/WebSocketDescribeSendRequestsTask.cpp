...
#include "Friend/Task/WebSocket/DescribeSendRequestsTask.h"
...
namespace Gs2::Friend::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("friend"), TEXT("sendFriendRequest"), TEXT("describeSendRequests"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDescribeSendRequestsResult::FromJson(WebSocketResult->Body());
