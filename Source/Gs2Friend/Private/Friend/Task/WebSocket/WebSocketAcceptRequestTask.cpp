...
#include "Friend/Task/WebSocket/AcceptRequestTask.h"
...
namespace Gs2::Friend::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("friend"), TEXT("receiveFriendRequest"), TEXT("acceptRequest"), ToCStr(RequestPayload->Payload()));
