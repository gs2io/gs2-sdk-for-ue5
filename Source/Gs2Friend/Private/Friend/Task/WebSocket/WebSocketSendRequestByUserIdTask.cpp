...
#include "Friend/Task/WebSocket/SendRequestByUserIdTask.h"
...
namespace Gs2::Friend::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("friend"), TEXT("sendFriendRequest"), TEXT("sendRequestByUserId"), ToCStr(RequestPayload->Payload()));
