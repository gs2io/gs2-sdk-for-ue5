...
#include "Friend/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Friend::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("friend"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
