...
#include "Friend/Task/WebSocket/SendRequestTask.h"
...
namespace Gs2::Friend::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("friend"), TEXT("sendFriendRequest"), TEXT("sendRequest"), ToCStr(RequestPayload->Payload()));
