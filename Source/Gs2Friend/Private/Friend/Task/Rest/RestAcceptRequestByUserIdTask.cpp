...
#include "Friend/Task/Rest/AcceptRequestByUserIdTask.h"
...
{
    FAcceptRequestByUserIdTask::FAcceptRequestByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAcceptRequestByUserIdTask::Action(
        const TSharedPtr<Result::FAcceptRequestByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcceptRequestByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
