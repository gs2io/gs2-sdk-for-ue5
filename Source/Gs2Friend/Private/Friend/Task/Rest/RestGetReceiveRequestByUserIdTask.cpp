...
#include "Friend/Task/Rest/GetReceiveRequestByUserIdTask.h"
...
{
    FGetReceiveRequestByUserIdTask::FGetReceiveRequestByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetReceiveRequestByUserIdTask::Action(
        const TSharedPtr<Result::FGetReceiveRequestByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/inbox/{fromUserId}");
            ...
            Url = Url.Replace(
                TEXT("{fromUserId}"),
                !this->Request->GetFromUserId().IsSet() || this->Request->GetFromUserId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetFromUserId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetReceiveRequestByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
