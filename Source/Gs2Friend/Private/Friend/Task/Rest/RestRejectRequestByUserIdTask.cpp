...
#include "Friend/Task/Rest/RejectRequestByUserIdTask.h"
...
{
    FRejectRequestByUserIdTask::FRejectRequestByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FRejectRequestByUserIdTask::Action(
        const TSharedPtr<Result::FRejectRequestByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRejectRequestByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
