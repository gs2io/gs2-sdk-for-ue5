...
{
    class GS2FRIEND_API FAcceptRequestResult final : public TSharedFromThis<FAcceptRequestResult>
    {
    ...
    public:
        ...
        TSharedPtr<FAcceptRequestResult> WithItem(const TSharedPtr<Model::FFriendRequest> Item);
