...
{
    class GS2FRIEND_API FSendRequestResult final : public TSharedFromThis<FSendRequestResult>
    {
    ...
    public:
        ...
        TSharedPtr<FSendRequestResult> WithItem(const TSharedPtr<Model::FFriendRequest> Item);
