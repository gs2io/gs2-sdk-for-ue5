...
{
    class GS2FRIEND_API FDeleteRequestByUserIdResult final : public TSharedFromThis<FDeleteRequestByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FDeleteRequestByUserIdResult> WithItem(const TSharedPtr<Model::FFriendRequest> Item);
