...
{
    class GS2FRIEND_API FGetSendRequestByUserIdResult final : public TSharedFromThis<FGetSendRequestByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSendRequestByUserIdResult> WithItem(const TSharedPtr<Model::FFriendRequest> Item);
