...
{
    class GS2FRIEND_API FGetSendRequestResult final : public TSharedFromThis<FGetSendRequestResult>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSendRequestResult> WithItem(const TSharedPtr<Model::FFriendRequest> Item);
