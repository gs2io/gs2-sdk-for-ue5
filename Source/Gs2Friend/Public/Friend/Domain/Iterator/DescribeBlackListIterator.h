...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    class GS2FRIEND_API FDescribeBlackListIterator :
        public TSharedFromThis<FDescribeBlackListIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeBlackListIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBlackListIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBlackListIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBlackListIterator> Iterable)
            {
