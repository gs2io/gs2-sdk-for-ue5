...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    class GS2FRIEND_API FDescribeFollowsByUserIdIterator :
        public TSharedFromThis<FDescribeFollowsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Friend::Model::FFollowUser>> Result) override;
        ...
        {
            TSharedRef<FDescribeFollowsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Friend::Model::FFollowUserPtr>> Range;
            TOptional<TArray<Gs2::Friend::Model::FFollowUserPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFollowsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFollowsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFollowsByUserIdIterator> Iterable)
            {
