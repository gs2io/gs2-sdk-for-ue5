...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Friend::Model::FNamespace>> Result) override;
        ...
        class GS2FRIEND_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Friend::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Friend::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
