...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    class GS2FRIEND_API FDescribeReceiveRequestsByUserIdIterator :
        public TSharedFromThis<FDescribeReceiveRequestsByUserIdIterator>
    {
    ...
    public:
        FDescribeReceiveRequestsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Friend::FGs2FriendRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        class GS2FRIEND_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Friend::Model::FReceiveFriendRequest>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Friend::Model::FReceiveFriendRequest>> Result) override;
        ...
        {
            TSharedRef<FDescribeReceiveRequestsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Friend::Model::FReceiveFriendRequestPtr>> Range;
            TOptional<TArray<Gs2::Friend::Model::FReceiveFriendRequestPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Friend::Model::FReceiveFriendRequestPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeReceiveRequestsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeReceiveRequestsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeReceiveRequestsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeReceiveRequestsByUserIdIterator> FDescribeReceiveRequestsByUserIdIteratorPtr;
}
