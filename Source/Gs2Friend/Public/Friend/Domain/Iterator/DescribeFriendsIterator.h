...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    class GS2FRIEND_API FDescribeFriendsIterator :
        public TSharedFromThis<FDescribeFriendsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeFriendsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFriendsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFriendsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFriendsIterator> Iterable)
            {
