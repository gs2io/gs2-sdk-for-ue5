...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    class GS2FRIEND_API FDescribeFriendsByUserIdIterator :
        public TSharedFromThis<FDescribeFriendsByUserIdIterator>
    {
    ...
    public:
        ...
        FDescribeFriendsByUserIdIterator(
            const FDescribeFriendsByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Friend::Model::FFriendUser>> Result) override;
        ...
        {
            TSharedRef<FDescribeFriendsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Friend::Model::FFriendUserPtr>> Range;
            TOptional<TArray<Gs2::Friend::Model::FFriendUserPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFriendsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFriendsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFriendsByUserIdIterator> Iterable)
            {
