...
namespace Gs2::Friend::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeFollowsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFollowsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFollowsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFollowsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeFollowsIterator> FDescribeFollowsIteratorPtr;
}
