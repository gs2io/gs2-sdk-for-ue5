...
namespace Gs2::Friend::Domain::Model
{
    ...
    class GS2FRIEND_API FSendBoxDomain:
        public TSharedFromThis<FSendBoxDomain>
    {
    ...
    public:
        ...
        class GS2FRIEND_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Friend::Model::FSendBox>,
        ...
        {
            const TSharedPtr<FSendBoxDomain> Self;
            const TFunction<void(Gs2::Friend::Model::FSendBoxPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FSendBoxDomain> FSendBoxDomainPtr;
}
