...
namespace Gs2::Friend::Domain::Model
{
    ...
    class GS2FRIEND_API FFollowAccessTokenDomain:
        public TSharedFromThis<FFollowAccessTokenDomain>
    {
    ...
    public:
        ...
        public:
            FSubscribeFollowsWithInitialCallTask(const TSharedPtr<FFollowAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::Friend::Model::FFollowUserPtr>)> Callback);
    ...
    typedef TSharedPtr<FFollowAccessTokenDomain> FFollowAccessTokenDomainPtr;
}
