...
namespace Gs2::Friend::Domain::Model
{
    ...
    class GS2FRIEND_API FPublicProfileDomain:
        public TSharedFromThis<FPublicProfileDomain>
    {
    ...
    typedef TSharedPtr<FPublicProfileDomain> FPublicProfileDomainPtr;
}
