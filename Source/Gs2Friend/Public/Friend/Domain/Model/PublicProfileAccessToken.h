...
namespace Gs2::Friend::Domain::Model
{
    ...
    class GS2FRIEND_API FPublicProfileAccessTokenDomain:
        public TSharedFromThis<FPublicProfileAccessTokenDomain>
    {
    ...
    public:
        ...
        FPublicProfileAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Friend::Domain::FGs2FriendDomainPtr& Service,
        ...
        class GS2FRIEND_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Friend::Model::FPublicProfile>,
        ...
        {
            const TSharedPtr<FPublicProfileAccessTokenDomain> Self;
            const TFunction<void(Gs2::Friend::Model::FPublicProfilePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FPublicProfileAccessTokenDomain> FPublicProfileAccessTokenDomainPtr;
}
