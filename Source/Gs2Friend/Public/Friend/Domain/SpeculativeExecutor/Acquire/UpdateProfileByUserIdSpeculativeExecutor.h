...
namespace Gs2::Friend::Domain::SpeculativeExecutor
{
    ...
    class GS2FRIEND_API FUpdateProfileByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2FRIEND_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Friend::Domain::FGs2FriendDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Friend::Request::FUpdateProfileByUserIdRequestPtr& Request
            ...
            GS2FRIEND_API FCommitTask(
                const FCommitTask& From
            );

            GS2FRIEND_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Friend::Request::FUpdateProfileByUserIdRequestPtr Rate(
            const Gs2::Friend::Request::FUpdateProfileByUserIdRequestPtr& Request,
            const double Rate
        );
