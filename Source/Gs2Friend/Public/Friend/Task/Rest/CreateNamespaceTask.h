...
#include "Friend/Result/CreateNamespaceResult.h"

namespace Gs2::Friend::Task::Rest
{
    class GS2FRIEND_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
