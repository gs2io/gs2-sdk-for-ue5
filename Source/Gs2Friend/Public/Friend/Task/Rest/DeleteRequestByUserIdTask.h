...
#include "Friend/Request/DeleteRequestByUserIdRequest.h"
#include "Friend/Result/DeleteRequestByUserIdResult.h"

namespace Gs2::Friend::Task::Rest
{
    class GS2FRIEND_API FDeleteRequestByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteRequestByUserIdResult>
    {
