...
#include "Friend/Request/DeleteNamespaceRequest.h"
#include "Friend/Result/DeleteNamespaceResult.h"

namespace Gs2::Friend::Task::Rest
{
    class GS2FRIEND_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
