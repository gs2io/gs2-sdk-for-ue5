...
#include "Friend/Result/UpdateNamespaceResult.h"

namespace Gs2::Friend::Task::Rest
{
    class GS2FRIEND_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
