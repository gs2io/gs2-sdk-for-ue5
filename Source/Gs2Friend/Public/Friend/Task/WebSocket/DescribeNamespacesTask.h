...
#include "Friend/Request/DescribeNamespacesRequest.h"
#include "Friend/Result/DescribeNamespacesResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
