...
#include "Friend/Request/ImportUserDataByUserIdRequest.h"
#include "Friend/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
