...
#include "Friend/Request/GetNamespaceStatusRequest.h"
#include "Friend/Result/GetNamespaceStatusResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
