...
#include "Friend/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Friend/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
