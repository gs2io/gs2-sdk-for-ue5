...
#include "Friend/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Friend/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
