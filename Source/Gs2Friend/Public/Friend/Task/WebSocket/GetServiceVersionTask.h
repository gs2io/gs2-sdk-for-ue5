...
#include "Friend/Request/GetServiceVersionRequest.h"
#include "Friend/Result/GetServiceVersionResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
