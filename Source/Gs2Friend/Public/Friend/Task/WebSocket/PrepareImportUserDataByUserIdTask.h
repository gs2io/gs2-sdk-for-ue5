...
#include "Friend/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Friend/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
