...
#include "Friend/Request/GetNamespaceRequest.h"
#include "Friend/Result/GetNamespaceResult.h"

namespace Gs2::Friend::Task::WebSocket
{
    class GS2FRIEND_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
