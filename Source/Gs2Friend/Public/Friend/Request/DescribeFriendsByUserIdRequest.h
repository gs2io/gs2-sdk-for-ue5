...
namespace Gs2::Friend::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeFriendsByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FDescribeFriendsByUserIdRequest> FDescribeFriendsByUserIdRequestPtr;
}