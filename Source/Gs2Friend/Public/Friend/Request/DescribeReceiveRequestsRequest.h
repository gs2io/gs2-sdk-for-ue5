...
namespace Gs2::Friend::Request
{
    ...
    class GS2FRIEND_API FDescribeReceiveRequestsRequest final : public TSharedFromThis<FDescribeReceiveRequestsRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeReceiveRequestsRequest> WithWithProfile(const TOptional<bool> WithProfile);
    ...
    typedef TSharedPtr<FDescribeReceiveRequestsRequest> FDescribeReceiveRequestsRequestPtr;
}