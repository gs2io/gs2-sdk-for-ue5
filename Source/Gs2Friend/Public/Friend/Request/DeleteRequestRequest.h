...
namespace Gs2::Friend::Request
{
    ...
    class GS2FRIEND_API FDeleteRequestRequest final : public TSharedFromThis<FDeleteRequestRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDeleteRequestRequest> WithTargetUserId(const TOptional<FString> TargetUserId);
    ...
    typedef TSharedPtr<FDeleteRequestRequest, ESPMode::ThreadSafe> FDeleteRequestRequestPtr;
}