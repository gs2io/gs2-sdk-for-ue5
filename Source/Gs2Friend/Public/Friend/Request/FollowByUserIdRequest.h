...
namespace Gs2::Friend::Request
{
    ...
    public:
        ...
        TSharedPtr<FFollowByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FFollowByUserIdRequest> FFollowByUserIdRequestPtr;
}