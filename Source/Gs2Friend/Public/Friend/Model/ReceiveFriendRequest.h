...
{
    class GS2FRIEND_API FReceiveFriendRequest final : public FGs2Object, public TSharedFromThis<FReceiveFriendRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FReceiveFriendRequest> WithPublicProfile(const TOptional<FString> PublicProfile);
