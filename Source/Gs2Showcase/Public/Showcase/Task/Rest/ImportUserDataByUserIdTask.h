...
#include "Showcase/Request/ImportUserDataByUserIdRequest.h"
#include "Showcase/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::Rest
{
    class GS2SHOWCASE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
