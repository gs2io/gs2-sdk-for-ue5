...
#include "Showcase/Request/GetNamespaceStatusRequest.h"
#include "Showcase/Result/GetNamespaceStatusResult.h"

namespace Gs2::Showcase::Task::Rest
{
    class GS2SHOWCASE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
