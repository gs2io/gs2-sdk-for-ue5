...
#include "Showcase/Request/CleanUserDataByUserIdRequest.h"
#include "Showcase/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::Rest
{
    class GS2SHOWCASE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
