...
#include "Showcase/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Showcase/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::Rest
{
    class GS2SHOWCASE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
