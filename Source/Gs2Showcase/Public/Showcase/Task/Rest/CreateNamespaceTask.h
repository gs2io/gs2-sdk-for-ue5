...
#include "Showcase/Result/CreateNamespaceResult.h"

namespace Gs2::Showcase::Task::Rest
{
    class GS2SHOWCASE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
