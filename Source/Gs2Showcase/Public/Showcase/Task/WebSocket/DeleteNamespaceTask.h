...
#include "Showcase/Request/DeleteNamespaceRequest.h"
#include "Showcase/Result/DeleteNamespaceResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
