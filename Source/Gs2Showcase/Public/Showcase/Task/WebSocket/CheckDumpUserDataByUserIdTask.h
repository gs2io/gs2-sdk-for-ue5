...
#include "Showcase/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Showcase/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
