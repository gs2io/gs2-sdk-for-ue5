...
#include "Showcase/Request/GetServiceVersionRequest.h"
#include "Showcase/Result/GetServiceVersionResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
