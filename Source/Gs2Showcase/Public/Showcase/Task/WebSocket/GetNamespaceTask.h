...
#include "Showcase/Request/GetNamespaceRequest.h"
#include "Showcase/Result/GetNamespaceResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
