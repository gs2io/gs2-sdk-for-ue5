...
#include "Showcase/Request/CheckImportUserDataByUserIdRequest.h"
#include "Showcase/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
