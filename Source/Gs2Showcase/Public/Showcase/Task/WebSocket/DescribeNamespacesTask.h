...
#include "Showcase/Request/DescribeNamespacesRequest.h"
#include "Showcase/Result/DescribeNamespacesResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
