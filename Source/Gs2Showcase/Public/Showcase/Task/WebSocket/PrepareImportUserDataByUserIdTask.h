...
#include "Showcase/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Showcase/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
