...
#include "Showcase/Request/DumpUserDataByUserIdRequest.h"
#include "Showcase/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Showcase::Task::WebSocket
{
    class GS2SHOWCASE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
