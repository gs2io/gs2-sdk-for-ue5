...
{
    class FUpdateCurrentShowcaseMasterRequest;

    class GS2SHOWCASE_API FUpdateCurrentShowcaseMasterRequest final : public TSharedFromThis<FUpdateCurrentShowcaseMasterRequest>
    {
    ...
    public:
        ...
        FUpdateCurrentShowcaseMasterRequest();
        FUpdateCurrentShowcaseMasterRequest(
            const FUpdateCurrentShowcaseMasterRequest& From
        );
        ~FUpdateCurrentShowcaseMasterRequest() = default;
    ...
    typedef TSharedPtr<FUpdateCurrentShowcaseMasterRequest, ESPMode::ThreadSafe> FUpdateCurrentShowcaseMasterRequestPtr;
}