...
{
    class GS2SHOWCASE_API FRandomShowcaseBuyByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FRandomShowcaseBuyByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Showcase::Domain::FGs2ShowcaseDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Showcase::Request::FRandomShowcaseBuyByUserIdRequestPtr& Request
