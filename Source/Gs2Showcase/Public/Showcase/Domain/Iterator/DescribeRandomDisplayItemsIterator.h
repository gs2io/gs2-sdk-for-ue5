...
namespace Gs2::Showcase::Domain::Iterator
{
    ...
    class GS2SHOWCASE_API FDescribeRandomDisplayItemsIterator :
        public TSharedFromThis<FDescribeRandomDisplayItemsIterator>
    {
    ...
    public:
        FDescribeRandomDisplayItemsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Showcase::FGs2ShowcaseRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> ShowcaseName,
        ...
        {
            TSharedRef<FDescribeRandomDisplayItemsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRandomDisplayItemsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRandomDisplayItemsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRandomDisplayItemsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRandomDisplayItemsIterator> FDescribeRandomDisplayItemsIteratorPtr;
}
