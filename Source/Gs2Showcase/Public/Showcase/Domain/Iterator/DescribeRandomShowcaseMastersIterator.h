...
namespace Gs2::Showcase::Domain::Iterator
{
    ...
    class GS2SHOWCASE_API FDescribeRandomShowcaseMastersIterator :
        public TSharedFromThis<FDescribeRandomShowcaseMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Showcase::Model::FRandomShowcaseMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeRandomShowcaseMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Showcase::Model::FRandomShowcaseMasterPtr>> Range;
            TOptional<TArray<Gs2::Showcase::Model::FRandomShowcaseMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Showcase::Model::FRandomShowcaseMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRandomShowcaseMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRandomShowcaseMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRandomShowcaseMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRandomShowcaseMastersIterator> FDescribeRandomShowcaseMastersIteratorPtr;
}
