...
namespace Gs2::Showcase::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Showcase::Model::FNamespace>> Result) override;
        ...
        class GS2SHOWCASE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Showcase::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Showcase::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
