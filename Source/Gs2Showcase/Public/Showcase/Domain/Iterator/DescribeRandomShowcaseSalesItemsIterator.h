...
namespace Gs2::Showcase::Domain::Iterator
{
    ...
    class GS2SHOWCASE_API FDescribeRandomShowcaseSalesItemsIterator :
        public TSharedFromThis<FDescribeRandomShowcaseSalesItemsIterator>
    {
    ...
    public:
        FDescribeRandomShowcaseSalesItemsIterator(
            const Core::Domain::FCacheDatabasePtr Cache,
            const Gs2::Showcase::FGs2ShowcaseRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> ShowcaseName,
        ...
        {
            TSharedRef<FDescribeRandomShowcaseSalesItemsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRandomShowcaseSalesItemsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRandomShowcaseSalesItemsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRandomShowcaseSalesItemsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRandomShowcaseSalesItemsIterator> FDescribeRandomShowcaseSalesItemsIteratorPtr;
}
