...
namespace Gs2::Showcase::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeRandomDisplayItemsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRandomDisplayItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRandomDisplayItemsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRandomDisplayItemsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRandomDisplayItemsByUserIdIterator> FDescribeRandomDisplayItemsByUserIdIteratorPtr;
}
