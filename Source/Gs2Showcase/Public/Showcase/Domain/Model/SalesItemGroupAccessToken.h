...
namespace Gs2::Showcase::Domain::Model
{
    ...
    class GS2SHOWCASE_API FSalesItemGroupAccessTokenDomain:
        public TSharedFromThis<FSalesItemGroupAccessTokenDomain>
    {
    ...
    public:
        ...
        FSalesItemGroupAccessTokenDomain(
    ...
    typedef TSharedPtr<FSalesItemGroupAccessTokenDomain> FSalesItemGroupAccessTokenDomainPtr;
}
