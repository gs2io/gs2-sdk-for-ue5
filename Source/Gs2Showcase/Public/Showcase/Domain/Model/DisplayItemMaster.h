...
namespace Gs2::Showcase::Domain::Model
{
    ...
    class GS2SHOWCASE_API FDisplayItemMasterDomain:
        public TSharedFromThis<FDisplayItemMasterDomain>
    {
    ...
    public:
        ...
        class GS2SHOWCASE_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Showcase::Model::FDisplayItemMaster>,
        ...
        {
            const TSharedPtr<FDisplayItemMasterDomain> Self;
            const TFunction<void(Gs2::Showcase::Model::FDisplayItemMasterPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FDisplayItemMasterDomain> FDisplayItemMasterDomainPtr;
}
