...
namespace Gs2::Showcase::Domain::Model
{
    ...
    class GS2SHOWCASE_API FRandomShowcaseDomain:
    ...
    public:
        ...
        Gs2::Core::Domain::CallbackID SubscribeRandomDisplayItems(
            TFunction<void(TArray<Gs2::Showcase::Model::FRandomDisplayItemPtr>)> Callback,const TOptional<FString> TimeOffsetToken = TOptional<FString>()
        );

        void InvalidateRandomDisplayItems(const TOptional<FString> TimeOffsetToken = TOptional<FString>());

        class GS2SHOWCASE_API FSubscribeRandomDisplayItemsWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeRandomDisplayItemsWithInitialCallTask>
        {
            const TSharedPtr<FRandomShowcaseDomain> Self;
            const TFunction<void(TArray<Gs2::Showcase::Model::FRandomDisplayItemPtr>)> Callback;
        const TOptional<FString> QueryTimeOffsetToken;
        public:
            FSubscribeRandomDisplayItemsWithInitialCallTask(const TSharedPtr<FRandomShowcaseDomain>& Self, TFunction<void(TArray<Gs2::Showcase::Model::FRandomDisplayItemPtr>)> Callback,const TOptional<FString> TimeOffsetToken);
            FSubscribeRandomDisplayItemsWithInitialCallTask(const FSubscribeRandomDisplayItemsWithInitialCallTask& From);
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Core::Domain::CallbackID>> Result) override;
        };

        TSharedPtr<FAsyncTask<FSubscribeRandomDisplayItemsWithInitialCallTask>> SubscribeRandomDisplayItemsWithInitialCall(
            TFunction<void(TArray<Gs2::Showcase::Model::FRandomDisplayItemPtr>)> Callback,const TOptional<FString> TimeOffsetToken = TOptional<FString>()
        );
        ...
        class GS2SHOWCASE_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Showcase::Model::FRandomShowcase>,
    ...
    typedef TSharedPtr<FRandomShowcaseDomain> FRandomShowcaseDomainPtr;
}
