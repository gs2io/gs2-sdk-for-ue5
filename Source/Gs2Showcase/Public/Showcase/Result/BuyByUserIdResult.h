...
namespace Gs2::Showcase::Result
{
    ...
    public:
        ...
        TSharedPtr<FBuyByUserIdResult> WithAtomicCommit(const TOptional<bool> AtomicCommit);
        TSharedPtr<FBuyByUserIdResult> WithTransaction(const TOptional<FString> Transaction);
        TSharedPtr<FBuyByUserIdResult> WithTransactionResult(const TSharedPtr<Gs2::Core::Model::FTransactionResult> TransactionResult);
