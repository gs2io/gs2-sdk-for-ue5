...
#include "Showcase/Task/Rest/GetSalesItemGroupMasterTask.h"
...
{
    FGetSalesItemGroupMasterTask::FGetSalesItemGroupMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSalesItemGroupMasterTask::Action(
        const TSharedPtr<Result::FGetSalesItemGroupMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSalesItemGroupMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
