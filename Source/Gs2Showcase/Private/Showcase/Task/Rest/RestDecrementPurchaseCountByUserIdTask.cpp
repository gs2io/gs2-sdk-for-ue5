...
#include "Showcase/Task/Rest/DecrementPurchaseCountByUserIdTask.h"
...
{
    FDecrementPurchaseCountByUserIdTask::FDecrementPurchaseCountByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDecrementPurchaseCountByUserIdTask::Action(
        const TSharedPtr<Result::FDecrementPurchaseCountByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/random/showcase/user/{userId}/status/{showcaseName}/{displayItemName}/purchase/count/decrease");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDecrementPurchaseCountByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
