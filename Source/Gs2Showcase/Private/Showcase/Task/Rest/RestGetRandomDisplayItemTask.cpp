...
#include "Showcase/Task/Rest/GetRandomDisplayItemTask.h"
...
{
    FGetRandomDisplayItemTask::FGetRandomDisplayItemTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRandomDisplayItemTask::Action(
        const TSharedPtr<Result::FGetRandomDisplayItemResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRandomDisplayItemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
