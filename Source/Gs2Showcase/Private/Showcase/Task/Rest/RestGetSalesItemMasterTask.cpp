...
#include "Showcase/Task/Rest/GetSalesItemMasterTask.h"
...
{
    FGetSalesItemMasterTask::FGetSalesItemMasterTask(
    ...
    FGetSalesItemMasterTask::FGetSalesItemMasterTask(
        const FGetSalesItemMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetSalesItemMasterTask::Action(
        const TSharedPtr<Result::FGetSalesItemMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSalesItemMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
