...
#include "Showcase/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Showcase::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetBuyScript() != nullptr && this->Request->GetBuyScript().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("buyScript"), this->Request->GetBuyScript()->ToJson());
            }
