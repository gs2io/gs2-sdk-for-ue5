...
#include "Showcase/Task/Rest/GetRandomShowcaseSalesItemByUserIdTask.h"
...
{
    FGetRandomShowcaseSalesItemByUserIdTask::FGetRandomShowcaseSalesItemByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRandomShowcaseSalesItemByUserIdTask::Action(
        const TSharedPtr<Result::FGetRandomShowcaseSalesItemByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/random/showcase/{showcaseName}/displayItem/{displayItemName}");
            ...
            Url = Url.Replace(
                ...
                !this->Request->GetDisplayItemName().IsSet() || this->Request->GetDisplayItemName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetDisplayItemName())
            );
            Url = Url.Replace(
                TEXT("{userId}"),
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRandomShowcaseSalesItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
