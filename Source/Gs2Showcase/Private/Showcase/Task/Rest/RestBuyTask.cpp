...
#include "Showcase/Task/Rest/BuyTask.h"
...
namespace Gs2::Showcase::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FBuyTask::Action(
        const TSharedPtr<Result::FBuyResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/showcase/{showcaseName}/{displayItemId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FBuyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
