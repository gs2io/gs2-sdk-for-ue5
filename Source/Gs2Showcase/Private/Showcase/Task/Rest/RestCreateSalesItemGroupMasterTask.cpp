...
#include "Showcase/Task/Rest/CreateSalesItemGroupMasterTask.h"
...
{
    FCreateSalesItemGroupMasterTask::FCreateSalesItemGroupMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateSalesItemGroupMasterTask::Action(
        const TSharedPtr<Result::FCreateSalesItemGroupMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/group");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateSalesItemGroupMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
