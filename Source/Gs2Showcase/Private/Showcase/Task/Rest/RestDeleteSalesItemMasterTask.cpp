...
#include "Showcase/Task/Rest/DeleteSalesItemMasterTask.h"
...
{
    FDeleteSalesItemMasterTask::FDeleteSalesItemMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteSalesItemMasterTask::Action(
        const TSharedPtr<Result::FDeleteSalesItemMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteSalesItemMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
