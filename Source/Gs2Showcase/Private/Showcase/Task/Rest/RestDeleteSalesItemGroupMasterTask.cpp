...
#include "Showcase/Task/Rest/DeleteSalesItemGroupMasterTask.h"
...
{
    FDeleteSalesItemGroupMasterTask::FDeleteSalesItemGroupMasterTask(
    ...
    FDeleteSalesItemGroupMasterTask::FDeleteSalesItemGroupMasterTask(
        const FDeleteSalesItemGroupMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteSalesItemGroupMasterTask::Action(
        const TSharedPtr<Result::FDeleteSalesItemGroupMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteSalesItemGroupMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
