...
#include "Showcase/Task/Rest/RandomShowcaseBuyByUserIdTask.h"
...
{
    FRandomShowcaseBuyByUserIdTask::FRandomShowcaseBuyByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FRandomShowcaseBuyByUserIdTask::Action(
        const TSharedPtr<Result::FRandomShowcaseBuyByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/random/showcase/{showcaseName}/{displayItemName}");
            ...
            if (this->Request->GetQuantity().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("quantity"), this->Request->GetQuantity().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRandomShowcaseBuyByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
