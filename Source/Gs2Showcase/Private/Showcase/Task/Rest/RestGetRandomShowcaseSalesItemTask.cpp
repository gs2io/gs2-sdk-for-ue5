...
#include "Showcase/Task/Rest/GetRandomShowcaseSalesItemTask.h"
...
{
    FGetRandomShowcaseSalesItemTask::FGetRandomShowcaseSalesItemTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRandomShowcaseSalesItemTask::Action(
        const TSharedPtr<Result::FGetRandomShowcaseSalesItemResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/random/showcase/{showcaseName}/displayItem/{displayItemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRandomShowcaseSalesItemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
