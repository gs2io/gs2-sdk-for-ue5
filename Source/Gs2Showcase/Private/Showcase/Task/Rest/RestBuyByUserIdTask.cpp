...
#include "Showcase/Task/Rest/BuyByUserIdTask.h"
...
{
    FBuyByUserIdTask::FBuyByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FBuyByUserIdTask::Action(
        const TSharedPtr<Result::FBuyByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/showcase/{showcaseName}/{displayItemId}");
            ...
            Url = Url.Replace(
                TEXT("{displayItemId}"),
                !this->Request->GetDisplayItemId().IsSet() || this->Request->GetDisplayItemId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetDisplayItemId())
            );
            Url = Url.Replace(
                TEXT("{userId}"),
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FBuyByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
