...
#include "Showcase/Task/Rest/GetRandomDisplayItemByUserIdTask.h"
...
{
    FGetRandomDisplayItemByUserIdTask::FGetRandomDisplayItemByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRandomDisplayItemByUserIdTask::Action(
        const TSharedPtr<Result::FGetRandomDisplayItemByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRandomDisplayItemByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
