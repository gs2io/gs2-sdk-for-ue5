...
#include "Showcase/Task/Rest/RandomShowcaseBuyTask.h"
...
{
    FRandomShowcaseBuyTask::FRandomShowcaseBuyTask(
    ...
    Core::Model::FGs2ErrorPtr FRandomShowcaseBuyTask::Action(
        const TSharedPtr<Result::FRandomShowcaseBuyResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/random/showcase/{showcaseName}/{displayItemName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRandomShowcaseBuyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
