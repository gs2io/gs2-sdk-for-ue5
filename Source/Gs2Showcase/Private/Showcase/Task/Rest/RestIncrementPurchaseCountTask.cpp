...
#include "Showcase/Task/Rest/IncrementPurchaseCountTask.h"
...
{
    FIncrementPurchaseCountTask::FIncrementPurchaseCountTask(
    ...
    Core::Model::FGs2ErrorPtr FIncrementPurchaseCountTask::Action(
        const TSharedPtr<Result::FIncrementPurchaseCountResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/random/showcase/user/me/status/{showcaseName}/{displayItemName}/purchase/count");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIncrementPurchaseCountResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
