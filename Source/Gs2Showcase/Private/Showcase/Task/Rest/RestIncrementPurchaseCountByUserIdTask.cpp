...
#include "Showcase/Task/Rest/IncrementPurchaseCountByUserIdTask.h"
...
{
    FIncrementPurchaseCountByUserIdTask::FIncrementPurchaseCountByUserIdTask(
    ...
    FIncrementPurchaseCountByUserIdTask::FIncrementPurchaseCountByUserIdTask(
        const FIncrementPurchaseCountByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FIncrementPurchaseCountByUserIdTask::Action(
        const TSharedPtr<Result::FIncrementPurchaseCountByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/random/showcase/user/{userId}/status/{showcaseName}/{displayItemName}/purchase/count");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIncrementPurchaseCountByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
