...
#include "Showcase/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Showcase::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("showcase"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
