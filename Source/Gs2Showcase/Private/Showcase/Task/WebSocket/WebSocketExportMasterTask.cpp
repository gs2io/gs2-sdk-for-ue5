...
#include "Showcase/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Showcase::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("showcase"), TEXT("currentShowcaseMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
