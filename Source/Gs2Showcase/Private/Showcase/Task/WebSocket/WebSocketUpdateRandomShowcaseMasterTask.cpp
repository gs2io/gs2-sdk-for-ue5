...
#include "Showcase/Task/WebSocket/UpdateRandomShowcaseMasterTask.h"
...
namespace Gs2::Showcase::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("showcase"), TEXT("randomShowcaseMaster"), TEXT("updateRandomShowcaseMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateRandomShowcaseMasterResult::FromJson(WebSocketResult->Body());
