...
namespace Gs2::Showcase::Model
{
    ...
    TSharedPtr<FSalesItemGroupMaster> FSalesItemGroupMaster::WithRevision(
    ...
    TOptional<int64> FSalesItemGroupMaster::GetRevision() const
    {
        return RevisionValue;
    }

    FString FSalesItemGroupMaster::GetRevisionString() const
    {
    ...
    TSharedPtr<FSalesItemGroupMaster> FSalesItemGroupMaster::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FSalesItemGroupMaster>()
            ->WithSalesItemGroupId(Data->HasField(ANSI_TO_TCHAR("salesItemGroupId")) ? [Data]() -> TOptional<FString>
                {
                    FString v("");
                    if (Data->TryGetStringField(ANSI_TO_TCHAR("salesItemGroupId"), v))
                    {
                        return TOptional(v);
                    }
                    return TOptional<FString>();
    ...
    TSharedPtr<FJsonObject> FSalesItemGroupMaster::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("salesItemGroupId"), SalesItemGroupIdValue.GetValue());
        }
        if (NameValue.IsSet())
        {
...
{
    FString FSalesItemGroupMasterCache::CreateCacheParentKey(
    ...
    )
    {
        return FString("showcase:")
            ...
            + FString::FromInt(CacheOwnerArgumentTimeOffset.Get(0)) + FString(":SalesItemGroupMaster");
    }

    FString FSalesItemGroupMasterCache::CreateCacheKey(
        TOptional<FString> CacheOwnerArgumentSalesItemGroupName
    )
    {
        return
            FString()
            + CacheOwnerArgumentSalesItemGroupName.Get(FString())
            ;
    }

    bool FSalesItemGroupMasterCache::TryGet(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentSalesItemGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Showcase::Model::FSalesItemGroupMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Showcase::Model::FSalesItemGroupMasterPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Showcase::Model::FSalesItemGroupMaster>(
            CreateCacheParentKey(
                CacheOwnerArgumentNamespaceName,
                CacheOwnerArgumentTimeOffset
            ),
            CreateCacheKey(
                CacheOwnerArgumentSalesItemGroupName
            ),
            &CacheOwnerValue
        );
    ...
    void FSalesItemGroupMasterCache::Put(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentSalesItemGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Showcase::Model::FSalesItemGroupMasterPtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Showcase::Model::FSalesItemGroupMasterPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Showcase::Model::FSalesItemGroupMaster>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Showcase::Model::FSalesItemGroupMaster::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
            FDateTime::Now() + FTimespan::FromMinutes(Gs2::Core::Domain::DefaultCacheMinutes)
        );
    }

    FString FSalesItemGroupMasterCache::PutUserData(
        const Gs2::Core::Domain::FCacheDatabasePtr& Cache,
        TOptional<FString> NamespaceName,
        TOptional<FString> UserId,
        TOptional<int32> TimeOffset,
        const Gs2::Showcase::Model::FSalesItemGroupMasterPtr& Item
    )
    {
    ...
    void FSalesItemGroupMasterCache::Delete(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentSalesItemGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Showcase::Model::FSalesItemGroupMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentSalesItemGroupName
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSalesItemGroupMasterCache::Fetch(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentSalesItemGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Showcase::Model::FSalesItemGroupMasterPtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Showcase::Model::FSalesItemGroupMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Showcase::Model::FSalesItemGroupMasterPtr CacheOwnerFetchedItem;
        ...
        if (CacheOwnerDetails.IsValid() && CacheOwnerDetails->Num() > 0 && (*CacheOwnerDetails)[0].IsValid() && (*CacheOwnerDetails)[0]->GetComponent() == TEXT("salesItemGroupMaster"))
        {
            return nullptr;
        }
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
    ...
    Gs2::Core::Domain::CallbackID FSalesItemGroupMasterCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Showcase::Model::FSalesItemGroupMasterPtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Showcase::Model::FSalesItemGroupMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Showcase::Model::FSalesItemGroupMasterPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Showcase::Model::FSalesItemGroupMaster>(CacheOwnerValue));
            if (CacheOwnerArgumentCallback) CacheOwnerArgumentCallback(CacheOwnerTypedValues);
        });
    }

    void FSalesItemGroupMasterCache::ListUnsubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Showcase::Model::FSalesItemGroupMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
