...
{
    FRandomShowcaseBuyResult::FRandomShowcaseBuyResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithItem(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithTransactionId(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithStampSheet(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithAtomicCommit(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithTransaction(
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FRandomDisplayItem> FRandomShowcaseBuyResult::GetItem() const
    {
    ...
    TOptional<FString> FRandomShowcaseBuyResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FRandomShowcaseBuyResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FRandomShowcaseBuyResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FRandomShowcaseBuyResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FRandomShowcaseBuyResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FRandomShowcaseBuyResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FRandomShowcaseBuyResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FRandomShowcaseBuyResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FRandomShowcaseBuyResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FRandomShowcaseBuyResult> FRandomShowcaseBuyResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FRandomShowcaseBuyResult>()
    ...
    TSharedPtr<FJsonObject> FRandomShowcaseBuyResult::ToJson() const
    {
