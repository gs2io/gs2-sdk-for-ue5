...
{
    FForceReDrawByUserIdResult::FForceReDrawByUserIdResult():
        ItemsValue(nullptr)
    {
    }
    ...
    TSharedPtr<FForceReDrawByUserIdResult> FForceReDrawByUserIdResult::WithItems(
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FRandomDisplayItem>>> FForceReDrawByUserIdResult::GetItems() const
    {
    ...
    TSharedPtr<FForceReDrawByUserIdResult> FForceReDrawByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FForceReDrawByUserIdResult>()
