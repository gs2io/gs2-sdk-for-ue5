...
#include "Showcase/Result/BuyResult.h"

namespace Gs2::Showcase::Result
{
    FBuyResult::FBuyResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithItem(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithTransactionId(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithStampSheet(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithAtomicCommit(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithTransaction(
    ...
    TSharedPtr<FBuyResult> FBuyResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FSalesItem> FBuyResult::GetItem() const
    {
    ...
    TOptional<FString> FBuyResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FBuyResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FBuyResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FBuyResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FBuyResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FBuyResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FBuyResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FBuyResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FBuyResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FBuyResult> FBuyResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FBuyResult>()
    ...
    TSharedPtr<FJsonObject> FBuyResult::ToJson() const
    {
