...
{
    FBuyByUserIdResult::FBuyByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithItem(
        const TSharedPtr<Model::FSalesItem> Item
    )
    {
        this->ItemValue = Item;
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FSalesItem> FBuyByUserIdResult::GetItem() const
    {
    ...
    TOptional<FString> FBuyByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FBuyByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FBuyByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FBuyByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FBuyByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FBuyByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FBuyByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FBuyByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FBuyByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FBuyByUserIdResult> FBuyByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FBuyByUserIdResult>()
            ->WithItem(Data->HasField(ANSI_TO_TCHAR("item")) ? [Data]() -> Model::FSalesItemPtr
                 {
                    if (Data->HasTypedField<EJson::Null>(ANSI_TO_TCHAR("item")))
                    {
                        return nullptr;
                    }
                    return Model::FSalesItem::FromJson(Data->GetObjectField(ANSI_TO_TCHAR("item")));
                 }() : nullptr)
    ...
    TSharedPtr<FJsonObject> FBuyByUserIdResult::ToJson() const
    {
