...
namespace Gs2::Showcase::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Showcase::Model::Cache::FSalesItemMasterCache::Delete(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Showcase::Model::FSalesItemMasterPtr Value;
                const auto CacheHit = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->SalesItemName,
                    TOptional<int32>(),
                    [Self](Gs2::Showcase::Model::FSalesItemMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FSalesItemMasterDomain::Invalidate()
    {
        Gs2::Showcase::Model::Cache::FSalesItemMasterCache::Delete(
            Gs2->Cache,
    ...
    FSalesItemMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FSalesItemMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSalesItemMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSalesItemMasterDomain::FSubscribeWithInitialCallTask>> FSalesItemMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Showcase::Model::FSalesItemMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Showcase::Model::Cache::FSalesItemMasterCache::CreateCacheKey(
        ...
        const TOptional<FString> QuerySalesItemName = SalesItemName;
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QuerySalesItemName]()
            {
                ...
                const auto Domain = MakeShared<FSalesItemMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QuerySalesItemName
