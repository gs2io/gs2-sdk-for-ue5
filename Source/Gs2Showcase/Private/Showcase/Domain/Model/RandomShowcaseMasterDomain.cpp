...
namespace Gs2::Showcase::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete(Gs2::Showcase::Model::FRandomShowcaseMaster::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::Showcase::Model::FRandomShowcaseMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::Showcase::Model::FRandomShowcaseMaster>(
                Self->ParentKey,
                Gs2::Showcase::Domain::Model::FRandomShowcaseMasterDomain::CreateCacheKey(
                    Self->ShowcaseName
                ),
