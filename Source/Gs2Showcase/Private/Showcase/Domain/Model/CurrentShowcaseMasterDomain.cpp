...
namespace Gs2::Showcase::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Showcase::Model::FCurrentShowcaseMasterPtr Value;
                const auto CacheHit = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Showcase::Model::FCurrentShowcaseMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FCurrentShowcaseMasterDomain::Invalidate()
    {
        Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::Delete(
            Gs2->Cache,
    ...
    FCurrentShowcaseMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCurrentShowcaseMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentShowcaseMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCurrentShowcaseMasterDomain::FSubscribeWithInitialCallTask>> FCurrentShowcaseMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Showcase::Model::FCurrentShowcaseMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Showcase::Model::Cache::FCurrentShowcaseMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName]()
            {
                ...
                const auto Domain = MakeShared<FCurrentShowcaseMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName
                );
