...
namespace Gs2::Showcase::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FIncrementPurchaseCountByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FIncrementPurchaseCountByUserIdRequest::FromJson(RequestModelJson);
            Request = FIncrementPurchaseCountByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FIncrementPurchaseCountByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
