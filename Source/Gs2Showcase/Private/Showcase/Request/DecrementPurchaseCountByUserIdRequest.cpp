...
namespace Gs2::Showcase::Request
{
    ...
    TSharedPtr<FDecrementPurchaseCountByUserIdRequest> FDecrementPurchaseCountByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDecrementPurchaseCountByUserIdRequest::GetTimeOffsetToken() const
    {
