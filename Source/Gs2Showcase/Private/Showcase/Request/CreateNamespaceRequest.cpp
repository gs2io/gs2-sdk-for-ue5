...
#include "Showcase/Request/CreateNamespaceRequest.h"
...
namespace Gs2::Showcase::Request
{
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithBuyScript(
    ...
    TSharedPtr<Model::FScriptSetting> FCreateNamespaceRequest::GetBuyScript() const
    {
