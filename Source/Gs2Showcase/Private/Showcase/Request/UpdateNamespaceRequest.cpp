...
#include "Showcase/Request/UpdateNamespaceRequest.h"
...
namespace Gs2::Showcase::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithBuyScript(
        const TSharedPtr<Model::FScriptSetting> BuyScript
    )
    {
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetBuyScript() const
    {
        if (!BuyScriptValue.IsValid())
        {
            return nullptr;
        }
