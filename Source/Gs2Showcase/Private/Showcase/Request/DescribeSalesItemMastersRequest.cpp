...
namespace Gs2::Showcase::Request
{
    ...
    TSharedPtr<FDescribeSalesItemMastersRequest> FDescribeSalesItemMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeSalesItemMastersRequest::GetNamePrefix() const
    {
