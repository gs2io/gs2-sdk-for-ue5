...
namespace Gs2::Showcase::Request
{
    ...
    TSharedPtr<FUpdateCurrentShowcaseMasterRequest> FUpdateCurrentShowcaseMasterRequest::WithMode(
    ...
    TSharedPtr<FUpdateCurrentShowcaseMasterRequest> FUpdateCurrentShowcaseMasterRequest::WithUploadToken(
    ...
    TOptional<FString> FUpdateCurrentShowcaseMasterRequest::GetMode() const
    {
        return ModeValue;
    }
    ...
    TOptional<FString> FUpdateCurrentShowcaseMasterRequest::GetUploadToken() const
    {
