...
namespace Gs2::Distributor::Domain::SpeculativeExecutor
{
    ...
    class GS2DISTRIBUTOR_API FAndExpressionByUserIdSpeculativeExecutor
    {
    public:
        ...
        public:
            GS2DISTRIBUTOR_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Distributor::Domain::FGs2DistributorDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Distributor::Request::FAndExpressionByUserIdRequestPtr& Request,
            ...
            GS2DISTRIBUTOR_API FCommitTask(
        ...
        static Gs2::Distributor::Request::FAndExpressionByUserIdRequestPtr Rate(
            const Gs2::Distributor::Request::FAndExpressionByUserIdRequestPtr& Request,
            const double Rate
        );
