...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    class GS2DISTRIBUTOR_API FDescribeUserDataIterator :
        public TSharedFromThis<FDescribeUserDataIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeUserDataIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeUserDataIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeUserDataIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeUserDataIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeUserDataIterator> FDescribeUserDataIteratorPtr;
}
