...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    public:
        ...
        FDescribeDistributorModelMastersIterator(
            const FDescribeDistributorModelMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Distributor::Model::FDistributorModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeDistributorModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Distributor::Model::FDistributorModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Distributor::Model::FDistributorModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDistributorModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDistributorModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDistributorModelMastersIterator> Iterable)
            {
