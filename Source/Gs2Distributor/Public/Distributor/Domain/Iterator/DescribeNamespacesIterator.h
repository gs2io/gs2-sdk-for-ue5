...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Distributor::Model::FNamespace>> Result) override;
        ...
        class GS2DISTRIBUTOR_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Distributor::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Distributor::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
