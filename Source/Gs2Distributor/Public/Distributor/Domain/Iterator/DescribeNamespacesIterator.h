...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    class GS2DISTRIBUTOR_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Distributor::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2DISTRIBUTOR_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Distributor::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::Distributor::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Distributor::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Distributor::Model::FNamespacePtr& operator*() const;
            Gs2::Distributor::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Distributor::Model::FNamespacePtr>>,
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(
            TSharedPtr<TSharedPtr<TArray<Gs2::Distributor::Model::FNamespacePtr>>> Result
        ) override;
    };
}
