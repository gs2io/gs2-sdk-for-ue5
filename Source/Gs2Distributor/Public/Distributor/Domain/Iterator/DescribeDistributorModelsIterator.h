...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    class GS2DISTRIBUTOR_API FDescribeDistributorModelsIterator :
        public TSharedFromThis<FDescribeDistributorModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Distributor::Model::FDistributorModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeDistributorModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Distributor::Model::FDistributorModelPtr>> Range;
            TOptional<TArray<Gs2::Distributor::Model::FDistributorModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDistributorModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDistributorModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDistributorModelsIterator> Iterable)
            {
