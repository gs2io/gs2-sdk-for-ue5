...
namespace Gs2::Distributor::Domain::Iterator
{
    ...
    class GS2DISTRIBUTOR_API FDescribeUserDataByUserIdIterator :
        public TSharedFromThis<FDescribeUserDataByUserIdIterator>
    {
    ...
    public:
        FDescribeUserDataByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Distributor::FGs2DistributorRestClientPtr Client,
            const TOptional<FString> UserId,
        ...
        class GS2DISTRIBUTOR_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Distributor::Model::FUserDataEntry>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Distributor::Model::FUserDataEntry>> Result) override;
        ...
        class GS2DISTRIBUTOR_API FIterator
        {
            TSharedRef<FDescribeUserDataByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Distributor::Model::FUserDataEntryPtr>> Range;
            TOptional<TArray<Gs2::Distributor::Model::FUserDataEntryPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Distributor::Model::FUserDataEntryPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeUserDataByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeUserDataByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeUserDataByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeUserDataByUserIdIterator> FDescribeUserDataByUserIdIteratorPtr;
}
