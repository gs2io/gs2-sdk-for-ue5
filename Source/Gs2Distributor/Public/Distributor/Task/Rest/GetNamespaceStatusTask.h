...
#include "Distributor/Request/GetNamespaceStatusRequest.h"
#include "Distributor/Result/GetNamespaceStatusResult.h"

namespace Gs2::Distributor::Task::Rest
{
    class GS2DISTRIBUTOR_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
