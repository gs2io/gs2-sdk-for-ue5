...
#include "Distributor/Request/GetServiceVersionRequest.h"
#include "Distributor/Result/GetServiceVersionResult.h"

namespace Gs2::Distributor::Task::Rest
{
    class GS2DISTRIBUTOR_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
