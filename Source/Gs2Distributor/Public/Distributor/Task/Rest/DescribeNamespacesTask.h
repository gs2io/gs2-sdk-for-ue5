...
#include "Distributor/Request/DescribeNamespacesRequest.h"
#include "Distributor/Result/DescribeNamespacesResult.h"

namespace Gs2::Distributor::Task::Rest
{
    class GS2DISTRIBUTOR_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
