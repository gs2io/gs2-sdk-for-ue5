...
#include "Distributor/Request/DeleteNamespaceRequest.h"
#include "Distributor/Result/DeleteNamespaceResult.h"

namespace Gs2::Distributor::Task::WebSocket
{
    class GS2DISTRIBUTOR_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
