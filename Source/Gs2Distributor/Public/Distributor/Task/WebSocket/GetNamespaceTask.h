...
#include "Distributor/Request/GetNamespaceRequest.h"
#include "Distributor/Result/GetNamespaceResult.h"

namespace Gs2::Distributor::Task::WebSocket
{
    class GS2DISTRIBUTOR_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
