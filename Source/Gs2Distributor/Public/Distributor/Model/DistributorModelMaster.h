...
{
    class GS2DISTRIBUTOR_API FDistributorModelMaster final : public FGs2Object, public TSharedFromThis<FDistributorModelMaster>
    {
    ...
    public:
        ...
        virtual ~FDistributorModelMaster() override = default;
