...
namespace Gs2::Distributor::Model
{
    ...
    public:
        ...
        static TSharedPtr<FCurrentDistributorMaster> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;

        static FString TypeName;
    };
    typedef TSharedPtr<FCurrentDistributorMaster, ESPMode::ThreadSafe> FCurrentDistributorMasterPtr;
}