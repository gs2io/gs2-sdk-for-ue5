...
#include "Distributor/Task/Rest/RunVerifyTaskTask.h"
...
{
    FRunVerifyTaskTask::FRunVerifyTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FRunVerifyTaskTask::Action(
        const TSharedPtr<Result::FRunVerifyTaskResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/distribute/stamp/verifyTask/run");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRunVerifyTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
