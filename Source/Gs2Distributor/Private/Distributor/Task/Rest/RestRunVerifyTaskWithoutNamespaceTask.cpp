...
#include "Distributor/Task/Rest/RunVerifyTaskWithoutNamespaceTask.h"
...
namespace Gs2::Distributor::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetVerifyTask().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("verifyTask"), this->Request->GetVerifyTask().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRunVerifyTaskWithoutNamespaceResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
