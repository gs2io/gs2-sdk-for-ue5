...
#include "Distributor/Task/Rest/SignFreezeMasterDataTimestampTask.h"
...
{
    FSignFreezeMasterDataTimestampTask::FSignFreezeMasterDataTimestampTask(
    ...
    Core::Model::FGs2ErrorPtr FSignFreezeMasterDataTimestampTask::Action(
        const TSharedPtr<Result::FSignFreezeMasterDataTimestampResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/masterdata/freeze/timestamp");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSignFreezeMasterDataTimestampResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
