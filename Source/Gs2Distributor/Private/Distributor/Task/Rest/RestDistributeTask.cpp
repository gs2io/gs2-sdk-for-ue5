...
#include "Distributor/Task/Rest/DistributeTask.h"
...
{
    FDistributeTask::FDistributeTask(
    ...
    Core::Model::FGs2ErrorPtr FDistributeTask::Action(
        const TSharedPtr<Result::FDistributeResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/distribute/{distributorName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDistributeResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
