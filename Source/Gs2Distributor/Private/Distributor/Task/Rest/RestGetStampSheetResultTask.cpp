...
#include "Distributor/Task/Rest/GetStampSheetResultTask.h"
...
{
    FGetStampSheetResultTask::FGetStampSheetResultTask(
    ...
    FGetStampSheetResultTask::FGetStampSheetResultTask(
        const FGetStampSheetResultTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetStampSheetResultTask::Action(
        const TSharedPtr<Result::FGetStampSheetResultResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/stampSheet/{transactionId}/result");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStampSheetResultResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
