...
#include "Distributor/Task/Rest/CreateDistributorModelMasterTask.h"
...
{
    FCreateDistributorModelMasterTask::FCreateDistributorModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateDistributorModelMasterTask::Action(
        const TSharedPtr<Result::FCreateDistributorModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/distributor");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateDistributorModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
