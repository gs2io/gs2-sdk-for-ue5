...
#include "Distributor/Task/Rest/IfExpressionByUserIdTask.h"
...
{
    FIfExpressionByUserIdTask::FIfExpressionByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FIfExpressionByUserIdTask::Action(
        const TSharedPtr<Result::FIfExpressionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/expression/if");
            ...
            if (this->Request->GetTrueActions() != nullptr && this->Request->GetTrueActions().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetTrueActions())
                {
            ...
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetFalseActions())
                {
                    v.Add(MakeShared<FJsonValueObject>(JsonObjectValue->ToJson()));
                }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIfExpressionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
