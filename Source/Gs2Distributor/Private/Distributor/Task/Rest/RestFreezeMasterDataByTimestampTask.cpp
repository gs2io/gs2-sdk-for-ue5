...
#include "Distributor/Task/Rest/FreezeMasterDataByTimestampTask.h"
...
{
    FFreezeMasterDataByTimestampTask::FFreezeMasterDataByTimestampTask(
    ...
    Core::Model::FGs2ErrorPtr FFreezeMasterDataByTimestampTask::Action(
        const TSharedPtr<Result::FFreezeMasterDataByTimestampResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/masterdata/freeze/timestamp/raw");
            ...
            if (this->Request->GetTimestamp().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("timestamp"), FString::Printf(TEXT("%lld"), this->Request->GetTimestamp().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FFreezeMasterDataByTimestampResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
