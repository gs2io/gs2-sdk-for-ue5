...
#include "Distributor/Task/Rest/DeleteDistributorModelMasterTask.h"
...
{
    FDeleteDistributorModelMasterTask::FDeleteDistributorModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteDistributorModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteDistributorModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteDistributorModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
