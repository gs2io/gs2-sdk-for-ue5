...
#include "Distributor/Task/Rest/GetTransactionResultTask.h"
...
{
    FGetTransactionResultTask::FGetTransactionResultTask(
    ...
    Core::Model::FGs2ErrorPtr FGetTransactionResultTask::Action(
        const TSharedPtr<Result::FGetTransactionResultResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/transaction/{transactionId}/result");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetTransactionResultResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
