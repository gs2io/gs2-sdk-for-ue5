...
#include "Distributor/Task/Rest/GetDistributorModelTask.h"
...
{
    FGetDistributorModelTask::FGetDistributorModelTask(
    ...
    FGetDistributorModelTask::FGetDistributorModelTask(
        const FGetDistributorModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetDistributorModelTask::Action(
        const TSharedPtr<Result::FGetDistributorModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/distributor/{distributorName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDistributorModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
