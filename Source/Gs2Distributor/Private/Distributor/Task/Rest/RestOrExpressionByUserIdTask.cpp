...
#include "Distributor/Task/Rest/OrExpressionByUserIdTask.h"
...
{
    FOrExpressionByUserIdTask::FOrExpressionByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FOrExpressionByUserIdTask::Action(
        const TSharedPtr<Result::FOrExpressionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/expression/or");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FOrExpressionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
