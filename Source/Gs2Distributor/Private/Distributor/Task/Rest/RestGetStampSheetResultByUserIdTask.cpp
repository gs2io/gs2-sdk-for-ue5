...
#include "Distributor/Task/Rest/GetStampSheetResultByUserIdTask.h"
...
{
    FGetStampSheetResultByUserIdTask::FGetStampSheetResultByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStampSheetResultByUserIdTask::Action(
        const TSharedPtr<Result::FGetStampSheetResultByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/stampSheet/{transactionId}/result");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStampSheetResultByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
