...
#include "Distributor/Task/Rest/AndExpressionByUserIdTask.h"
...
{
    FAndExpressionByUserIdTask::FAndExpressionByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAndExpressionByUserIdTask::Action(
        const TSharedPtr<Result::FAndExpressionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/expression/and");
            ...
            if (this->Request->GetActions() != nullptr && this->Request->GetActions().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetActions())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAndExpressionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
