...
#include "Distributor/Task/Rest/GetDistributorModelMasterTask.h"
...
{
    FGetDistributorModelMasterTask::FGetDistributorModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetDistributorModelMasterTask::Action(
        const TSharedPtr<Result::FGetDistributorModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDistributorModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
