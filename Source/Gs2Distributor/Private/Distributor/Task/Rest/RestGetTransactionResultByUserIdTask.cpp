...
#include "Distributor/Task/Rest/GetTransactionResultByUserIdTask.h"
...
{
    FGetTransactionResultByUserIdTask::FGetTransactionResultByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetTransactionResultByUserIdTask::Action(
        const TSharedPtr<Result::FGetTransactionResultByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/transaction/{transactionId}/result");
            ...
            Url = Url.Replace(
                TEXT("{transactionId}"),
                !this->Request->GetTransactionId().IsSet() || this->Request->GetTransactionId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetTransactionId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetTransactionResultByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
