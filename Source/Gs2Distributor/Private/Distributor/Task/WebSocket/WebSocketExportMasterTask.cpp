...
#include "Distributor/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Distributor::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("distributor"), TEXT("currentDistributorMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
