...
{
    FPreUpdateCurrentDistributorMasterResult::FPreUpdateCurrentDistributorMasterResult():
    ...
    FPreUpdateCurrentDistributorMasterResult::FPreUpdateCurrentDistributorMasterResult(
        const FPreUpdateCurrentDistributorMasterResult& From
    ):
    ...
    TSharedPtr<FPreUpdateCurrentDistributorMasterResult> FPreUpdateCurrentDistributorMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentDistributorMasterResult> FPreUpdateCurrentDistributorMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentDistributorMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentDistributorMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentDistributorMasterResult> FPreUpdateCurrentDistributorMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentDistributorMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentDistributorMasterResult::ToJson() const
    {
