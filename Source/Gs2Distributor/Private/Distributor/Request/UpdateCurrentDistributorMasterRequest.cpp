...
namespace Gs2::Distributor::Request
{
    ...
    TSharedPtr<FUpdateCurrentDistributorMasterRequest> FUpdateCurrentDistributorMasterRequest::WithMode(
    ...
    TSharedPtr<FUpdateCurrentDistributorMasterRequest> FUpdateCurrentDistributorMasterRequest::WithUploadToken(
    ...
    TOptional<FString> FUpdateCurrentDistributorMasterRequest::GetMode() const
    {
        return ModeValue;
    }
    ...
    TOptional<FString> FUpdateCurrentDistributorMasterRequest::GetUploadToken() const
    {
