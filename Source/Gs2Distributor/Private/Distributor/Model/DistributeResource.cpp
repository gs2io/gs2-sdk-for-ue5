...
{
    FDistributeResource::FDistributeResource():
    ...
    TSharedPtr<FDistributeResource> FDistributeResource::WithAction(
    ...
    TSharedPtr<FDistributeResource> FDistributeResource::WithRequest(
    ...
    TOptional<FString> FDistributeResource::GetAction() const
    {
        return ActionValue;
    }
    TOptional<FString> FDistributeResource::GetRequest() const
    {
        return RequestValue;
    }

    TSharedPtr<FDistributeResource> FDistributeResource::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
    ...
    TSharedPtr<FJsonObject> FDistributeResource::ToJson() const
    {
    ...
    FString FDistributeResource::TypeName = "DistributeResource";
}