...
namespace Gs2::SerialKey::Request
{
    ...
    TSharedPtr<FDescribeCampaignModelMastersRequest> FDescribeCampaignModelMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeCampaignModelMastersRequest::GetNamePrefix() const
    {
