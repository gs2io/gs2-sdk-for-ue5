...
{
    FRevertUseByStampSheetResult::FRevertUseByStampSheetResult():
        ItemValue(nullptr),
    ...
    FRevertUseByStampSheetResult::FRevertUseByStampSheetResult(
        const FRevertUseByStampSheetResult& From
    ):
    ...
    TSharedPtr<FRevertUseByStampSheetResult> FRevertUseByStampSheetResult::WithItem(
    ...
    TSharedPtr<FRevertUseByStampSheetResult> FRevertUseByStampSheetResult::WithCampaignModel(
    ...
    TSharedPtr<Model::FSerialKey> FRevertUseByStampSheetResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FCampaignModel> FRevertUseByStampSheetResult::GetCampaignModel() const
    {
    ...
    TSharedPtr<FRevertUseByStampSheetResult> FRevertUseByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FRevertUseByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FRevertUseByStampSheetResult::ToJson() const
    {
