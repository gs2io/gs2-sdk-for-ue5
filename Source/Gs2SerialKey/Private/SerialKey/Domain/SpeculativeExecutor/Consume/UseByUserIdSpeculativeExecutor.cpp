...
namespace Gs2::SerialKey::Domain::SpeculativeExecutor
{
    ...
    {
        return FString("Gs2SerialKey:UseByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FUseByUserIdSpeculativeExecutor::Transform(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::SerialKey::Request::FUseByUserIdRequestPtr& Request,
    ...
    FUseByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
    ...
    TSharedPtr<FAsyncTask<FUseByUserIdSpeculativeExecutor::FCommitTask>> FUseByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::SerialKey::Domain::FGs2SerialKeyDomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::SerialKey::Request::FUseByUserIdRequestPtr& Request
    ...
    Gs2::SerialKey::Request::FUseByUserIdRequestPtr FUseByUserIdSpeculativeExecutor::Rate(
        const Gs2::SerialKey::Request::FUseByUserIdRequestPtr& Request,
        const double Rate
    )
    {
