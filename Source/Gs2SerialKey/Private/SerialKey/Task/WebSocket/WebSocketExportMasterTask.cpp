...
#include "SerialKey/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::SerialKey::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("serialKey"), TEXT("currentCampaignMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
