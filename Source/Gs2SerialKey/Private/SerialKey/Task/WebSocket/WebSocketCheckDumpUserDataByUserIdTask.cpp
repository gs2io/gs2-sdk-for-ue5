...
#include "SerialKey/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::SerialKey::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("serialKey"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
