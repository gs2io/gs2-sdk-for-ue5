...
#include "SerialKey/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::SerialKey::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("serialKey"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
