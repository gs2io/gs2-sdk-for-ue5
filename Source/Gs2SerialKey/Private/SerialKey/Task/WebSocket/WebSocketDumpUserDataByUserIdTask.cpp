...
#include "SerialKey/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::SerialKey::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("serialKey"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
