...
#include "SerialKey/Task/Rest/GetSerialKeyTask.h"
...
{
    FGetSerialKeyTask::FGetSerialKeyTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSerialKeyTask::Action(
        const TSharedPtr<Result::FGetSerialKeyResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/serialKey/{code}");
            ...
            Url = Url.Replace(
                TEXT("{code}"),
                !this->Request->GetCode().IsSet() || this->Request->GetCode().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetCode())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSerialKeyResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
