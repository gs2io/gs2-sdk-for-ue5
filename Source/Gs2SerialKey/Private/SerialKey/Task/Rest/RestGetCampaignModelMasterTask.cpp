...
#include "SerialKey/Task/Rest/GetCampaignModelMasterTask.h"
...
{
    FGetCampaignModelMasterTask::FGetCampaignModelMasterTask(
    ...
    FGetCampaignModelMasterTask::FGetCampaignModelMasterTask(
        const FGetCampaignModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetCampaignModelMasterTask::Action(
        const TSharedPtr<Result::FGetCampaignModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetCampaignModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
