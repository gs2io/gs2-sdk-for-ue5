...
#include "SerialKey/Task/Rest/GetCampaignModelTask.h"
...
{
    FGetCampaignModelTask::FGetCampaignModelTask(
    ...
    FGetCampaignModelTask::FGetCampaignModelTask(
        const FGetCampaignModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetCampaignModelTask::Action(
        const TSharedPtr<Result::FGetCampaignModelResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetCampaignModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
