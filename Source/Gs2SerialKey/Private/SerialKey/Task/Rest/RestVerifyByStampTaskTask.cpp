...
#include "SerialKey/Task/Rest/VerifyByStampTaskTask.h"
...
{
    FVerifyByStampTaskTask::FVerifyByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyByStampTaskTask::Action(
        const TSharedPtr<Result::FVerifyByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
