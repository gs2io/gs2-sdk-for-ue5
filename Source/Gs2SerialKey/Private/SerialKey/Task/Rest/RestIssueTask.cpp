...
#include "SerialKey/Task/Rest/IssueTask.h"
...
namespace Gs2::SerialKey::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FIssueTask::Action(
        const TSharedPtr<Result::FIssueResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/campaign/{campaignModelName}");
            ...
            if (this->Request->GetIssueRequestCount().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("issueRequestCount"), this->Request->GetIssueRequestCount().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIssueResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
