...
#include "SerialKey/Task/Rest/UseByUserIdTask.h"
...
{
    FUseByUserIdTask::FUseByUserIdTask(
    ...
    FUseByUserIdTask::FUseByUserIdTask(
        const FUseByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUseByUserIdTask::Action(
        const TSharedPtr<Result::FUseByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/serialKey");
            ...
            if (this->Request->GetCode().IsSet() && !this->Request->GetCode().GetValue().IsEmpty())
            {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUseByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
