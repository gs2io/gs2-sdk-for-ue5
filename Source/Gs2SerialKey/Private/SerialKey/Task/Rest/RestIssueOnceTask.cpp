...
#include "SerialKey/Task/Rest/IssueOnceTask.h"
...
namespace Gs2::SerialKey::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FIssueOnceTask::Action(
        const TSharedPtr<Result::FIssueOnceResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/campaign/{campaignModelName}/serialKey");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FIssueOnceResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
