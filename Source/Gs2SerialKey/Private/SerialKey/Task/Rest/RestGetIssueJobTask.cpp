...
#include "SerialKey/Task/Rest/GetIssueJobTask.h"
...
{
    FGetIssueJobTask::FGetIssueJobTask(
    ...
    FGetIssueJobTask::FGetIssueJobTask(
        const FGetIssueJobTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetIssueJobTask::Action(
        const TSharedPtr<Result::FGetIssueJobResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/campaign/{campaignModelName}/issue/{issueJobName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetIssueJobResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
