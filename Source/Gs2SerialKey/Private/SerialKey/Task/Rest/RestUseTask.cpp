...
#include "SerialKey/Task/Rest/UseTask.h"
...
namespace Gs2::SerialKey::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FUseTask::Action(
        const TSharedPtr<Result::FUseResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/serialKey");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUseResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
