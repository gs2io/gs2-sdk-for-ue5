...
#include "SerialKey/Task/Rest/DeleteCampaignModelMasterTask.h"
...
{
    FDeleteCampaignModelMasterTask::FDeleteCampaignModelMasterTask(
    ...
    FDeleteCampaignModelMasterTask::FDeleteCampaignModelMasterTask(
        const FDeleteCampaignModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteCampaignModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteCampaignModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteCampaignModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
