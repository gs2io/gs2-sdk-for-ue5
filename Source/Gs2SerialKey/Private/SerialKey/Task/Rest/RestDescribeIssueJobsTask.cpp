...
#include "SerialKey/Task/Rest/DescribeIssueJobsTask.h"
...
{
    FDescribeIssueJobsTask::FDescribeIssueJobsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeIssueJobsTask::Action(
        const TSharedPtr<Result::FDescribeIssueJobsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/campaign/{campaignModelName}/issue");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeIssueJobsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
