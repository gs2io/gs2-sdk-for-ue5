...
#include "SerialKey/Task/Rest/DownloadSerialCodesTask.h"
...
{
    FDownloadSerialCodesTask::FDownloadSerialCodesTask(
    ...
    Core::Model::FGs2ErrorPtr FDownloadSerialCodesTask::Action(
        const TSharedPtr<Result::FDownloadSerialCodesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/campaign/{campaignModelName}/issue/{issueJobName}/serialCode/download");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDownloadSerialCodesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
