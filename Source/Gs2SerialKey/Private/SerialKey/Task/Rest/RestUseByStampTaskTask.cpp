...
#include "SerialKey/Task/Rest/UseByStampTaskTask.h"
...
{
    FUseByStampTaskTask::FUseByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FUseByStampTaskTask::Action(
        const TSharedPtr<Result::FUseByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUseByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
