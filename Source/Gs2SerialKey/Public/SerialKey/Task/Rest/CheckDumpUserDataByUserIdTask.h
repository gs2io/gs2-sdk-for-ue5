...
#include "SerialKey/Request/CheckDumpUserDataByUserIdRequest.h"
#include "SerialKey/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
