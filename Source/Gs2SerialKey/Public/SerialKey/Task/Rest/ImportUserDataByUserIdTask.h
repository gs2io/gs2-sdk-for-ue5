...
#include "SerialKey/Request/ImportUserDataByUserIdRequest.h"
#include "SerialKey/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
