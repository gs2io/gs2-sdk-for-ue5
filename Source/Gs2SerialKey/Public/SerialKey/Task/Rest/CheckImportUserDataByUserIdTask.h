...
#include "SerialKey/Request/CheckImportUserDataByUserIdRequest.h"
#include "SerialKey/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
