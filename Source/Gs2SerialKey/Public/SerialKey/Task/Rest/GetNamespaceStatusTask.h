...
#include "SerialKey/Request/GetNamespaceStatusRequest.h"
#include "SerialKey/Result/GetNamespaceStatusResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
