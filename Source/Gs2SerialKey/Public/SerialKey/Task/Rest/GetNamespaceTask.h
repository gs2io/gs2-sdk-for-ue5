...
#include "SerialKey/Request/GetNamespaceRequest.h"
#include "SerialKey/Result/GetNamespaceResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
