...
#include "SerialKey/Request/GetServiceVersionRequest.h"
#include "SerialKey/Result/GetServiceVersionResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
