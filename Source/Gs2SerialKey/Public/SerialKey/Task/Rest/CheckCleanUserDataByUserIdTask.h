...
#include "SerialKey/Request/CheckCleanUserDataByUserIdRequest.h"
#include "SerialKey/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
