...
#include "SerialKey/Request/DescribeNamespacesRequest.h"
#include "SerialKey/Result/DescribeNamespacesResult.h"

namespace Gs2::SerialKey::Task::Rest
{
    class GS2SERIALKEY_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
