...
#include "SerialKey/Request/CreateNamespaceRequest.h"
#include "SerialKey/Result/CreateNamespaceResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
