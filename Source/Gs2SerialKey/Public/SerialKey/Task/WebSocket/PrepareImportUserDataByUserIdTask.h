...
#include "SerialKey/Request/PrepareImportUserDataByUserIdRequest.h"
#include "SerialKey/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
