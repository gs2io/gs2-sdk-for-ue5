...
#include "SerialKey/Request/UpdateNamespaceRequest.h"
#include "SerialKey/Result/UpdateNamespaceResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
