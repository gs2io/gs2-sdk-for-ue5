...
#include "SerialKey/Request/DeleteNamespaceRequest.h"
#include "SerialKey/Result/DeleteNamespaceResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
