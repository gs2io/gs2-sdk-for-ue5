...
#include "SerialKey/Request/DumpUserDataByUserIdRequest.h"
#include "SerialKey/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
