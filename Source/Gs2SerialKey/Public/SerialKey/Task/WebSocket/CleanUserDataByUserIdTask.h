...
#include "SerialKey/Request/CleanUserDataByUserIdRequest.h"
#include "SerialKey/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::SerialKey::Task::WebSocket
{
    class GS2SERIALKEY_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
