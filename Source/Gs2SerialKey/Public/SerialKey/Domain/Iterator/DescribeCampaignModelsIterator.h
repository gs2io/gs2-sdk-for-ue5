...
namespace Gs2::SerialKey::Domain::Iterator
{
    ...
    class GS2SERIALKEY_API FDescribeCampaignModelsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::SerialKey::Model::FCampaignModel, FDescribeCampaignModelsIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::SerialKey::FGs2SerialKeyRestClientPtr Client;

        friend FDescribeCampaignModelsIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeCampaignModelsIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeCampaignModelsIterator;
        ...
        public:
            ...
            const Gs2::SerialKey::Model::FCampaignModelPtr& operator*() const;
            Gs2::SerialKey::Model::FCampaignModelPtr operator->();
    ...
    class FDescribeCampaignModelsIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::SerialKey::Model::FCampaignModelPtr>>,
        public TSharedFromThis<FDescribeCampaignModelsIteratorLoadTask>
    {
        TSharedPtr<FDescribeCampaignModelsIterator> Self;
