...
namespace Gs2::SerialKey::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SerialKey::Model::FNamespace>> Result) override;
        ...
        class GS2SERIALKEY_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::SerialKey::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::SerialKey::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
