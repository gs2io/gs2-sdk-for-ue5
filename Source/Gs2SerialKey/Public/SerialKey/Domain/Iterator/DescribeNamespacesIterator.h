...
namespace Gs2::SerialKey::Domain::Iterator
{
    ...
    class GS2SERIALKEY_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::SerialKey::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2SERIALKEY_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::SerialKey::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::SerialKey::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::SerialKey::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::SerialKey::Model::FNamespacePtr& operator*() const;
            Gs2::SerialKey::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::SerialKey::Model::FNamespacePtr>>,
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(
            TSharedPtr<TSharedPtr<TArray<Gs2::SerialKey::Model::FNamespacePtr>>> Result
        ) override;
    };
}
