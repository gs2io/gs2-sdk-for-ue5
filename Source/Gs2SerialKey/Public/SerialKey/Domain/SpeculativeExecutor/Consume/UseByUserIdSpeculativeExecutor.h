...
namespace Gs2::SerialKey::Domain::SpeculativeExecutor
{
    ...
    class GS2SERIALKEY_API FUseByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        class GS2SERIALKEY_API FCommitTask final :
        ...
        static Gs2::SerialKey::Request::FUseByUserIdRequestPtr Rate(
            const Gs2::SerialKey::Request::FUseByUserIdRequestPtr& Request,
            const double Rate
        );
