...
#include "Lock/Task/Rest/UnlockByUserIdTask.h"
...
{
    FUnlockByUserIdTask::FUnlockByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FUnlockByUserIdTask::Action(
        const TSharedPtr<Result::FUnlockByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/mutex/{propertyId}/unlock");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUnlockByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
