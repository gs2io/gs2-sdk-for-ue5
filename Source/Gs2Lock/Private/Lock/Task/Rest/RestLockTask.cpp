...
#include "Lock/Task/Rest/LockTask.h"
...
namespace Gs2::Lock::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FLockTask::Action(
        const TSharedPtr<Result::FLockResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/mutex/{propertyId}/lock");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FLockResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
