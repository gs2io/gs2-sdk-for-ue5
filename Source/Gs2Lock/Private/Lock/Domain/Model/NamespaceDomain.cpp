...
namespace Gs2::Lock::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Gs2->Cache->Delete(Gs2::Lock::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        TSharedPtr<Gs2::Lock::Model::FNamespace> Value;
        auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::Lock::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Gs2->Cache->TryGet<Gs2::Lock::Model::FNamespace>(
                ParentKey,
                Gs2::Lock::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
