...
namespace Gs2::Lock::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Lock::Model::Cache::FNamespaceCache::Delete(
            Self->Gs2->Cache,
    ...
    TSharedPtr<Gs2::Lock::Domain::Model::FUserDomain> FNamespaceDomain::User(
        const FString UserId
    )
    {
        return MakeShared<Gs2::Lock::Domain::Model::FUserDomain>(
            Gs2,
            Service,
            NamespaceName,
    ...
    TSharedPtr<Gs2::Lock::Domain::Model::FUserAccessTokenDomain> FNamespaceDomain::AccessToken(
        Gs2::Auth::Model::FAccessTokenPtr AccessToken
    )
    {
        return MakeShared<Gs2::Lock::Domain::Model::FUserAccessTokenDomain>(
            Gs2,
            Service,
            NamespaceName,
            AccessToken
    ...
    {
        const auto CacheParentKey = Gs2::Lock::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Lock::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Lock::Model::FNamespacePtr Value;
                const auto CacheHit = Gs2::Lock::Model::Cache::FNamespaceCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Lock::Model::Cache::FNamespaceCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Lock::Model::FNamespacePtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Lock::Request::FGetNamespaceRequest>()
                        );
                        Future->StartSynchronousTask();
    ...
    {
        const auto SubscriptionParentKey = Gs2::Lock::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Lock::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Lock::Model::FNamespace>(obj));
            },
