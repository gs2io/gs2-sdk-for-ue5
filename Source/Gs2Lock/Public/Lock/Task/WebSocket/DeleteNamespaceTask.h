...
#include "Lock/Request/DeleteNamespaceRequest.h"
#include "Lock/Result/DeleteNamespaceResult.h"

namespace Gs2::Lock::Task::WebSocket
{
    class GS2LOCK_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
