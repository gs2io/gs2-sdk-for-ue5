...
#include "Lock/Request/GetServiceVersionRequest.h"
#include "Lock/Result/GetServiceVersionResult.h"

namespace Gs2::Lock::Task::WebSocket
{
    class GS2LOCK_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
