...
#include "Lock/Request/GetNamespaceRequest.h"
#include "Lock/Result/GetNamespaceResult.h"

namespace Gs2::Lock::Task::WebSocket
{
    class GS2LOCK_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
