...
#include "Lock/Request/CreateNamespaceRequest.h"
#include "Lock/Result/CreateNamespaceResult.h"

namespace Gs2::Lock::Task::Rest
{
    class GS2LOCK_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
