...
#include "Lock/Request/GetNamespaceStatusRequest.h"
#include "Lock/Result/GetNamespaceStatusResult.h"

namespace Gs2::Lock::Task::Rest
{
    class GS2LOCK_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
