...
#include "Lock/Request/DescribeNamespacesRequest.h"
#include "Lock/Result/DescribeNamespacesResult.h"

namespace Gs2::Lock::Task::Rest
{
    class GS2LOCK_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
