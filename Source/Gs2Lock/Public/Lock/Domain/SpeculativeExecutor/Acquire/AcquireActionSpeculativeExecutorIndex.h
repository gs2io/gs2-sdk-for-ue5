...
namespace Gs2::Lock::Domain::SpeculativeExecutor
{
    class GS2LOCK_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Lock::Domain::FGs2LockDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2LOCK_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Lock::Domain::FGs2LockDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2LOCK_API FCommitTask(
                const FCommitTask& From
            );

            GS2LOCK_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
