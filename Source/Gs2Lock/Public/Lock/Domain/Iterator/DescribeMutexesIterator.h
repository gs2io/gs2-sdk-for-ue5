...
namespace Gs2::Lock::Domain::Iterator
{
    ...
    class GS2LOCK_API FDescribeMutexesIterator :
        public TSharedFromThis<FDescribeMutexesIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeMutexesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMutexesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMutexesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMutexesIterator> Iterable)
            {
