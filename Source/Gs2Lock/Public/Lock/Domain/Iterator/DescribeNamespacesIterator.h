...
namespace Gs2::Lock::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Lock::Model::FNamespace>> Result) override;
        ...
        class GS2LOCK_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Lock::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Lock::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
