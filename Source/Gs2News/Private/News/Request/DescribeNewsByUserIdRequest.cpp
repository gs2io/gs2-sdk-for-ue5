...
namespace Gs2::News::Request
{
    ...
    TSharedPtr<FDescribeNewsByUserIdRequest> FDescribeNewsByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FDescribeNewsByUserIdRequest::GetTimeOffsetToken() const
    {
