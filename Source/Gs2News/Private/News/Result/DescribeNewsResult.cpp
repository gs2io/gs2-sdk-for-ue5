...
namespace Gs2::News::Result
{
    ...
    TSharedPtr<FDescribeNewsResult> FDescribeNewsResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FDescribeNewsResult>()
            ->WithItems(Data->HasField(ANSI_TO_TCHAR("items")) ? [Data]() -> TSharedPtr<TArray<Model::FNewsPtr>>
                 {
            ...
            ->WithContentHash(Data->HasField(ANSI_TO_TCHAR("contentHash")) ? [Data]() -> TOptional<FString>
                {
                    FString v("");
            ...
            ->WithTemplateHash(Data->HasField(ANSI_TO_TCHAR("templateHash")) ? [Data]() -> TOptional<FString>
                {
                    FString v("");
