...
namespace Gs2::News::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::News::Model::Cache::FOutputCache::CreateCacheParentKey(

            Self->NamespaceName,
            Self->UploadToken,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::News::Model::Cache::FOutputCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::News::Model::FOutputPtr Value;
                const auto CacheHit = Gs2::News::Model::Cache::FOutputCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::News::Model::Cache::FOutputCache::Fetch(
                    Self->Gs2->Cache,
                    ...
                    Self->OutputName,
                    TOptional<int32>(),
                    [Self](Gs2::News::Model::FOutputPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        Gs2::News::Model::Cache::FOutputCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::News::Model::Cache::FOutputCache::CreateCacheParentKey(

            NamespaceName,
            UploadToken,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::News::Model::Cache::FOutputCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryUploadToken, QueryOutputName]()
            {
