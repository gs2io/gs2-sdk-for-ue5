...
#include "News/Request/DescribeNamespacesRequest.h"
#include "News/Result/DescribeNamespacesResult.h"

namespace Gs2::News::Task::Rest
{
    class GS2NEWS_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
