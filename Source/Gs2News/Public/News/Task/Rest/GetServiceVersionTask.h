...
#include "News/Request/GetServiceVersionRequest.h"
#include "News/Result/GetServiceVersionResult.h"

namespace Gs2::News::Task::Rest
{
    class GS2NEWS_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
