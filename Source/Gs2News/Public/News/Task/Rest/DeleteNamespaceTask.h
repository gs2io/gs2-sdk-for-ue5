...
#include "News/Request/DeleteNamespaceRequest.h"
#include "News/Result/DeleteNamespaceResult.h"

namespace Gs2::News::Task::Rest
{
    class GS2NEWS_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
