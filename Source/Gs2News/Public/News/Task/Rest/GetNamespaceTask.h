...
#include "News/Request/GetNamespaceRequest.h"
#include "News/Result/GetNamespaceResult.h"

namespace Gs2::News::Task::Rest
{
    class GS2NEWS_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
