...
#include "News/Request/CreateNamespaceRequest.h"
#include "News/Result/CreateNamespaceResult.h"

namespace Gs2::News::Task::Rest
{
    class GS2NEWS_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
