...
#include "News/Request/UpdateNamespaceRequest.h"
#include "News/Result/UpdateNamespaceResult.h"

namespace Gs2::News::Task::WebSocket
{
    class GS2NEWS_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
