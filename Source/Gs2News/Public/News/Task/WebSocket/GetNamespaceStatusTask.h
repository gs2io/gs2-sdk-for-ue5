...
#include "News/Request/GetNamespaceStatusRequest.h"
#include "News/Result/GetNamespaceStatusResult.h"

namespace Gs2::News::Task::WebSocket
{
    class GS2NEWS_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
