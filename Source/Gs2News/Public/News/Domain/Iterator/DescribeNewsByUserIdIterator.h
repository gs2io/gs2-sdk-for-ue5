...
namespace Gs2::News::Domain::Iterator
{
    ...
    class GS2NEWS_API FDescribeNewsByUserIdIterator :
        public TSharedFromThis<FDescribeNewsByUserIdIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeNewsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeNewsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeNewsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeNewsByUserIdIterator> Iterable)
            {
