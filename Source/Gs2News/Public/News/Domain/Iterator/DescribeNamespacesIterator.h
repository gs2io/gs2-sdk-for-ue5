...
namespace Gs2::News::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::News::Model::FNamespace>> Result) override;
        ...
        class GS2NEWS_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::News::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::News::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
