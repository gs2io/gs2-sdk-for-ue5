...
namespace Gs2::News::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::News::Model::FProgress>> Result) override;
        ...
        {
            TSharedRef<FDescribeProgressesIterator> Self;
            TSharedPtr<TArray<Gs2::News::Model::FProgressPtr>> Range;
            TOptional<TArray<Gs2::News::Model::FProgressPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeProgressesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeProgressesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeProgressesIterator> Iterable)
            {
