...
namespace Gs2::News::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::News::Model::FOutput>> Result) override;
        ...
        class GS2NEWS_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::News::Model::FOutputPtr>> Range;
            TOptional<TArray<Gs2::News::Model::FOutputPtr>::TIterator> RangeIteratorOpt;
