...
namespace Gs2::News::Domain::SpeculativeExecutor
{
    class GS2NEWS_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::News::Domain::FGs2NewsDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2NEWS_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::News::Domain::FGs2NewsDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2NEWS_API FCommitTask(
                const FCommitTask& From
            );

            GS2NEWS_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
