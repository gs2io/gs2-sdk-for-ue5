...
{
    class GS2NEWS_API FNamespace final : public FGs2Object, public TSharedFromThis<FNamespace>
    {
    ...
    public:
        ...
        TSharedPtr<FNamespace> WithVersion(const TOptional<FString> Version);
