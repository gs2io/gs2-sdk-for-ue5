...
namespace Gs2::Formation::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FSubMoldCapacityByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FSubMoldCapacityByUserIdRequest::FromJson(RequestModelJson);
            Request = FSubMoldCapacityByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FSubMoldCapacityByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
