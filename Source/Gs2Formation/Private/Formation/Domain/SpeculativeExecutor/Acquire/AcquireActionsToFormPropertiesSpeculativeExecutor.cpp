...
namespace Gs2::Formation::Domain::SpeculativeExecutor
{
    ...
    FString FAcquireActionsToFormPropertiesSpeculativeExecutor::Action()
    {
        return FString("Gs2Formation:AcquireActionsToFormProperties");
    }
    ...
    Gs2::Formation::Request::FAcquireActionsToFormPropertiesRequestPtr FAcquireActionsToFormPropertiesSpeculativeExecutor::Rate(
        const Gs2::Formation::Request::FAcquireActionsToFormPropertiesRequestPtr& Request,
        const double Rate
    )
    {
