...
{
    FSubMoldCapacityByUserIdResult::FSubMoldCapacityByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FSubMoldCapacityByUserIdResult> FSubMoldCapacityByUserIdResult::WithItem(
    ...
    TSharedPtr<FSubMoldCapacityByUserIdResult> FSubMoldCapacityByUserIdResult::WithMoldModel(
    ...
    TSharedPtr<Model::FMold> FSubMoldCapacityByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FMoldModel> FSubMoldCapacityByUserIdResult::GetMoldModel() const
    {
    ...
    TSharedPtr<FSubMoldCapacityByUserIdResult> FSubMoldCapacityByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSubMoldCapacityByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FSubMoldCapacityByUserIdResult::ToJson() const
    {
