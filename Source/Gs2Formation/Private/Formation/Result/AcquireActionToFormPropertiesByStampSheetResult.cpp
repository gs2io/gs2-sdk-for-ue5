...
namespace Gs2::Formation::Result
{
    ...
    TSharedPtr<FAcquireActionToFormPropertiesByStampSheetResult> FAcquireActionToFormPropertiesByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FAcquireActionToFormPropertiesByStampSheetResult> FAcquireActionToFormPropertiesByStampSheetResult::WithTransaction(
    ...
    TSharedPtr<FAcquireActionToFormPropertiesByStampSheetResult> FAcquireActionToFormPropertiesByStampSheetResult::WithTransactionResult(
    ...
    TOptional<bool> FAcquireActionToFormPropertiesByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FAcquireActionToFormPropertiesByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FAcquireActionToFormPropertiesByStampSheetResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FAcquireActionToFormPropertiesByStampSheetResult::GetTransactionResult() const
    {
