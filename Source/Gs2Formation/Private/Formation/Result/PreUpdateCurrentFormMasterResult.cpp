...
{
    FPreUpdateCurrentFormMasterResult::FPreUpdateCurrentFormMasterResult():
    ...
    FPreUpdateCurrentFormMasterResult::FPreUpdateCurrentFormMasterResult(
        const FPreUpdateCurrentFormMasterResult& From
    ):
    ...
    TSharedPtr<FPreUpdateCurrentFormMasterResult> FPreUpdateCurrentFormMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentFormMasterResult> FPreUpdateCurrentFormMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentFormMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentFormMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentFormMasterResult> FPreUpdateCurrentFormMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentFormMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentFormMasterResult::ToJson() const
    {
