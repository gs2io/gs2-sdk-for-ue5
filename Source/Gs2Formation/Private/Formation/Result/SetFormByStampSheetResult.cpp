...
#include "Formation/Result/SetFormByStampSheetResult.h"

namespace Gs2::Formation::Result
{
    FSetFormByStampSheetResult::FSetFormByStampSheetResult():
        ItemValue(nullptr),
        MoldValue(nullptr),
    ...
    TSharedPtr<FSetFormByStampSheetResult> FSetFormByStampSheetResult::WithItem(
    ...
    TSharedPtr<FSetFormByStampSheetResult> FSetFormByStampSheetResult::WithMold(
    ...
    TSharedPtr<FSetFormByStampSheetResult> FSetFormByStampSheetResult::WithMoldModel(
    ...
    TSharedPtr<FSetFormByStampSheetResult> FSetFormByStampSheetResult::WithFormModel(
    ...
    TSharedPtr<Model::FForm> FSetFormByStampSheetResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FMold> FSetFormByStampSheetResult::GetMold() const
    {
    ...
    TSharedPtr<Model::FMoldModel> FSetFormByStampSheetResult::GetMoldModel() const
    {
    ...
    TSharedPtr<Model::FFormModel> FSetFormByStampSheetResult::GetFormModel() const
    {
    ...
    TSharedPtr<FSetFormByStampSheetResult> FSetFormByStampSheetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FSetFormByStampSheetResult>()
    ...
    TSharedPtr<FJsonObject> FSetFormByStampSheetResult::ToJson() const
    {
