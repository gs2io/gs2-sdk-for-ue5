...
namespace Gs2::Formation::Result
{
    ...
    TSharedPtr<FGetPropertyFormResult> FGetPropertyFormResult::WithPropertyFormModel(
    ...
    TSharedPtr<Model::FPropertyFormModel> FGetPropertyFormResult::GetPropertyFormModel() const
    {
