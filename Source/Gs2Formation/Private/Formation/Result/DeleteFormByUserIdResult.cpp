...
{
    FDeleteFormByUserIdResult::FDeleteFormByUserIdResult():
        ItemValue(nullptr),
        MoldValue(nullptr),
    ...
    FDeleteFormByUserIdResult::FDeleteFormByUserIdResult(
        const FDeleteFormByUserIdResult& From
    ):
    ...
    TSharedPtr<FDeleteFormByUserIdResult> FDeleteFormByUserIdResult::WithItem(
    ...
    TSharedPtr<FDeleteFormByUserIdResult> FDeleteFormByUserIdResult::WithMold(
    ...
    TSharedPtr<FDeleteFormByUserIdResult> FDeleteFormByUserIdResult::WithMoldModel(
    ...
    TSharedPtr<FDeleteFormByUserIdResult> FDeleteFormByUserIdResult::WithFormModel(
    ...
    TSharedPtr<Model::FForm> FDeleteFormByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<Model::FMold> FDeleteFormByUserIdResult::GetMold() const
    {
    ...
    TSharedPtr<Model::FMoldModel> FDeleteFormByUserIdResult::GetMoldModel() const
    {
    ...
    TSharedPtr<Model::FFormModel> FDeleteFormByUserIdResult::GetFormModel() const
    {
    ...
    TSharedPtr<FDeleteFormByUserIdResult> FDeleteFormByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDeleteFormByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FDeleteFormByUserIdResult::ToJson() const
    {
