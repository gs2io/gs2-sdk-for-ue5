...
namespace Gs2::Formation::Result
{
    ...
    TSharedPtr<FAcquireActionToPropertyFormPropertiesByStampSheetResult> FAcquireActionToPropertyFormPropertiesByStampSheetResult::WithAtomicCommit(
    ...
    TSharedPtr<FAcquireActionToPropertyFormPropertiesByStampSheetResult> FAcquireActionToPropertyFormPropertiesByStampSheetResult::WithTransaction(
    ...
    TSharedPtr<FAcquireActionToPropertyFormPropertiesByStampSheetResult> FAcquireActionToPropertyFormPropertiesByStampSheetResult::WithTransactionResult(
    ...
    TOptional<bool> FAcquireActionToPropertyFormPropertiesByStampSheetResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FAcquireActionToPropertyFormPropertiesByStampSheetResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FAcquireActionToPropertyFormPropertiesByStampSheetResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FAcquireActionToPropertyFormPropertiesByStampSheetResult::GetTransactionResult() const
    {
