...
#include "Formation/Task/Rest/GetPropertyFormModelMasterTask.h"
...
{
    FGetPropertyFormModelMasterTask::FGetPropertyFormModelMasterTask(
    ...
    FGetPropertyFormModelMasterTask::FGetPropertyFormModelMasterTask(
        const FGetPropertyFormModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormModelMasterTask::Action(
        const TSharedPtr<Result::FGetPropertyFormModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
