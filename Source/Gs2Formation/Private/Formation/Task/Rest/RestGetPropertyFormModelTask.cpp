...
#include "Formation/Task/Rest/GetPropertyFormModelTask.h"
...
{
    FGetPropertyFormModelTask::FGetPropertyFormModelTask(
    ...
    FGetPropertyFormModelTask::FGetPropertyFormModelTask(
        const FGetPropertyFormModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormModelTask::Action(
        const TSharedPtr<Result::FGetPropertyFormModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/propertyForm/{propertyFormModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
