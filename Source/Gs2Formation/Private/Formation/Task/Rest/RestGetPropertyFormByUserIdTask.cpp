...
#include "Formation/Task/Rest/GetPropertyFormByUserIdTask.h"
...
{
    FGetPropertyFormByUserIdTask::FGetPropertyFormByUserIdTask(
    ...
    FGetPropertyFormByUserIdTask::FGetPropertyFormByUserIdTask(
        const FGetPropertyFormByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormByUserIdTask::Action(
        const TSharedPtr<Result::FGetPropertyFormByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/property/{propertyFormModelName}/form/{propertyId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
