...
#include "Formation/Task/Rest/SetPropertyFormTask.h"
...
{
    FSetPropertyFormTask::FSetPropertyFormTask(
    ...
    Core::Model::FGs2ErrorPtr FSetPropertyFormTask::Action(
        const TSharedPtr<Result::FSetPropertyFormResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/property/{propertyFormModelName}/form/{propertyId}/raw");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetPropertyFormResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
