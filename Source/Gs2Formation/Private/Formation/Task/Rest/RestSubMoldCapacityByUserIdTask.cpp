...
#include "Formation/Task/Rest/SubMoldCapacityByUserIdTask.h"
...
{
    FSubMoldCapacityByUserIdTask::FSubMoldCapacityByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FSubMoldCapacityByUserIdTask::Action(
        const TSharedPtr<Result::FSubMoldCapacityByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/mold/{moldModelName}/sub");
            ...
            if (this->Request->GetCapacity().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("capacity"), this->Request->GetCapacity().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSubMoldCapacityByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
