...
#include "Formation/Task/Rest/SetMoldCapacityByUserIdTask.h"
...
{
    FSetMoldCapacityByUserIdTask::FSetMoldCapacityByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FSetMoldCapacityByUserIdTask::Action(
        const TSharedPtr<Result::FSetMoldCapacityByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/mold/{moldModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetMoldCapacityByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
