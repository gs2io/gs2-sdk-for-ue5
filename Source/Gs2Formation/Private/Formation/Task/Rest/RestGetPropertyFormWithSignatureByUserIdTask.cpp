...
#include "Formation/Task/Rest/GetPropertyFormWithSignatureByUserIdTask.h"
...
{
    FGetPropertyFormWithSignatureByUserIdTask::FGetPropertyFormWithSignatureByUserIdTask(
    ...
    FGetPropertyFormWithSignatureByUserIdTask::FGetPropertyFormWithSignatureByUserIdTask(
        const FGetPropertyFormWithSignatureByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormWithSignatureByUserIdTask::Action(
        const TSharedPtr<Result::FGetPropertyFormWithSignatureByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/property/{propertyFormModelName}/form/{propertyId}/signature");
            ...
            Url = Url.Replace(
                TEXT("{propertyFormModelName}"),
                !this->Request->GetPropertyFormModelName().IsSet() || this->Request->GetPropertyFormModelName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetPropertyFormModelName())
            );
            Url = Url.Replace(
                TEXT("{propertyId}"),
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormWithSignatureByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
