...
#include "Formation/Task/Rest/GetPropertyFormWithSignatureTask.h"
...
{
    FGetPropertyFormWithSignatureTask::FGetPropertyFormWithSignatureTask(
    ...
    FGetPropertyFormWithSignatureTask::FGetPropertyFormWithSignatureTask(
        const FGetPropertyFormWithSignatureTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormWithSignatureTask::Action(
        const TSharedPtr<Result::FGetPropertyFormWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/property/{propertyFormModelName}/form/{propertyId}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
