...
#include "Formation/Task/Rest/DescribePropertyFormsTask.h"
...
{
    FDescribePropertyFormsTask::FDescribePropertyFormsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribePropertyFormsTask::Action(
        const TSharedPtr<Result::FDescribePropertyFormsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/property/{propertyFormModelName}/form");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribePropertyFormsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
