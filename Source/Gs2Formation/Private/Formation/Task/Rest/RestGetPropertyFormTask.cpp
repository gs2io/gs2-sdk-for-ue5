...
#include "Formation/Task/Rest/GetPropertyFormTask.h"
...
{
    FGetPropertyFormTask::FGetPropertyFormTask(
    ...
    FGetPropertyFormTask::FGetPropertyFormTask(
        const FGetPropertyFormTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetPropertyFormTask::Action(
        const TSharedPtr<Result::FGetPropertyFormResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetPropertyFormResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
