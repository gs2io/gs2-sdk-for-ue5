...
#include "Formation/Task/Rest/AcquireActionsToPropertyFormPropertiesTask.h"
...
{
    FAcquireActionsToPropertyFormPropertiesTask::FAcquireActionsToPropertyFormPropertiesTask(
    ...
    Core::Model::FGs2ErrorPtr FAcquireActionsToPropertyFormPropertiesTask::Action(
        const TSharedPtr<Result::FAcquireActionsToPropertyFormPropertiesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/property/{propertyFormModelName}/form/{propertyId}/stamp/delegate");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAcquireActionsToPropertyFormPropertiesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
