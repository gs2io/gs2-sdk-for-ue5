...
#include "Formation/Task/Rest/DeletePropertyFormTask.h"
...
{
    FDeletePropertyFormTask::FDeletePropertyFormTask(
    ...
    FDeletePropertyFormTask::FDeletePropertyFormTask(
        const FDeletePropertyFormTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeletePropertyFormTask::Action(
        const TSharedPtr<Result::FDeletePropertyFormResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePropertyFormResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
