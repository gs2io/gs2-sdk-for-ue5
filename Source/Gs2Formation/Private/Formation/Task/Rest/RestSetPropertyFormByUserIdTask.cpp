...
#include "Formation/Task/Rest/SetPropertyFormByUserIdTask.h"
...
{
    FSetPropertyFormByUserIdTask::FSetPropertyFormByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FSetPropertyFormByUserIdTask::Action(
        const TSharedPtr<Result::FSetPropertyFormByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetPropertyFormByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
