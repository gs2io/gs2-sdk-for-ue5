...
#include "Formation/Task/Rest/AddMoldCapacityByUserIdTask.h"
...
{
    FAddMoldCapacityByUserIdTask::FAddMoldCapacityByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FAddMoldCapacityByUserIdTask::Action(
        const TSharedPtr<Result::FAddMoldCapacityByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FAddMoldCapacityByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
