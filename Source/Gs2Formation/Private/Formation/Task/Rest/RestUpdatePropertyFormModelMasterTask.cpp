...
#include "Formation/Task/Rest/UpdatePropertyFormModelMasterTask.h"
...
{
    FUpdatePropertyFormModelMasterTask::FUpdatePropertyFormModelMasterTask(
    ...
    FUpdatePropertyFormModelMasterTask::FUpdatePropertyFormModelMasterTask(
        const FUpdatePropertyFormModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdatePropertyFormModelMasterTask::Action(
        const TSharedPtr<Result::FUpdatePropertyFormModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/model/propertyForm/{propertyFormModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdatePropertyFormModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
