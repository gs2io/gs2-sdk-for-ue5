...
#include "Formation/Task/Rest/DeletePropertyFormModelMasterTask.h"
...
{
    FDeletePropertyFormModelMasterTask::FDeletePropertyFormModelMasterTask(
    ...
    FDeletePropertyFormModelMasterTask::FDeletePropertyFormModelMasterTask(
        const FDeletePropertyFormModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeletePropertyFormModelMasterTask::Action(
        const TSharedPtr<Result::FDeletePropertyFormModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePropertyFormModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
