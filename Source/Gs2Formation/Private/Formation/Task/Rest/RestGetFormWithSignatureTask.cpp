...
#include "Formation/Task/Rest/GetFormWithSignatureTask.h"
...
{
    FGetFormWithSignatureTask::FGetFormWithSignatureTask(
    ...
    FGetFormWithSignatureTask::FGetFormWithSignatureTask(
        const FGetFormWithSignatureTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetFormWithSignatureTask::Action(
        const TSharedPtr<Result::FGetFormWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/mold/{moldModelName}/form/{index}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetFormWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
