...
#include "Formation/Task/Rest/GetFormWithSignatureByUserIdTask.h"
...
{
    FGetFormWithSignatureByUserIdTask::FGetFormWithSignatureByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetFormWithSignatureByUserIdTask::Action(
        const TSharedPtr<Result::FGetFormWithSignatureByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/mold/{moldModelName}/form/{index}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetFormWithSignatureByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
