...
#include "Formation/Task/Rest/SetPropertyFormWithSignatureTask.h"
...
{
    FSetPropertyFormWithSignatureTask::FSetPropertyFormWithSignatureTask(
    ...
    FSetPropertyFormWithSignatureTask::FSetPropertyFormWithSignatureTask(
        const FSetPropertyFormWithSignatureTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FSetPropertyFormWithSignatureTask::Action(
        const TSharedPtr<Result::FSetPropertyFormWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/property/{propertyFormModelName}/form/{propertyId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSetPropertyFormWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
