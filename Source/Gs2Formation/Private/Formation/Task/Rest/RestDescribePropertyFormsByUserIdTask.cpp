...
#include "Formation/Task/Rest/DescribePropertyFormsByUserIdTask.h"
...
{
    FDescribePropertyFormsByUserIdTask::FDescribePropertyFormsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribePropertyFormsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribePropertyFormsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/property/{propertyFormModelName}/form");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribePropertyFormsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
