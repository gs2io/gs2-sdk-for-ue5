...
#include "Formation/Task/Rest/SubMoldCapacityTask.h"
...
{
    FSubMoldCapacityTask::FSubMoldCapacityTask(
    ...
    FSubMoldCapacityTask::FSubMoldCapacityTask(
        const FSubMoldCapacityTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FSubMoldCapacityTask::Action(
        const TSharedPtr<Result::FSubMoldCapacityResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/mold/{moldModelName}/sub");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FSubMoldCapacityResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
