...
#include "Formation/Task/Rest/DeletePropertyFormByUserIdTask.h"
...
{
    FDeletePropertyFormByUserIdTask::FDeletePropertyFormByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeletePropertyFormByUserIdTask::Action(
        const TSharedPtr<Result::FDeletePropertyFormByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePropertyFormByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
