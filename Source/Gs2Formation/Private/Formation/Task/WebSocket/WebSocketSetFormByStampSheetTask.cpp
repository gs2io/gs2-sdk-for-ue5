...
#include "Formation/Task/WebSocket/SetFormByStampSheetTask.h"
...
namespace Gs2::Formation::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("formation"), TEXT("form"), TEXT("setFormByStampSheet"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FSetFormByStampSheetResult::FromJson(WebSocketResult->Body());
