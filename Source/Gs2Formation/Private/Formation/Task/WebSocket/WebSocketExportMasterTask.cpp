...
#include "Formation/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Formation::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("formation"), TEXT("currentFormMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
