...
#include "Formation/Task/WebSocket/SetFormTask.h"
...
namespace Gs2::Formation::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("formation"), TEXT("form"), TEXT("setForm"), ToCStr(RequestPayload->Payload()));
