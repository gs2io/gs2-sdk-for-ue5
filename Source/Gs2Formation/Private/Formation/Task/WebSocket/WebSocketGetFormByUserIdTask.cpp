...
#include "Formation/Task/WebSocket/GetFormByUserIdTask.h"
...
namespace Gs2::Formation::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("formation"), TEXT("form"), TEXT("getFormByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FGetFormByUserIdResult::FromJson(WebSocketResult->Body());
