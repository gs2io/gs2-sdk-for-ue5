...
#include "Formation/Task/WebSocket/CheckImportUserDataByUserIdTask.h"
...
namespace Gs2::Formation::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("formation"), TEXT("namespace"), TEXT("checkImportUserDataByUserId"), ToCStr(RequestPayload->Payload()));
