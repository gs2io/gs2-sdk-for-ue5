...
namespace Gs2::Formation::Request
{
    ...
    TSharedPtr<FAddMoldCapacityByUserIdRequest> FAddMoldCapacityByUserIdRequest::WithMoldName(
    ...
    TOptional<FString> FAddMoldCapacityByUserIdRequest::GetMoldName() const
    {
