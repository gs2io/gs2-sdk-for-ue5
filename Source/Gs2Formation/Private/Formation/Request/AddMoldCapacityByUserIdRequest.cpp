...
namespace Gs2::Formation::Request
{
    ...
    TSharedPtr<FAddMoldCapacityByUserIdRequest> FAddMoldCapacityByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FAddMoldCapacityByUserIdRequest::GetTimeOffsetToken() const
    {
