...
namespace Gs2::Formation::Request
{
    ...
    TSharedPtr<FGetPropertyFormByUserIdRequest> FGetPropertyFormByUserIdRequest::WithPropertyFormModelName(
    ...
    TSharedPtr<FGetPropertyFormByUserIdRequest> FGetPropertyFormByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FGetPropertyFormByUserIdRequest::GetPropertyFormModelName() const
    {
    ...
    TOptional<FString> FGetPropertyFormByUserIdRequest::GetTimeOffsetToken() const
    {
