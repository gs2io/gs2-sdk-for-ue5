...
namespace Gs2::Formation::Request
{
    ...
    TSharedPtr<FSubMoldCapacityByUserIdRequest> FSubMoldCapacityByUserIdRequest::WithMoldName(
    ...
    TOptional<FString> FSubMoldCapacityByUserIdRequest::GetMoldName() const
    {
