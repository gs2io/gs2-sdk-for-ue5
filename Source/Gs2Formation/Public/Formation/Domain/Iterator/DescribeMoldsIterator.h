...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    class GS2FORMATION_API FDescribeMoldsIterator :
        public TSharedFromThis<FDescribeMoldsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeMoldsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMoldsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMoldsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMoldsIterator> Iterable)
            {
