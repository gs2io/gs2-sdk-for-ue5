...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    class GS2FORMATION_API FDescribeMoldsByUserIdIterator :
        public TSharedFromThis<FDescribeMoldsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Formation::Model::FMold>> Result) override;
        ...
        {
            TSharedRef<FDescribeMoldsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Formation::Model::FMoldPtr>> Range;
            TOptional<TArray<Gs2::Formation::Model::FMoldPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMoldsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMoldsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMoldsByUserIdIterator> Iterable)
            {
