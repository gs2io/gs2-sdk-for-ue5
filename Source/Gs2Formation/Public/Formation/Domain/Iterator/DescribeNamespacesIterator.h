...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Formation::Model::FNamespace>> Result) override;
        ...
        class GS2FORMATION_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Formation::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Formation::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
