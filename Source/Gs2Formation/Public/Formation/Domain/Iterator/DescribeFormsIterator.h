...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDescribeFormsIterator> Self;
            ...
            FIterator(
                const TSharedRef<FDescribeFormsIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFormsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFormsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFormsIterator> Iterable)
            {
