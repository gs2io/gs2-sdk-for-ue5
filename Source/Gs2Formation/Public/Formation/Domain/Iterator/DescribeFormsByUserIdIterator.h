...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    class GS2FORMATION_API FDescribeFormsByUserIdIterator :
        public TSharedFromThis<FDescribeFormsByUserIdIterator>
    {
    ...
    public:
        ...
        FDescribeFormsByUserIdIterator(
            const FDescribeFormsByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Formation::Model::FForm>> Result) override;
        ...
        {
            TSharedRef<FDescribeFormsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Formation::Model::FFormPtr>> Range;
            TOptional<TArray<Gs2::Formation::Model::FFormPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFormsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFormsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFormsByUserIdIterator> Iterable)
            {
