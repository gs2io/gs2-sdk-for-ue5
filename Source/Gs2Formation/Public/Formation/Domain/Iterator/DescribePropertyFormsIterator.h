...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    class GS2FORMATION_API FDescribePropertyFormsIterator :
        public TSharedFromThis<FDescribePropertyFormsIterator>
    {
    ...
    public:
        ...
        FDescribePropertyFormsIterator(
            const FDescribePropertyFormsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Formation::Model::FPropertyForm>> Result) override;
        ...
        {
            TSharedRef<FDescribePropertyFormsIterator> Self;
            TSharedPtr<TArray<Gs2::Formation::Model::FPropertyFormPtr>> Range;
            TOptional<TArray<Gs2::Formation::Model::FPropertyFormPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribePropertyFormsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribePropertyFormsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribePropertyFormsIterator> Iterable)
            {
