...
namespace Gs2::Formation::Domain::Iterator
{
    ...
    class GS2FORMATION_API FDescribeMoldModelMastersIterator :
        public TSharedFromThis<FDescribeMoldModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Formation::Model::FMoldModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeMoldModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Formation::Model::FMoldModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Formation::Model::FMoldModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMoldModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMoldModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMoldModelMastersIterator> Iterable)
            {
