...
{
    class GS2FORMATION_API FAcquireActionsToPropertyFormPropertiesSpeculativeExecutor
    {
    public:
        ...
        public:
            GS2FORMATION_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Formation::Domain::FGs2FormationDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Formation::Request::FAcquireActionsToPropertyFormPropertiesRequestPtr& Request
            ...
            GS2FORMATION_API FCommitTask(
                const FCommitTask& From
            );

            GS2FORMATION_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
                TSharedPtr<TSharedPtr<Gs2::Core::Domain::SpeculativeExecutor::FPreparedSpeculativeCommit>> Result
            ) override;
        };
        friend FCommitTask;

        static TSharedPtr<FAsyncTask<FAcquireActionsToPropertyFormPropertiesSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Formation::Domain::FGs2FormationDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Formation::Request::FAcquireActionsToPropertyFormPropertiesRequestPtr& Request
