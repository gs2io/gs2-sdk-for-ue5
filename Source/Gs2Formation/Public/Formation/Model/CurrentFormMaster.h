...
{
    class GS2FORMATION_API FCurrentFormMaster final : public FGs2Object, public TSharedFromThis<FCurrentFormMaster>
    {
    ...
    public:
        ...
        static TSharedPtr<FCurrentFormMaster> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;

        static FString TypeName;
    };
    typedef TSharedPtr<FCurrentFormMaster, ESPMode::ThreadSafe> FCurrentFormMasterPtr;
}