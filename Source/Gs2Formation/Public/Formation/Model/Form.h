...
{
    class GS2FORMATION_API FForm final : public FGs2Object, public TSharedFromThis<FForm>
    {
    ...
    public:
        ...
        virtual ~FForm() override = default;
        ...
        TSharedPtr<FForm> WithRevision(const TOptional<int64> Revision);
