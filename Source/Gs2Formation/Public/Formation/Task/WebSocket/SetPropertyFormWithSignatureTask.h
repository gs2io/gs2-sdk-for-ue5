...
{
    class GS2FORMATION_API FSetPropertyFormWithSignatureTask final : public Gs2::Core::Util::TGs2Future<Result::FSetPropertyFormWithSignatureResult>
    {
        Core::Net::WebSocket::FGs2WebSocketSessionPtr Session;
        Request::FSetPropertyFormWithSignatureRequestPtr Request;
    public:
        explicit FSetPropertyFormWithSignatureTask(
            const Core::Net::WebSocket::FGs2WebSocketSessionPtr Session,
            const Request::FSetPropertyFormWithSignatureRequestPtr Request
        );
        FSetPropertyFormWithSignatureTask(
