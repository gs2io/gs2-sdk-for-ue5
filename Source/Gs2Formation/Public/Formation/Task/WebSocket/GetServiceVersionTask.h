...
#include "Formation/Request/GetServiceVersionRequest.h"
#include "Formation/Result/GetServiceVersionResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
