...
#include "Formation/Request/GetNamespaceStatusRequest.h"
#include "Formation/Result/GetNamespaceStatusResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
