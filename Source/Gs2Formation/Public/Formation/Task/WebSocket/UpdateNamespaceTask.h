...
#include "Formation/Result/UpdateNamespaceResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
