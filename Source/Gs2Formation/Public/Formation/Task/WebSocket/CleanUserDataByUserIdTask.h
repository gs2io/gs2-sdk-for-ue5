...
#include "Formation/Request/CleanUserDataByUserIdRequest.h"
#include "Formation/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
