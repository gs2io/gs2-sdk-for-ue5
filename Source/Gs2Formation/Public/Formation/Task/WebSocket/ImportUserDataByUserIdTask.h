...
#include "Formation/Request/ImportUserDataByUserIdRequest.h"
#include "Formation/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
