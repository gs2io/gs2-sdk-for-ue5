...
#include "Formation/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Formation/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::WebSocket
{
    class GS2FORMATION_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
