...
#include "Formation/Result/CreateNamespaceResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
