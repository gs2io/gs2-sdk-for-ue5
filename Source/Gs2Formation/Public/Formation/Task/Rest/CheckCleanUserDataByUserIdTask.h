...
#include "Formation/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Formation/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
