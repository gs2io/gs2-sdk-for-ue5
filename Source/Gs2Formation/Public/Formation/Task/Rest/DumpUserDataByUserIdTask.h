...
#include "Formation/Request/DumpUserDataByUserIdRequest.h"
#include "Formation/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
