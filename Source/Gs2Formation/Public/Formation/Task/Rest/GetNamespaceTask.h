...
#include "Formation/Request/GetNamespaceRequest.h"
#include "Formation/Result/GetNamespaceResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
