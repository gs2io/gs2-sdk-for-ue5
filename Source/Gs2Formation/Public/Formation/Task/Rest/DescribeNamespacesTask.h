...
#include "Formation/Request/DescribeNamespacesRequest.h"
#include "Formation/Result/DescribeNamespacesResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
