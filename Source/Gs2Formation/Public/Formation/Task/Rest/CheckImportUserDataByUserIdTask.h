...
#include "Formation/Request/CheckImportUserDataByUserIdRequest.h"
#include "Formation/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
