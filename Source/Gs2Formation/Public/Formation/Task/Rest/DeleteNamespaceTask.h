...
#include "Formation/Request/DeleteNamespaceRequest.h"
#include "Formation/Result/DeleteNamespaceResult.h"

namespace Gs2::Formation::Task::Rest
{
    class GS2FORMATION_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
