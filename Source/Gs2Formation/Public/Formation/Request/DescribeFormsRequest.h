...
namespace Gs2::Formation::Request
{
    ...
    public:
        ...
        TSharedPtr<FDescribeFormsRequest> WithMoldName(const TOptional<FString> MoldName);
    ...
    typedef TSharedPtr<FDescribeFormsRequest, ESPMode::ThreadSafe> FDescribeFormsRequestPtr;
}