...
namespace Gs2::Formation::Request
{
    ...
    class GS2FORMATION_API FSetCapacityByStampSheetRequest final : public TSharedFromThis<FSetCapacityByStampSheetRequest>
    {
    ...
    typedef TSharedPtr<FSetCapacityByStampSheetRequest, ESPMode::ThreadSafe> FSetCapacityByStampSheetRequestPtr;
}