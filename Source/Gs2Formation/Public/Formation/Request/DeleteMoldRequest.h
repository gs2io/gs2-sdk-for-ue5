...
namespace Gs2::Formation::Request
{
    ...
    public:
        ...
        TSharedPtr<FDeleteMoldRequest> WithMoldName(const TOptional<FString> MoldName);
    ...
    typedef TSharedPtr<FDeleteMoldRequest, ESPMode::ThreadSafe> FDeleteMoldRequestPtr;
}