...
namespace Gs2::Formation::Request
{
    ...
    class GS2FORMATION_API FCreateNamespaceRequest final : public TSharedFromThis<FCreateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FCreateNamespaceRequest> WithUpdateMoldScript(const TSharedPtr<Model::FScriptSetting> UpdateMoldScript);
        TSharedPtr<FCreateNamespaceRequest> WithUpdateFormScript(const TSharedPtr<Model::FScriptSetting> UpdateFormScript);
        TSharedPtr<FCreateNamespaceRequest> WithUpdatePropertyFormScript(const TSharedPtr<Model::FScriptSetting> UpdatePropertyFormScript);
