...
namespace Gs2::Formation::Request
{
    ...
    public:
        ...
        TSharedPtr<FGetMoldByUserIdRequest> WithMoldModelName(const TOptional<FString> MoldModelName);
        TSharedPtr<FGetMoldByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FGetMoldByUserIdRequest> FGetMoldByUserIdRequestPtr;
}