...
namespace Gs2::Formation::Request
{
    ...
    public:
        ...
        TSharedPtr<FGetFormModelRequest> WithMoldModelName(const TOptional<FString> MoldModelName);
    ...
    typedef TSharedPtr<FGetFormModelRequest> FGetFormModelRequestPtr;
}