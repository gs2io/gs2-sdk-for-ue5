...
namespace Gs2::Account::Request
{
    ...
    TSharedPtr<FGetTakeOverByUserIdRequest> FGetTakeOverByUserIdRequest::WithContextStack(
    ...
    TSharedPtr<FGetTakeOverByUserIdRequest> FGetTakeOverByUserIdRequest::WithNamespaceName(
    ...
    TSharedPtr<FGetTakeOverByUserIdRequest> FGetTakeOverByUserIdRequest::WithUserId(
    ...
    TSharedPtr<FGetTakeOverByUserIdRequest> FGetTakeOverByUserIdRequest::WithType(
    ...
    TOptional<FString> FGetTakeOverByUserIdRequest::GetNamespaceName() const
    {
        return NamespaceNameValue;
    }

    TOptional<FString> FGetTakeOverByUserIdRequest::GetUserId() const
    {
        return UserIdValue;
    }

    TOptional<int32> FGetTakeOverByUserIdRequest::GetType() const
    {
        return TypeValue;
    }

    FString FGetTakeOverByUserIdRequest::GetTypeString() const
    {
        if (!TypeValue.IsSet())
        {
            return FString("null");
    ...
    TSharedPtr<FGetTakeOverByUserIdRequest> FGetTakeOverByUserIdRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FGetTakeOverByUserIdRequest>()
