...
namespace Gs2::Account::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithUnBanScript(
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetUnBanScript() const
    {
