...
#include "Account/Task/WebSocket/UpdateCurrentModelMasterTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("currentModelMaster"), TEXT("updateCurrentModelMaster"), ToCStr(RequestPayload->Payload()));
