...
#include "Account/Task/WebSocket/UpdateTakeOverTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("takeOver"), TEXT("updateTakeOver"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateTakeOverResult::FromJson(WebSocketResult->Body());
