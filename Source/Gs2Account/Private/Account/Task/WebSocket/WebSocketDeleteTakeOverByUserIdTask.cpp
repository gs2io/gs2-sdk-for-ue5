...
#include "Account/Task/WebSocket/DeleteTakeOverByUserIdTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("takeOver"), TEXT("deleteTakeOverByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDeleteTakeOverByUserIdResult::FromJson(WebSocketResult->Body());
