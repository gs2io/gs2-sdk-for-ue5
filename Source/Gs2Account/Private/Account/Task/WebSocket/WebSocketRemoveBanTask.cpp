...
#include "Account/Task/WebSocket/RemoveBanTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("account"), TEXT("removeBan"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FRemoveBanResult::FromJson(WebSocketResult->Body());
