...
#include "Account/Task/WebSocket/DoTakeOverTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("takeOver"), TEXT("doTakeOver"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDoTakeOverResult::FromJson(WebSocketResult->Body());
