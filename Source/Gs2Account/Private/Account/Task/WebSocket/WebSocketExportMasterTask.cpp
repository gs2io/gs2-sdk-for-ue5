...
#include "Account/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Account::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("account"), TEXT("currentModelMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
