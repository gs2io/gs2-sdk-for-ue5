...
#include "Account/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Account::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetBoolField(TEXT("differentUserIdForLoginAndDataRetention"), this->Request->GetDifferentUserIdForLoginAndDataRetention().GetValue());
            }
