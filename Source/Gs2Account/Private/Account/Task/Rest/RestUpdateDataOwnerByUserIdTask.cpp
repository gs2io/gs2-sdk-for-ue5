...
#include "Account/Task/Rest/UpdateDataOwnerByUserIdTask.h"
...
{
    FUpdateDataOwnerByUserIdTask::FUpdateDataOwnerByUserIdTask(
    ...
    FUpdateDataOwnerByUserIdTask::FUpdateDataOwnerByUserIdTask(
        const FUpdateDataOwnerByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateDataOwnerByUserIdTask::Action(
        const TSharedPtr<Result::FUpdateDataOwnerByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/{userId}/dataOwner");
            ...
            if (this->Request->GetDataOwnerName().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("dataOwnerName"), this->Request->GetDataOwnerName().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateDataOwnerByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
