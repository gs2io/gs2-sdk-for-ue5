...
#include "Account/Task/Rest/FindPlatformIdTask.h"
...
{
    FFindPlatformIdTask::FFindPlatformIdTask(
    ...
    Core::Model::FGs2ErrorPtr FFindPlatformIdTask::Action(
        const TSharedPtr<Result::FFindPlatformIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/me/platformId/type/{type}/userIdentifier/{userIdentifier}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FFindPlatformIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
