...
#include "Account/Task/Rest/UpdateBannedTask.h"
...
{
    FUpdateBannedTask::FUpdateBannedTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateBannedTask::Action(
        const TSharedPtr<Result::FUpdateBannedResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/{userId}/banned");
            ...
            if (this->Request->GetBanned().IsSet())
            {
                JsonRootObject->SetBoolField(TEXT("banned"), this->Request->GetBanned().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateBannedResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
