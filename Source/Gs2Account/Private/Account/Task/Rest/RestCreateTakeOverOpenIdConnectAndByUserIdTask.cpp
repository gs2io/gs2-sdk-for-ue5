...
#include "Account/Task/Rest/CreateTakeOverOpenIdConnectAndByUserIdTask.h"
...
{
    FCreateTakeOverOpenIdConnectAndByUserIdTask::FCreateTakeOverOpenIdConnectAndByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateTakeOverOpenIdConnectAndByUserIdTask::Action(
        const TSharedPtr<Result::FCreateTakeOverOpenIdConnectAndByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/{userId}/takeover/openIdConnect");
            ...
            if (this->Request->GetIdToken().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("idToken"), this->Request->GetIdToken().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateTakeOverOpenIdConnectAndByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
