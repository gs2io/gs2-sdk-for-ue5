...
#include "Account/Task/Rest/DoTakeOverOpenIdConnectTask.h"
...
{
    FDoTakeOverOpenIdConnectTask::FDoTakeOverOpenIdConnectTask(
    ...
    Core::Model::FGs2ErrorPtr FDoTakeOverOpenIdConnectTask::Action(
        const TSharedPtr<Result::FDoTakeOverOpenIdConnectResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/takeover/type/{type}/openIdConnect");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDoTakeOverOpenIdConnectResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
