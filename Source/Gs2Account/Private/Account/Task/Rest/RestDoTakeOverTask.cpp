...
#include "Account/Task/Rest/DoTakeOverTask.h"
...
{
    FDoTakeOverTask::FDoTakeOverTask(
    ...
    Core::Model::FGs2ErrorPtr FDoTakeOverTask::Action(
        const TSharedPtr<Result::FDoTakeOverResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/takeover/type/{type}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDoTakeOverResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
