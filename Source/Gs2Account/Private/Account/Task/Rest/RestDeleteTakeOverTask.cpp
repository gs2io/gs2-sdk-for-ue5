...
#include "Account/Task/Rest/DeleteTakeOverTask.h"
...
{
    FDeleteTakeOverTask::FDeleteTakeOverTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteTakeOverTask::Action(
        const TSharedPtr<Result::FDeleteTakeOverResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteTakeOverResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
