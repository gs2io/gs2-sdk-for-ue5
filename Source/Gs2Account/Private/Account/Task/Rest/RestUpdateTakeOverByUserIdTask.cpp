...
#include "Account/Task/Rest/UpdateTakeOverByUserIdTask.h"
...
{
    FUpdateTakeOverByUserIdTask::FUpdateTakeOverByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateTakeOverByUserIdTask::Action(
        const TSharedPtr<Result::FUpdateTakeOverByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/{userId}/takeover/type/{type}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("oldPassword"), this->Request->GetOldPassword().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateTakeOverByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
    ...
    void FUpdateTakeOverByUserIdTask::OnError(Core::Model::FGs2ErrorPtr Error)
    {
        if (Error->Count() > 0 && Error->Detail(0)->Code() == "account.password.invalid") {
            TGs2Future<Result::FUpdateTakeOverByUserIdResult>::OnError(MakeShared<Account::Error::FPasswordIncorrectError>(Error));
        }
        else {
            TGs2Future<Result::FUpdateTakeOverByUserIdResult>::OnError(Error);
        }
    }
}