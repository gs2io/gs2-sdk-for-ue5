...
#include "Account/Task/Rest/CreateTakeOverOpenIdConnectTask.h"
...
{
    FCreateTakeOverOpenIdConnectTask::FCreateTakeOverOpenIdConnectTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateTakeOverOpenIdConnectTask::Action(
        const TSharedPtr<Result::FCreateTakeOverOpenIdConnectResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/me/takeover/openIdConnect");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateTakeOverOpenIdConnectResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
