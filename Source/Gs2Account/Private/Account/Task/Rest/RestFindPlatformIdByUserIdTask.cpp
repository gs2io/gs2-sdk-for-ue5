...
#include "Account/Task/Rest/FindPlatformIdByUserIdTask.h"
...
{
    FFindPlatformIdByUserIdTask::FFindPlatformIdByUserIdTask(
    ...
    FFindPlatformIdByUserIdTask::FFindPlatformIdByUserIdTask(
        const FFindPlatformIdByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FFindPlatformIdByUserIdTask::Action(
        const TSharedPtr<Result::FFindPlatformIdByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/{userId}/platformId/type/{type}/userIdentifier/{userIdentifier}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FFindPlatformIdByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
