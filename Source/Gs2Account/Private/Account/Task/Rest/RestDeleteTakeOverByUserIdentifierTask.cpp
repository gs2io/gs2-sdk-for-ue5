...
#include "Account/Task/Rest/DeleteTakeOverByUserIdentifierTask.h"
...
{
    FDeleteTakeOverByUserIdentifierTask::FDeleteTakeOverByUserIdentifierTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteTakeOverByUserIdentifierTask::Action(
        const TSharedPtr<Result::FDeleteTakeOverByUserIdentifierResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/takeover/type/{type}/userIdentifier/{userIdentifier}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteTakeOverByUserIdentifierResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
