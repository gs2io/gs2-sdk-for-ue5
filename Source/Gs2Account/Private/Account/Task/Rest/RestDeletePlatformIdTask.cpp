...
#include "Account/Task/Rest/DeletePlatformIdTask.h"
...
{
    FDeletePlatformIdTask::FDeletePlatformIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeletePlatformIdTask::Action(
        const TSharedPtr<Result::FDeletePlatformIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/me/platformId/type/{type}");
            ...
            if (this->Request->GetUserIdentifier().IsSet()) {
                queryStrings.Add("userIdentifier=" + FGenericPlatformHttp::UrlEncode(this->Request->GetUserIdentifier().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePlatformIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
