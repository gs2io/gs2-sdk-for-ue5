...
#include "Account/Task/Rest/CreatePlatformIdTask.h"
...
{
    FCreatePlatformIdTask::FCreatePlatformIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCreatePlatformIdTask::Action(
        const TSharedPtr<Result::FCreatePlatformIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/me/platformId");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreatePlatformIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
