...
#include "Account/Task/Rest/DeletePlatformIdByUserIdentifierTask.h"
...
{
    FDeletePlatformIdByUserIdentifierTask::FDeletePlatformIdByUserIdentifierTask(
    ...
    Core::Model::FGs2ErrorPtr FDeletePlatformIdByUserIdentifierTask::Action(
        const TSharedPtr<Result::FDeletePlatformIdByUserIdentifierResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/platformId/type/{type}/userIdentifier/{userIdentifier}");
            ...
            Url = Url.Replace(
                TEXT("{userIdentifier}"),
                !this->Request->GetUserIdentifier().IsSet() || this->Request->GetUserIdentifier().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetUserIdentifier())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeletePlatformIdByUserIdentifierResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
