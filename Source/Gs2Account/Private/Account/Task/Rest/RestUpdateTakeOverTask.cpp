...
#include "Account/Task/Rest/UpdateTakeOverTask.h"
...
{
    FUpdateTakeOverTask::FUpdateTakeOverTask(
    ...
    FUpdateTakeOverTask::FUpdateTakeOverTask(
        const FUpdateTakeOverTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateTakeOverTask::Action(
        const TSharedPtr<Result::FUpdateTakeOverResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/account/me/takeover/type/{type}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateTakeOverResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
