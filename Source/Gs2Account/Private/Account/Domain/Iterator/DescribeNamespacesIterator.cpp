...
namespace Gs2::Account::Domain::Iterator
{
    ...
    const Gs2::Account::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Account::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
