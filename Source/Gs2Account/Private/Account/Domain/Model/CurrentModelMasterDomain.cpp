...
namespace Gs2::Account::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Account::Model::Cache::FCurrentModelMasterCache::Put(
            Self->Gs2->Cache,
    ...
    FCurrentModelMasterDomain::FPreUpdateTask::FPreUpdateTask(
        const TSharedPtr<FCurrentModelMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentModelMasterDomain::FPreUpdateTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Account::Domain::Model::FCurrentModelMasterDomain>> Result
    )
    {
        Request
            ->WithContextStack((!Request->GetContextStack().IsSet() || Request->GetContextStack()->IsEmpty()) ? Self->Gs2->DefaultContextStack : Request->GetContextStack())
            ->WithNamespaceName(Self->NamespaceName);
        const auto Future = Self->Client->PreUpdateCurrentModelMaster(
            Request
        );
        Future->StartSynchronousTask();
        if (Future->GetTask().IsError())
    ...
    TSharedPtr<FAsyncTask<FCurrentModelMasterDomain::FPreUpdateTask>> FCurrentModelMasterDomain::PreUpdate(
    ...
    {
        const auto CacheParentKey = Gs2::Account::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Account::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(

        );
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            Gs2::Account::Model::FCurrentModelMaster::TypeName,
            CacheParentKey,
            CacheKey,
            [Self = Self, Result]() -> Gs2::Core::Model::FGs2ErrorPtr
            {
                Gs2::Account::Model::FCurrentModelMasterPtr Value;
                const auto CacheHit = Gs2::Account::Model::Cache::FCurrentModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Account::Model::Cache::FCurrentModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Account::Model::FCurrentModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Account::Request::FGetCurrentModelMasterRequest>()
                        );
                        Future->StartSynchronousTask();
    ...
    void FCurrentModelMasterDomain::Invalidate()
    {
        Gs2::Account::Model::Cache::FCurrentModelMasterCache::Delete(
            Gs2->Cache,
    ...
    FCurrentModelMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FCurrentModelMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FCurrentModelMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FCurrentModelMasterDomain::FSubscribeWithInitialCallTask>> FCurrentModelMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Account::Model::FCurrentModelMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Account::Model::Cache::FCurrentModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Account::Model::Cache::FCurrentModelMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Account::Model::FCurrentModelMaster>(obj));
            },
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName]()
            {
                ...
                const auto Domain = MakeShared<FCurrentModelMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName
                );
