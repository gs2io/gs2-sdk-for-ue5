...
namespace Gs2::Account::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FAccount>> Result) override;
        ...
        {
            TSharedRef<FDescribeAccountsIterator> Self;
            TSharedPtr<TArray<Gs2::Account::Model::FAccountPtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FAccountPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAccountsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAccountsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAccountsIterator> Iterable)
            {
