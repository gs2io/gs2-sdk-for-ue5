...
namespace Gs2::Account::Domain::Iterator
{
    ...
    class GS2ACCOUNT_API FDescribeTakeOversIterator :
        public TSharedFromThis<FDescribeTakeOversIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeTakeOversIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTakeOversIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTakeOversIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTakeOversIterator> Iterable)
            {
