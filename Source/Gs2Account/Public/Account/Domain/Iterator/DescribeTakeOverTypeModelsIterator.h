...
namespace Gs2::Account::Domain::Iterator
{
    ...
    class GS2ACCOUNT_API FDescribeTakeOverTypeModelsIterator :
        public TSharedFromThis<FDescribeTakeOverTypeModelsIterator>
    {
    ...
    public:
        FDescribeTakeOverTypeModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Account::FGs2AccountRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FTakeOverTypeModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeTakeOverTypeModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Account::Model::FTakeOverTypeModelPtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FTakeOverTypeModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Account::Model::FTakeOverTypeModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTakeOverTypeModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTakeOverTypeModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTakeOverTypeModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeTakeOverTypeModelsIterator> FDescribeTakeOverTypeModelsIteratorPtr;
}
