...
namespace Gs2::Account::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FNamespace>> Result) override;
        ...
        class GS2ACCOUNT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Account::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
