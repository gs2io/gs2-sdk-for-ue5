...
namespace Gs2::Account::Domain::Iterator
{
    ...
    class GS2ACCOUNT_API FDescribePlatformIdsIterator :
        public TSharedFromThis<FDescribePlatformIdsIterator>
    {
    ...
    public:
        ...
        FDescribePlatformIdsIterator(
            const FDescribePlatformIdsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FPlatformId>> Result) override;
        ...
        {
            TSharedRef<FDescribePlatformIdsIterator> Self;
            TSharedPtr<TArray<Gs2::Account::Model::FPlatformIdPtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FPlatformIdPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribePlatformIdsIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Account::Model::FPlatformIdPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribePlatformIdsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribePlatformIdsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribePlatformIdsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribePlatformIdsIterator> FDescribePlatformIdsIteratorPtr;
}
