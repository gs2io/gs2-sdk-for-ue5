...
namespace Gs2::Account::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FTakeOver>> Result) override;
        ...
        {
            TSharedRef<FDescribeTakeOversByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Account::Model::FTakeOverPtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FTakeOverPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeTakeOversByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTakeOversByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTakeOversByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTakeOversByUserIdIterator> Iterable)
            {
