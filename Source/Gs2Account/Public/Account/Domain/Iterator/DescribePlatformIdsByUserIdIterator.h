...
namespace Gs2::Account::Domain::Iterator
{
    ...
    class GS2ACCOUNT_API FDescribePlatformIdsByUserIdIterator :
        public TSharedFromThis<FDescribePlatformIdsByUserIdIterator>
    {
    ...
    public:
        FDescribePlatformIdsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Account::FGs2AccountRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        {
            TSharedRef<FDescribePlatformIdsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribePlatformIdsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribePlatformIdsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribePlatformIdsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribePlatformIdsByUserIdIterator> FDescribePlatformIdsByUserIdIteratorPtr;
}
