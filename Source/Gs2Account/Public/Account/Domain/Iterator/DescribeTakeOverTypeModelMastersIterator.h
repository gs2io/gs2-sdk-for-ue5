...
namespace Gs2::Account::Domain::Iterator
{
    ...
    class GS2ACCOUNT_API FDescribeTakeOverTypeModelMastersIterator :
        public TSharedFromThis<FDescribeTakeOverTypeModelMastersIterator>
    {
    ...
    public:
        FDescribeTakeOverTypeModelMastersIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Account::FGs2AccountRestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Account::Model::FTakeOverTypeModelMaster>> Result) override;
        ...
        class GS2ACCOUNT_API FIterator
        {
            TSharedRef<FDescribeTakeOverTypeModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Account::Model::FTakeOverTypeModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Account::Model::FTakeOverTypeModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Account::Model::FTakeOverTypeModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeTakeOverTypeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeTakeOverTypeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeTakeOverTypeModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeTakeOverTypeModelMastersIterator> FDescribeTakeOverTypeModelMastersIteratorPtr;
}
