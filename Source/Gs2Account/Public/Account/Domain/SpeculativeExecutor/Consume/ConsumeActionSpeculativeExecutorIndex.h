...
namespace Gs2::Account::Domain::SpeculativeExecutor
{
    class GS2ACCOUNT_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Account::Domain::FGs2AccountDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2ACCOUNT_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Account::Domain::FGs2AccountDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2ACCOUNT_API FCommitTask(
                const FCommitTask& From
            );

            GS2ACCOUNT_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
