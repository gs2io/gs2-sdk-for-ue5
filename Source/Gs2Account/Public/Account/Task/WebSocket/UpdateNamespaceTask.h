...
#include "Account/Result/UpdateNamespaceResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
