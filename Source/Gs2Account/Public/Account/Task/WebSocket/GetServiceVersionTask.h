...
#include "Account/Request/GetServiceVersionRequest.h"
#include "Account/Result/GetServiceVersionResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
