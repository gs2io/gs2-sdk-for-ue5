...
#include "Account/Request/CleanUserDataByUserIdRequest.h"
#include "Account/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
