...
#include "Account/Request/DescribeNamespacesRequest.h"
#include "Account/Result/DescribeNamespacesResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
