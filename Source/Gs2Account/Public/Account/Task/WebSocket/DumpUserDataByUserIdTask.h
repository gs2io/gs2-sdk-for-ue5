...
#include "Account/Request/DumpUserDataByUserIdRequest.h"
#include "Account/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
