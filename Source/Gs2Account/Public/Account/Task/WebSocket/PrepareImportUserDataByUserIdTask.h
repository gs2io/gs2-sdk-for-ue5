...
#include "Account/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Account/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
