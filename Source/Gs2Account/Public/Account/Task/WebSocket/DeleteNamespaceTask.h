...
#include "Account/Request/DeleteNamespaceRequest.h"
#include "Account/Result/DeleteNamespaceResult.h"

namespace Gs2::Account::Task::WebSocket
{
    class GS2ACCOUNT_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
