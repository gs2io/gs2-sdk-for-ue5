...
#include "Account/Request/ImportUserDataByUserIdRequest.h"
#include "Account/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
