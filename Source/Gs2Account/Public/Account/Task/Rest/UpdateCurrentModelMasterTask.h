...
#include "Account/Request/UpdateCurrentModelMasterRequest.h"
#include "Account/Result/UpdateCurrentModelMasterResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateCurrentModelMasterResult>
    {
