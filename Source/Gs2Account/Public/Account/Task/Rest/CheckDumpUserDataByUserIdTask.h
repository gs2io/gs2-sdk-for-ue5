...
#include "Account/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Account/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
