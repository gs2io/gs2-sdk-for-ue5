...
#include "Account/Request/GetNamespaceRequest.h"
#include "Account/Result/GetNamespaceResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
