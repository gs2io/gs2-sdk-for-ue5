...
#include "Account/Request/GetNamespaceStatusRequest.h"
#include "Account/Result/GetNamespaceStatusResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
