...
#include "Account/Request/CheckImportUserDataByUserIdRequest.h"
#include "Account/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
