...
#include "Account/Result/CreateNamespaceResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
