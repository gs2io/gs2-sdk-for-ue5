...
#include "Account/Request/PreUpdateCurrentModelMasterRequest.h"
#include "Account/Result/PreUpdateCurrentModelMasterResult.h"

namespace Gs2::Account::Task::Rest
{
    class GS2ACCOUNT_API FPreUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FPreUpdateCurrentModelMasterResult>
    {
