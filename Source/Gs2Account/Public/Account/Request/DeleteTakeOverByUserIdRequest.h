...
{
    class FDeleteTakeOverByUserIdRequest;

    class GS2ACCOUNT_API FDeleteTakeOverByUserIdRequest final : public TSharedFromThis<FDeleteTakeOverByUserIdRequest>
    {
    ...
    public:
        ...
        FDeleteTakeOverByUserIdRequest();
        FDeleteTakeOverByUserIdRequest(
            const FDeleteTakeOverByUserIdRequest& From
        );
        ~FDeleteTakeOverByUserIdRequest() = default;

        TSharedPtr<FDeleteTakeOverByUserIdRequest> WithContextStack(const TOptional<FString> ContextStack);
    ...
    typedef TSharedPtr<FDeleteTakeOverByUserIdRequest, ESPMode::ThreadSafe> FDeleteTakeOverByUserIdRequestPtr;
}