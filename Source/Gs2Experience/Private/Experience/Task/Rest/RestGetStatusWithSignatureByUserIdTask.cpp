...
#include "Experience/Task/Rest/GetStatusWithSignatureByUserIdTask.h"
...
{
    FGetStatusWithSignatureByUserIdTask::FGetStatusWithSignatureByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetStatusWithSignatureByUserIdTask::Action(
        const TSharedPtr<Result::FGetStatusWithSignatureByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/model/{experienceName}/property/{propertyId}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStatusWithSignatureByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
