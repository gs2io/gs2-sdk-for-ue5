...
#include "Experience/Task/Rest/DescribeStatusesTask.h"
...
{
    FDescribeStatusesTask::FDescribeStatusesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeStatusesTask::Action(
        const TSharedPtr<Result::FDescribeStatusesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeStatusesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
