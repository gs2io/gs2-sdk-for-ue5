...
#include "Experience/Task/Rest/DescribeStatusesByUserIdTask.h"
...
{
    FDescribeStatusesByUserIdTask::FDescribeStatusesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeStatusesByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeStatusesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status");
            ...
            if (this->Request->GetExperienceName().IsSet()) {
                queryStrings.Add("experienceName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetExperienceName().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeStatusesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
