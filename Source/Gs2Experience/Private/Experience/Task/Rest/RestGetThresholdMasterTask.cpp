...
#include "Experience/Task/Rest/GetThresholdMasterTask.h"
...
{
    FGetThresholdMasterTask::FGetThresholdMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetThresholdMasterTask::Action(
        const TSharedPtr<Result::FGetThresholdMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetThresholdMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
