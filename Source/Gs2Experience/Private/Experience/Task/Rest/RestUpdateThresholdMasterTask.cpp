...
#include "Experience/Task/Rest/UpdateThresholdMasterTask.h"
...
{
    FUpdateThresholdMasterTask::FUpdateThresholdMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateThresholdMasterTask::Action(
        const TSharedPtr<Result::FUpdateThresholdMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/threshold/{thresholdName}");
            ...
            Url = Url.Replace(
                TEXT("{thresholdName}"),
                !this->Request->GetThresholdName().IsSet() || this->Request->GetThresholdName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetThresholdName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateThresholdMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
