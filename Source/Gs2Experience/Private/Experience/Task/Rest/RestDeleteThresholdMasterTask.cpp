...
#include "Experience/Task/Rest/DeleteThresholdMasterTask.h"
...
{
    FDeleteThresholdMasterTask::FDeleteThresholdMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteThresholdMasterTask::Action(
        const TSharedPtr<Result::FDeleteThresholdMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteThresholdMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
