...
#include "Experience/Task/Rest/VerifyRankTask.h"
...
{
    FVerifyRankTask::FVerifyRankTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyRankTask::Action(
        const TSharedPtr<Result::FVerifyRankResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/{experienceName}/verify/rank/{verifyType}");
            ...
            {
                JsonRootObject->SetStringField(TEXT("rankValue"), FString::Printf(TEXT("%lld"), this->Request->GetRankValue().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyRankResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
