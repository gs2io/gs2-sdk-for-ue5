...
#include "Experience/Task/Rest/GetStatusWithSignatureTask.h"
...
{
    FGetStatusWithSignatureTask::FGetStatusWithSignatureTask(
    ...
    FGetStatusWithSignatureTask::FGetStatusWithSignatureTask(
        const FGetStatusWithSignatureTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetStatusWithSignatureTask::Action(
        const TSharedPtr<Result::FGetStatusWithSignatureResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/model/{experienceName}/property/{propertyId}/signature");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStatusWithSignatureResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
