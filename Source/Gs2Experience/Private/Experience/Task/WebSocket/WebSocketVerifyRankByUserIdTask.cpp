...
#include "Experience/Task/WebSocket/VerifyRankByUserIdTask.h"
...
namespace Gs2::Experience::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("experience"), TEXT("status"), TEXT("verifyRankByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FVerifyRankByUserIdResult::FromJson(WebSocketResult->Body());
