...
#include "Experience/Task/WebSocket/MultiplyAcquireActionsByUserIdTask.h"
...
namespace Gs2::Experience::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("experience"), TEXT("status"), TEXT("multiplyAcquireActionsByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FMultiplyAcquireActionsByUserIdResult::FromJson(WebSocketResult->Body());
