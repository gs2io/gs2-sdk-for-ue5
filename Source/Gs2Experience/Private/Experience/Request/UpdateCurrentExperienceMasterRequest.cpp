...
namespace Gs2::Experience::Request
{
    ...
    TSharedPtr<FUpdateCurrentExperienceMasterRequest> FUpdateCurrentExperienceMasterRequest::WithContextStack(
    ...
    TSharedPtr<FUpdateCurrentExperienceMasterRequest> FUpdateCurrentExperienceMasterRequest::WithNamespaceName(
    ...
    TOptional<FString> FUpdateCurrentExperienceMasterRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FUpdateCurrentExperienceMasterRequest::GetNamespaceName() const
    {
    ...
    TSharedPtr<FUpdateCurrentExperienceMasterRequest> FUpdateCurrentExperienceMasterRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FUpdateCurrentExperienceMasterRequest>()
    ...
    TSharedPtr<FJsonObject> FUpdateCurrentExperienceMasterRequest::ToJson() const
    {
