...
namespace Gs2::Experience::Result
{
    ...
    TSharedPtr<FVerifyRankCapByStampTaskResult> FVerifyRankCapByStampTaskResult::WithItem(
    ...
    TSharedPtr<Model::FStatus> FVerifyRankCapByStampTaskResult::GetItem() const
    {
