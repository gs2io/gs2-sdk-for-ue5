...
#include "Experience/Result/PreUpdateCurrentExperienceMasterResult.h"

namespace Gs2::Experience::Result
{
    FPreUpdateCurrentExperienceMasterResult::FPreUpdateCurrentExperienceMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentExperienceMasterResult> FPreUpdateCurrentExperienceMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentExperienceMasterResult> FPreUpdateCurrentExperienceMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentExperienceMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentExperienceMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentExperienceMasterResult> FPreUpdateCurrentExperienceMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentExperienceMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentExperienceMasterResult::ToJson() const
    {
