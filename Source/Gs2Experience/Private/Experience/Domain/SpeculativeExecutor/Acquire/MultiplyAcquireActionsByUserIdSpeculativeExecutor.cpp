...
namespace Gs2::Experience::Domain::SpeculativeExecutor
{
    ...
    {
        return FString("Gs2Experience:MultiplyAcquireActionsByUserId");
    }
    ...
    Gs2::Experience::Request::FMultiplyAcquireActionsByUserIdRequestPtr FMultiplyAcquireActionsByUserIdSpeculativeExecutor::Rate(
        const Gs2::Experience::Request::FMultiplyAcquireActionsByUserIdRequestPtr& Request,
        const double Rate
    )
    {
