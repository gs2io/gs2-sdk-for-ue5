...
namespace Gs2::Experience::Domain::Iterator
{
    ...
    const Gs2::Experience::Model::FNamespacePtr& FDescribeNamespacesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::Experience::Model::FNamespacePtr FDescribeNamespacesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
