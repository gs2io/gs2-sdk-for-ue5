...
namespace Gs2::Experience::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Experience::Model::FCurrentExperienceMaster>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Experience::Model::FCurrentExperienceMaster>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Experience::Model::FCurrentExperienceMaster>(
                            Self->ParentKey,
                            Gs2::Experience::Domain::Model::FCurrentExperienceMasterDomain::CreateCacheKey(
                            )
                        );
            ...
            Value = Self->Cache->Get<Gs2::Experience::Model::FCurrentExperienceMaster>(
                Self->ParentKey,
                Gs2::Experience::Domain::Model::FCurrentExperienceMasterDomain::CreateCacheKey(
                )
            );
