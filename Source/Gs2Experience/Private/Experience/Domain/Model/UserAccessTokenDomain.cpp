...
namespace Gs2::Experience::Domain::Model
{
    ...
    void FUserAccessTokenDomain::UnsubscribeStatuses(
        ...
        Gs2::Core::Domain::CallbackID CallbackID, const TOptional<FString> ExperienceName
    )
    {
    ...
    class FUserAccessTokenDomain::FCollectStatusesTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Experience::Model::FStatusPtr>>, public TSharedFromThis<FCollectStatusesTask>
    {
        const TSharedPtr<FUserAccessTokenDomain> Self;
        const TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> OnCollected;
    const TOptional<FString> QueryExperienceName;
    public:
        explicit FCollectStatusesTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> OnCollected,const TOptional<FString> ExperienceName) : Self(Self), OnCollected(OnCollected), QueryExperienceName(ExperienceName) {}
        FCollectStatusesTask(const FCollectStatusesTask& From) : TGs2Future(From), Self(From.Self), OnCollected(From.OnCollected), QueryExperienceName(From.QueryExperienceName) {}
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Experience::Model::FStatusPtr>>> Result) override
        {
            ...
            auto Iterator = Self->Statuses(QueryExperienceName)->begin();
    ...
    Gs2::Core::Domain::CallbackID FUserAccessTokenDomain::SubscribeStatuses(
        TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback,const TOptional<FString> ExperienceName
    )
    {
        ...
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [WeakGs2, WeakService, Callback, QueryNamespaceName, QueryExperienceName, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectStatusesTask>>(Domain, Callback, QueryExperienceName);
                Task->StartBackgroundTask();
            }
        );
    }

    void FUserAccessTokenDomain::InvalidateStatuses(const TOptional<FString> ExperienceName)
    {
    ...
    FUserAccessTokenDomain::FSubscribeStatusesWithInitialCallTask::FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback,const TOptional<FString> ExperienceName) : Self(Self), Callback(Callback), QueryExperienceName(ExperienceName) {}
    FUserAccessTokenDomain::FSubscribeStatusesWithInitialCallTask::FSubscribeStatusesWithInitialCallTask(const FSubscribeStatusesWithInitialCallTask& From) : TGs2Future(From), Self(From.Self), Callback(From.Callback), QueryExperienceName(From.QueryExperienceName) {}
    ...
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectStatusesTask>>(Self, TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)>(), QueryExperienceName);
        Task->StartSynchronousTask(); Task->EnsureCompletion();
        if (Task->GetTask().IsError()) return Task->GetTask().Error();
        const auto Values = Task->GetTask().Result();
        const auto CallbackId = Self->SubscribeStatuses(Callback, QueryExperienceName);
        Callback(*Values); *Result = MakeShared<Gs2::Core::Domain::CallbackID>(CallbackId);
        return nullptr;
    }
    TSharedPtr<FAsyncTask<FUserAccessTokenDomain::FSubscribeStatusesWithInitialCallTask>> FUserAccessTokenDomain::SubscribeStatusesWithInitialCall(TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback,const TOptional<FString> ExperienceName)
    {
        return Gs2::Core::Util::New<FAsyncTask<FSubscribeStatusesWithInitialCallTask>>(this->AsShared(), Callback, ExperienceName);
    }
