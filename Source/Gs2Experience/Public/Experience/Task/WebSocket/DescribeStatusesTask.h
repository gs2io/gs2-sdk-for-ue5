...
#include "Experience/Result/DescribeStatusesResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FDescribeStatusesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeStatusesResult>
    {
