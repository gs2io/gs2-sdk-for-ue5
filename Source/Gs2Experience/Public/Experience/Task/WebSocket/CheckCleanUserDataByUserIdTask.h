...
#include "Experience/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Experience/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
