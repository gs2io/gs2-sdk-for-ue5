...
#include "Experience/Request/DumpUserDataByUserIdRequest.h"
#include "Experience/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
