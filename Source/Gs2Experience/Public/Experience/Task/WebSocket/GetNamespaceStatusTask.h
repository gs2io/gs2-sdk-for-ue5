...
#include "Experience/Request/GetNamespaceStatusRequest.h"
#include "Experience/Result/GetNamespaceStatusResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
