...
#include "Experience/Request/DescribeNamespacesRequest.h"
#include "Experience/Result/DescribeNamespacesResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
