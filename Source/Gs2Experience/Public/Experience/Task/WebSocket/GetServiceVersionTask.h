...
#include "Experience/Request/GetServiceVersionRequest.h"
#include "Experience/Result/GetServiceVersionResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
