...
#include "Experience/Request/CleanUserDataByUserIdRequest.h"
#include "Experience/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::WebSocket
{
    class GS2EXPERIENCE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
