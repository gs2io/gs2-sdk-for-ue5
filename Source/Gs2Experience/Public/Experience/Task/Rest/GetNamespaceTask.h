...
#include "Experience/Request/GetNamespaceRequest.h"
#include "Experience/Result/GetNamespaceResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
