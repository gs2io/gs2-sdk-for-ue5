...
#include "Experience/Result/UpdateNamespaceResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
