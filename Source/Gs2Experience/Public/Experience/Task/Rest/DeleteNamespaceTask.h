...
#include "Experience/Request/DeleteNamespaceRequest.h"
#include "Experience/Result/DeleteNamespaceResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
