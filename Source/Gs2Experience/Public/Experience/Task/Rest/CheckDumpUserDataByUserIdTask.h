...
#include "Experience/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Experience/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
