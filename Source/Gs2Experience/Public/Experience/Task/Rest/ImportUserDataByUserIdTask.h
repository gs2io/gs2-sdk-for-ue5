...
#include "Experience/Request/ImportUserDataByUserIdRequest.h"
#include "Experience/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
