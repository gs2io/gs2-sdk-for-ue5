...
#include "Experience/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Experience/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Experience::Task::Rest
{
    class GS2EXPERIENCE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
