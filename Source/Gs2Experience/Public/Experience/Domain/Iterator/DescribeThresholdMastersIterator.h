...
namespace Gs2::Experience::Domain::Iterator
{
    ...
    class GS2EXPERIENCE_API FDescribeThresholdMastersIterator :
        public TSharedFromThis<FDescribeThresholdMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Experience::Model::FThresholdMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeThresholdMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Experience::Model::FThresholdMasterPtr>> Range;
            TOptional<TArray<Gs2::Experience::Model::FThresholdMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeThresholdMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeThresholdMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeThresholdMastersIterator> Iterable)
            {
