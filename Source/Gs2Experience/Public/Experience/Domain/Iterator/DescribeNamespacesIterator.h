...
namespace Gs2::Experience::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Experience::Model::FNamespace>> Result) override;
        ...
        class GS2EXPERIENCE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Experience::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Experience::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
