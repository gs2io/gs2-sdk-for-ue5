...
namespace Gs2::Experience::Domain::Model
{
    ...
    class GS2EXPERIENCE_API FUserDomain:
    ...
    public:
        ...
        Gs2::Experience::Domain::Iterator::FDescribeStatusesByUserIdIteratorPtr Statuses(
        ...
        Gs2::Core::Domain::CallbackID SubscribeStatuses(
            TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback,const TOptional<FString> ExperienceName = TOptional<FString>(),const TOptional<FString> TimeOffsetToken = TOptional<FString>()
        );

        void InvalidateStatuses(const TOptional<FString> ExperienceName = TOptional<FString>(),const TOptional<FString> TimeOffsetToken = TOptional<FString>());

        class GS2EXPERIENCE_API FSubscribeStatusesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeStatusesWithInitialCallTask>
        {
            const TSharedPtr<FUserDomain> Self;
            const TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback;
        const TOptional<FString> QueryExperienceName;const TOptional<FString> QueryTimeOffsetToken;
        public:
            FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserDomain>& Self, TFunction<void(TArray<Gs2::Experience::Model::FStatusPtr>)> Callback,const TOptional<FString> ExperienceName,const TOptional<FString> TimeOffsetToken);
        ...
        void UnsubscribeStatuses(
            ...
            Gs2::Core::Domain::CallbackID CallbackID, const TOptional<FString> ExperienceName = TOptional<FString>(), const TOptional<FString> TimeOffsetToken = TOptional<FString>()
        );
