...
namespace Gs2::Experience::Domain
{
    ...
    class GS2EXPERIENCE_API FGs2ExperienceDomain:
        public TSharedFromThis<FGs2ExperienceDomain>
    {
    ...
    public:
        ...
        class GS2EXPERIENCE_API FCreateNamespaceTask final :
        ...
        class GS2EXPERIENCE_API FDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FCheckDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FCheckCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        class GS2EXPERIENCE_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2ExperienceDomain>,
        ...
        Gs2::Experience::Domain::Iterator::FDescribeNamespacesIteratorPtr Namespaces(
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Experience::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2EXPERIENCE_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2ExperienceDomain> Self;
            const TFunction<void(TArray<Gs2::Experience::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2ExperienceDomain>& Self, TFunction<void(TArray<Gs2::Experience::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
        ...
        TSharedPtr<Gs2::Experience::Domain::Model::FNamespaceDomain> Namespace(
