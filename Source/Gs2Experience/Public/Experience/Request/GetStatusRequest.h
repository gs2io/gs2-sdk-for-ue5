...
namespace Gs2::Experience::Request
{
    ...
    class GS2EXPERIENCE_API FGetStatusRequest final : public TSharedFromThis<FGetStatusRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetStatusRequest> WithExperienceName(const TOptional<FString> ExperienceName);
    ...
    typedef TSharedPtr<FGetStatusRequest, ESPMode::ThreadSafe> FGetStatusRequestPtr;
}