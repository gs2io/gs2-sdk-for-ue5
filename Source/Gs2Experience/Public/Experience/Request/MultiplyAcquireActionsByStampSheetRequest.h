...
namespace Gs2::Experience::Request
{
    ...
    class GS2EXPERIENCE_API FMultiplyAcquireActionsByStampSheetRequest final : public TSharedFromThis<FMultiplyAcquireActionsByStampSheetRequest>
    {
    ...
    typedef TSharedPtr<FMultiplyAcquireActionsByStampSheetRequest> FMultiplyAcquireActionsByStampSheetRequestPtr;
}