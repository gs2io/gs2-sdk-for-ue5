...
namespace Gs2::Experience::Request
{
    ...
    public:
        ...
        TSharedPtr<FMultiplyAcquireActionsByUserIdRequest> WithBaseRate(const TOptional<float> BaseRate);
        ...
        TOptional<float> GetBaseRate() const;
        FString GetBaseRateString() const;
