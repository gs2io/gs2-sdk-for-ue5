...
namespace Gs2::Experience::Request
{
    ...
    class GS2EXPERIENCE_API FDescribeStatusesRequest final : public TSharedFromThis<FDescribeStatusesRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeStatusesRequest> WithExperienceName(const TOptional<FString> ExperienceName);
    ...
    typedef TSharedPtr<FDescribeStatusesRequest> FDescribeStatusesRequestPtr;
}