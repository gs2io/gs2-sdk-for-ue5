...
namespace Gs2::Experience::Request
{
    ...
    class GS2EXPERIENCE_API FDescribeStatusesByUserIdRequest final : public TSharedFromThis<FDescribeStatusesByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeStatusesByUserIdRequest> WithExperienceName(const TOptional<FString> ExperienceName);
    ...
    typedef TSharedPtr<FDescribeStatusesByUserIdRequest, ESPMode::ThreadSafe> FDescribeStatusesByUserIdRequestPtr;
}