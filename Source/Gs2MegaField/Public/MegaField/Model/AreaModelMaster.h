...
{
    class GS2MEGAFIELD_API FAreaModelMaster final : public FGs2Object, public TSharedFromThis<FAreaModelMaster>
    {
    ...
    public:
        ...
        TSharedPtr<FAreaModelMaster> WithRevision(const TOptional<int64> Revision);
