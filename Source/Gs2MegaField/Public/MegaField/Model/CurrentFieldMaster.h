...
namespace Gs2::MegaField::Model
{
    ...
    public:
        ...
        static TSharedPtr<FCurrentFieldMaster> FromJson(const TSharedPtr<FJsonObject> Data);
        TSharedPtr<FJsonObject> ToJson() const;

        static FString TypeName;
    };
    typedef TSharedPtr<FCurrentFieldMaster, ESPMode::ThreadSafe> FCurrentFieldMasterPtr;
}