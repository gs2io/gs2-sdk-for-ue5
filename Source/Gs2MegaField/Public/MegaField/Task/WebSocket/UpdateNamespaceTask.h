...
#include "MegaField/Request/UpdateNamespaceRequest.h"
#include "MegaField/Result/UpdateNamespaceResult.h"

namespace Gs2::MegaField::Task::WebSocket
{
    class GS2MEGAFIELD_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
