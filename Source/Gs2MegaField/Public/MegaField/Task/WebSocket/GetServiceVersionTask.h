...
#include "MegaField/Request/GetServiceVersionRequest.h"
#include "MegaField/Result/GetServiceVersionResult.h"

namespace Gs2::MegaField::Task::WebSocket
{
    class GS2MEGAFIELD_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
