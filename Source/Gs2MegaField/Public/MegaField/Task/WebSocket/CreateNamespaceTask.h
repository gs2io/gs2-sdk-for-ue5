...
#include "MegaField/Request/CreateNamespaceRequest.h"
#include "MegaField/Result/CreateNamespaceResult.h"

namespace Gs2::MegaField::Task::WebSocket
{
    class GS2MEGAFIELD_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
