...
#include "MegaField/Request/GetNamespaceRequest.h"
#include "MegaField/Result/GetNamespaceResult.h"

namespace Gs2::MegaField::Task::Rest
{
    class GS2MEGAFIELD_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
