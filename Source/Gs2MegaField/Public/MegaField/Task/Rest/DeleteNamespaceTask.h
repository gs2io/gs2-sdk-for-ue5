...
#include "MegaField/Request/DeleteNamespaceRequest.h"
#include "MegaField/Result/DeleteNamespaceResult.h"

namespace Gs2::MegaField::Task::Rest
{
    class GS2MEGAFIELD_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
