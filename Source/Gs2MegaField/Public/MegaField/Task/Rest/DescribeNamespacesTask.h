...
#include "MegaField/Request/DescribeNamespacesRequest.h"
#include "MegaField/Result/DescribeNamespacesResult.h"

namespace Gs2::MegaField::Task::Rest
{
    class GS2MEGAFIELD_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
