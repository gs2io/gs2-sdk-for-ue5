...
#include "MegaField/Result/ExportMasterResult.h"

namespace Gs2::MegaField::Task::Rest
{
    class GS2MEGAFIELD_API FExportMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FExportMasterResult>
    {
