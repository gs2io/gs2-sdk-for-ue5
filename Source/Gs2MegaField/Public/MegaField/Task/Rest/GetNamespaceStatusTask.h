...
#include "MegaField/Result/GetNamespaceStatusResult.h"

namespace Gs2::MegaField::Task::Rest
{
    class GS2MEGAFIELD_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
