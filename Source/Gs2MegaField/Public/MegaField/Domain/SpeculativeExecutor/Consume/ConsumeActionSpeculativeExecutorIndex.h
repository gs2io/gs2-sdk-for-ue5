...
namespace Gs2::MegaField::Domain::SpeculativeExecutor
{
    class GS2MEGAFIELD_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::MegaField::Domain::FGs2MegaFieldDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2MEGAFIELD_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::MegaField::Domain::FGs2MegaFieldDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2MEGAFIELD_API FCommitTask(
                const FCommitTask& From
            );

            GS2MEGAFIELD_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
