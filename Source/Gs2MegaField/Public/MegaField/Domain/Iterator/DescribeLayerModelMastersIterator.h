...
namespace Gs2::MegaField::Domain::Iterator
{
    ...
    class GS2MEGAFIELD_API FDescribeLayerModelMastersIterator :
        public TSharedFromThis<FDescribeLayerModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::MegaField::Model::FLayerModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeLayerModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::MegaField::Model::FLayerModelMasterPtr>> Range;
            TOptional<TArray<Gs2::MegaField::Model::FLayerModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLayerModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLayerModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLayerModelMastersIterator> Iterable)
            {
