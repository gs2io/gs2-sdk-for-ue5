...
namespace Gs2::MegaField::Domain::Iterator
{
    ...
    class GS2MEGAFIELD_API FDescribeAreaModelMastersIterator :
        public TSharedFromThis<FDescribeAreaModelMastersIterator>
    {
    ...
    public:
        ...
        FDescribeAreaModelMastersIterator(
            const FDescribeAreaModelMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::MegaField::Model::FAreaModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeAreaModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::MegaField::Model::FAreaModelMasterPtr>> Range;
            TOptional<TArray<Gs2::MegaField::Model::FAreaModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAreaModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAreaModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAreaModelMastersIterator> Iterable)
            {
