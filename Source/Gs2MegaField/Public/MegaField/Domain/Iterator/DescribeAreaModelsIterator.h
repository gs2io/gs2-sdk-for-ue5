...
namespace Gs2::MegaField::Domain::Iterator
{
    ...
    public:
        ...
        FDescribeAreaModelsIterator(
            const FDescribeAreaModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::MegaField::Model::FAreaModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeAreaModelsIterator> Self;
            TSharedPtr<TArray<Gs2::MegaField::Model::FAreaModelPtr>> Range;
            TOptional<TArray<Gs2::MegaField::Model::FAreaModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeAreaModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeAreaModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeAreaModelsIterator> Iterable)
            {
