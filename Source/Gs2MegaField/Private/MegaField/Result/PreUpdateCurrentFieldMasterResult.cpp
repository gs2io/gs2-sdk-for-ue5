...
{
    FPreUpdateCurrentFieldMasterResult::FPreUpdateCurrentFieldMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentFieldMasterResult> FPreUpdateCurrentFieldMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentFieldMasterResult> FPreUpdateCurrentFieldMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentFieldMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentFieldMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentFieldMasterResult> FPreUpdateCurrentFieldMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentFieldMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentFieldMasterResult::ToJson() const
    {
