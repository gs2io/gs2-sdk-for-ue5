...
namespace Gs2::MegaField::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Cache->Delete(Gs2::MegaField::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::MegaField::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::MegaField::Model::FNamespace>(
                ParentKey,
                Gs2::MegaField::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
