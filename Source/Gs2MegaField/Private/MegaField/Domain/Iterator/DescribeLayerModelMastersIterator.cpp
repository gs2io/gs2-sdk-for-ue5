...
namespace Gs2::MegaField::Domain::Iterator
{
    ...
    FDescribeLayerModelMastersIterator::FIterator& FDescribeLayerModelMastersIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::MegaField::Model::Cache::FLayerModelMasterCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->AreaModelName,
                TOptional<int32>()
            );
            ...
            const auto Request =
                MakeShared<Gs2::MegaField::Request::FDescribeLayerModelMastersRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeLayerModelMasters(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::MegaField::Model::FLayerModelMasterPtr>>();
