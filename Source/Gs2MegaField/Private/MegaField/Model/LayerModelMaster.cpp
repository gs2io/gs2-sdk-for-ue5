...
namespace Gs2::MegaField::Model::Cache
{
    ...
    FString FLayerModelMasterCache::PutUserData(
        const Gs2::Core::Domain::FCacheDatabasePtr& Cache,
        TOptional<FString> NamespaceName,
        TOptional<FString> UserId,
        TOptional<int32> TimeOffset,
        const Gs2::MegaField::Model::FLayerModelMasterPtr& Item
    )
    {
        ...
        Put(
            Cache,
            NamespaceName,
            (Item->GetLayerModelMasterId().IsSet() ? Gs2::MegaField::Model::FLayerModelMaster::GetAreaModelNameFromGrn(*Item->GetLayerModelMasterId()) : TOptional<FString>()),
            Item->GetName(),
            TimeOffset,
            Item
        );
