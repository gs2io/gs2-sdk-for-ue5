...
namespace Gs2::MegaField::Model
{
    ...
    TSharedPtr<FLayerModelMaster> FLayerModelMaster::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FLayerModelMaster>()
            ->WithLayerModelMasterId(Data->HasField("layerModelMasterId") ? [Data]() -> TOptional<FString>
                {
                    FString v("");
                    if (Data->TryGetStringField("layerModelMasterId", v))
                    {
    ...
    TSharedPtr<FJsonObject> FLayerModelMaster::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField("layerModelMasterId", LayerModelMasterIdValue.GetValue());
        }
        if (NameValue.IsSet())
        {
