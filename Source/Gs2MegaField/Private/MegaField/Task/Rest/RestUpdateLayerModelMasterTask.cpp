...
#include "MegaField/Task/Rest/UpdateLayerModelMasterTask.h"
...
{
    FUpdateLayerModelMasterTask::FUpdateLayerModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateLayerModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateLayerModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateLayerModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
