...
#include "MegaField/Task/Rest/NearUserIdsTask.h"
...
{
    FNearUserIdsTask::FNearUserIdsTask(
    ...
    Core::Model::FGs2ErrorPtr FNearUserIdsTask::Action(
        const TSharedPtr<Result::FNearUserIdsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/area/{areaModelName}/layer/{layerModelName}/spatial/near");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FNearUserIdsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
