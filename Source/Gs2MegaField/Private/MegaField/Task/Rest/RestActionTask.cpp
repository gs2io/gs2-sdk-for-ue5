...
#include "MegaField/Task/Rest/ActionTask.h"
...
namespace Gs2::MegaField::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FActionTask::Action(
        const TSharedPtr<Result::FActionResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/spatial/{areaModelName}/{layerModelName}/action");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FActionResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
