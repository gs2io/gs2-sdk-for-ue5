...
#include "MegaField/Task/Rest/DeleteAreaModelMasterTask.h"
...
{
    FDeleteAreaModelMasterTask::FDeleteAreaModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteAreaModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteAreaModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteAreaModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
