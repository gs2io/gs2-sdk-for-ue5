...
#include "MegaField/Task/Rest/NearUserIdsFromSystemTask.h"
...
{
    FNearUserIdsFromSystemTask::FNearUserIdsFromSystemTask(
    ...
    Core::Model::FGs2ErrorPtr FNearUserIdsFromSystemTask::Action(
        const TSharedPtr<Result::FNearUserIdsFromSystemResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/system/area/{areaModelName}/layer/{layerModelName}/spatial/near");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FNearUserIdsFromSystemResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
