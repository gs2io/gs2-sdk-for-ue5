...
#include "MegaField/Task/Rest/UpdateAreaModelMasterTask.h"
...
{
    FUpdateAreaModelMasterTask::FUpdateAreaModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateAreaModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateAreaModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/area/{areaModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateAreaModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
