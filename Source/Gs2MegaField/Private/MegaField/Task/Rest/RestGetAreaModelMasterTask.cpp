...
#include "MegaField/Task/Rest/GetAreaModelMasterTask.h"
...
{
    FGetAreaModelMasterTask::FGetAreaModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetAreaModelMasterTask::Action(
        const TSharedPtr<Result::FGetAreaModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetAreaModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
