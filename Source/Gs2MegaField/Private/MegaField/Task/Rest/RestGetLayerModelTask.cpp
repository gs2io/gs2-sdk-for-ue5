...
#include "MegaField/Task/Rest/GetLayerModelTask.h"
...
{
    FGetLayerModelTask::FGetLayerModelTask(
    ...
    FGetLayerModelTask::FGetLayerModelTask(
        const FGetLayerModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetLayerModelTask::Action(
        const TSharedPtr<Result::FGetLayerModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/area/{areaModelName}/layer/{layerModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLayerModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
