...
#include "MegaField/Task/Rest/PutPositionByUserIdTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/spatial/{areaModelName}/{layerModelName}");
            ...
            if (this->Request->GetVector() != nullptr && this->Request->GetVector().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("vector"), this->Request->GetVector()->ToJson());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPutPositionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
