...
#include "MegaField/Task/Rest/DeleteLayerModelMasterTask.h"
...
{
    FDeleteLayerModelMasterTask::FDeleteLayerModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteLayerModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteLayerModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteLayerModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
