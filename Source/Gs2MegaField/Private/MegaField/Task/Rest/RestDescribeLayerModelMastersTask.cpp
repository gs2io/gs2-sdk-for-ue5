...
#include "MegaField/Task/Rest/DescribeLayerModelMastersTask.h"
...
{
    FDescribeLayerModelMastersTask::FDescribeLayerModelMastersTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeLayerModelMastersTask::Action(
        const TSharedPtr<Result::FDescribeLayerModelMastersResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/area/{areaModelName}/layer");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeLayerModelMastersResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
