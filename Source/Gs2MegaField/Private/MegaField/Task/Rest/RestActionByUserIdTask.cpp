...
#include "MegaField/Task/Rest/ActionByUserIdTask.h"
...
{
    FActionByUserIdTask::FActionByUserIdTask(
    ...
    FActionByUserIdTask::FActionByUserIdTask(
        const FActionByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FActionByUserIdTask::Action(
        const TSharedPtr<Result::FActionByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/spatial/{areaModelName}/{layerModelName}/action");
            ...
            if (this->Request->GetScopes() != nullptr && this->Request->GetScopes().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetScopes())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FActionByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
