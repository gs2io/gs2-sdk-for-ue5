...
#include "MegaField/Task/Rest/GetAreaModelTask.h"
...
{
    FGetAreaModelTask::FGetAreaModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetAreaModelTask::Action(
        const TSharedPtr<Result::FGetAreaModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/area/{areaModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetAreaModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
