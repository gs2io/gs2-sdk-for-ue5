...
#include "MegaField/Task/Rest/DescribeLayerModelsTask.h"
...
{
    FDescribeLayerModelsTask::FDescribeLayerModelsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeLayerModelsTask::Action(
        const TSharedPtr<Result::FDescribeLayerModelsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/area/{areaModelName}/layer");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeLayerModelsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
