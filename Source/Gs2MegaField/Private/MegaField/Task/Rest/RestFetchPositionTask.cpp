...
#include "MegaField/Task/Rest/FetchPositionTask.h"
...
{
    FFetchPositionTask::FFetchPositionTask(
    ...
    Core::Model::FGs2ErrorPtr FFetchPositionTask::Action(
        const TSharedPtr<Result::FFetchPositionResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/area/{areaModelName}/layer/{layerModelName}/spatial/fetch");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FFetchPositionResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
