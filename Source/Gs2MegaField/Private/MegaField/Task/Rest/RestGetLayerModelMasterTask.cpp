...
#include "MegaField/Task/Rest/GetLayerModelMasterTask.h"
...
{
    FGetLayerModelMasterTask::FGetLayerModelMasterTask(
    ...
    FGetLayerModelMasterTask::FGetLayerModelMasterTask(
        const FGetLayerModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetLayerModelMasterTask::Action(
        const TSharedPtr<Result::FGetLayerModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/area/{areaModelName}/layer/{layerModelName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLayerModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
