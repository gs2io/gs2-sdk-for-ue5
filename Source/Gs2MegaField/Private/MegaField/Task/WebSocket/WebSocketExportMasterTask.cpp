...
#include "MegaField/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::MegaField::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("megaField"), TEXT("currentFieldMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
