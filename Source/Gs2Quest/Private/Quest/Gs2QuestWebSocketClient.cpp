...
namespace Gs2::Quest
{
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FGetServiceVersionTask>> FGs2QuestWebSocketClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FPrepareImportUserDataByUserIdTask>> FGs2QuestWebSocketClient::PrepareImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FImportUserDataByUserIdTask>> FGs2QuestWebSocketClient::ImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FCheckImportUserDataByUserIdTask>> FGs2QuestWebSocketClient::CheckImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::WebSocket::FPreUpdateCurrentQuestMasterTask>> FGs2QuestWebSocketClient::PreUpdateCurrentQuestMaster(
        const Request::FPreUpdateCurrentQuestMasterRequestPtr Request) const
    {
        return Gs2::Core::Util::New<FAsyncTask<Task::WebSocket::FPreUpdateCurrentQuestMasterTask>>(
            Session,
            Request
        );
    }
