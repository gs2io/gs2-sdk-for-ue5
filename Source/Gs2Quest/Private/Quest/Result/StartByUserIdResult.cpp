...
#include "Quest/Result/StartByUserIdResult.h"
...
namespace Gs2::Quest::Result
{
    ...
    TSharedPtr<FStartByUserIdResult> FStartByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FStartByUserIdResult> FStartByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FStartByUserIdResult> FStartByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FStartByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FStartByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FStartByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FStartByUserIdResult::GetTransactionResult() const
    {
