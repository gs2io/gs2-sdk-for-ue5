...
#include "Quest/Result/EndByUserIdResult.h"
...
namespace Gs2::Quest::Result
{
    ...
    TSharedPtr<FEndByUserIdResult> FEndByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FEndByUserIdResult> FEndByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FEndByUserIdResult> FEndByUserIdResult::WithTransactionResult(
    ...
    TOptional<bool> FEndByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FEndByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FEndByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FEndByUserIdResult::GetTransactionResult() const
    {
