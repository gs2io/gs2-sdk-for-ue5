    ...
    TSharedPtr<FQuestModelMaster> FQuestModelMaster::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FQuestModelMaster>()
            ...
            ->WithFirstCompleteAcquireActions(Data->HasField(ANSI_TO_TCHAR("firstCompleteAcquireActions")) ? [Data]() -> TSharedPtr<TArray<Model::FAcquireActionPtr>>
                {
                    if (!Data->HasTypedField<EJson::Array>(ANSI_TO_TCHAR("firstCompleteAcquireActions")))
                    {
                        return nullptr;
                    }
            ...
            ->WithFailedAcquireActions(Data->HasField(ANSI_TO_TCHAR("failedAcquireActions")) ? [Data]() -> TSharedPtr<TArray<Model::FAcquireActionPtr>>
                {
                    if (!Data->HasTypedField<EJson::Array>(ANSI_TO_TCHAR("failedAcquireActions")))
                    {
                        return nullptr;
                    }
                    auto v = MakeShared<TArray<Model::FAcquireActionPtr>>();
            ...
            ->WithPremiseQuestNames(Data->HasField(ANSI_TO_TCHAR("premiseQuestNames")) ? [Data]() -> TSharedPtr<TArray<FString>>
                {
                    if (!Data->HasTypedField<EJson::Array>(ANSI_TO_TCHAR("premiseQuestNames")))
                    {
                        return nullptr;
                    }
...
{
    FString FQuestModelMasterCache::CreateCacheParentKey(
    ...
    )
    {
        return FString("quest:")
            ...
            + FString::FromInt(CacheOwnerArgumentTimeOffset.Get(0)) + FString(":QuestModelMaster");
    }

    FString FQuestModelMasterCache::CreateCacheKey(
    ...
    bool FQuestModelMasterCache::TryGet(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<FString> CacheOwnerArgumentQuestName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Quest::Model::FQuestModelMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Quest::Model::FQuestModelMasterPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Quest::Model::FQuestModelMaster>(
    ...
    void FQuestModelMasterCache::Put(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<FString> CacheOwnerArgumentQuestName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Quest::Model::FQuestModelMasterPtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Quest::Model::FQuestModelMasterPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Quest::Model::FQuestModelMaster>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Quest::Model::FQuestModelMaster::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
            FDateTime::Now() + FTimespan::FromMinutes(Gs2::Core::Domain::DefaultCacheMinutes)
        );
    }

    FString FQuestModelMasterCache::PutUserData(
        const Gs2::Core::Domain::FCacheDatabasePtr& Cache,
        TOptional<FString> NamespaceName,
        TOptional<FString> UserId,
        TOptional<int32> TimeOffset,
        const Gs2::Quest::Model::FQuestModelMasterPtr& Item
    )
    {
    ...
    void FQuestModelMasterCache::Delete(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<FString> CacheOwnerArgumentQuestName,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Quest::Model::FQuestModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentQuestGroupName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FQuestModelMasterCache::Fetch(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<FString> CacheOwnerArgumentQuestName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Quest::Model::FQuestModelMasterPtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Quest::Model::FQuestModelMasterPtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Quest::Model::FQuestModelMasterPtr CacheOwnerFetchedItem;
        ...
        if (CacheOwnerDetails.IsValid() && CacheOwnerDetails->Num() > 0 && (*CacheOwnerDetails)[0].IsValid() && (*CacheOwnerDetails)[0]->GetComponent() == TEXT("questModelMaster"))
        {
            return nullptr;
        }
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
    ...
    Gs2::Core::Domain::CallbackID FQuestModelMasterCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Quest::Model::FQuestModelMasterPtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Quest::Model::FQuestModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentQuestGroupName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Quest::Model::FQuestModelMasterPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Quest::Model::FQuestModelMaster>(CacheOwnerValue));
            if (CacheOwnerArgumentCallback) CacheOwnerArgumentCallback(CacheOwnerTypedValues);
        });
    }

    void FQuestModelMasterCache::ListUnsubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<FString> CacheOwnerArgumentQuestGroupName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Quest::Model::FQuestModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentQuestGroupName,
            CacheOwnerArgumentTimeOffset
