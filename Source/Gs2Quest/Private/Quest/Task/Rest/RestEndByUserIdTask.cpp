...
#include "Quest/Task/Rest/EndByUserIdTask.h"
...
{
    FEndByUserIdTask::FEndByUserIdTask(
    ...
    FEndByUserIdTask::FEndByUserIdTask(
        const FEndByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FEndByUserIdTask::Action(
        const TSharedPtr<Result::FEndByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/progress/end");
            ...
            if (this->Request->GetIsComplete().IsSet())
            {
                JsonRootObject->SetBoolField("isComplete", this->Request->GetIsComplete().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FEndByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
