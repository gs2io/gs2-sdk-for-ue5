...
#include "Quest/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Quest::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("quest"), TEXT("currentQuestMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
