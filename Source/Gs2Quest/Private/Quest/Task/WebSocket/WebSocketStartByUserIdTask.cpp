...
#include "Quest/Task/WebSocket/StartByUserIdTask.h"
...
namespace Gs2::Quest::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("quest"), TEXT("progress"), TEXT("startByUserId"), ToCStr(RequestPayload->Payload()));
