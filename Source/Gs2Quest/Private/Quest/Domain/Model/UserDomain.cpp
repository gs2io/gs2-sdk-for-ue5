...
namespace Gs2::Quest::Domain::Model
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FUserDomain::FEndTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Quest::Domain::Model::FUserDomain>> Result
    )
    {
        Request
    ...
    TSharedPtr<FAsyncTask<FUserDomain::FEndTask>> FUserDomain::End(
        Request::FEndByUserIdRequestPtr Request
    ) {
        return Gs2::Core::Util::New<FAsyncTask<FEndTask>>(this->AsShared(), Request);
    }

    FUserDomain::FDeleteProgressTask::FDeleteProgressTask(
        const TSharedPtr<FUserDomain> Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FUserDomain::FDeleteProgressTask::Action(
        TSharedPtr<TSharedPtr<Gs2::Quest::Domain::Model::FProgressDomain>> Result
    )
    {
        Request
    ...
    TSharedPtr<FAsyncTask<FUserDomain::FDeleteProgressTask>> FUserDomain::DeleteProgress(
        Request::FDeleteProgressByUserIdRequestPtr Request
    ) {
        return Gs2::Core::Util::New<FAsyncTask<FDeleteProgressTask>>(this->AsShared(), Request);
    }
