...
namespace Gs2::Quest::Domain::Model
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FUserAccessTokenDomain::FDeleteProgressTask::Action(
    ...
    )
    {
        ...
        auto Domain = MakeShared<Gs2::Quest::Domain::Model::FProgressAccessTokenDomain>(
            Self->Cache,
            Self->JobQueueDomain,
            Self->StampSheetConfiguration,
            Self->Session,
    ...
    TSharedPtr<FAsyncTask<FUserAccessTokenDomain::FDeleteProgressTask>> FUserAccessTokenDomain::DeleteProgress(
