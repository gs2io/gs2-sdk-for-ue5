...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeCompletedQuestListsByUserIdIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FCompletedQuestList>> Result)
    {
        ++Iterator;
    ...
    FDescribeCompletedQuestListsByUserIdIterator::FIterator::FIterator(
    ...
    FDescribeCompletedQuestListsByUserIdIterator::FIterator FDescribeCompletedQuestListsByUserIdIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeCompletedQuestListsByUserIdIterator::FIterator FDescribeCompletedQuestListsByUserIdIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeCompletedQuestListsByUserIdIterator::FIterator FDescribeCompletedQuestListsByUserIdIterator::end()
    {
