...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    FDescribeProgressesByUserIdIterator::FIterator& FDescribeProgressesByUserIdIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Quest::Model::Cache::FProgressCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->UserId,
                TOptional<int32>()
            );
            ...
            const auto Request =
                MakeShared<Gs2::Quest::Request::FDescribeProgressesByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeProgressesByUserId(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Quest::Model::FProgressPtr>>();
