...
namespace Gs2::Quest::Domain
{
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Quest::Model::Cache::FNamespaceCache::CreateCacheParentKey(
                TOptional<int32>()
            ),
            Callback,
            Callback
    ...
    class FGs2QuestDomain::FCollectNamespacesTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Quest::Model::FNamespacePtr>>, public TSharedFromThis<FCollectNamespacesTask>
    {
        const TSharedPtr<FGs2QuestDomain> Self;
        const TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> OnCollected;
    const TOptional<FString> QueryNamePrefix;
    public:
        explicit FCollectNamespacesTask(const TSharedPtr<FGs2QuestDomain>& Self, TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> OnCollected,const TOptional<FString> NamePrefix) : Self(Self), OnCollected(OnCollected), QueryNamePrefix(NamePrefix) {}
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Quest::Model::FNamespacePtr>>> Result) override
        {
            TArray<Gs2::Quest::Model::FNamespacePtr> Items;
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::Quest::Model::FNamespacePtr>>(Items);
    ...
    Gs2::Core::Domain::CallbackID FGs2QuestDomain::SubscribeNamespaces(
        TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix
    )
    {
        const TWeakPtr<Gs2::Core::Domain::FGs2> WeakGs2 = this->Gs2;
        const auto QueryNamePrefix = NamePrefix;
        const auto Parent = Gs2::Quest::Model::Cache::FNamespaceCache::CreateCacheParentKey(
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [Callback, WeakGs2](const TArray<FGs2ObjectPtr>& Values)
            {
                ...
                TArray<Gs2::Quest::Model::FNamespacePtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::Quest::Model::FNamespace>(Value));
            ...
            [WeakGs2, Callback, QueryNamePrefix]()
            {
                ...
                const auto Domain = MakeShared<FGs2QuestDomain>(Owner);
    ...
    void FGs2QuestDomain::InvalidateNamespaces(const TOptional<FString> NamePrefix)
    {
    ...
    FGs2QuestDomain::FSubscribeNamespacesWithInitialCallTask::FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2QuestDomain>& Self, TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix) : Self(Self), Callback(Callback), QueryNamePrefix(NamePrefix) {}
    FGs2QuestDomain::FSubscribeNamespacesWithInitialCallTask::FSubscribeNamespacesWithInitialCallTask(const FSubscribeNamespacesWithInitialCallTask& From) : TGs2Future(From), Self(From.Self), Callback(From.Callback), QueryNamePrefix(From.QueryNamePrefix) {}
    Gs2::Core::Model::FGs2ErrorPtr FGs2QuestDomain::FSubscribeNamespacesWithInitialCallTask::Action(TSharedPtr<TSharedPtr<Gs2::Core::Domain::CallbackID>> Result)
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectNamespacesTask>>(Self, TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)>(), QueryNamePrefix);
    ...
    TSharedPtr<FAsyncTask<FGs2QuestDomain::FSubscribeNamespacesWithInitialCallTask>> FGs2QuestDomain::SubscribeNamespacesWithInitialCall(TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix)
    {
