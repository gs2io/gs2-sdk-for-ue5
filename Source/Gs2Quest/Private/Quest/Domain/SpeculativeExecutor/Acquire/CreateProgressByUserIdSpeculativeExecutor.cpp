...
#include "Quest/Domain/SpeculativeExecutor/Acquire/CreateProgressByUserIdSpeculativeExecutor.h"
...
namespace Gs2::Quest::Domain::SpeculativeExecutor
{
    ...
    {
        return FString("Gs2Quest:CreateProgressByUserId");
    }

    Gs2::Core::Model::FGs2ErrorPtr FCreateProgressByUserIdSpeculativeExecutor::Transform(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr& Request,
    ...
    Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr FCreateProgressByUserIdSpeculativeExecutor::Rate(
        const Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr& Request,
        const double Rate
    )
    {
