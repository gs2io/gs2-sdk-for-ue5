...
{
    class GS2QUEST_API FGetProgressByUserIdResult final : public TSharedFromThis<FGetProgressByUserIdResult>
    {
    ...
    public:
        ...
        TSharedPtr<FGetProgressByUserIdResult> WithQuestGroup(const TSharedPtr<Model::FQuestGroupModel> QuestGroup);
        TSharedPtr<FGetProgressByUserIdResult> WithQuest(const TSharedPtr<Model::FQuestModel> Quest);
