...
{
    class GS2QUEST_API FExportMasterResult final : public TSharedFromThis<FExportMasterResult>
    {
    ...
    public:
        ...
        TSharedPtr<FExportMasterResult> WithItem(const TSharedPtr<Model::FCurrentQuestMaster> Item);
