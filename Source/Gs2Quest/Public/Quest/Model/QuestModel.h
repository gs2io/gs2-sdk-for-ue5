...
{
    class GS2QUEST_API FQuestModel final : public FGs2Object, public TSharedFromThis<FQuestModel>
    {
    ...
    public:
        ...
        virtual ~FQuestModel() override = default;
        ...
        TSharedPtr<FQuestModel> WithVerifyActions(const TSharedPtr<TArray<TSharedPtr<FVerifyAction>>> VerifyActions);
