...
namespace Gs2::Quest::Request
{
    ...
    class GS2QUEST_API FDeleteProgressByStampTaskRequest final : public TSharedFromThis<FDeleteProgressByStampTaskRequest>
    {
    ...
    typedef TSharedPtr<FDeleteProgressByStampTaskRequest, ESPMode::ThreadSafe> FDeleteProgressByStampTaskRequestPtr;
}