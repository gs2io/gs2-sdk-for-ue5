...
namespace Gs2::Quest::Request
{
    ...
    class GS2QUEST_API FDeleteProgressByUserIdRequest final : public TSharedFromThis<FDeleteProgressByUserIdRequest>
    {
    ...
    typedef TSharedPtr<FDeleteProgressByUserIdRequest, ESPMode::ThreadSafe> FDeleteProgressByUserIdRequestPtr;
}