...
namespace Gs2::Quest::Domain
{
    ...
    class GS2QUEST_API FGs2QuestDomain:
        public TSharedFromThis<FGs2QuestDomain>
    {
    ...
    public:
        ...
        class GS2QUEST_API FCreateNamespaceTask final :
        ...
        class GS2QUEST_API FDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FCheckDumpUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FCheckCleanUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        class GS2QUEST_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2QuestDomain>,
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2QUEST_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2QuestDomain> Self;
            const TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2QuestDomain>& Self, TFunction<void(TArray<Gs2::Quest::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
