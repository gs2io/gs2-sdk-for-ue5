...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    class GS2QUEST_API FDescribeCompletedQuestListsIterator :
        public TSharedFromThis<FDescribeCompletedQuestListsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeCompletedQuestListsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCompletedQuestListsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCompletedQuestListsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCompletedQuestListsIterator> Iterable)
            {
