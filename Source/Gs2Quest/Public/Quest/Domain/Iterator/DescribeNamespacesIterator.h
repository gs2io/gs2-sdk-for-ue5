...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FNamespace>> Result) override;
        ...
        class GS2QUEST_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Quest::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
