...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    class GS2QUEST_API FDescribeQuestModelMastersIterator :
        public TSharedFromThis<FDescribeQuestModelMastersIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FQuestModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeQuestModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Quest::Model::FQuestModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FQuestModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeQuestModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeQuestModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeQuestModelMastersIterator> Iterable)
            {
