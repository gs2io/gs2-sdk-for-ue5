...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    class GS2QUEST_API FDescribeQuestGroupModelsIterator :
        public TSharedFromThis<FDescribeQuestGroupModelsIterator>
    {
    ...
    public:
        ...
        FDescribeQuestGroupModelsIterator(
            const FDescribeQuestGroupModelsIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FQuestGroupModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeQuestGroupModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Quest::Model::FQuestGroupModelPtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FQuestGroupModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeQuestGroupModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeQuestGroupModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeQuestGroupModelsIterator> Iterable)
            {
