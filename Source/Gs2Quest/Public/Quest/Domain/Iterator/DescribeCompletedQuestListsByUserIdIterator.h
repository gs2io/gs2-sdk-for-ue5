...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    class GS2QUEST_API FDescribeCompletedQuestListsByUserIdIterator :
        public TSharedFromThis<FDescribeCompletedQuestListsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FCompletedQuestList>> Result) override;
        ...
        {
            TSharedRef<FDescribeCompletedQuestListsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Quest::Model::FCompletedQuestListPtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FCompletedQuestListPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FDescribeCompletedQuestListsByUserIdIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeCompletedQuestListsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeCompletedQuestListsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeCompletedQuestListsByUserIdIterator> Iterable)
            {
