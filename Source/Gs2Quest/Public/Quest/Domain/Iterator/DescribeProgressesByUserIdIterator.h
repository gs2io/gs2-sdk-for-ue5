...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    class GS2QUEST_API FDescribeProgressesByUserIdIterator :
        public TSharedFromThis<FDescribeProgressesByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FProgress>> Result) override;
        ...
        {
            TSharedRef<FDescribeProgressesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Quest::Model::FProgressPtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FProgressPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeProgressesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeProgressesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeProgressesByUserIdIterator> Iterable)
            {
