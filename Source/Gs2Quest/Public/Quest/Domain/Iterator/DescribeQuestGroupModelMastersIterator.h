...
namespace Gs2::Quest::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Quest::Model::FQuestGroupModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeQuestGroupModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Quest::Model::FQuestGroupModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Quest::Model::FQuestGroupModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeQuestGroupModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeQuestGroupModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeQuestGroupModelMastersIterator> Iterable)
            {
