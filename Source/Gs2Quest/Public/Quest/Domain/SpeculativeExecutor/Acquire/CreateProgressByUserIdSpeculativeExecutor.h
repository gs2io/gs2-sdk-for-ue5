...
namespace Gs2::Quest::Domain::SpeculativeExecutor
{
    ...
    class GS2QUEST_API FCreateProgressByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2QUEST_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Quest::Domain::FGs2QuestDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr& Request
            ...
            GS2QUEST_API FCommitTask(
                const FCommitTask& From
            );

            GS2QUEST_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr Rate(
            const Gs2::Quest::Request::FCreateProgressByUserIdRequestPtr& Request,
            const double Rate
        );
