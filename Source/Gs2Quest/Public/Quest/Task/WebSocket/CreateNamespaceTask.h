...
#include "Quest/Result/CreateNamespaceResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
