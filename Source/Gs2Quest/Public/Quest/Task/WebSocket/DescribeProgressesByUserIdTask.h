...
{
    class GS2QUEST_API FDescribeProgressesByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeProgressesByUserIdResult>
    {
    ...
    public:
        ...
        virtual Core::Model::FGs2ErrorPtr Action(const TSharedPtr<Result::FDescribeProgressesByUserIdResultPtr> Result) override;
    };
