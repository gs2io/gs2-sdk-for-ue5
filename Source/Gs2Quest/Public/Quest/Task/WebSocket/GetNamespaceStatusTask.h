...
#include "Quest/Request/GetNamespaceStatusRequest.h"
#include "Quest/Result/GetNamespaceStatusResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
