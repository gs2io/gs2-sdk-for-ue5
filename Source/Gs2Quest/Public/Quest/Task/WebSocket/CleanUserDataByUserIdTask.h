...
#include "Quest/Request/CleanUserDataByUserIdRequest.h"
#include "Quest/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
