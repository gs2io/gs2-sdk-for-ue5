...
#include "Quest/Result/UpdateNamespaceResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
