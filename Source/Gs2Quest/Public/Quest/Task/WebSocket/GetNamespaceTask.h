...
#include "Quest/Request/GetNamespaceRequest.h"
#include "Quest/Result/GetNamespaceResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
