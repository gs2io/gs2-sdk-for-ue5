...
#include "Quest/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Quest/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
