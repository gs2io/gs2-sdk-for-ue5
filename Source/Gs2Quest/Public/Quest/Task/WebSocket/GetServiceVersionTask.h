...
#include "Quest/Request/GetServiceVersionRequest.h"
#include "Quest/Result/GetServiceVersionResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
