...
#include "Quest/Request/DescribeNamespacesRequest.h"
#include "Quest/Result/DescribeNamespacesResult.h"

namespace Gs2::Quest::Task::WebSocket
{
    class GS2QUEST_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
