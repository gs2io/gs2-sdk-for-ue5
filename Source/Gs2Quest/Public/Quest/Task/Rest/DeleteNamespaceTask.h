...
#include "Quest/Result/DeleteNamespaceResult.h"

namespace Gs2::Quest::Task::Rest
{
    class GS2QUEST_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
