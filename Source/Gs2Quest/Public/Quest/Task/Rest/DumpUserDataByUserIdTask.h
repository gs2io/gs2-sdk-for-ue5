...
#include "Quest/Request/DumpUserDataByUserIdRequest.h"
#include "Quest/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::Rest
{
    class GS2QUEST_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
