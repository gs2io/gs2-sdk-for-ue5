...
#include "Quest/Request/CheckImportUserDataByUserIdRequest.h"
#include "Quest/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::Rest
{
    class GS2QUEST_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
