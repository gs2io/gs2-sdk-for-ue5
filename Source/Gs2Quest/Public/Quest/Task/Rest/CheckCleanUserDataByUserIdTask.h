...
#include "Quest/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Quest/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::Rest
{
    class GS2QUEST_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
