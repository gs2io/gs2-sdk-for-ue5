...
#include "Quest/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Quest/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Quest::Task::Rest
{
    class GS2QUEST_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
