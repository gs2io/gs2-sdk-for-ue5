...
#include "JobQueue/Task/Rest/DeleteDeadLetterJobByUserIdTask.h"
...
{
    FDeleteDeadLetterJobByUserIdTask::FDeleteDeadLetterJobByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteDeadLetterJobByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteDeadLetterJobByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/dead/{deadLetterJobName}");
            ...
            Url = Url.Replace(
                TEXT("{deadLetterJobName}"),
                !this->Request->GetDeadLetterJobName().IsSet() || this->Request->GetDeadLetterJobName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetDeadLetterJobName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteDeadLetterJobByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
