...
#include "JobQueue/Task/Rest/GetJobResultTask.h"
...
{
    FGetJobResultTask::FGetJobResultTask(
    ...
    FGetJobResultTask::FGetJobResultTask(
        const FGetJobResultTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetJobResultTask::Action(
        const TSharedPtr<Result::FGetJobResultResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/job/{jobName}/result");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetJobResultResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
