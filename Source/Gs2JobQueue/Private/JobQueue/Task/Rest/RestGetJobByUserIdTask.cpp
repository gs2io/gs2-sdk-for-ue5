...
#include "JobQueue/Task/Rest/GetJobByUserIdTask.h"
...
{
    FGetJobByUserIdTask::FGetJobByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetJobByUserIdTask::Action(
        const TSharedPtr<Result::FGetJobByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetJobByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
