...
#include "JobQueue/Task/Rest/UpdateNamespaceTask.h"
...
namespace Gs2::JobQueue::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetEnableAutoRun().IsSet())
            {
                JsonRootObject->SetBoolField(TEXT("enableAutoRun"), this->Request->GetEnableAutoRun().GetValue());
            }
            if (this->Request->GetPushNotification() != nullptr && this->Request->GetPushNotification().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("pushNotification"), this->Request->GetPushNotification()->ToJson());
            }
            if (this->Request->GetRunNotification() != nullptr && this->Request->GetRunNotification().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("runNotification"), this->Request->GetRunNotification()->ToJson());
            }
