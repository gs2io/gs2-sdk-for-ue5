...
#include "JobQueue/Task/Rest/DeleteByStampTaskTask.h"
...
{
    FDeleteByStampTaskTask::FDeleteByStampTaskTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteByStampTaskTask::Action(
        const TSharedPtr<Result::FDeleteByStampTaskResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteByStampTaskResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
