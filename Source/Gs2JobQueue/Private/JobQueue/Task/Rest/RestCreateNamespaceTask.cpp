...
namespace Gs2::JobQueue::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetBoolField("enableAutoRun", this->Request->GetEnableAutoRun().GetValue());
            }
            if (this->Request->GetPushNotification() != nullptr && this->Request->GetPushNotification().IsValid())
            {
                JsonRootObject->SetObjectField("pushNotification", this->Request->GetPushNotification()->ToJson());
            }
            if (this->Request->GetRunNotification() != nullptr && this->Request->GetRunNotification().IsValid())
            {
                JsonRootObject->SetObjectField("runNotification", this->Request->GetRunNotification()->ToJson());
            }
