...
#include "JobQueue/Task/Rest/DeleteJobByUserIdTask.h"
...
{
    FDeleteJobByUserIdTask::FDeleteJobByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteJobByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteJobByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/job/{jobName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteJobByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
