...
#include "JobQueue/Task/Rest/GetDeadLetterJobByUserIdTask.h"
...
{
    FGetDeadLetterJobByUserIdTask::FGetDeadLetterJobByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetDeadLetterJobByUserIdTask::Action(
        const TSharedPtr<Result::FGetDeadLetterJobByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDeadLetterJobByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
