...
#include "JobQueue/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::JobQueue::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("jobQueue"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
