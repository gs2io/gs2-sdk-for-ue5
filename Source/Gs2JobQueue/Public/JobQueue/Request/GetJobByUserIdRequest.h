...
namespace Gs2::JobQueue::Request
{
    ...
    public:
        ...
        TSharedPtr<FGetJobByUserIdRequest> WithTimeOffsetToken(const TOptional<FString> TimeOffsetToken);
    ...
    typedef TSharedPtr<FGetJobByUserIdRequest> FGetJobByUserIdRequestPtr;
}