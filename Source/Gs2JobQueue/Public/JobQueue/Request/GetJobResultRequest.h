...
{
    class FGetJobResultRequest;

    class GS2JOBQUEUE_API FGetJobResultRequest final : public TSharedFromThis<FGetJobResultRequest>
    {
    ...
    public:
        ...
        FGetJobResultRequest();
        FGetJobResultRequest(
            const FGetJobResultRequest& From
        );
        ~FGetJobResultRequest() = default;

        TSharedPtr<FGetJobResultRequest> WithContextStack(const TOptional<FString> ContextStack);
    ...
    typedef TSharedPtr<FGetJobResultRequest, ESPMode::ThreadSafe> FGetJobResultRequestPtr;
}