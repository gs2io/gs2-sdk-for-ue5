...
#include "JobQueue/Request/CleanUserDataByUserIdRequest.h"
#include "JobQueue/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
