...
#include "JobQueue/Request/CheckImportUserDataByUserIdRequest.h"
#include "JobQueue/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
