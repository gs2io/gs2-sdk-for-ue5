...
#include "JobQueue/Request/CheckCleanUserDataByUserIdRequest.h"
#include "JobQueue/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
