...
#include "JobQueue/Request/GetNamespaceStatusRequest.h"
#include "JobQueue/Result/GetNamespaceStatusResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
