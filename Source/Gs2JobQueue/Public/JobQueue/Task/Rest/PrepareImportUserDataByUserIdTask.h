...
#include "JobQueue/Request/PrepareImportUserDataByUserIdRequest.h"
#include "JobQueue/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
