...
#include "JobQueue/Request/GetServiceVersionRequest.h"
#include "JobQueue/Result/GetServiceVersionResult.h"

namespace Gs2::JobQueue::Task::Rest
{
    class GS2JOBQUEUE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
