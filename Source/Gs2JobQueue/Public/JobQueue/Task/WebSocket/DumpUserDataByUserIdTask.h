...
#include "JobQueue/Request/DumpUserDataByUserIdRequest.h"
#include "JobQueue/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::WebSocket
{
    class GS2JOBQUEUE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
