...
#include "JobQueue/Request/ImportUserDataByUserIdRequest.h"
#include "JobQueue/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::WebSocket
{
    class GS2JOBQUEUE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
