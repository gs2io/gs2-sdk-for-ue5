...
#include "JobQueue/Request/DeleteNamespaceRequest.h"
#include "JobQueue/Result/DeleteNamespaceResult.h"

namespace Gs2::JobQueue::Task::WebSocket
{
    class GS2JOBQUEUE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
