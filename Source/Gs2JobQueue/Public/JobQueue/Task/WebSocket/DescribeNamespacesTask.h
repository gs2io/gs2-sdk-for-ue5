...
#include "JobQueue/Request/DescribeNamespacesRequest.h"
#include "JobQueue/Result/DescribeNamespacesResult.h"

namespace Gs2::JobQueue::Task::WebSocket
{
    class GS2JOBQUEUE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
