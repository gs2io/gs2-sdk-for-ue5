...
#include "JobQueue/Request/CheckDumpUserDataByUserIdRequest.h"
#include "JobQueue/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::JobQueue::Task::WebSocket
{
    class GS2JOBQUEUE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
