...
namespace Gs2::JobQueue::Domain::SpeculativeExecutor
{
    ...
    class GS2JOBQUEUE_API FPushByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2JOBQUEUE_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::JobQueue::Domain::FGs2JobQueueDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::JobQueue::Request::FPushByUserIdRequestPtr& Request
            ...
            GS2JOBQUEUE_API FCommitTask(
                const FCommitTask& From
            );

            GS2JOBQUEUE_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::JobQueue::Request::FPushByUserIdRequestPtr Rate(
            const Gs2::JobQueue::Request::FPushByUserIdRequestPtr& Request,
            const double Rate
        );
