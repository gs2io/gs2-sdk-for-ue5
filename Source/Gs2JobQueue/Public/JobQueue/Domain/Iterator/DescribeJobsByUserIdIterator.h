...
namespace Gs2::JobQueue::Domain::Iterator
{
    ...
    class GS2JOBQUEUE_API FDescribeJobsByUserIdIterator :
        public TSharedFromThis<FDescribeJobsByUserIdIterator>
    {
    ...
    public:
        ...
        FDescribeJobsByUserIdIterator(
            const FDescribeJobsByUserIdIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::JobQueue::Model::FJob>> Result) override;
        ...
        {
            TSharedRef<FDescribeJobsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::JobQueue::Model::FJobPtr>> Range;
            TOptional<TArray<Gs2::JobQueue::Model::FJobPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeJobsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeJobsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeJobsByUserIdIterator> Iterable)
            {
