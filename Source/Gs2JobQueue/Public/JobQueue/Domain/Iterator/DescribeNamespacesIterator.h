...
namespace Gs2::JobQueue::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::JobQueue::Model::FNamespace>> Result) override;
        ...
        class GS2JOBQUEUE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::JobQueue::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::JobQueue::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
