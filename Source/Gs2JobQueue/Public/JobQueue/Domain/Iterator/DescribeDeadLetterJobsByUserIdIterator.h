...
namespace Gs2::JobQueue::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::JobQueue::Model::FDeadLetterJob>> Result) override;
        ...
        class GS2JOBQUEUE_API FIterator
        {
            TSharedRef<FDescribeDeadLetterJobsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::JobQueue::Model::FDeadLetterJobPtr>> Range;
            TOptional<TArray<Gs2::JobQueue::Model::FDeadLetterJobPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDeadLetterJobsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDeadLetterJobsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDeadLetterJobsByUserIdIterator> Iterable)
            {
