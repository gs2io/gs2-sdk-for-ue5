...
{
	class FAutoJobQueueDomain: public FTransactionDomain
	{
	private:
    ...
    public:
	    ...
	    virtual ~FAutoJobQueueDomain() override = default;
    ...
    typedef TSharedPtr<FAutoJobQueueDomain> FAutoJobQueueDomainPtr;
}
