...
namespace Gs2::UE5::Friend::Domain::Iterator
{
        ...
        public TSharedFromThis<FEzDescribeSendRequestsIterator>
    {
		...
		Gs2::Friend::Domain::Iterator::FDescribeSendRequestsIteratorPtr DomainIterable;

	public:

        explicit FEzDescribeSendRequestsIterator(
            Gs2::Friend::Domain::Iterator::FDescribeSendRequestsIterator& DomainIterable
		...
		class EZGS2_API FIterator
		{
			...
			Gs2::Friend::Domain::Iterator::FDescribeSendRequestsIterator::FIterator DomainIterator;
