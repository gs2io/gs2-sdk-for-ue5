...
namespace Gs2::UE5::Gateway::Domain::Model
{
    ...
    class EZGS2_API FEzFirebaseTokenDomain final :
        public TSharedFromThis<FEzFirebaseTokenDomain>
    {
    ...
    typedef TSharedPtr<FEzFirebaseTokenDomain> FEzFirebaseTokenDomainPtr;
}
