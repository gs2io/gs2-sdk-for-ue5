...
#include "StateMachine/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::StateMachine::Model
{
	...
	public:
        ...
        Gs2::StateMachine::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::StateMachine::Model::FAcquireActionResultPtr Model);
    };
