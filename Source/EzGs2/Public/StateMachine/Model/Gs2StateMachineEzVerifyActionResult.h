...
#include "StateMachine/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::StateMachine::Model
{
	...
	public:
        ...
        Gs2::StateMachine::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::StateMachine::Model::FVerifyActionResultPtr Model);
    };
