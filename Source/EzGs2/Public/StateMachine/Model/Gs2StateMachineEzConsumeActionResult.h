...
#include "StateMachine/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::StateMachine::Model
{
	...
	public:
        ...
        Gs2::StateMachine::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::StateMachine::Model::FConsumeActionResultPtr Model);
    };
