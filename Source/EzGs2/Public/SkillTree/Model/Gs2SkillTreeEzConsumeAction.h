...
#include "SkillTree/Model/ConsumeAction.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FConsumeActionPtr ToModel() const;
        static TSharedPtr<FEzConsumeAction> FromModel(Gs2::SkillTree::Model::FConsumeActionPtr Model);
    };
