...
#include "SkillTree/Model/VerifyAction.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::SkillTree::Model::FVerifyActionPtr Model);
    };
