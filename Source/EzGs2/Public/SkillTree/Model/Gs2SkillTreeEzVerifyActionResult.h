...
#include "SkillTree/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::SkillTree::Model::FVerifyActionResultPtr Model);
    };
