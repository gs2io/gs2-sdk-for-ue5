...
#include "SkillTree/Model/AcquireAction.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::SkillTree::Model::FAcquireActionPtr Model);
    };
