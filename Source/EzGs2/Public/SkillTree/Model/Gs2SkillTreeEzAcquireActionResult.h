...
#include "SkillTree/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::SkillTree::Model::FAcquireActionResultPtr Model);
    };
