...
#include "SkillTree/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::SkillTree::Model
{
	...
	public:
        ...
        Gs2::SkillTree::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::SkillTree::Model::FConsumeActionResultPtr Model);
    };
