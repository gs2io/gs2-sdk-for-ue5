...
#include "LoginReward/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::LoginReward::Model
{
	...
	public:
        ...
        Gs2::LoginReward::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::LoginReward::Model::FConsumeActionResultPtr Model);
    };
