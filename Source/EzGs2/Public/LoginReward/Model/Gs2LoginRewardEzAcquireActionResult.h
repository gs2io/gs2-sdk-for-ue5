...
#include "LoginReward/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::LoginReward::Model
{
	...
	public:
        ...
        Gs2::LoginReward::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::LoginReward::Model::FAcquireActionResultPtr Model);
    };
