...
#include "LoginReward/Model/AcquireAction.h"
...
namespace Gs2::UE5::LoginReward::Model
{
	...
	public:
        ...
        Gs2::LoginReward::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::LoginReward::Model::FAcquireActionPtr Model);
    };
