...
#include "LoginReward/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::LoginReward::Model
{
	...
	public:
        ...
        Gs2::LoginReward::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::LoginReward::Model::FVerifyActionResultPtr Model);
    };
