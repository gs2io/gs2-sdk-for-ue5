...
#include "LoginReward/Model/Config.h"
...
namespace Gs2::UE5::LoginReward::Model
{
	...
	public:
        ...
        Gs2::LoginReward::Model::FConfigPtr ToModel() const;
        static TSharedPtr<FEzConfig> FromModel(Gs2::LoginReward::Model::FConfigPtr Model);
    };
