...
#include "SeasonRating/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::SeasonRating::Model
{
	...
	public:
        ...
        Gs2::SeasonRating::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::SeasonRating::Model::FVerifyActionResultPtr Model);
    };
