...
#include "SeasonRating/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::SeasonRating::Model
{
	...
	public:
        ...
        Gs2::SeasonRating::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::SeasonRating::Model::FAcquireActionResultPtr Model);
    };
