...
#include "SeasonRating/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::SeasonRating::Model
{
	...
	public:
        ...
        Gs2::SeasonRating::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::SeasonRating::Model::FConsumeActionResultPtr Model);
    };
