...
#include "Showcase/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Showcase::Model
{
	...
	public:
        ...
        Gs2::Showcase::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Showcase::Model::FAcquireActionResultPtr Model);
    };
