...
#include "Showcase/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Showcase::Model
{
	...
	public:
        ...
        Gs2::Showcase::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Showcase::Model::FVerifyActionResultPtr Model);
    };
