...
#include "Showcase/Model/VerifyAction.h"
...
namespace Gs2::UE5::Showcase::Model
{
	...
	public:
        ...
        Gs2::Showcase::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::Showcase::Model::FVerifyActionPtr Model);
    };
