...
namespace Gs2::UE5::Showcase::Model
{
	...
	public:
        ...
        Gs2::Showcase::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Showcase::Model::FConsumeActionResultPtr Model);
    };
