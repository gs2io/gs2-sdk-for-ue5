...
namespace Gs2::UE5::Showcase::Domain::Model
{
    ...
    class EZGS2_API FEzRandomShowcaseStatusGameSessionDomain final :
        public TSharedFromThis<FEzRandomShowcaseStatusGameSessionDomain>
    {
        ...
        FEzRandomShowcaseStatusGameSessionDomain(
            Gs2::Showcase::Domain::Model::FRandomShowcaseStatusAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
    ...
    typedef TSharedPtr<FEzRandomShowcaseStatusGameSessionDomain> FEzRandomShowcaseStatusGameSessionDomainPtr;
}
