...
namespace Gs2::UE5::Enhance::Domain::Iterator
{
            ...
            public TSharedFromThis<FEzDescribeRateModelsIterator>
    {
		...
		TSharedPtr<Gs2::Enhance::Domain::Iterator::FDescribeRateModelsIterator> Iterator;
	...
	public:
		...
		public:
			...
			const Gs2::UE5::Enhance::Model::FEzRateModelPtr& operator*() const;
			Gs2::UE5::Enhance::Model::FEzRateModelPtr operator->();
