...
#include "Enhance/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Enhance::Model
{
	...
	public:
        ...
        Gs2::Enhance::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Enhance::Model::FAcquireActionResultPtr Model);
    };
