...
#include "Enhance/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Enhance::Model
{
	...
	public:
        ...
        Gs2::Enhance::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Enhance::Model::FConsumeActionResultPtr Model);
    };
