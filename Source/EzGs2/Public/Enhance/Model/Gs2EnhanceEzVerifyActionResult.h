...
#include "Enhance/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Enhance::Model
{
	...
	public:
        ...
        Gs2::Enhance::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Enhance::Model::FVerifyActionResultPtr Model);
    };
