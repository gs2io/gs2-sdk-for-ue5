...
#include "Mission/Model/VerifyAction.h"
...
namespace Gs2::UE5::Mission::Model
{
	...
	public:
        ...
        Gs2::Mission::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::Mission::Model::FVerifyActionPtr Model);
    };
