...
#include "Mission/Model/AcquireAction.h"
...
namespace Gs2::UE5::Mission::Model
{
	...
	public:
        ...
        Gs2::Mission::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Mission::Model::FAcquireActionPtr Model);
    };
