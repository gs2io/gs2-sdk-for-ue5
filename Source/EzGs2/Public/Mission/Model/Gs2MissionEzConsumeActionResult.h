...
#include "Mission/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Mission::Model
{
	...
	public:
        ...
        Gs2::Mission::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Mission::Model::FConsumeActionResultPtr Model);
    };
