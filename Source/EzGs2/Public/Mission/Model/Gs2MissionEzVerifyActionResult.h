...
#include "Mission/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Mission::Model
{
	...
	public:
        ...
        Gs2::Mission::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Mission::Model::FVerifyActionResultPtr Model);
    };
