...
#include "Mission/Model/ConsumeAction.h"
...
namespace Gs2::UE5::Mission::Model
{
	...
	public:
        ...
        Gs2::Mission::Model::FConsumeActionPtr ToModel() const;
        static TSharedPtr<FEzConsumeAction> FromModel(Gs2::Mission::Model::FConsumeActionPtr Model);
    };
