...
namespace Gs2::UE5::Mission::Domain::Iterator
{
            ...
            public TSharedFromThis<FEzDescribeMissionGroupModelsIterator>
    {
		...
		TSharedPtr<Gs2::Mission::Domain::Iterator::FDescribeMissionGroupModelsIterator> Iterator;
	...
	public:
	    ...
	    class EZGS2_API FDescribeMissionGroupModelsIteratorLoadTask :
		...
		{
			friend FEzDescribeMissionGroupModelsIterator;
		...
		public:
			...
			const Gs2::UE5::Mission::Model::FEzMissionGroupModelPtr& operator*() const;
			Gs2::UE5::Mission::Model::FEzMissionGroupModelPtr operator->();
		...
		TSharedPtr<FAsyncTask<FDescribeMissionGroupModelsIteratorLoadTask>> Next() const;
    };
