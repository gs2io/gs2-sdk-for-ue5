...
namespace Gs2::UE5::Mission::Domain::Iterator
{
	...
	public:
		...
		{
		    friend class FEzDescribeMissionGroupModelsIterator;
        	...
        	)
        	{
				return DomainIterator.IsCurrentValid()
	    			? Gs2::UE5::Mission::Model::FEzMissionGroupModel::FromModel(DomainIterator.Current())
					: nullptr;
        	}
		...
		public:
			explicit FIterator(
				FEzDescribeMissionGroupModelsIterator& Iterable
			) :
