...
namespace Gs2::UE5::Mission::Domain::Model
{
        ...
        public TSharedFromThis<FEzCounterGameSessionDomain>
    {
        ...
        friend FDecreaseCounterTask;

        TSharedPtr<FAsyncTask<FDecreaseCounterTask>> DecreaseCounter(
            int64 Value
        );
        ...
        friend FDeleteCounterTask;

        TSharedPtr<FAsyncTask<FDeleteCounterTask>> DeleteCounter(
        );
