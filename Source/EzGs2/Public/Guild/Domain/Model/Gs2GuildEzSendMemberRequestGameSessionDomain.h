...
namespace Gs2::UE5::Guild::Domain::Model
{
    ...
    class EZGS2_API FEzSendMemberRequestGameSessionDomain final :
        public TSharedFromThis<FEzSendMemberRequestGameSessionDomain>
    {
        ...
        FEzSendMemberRequestGameSessionDomain(
            Gs2::Guild::Domain::Model::FSendMemberRequestAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
    ...
    typedef TSharedPtr<FEzSendMemberRequestGameSessionDomain> FEzSendMemberRequestGameSessionDomainPtr;
}
