...
namespace Gs2::UE5::Guild::Domain::Model
{
    ...
    class EZGS2_API FEzIgnoreUserGameSessionDomain final :
        public TSharedFromThis<FEzIgnoreUserGameSessionDomain>
    {
        ...
        FEzIgnoreUserGameSessionDomain(
            Gs2::Guild::Domain::Model::FIgnoreUserAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
            Gs2::UE5::Util::FGs2ConnectionPtr Connection
        );

        class EZGS2_API FDeleteIgnoreUserTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Guild::Domain::Model::FEzIgnoreUserGameSessionDomain>,
            public TSharedFromThis<FDeleteIgnoreUserTask>
        {
        ...
        friend FDeleteIgnoreUserTask;

        TSharedPtr<FAsyncTask<FDeleteIgnoreUserTask>> DeleteIgnoreUser(
            FString UserId
        );

        class EZGS2_API FModelTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Guild::Model::FEzIgnoreUser>,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Guild::Model::FEzIgnoreUserPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzIgnoreUserGameSessionDomain> FEzIgnoreUserGameSessionDomainPtr;
}
