...
#include "Gs2GuildEzIgnoreUserDomain.h"
...
namespace Gs2::UE5::Guild::Domain::Model
{
    ...
    class EZGS2_API FEzIgnoreUserDomain final :
        public TSharedFromThis<FEzIgnoreUserDomain>
    {
    ...
    typedef TSharedPtr<FEzIgnoreUserDomain> FEzIgnoreUserDomainPtr;
}
