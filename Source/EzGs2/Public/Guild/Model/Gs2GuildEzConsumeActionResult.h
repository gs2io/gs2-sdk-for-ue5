...
#include "Guild/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Guild::Model
{
	...
	public:
        ...
        Gs2::Guild::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Guild::Model::FConsumeActionResultPtr Model);
    };
