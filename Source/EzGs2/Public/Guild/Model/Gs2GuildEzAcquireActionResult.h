...
#include "Guild/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Guild::Model
{
	...
	public:
        ...
        Gs2::Guild::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Guild::Model::FAcquireActionResultPtr Model);
    };
