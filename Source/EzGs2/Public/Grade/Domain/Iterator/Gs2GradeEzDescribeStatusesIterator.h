...
namespace Gs2::UE5::Grade::Domain::Iterator
{
    ...
    {
        Gs2::Grade::Domain::Iterator::FDescribeStatusesIteratorPtr It;
	...
	public:
        ...
        explicit FEzDescribeStatusesIterator(
            ...
            Gs2::UE5::Util::IGameSessionPtr GameSession,
            Gs2::UE5::Util::FGs2ConnectionPtr Connection,
            TOptional<FString> GradeName = TOptional<FString>()
        ) :
            It(
                Domain->Statuses(
                    GradeName
		...
		class EZGS2_API FIterator
		{
			...
			Gs2::Grade::Domain::Iterator::FDescribeStatusesIterator::FIterator DomainIterator;
			Gs2::UE5::Grade::Model::FEzStatusPtr CurrentValue;
        	static Gs2::UE5::Grade::Model::FEzStatusPtr ConvertCurrent(
        		Gs2::Grade::Domain::Iterator::FDescribeStatusesIterator::FIterator& DomainIterator
        	)
        	{
				return DomainIterator.IsCurrentValid()
	    			? Gs2::UE5::Grade::Model::FEzStatus::FromModel(DomainIterator.Current())
					: nullptr;
        	}
		...
		public:
            ...
            Gs2::UE5::Grade::Model::FEzStatusPtr& Current()
            {
                return CurrentValue;
            }
