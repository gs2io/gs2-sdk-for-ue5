...
#include "Grade/Model/AcquireAction.h"
...
namespace Gs2::UE5::Grade::Model
{
	...
	public:
        ...
        Gs2::Grade::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Grade::Model::FAcquireActionPtr Model);
    };
