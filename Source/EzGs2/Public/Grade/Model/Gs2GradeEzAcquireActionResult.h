...
#include "Grade/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Grade::Model
{
	...
	public:
        ...
        Gs2::Grade::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Grade::Model::FAcquireActionResultPtr Model);
    };
