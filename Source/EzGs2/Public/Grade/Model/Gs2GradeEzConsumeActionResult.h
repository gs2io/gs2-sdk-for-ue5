...
#include "Grade/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Grade::Model
{
	...
	public:
        ...
        Gs2::Grade::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Grade::Model::FConsumeActionResultPtr Model);
    };
