...
namespace Gs2::UE5::Version::Domain::Iterator
{
    ...
    {
        Gs2::Version::Domain::Iterator::FDescribeVersionModelsIteratorPtr It;
	...
	public:
		...
		FEzDescribeVersionModelsIterator(
			const FEzDescribeVersionModelsIterator& From
		) :
			It(From.It),
			Domain(From.Domain),
		...
		class EZGS2_API FIterator
		{
        	...
        	static Gs2::UE5::Version::Model::FEzVersionModelPtr ConvertCurrent(
        		Gs2::Version::Domain::Iterator::FDescribeVersionModelsIterator::FIterator& DomainIterator
        	)
        	{
