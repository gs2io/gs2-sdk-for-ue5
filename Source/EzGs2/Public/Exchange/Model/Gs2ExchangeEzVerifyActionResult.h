...
#include "Exchange/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Exchange::Model::FVerifyActionResultPtr Model);
    };
