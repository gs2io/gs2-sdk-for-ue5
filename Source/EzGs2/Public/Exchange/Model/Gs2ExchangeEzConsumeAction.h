...
#include "Exchange/Model/ConsumeAction.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FConsumeActionPtr ToModel() const;
        static TSharedPtr<FEzConsumeAction> FromModel(Gs2::Exchange::Model::FConsumeActionPtr Model);
    };
