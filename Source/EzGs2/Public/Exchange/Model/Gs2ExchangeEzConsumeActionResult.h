...
#include "Exchange/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Exchange::Model::FConsumeActionResultPtr Model);
    };
