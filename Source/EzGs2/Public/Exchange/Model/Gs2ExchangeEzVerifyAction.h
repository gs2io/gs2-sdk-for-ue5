...
#include "Exchange/Model/VerifyAction.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::Exchange::Model::FVerifyActionPtr Model);
    };
