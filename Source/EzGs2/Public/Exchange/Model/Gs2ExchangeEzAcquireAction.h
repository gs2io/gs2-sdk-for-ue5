...
#include "Exchange/Model/AcquireAction.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Exchange::Model::FAcquireActionPtr Model);
    };
