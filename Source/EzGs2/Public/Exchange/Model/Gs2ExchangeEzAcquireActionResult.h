...
#include "Exchange/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Exchange::Model
{
	...
	public:
        ...
        Gs2::Exchange::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Exchange::Model::FAcquireActionResultPtr Model);
    };
