...
namespace Gs2::UE5::Exchange::Domain::Iterator
{
    ...
    {
        Gs2::Exchange::Domain::Iterator::FDescribeIncrementalRateModelsIteratorPtr It;
	...
	public:
		...
		FEzDescribeIncrementalRateModelsIterator(
			const FEzDescribeIncrementalRateModelsIterator& From
		) :
			It(From.It),
			Domain(From.Domain),
