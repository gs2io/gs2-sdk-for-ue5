...
namespace Gs2::UE5::Inventory::Domain::Iterator
{
	...
	public:
		...
		{
		    friend class FEzDescribeInventoriesIterator;
        	...
        	)
        	{
				return DomainIterator.IsCurrentValid()
	    			? Gs2::UE5::Inventory::Model::FEzInventory::FromModel(DomainIterator.Current())
					: nullptr;
        	}
		...
		public:
			explicit FIterator(
				FEzDescribeInventoriesIterator& Iterable
			) :
