...
namespace Gs2::UE5::Limit::Domain::Iterator
{
            ...
            public TSharedFromThis<FEzDescribeCountersIterator>
    {
		...
		TSharedPtr<Gs2::Limit::Domain::Iterator::FDescribeCountersIterator> Iterator;
	...
	public:
		...
		public:
			...
			const Gs2::UE5::Limit::Model::FEzCounterPtr& operator*() const;
			Gs2::UE5::Limit::Model::FEzCounterPtr operator->();
