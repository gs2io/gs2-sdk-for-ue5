...
#include "Distributor/Model/AcquireAction.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Distributor::Model::FAcquireActionPtr Model);
    };
