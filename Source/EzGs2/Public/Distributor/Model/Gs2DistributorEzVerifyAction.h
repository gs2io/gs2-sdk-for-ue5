...
#include "Distributor/Model/VerifyAction.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::Distributor::Model::FVerifyActionPtr Model);
    };
