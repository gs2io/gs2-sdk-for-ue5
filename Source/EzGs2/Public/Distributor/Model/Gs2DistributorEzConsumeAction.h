...
#include "Distributor/Model/ConsumeAction.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FConsumeActionPtr ToModel() const;
        static TSharedPtr<FEzConsumeAction> FromModel(Gs2::Distributor::Model::FConsumeActionPtr Model);
    };
