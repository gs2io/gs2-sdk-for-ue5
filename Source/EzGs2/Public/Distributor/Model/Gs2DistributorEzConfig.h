...
#include "Distributor/Model/Config.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FConfigPtr ToModel() const;
        static TSharedPtr<FEzConfig> FromModel(Gs2::Distributor::Model::FConfigPtr Model);
    };
