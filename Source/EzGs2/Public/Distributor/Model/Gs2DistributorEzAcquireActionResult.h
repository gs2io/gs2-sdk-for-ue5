...
#include "Distributor/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Distributor::Model::FAcquireActionResultPtr Model);
    };
