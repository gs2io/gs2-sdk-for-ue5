...
#include "Distributor/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Distributor::Model::FConsumeActionResultPtr Model);
    };
