...
#include "Distributor/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Distributor::Model
{
	...
	public:
        ...
        Gs2::Distributor::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Distributor::Model::FVerifyActionResultPtr Model);
    };
