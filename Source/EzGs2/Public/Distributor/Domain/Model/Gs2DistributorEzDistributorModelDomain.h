...
namespace Gs2::UE5::Distributor::Domain::Model
{
    ...
    class EZGS2_API FEzDistributorModelDomain final :
        public TSharedFromThis<FEzDistributorModelDomain>
    {
        ...
        TOptional<FString> DistributorName() const;

        FEzDistributorModelDomain(
            Gs2::Distributor::Domain::Model::FDistributorModelDomainPtr Domain,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Distributor::Model::FEzDistributorModelPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzDistributorModelDomain> FEzDistributorModelDomainPtr;
}
