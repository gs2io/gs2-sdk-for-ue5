...
namespace Gs2::UE5::Distributor::Domain::Model
{
    ...
    class EZGS2_API FEzTransactionResultGameSessionDomain final :
        public TSharedFromThis<FEzTransactionResultGameSessionDomain>
    {
        ...
        FEzTransactionResultGameSessionDomain(
            Gs2::Distributor::Domain::Model::FTransactionResultAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
    ...
    typedef TSharedPtr<FEzTransactionResultGameSessionDomain> FEzTransactionResultGameSessionDomainPtr;
}
