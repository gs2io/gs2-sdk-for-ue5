...
#include "Core/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Core::Model
{
	...
	public:
        ...
        Gs2::Core::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Core::Model::FConsumeActionResultPtr Model);
    };
