...
#include "Idle/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Idle::Model
{
	...
	public:
        ...
        Gs2::Idle::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Idle::Model::FConsumeActionResultPtr Model);
    };
