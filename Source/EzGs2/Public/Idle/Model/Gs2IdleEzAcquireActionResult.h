...
#include "Idle/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Idle::Model
{
	...
	public:
        ...
        Gs2::Idle::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Idle::Model::FAcquireActionResultPtr Model);
    };
