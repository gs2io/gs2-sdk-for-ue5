...
#include "Formation/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Formation::Model
{
	...
	public:
        ...
        Gs2::Formation::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Formation::Model::FConsumeActionResultPtr Model);
    };
