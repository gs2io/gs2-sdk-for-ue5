...
#include "Formation/Model/AcquireAction.h"
...
namespace Gs2::UE5::Formation::Model
{
	...
	public:
        ...
        Gs2::Formation::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Formation::Model::FAcquireActionPtr Model);
    };
