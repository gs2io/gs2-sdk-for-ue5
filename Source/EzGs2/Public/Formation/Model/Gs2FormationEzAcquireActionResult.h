...
#include "Formation/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Formation::Model
{
	...
	public:
        ...
        Gs2::Formation::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Formation::Model::FAcquireActionResultPtr Model);
    };
