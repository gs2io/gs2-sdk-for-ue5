...
#include "Formation/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Formation::Model
{
	...
	public:
        ...
        Gs2::Formation::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Formation::Model::FVerifyActionResultPtr Model);
    };
