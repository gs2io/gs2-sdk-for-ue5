...
namespace Gs2::UE5::Formation::Domain::Iterator
{
    ...
    {
        Gs2::Formation::Domain::Iterator::FDescribePropertyFormModelsIteratorPtr It;
	...
	public:
		...
		FEzDescribePropertyFormModelsIterator(
			const FEzDescribePropertyFormModelsIterator& From
		) :
			It(From.It),
			Domain(From.Domain),
