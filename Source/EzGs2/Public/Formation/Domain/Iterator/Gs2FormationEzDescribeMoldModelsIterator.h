...
namespace Gs2::UE5::Formation::Domain::Iterator
{
            ...
            public TSharedFromThis<FEzDescribeMoldModelsIterator>
    {
		...
		TSharedPtr<Gs2::Formation::Domain::Iterator::FDescribeMoldModelsIterator> Iterator;
	...
	public:
	    ...
	    class EZGS2_API FDescribeMoldModelsIteratorLoadTask :
		...
		{
			friend FEzDescribeMoldModelsIterator;
		...
		public:
			...
			const Gs2::UE5::Formation::Model::FEzMoldModelPtr& operator*() const;
			Gs2::UE5::Formation::Model::FEzMoldModelPtr operator->();
		...
		TSharedPtr<FAsyncTask<FDescribeMoldModelsIteratorLoadTask>> Next() const;
    };
