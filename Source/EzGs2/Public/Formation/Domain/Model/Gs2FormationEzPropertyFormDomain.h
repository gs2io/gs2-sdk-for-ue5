...
namespace Gs2::UE5::Formation::Domain::Model
{
    ...
    class EZGS2_API FEzPropertyFormDomain final :
        public TSharedFromThis<FEzPropertyFormDomain>
    {
    ...
    typedef TSharedPtr<FEzPropertyFormDomain> FEzPropertyFormDomainPtr;
}
