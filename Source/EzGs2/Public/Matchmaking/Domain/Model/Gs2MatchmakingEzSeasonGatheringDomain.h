...
namespace Gs2::UE5::Matchmaking::Domain::Model
{
    ...
    class EZGS2_API FEzSeasonGatheringDomain final :
        public TSharedFromThis<FEzSeasonGatheringDomain>
    {
    ...
    typedef TSharedPtr<FEzSeasonGatheringDomain> FEzSeasonGatheringDomainPtr;
}
