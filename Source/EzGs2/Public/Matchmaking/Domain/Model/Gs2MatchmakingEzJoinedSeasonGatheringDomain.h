...
namespace Gs2::UE5::Matchmaking::Domain::Model
{
    ...
    class EZGS2_API FEzJoinedSeasonGatheringDomain final :
        public TSharedFromThis<FEzJoinedSeasonGatheringDomain>
    {
        ...
        FEzJoinedSeasonGatheringDomain(
            Gs2::Matchmaking::Domain::Model::FJoinedSeasonGatheringDomainPtr Domain,
    ...
    typedef TSharedPtr<FEzJoinedSeasonGatheringDomain> FEzJoinedSeasonGatheringDomainPtr;
}
