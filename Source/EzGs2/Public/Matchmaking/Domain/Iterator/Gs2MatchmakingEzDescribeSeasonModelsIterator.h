...
namespace Gs2::UE5::Matchmaking::Domain::Iterator
{
    ...
    {
        Gs2::Matchmaking::Domain::Iterator::FDescribeSeasonModelsIteratorPtr It;
	...
	public:
		...
		class EZGS2_API FIterator
		{
			...
			Gs2::Matchmaking::Domain::Iterator::FDescribeSeasonModelsIterator::FIterator DomainIterator;
			Gs2::UE5::Matchmaking::Model::FEzSeasonModelPtr CurrentValue;
        	static Gs2::UE5::Matchmaking::Model::FEzSeasonModelPtr ConvertCurrent(
        		Gs2::Matchmaking::Domain::Iterator::FDescribeSeasonModelsIterator::FIterator& DomainIterator
        	)
        	{
				return DomainIterator.IsCurrentValid()
	    			? Gs2::UE5::Matchmaking::Model::FEzSeasonModel::FromModel(DomainIterator.Current())
					: nullptr;
        	}
		...
		public:
            ...
            Gs2::UE5::Matchmaking::Model::FEzSeasonModelPtr& Current()
            {
                return CurrentValue;
            }
