...
namespace Gs2::UE5::Matchmaking::Domain::Iterator
{
    ...
    {
        Gs2::Matchmaking::Domain::Iterator::FDescribeRatingModelsIteratorPtr It;
	...
	public:
		...
		FEzDescribeRatingModelsIterator(
			const FEzDescribeRatingModelsIterator& From
		) :
			It(From.It),
			Domain(From.Domain),
		...
		class EZGS2_API FIterator
		{
        	...
        	static Gs2::UE5::Matchmaking::Model::FEzRatingModelPtr ConvertCurrent(
        		Gs2::Matchmaking::Domain::Iterator::FDescribeRatingModelsIterator::FIterator& DomainIterator
        	)
        	{
