...
#include "Inbox/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Inbox::Model
{
	...
	public:
        ...
        Gs2::Inbox::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Inbox::Model::FAcquireActionResultPtr Model);
    };
