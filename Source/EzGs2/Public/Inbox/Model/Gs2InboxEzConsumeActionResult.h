...
#include "Inbox/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Inbox::Model
{
	...
	public:
        ...
        Gs2::Inbox::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Inbox::Model::FConsumeActionResultPtr Model);
    };
