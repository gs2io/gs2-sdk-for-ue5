...
#include "Inbox/Model/AcquireAction.h"
...
namespace Gs2::UE5::Inbox::Model
{
	...
	public:
        ...
        Gs2::Inbox::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Inbox::Model::FAcquireActionPtr Model);
    };
