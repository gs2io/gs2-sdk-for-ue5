...
#include "Lottery/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Lottery::Model
{
	...
	public:
        ...
        Gs2::Lottery::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Lottery::Model::FConsumeActionResultPtr Model);
    };
