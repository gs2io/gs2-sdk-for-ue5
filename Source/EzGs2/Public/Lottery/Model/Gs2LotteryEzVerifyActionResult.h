...
#include "Lottery/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Lottery::Model
{
	...
	public:
        ...
        Gs2::Lottery::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Lottery::Model::FVerifyActionResultPtr Model);
    };
