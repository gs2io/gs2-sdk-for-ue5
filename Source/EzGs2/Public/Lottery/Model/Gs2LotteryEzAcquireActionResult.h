...
#include "Lottery/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Lottery::Model
{
	...
	public:
        ...
        Gs2::Lottery::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Lottery::Model::FAcquireActionResultPtr Model);
    };
