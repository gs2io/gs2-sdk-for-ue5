...
#include "Lottery/Model/AcquireAction.h"
...
namespace Gs2::UE5::Lottery::Model
{
	...
	public:
        ...
        Gs2::Lottery::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Lottery::Model::FAcquireActionPtr Model);
    };
