...
namespace Gs2::UE5::Lottery::Domain::Model
{
    ...
    class EZGS2_API FEzBoxGameSessionDomain final :
        public TSharedFromThis<FEzBoxGameSessionDomain>
    {
        ...
        FEzBoxGameSessionDomain(
            Gs2::Lottery::Domain::Model::FBoxItemsAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::FProfilePtr Profile
        );

    };
    typedef TSharedPtr<FEzBoxGameSessionDomain> FEzBoxGameSessionDomainPtr;
}
