...
#include "Dictionary/Model/Config.h"
...
namespace Gs2::UE5::Dictionary::Model
{
	...
	public:
        ...
        Gs2::Dictionary::Model::FConfigPtr ToModel() const;
        static TSharedPtr<FEzConfig> FromModel(Gs2::Dictionary::Model::FConfigPtr Model);
    };
