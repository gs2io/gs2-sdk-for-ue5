...
namespace Gs2::UE5::Ranking2::Domain::Iterator
{
    ...
    {
        Gs2::Ranking2::Domain::Iterator::FDescribeSubscribesIteratorPtr It;
	...
	public:
		...
		class EZGS2_API FIterator
		{
			...
			Gs2::Ranking2::Domain::Iterator::FDescribeSubscribesIterator::FIterator DomainIterator;
			Gs2::UE5::Ranking2::Model::FEzSubscribeUserPtr CurrentValue;
        	static Gs2::UE5::Ranking2::Model::FEzSubscribeUserPtr ConvertCurrent(
        		Gs2::Ranking2::Domain::Iterator::FDescribeSubscribesIterator::FIterator& DomainIterator
        	)
        	{
				return DomainIterator.IsCurrentValid()
	    			? Gs2::UE5::Ranking2::Model::FEzSubscribeUser::FromModel(DomainIterator.Current())
					: nullptr;
        	}
		...
		public:
            ...
            Gs2::UE5::Ranking2::Model::FEzSubscribeUserPtr& Current()
            {
                return CurrentValue;
            }
