...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscribeRankingModelDomain final :
        public TSharedFromThis<FEzSubscribeRankingModelDomain>
    {
        ...
        FEzSubscribeRankingModelDomain(
            Gs2::Ranking2::Domain::Model::FSubscribeRankingModelDomainPtr Domain,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzSubscribeRankingModelPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzSubscribeRankingModelDomain> FEzSubscribeRankingModelDomainPtr;
}
