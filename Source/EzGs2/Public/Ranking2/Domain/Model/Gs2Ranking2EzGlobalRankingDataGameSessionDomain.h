...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzGlobalRankingDataGameSessionDomain final :
        public TSharedFromThis<FEzGlobalRankingDataGameSessionDomain>
    {
        ...
        class FGetGlobalRankingRankTask :
        ...
        class FModelTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Ranking2::Model::FEzGlobalRankingData>,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzGlobalRankingDataPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzGlobalRankingDataGameSessionDomain> FEzGlobalRankingDataGameSessionDomainPtr;
}
