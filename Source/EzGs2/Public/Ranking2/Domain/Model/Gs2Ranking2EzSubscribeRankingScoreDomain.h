...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscribeRankingScoreDomain final :
        public TSharedFromThis<FEzSubscribeRankingScoreDomain>
    {
        ...
        FEzSubscribeRankingScoreDomain(
            Gs2::Ranking2::Domain::Model::FSubscribeRankingScoreDomainPtr Domain,
    ...
    typedef TSharedPtr<FEzSubscribeRankingScoreDomain> FEzSubscribeRankingScoreDomainPtr;
}
