...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzClusterRankingModelDomain final :
        public TSharedFromThis<FEzClusterRankingModelDomain>
    {
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzClusterRankingModelPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzClusterRankingModelDomain> FEzClusterRankingModelDomainPtr;
}
