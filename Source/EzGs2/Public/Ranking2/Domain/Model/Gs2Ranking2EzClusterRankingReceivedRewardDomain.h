...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzClusterRankingReceivedRewardDomain final :
        public TSharedFromThis<FEzClusterRankingReceivedRewardDomain>
    {
    ...
    typedef TSharedPtr<FEzClusterRankingReceivedRewardDomain> FEzClusterRankingReceivedRewardDomainPtr;
}
