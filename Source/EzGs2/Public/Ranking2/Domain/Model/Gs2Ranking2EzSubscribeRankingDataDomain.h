...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscribeRankingDataDomain final :
        public TSharedFromThis<FEzSubscribeRankingDataDomain>
    {
    ...
    typedef TSharedPtr<FEzSubscribeRankingDataDomain> FEzSubscribeRankingDataDomainPtr;
}
