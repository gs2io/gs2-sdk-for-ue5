...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscribeRankingScoreGameSessionDomain final :
        public TSharedFromThis<FEzSubscribeRankingScoreGameSessionDomain>
    {
        ...
        FEzSubscribeRankingScoreGameSessionDomain(
            Gs2::Ranking2::Domain::Model::FSubscribeRankingScoreAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
        ...
        class EZGS2_API FModelTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Ranking2::Model::FEzSubscribeRankingScore>,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzSubscribeRankingScorePtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzSubscribeRankingScoreGameSessionDomain> FEzSubscribeRankingScoreGameSessionDomainPtr;
}
