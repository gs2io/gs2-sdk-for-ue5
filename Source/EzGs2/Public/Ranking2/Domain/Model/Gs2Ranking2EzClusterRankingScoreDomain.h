...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzClusterRankingScoreDomain final :
        public TSharedFromThis<FEzClusterRankingScoreDomain>
    {
    ...
    typedef TSharedPtr<FEzClusterRankingScoreDomain> FEzClusterRankingScoreDomainPtr;
}
