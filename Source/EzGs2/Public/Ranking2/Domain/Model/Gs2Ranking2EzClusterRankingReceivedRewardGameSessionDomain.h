...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzClusterRankingReceivedRewardGameSessionDomain final :
        public TSharedFromThis<FEzClusterRankingReceivedRewardGameSessionDomain>
    {
        ...
        class EZGS2_API FModelTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Ranking2::Model::FEzClusterRankingReceivedReward>,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzClusterRankingReceivedRewardPtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzClusterRankingReceivedRewardGameSessionDomain> FEzClusterRankingReceivedRewardGameSessionDomainPtr;
}
