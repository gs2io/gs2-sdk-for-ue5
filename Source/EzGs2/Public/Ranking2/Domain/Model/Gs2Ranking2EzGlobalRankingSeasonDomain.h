...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzGlobalRankingSeasonDomain final :
        public TSharedFromThis<FEzGlobalRankingSeasonDomain>
    {
    ...
    typedef TSharedPtr<FEzGlobalRankingSeasonDomain> FEzGlobalRankingSeasonDomainPtr;
}
