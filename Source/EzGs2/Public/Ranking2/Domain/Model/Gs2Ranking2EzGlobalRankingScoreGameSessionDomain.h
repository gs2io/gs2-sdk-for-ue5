...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzGlobalRankingScoreGameSessionDomain final :
        public TSharedFromThis<FEzGlobalRankingScoreGameSessionDomain>
    {
        ...
        FEzGlobalRankingScoreGameSessionDomain(
            Gs2::Ranking2::Domain::Model::FGlobalRankingScoreAccessTokenDomainPtr Domain,
            Gs2::UE5::Util::IGameSessionPtr GameSession,
        ...
        class EZGS2_API FModelTask :
            public Gs2::Core::Util::TGs2Future<Gs2::UE5::Ranking2::Model::FEzGlobalRankingScore>,
        ...
        Gs2::Core::Domain::CallbackID Subscribe(TFunction<void(Gs2::UE5::Ranking2::Model::FEzGlobalRankingScorePtr)> Callback);

        void Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId);

    };
    typedef TSharedPtr<FEzGlobalRankingScoreGameSessionDomain> FEzGlobalRankingScoreGameSessionDomainPtr;
}
