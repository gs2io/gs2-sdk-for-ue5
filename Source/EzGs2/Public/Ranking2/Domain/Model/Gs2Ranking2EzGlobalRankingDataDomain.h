...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzGlobalRankingDataDomain final :
        public TSharedFromThis<FEzGlobalRankingDataDomain>
    {
    ...
    typedef TSharedPtr<FEzGlobalRankingDataDomain> FEzGlobalRankingDataDomainPtr;
}
