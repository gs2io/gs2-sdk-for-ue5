...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzClusterRankingDataGameSessionDomain final :
    ...
    typedef TSharedPtr<FEzClusterRankingDataGameSessionDomain> FEzClusterRankingDataGameSessionDomainPtr;
}
