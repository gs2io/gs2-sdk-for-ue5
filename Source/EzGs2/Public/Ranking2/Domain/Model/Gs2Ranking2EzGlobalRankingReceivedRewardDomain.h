...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzGlobalRankingReceivedRewardDomain final :
        public TSharedFromThis<FEzGlobalRankingReceivedRewardDomain>
    {
    ...
    typedef TSharedPtr<FEzGlobalRankingReceivedRewardDomain> FEzGlobalRankingReceivedRewardDomainPtr;
}
