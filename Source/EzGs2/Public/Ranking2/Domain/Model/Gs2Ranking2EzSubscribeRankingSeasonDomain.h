...
#include "Gs2Ranking2EzSubscribeRankingScoreDomain.h"
#include "Gs2Ranking2EzSubscribeRankingDataDomain.h"
...
namespace Gs2::UE5::Ranking2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscribeRankingSeasonDomain final :
        public TSharedFromThis<FEzSubscribeRankingSeasonDomain>
    {
        ...
        FEzSubscribeRankingSeasonDomain(
            Gs2::Ranking2::Domain::Model::FSubscribeRankingSeasonDomainPtr Domain,
            Gs2::UE5::Util::FGs2ConnectionPtr Connection
        );

        Gs2::UE5::Ranking2::Domain::Model::FEzSubscribeRankingScoreDomainPtr SubscribeRankingScore(
        ) const;

        Gs2::UE5::Ranking2::Domain::Model::FEzSubscribeRankingDataDomainPtr SubscribeRankingData(
            const FString ScorerUserId
        ) const;

    };
    typedef TSharedPtr<FEzSubscribeRankingSeasonDomain> FEzSubscribeRankingSeasonDomainPtr;
}
