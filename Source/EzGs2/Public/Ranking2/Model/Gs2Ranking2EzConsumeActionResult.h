...
#include "Ranking2/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Ranking2::Model
{
	...
	public:
        ...
        Gs2::Ranking2::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Ranking2::Model::FConsumeActionResultPtr Model);
    };
