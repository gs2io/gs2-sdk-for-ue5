...
#include "Ranking2/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Ranking2::Model
{
	...
	public:
        ...
        Gs2::Ranking2::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Ranking2::Model::FAcquireActionResultPtr Model);
    };
