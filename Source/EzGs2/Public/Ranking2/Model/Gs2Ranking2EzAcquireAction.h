...
#include "Ranking2/Model/AcquireAction.h"
...
namespace Gs2::UE5::Ranking2::Model
{
	...
	public:
        ...
        Gs2::Ranking2::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Ranking2::Model::FAcquireActionPtr Model);
    };
