...
namespace Gs2::UE5::Datastore::Domain::Model
{
    ...
    class EZGS2_API FEzDataObjectHistoryDomain final :
        public TSharedFromThis<FEzDataObjectHistoryDomain>
    {
    ...
    typedef TSharedPtr<FEzDataObjectHistoryDomain> FEzDataObjectHistoryDomainPtr;
}
