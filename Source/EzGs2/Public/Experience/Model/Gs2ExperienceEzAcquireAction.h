...
#include "Experience/Model/AcquireAction.h"
...
namespace Gs2::UE5::Experience::Model
{
	...
	public:
        ...
        Gs2::Experience::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Experience::Model::FAcquireActionPtr Model);
    };
