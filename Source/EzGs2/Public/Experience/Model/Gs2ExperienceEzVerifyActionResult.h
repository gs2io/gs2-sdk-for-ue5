...
#include "Experience/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Experience::Model
{
	...
	public:
        ...
        Gs2::Experience::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Experience::Model::FVerifyActionResultPtr Model);
    };
