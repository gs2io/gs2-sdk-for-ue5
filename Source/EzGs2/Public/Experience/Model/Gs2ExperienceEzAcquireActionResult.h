...
#include "Experience/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Experience::Model
{
	...
	public:
        ...
        Gs2::Experience::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Experience::Model::FAcquireActionResultPtr Model);
    };
