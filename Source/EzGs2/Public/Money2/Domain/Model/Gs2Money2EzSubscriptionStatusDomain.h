...
namespace Gs2::UE5::Money2::Domain::Model
{
    ...
    class EZGS2_API FEzSubscriptionStatusDomain final :
        public TSharedFromThis<FEzSubscriptionStatusDomain>
    {
    ...
    typedef TSharedPtr<FEzSubscriptionStatusDomain> FEzSubscriptionStatusDomainPtr;
}
