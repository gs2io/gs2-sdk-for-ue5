...
#include "Enchant/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Enchant::Model
{
	...
	public:
        ...
        Gs2::Enchant::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Enchant::Model::FConsumeActionResultPtr Model);
    };
