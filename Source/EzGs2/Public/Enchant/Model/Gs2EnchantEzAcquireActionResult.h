...
#include "Enchant/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Enchant::Model
{
	...
	public:
        ...
        Gs2::Enchant::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Enchant::Model::FAcquireActionResultPtr Model);
    };
