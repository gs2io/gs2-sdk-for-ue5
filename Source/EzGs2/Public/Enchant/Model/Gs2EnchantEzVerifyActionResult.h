...
#include "Enchant/Model/VerifyActionResult.h"
...
namespace Gs2::UE5::Enchant::Model
{
	...
	public:
        ...
        Gs2::Enchant::Model::FVerifyActionResultPtr ToModel() const;
        static TSharedPtr<FEzVerifyActionResult> FromModel(Gs2::Enchant::Model::FVerifyActionResultPtr Model);
    };
