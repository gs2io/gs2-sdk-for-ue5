...
namespace Gs2::UE5::Enchant::Domain::Iterator
{
    ...
    {
        Gs2::Enchant::Domain::Iterator::FDescribeRarityParameterStatusesIteratorPtr It;
	...
	public:
		...
		FEzDescribeRarityParameterStatusesIterator(
			const FEzDescribeRarityParameterStatusesIterator& From
		) :
			It(From.It),
			Domain(From.Domain),
