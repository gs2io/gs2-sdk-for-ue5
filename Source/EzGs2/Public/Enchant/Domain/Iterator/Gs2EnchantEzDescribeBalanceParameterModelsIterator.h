...
namespace Gs2::UE5::Enchant::Domain::Iterator
{
        ...
        public TSharedFromThis<FEzDescribeBalanceParameterModelsIterator>
    {
		...
		Gs2::Enchant::Domain::Iterator::FDescribeBalanceParameterModelsIteratorPtr DomainIterable;

	public:

        explicit FEzDescribeBalanceParameterModelsIterator(
            Gs2::Enchant::Domain::Iterator::FDescribeBalanceParameterModelsIterator& DomainIterable
