...
#include "Quest/Model/VerifyAction.h"
...
namespace Gs2::UE5::Quest::Model
{
	...
	public:
        ...
        Gs2::Quest::Model::FVerifyActionPtr ToModel() const;
        static TSharedPtr<FEzVerifyAction> FromModel(Gs2::Quest::Model::FVerifyActionPtr Model);
    };
