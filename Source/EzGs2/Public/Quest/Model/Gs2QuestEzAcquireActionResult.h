...
#include "Quest/Model/AcquireActionResult.h"
...
namespace Gs2::UE5::Quest::Model
{
	...
	public:
        ...
        Gs2::Quest::Model::FAcquireActionResultPtr ToModel() const;
        static TSharedPtr<FEzAcquireActionResult> FromModel(Gs2::Quest::Model::FAcquireActionResultPtr Model);
    };
