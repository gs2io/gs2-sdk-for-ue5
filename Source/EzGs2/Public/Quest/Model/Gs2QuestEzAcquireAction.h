...
#include "Quest/Model/AcquireAction.h"
...
namespace Gs2::UE5::Quest::Model
{
	...
	public:
        ...
        Gs2::Quest::Model::FAcquireActionPtr ToModel() const;
        static TSharedPtr<FEzAcquireAction> FromModel(Gs2::Quest::Model::FAcquireActionPtr Model);
    };
