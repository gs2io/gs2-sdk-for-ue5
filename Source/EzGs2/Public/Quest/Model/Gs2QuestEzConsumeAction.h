...
#include "Quest/Model/ConsumeAction.h"
...
namespace Gs2::UE5::Quest::Model
{
	...
	public:
        ...
        Gs2::Quest::Model::FConsumeActionPtr ToModel() const;
        static TSharedPtr<FEzConsumeAction> FromModel(Gs2::Quest::Model::FConsumeActionPtr Model);
    };
