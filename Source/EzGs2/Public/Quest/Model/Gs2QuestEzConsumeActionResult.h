...
#include "Quest/Model/ConsumeActionResult.h"
...
namespace Gs2::UE5::Quest::Model
{
	...
	public:
        ...
        Gs2::Quest::Model::FConsumeActionResultPtr ToModel() const;
        static TSharedPtr<FEzConsumeActionResult> FromModel(Gs2::Quest::Model::FConsumeActionResultPtr Model);
    };
