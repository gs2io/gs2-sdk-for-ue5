...
namespace Gs2::UE5::SeasonRating::Model
{
    ...
    Gs2::SeasonRating::Model::FAcquireActionResultPtr FEzAcquireActionResult::ToModel() const
    {
        return MakeShared<Gs2::SeasonRating::Model::FAcquireActionResult>()
    ...
    TSharedPtr<FEzAcquireActionResult> FEzAcquireActionResult::FromModel(const Gs2::SeasonRating::Model::FAcquireActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
