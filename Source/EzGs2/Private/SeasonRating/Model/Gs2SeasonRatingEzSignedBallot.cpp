...
namespace Gs2::UE5::SeasonRating::Model
{
    ...
    Gs2::SeasonRating::Model::FSignedBallotPtr FEzSignedBallot::ToModel() const
    {
        return MakeShared<Gs2::SeasonRating::Model::FSignedBallot>()
            ->WithBody(BodyValue)
            ->WithSignature(SignatureValue);
    }

    TSharedPtr<FEzSignedBallot> FEzSignedBallot::FromModel(const Gs2::SeasonRating::Model::FSignedBallotPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
