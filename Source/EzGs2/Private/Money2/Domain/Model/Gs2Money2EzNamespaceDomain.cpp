...
namespace Gs2::UE5::Money2::Domain::Model
{
    ...
    {
        return MakeShared<Gs2::UE5::Money2::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ConnectionValue
    ...
    Gs2::UE5::Money2::Domain::Model::FEzUserGameSessionDomainPtr FEzNamespaceDomain::Me(
        Gs2::UE5::Util::IGameSessionPtr GameSession
    ) const
    {
        return MakeShared<Gs2::UE5::Money2::Domain::Model::FEzUserGameSessionDomain>(
            Domain->AccessToken(
