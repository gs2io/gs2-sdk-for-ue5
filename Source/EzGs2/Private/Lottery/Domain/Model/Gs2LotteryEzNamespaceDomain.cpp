...
namespace Gs2::UE5::Lottery::Domain::Model
{
    ...
    {
        return MakeShared<Gs2::UE5::Lottery::Domain::Iterator::FEzDescribeLotteryModelsIterator>(
    ...
    {
        return MakeShared<Gs2::UE5::Lottery::Domain::Model::FEzLotteryModelDomain>(
            Domain->LotteryModel(
                LotteryName
            ),
            ProfileValue
