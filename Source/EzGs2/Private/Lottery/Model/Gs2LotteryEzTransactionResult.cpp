...
namespace Gs2::UE5::Lottery::Model
{
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithVerifyResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzVerifyActionResult>>> VerifyResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithConsumeResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzConsumeActionResult>>> ConsumeResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithAcquireResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzAcquireActionResult>>> AcquireResults
    )
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzVerifyActionResult>>> FEzTransactionResult::GetVerifyResults() const
    {
        return VerifyResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzConsumeActionResult>>> FEzTransactionResult::GetConsumeResults() const
    {
        return ConsumeResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Lottery::Model::FEzAcquireActionResult>>> FEzTransactionResult::GetAcquireResults() const
    {
        return AcquireResultsValue;
    }

    Gs2::Lottery::Model::FTransactionResultPtr FEzTransactionResult::ToModel() const
    {
        return MakeShared<Gs2::Lottery::Model::FTransactionResult>()
            ->WithTransactionId(TransactionIdValue)
            ->WithVerifyResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Lottery::Model::FVerifyActionResult>>>();
            ...
            ->WithConsumeResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Lottery::Model::FConsumeActionResult>>>();
            ...
            ->WithAcquireResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Lottery::Model::FAcquireActionResult>>>();
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::FromModel(const Gs2::Lottery::Model::FTransactionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
