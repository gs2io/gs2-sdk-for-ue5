...
namespace Gs2::UE5::Lottery::Model
{
    ...
    Gs2::Lottery::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Lottery::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Lottery::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
