...
#include "EzGs2/Public/Lottery/Model/Gs2LotteryEzConfig.h"
...
namespace Gs2::UE5::Lottery::Model
{
    ...
    Gs2::Lottery::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Lottery::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Lottery::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
