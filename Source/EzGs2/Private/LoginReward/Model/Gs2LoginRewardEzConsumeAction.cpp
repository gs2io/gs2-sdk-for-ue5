...
#include "EzGs2/Public/LoginReward/Model/Gs2LoginRewardEzConsumeAction.h"
...
namespace Gs2::UE5::LoginReward::Model
{
    ...
    Gs2::LoginReward::Model::FConsumeActionPtr FEzConsumeAction::ToModel() const
    {
        return MakeShared<Gs2::LoginReward::Model::FConsumeAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzConsumeAction> FEzConsumeAction::FromModel(const Gs2::LoginReward::Model::FConsumeActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
