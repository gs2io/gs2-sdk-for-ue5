...
namespace Gs2::UE5::LoginReward::Model
{
    ...
    Gs2::LoginReward::Model::FConsumeActionResultPtr FEzConsumeActionResult::ToModel() const
    {
        return MakeShared<Gs2::LoginReward::Model::FConsumeActionResult>()
    ...
    TSharedPtr<FEzConsumeActionResult> FEzConsumeActionResult::FromModel(const Gs2::LoginReward::Model::FConsumeActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
