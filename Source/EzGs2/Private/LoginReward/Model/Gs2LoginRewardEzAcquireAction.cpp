...
#include "EzGs2/Public/LoginReward/Model/Gs2LoginRewardEzAcquireAction.h"
...
namespace Gs2::UE5::LoginReward::Model
{
    ...
    Gs2::LoginReward::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::LoginReward::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::LoginReward::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
