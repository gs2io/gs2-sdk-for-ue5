...
namespace Gs2::UE5::LoginReward::Model
{
    ...
    Gs2::LoginReward::Model::FAcquireActionResultPtr FEzAcquireActionResult::ToModel() const
    {
        return MakeShared<Gs2::LoginReward::Model::FAcquireActionResult>()
    ...
    TSharedPtr<FEzAcquireActionResult> FEzAcquireActionResult::FromModel(const Gs2::LoginReward::Model::FAcquireActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
