...
namespace Gs2::UE5::LoginReward::Model
{
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithVerifyResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzVerifyActionResult>>> VerifyResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithConsumeResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzConsumeActionResult>>> ConsumeResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithAcquireResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzAcquireActionResult>>> AcquireResults
    )
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzVerifyActionResult>>> FEzTransactionResult::GetVerifyResults() const
    {
        return VerifyResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzConsumeActionResult>>> FEzTransactionResult::GetConsumeResults() const
    {
        return ConsumeResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::LoginReward::Model::FEzAcquireActionResult>>> FEzTransactionResult::GetAcquireResults() const
    {
        return AcquireResultsValue;
    }

    Gs2::LoginReward::Model::FTransactionResultPtr FEzTransactionResult::ToModel() const
    {
        return MakeShared<Gs2::LoginReward::Model::FTransactionResult>()
            ->WithTransactionId(TransactionIdValue)
            ->WithVerifyResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::LoginReward::Model::FVerifyActionResult>>>();
            ...
            ->WithConsumeResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::LoginReward::Model::FConsumeActionResult>>>();
            ...
            ->WithAcquireResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::LoginReward::Model::FAcquireActionResult>>>();
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::FromModel(const Gs2::LoginReward::Model::FTransactionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
