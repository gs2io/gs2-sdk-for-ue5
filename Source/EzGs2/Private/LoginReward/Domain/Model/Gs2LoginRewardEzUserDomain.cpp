...
#include "LoginReward/Domain/Model/Gs2LoginRewardEzUserDomain.h"
...
namespace Gs2::UE5::LoginReward::Domain::Model
{
    ...
    Gs2::UE5::LoginReward::Domain::Model::FEzReceiveStatusDomainPtr FEzUserDomain::ReceiveStatus(
        const FString BonusModelName
    ) const
    {
        return MakeShared<Gs2::UE5::LoginReward::Domain::Model::FEzReceiveStatusDomain>(
