...
#include "JobQueue/Domain/Model/Gs2JobQueueEzUserDomain.h"

namespace Gs2::UE5::JobQueue::Domain::Model
{

    TOptional<bool> FEzUserDomain::AutoRun() const
    {
        return Domain->AutoRun;
    }

    TOptional<bool> FEzUserDomain::IsLastJob() const
    {
    ...
    Gs2::UE5::JobQueue::Domain::Model::FEzJobDomainPtr FEzUserDomain::Job(
        const FString JobName
    ) const
    {
        return MakeShared<Gs2::UE5::JobQueue::Domain::Model::FEzJobDomain>(
            Domain->Job(
                JobName
            ),
            ConnectionValue
