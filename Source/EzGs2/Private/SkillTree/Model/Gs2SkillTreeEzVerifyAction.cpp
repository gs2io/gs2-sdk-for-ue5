...
namespace Gs2::UE5::SkillTree::Model
{
    ...
    Gs2::SkillTree::Model::FVerifyActionPtr FEzVerifyAction::ToModel() const
    {
        return MakeShared<Gs2::SkillTree::Model::FVerifyAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzVerifyAction> FEzVerifyAction::FromModel(const Gs2::SkillTree::Model::FVerifyActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
