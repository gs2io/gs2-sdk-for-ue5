...
#include "EzGs2/Public/SkillTree/Model/Gs2SkillTreeEzAcquireAction.h"
...
namespace Gs2::UE5::SkillTree::Model
{
    ...
    Gs2::SkillTree::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::SkillTree::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::SkillTree::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
