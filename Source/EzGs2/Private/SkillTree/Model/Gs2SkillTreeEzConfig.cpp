...
#include "EzGs2/Public/SkillTree/Model/Gs2SkillTreeEzConfig.h"
...
namespace Gs2::UE5::SkillTree::Model
{
    ...
    Gs2::SkillTree::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::SkillTree::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::SkillTree::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
