...
#include "EzGs2/Public/SkillTree/Model/Gs2SkillTreeEzConsumeAction.h"
...
namespace Gs2::UE5::SkillTree::Model
{
    ...
    Gs2::SkillTree::Model::FConsumeActionPtr FEzConsumeAction::ToModel() const
    {
        return MakeShared<Gs2::SkillTree::Model::FConsumeAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzConsumeAction> FEzConsumeAction::FromModel(const Gs2::SkillTree::Model::FConsumeActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
