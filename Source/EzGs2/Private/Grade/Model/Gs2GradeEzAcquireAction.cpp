...
namespace Gs2::UE5::Grade::Model
{
    ...
    Gs2::Grade::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Grade::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Grade::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
