...
namespace Gs2::UE5::Grade::Model
{
    ...
    Gs2::Grade::Model::FAcquireActionRatePtr FEzAcquireActionRate::ToModel() const
    {
        return MakeShared<Gs2::Grade::Model::FAcquireActionRate>()
            ->WithName(NameValue)
            ->WithMode(ModeValue)
    ...
    TSharedPtr<FEzAcquireActionRate> FEzAcquireActionRate::FromModel(const Gs2::Grade::Model::FAcquireActionRatePtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
