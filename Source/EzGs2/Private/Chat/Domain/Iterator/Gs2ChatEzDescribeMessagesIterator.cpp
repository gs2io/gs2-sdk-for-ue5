...
namespace Gs2::UE5::Chat::Domain::Iterator
{
    ...
    const Gs2::UE5::Chat::Model::FEzMessagePtr& FEzDescribeMessagesIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::UE5::Chat::Model::FEzMessagePtr FEzDescribeMessagesIterator::IteratorImpl::operator->()
    {
        return Current;
    }
    ...
    FEzDescribeMessagesIterator::IteratorImpl& FEzDescribeMessagesIterator::IteratorImpl::operator++()
    {
        ...
        {
            Current = Gs2::UE5::Chat::Model::FEzMessage::FromModel(Task->GetTask().Result());
        }
    ...
    FEzDescribeMessagesIterator::IteratorImpl FEzDescribeMessagesIterator::begin()
    {
        ...
        if (!Task->GetTask().IsError() && Task->GetTask().Result() != nullptr)
        {
            Impl.Current = Gs2::UE5::Chat::Model::FEzMessage::FromModel(Task->GetTask().Result());
        }
        Task->EnsureCompletion();
        return Impl;
    }
