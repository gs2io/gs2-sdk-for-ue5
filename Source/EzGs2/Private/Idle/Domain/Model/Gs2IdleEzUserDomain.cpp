...
#include "Idle/Domain/Model/Gs2IdleEzUserDomain.h"
...
namespace Gs2::UE5::Idle::Domain::Model
{
    ...
    Gs2::UE5::Idle::Domain::Model::FEzStatusDomainPtr FEzUserDomain::Status(
        const FString CategoryName
    ) const
    {
        return MakeShared<Gs2::UE5::Idle::Domain::Model::FEzStatusDomain>(
            Domain->Status(
                CategoryName
            ),
            ConnectionValue
