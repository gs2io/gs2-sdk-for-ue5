...
namespace Gs2::UE5::Idle::Model
{
    ...
    Gs2::Idle::Model::FVerifyActionResultPtr FEzVerifyActionResult::ToModel() const
    {
        return MakeShared<Gs2::Idle::Model::FVerifyActionResult>()
    ...
    TSharedPtr<FEzVerifyActionResult> FEzVerifyActionResult::FromModel(const Gs2::Idle::Model::FVerifyActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
