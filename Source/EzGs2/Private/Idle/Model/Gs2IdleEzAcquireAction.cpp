...
#include "EzGs2/Public/Idle/Model/Gs2IdleEzAcquireAction.h"
...
namespace Gs2::UE5::Idle::Model
{
    ...
    Gs2::Idle::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Idle::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Idle::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
