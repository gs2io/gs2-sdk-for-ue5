...
#include "EzGs2/Public/Idle/Model/Gs2IdleEzConfig.h"
...
namespace Gs2::UE5::Idle::Model
{
    ...
    Gs2::Idle::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Idle::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Idle::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
