...
namespace Gs2::UE5::MegaField::Domain::Model
{
    ...
    TOptional<FString> FEzSpatialDomain::NamespaceName() const
    {
        return Domain->NamespaceName;
    }

    TOptional<FString> FEzSpatialDomain::UserId() const
    {
        return Domain->UserId;
    }

    TOptional<FString> FEzSpatialDomain::AreaModelName() const
    {
        return Domain->AreaModelName;
    }

    TOptional<FString> FEzSpatialDomain::LayerModelName() const
    {
        return Domain->LayerModelName;
    }

    FEzSpatialDomain::FEzSpatialDomain(
    ...
    FEzSpatialDomain::FModelTask::FModelTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzSpatialDomain::FModelTask::Action(
    ...
    TSharedPtr<FAsyncTask<FEzSpatialDomain::FModelTask>> FEzSpatialDomain::Model() {
    ...
    void FEzSpatialDomain::Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId)
    {
        Domain->Unsubscribe(
            CallbackId
        );
