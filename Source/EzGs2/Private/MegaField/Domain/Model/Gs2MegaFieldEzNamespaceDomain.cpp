...
namespace Gs2::UE5::MegaField::Domain::Model
{
    ...
    Gs2::UE5::MegaField::Domain::Iterator::FEzDescribeAreaModelsIteratorPtr FEzNamespaceDomain::AreaModels(
    ) const
    {
        return MakeShared<Gs2::UE5::MegaField::Domain::Iterator::FEzDescribeAreaModelsIterator>(
            Domain->AreaModels(
            )
        );
    }
    ...
    {
        return MakeShared<Gs2::UE5::MegaField::Domain::Model::FEzAreaModelDomain>(
            Domain->AreaModel(
                AreaModelName
            ),
            ProfileValue
    ...
    Gs2::UE5::MegaField::Domain::Model::FEzUserDomainPtr FEzNamespaceDomain::User(
        const FString UserId
    ) const
    {
        return MakeShared<Gs2::UE5::MegaField::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ProfileValue
