...
#include "MegaField/Domain/Model/Gs2MegaFieldEzUserDomain.h"
...
namespace Gs2::UE5::MegaField::Domain::Model
{
    ...
    Gs2::UE5::MegaField::Domain::Model::FEzSpatialDomainPtr FEzUserDomain::Spatial(
        const FString AreaModelName,
        const FString LayerModelName
    ) const
    {
        return MakeShared<Gs2::UE5::MegaField::Domain::Model::FEzSpatialDomain>(
            Domain->Spatial(
                AreaModelName,
                LayerModelName
            ),
