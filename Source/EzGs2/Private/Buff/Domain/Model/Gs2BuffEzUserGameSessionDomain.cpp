...
namespace Gs2::UE5::Buff::Domain::Model
{
    ...
    FEzUserGameSessionDomain::FEzUserGameSessionDomain(
        Gs2::Buff::Domain::Model::FUserAccessTokenDomainPtr Domain,
    ...
    Gs2::UE5::Buff::Domain::Model::FEzBuffGameSessionDomainPtr FEzUserGameSessionDomain::Buff(
    ) const
    {
        return MakeShared<Gs2::UE5::Buff::Domain::Model::FEzBuffGameSessionDomain>(
            Domain->Buff(
            ),
            GameSession,
            ConnectionValue
