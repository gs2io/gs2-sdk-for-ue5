...
namespace Gs2::UE5::Ranking::Domain::Model
{
    ...
    Gs2::UE5::Ranking::Domain::Iterator::FEzDescribeCategoryModelsIteratorPtr FEzNamespaceDomain::CategoryModels(
    ) const
    {
        return MakeShared<Gs2::UE5::Ranking::Domain::Iterator::FEzDescribeCategoryModelsIterator>(
    ...
    {
        return MakeShared<Gs2::UE5::Ranking::Domain::Model::FEzCategoryModelDomain>(
    ...
    Gs2::UE5::Ranking::Domain::Model::FEzUserDomainPtr FEzNamespaceDomain::User(
        const FString UserId
    ) const
    {
        return MakeShared<Gs2::UE5::Ranking::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ProfileValue
    ...
    Gs2::UE5::Ranking::Domain::Model::FEzUserGameSessionDomainPtr FEzNamespaceDomain::Me(
        Gs2::UE5::Auth::Model::FEzAccessTokenPtr AccessToken
    ) const
    {
        return MakeShared<Gs2::UE5::Ranking::Domain::Model::FEzUserGameSessionDomain>(
            Domain->AccessToken(
                AccessToken->ToModel()
            ),
            ProfileValue
