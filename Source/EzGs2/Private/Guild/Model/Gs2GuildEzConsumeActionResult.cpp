...
namespace Gs2::UE5::Guild::Model
{
    ...
    Gs2::Guild::Model::FConsumeActionResultPtr FEzConsumeActionResult::ToModel() const
    {
        return MakeShared<Gs2::Guild::Model::FConsumeActionResult>()
    ...
    TSharedPtr<FEzConsumeActionResult> FEzConsumeActionResult::FromModel(const Gs2::Guild::Model::FConsumeActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
