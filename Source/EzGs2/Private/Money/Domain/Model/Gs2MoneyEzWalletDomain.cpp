...
#include "Money/Domain/Model/Gs2MoneyEzWalletDomain.h"

namespace Gs2::UE5::Money::Domain::Model
{

    TOptional<float> FEzWalletDomain::Price() const
    {
        return Domain->Price;
    }
    ...
    Gs2::Core::Domain::CallbackID FEzWalletDomain::Subscribe(TFunction<void(Gs2::UE5::Money::Model::FEzWalletPtr)> Callback)
    {
