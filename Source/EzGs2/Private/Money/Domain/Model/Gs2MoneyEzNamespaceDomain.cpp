...
namespace Gs2::UE5::Money::Domain::Model
{
    ...
    Gs2::UE5::Money::Domain::Model::FEzUserDomainPtr FEzNamespaceDomain::User(
        const FString UserId
    ) const
    {
        return MakeShared<Gs2::UE5::Money::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ConnectionValue
    ...
    Gs2::UE5::Money::Domain::Model::FEzUserGameSessionDomainPtr FEzNamespaceDomain::Me(
        Gs2::UE5::Util::IGameSessionPtr GameSession
    ) const
    {
        return MakeShared<Gs2::UE5::Money::Domain::Model::FEzUserGameSessionDomain>(
            Domain->AccessToken(
