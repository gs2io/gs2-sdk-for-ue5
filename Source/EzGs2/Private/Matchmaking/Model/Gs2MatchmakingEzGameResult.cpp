...
#include "EzGs2/Public/Matchmaking/Model/Gs2MatchmakingEzGameResult.h"
...
namespace Gs2::UE5::Matchmaking::Model
{
    ...
    Gs2::Matchmaking::Model::FGameResultPtr FEzGameResult::ToModel() const
    {
        return MakeShared<Gs2::Matchmaking::Model::FGameResult>()
            ->WithRank(RankValue)
            ->WithUserId(UserIdValue);
    }

    TSharedPtr<FEzGameResult> FEzGameResult::FromModel(const Gs2::Matchmaking::Model::FGameResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
