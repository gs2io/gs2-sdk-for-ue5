...
namespace Gs2::UE5::Matchmaking::Domain::Model
{
    ...
    Gs2::Core::Domain::CallbackID FEzRatingGameSessionDomain::Subscribe(TFunction<void(Gs2::UE5::Matchmaking::Model::FEzRatingPtr)> Callback)
    {
    ...
    void FEzRatingGameSessionDomain::Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId)
    {
        Domain->Unsubscribe(
            CallbackId
        );
