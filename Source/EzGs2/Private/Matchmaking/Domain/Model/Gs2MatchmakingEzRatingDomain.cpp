...
#include "Matchmaking/Domain/Model/Gs2MatchmakingEzRatingDomain.h"

namespace Gs2::UE5::Matchmaking::Domain::Model
{

    TOptional<FString> FEzRatingDomain::NamespaceName() const
    {
        return Domain->NamespaceName;
    }

    TOptional<FString> FEzRatingDomain::UserId() const
    {
        return Domain->UserId;
    }

    TOptional<FString> FEzRatingDomain::RatingName() const
    {
        return Domain->RatingName;
    }

    FEzRatingDomain::FEzRatingDomain(
    ...
    FEzRatingDomain::FModelTask::FModelTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzRatingDomain::FModelTask::Action(
    ...
    Gs2::Core::Domain::CallbackID FEzRatingDomain::Subscribe(TFunction<void(Gs2::UE5::Matchmaking::Model::FEzRatingPtr)> Callback)
    {
        return Domain->Subscribe(
            [Callback](Gs2::Matchmaking::Model::FRatingPtr Item)
            {
