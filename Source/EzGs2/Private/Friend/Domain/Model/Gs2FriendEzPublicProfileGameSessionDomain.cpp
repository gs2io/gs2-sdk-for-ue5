...
#include "Friend/Domain/Model/Gs2FriendEzPublicProfileGameSessionDomain.h"

namespace Gs2::UE5::Friend::Domain::Model
{

    TOptional<FString> FEzPublicProfileGameSessionDomain::NamespaceName() const
    {
        return Domain->NamespaceName;
    }

    TOptional<FString> FEzPublicProfileGameSessionDomain::UserId() const
    {
        return Domain->UserId();
    }

    FEzPublicProfileGameSessionDomain::FEzPublicProfileGameSessionDomain(
    ...
    FEzPublicProfileGameSessionDomain::FModelTask::FModelTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzPublicProfileGameSessionDomain::FModelTask::Action(
