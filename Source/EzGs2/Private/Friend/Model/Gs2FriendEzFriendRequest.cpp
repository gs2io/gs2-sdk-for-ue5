...
namespace Gs2::UE5::Friend::Model
{
    ...
    TSharedPtr<FEzFriendRequest> FEzFriendRequest::FromModel(const Gs2::Friend::Model::FSendFriendRequestPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
    ...
    TSharedPtr<FEzFriendRequest> FEzFriendRequest::FromModel(const Gs2::Friend::Model::FReceiveFriendRequestPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
