...
namespace Gs2::UE5::AdReward::Domain::Model
{
    ...
    Gs2::Core::Domain::CallbackID FEzPointDomain::Subscribe(TFunction<void(Gs2::UE5::AdReward::Model::FEzPointPtr)> Callback)
    {
    ...
    void FEzPointDomain::Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId)
    {
        Domain->Unsubscribe(
            CallbackId
        );
