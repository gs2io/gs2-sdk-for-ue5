...
#include "Inbox/Domain/Model/Gs2InboxEzUserDomain.h"
...
namespace Gs2::UE5::Inbox::Domain::Model
{
    ...
    Gs2::UE5::Inbox::Domain::Model::FEzMessageDomainPtr FEzUserDomain::Message(
        const FString MessageName
    ) const
    {
        return MakeShared<Gs2::UE5::Inbox::Domain::Model::FEzMessageDomain>(
            Domain->Message(
                MessageName
            ),
            ProfileValue
