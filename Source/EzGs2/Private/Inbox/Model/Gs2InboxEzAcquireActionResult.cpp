...
namespace Gs2::UE5::Inbox::Model
{
    ...
    Gs2::Inbox::Model::FAcquireActionResultPtr FEzAcquireActionResult::ToModel() const
    {
        return MakeShared<Gs2::Inbox::Model::FAcquireActionResult>()
    ...
    TSharedPtr<FEzAcquireActionResult> FEzAcquireActionResult::FromModel(const Gs2::Inbox::Model::FAcquireActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
