...
#include "EzGs2/Public/Inbox/Model/Gs2InboxEzAcquireAction.h"
...
namespace Gs2::UE5::Inbox::Model
{
    ...
    Gs2::Inbox::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Inbox::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Inbox::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
