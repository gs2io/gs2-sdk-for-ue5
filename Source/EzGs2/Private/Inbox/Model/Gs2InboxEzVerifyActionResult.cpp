...
namespace Gs2::UE5::Inbox::Model
{
    ...
    Gs2::Inbox::Model::FVerifyActionResultPtr FEzVerifyActionResult::ToModel() const
    {
        return MakeShared<Gs2::Inbox::Model::FVerifyActionResult>()
    ...
    TSharedPtr<FEzVerifyActionResult> FEzVerifyActionResult::FromModel(const Gs2::Inbox::Model::FVerifyActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
