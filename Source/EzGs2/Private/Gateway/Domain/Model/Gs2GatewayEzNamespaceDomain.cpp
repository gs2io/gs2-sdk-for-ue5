...
namespace Gs2::UE5::Gateway::Domain::Model
{
    ...
    Gs2::UE5::Gateway::Domain::Model::FEzUserDomainPtr FEzNamespaceDomain::User(
        const FString UserId
    ) const
    {
        return MakeShared<Gs2::UE5::Gateway::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ProfileValue
    ...
    Gs2::UE5::Gateway::Domain::Model::FEzUserGameSessionDomainPtr FEzNamespaceDomain::Me(
        Gs2::UE5::Auth::Model::FEzAccessTokenPtr AccessToken
    ) const
    {
        return MakeShared<Gs2::UE5::Gateway::Domain::Model::FEzUserGameSessionDomain>(
            Domain->AccessToken(
                AccessToken->ToModel()
            ),
            ProfileValue
