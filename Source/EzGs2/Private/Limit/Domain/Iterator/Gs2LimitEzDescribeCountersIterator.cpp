...
namespace Gs2::UE5::Limit::Domain::Iterator
{
    ...
    FEzDescribeCountersIterator::FEzDescribeCountersIterator(
        const Gs2::Limit::Domain::Iterator::FDescribeCountersIteratorPtr Iterator
    ): Iterator(Iterator)
    {
    }

    FEzDescribeCountersIterator::FDescribeCountersIteratorLoadTask::FDescribeCountersIteratorLoadTask(
        const TSharedPtr<Gs2::Limit::Domain::Iterator::FDescribeCountersIterator> Self
    ): Task(Self->Next())
    {
    ...
    const Gs2::UE5::Limit::Model::FEzCounterPtr& FEzDescribeCountersIterator::IteratorImpl::operator*() const
    {
        return Current;
    }
    Gs2::UE5::Limit::Model::FEzCounterPtr FEzDescribeCountersIterator::IteratorImpl::operator->()
    {
        return Current;
    }
    ...
    FEzDescribeCountersIterator::IteratorImpl& FEzDescribeCountersIterator::IteratorImpl::operator++()
    {
        ...
        {
            Current = Gs2::UE5::Limit::Model::FEzCounter::FromModel(Task->GetTask().Result());
        }
    ...
    FEzDescribeCountersIterator::IteratorImpl FEzDescribeCountersIterator::begin()
    {
        ...
        if (!Task->GetTask().IsError() && Task->GetTask().Result() != nullptr)
        {
            Impl.Current = Gs2::UE5::Limit::Model::FEzCounter::FromModel(Task->GetTask().Result());
        }
        Task->EnsureCompletion();
        return Impl;
    }
