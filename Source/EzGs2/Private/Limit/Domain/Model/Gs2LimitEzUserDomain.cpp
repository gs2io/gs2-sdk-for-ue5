...
#include "Limit/Domain/Model/Gs2LimitEzUserDomain.h"
...
namespace Gs2::UE5::Limit::Domain::Model
{
    ...
    Gs2::UE5::Limit::Domain::Model::FEzCounterDomainPtr FEzUserDomain::Counter(
        const FString LimitName,
        const FString CounterName
    ) const
    {
        return MakeShared<Gs2::UE5::Limit::Domain::Model::FEzCounterDomain>(
            Domain->Counter(
                LimitName,
                CounterName
            ),
