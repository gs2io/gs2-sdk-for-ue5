...
namespace Gs2::UE5::Enchant::Model
{
    ...
    Gs2::Enchant::Model::FConsumeActionResultPtr FEzConsumeActionResult::ToModel() const
    {
        return MakeShared<Gs2::Enchant::Model::FConsumeActionResult>()
    ...
    TSharedPtr<FEzConsumeActionResult> FEzConsumeActionResult::FromModel(const Gs2::Enchant::Model::FConsumeActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
