...
#include "Stamina/Domain/Model/Gs2StaminaEzUserDomain.h"

namespace Gs2::UE5::Stamina::Domain::Model
{

    TOptional<int32> FEzUserDomain::OverflowValue() const
    {
    ...
    Gs2::UE5::Stamina::Domain::Model::FEzStaminaDomainPtr FEzUserDomain::Stamina(
        const FString StaminaName
    ) const
    {
        return MakeShared<Gs2::UE5::Stamina::Domain::Model::FEzStaminaDomain>(
            Domain->Stamina(
                StaminaName
            ),
            ProfileValue
