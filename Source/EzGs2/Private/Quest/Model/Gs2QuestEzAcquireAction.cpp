...
#include "EzGs2/Public/Quest/Model/Gs2QuestEzAcquireAction.h"
...
namespace Gs2::UE5::Quest::Model
{
    ...
    Gs2::Quest::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Quest::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Quest::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
