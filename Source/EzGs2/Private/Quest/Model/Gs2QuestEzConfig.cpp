...
#include "EzGs2/Public/Quest/Model/Gs2QuestEzConfig.h"
...
namespace Gs2::UE5::Quest::Model
{
    ...
    Gs2::Quest::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Quest::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Quest::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
