...
#include "EzGs2/Public/Quest/Model/Gs2QuestEzConsumeAction.h"
...
namespace Gs2::UE5::Quest::Model
{
    ...
    Gs2::Quest::Model::FConsumeActionPtr FEzConsumeAction::ToModel() const
    {
        return MakeShared<Gs2::Quest::Model::FConsumeAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzConsumeAction> FEzConsumeAction::FromModel(const Gs2::Quest::Model::FConsumeActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
