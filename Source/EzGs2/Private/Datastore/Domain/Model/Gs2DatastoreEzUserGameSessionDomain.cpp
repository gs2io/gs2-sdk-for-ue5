...
namespace Gs2::UE5::Datastore::Domain::Model
{
    ...
    Gs2::Core::Domain::CallbackID FEzUserGameSessionDomain::SubscribeDataObjects(TFunction<void()> Callback)
    {
        return Domain->SubscribeDataObjects(
            Callback
        );
    }

    void FEzUserGameSessionDomain::UnsubscribeDataObjects(
            Gs2::Core::Domain::CallbackID CallbackId)
    {
        Domain->UnsubscribeDataObjects(
            CallbackId
        );
    }
