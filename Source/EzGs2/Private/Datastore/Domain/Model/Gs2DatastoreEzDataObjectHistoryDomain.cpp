...
namespace Gs2::UE5::Datastore::Domain::Model
{
    ...
    Gs2::Core::Domain::CallbackID FEzDataObjectHistoryDomain::Subscribe(TFunction<void(Gs2::UE5::Datastore::Model::FEzDataObjectHistoryPtr)> Callback)
    {
    ...
    void FEzDataObjectHistoryDomain::Unsubscribe(Gs2::Core::Domain::CallbackID CallbackId)
    {
        Domain->Unsubscribe(
            CallbackId
        );
