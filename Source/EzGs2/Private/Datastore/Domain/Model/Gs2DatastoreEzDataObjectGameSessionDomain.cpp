...
namespace Gs2::UE5::Datastore::Domain::Model
{
    ...
    FEzDataObjectGameSessionDomain::FDownloadOwnTask::FDownloadOwnTask(
        TSharedPtr<FEzDataObjectGameSessionDomain> Self
    ): Self(Self)
    {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzDataObjectGameSessionDomain::FDownloadOwnTask::Action(
        TSharedPtr<TSharedPtr<TArray<uint8>>> Result
    )
    {
        const auto Future = Self->ConnectionValue->Run(
    ...
    TSharedPtr<FAsyncTask<FEzDataObjectGameSessionDomain::FDownloadOwnTask>> FEzDataObjectGameSessionDomain::DownloadOwn(
    )
    {
        return Gs2::Core::Util::New<FAsyncTask<FDownloadOwnTask>>(
            this->AsShared()
        );
    }
}
