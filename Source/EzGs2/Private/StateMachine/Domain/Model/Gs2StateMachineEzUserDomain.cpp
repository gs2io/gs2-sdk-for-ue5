...
#include "StateMachine/Domain/Model/Gs2StateMachineEzUserDomain.h"
...
namespace Gs2::UE5::StateMachine::Domain::Model
{
    ...
    Gs2::UE5::StateMachine::Domain::Model::FEzStatusDomainPtr FEzUserDomain::Status(
        const FString StatusName
    ) const
    {
        return MakeShared<Gs2::UE5::StateMachine::Domain::Model::FEzStatusDomain>(
            Domain->Status(
                StatusName
            ),
            ConnectionValue
