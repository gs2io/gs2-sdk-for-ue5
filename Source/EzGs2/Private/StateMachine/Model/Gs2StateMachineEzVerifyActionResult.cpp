...
namespace Gs2::UE5::StateMachine::Model
{
    ...
    Gs2::StateMachine::Model::FVerifyActionResultPtr FEzVerifyActionResult::ToModel() const
    {
        return MakeShared<Gs2::StateMachine::Model::FVerifyActionResult>()
    ...
    TSharedPtr<FEzVerifyActionResult> FEzVerifyActionResult::FromModel(const Gs2::StateMachine::Model::FVerifyActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
