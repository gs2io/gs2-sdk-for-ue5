...
namespace Gs2::UE5::StateMachine::Model
{
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithVerifyResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzVerifyActionResult>>> VerifyResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithConsumeResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzConsumeActionResult>>> ConsumeResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithAcquireResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzAcquireActionResult>>> AcquireResults
    )
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzVerifyActionResult>>> FEzTransactionResult::GetVerifyResults() const
    {
        return VerifyResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzConsumeActionResult>>> FEzTransactionResult::GetConsumeResults() const
    {
        return ConsumeResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::StateMachine::Model::FEzAcquireActionResult>>> FEzTransactionResult::GetAcquireResults() const
    {
        return AcquireResultsValue;
    }

    Gs2::StateMachine::Model::FTransactionResultPtr FEzTransactionResult::ToModel() const
    {
        return MakeShared<Gs2::StateMachine::Model::FTransactionResult>()
            ->WithTransactionId(TransactionIdValue)
            ->WithVerifyResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::StateMachine::Model::FVerifyActionResult>>>();
            ...
            ->WithConsumeResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::StateMachine::Model::FConsumeActionResult>>>();
            ...
            ->WithAcquireResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::StateMachine::Model::FAcquireActionResult>>>();
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::FromModel(const Gs2::StateMachine::Model::FTransactionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
