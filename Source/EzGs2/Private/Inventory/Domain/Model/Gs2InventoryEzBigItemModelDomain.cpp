...
namespace Gs2::UE5::Inventory::Domain::Model
{
    ...
    FEzBigItemModelDomain::FGetBigItemModelTask::FGetBigItemModelTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzBigItemModelDomain::FGetBigItemModelTask::Action(
        TSharedPtr<TSharedPtr<Gs2::UE5::Inventory::Model::FEzBigItemModel>> Result
    )
    {
        const auto Future = Self->ProfileValue->Run<FGetBigItemModelTask>(
            [&]() -> Gs2::Core::Model::FGs2ErrorPtr {
                ...
                *Result = Gs2::UE5::Inventory::Model::FEzBigItemModel::FromModel(
                    Task->GetTask().Result()
                );
                Task->EnsureCompletion();
                return nullptr;
    ...
    TSharedPtr<FAsyncTask<FEzBigItemModelDomain::FGetBigItemModelTask>> FEzBigItemModelDomain::GetBigItemModel(
    )
    {
        return Gs2::Core::Util::New<FAsyncTask<FGetBigItemModelTask>>(
            this->AsShared()
        );
    }
