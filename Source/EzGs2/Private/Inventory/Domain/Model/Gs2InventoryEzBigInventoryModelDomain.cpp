...
namespace Gs2::UE5::Inventory::Domain::Model
{
    ...
    FEzBigInventoryModelDomain::FGetBigInventoryModelTask::FGetBigInventoryModelTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FEzBigInventoryModelDomain::FGetBigInventoryModelTask::Action(
        TSharedPtr<TSharedPtr<Gs2::UE5::Inventory::Model::FEzBigInventoryModel>> Result
    )
    {
        const auto Future = Self->ProfileValue->Run<FGetBigInventoryModelTask>(
            [&]() -> Gs2::Core::Model::FGs2ErrorPtr {
                ...
                *Result = Gs2::UE5::Inventory::Model::FEzBigInventoryModel::FromModel(
                    Task->GetTask().Result()
                );
                Task->EnsureCompletion();
                return nullptr;
    ...
    TSharedPtr<FAsyncTask<FEzBigInventoryModelDomain::FGetBigInventoryModelTask>> FEzBigInventoryModelDomain::GetBigInventoryModel(
    )
    {
        return Gs2::Core::Util::New<FAsyncTask<FGetBigInventoryModelTask>>(
            this->AsShared()
        );
    }
