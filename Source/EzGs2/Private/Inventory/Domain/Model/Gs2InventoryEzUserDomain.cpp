...
#include "Inventory/Domain/Model/Gs2InventoryEzUserDomain.h"
...
namespace Gs2::UE5::Inventory::Domain::Model
{
    ...
    Gs2::UE5::Inventory::Domain::Model::FEzInventoryDomainPtr FEzUserDomain::Inventory(
        const FString InventoryName
    ) const
    {
        return MakeShared<Gs2::UE5::Inventory::Domain::Model::FEzInventoryDomain>(
            Domain->Inventory(
                InventoryName
            ),
            ConnectionValue
