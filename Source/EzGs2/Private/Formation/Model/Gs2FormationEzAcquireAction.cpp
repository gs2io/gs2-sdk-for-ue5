...
#include "EzGs2/Public/Formation/Model/Gs2FormationEzAcquireAction.h"
...
namespace Gs2::UE5::Formation::Model
{
    ...
    Gs2::Formation::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Formation::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Formation::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
