...
#include "EzGs2/Public/Formation/Model/Gs2FormationEzConfig.h"
...
namespace Gs2::UE5::Formation::Model
{
    ...
    Gs2::Formation::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Formation::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Formation::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
