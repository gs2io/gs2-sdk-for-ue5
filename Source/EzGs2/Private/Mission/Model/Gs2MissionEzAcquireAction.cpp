...
namespace Gs2::UE5::Mission::Model
{
    ...
    Gs2::Mission::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Mission::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Mission::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
