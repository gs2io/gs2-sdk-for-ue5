...
namespace Gs2::UE5::Mission::Model
{
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithVerifyResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzVerifyActionResult>>> VerifyResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithConsumeResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzConsumeActionResult>>> ConsumeResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithAcquireResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzAcquireActionResult>>> AcquireResults
    )
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzVerifyActionResult>>> FEzTransactionResult::GetVerifyResults() const
    {
        return VerifyResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzConsumeActionResult>>> FEzTransactionResult::GetConsumeResults() const
    {
        return ConsumeResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Mission::Model::FEzAcquireActionResult>>> FEzTransactionResult::GetAcquireResults() const
    {
        return AcquireResultsValue;
    }

    Gs2::Mission::Model::FTransactionResultPtr FEzTransactionResult::ToModel() const
    {
        return MakeShared<Gs2::Mission::Model::FTransactionResult>()
            ->WithTransactionId(TransactionIdValue)
            ->WithVerifyResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Mission::Model::FVerifyActionResult>>>();
            ...
            ->WithConsumeResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Mission::Model::FConsumeActionResult>>>();
            ...
            ->WithAcquireResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Mission::Model::FAcquireActionResult>>>();
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::FromModel(const Gs2::Mission::Model::FTransactionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
