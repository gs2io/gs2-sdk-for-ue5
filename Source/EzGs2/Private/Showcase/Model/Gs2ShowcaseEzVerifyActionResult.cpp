...
namespace Gs2::UE5::Showcase::Model
{
    ...
    Gs2::Showcase::Model::FVerifyActionResultPtr FEzVerifyActionResult::ToModel() const
    {
        return MakeShared<Gs2::Showcase::Model::FVerifyActionResult>()
    ...
    TSharedPtr<FEzVerifyActionResult> FEzVerifyActionResult::FromModel(const Gs2::Showcase::Model::FVerifyActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
