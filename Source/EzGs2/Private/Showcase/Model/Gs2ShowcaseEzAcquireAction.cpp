...
#include "EzGs2/Public/Showcase/Model/Gs2ShowcaseEzAcquireAction.h"
...
namespace Gs2::UE5::Showcase::Model
{
    ...
    Gs2::Showcase::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Showcase::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Showcase::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
