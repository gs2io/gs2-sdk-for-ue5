...
#include "EzGs2/Public/Showcase/Model/Gs2ShowcaseEzConfig.h"
...
namespace Gs2::UE5::Showcase::Model
{
    ...
    Gs2::Showcase::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Showcase::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Showcase::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
