...
#include "EzGs2/Public/Distributor/Model/Gs2DistributorEzConsumeAction.h"
...
namespace Gs2::UE5::Distributor::Model
{
    ...
    Gs2::Distributor::Model::FConsumeActionPtr FEzConsumeAction::ToModel() const
    {
        return MakeShared<Gs2::Distributor::Model::FConsumeAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzConsumeAction> FEzConsumeAction::FromModel(const Gs2::Distributor::Model::FConsumeActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
