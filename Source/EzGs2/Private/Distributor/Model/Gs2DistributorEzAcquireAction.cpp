...
namespace Gs2::UE5::Distributor::Model
{
    ...
    Gs2::Distributor::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Distributor::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Distributor::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
