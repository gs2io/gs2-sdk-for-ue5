...
namespace Gs2::UE5::Experience::Model
{
    ...
    Gs2::Experience::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Experience::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Experience::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
