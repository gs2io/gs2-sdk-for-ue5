...
#include "Experience/Domain/Model/Gs2ExperienceEzUserDomain.h"
...
namespace Gs2::UE5::Experience::Domain::Model
{
    ...
    Gs2::UE5::Experience::Domain::Model::FEzStatusDomainPtr FEzUserDomain::Status(
        const FString ExperienceName,
        const FString PropertyId
    ) const
    {
        return MakeShared<Gs2::UE5::Experience::Domain::Model::FEzStatusDomain>(
            Domain->Status(
                ExperienceName,
                PropertyId
            ),
