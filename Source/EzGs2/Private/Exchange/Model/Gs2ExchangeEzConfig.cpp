...
#include "EzGs2/Public/Exchange/Model/Gs2ExchangeEzConfig.h"
...
namespace Gs2::UE5::Exchange::Model
{
    ...
    Gs2::Exchange::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Exchange::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Exchange::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
