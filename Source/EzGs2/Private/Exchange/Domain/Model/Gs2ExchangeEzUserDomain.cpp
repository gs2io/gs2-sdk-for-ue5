...
#include "Exchange/Domain/Model/Gs2ExchangeEzUserDomain.h"
...
namespace Gs2::UE5::Exchange::Domain::Model
{
    ...
    Gs2::UE5::Exchange::Domain::Model::FEzAwaitDomainPtr FEzUserDomain::Await(
        const FString AwaitName
    ) const
    {
        return MakeShared<Gs2::UE5::Exchange::Domain::Model::FEzAwaitDomain>(
            Domain->Await(
                AwaitName
            ),
            ProfileValue
