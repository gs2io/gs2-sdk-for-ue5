...
namespace Gs2::UE5::Enhance::Model
{
    ...
    Gs2::Enhance::Model::FAcquireActionResultPtr FEzAcquireActionResult::ToModel() const
    {
        return MakeShared<Gs2::Enhance::Model::FAcquireActionResult>()
    ...
    TSharedPtr<FEzAcquireActionResult> FEzAcquireActionResult::FromModel(const Gs2::Enhance::Model::FAcquireActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
