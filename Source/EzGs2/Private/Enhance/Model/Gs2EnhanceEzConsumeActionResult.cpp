...
namespace Gs2::UE5::Enhance::Model
{
    ...
    Gs2::Enhance::Model::FConsumeActionResultPtr FEzConsumeActionResult::ToModel() const
    {
        return MakeShared<Gs2::Enhance::Model::FConsumeActionResult>()
    ...
    TSharedPtr<FEzConsumeActionResult> FEzConsumeActionResult::FromModel(const Gs2::Enhance::Model::FConsumeActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
