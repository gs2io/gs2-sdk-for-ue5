...
namespace Gs2::UE5::News::Domain::Model
{
    ...
    Gs2::UE5::News::Domain::Model::FEzUserDomainPtr FEzNamespaceDomain::User(
        const FString UserId
    ) const
    {
        return MakeShared<Gs2::UE5::News::Domain::Model::FEzUserDomain>(
            Domain->User(
                UserId
            ),
            ConnectionValue
    ...
    Gs2::UE5::News::Domain::Model::FEzUserGameSessionDomainPtr FEzNamespaceDomain::Me(
        Gs2::UE5::Util::FGameSessionPtr GameSession
    ) const
    {
        return MakeShared<Gs2::UE5::News::Domain::Model::FEzUserGameSessionDomain>(
            Domain->AccessToken(
