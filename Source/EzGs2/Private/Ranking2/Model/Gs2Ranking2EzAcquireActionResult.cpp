...
namespace Gs2::UE5::Ranking2::Model
{
    ...
    Gs2::Ranking2::Model::FAcquireActionResultPtr FEzAcquireActionResult::ToModel() const
    {
        return MakeShared<Gs2::Ranking2::Model::FAcquireActionResult>()
    ...
    TSharedPtr<FEzAcquireActionResult> FEzAcquireActionResult::FromModel(const Gs2::Ranking2::Model::FAcquireActionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
