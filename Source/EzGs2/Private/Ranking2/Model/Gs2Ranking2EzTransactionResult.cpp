...
namespace Gs2::UE5::Ranking2::Model
{
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithVerifyResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzVerifyActionResult>>> VerifyResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithConsumeResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzConsumeActionResult>>> ConsumeResults
    )
    {
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::WithAcquireResults(
        const TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzAcquireActionResult>>> AcquireResults
    )
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzVerifyActionResult>>> FEzTransactionResult::GetVerifyResults() const
    {
        return VerifyResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzConsumeActionResult>>> FEzTransactionResult::GetConsumeResults() const
    {
        return ConsumeResultsValue;
    }
    TSharedPtr<TArray<TSharedPtr<Gs2::UE5::Ranking2::Model::FEzAcquireActionResult>>> FEzTransactionResult::GetAcquireResults() const
    {
        return AcquireResultsValue;
    }

    Gs2::Ranking2::Model::FTransactionResultPtr FEzTransactionResult::ToModel() const
    {
        return MakeShared<Gs2::Ranking2::Model::FTransactionResult>()
            ->WithTransactionId(TransactionIdValue)
            ->WithVerifyResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Ranking2::Model::FVerifyActionResult>>>();
            ...
            ->WithConsumeResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Ranking2::Model::FConsumeActionResult>>>();
            ...
            ->WithAcquireResults([&]
                {
                    auto v = MakeShared<TArray<TSharedPtr<Gs2::Ranking2::Model::FAcquireActionResult>>>();
    ...
    TSharedPtr<FEzTransactionResult> FEzTransactionResult::FromModel(const Gs2::Ranking2::Model::FTransactionResultPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
