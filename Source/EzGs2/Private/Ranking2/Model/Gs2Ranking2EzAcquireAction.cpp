...
namespace Gs2::UE5::Ranking2::Model
{
    ...
    Gs2::Ranking2::Model::FAcquireActionPtr FEzAcquireAction::ToModel() const
    {
        return MakeShared<Gs2::Ranking2::Model::FAcquireAction>()
            ->WithAction(ActionValue)
            ->WithRequest(RequestValue);
    }

    TSharedPtr<FEzAcquireAction> FEzAcquireAction::FromModel(const Gs2::Ranking2::Model::FAcquireActionPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
