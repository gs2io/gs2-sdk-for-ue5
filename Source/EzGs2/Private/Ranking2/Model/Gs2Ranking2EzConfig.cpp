...
namespace Gs2::UE5::Ranking2::Model
{
    ...
    Gs2::Ranking2::Model::FConfigPtr FEzConfig::ToModel() const
    {
        return MakeShared<Gs2::Ranking2::Model::FConfig>()
            ->WithKey(KeyValue)
            ->WithValue(ValueValue);
    }

    TSharedPtr<FEzConfig> FEzConfig::FromModel(const Gs2::Ranking2::Model::FConfigPtr Model)
    {
        if (Model == nullptr)
        {
            return nullptr;
