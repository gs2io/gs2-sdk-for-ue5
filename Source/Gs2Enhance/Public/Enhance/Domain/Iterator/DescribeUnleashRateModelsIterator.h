...
namespace Gs2::Enhance::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enhance::Model::FUnleashRateModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeUnleashRateModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Enhance::Model::FUnleashRateModelPtr>> Range;
            TOptional<TArray<Gs2::Enhance::Model::FUnleashRateModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enhance::Model::FUnleashRateModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeUnleashRateModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeUnleashRateModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeUnleashRateModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeUnleashRateModelsIterator> FDescribeUnleashRateModelsIteratorPtr;
}
