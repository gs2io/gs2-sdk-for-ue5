...
namespace Gs2::Enhance::Domain::Iterator
{
    ...
    class GS2ENHANCE_API FDescribeRateModelMastersIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enhance::Model::FRateModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeRateModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Enhance::Model::FRateModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Enhance::Model::FRateModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Enhance::Model::FRateModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRateModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRateModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRateModelMastersIterator> Iterable)
            {
