...
namespace Gs2::Enhance::Domain::Iterator
{
    ...
    class GS2ENHANCE_API FDescribeNamespacesIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Enhance::Model::FNamespace, FDescribeNamespacesIteratorLoadTask>
    {
...
public:
        ...
        class GS2ENHANCE_API IteratorImpl
        {
            ...
            TSharedPtr<FAsyncTask<Gs2::Enhance::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task;
            Gs2::Enhance::Model::FNamespacePtr Current;

        public:
            explicit IteratorImpl(
                const TSharedPtr<FAsyncTask<Gs2::Enhance::Domain::Iterator::FDescribeNamespacesIterator::FNextTask>> Task
            ): Task(Task)
            {

            }
            const Gs2::Enhance::Model::FNamespacePtr& operator*() const;
            Gs2::Enhance::Model::FNamespacePtr operator->();
    ...
    class FDescribeNamespacesIteratorLoadTask :
        public Gs2::Core::Util::TGs2Future<TArray<Gs2::Enhance::Model::FNamespacePtr>>,
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(
            TSharedPtr<TSharedPtr<TArray<Gs2::Enhance::Model::FNamespacePtr>>> Result
        ) override;
    };
}
