...
namespace Gs2::Enhance::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Enhance::Model::FNamespace>> Result) override;
        ...
        class GS2ENHANCE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Enhance::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Enhance::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
