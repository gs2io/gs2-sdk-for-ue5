...
{
    class GS2ENHANCE_API FDirectEnhanceByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FDirectEnhanceByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Enhance::Domain::FGs2EnhanceDomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Enhance::Request::FDirectEnhanceByUserIdRequestPtr& Request
