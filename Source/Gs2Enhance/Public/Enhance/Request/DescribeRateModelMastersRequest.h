...
namespace Gs2::Enhance::Request
{
    ...
    class GS2ENHANCE_API FDescribeRateModelMastersRequest final : public TSharedFromThis<FDescribeRateModelMastersRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeRateModelMastersRequest> WithNamePrefix(const TOptional<FString> NamePrefix);
    ...
    typedef TSharedPtr<FDescribeRateModelMastersRequest> FDescribeRateModelMastersRequestPtr;
}