...
namespace Gs2::Enhance::Request
{
    ...
    class GS2ENHANCE_API FGetRateModelMasterRequest final : public TSharedFromThis<FGetRateModelMasterRequest>
    {
    ...
    typedef TSharedPtr<FGetRateModelMasterRequest> FGetRateModelMasterRequestPtr;
}