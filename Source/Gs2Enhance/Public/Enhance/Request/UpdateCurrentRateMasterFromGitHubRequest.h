...
namespace Gs2::Enhance::Request
{
    ...
    class GS2ENHANCE_API FUpdateCurrentRateMasterFromGitHubRequest final : public TSharedFromThis<FUpdateCurrentRateMasterFromGitHubRequest>
    {
    ...
    typedef TSharedPtr<FUpdateCurrentRateMasterFromGitHubRequest, ESPMode::ThreadSafe> FUpdateCurrentRateMasterFromGitHubRequestPtr;
}