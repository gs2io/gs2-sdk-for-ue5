...
#include "Enhance/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Enhance/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
