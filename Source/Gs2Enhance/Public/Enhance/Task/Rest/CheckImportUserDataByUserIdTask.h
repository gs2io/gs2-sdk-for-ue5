...
#include "Enhance/Request/CheckImportUserDataByUserIdRequest.h"
#include "Enhance/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
