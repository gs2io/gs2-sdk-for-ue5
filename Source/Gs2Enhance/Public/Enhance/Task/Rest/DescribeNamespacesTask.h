...
#include "Enhance/Request/DescribeNamespacesRequest.h"
#include "Enhance/Result/DescribeNamespacesResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
