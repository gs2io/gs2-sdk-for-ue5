...
#include "Enhance/Request/GetProgressRequest.h"
#include "Enhance/Result/GetProgressResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FGetProgressTask final : public Gs2::Core::Util::TGs2Future<Result::FGetProgressResult>
    {
