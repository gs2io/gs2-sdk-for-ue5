...
#include "Enhance/Request/CleanUserDataByUserIdRequest.h"
#include "Enhance/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
