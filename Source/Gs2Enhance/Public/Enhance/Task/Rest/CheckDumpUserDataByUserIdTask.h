...
#include "Enhance/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Enhance/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::Rest
{
    class GS2ENHANCE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
