...
#include "Enhance/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Enhance/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
