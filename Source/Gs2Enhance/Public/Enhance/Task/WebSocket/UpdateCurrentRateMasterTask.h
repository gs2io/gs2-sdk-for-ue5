...
#include "Enhance/Result/UpdateCurrentRateMasterResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FUpdateCurrentRateMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateCurrentRateMasterResult>
    {
