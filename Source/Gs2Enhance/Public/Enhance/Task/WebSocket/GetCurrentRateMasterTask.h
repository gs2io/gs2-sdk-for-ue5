...
#include "Enhance/Result/GetCurrentRateMasterResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FGetCurrentRateMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FGetCurrentRateMasterResult>
    {
