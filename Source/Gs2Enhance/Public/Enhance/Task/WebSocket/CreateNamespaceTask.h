...
#include "Enhance/Result/CreateNamespaceResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
