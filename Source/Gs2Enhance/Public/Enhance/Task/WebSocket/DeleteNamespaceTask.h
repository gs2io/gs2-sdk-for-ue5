...
#include "Enhance/Request/DeleteNamespaceRequest.h"
#include "Enhance/Result/DeleteNamespaceResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
