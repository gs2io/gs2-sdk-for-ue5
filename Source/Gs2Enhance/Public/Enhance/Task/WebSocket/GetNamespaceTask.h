...
#include "Enhance/Request/GetNamespaceRequest.h"
#include "Enhance/Result/GetNamespaceResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
