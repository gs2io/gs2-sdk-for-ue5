...
#include "Enhance/Request/ImportUserDataByUserIdRequest.h"
#include "Enhance/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
