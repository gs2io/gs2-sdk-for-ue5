...
#include "Enhance/Request/GetServiceVersionRequest.h"
#include "Enhance/Result/GetServiceVersionResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
