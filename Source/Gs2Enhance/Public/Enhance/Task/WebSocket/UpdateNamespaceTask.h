...
#include "Enhance/Result/UpdateNamespaceResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
