...
#include "Enhance/Result/GetProgressByUserIdResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FGetProgressByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FGetProgressByUserIdResult>
    {
