...
#include "Enhance/Request/GetNamespaceStatusRequest.h"
#include "Enhance/Result/GetNamespaceStatusResult.h"

namespace Gs2::Enhance::Task::WebSocket
{
    class GS2ENHANCE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
