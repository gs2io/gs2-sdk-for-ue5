...
namespace Gs2::Enhance::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Enhance::Model::FCurrentRateMasterPtr Value;
                const auto CacheHit = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Enhance::Model::FCurrentRateMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Enhance::Model::Cache::FCurrentRateMasterCache::CreateCacheKey(
