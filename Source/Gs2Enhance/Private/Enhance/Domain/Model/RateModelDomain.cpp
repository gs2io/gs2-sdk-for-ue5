...
namespace Gs2::Enhance::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::Enhance::Model::Cache::FRateModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Enhance::Model::Cache::FRateModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Enhance::Model::FRateModelPtr Value;
                const auto CacheHit = Gs2::Enhance::Model::Cache::FRateModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Enhance::Model::Cache::FRateModelCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->RateName,
                    TOptional<int32>(),
                    [Self](Gs2::Enhance::Model::FRateModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        Gs2::Enhance::Model::Cache::FRateModelCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::Enhance::Model::Cache::FRateModelCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Enhance::Model::Cache::FRateModelCache::CreateCacheKey(
