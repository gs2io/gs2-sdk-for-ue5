...
namespace Gs2::Enhance::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Put<Gs2::Enhance::Model::FRateModel>(
                    ParentKey,
                    Key,
                    ResultModel->GetItem(),
    ...
    )
    {
        ...
        auto Value = Self->Cache->Get<Gs2::Enhance::Model::FRateModel>(
            Self->ParentKey,
        ...
        if (Value == nullptr) {
            ...
            if (Future->GetTask().IsError())
            {
                if (Future->GetTask().Error()->Type() == Gs2::Core::Model::FNotFoundError::TypeString)
                {
                    ...
                    {
                        Self->Cache->Delete<Gs2::Enhance::Model::FRateModel>(
                            Self->ParentKey,
                            Gs2::Enhance::Domain::Model::FRateModelDomain::CreateCacheKey(
                                Self->RateName
                            )
            ...
            Value = Self->Cache->Get<Gs2::Enhance::Model::FRateModel>(
                Self->ParentKey,
                Gs2::Enhance::Domain::Model::FRateModelDomain::CreateCacheKey(
                    Self->RateName
                )
