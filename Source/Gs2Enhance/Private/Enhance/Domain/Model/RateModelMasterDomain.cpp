...
namespace Gs2::Enhance::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Enhance::Model::Cache::FRateModelMasterCache::Delete(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Enhance::Model::Cache::FRateModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Enhance::Model::Cache::FRateModelMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Enhance::Model::FRateModelMasterPtr Value;
                const auto CacheHit = Gs2::Enhance::Model::Cache::FRateModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Enhance::Model::Cache::FRateModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->RateName,
                    TOptional<int32>(),
                    [Self](Gs2::Enhance::Model::FRateModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Enhance::Model::Cache::FRateModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Enhance::Model::Cache::FRateModelMasterCache::CreateCacheKey(
