...
#include "Enhance/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::Enhance::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetEnhanceScript() != nullptr && this->Request->GetEnhanceScript().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("enhanceScript"), this->Request->GetEnhanceScript()->ToJson());
            }
            ...
            {
                JsonRootObject->SetBoolField(TEXT("enableDirectEnhance"), this->Request->GetEnableDirectEnhance().GetValue());
            }
