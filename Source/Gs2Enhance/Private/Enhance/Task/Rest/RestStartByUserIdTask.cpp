...
#include "Enhance/Task/Rest/StartByUserIdTask.h"
...
{
    FStartByUserIdTask::FStartByUserIdTask(
    ...
    FStartByUserIdTask::FStartByUserIdTask(
        const FStartByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FStartByUserIdTask::Action(
        const TSharedPtr<Result::FStartByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/progress/rate/{rateName}/start");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FStartByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
