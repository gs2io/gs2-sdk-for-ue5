...
#include "Enhance/Task/Rest/DirectEnhanceTask.h"
...
{
    FDirectEnhanceTask::FDirectEnhanceTask(
    ...
    Core::Model::FGs2ErrorPtr FDirectEnhanceTask::Action(
        const TSharedPtr<Result::FDirectEnhanceResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/enhance/{rateName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDirectEnhanceResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
