...
#include "Enhance/Task/WebSocket/UpdateRateModelMasterTask.h"
...
namespace Gs2::Enhance::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enhance"), TEXT("rateModelMaster"), TEXT("updateRateModelMaster"), ToCStr(RequestPayload->Payload()));
