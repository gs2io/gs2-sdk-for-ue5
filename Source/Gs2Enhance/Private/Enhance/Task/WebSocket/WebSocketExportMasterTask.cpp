...
#include "Enhance/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Enhance::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enhance"), TEXT("currentRateMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
