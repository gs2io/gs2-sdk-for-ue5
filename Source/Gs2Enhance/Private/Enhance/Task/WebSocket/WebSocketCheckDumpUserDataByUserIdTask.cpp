...
#include "Enhance/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::Enhance::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enhance"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
