...
#include "Enhance/Task/WebSocket/CreateRateModelMasterTask.h"
...
namespace Gs2::Enhance::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("enhance"), TEXT("rateModelMaster"), TEXT("createRateModelMaster"), ToCStr(RequestPayload->Payload()));
