...
#include "Enhance/Model/Namespace.h"
...
namespace Gs2::Enhance::Model
{
    ...
    TSharedPtr<FNamespace> FNamespace::WithEnhanceScript(
        const TSharedPtr<FScriptSetting> EnhanceScript
    )
    {
    ...
    TSharedPtr<FScriptSetting> FNamespace::GetEnhanceScript() const
    {
    ...
    TSharedPtr<FNamespace> FNamespace::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FNamespace>()
            ...
            ->WithEnhanceScript(Data->HasField(ANSI_TO_TCHAR("enhanceScript")) ? [Data]() -> Model::FScriptSettingPtr
                {
                    if (Data->HasTypedField<EJson::Null>(ANSI_TO_TCHAR("enhanceScript")))
                    {
                        return nullptr;
                    }
                    return Model::FScriptSetting::FromJson(Data->GetObjectField(ANSI_TO_TCHAR("enhanceScript")));
                 }() : nullptr)
    ...
    TSharedPtr<FJsonObject> FNamespace::ToJson() const
    {
        ...
        {
            JsonRootObject->SetObjectField(TEXT("enhanceScript"), EnhanceScriptValue->ToJson());
        }
        ...
        if (EnableDirectEnhanceValue.IsSet())
        {
            JsonRootObject->SetBoolField(TEXT("enableDirectEnhance"), EnableDirectEnhanceValue.GetValue());
        }
...
namespace Gs2::Enhance::Model::Cache
{
    ...
    bool FNamespaceCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::Enhance::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Enhance::Model::FNamespacePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Enhance::Model::FNamespace>(
    ...
    void FNamespaceCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::Enhance::Model::FNamespacePtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Enhance::Model::FNamespacePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Enhance::Model::FNamespace>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Enhance::Model::FNamespace::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    FString FNamespaceCache::PutUserData(
        ...
        const Gs2::Enhance::Model::FNamespacePtr& Item
    )
    {
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Enhance::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentNamespaceName
        ));
    ...
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::Enhance::Model::FNamespacePtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::Enhance::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::Enhance::Model::FNamespacePtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FNamespaceCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::Enhance::Model::FNamespacePtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::Enhance::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Enhance::Model::FNamespacePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Enhance::Model::FNamespace>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Enhance::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
