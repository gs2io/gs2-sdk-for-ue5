...
#include "Limit/Task/WebSocket/GetCounterTask.h"
...
namespace Gs2::Limit::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("limit"), TEXT("counter"), TEXT("getCounter"), ToCStr(RequestPayload->Payload()));
