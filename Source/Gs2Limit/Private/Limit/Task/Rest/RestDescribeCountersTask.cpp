...
#include "Limit/Task/Rest/DescribeCountersTask.h"
...
{
    FDescribeCountersTask::FDescribeCountersTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeCountersTask::Action(
        const TSharedPtr<Result::FDescribeCountersResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/counter");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeCountersResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
