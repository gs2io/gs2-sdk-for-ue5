...
#include "Limit/Task/Rest/CountUpByUserIdTask.h"
...
{
    FCountUpByUserIdTask::FCountUpByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCountUpByUserIdTask::Action(
        const TSharedPtr<Result::FCountUpByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/counter/{limitName}/{counterName}");
            ...
            {
                JsonRootObject->SetNumberField(TEXT("countUpValue"), this->Request->GetCountUpValue().GetValue());
            }
            if (this->Request->GetMaxValue().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("maxValue"), this->Request->GetMaxValue().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCountUpByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
