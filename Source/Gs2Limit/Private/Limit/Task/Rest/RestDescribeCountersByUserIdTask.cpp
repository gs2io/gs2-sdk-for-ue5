...
#include "Limit/Task/Rest/DescribeCountersByUserIdTask.h"
...
{
    FDescribeCountersByUserIdTask::FDescribeCountersByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeCountersByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeCountersByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/counter");
            ...
            if (this->Request->GetLimitName().IsSet()) {
                queryStrings.Add("limitName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetLimitName().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeCountersByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
