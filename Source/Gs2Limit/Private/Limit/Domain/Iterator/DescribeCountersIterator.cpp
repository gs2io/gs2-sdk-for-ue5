...
namespace Gs2::Limit::Domain::Iterator
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeCountersIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Limit::Model::FCounter>> Result)
    {
        ++Iterator;
            ...
            if (Range.IsValid())
            {
                for (const auto& Item : *Range)
                {
                    ...
                    Gs2::Limit::Model::Cache::FCounterCache::Put(
                        Self->Gs2->Cache,
                        Request->GetNamespaceName(), CacheOwnerSnapshotUserId, Item->GetLimitName(), Item->GetName(),
