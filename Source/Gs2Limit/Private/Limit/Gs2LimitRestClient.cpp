...
namespace Gs2::Limit
{
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FGetServiceVersionTask>> FGs2LimitRestClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FDumpUserDataByUserIdTask>> FGs2LimitRestClient::DumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckDumpUserDataByUserIdTask>> FGs2LimitRestClient::CheckDumpUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCleanUserDataByUserIdTask>> FGs2LimitRestClient::CleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckCleanUserDataByUserIdTask>> FGs2LimitRestClient::CheckCleanUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FPrepareImportUserDataByUserIdTask>> FGs2LimitRestClient::PrepareImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FImportUserDataByUserIdTask>> FGs2LimitRestClient::ImportUserDataByUserId(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FCheckImportUserDataByUserIdTask>> FGs2LimitRestClient::CheckImportUserDataByUserId(
