...
namespace Gs2::Limit::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithCountUpScript(
    ...
    TSharedPtr<Model::FScriptSetting> FUpdateNamespaceRequest::GetCountUpScript() const
    {
