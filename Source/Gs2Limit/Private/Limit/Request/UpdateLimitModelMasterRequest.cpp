...
namespace Gs2::Limit::Request
{
    ...
    TSharedPtr<FUpdateLimitModelMasterRequest> FUpdateLimitModelMasterRequest::WithAnchorTimestamp(
    ...
    TSharedPtr<FUpdateLimitModelMasterRequest> FUpdateLimitModelMasterRequest::WithDays(
    ...
    TOptional<int64> FUpdateLimitModelMasterRequest::GetAnchorTimestamp() const
    {
        return AnchorTimestampValue;
    }

    FString FUpdateLimitModelMasterRequest::GetAnchorTimestampString() const
    {
    ...
    TOptional<int32> FUpdateLimitModelMasterRequest::GetDays() const
    {
        return DaysValue;
    }

    FString FUpdateLimitModelMasterRequest::GetDaysString() const
    {
        if (!DaysValue.IsSet())
        {
            return FString("null");
