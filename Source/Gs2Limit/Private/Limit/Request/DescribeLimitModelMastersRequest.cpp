...
namespace Gs2::Limit::Request
{
    ...
    TSharedPtr<FDescribeLimitModelMastersRequest> FDescribeLimitModelMastersRequest::WithNamePrefix(
    ...
    TOptional<FString> FDescribeLimitModelMastersRequest::GetNamePrefix() const
    {
