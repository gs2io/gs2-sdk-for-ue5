...
namespace Gs2::Limit::Domain::SpeculativeExecutor
{
    ...
    class GS2LIMIT_API FDeleteCounterByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        public:
            GS2LIMIT_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Limit::Domain::FGs2LimitDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Limit::Request::FDeleteCounterByUserIdRequestPtr& Request
            ...
            GS2LIMIT_API FCommitTask(
                const FCommitTask& From
            );

            GS2LIMIT_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
        ...
        static Gs2::Limit::Request::FDeleteCounterByUserIdRequestPtr Rate(
            const Gs2::Limit::Request::FDeleteCounterByUserIdRequestPtr& Request,
            const double Rate
        );
