...
namespace Gs2::Limit::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Limit::Model::FNamespace>> Result) override;
        ...
        class GS2LIMIT_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Limit::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Limit::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
