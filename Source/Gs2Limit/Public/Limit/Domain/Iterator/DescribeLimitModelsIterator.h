...
namespace Gs2::Limit::Domain::Iterator
{
    ...
    class GS2LIMIT_API FDescribeLimitModelsIterator :
        public TSharedFromThis<FDescribeLimitModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Limit::Model::FLimitModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeLimitModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Limit::Model::FLimitModelPtr>> Range;
            TOptional<TArray<Gs2::Limit::Model::FLimitModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLimitModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLimitModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLimitModelsIterator> Iterable)
            {
