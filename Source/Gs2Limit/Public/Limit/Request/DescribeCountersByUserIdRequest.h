...
namespace Gs2::Limit::Request
{
    ...
    class GS2LIMIT_API FDescribeCountersByUserIdRequest final : public TSharedFromThis<FDescribeCountersByUserIdRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeCountersByUserIdRequest> WithLimitName(const TOptional<FString> LimitName);
    ...
    typedef TSharedPtr<FDescribeCountersByUserIdRequest, ESPMode::ThreadSafe> FDescribeCountersByUserIdRequestPtr;
}