...
namespace Gs2::Limit::Request
{
    ...
    class GS2LIMIT_API FDescribeCountersRequest final : public TSharedFromThis<FDescribeCountersRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeCountersRequest> WithLimitName(const TOptional<FString> LimitName);
    ...
    typedef TSharedPtr<FDescribeCountersRequest, ESPMode::ThreadSafe> FDescribeCountersRequestPtr;
}