...
#include "Limit/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Limit/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::Rest
{
    class GS2LIMIT_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
