...
#include "Limit/Request/CheckImportUserDataByUserIdRequest.h"
#include "Limit/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::Rest
{
    class GS2LIMIT_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
