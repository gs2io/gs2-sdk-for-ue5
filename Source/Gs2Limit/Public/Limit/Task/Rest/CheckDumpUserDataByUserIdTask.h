...
#include "Limit/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Limit/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::Rest
{
    class GS2LIMIT_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
