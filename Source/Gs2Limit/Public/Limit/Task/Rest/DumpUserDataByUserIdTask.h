...
#include "Limit/Request/DumpUserDataByUserIdRequest.h"
#include "Limit/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::Rest
{
    class GS2LIMIT_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
