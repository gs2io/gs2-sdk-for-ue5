...
#include "Limit/Request/GetNamespaceStatusRequest.h"
#include "Limit/Result/GetNamespaceStatusResult.h"

namespace Gs2::Limit::Task::Rest
{
    class GS2LIMIT_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
