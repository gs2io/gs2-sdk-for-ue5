...
#include "Limit/Request/DeleteNamespaceRequest.h"
#include "Limit/Result/DeleteNamespaceResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
