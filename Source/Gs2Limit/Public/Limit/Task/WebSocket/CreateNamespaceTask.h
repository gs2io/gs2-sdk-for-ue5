...
#include "Limit/Result/CreateNamespaceResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
