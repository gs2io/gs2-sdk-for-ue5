...
#include "Limit/Request/GetServiceVersionRequest.h"
#include "Limit/Result/GetServiceVersionResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
