...
#include "Limit/Request/ImportUserDataByUserIdRequest.h"
#include "Limit/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
