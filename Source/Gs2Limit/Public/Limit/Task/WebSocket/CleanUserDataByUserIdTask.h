...
#include "Limit/Request/CleanUserDataByUserIdRequest.h"
#include "Limit/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
