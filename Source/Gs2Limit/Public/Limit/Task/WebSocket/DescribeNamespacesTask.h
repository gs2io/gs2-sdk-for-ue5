...
#include "Limit/Request/DescribeNamespacesRequest.h"
#include "Limit/Result/DescribeNamespacesResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
