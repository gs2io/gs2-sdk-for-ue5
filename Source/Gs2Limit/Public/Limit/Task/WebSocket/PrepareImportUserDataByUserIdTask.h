...
#include "Limit/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Limit/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
