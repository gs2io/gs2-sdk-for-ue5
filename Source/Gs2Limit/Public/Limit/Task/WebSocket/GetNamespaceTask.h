...
#include "Limit/Request/GetNamespaceRequest.h"
#include "Limit/Result/GetNamespaceResult.h"

namespace Gs2::Limit::Task::WebSocket
{
    class GS2LIMIT_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
