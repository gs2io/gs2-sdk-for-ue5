...
namespace Gs2::SkillTree::Result
{
    ...
    public:
        ...
        TSharedPtr<FResetResult> WithAtomicCommit(const TOptional<bool> AtomicCommit);
        TSharedPtr<FResetResult> WithTransaction(const TOptional<FString> Transaction);
        TSharedPtr<FResetResult> WithTransactionResult(const TSharedPtr<Gs2::Core::Model::FTransactionResult> TransactionResult);
