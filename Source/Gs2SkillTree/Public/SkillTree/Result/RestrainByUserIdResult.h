...
namespace Gs2::SkillTree::Result
{
    ...
    public:
        ...
        TSharedPtr<FRestrainByUserIdResult> WithAtomicCommit(const TOptional<bool> AtomicCommit);
        TSharedPtr<FRestrainByUserIdResult> WithTransaction(const TOptional<FString> Transaction);
        TSharedPtr<FRestrainByUserIdResult> WithTransactionResult(const TSharedPtr<Gs2::Core::Model::FTransactionResult> TransactionResult);
