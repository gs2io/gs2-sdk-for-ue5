...
#include "SkillTree/Request/CleanUserDataByUserIdRequest.h"
#include "SkillTree/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
