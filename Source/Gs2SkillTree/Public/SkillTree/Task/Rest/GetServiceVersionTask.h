...
#include "SkillTree/Request/GetServiceVersionRequest.h"
#include "SkillTree/Result/GetServiceVersionResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
