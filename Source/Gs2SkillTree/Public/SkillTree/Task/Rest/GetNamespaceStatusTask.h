...
#include "SkillTree/Request/GetNamespaceStatusRequest.h"
#include "SkillTree/Result/GetNamespaceStatusResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
