...
#include "SkillTree/Result/UpdateNamespaceResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
