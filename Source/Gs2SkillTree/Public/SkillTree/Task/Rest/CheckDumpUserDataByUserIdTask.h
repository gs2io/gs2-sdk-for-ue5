...
#include "SkillTree/Request/CheckDumpUserDataByUserIdRequest.h"
#include "SkillTree/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
