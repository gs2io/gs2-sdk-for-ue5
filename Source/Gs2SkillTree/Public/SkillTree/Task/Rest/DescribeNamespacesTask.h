...
#include "SkillTree/Request/DescribeNamespacesRequest.h"
#include "SkillTree/Result/DescribeNamespacesResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
