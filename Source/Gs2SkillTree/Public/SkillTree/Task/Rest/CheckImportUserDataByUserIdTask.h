...
#include "SkillTree/Request/CheckImportUserDataByUserIdRequest.h"
#include "SkillTree/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
