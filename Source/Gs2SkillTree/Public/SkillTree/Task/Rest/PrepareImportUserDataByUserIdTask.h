...
#include "SkillTree/Request/PrepareImportUserDataByUserIdRequest.h"
#include "SkillTree/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::Rest
{
    class GS2SKILLTREE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
