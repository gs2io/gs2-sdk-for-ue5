...
#include "SkillTree/Request/ImportUserDataByUserIdRequest.h"
#include "SkillTree/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::WebSocket
{
    class GS2SKILLTREE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
