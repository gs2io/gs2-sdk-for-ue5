...
#include "SkillTree/Request/CheckCleanUserDataByUserIdRequest.h"
#include "SkillTree/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::SkillTree::Task::WebSocket
{
    class GS2SKILLTREE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
