...
#include "SkillTree/Request/DeleteNamespaceRequest.h"
#include "SkillTree/Result/DeleteNamespaceResult.h"

namespace Gs2::SkillTree::Task::WebSocket
{
    class GS2SKILLTREE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
