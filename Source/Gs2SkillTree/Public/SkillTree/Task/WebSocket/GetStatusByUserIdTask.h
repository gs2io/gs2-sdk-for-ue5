...
#include "SkillTree/Request/GetStatusByUserIdRequest.h"
#include "SkillTree/Result/GetStatusByUserIdResult.h"

namespace Gs2::SkillTree::Task::WebSocket
{
    class GS2SKILLTREE_API FGetStatusByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FGetStatusByUserIdResult>
    {
