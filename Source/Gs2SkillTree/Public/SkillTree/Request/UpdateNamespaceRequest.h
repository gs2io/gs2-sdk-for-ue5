...
namespace Gs2::SkillTree::Request
{
    ...
    class GS2SKILLTREE_API FUpdateNamespaceRequest final : public TSharedFromThis<FUpdateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FUpdateNamespaceRequest> WithReleaseScript(const TSharedPtr<Model::FScriptSetting> ReleaseScript);
        TSharedPtr<FUpdateNamespaceRequest> WithRestrainScript(const TSharedPtr<Model::FScriptSetting> RestrainScript);
