...
namespace Gs2::SkillTree::Request
{
    ...
    public:
        ...
        TSharedPtr<FUpdateCurrentTreeMasterRequest> WithMode(const TOptional<FString> Mode);
        TSharedPtr<FUpdateCurrentTreeMasterRequest> WithSettings(const TOptional<FString> Settings);
        TSharedPtr<FUpdateCurrentTreeMasterRequest> WithUploadToken(const TOptional<FString> UploadToken);
    ...
    typedef TSharedPtr<FUpdateCurrentTreeMasterRequest> FUpdateCurrentTreeMasterRequestPtr;
}