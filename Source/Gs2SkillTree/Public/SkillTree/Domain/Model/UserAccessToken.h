...
namespace Gs2::SkillTree::Domain::Model
{
    ...
    public:
        ...
        Gs2::SkillTree::Domain::Iterator::FDescribeStatusesIteratorPtr Statuses(
        ) const;
        ...
        public:
            FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback);
