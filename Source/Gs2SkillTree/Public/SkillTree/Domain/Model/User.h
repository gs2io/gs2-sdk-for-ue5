...
namespace Gs2::SkillTree::Domain::Model
{
    ...
    public:
        ...
        Gs2::Core::Domain::CallbackID SubscribeStatuses(
            TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback,const TOptional<FString> TimeOffsetToken = TOptional<FString>()
        );

        void InvalidateStatuses(const TOptional<FString> TimeOffsetToken = TOptional<FString>());

        class GS2SKILLTREE_API FSubscribeStatusesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeStatusesWithInitialCallTask>
        {
            const TSharedPtr<FUserDomain> Self;
            const TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback;
        const TOptional<FString> QueryTimeOffsetToken;
        public:
            FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback,const TOptional<FString> TimeOffsetToken);
