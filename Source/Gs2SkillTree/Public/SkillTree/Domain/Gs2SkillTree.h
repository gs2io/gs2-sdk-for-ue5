...
namespace Gs2::SkillTree::Domain
{
    ...
    public:
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::SkillTree::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2SKILLTREE_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2SkillTreeDomain> Self;
            const TFunction<void(TArray<Gs2::SkillTree::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2SkillTreeDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
