...
namespace Gs2::SkillTree::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SkillTree::Model::FStatus>> Result) override;
        ...
        class GS2SKILLTREE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::SkillTree::Model::FStatusPtr>> Range;
            TOptional<TArray<Gs2::SkillTree::Model::FStatusPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SkillTree::Model::FStatusPtr& Current()
            {
