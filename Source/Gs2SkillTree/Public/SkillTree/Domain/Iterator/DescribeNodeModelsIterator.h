...
namespace Gs2::SkillTree::Domain::Iterator
{
    ...
    class GS2SKILLTREE_API FDescribeNodeModelsIterator :
        public TSharedFromThis<FDescribeNodeModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SkillTree::Model::FNodeModel>> Result) override;
        ...
        class GS2SKILLTREE_API FIterator
        {
            TSharedRef<FDescribeNodeModelsIterator> Self;
            TSharedPtr<TArray<Gs2::SkillTree::Model::FNodeModelPtr>> Range;
            TOptional<TArray<Gs2::SkillTree::Model::FNodeModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SkillTree::Model::FNodeModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeNodeModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeNodeModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeNodeModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeNodeModelsIterator> FDescribeNodeModelsIteratorPtr;
}
