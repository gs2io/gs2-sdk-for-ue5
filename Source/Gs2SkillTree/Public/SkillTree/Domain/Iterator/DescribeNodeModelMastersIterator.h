...
namespace Gs2::SkillTree::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SkillTree::Model::FNodeModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeNodeModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::SkillTree::Model::FNodeModelMasterPtr>> Range;
            TOptional<TArray<Gs2::SkillTree::Model::FNodeModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SkillTree::Model::FNodeModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeNodeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeNodeModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeNodeModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeNodeModelMastersIterator> FDescribeNodeModelMastersIteratorPtr;
}
