...
namespace Gs2::SkillTree::Domain::Iterator
{
    ...
    class GS2SKILLTREE_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SkillTree::Model::FNamespace>> Result) override;
        ...
        class GS2SKILLTREE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::SkillTree::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::SkillTree::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SkillTree::Model::FNamespacePtr& Current()
            {
