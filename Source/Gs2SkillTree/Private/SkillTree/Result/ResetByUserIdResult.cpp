...
#include "SkillTree/Result/ResetByUserIdResult.h"
...
namespace Gs2::SkillTree::Result
{
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithItem(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FResetByUserIdResult> FResetByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FStatus> FResetByUserIdResult::GetItem() const
    {
    ...
    TOptional<FString> FResetByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FResetByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FResetByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FResetByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FResetByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FResetByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FResetByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FResetByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FResetByUserIdResult::GetTransactionResult() const
    {
