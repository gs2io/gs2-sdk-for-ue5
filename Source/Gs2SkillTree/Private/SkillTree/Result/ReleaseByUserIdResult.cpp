...
#include "SkillTree/Result/ReleaseByUserIdResult.h"

namespace Gs2::SkillTree::Result
{
    FReleaseByUserIdResult::FReleaseByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithItem(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FStatus> FReleaseByUserIdResult::GetItem() const
    {
    ...
    TOptional<FString> FReleaseByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FReleaseByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FReleaseByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FReleaseByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FReleaseByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FReleaseByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReleaseByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReleaseByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReleaseByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FReleaseByUserIdResult> FReleaseByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FReleaseByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FReleaseByUserIdResult::ToJson() const
    {
