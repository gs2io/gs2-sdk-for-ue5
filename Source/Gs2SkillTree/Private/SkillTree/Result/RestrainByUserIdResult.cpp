...
{
    FRestrainByUserIdResult::FRestrainByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithItem(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FStatus> FRestrainByUserIdResult::GetItem() const
    {
    ...
    TOptional<FString> FRestrainByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FRestrainByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FRestrainByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FRestrainByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FRestrainByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FRestrainByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FRestrainByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FRestrainByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FRestrainByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FRestrainByUserIdResult> FRestrainByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FRestrainByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FRestrainByUserIdResult::ToJson() const
    {
