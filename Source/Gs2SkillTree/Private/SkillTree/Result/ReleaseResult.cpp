...
namespace Gs2::SkillTree::Result
{
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithItem(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithTransactionId(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithStampSheet(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithAtomicCommit(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithTransaction(
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FStatus> FReleaseResult::GetItem() const
    {
    ...
    TOptional<FString> FReleaseResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FReleaseResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FReleaseResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FReleaseResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FReleaseResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FReleaseResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReleaseResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReleaseResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReleaseResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FReleaseResult> FReleaseResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FReleaseResult>()
    ...
    TSharedPtr<FJsonObject> FReleaseResult::ToJson() const
    {
