...
namespace Gs2::SkillTree::Result
{
    ...
    TSharedPtr<FRestrainResult> FRestrainResult::WithAtomicCommit(
    ...
    TSharedPtr<FRestrainResult> FRestrainResult::WithTransaction(
    ...
    TSharedPtr<FRestrainResult> FRestrainResult::WithTransactionResult(
    ...
    TOptional<bool> FRestrainResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FRestrainResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FRestrainResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FRestrainResult::GetTransactionResult() const
    {
