...
#include "SkillTree/Model/Namespace.h"
...
namespace Gs2::SkillTree::Model
{
    ...
    TSharedPtr<FNamespace> FNamespace::WithReleaseScript(
        const TSharedPtr<FScriptSetting> ReleaseScript
    )
    {
    ...
    TSharedPtr<FNamespace> FNamespace::WithRestrainScript(
        const TSharedPtr<FScriptSetting> RestrainScript
    )
    {
    ...
    TSharedPtr<FScriptSetting> FNamespace::GetReleaseScript() const
    {
        return ReleaseScriptValue;
    }
    TSharedPtr<FScriptSetting> FNamespace::GetRestrainScript() const
    {
    ...
    TSharedPtr<FJsonObject> FNamespace::ToJson() const
    {
        ...
        {
            JsonRootObject->SetObjectField(TEXT("releaseScript"), ReleaseScriptValue->ToJson());
        }
        if (RestrainScriptValue != nullptr && RestrainScriptValue.IsValid())
        {
            JsonRootObject->SetObjectField(TEXT("restrainScript"), RestrainScriptValue->ToJson());
        }
...
namespace Gs2::SkillTree::Model::Cache
{
    ...
    bool FNamespaceCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::SkillTree::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::SkillTree::Model::FNamespacePtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::SkillTree::Model::FNamespace>(
    ...
    void FNamespaceCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::SkillTree::Model::FNamespacePtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::SkillTree::Model::FNamespacePtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::SkillTree::Model::FNamespace>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::SkillTree::Model::FNamespace::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    FString FNamespaceCache::PutUserData(
        ...
        const Gs2::SkillTree::Model::FNamespacePtr& Item
    )
    {
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::SkillTree::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentNamespaceName
        ));
    ...
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentNamespaceName,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::SkillTree::Model::FNamespacePtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::SkillTree::Model::FNamespacePtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::SkillTree::Model::FNamespacePtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FNamespaceCache::ListSubscribe(
        const Gs2::Core::Domain::FCacheDatabasePtr& CacheOwnerArgumentCache,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::SkillTree::Model::FNamespacePtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::SkillTree::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::SkillTree::Model::FNamespacePtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::SkillTree::Model::FNamespace>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::SkillTree::Model::FNamespace::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentTimeOffset
