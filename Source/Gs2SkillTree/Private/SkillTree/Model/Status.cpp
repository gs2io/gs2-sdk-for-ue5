...
namespace Gs2::SkillTree::Model
{
    ...
    TSharedPtr<FStatus> FStatus::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        ...
        return MakeShared<FStatus>()
            ...
            ->WithReleasedNodeNames(Data->HasField(ANSI_TO_TCHAR("releasedNodeNames")) ? [Data]() -> TSharedPtr<TArray<FString>>
                {
                    auto v = MakeShared<TArray<FString>>();
                    if (!Data->HasTypedField<EJson::Null>(ANSI_TO_TCHAR("releasedNodeNames")) && Data->HasTypedField<EJson::Array>(ANSI_TO_TCHAR("releasedNodeNames")))
                    {
                        for (auto JsonObjectValue : Data->GetArrayField(ANSI_TO_TCHAR("releasedNodeNames")))
                        {
...
namespace Gs2::SkillTree::Model::Cache
{
    ...
    bool FStatusCache::TryGet(
        ...
        TOptional<FString> CacheOwnerArgumentPropertyId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        Gs2::SkillTree::Model::FStatusPtr* CacheOwnerArgumentOutItem
    )
    {
        ...
        Gs2::SkillTree::Model::FStatusPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::SkillTree::Model::FStatus>(
    ...
    void FStatusCache::Put(
        ...
        TOptional<FString> CacheOwnerArgumentPropertyId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const Gs2::SkillTree::Model::FStatusPtr& CacheOwnerArgumentItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::SkillTree::Model::FStatusPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::SkillTree::Model::FStatus>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::SkillTree::Model::FStatus::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    )
    {
        ...
        if (!CacheSnapshot.IsValid()) return;
        if (!CacheOwnerArgumentUserId.IsSet()) return;
        CacheSnapshot->Delete(Gs2::SkillTree::Model::FStatus::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FStatusCache::Fetch(
        ...
        TOptional<FString> CacheOwnerArgumentPropertyId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        const TFunction<Gs2::Core::Model::FGs2ErrorPtr(Gs2::SkillTree::Model::FStatusPtr*)>& CacheOwnerArgumentFetchImpl,
        Gs2::SkillTree::Model::FStatusPtr* CacheOwnerArgumentOutItem
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        ...
        Gs2::SkillTree::Model::FStatusPtr CacheOwnerFetchedItem;
    ...
    Gs2::Core::Domain::CallbackID FStatusCache::ListSubscribe(
        ...
        TOptional<FString> CacheOwnerArgumentUserId,
        TOptional<int32> CacheOwnerArgumentTimeOffset,
        TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> CacheOwnerArgumentCallback
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return 0;
        return CacheSnapshot->ListSubscribeTyped(Gs2::SkillTree::Model::FStatus::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::SkillTree::Model::FStatusPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::SkillTree::Model::FStatus>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::SkillTree::Model::FStatus::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentUserId,
            CacheOwnerArgumentTimeOffset
