...
#include "SkillTree/Task/Rest/RestrainByUserIdTask.h"
...
{
    FRestrainByUserIdTask::FRestrainByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FRestrainByUserIdTask::Action(
        const TSharedPtr<Result::FRestrainByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/{propertyId}/node/restrain");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRestrainByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
