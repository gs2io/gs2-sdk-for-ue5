...
#include "SkillTree/Task/Rest/ReleaseByUserIdTask.h"
...
{
    FReleaseByUserIdTask::FReleaseByUserIdTask(
    ...
    FReleaseByUserIdTask::FReleaseByUserIdTask(
        const FReleaseByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FReleaseByUserIdTask::Action(
        const TSharedPtr<Result::FReleaseByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/status/{propertyId}/node/release");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReleaseByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
