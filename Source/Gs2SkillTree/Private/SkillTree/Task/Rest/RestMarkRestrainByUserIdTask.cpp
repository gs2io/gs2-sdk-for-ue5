...
#include "SkillTree/Task/Rest/MarkRestrainByUserIdTask.h"
...
{
    FMarkRestrainByUserIdTask::FMarkRestrainByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FMarkRestrainByUserIdTask::Action(
        const TSharedPtr<Result::FMarkRestrainByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FMarkRestrainByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
