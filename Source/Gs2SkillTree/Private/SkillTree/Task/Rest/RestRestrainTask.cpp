...
#include "SkillTree/Task/Rest/RestrainTask.h"
...
namespace Gs2::SkillTree::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FRestrainTask::Action(
        const TSharedPtr<Result::FRestrainResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/{propertyId}/node/restrain");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRestrainResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
