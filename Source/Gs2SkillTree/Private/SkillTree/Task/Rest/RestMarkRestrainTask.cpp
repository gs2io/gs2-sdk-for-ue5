...
#include "SkillTree/Task/Rest/MarkRestrainTask.h"
...
{
    FMarkRestrainTask::FMarkRestrainTask(
    ...
    Core::Model::FGs2ErrorPtr FMarkRestrainTask::Action(
        const TSharedPtr<Result::FMarkRestrainResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/{propertyId}/node/restrain/mark");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FMarkRestrainResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
