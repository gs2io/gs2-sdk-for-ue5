...
#include "SkillTree/Task/Rest/ReleaseTask.h"
...
namespace Gs2::SkillTree::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FReleaseTask::Action(
        const TSharedPtr<Result::FReleaseResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/status/{propertyId}/node/release");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReleaseResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
