...
#include "SkillTree/Task/Rest/CreateNamespaceTask.h"
...
namespace Gs2::SkillTree::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetReleaseScript() != nullptr && this->Request->GetReleaseScript().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("releaseScript"), this->Request->GetReleaseScript()->ToJson());
            }
            if (this->Request->GetRestrainScript() != nullptr && this->Request->GetRestrainScript().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("restrainScript"), this->Request->GetRestrainScript()->ToJson());
            }
