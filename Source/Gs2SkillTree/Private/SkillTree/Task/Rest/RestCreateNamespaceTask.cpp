...
namespace Gs2::SkillTree::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetObjectField("releaseScript", this->Request->GetReleaseScript()->ToJson());
            }
            if (this->Request->GetRestrainScript() != nullptr && this->Request->GetRestrainScript().IsValid())
            {
                JsonRootObject->SetObjectField("restrainScript", this->Request->GetRestrainScript()->ToJson());
            }
