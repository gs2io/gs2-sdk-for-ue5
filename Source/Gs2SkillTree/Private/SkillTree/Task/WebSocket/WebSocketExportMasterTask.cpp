...
#include "SkillTree/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::SkillTree::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("skillTree"), TEXT("currentTreeMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
