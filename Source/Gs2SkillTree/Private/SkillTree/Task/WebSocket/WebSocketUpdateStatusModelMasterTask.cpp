...
#include "SkillTree/Task/WebSocket/UpdateStatusModelMasterTask.h"
...
namespace Gs2::SkillTree::Task::WebSocket
{
    ...
    )
    {
        ...
        RequestPayload->AddHeader(
            ...
            "skillTree",
            "nodeModelMaster",
            "updateStatusModelMaster"
        );
        Session->Send(RequestPayload);

        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("skillTree"), TEXT("nodeModelMaster"), TEXT("updateStatusModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateStatusModelMasterResult::FromJson(WebSocketResult->Body());
