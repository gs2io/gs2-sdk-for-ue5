...
namespace Gs2::SkillTree::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FMarkRestrainByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
            ...
            auto Request = Request::FMarkRestrainByUserIdRequest::FromJson(RequestModelJson);
            Request = FMarkRestrainByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FMarkRestrainByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
