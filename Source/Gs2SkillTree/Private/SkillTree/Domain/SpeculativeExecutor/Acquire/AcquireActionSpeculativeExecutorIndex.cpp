...
namespace Gs2::SkillTree::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FMarkReleaseByUserIdSpeculativeExecutor::Action() == NewAcquireAction->GetAction()) {
            ...
            auto Request = Request::FMarkReleaseByUserIdRequest::FromJson(RequestModelJson);
            Request = FMarkReleaseByUserIdSpeculativeExecutor::Rate(Request, Rate);
            auto Future = FMarkReleaseByUserIdSpeculativeExecutor::Execute(
                Domain,
                Service,
                AccessToken,
                Request
