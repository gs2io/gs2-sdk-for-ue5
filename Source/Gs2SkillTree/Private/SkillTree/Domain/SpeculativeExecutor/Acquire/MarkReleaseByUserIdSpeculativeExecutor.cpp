...
Gs2::Core::Model::FGs2ErrorPtr FMarkReleaseByUserIdSpeculativeExecutor::Transform(
    ...
    const Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr&,
...
FMarkReleaseByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(const FCommitTask& From):
...
)
{
    *Result = nullptr;
    ...
    Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr Prepared = nullptr;
    if (Request.IsValid()) Prepared = MakeShared<Gs2::SkillTree::Request::FMarkReleaseByUserIdRequest>(*Request);
    ...
    const auto Commit = FStatusSpeculativeCommit::Create(
        ...
        [RequestedNames](const Gs2::SkillTree::Model::FStatusPtr& Source)
        {
            ...
            const auto Names = MakeShared<TArray<FString>>(*Source->GetReleasedNodeNames());
            for (const auto& Requested : *RequestedNames)
            {
                if (Names->Contains(Requested)) return Gs2::SkillTree::Model::FStatusPtr();
                Names->Add(Requested);
            }
...
Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr FMarkReleaseByUserIdSpeculativeExecutor::Rate(
    const Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr& Request, const double)
{ return Request; }

Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr FMarkReleaseByUserIdSpeculativeExecutor::Rate(
    const Gs2::SkillTree::Request::FMarkReleaseByUserIdRequestPtr& Request, TBigInt<1024, false>)
{ return Request; }
}
