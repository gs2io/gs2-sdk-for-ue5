...
namespace Gs2::SkillTree::Domain::Model
{
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::SkillTree::Model::Cache::FStatusCache::CreateCacheParentKey(
                NamespaceName,
                UserId,
                TOptional<int32>()
            ),
    ...
    class FUserDomain::FCollectStatusesTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::SkillTree::Model::FStatusPtr>>, public TSharedFromThis<FCollectStatusesTask>
    {
        const TSharedPtr<FUserDomain> Self;
        const TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> OnCollected;
    const TOptional<FString> QueryTimeOffsetToken;
    public:
        explicit FCollectStatusesTask(const TSharedPtr<FUserDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> OnCollected,const TOptional<FString> TimeOffsetToken) : Self(Self), OnCollected(OnCollected), QueryTimeOffsetToken(TimeOffsetToken) {}
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::SkillTree::Model::FStatusPtr>>> Result) override
        {
            TArray<Gs2::SkillTree::Model::FStatusPtr> Items;
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::SkillTree::Model::FStatusPtr>>(Items);
    ...
    Gs2::Core::Domain::CallbackID FUserDomain::SubscribeStatuses(
        TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback,const TOptional<FString> TimeOffsetToken
    )
    {
        ...
        const auto Parent = Gs2::SkillTree::Model::Cache::FStatusCache::CreateCacheParentKey(
        NamespaceName,
        UserId,
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [Callback, WeakGs2](const TArray<FGs2ObjectPtr>& Values)
            {
                ...
                TArray<Gs2::SkillTree::Model::FStatusPtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::SkillTree::Model::FStatus>(Value));
    ...
    FUserDomain::FSubscribeStatusesWithInitialCallTask::FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback,const TOptional<FString> TimeOffsetToken) : Self(Self), Callback(Callback), QueryTimeOffsetToken(TimeOffsetToken) {}
    ...
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectStatusesTask>>(Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)>(), QueryTimeOffsetToken);
    ...
    TSharedPtr<FAsyncTask<FUserDomain::FSubscribeStatusesWithInitialCallTask>> FUserDomain::SubscribeStatusesWithInitialCall(TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback,const TOptional<FString> TimeOffsetToken)
    {
