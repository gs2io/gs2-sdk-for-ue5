...
namespace Gs2::SkillTree::Domain::Model
{
    ...
    class FUserAccessTokenDomain::FCollectStatusesTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::SkillTree::Model::FStatusPtr>>, public TSharedFromThis<FCollectStatusesTask>
    {
        const TSharedPtr<FUserAccessTokenDomain> Self;
        const TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> OnCollected;

    public:
        explicit FCollectStatusesTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> OnCollected) : Self(Self), OnCollected(OnCollected) {}
    ...
    Gs2::Core::Domain::CallbackID FUserAccessTokenDomain::SubscribeStatuses(
        TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback
    )
    {
    ...
    FUserAccessTokenDomain::FSubscribeStatusesWithInitialCallTask::FSubscribeStatusesWithInitialCallTask(const TSharedPtr<FUserAccessTokenDomain>& Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback) : Self(Self), Callback(Callback) {}
    ...
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectStatusesTask>>(Self, TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)>());
    ...
    TSharedPtr<FAsyncTask<FUserAccessTokenDomain::FSubscribeStatusesWithInitialCallTask>> FUserAccessTokenDomain::SubscribeStatusesWithInitialCall(TFunction<void(TArray<Gs2::SkillTree::Model::FStatusPtr>)> Callback)
    {
