...
namespace Gs2::SkillTree::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            if (ResultModel->GetItem() != nullptr)
            {
                ...
                Self->Cache->Delete(Gs2::SkillTree::Model::FNodeModelMaster::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        ...
        auto bCacheHit = Self->Cache->TryGet<Gs2::SkillTree::Model::FNodeModelMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Cache->TryGet<Gs2::SkillTree::Model::FNodeModelMaster>(
                Self->ParentKey,
                Gs2::SkillTree::Domain::Model::FNodeModelMasterDomain::CreateCacheKey(
                    Self->NodeModelName
                ),
