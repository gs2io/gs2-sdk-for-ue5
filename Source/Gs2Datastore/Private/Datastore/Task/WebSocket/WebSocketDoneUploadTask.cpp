...
#include "Datastore/Task/WebSocket/DoneUploadTask.h"
...
{
    FDoneUploadTask::FDoneUploadTask(
    ...
    Core::Model::FGs2ErrorPtr FDoneUploadTask::Action(
        const TSharedPtr<Result::FDoneUploadResultPtr> Result
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("datastore"), TEXT("dataObject"), TEXT("doneUpload"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDoneUploadResult::FromJson(WebSocketResult->Body());
