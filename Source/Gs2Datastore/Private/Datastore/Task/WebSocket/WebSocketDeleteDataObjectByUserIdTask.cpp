...
#include "Datastore/Task/WebSocket/DeleteDataObjectByUserIdTask.h"
...
{
    FDeleteDataObjectByUserIdTask::FDeleteDataObjectByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteDataObjectByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteDataObjectByUserIdResultPtr> Result
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("datastore"), TEXT("dataObject"), TEXT("deleteDataObjectByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FDeleteDataObjectByUserIdResult::FromJson(WebSocketResult->Body());
