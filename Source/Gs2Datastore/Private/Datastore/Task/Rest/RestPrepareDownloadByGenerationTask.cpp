...
#include "Datastore/Task/Rest/PrepareDownloadByGenerationTask.h"
...
{
    FPrepareDownloadByGenerationTask::FPrepareDownloadByGenerationTask(
    ...
    Core::Model::FGs2ErrorPtr FPrepareDownloadByGenerationTask::Action(
        const TSharedPtr<Result::FPrepareDownloadByGenerationResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/file/generation/{generation}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPrepareDownloadByGenerationResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
