...
#include "Datastore/Task/Rest/DescribeDataObjectsTask.h"
...
{
    FDescribeDataObjectsTask::FDescribeDataObjectsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeDataObjectsTask::Action(
        const TSharedPtr<Result::FDescribeDataObjectsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/data");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeDataObjectsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
