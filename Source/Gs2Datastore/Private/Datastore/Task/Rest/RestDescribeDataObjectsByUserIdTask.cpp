...
#include "Datastore/Task/Rest/DescribeDataObjectsByUserIdTask.h"
...
{
    FDescribeDataObjectsByUserIdTask::FDescribeDataObjectsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeDataObjectsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeDataObjectsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/data");
            ...
            if (this->Request->GetStatus().IsSet()) {
                queryStrings.Add("status=" + FGenericPlatformHttp::UrlEncode(this->Request->GetStatus().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeDataObjectsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
