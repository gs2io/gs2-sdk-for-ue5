...
#include "Datastore/Task/Rest/UpdateNamespaceTask.h"
...
namespace Gs2::Datastore::Task::Rest
{
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            if (this->Request->GetDoneUploadScript() != nullptr && this->Request->GetDoneUploadScript().IsValid())
            {
                JsonRootObject->SetObjectField(TEXT("doneUploadScript"), this->Request->GetDoneUploadScript()->ToJson());
            }
