...
#include "Datastore/Task/Rest/GetDataObjectHistoryByUserIdTask.h"
...
{
    FGetDataObjectHistoryByUserIdTask::FGetDataObjectHistoryByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetDataObjectHistoryByUserIdTask::Action(
        const TSharedPtr<Result::FGetDataObjectHistoryByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/data/{dataObjectName}/history/{generation}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDataObjectHistoryByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
