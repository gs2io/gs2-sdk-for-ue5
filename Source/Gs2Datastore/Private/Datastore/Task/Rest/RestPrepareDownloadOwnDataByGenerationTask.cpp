...
#include "Datastore/Task/Rest/PrepareDownloadOwnDataByGenerationTask.h"
...
{
    FPrepareDownloadOwnDataByGenerationTask::FPrepareDownloadOwnDataByGenerationTask(
    ...
    Core::Model::FGs2ErrorPtr FPrepareDownloadOwnDataByGenerationTask::Action(
        const TSharedPtr<Result::FPrepareDownloadOwnDataByGenerationResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/data/{dataObjectName}/generation/{generation}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPrepareDownloadOwnDataByGenerationResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
