...
#include "Datastore/Task/Rest/PrepareDownloadByUserIdAndDataObjectNameAndGenerationTask.h"
...
{
    FPrepareDownloadByUserIdAndDataObjectNameAndGenerationTask::FPrepareDownloadByUserIdAndDataObjectNameAndGenerationTask(
    ...
    Core::Model::FGs2ErrorPtr FPrepareDownloadByUserIdAndDataObjectNameAndGenerationTask::Action(
        const TSharedPtr<Result::FPrepareDownloadByUserIdAndDataObjectNameAndGenerationResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/data/{dataObjectName}/generation/{generation}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPrepareDownloadByUserIdAndDataObjectNameAndGenerationResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
