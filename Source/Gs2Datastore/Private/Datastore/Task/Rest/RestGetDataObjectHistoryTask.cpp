...
#include "Datastore/Task/Rest/GetDataObjectHistoryTask.h"
...
{
    FGetDataObjectHistoryTask::FGetDataObjectHistoryTask(
    ...
    FGetDataObjectHistoryTask::FGetDataObjectHistoryTask(
        const FGetDataObjectHistoryTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetDataObjectHistoryTask::Action(
        const TSharedPtr<Result::FGetDataObjectHistoryResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/data/{dataObjectName}/history/{generation}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDataObjectHistoryResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
