...
namespace Gs2::Datastore::Request
{
    ...
    TSharedPtr<FPrepareDownloadByUserIdRequest> FPrepareDownloadByUserIdRequest::WithTimeOffsetToken(
    ...
    TOptional<FString> FPrepareDownloadByUserIdRequest::GetTimeOffsetToken() const
    {
