...
namespace Gs2::Datastore::Domain
{
    ...
    )
    {
        ...
        Gs2::Datastore::Model::Cache::FNamespaceCache::Put(
            Self->Gs2->Cache,
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            ...
            Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheParentKey(
                TOptional<int32>()
            ),
            Callback,
            Callback
    ...
    class FGs2DatastoreDomain::FCollectNamespacesTask : public Gs2::Core::Util::TGs2Future<TArray<Gs2::Datastore::Model::FNamespacePtr>>, public TSharedFromThis<FCollectNamespacesTask>
    {
        const TSharedPtr<FGs2DatastoreDomain> Self;
        const TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> OnCollected;
    const TOptional<FString> QueryNamePrefix;
    public:
        explicit FCollectNamespacesTask(const TSharedPtr<FGs2DatastoreDomain>& Self, TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> OnCollected,const TOptional<FString> NamePrefix) : Self(Self), OnCollected(OnCollected), QueryNamePrefix(NamePrefix) {}
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<TArray<Gs2::Datastore::Model::FNamespacePtr>>> Result) override
        {
            TArray<Gs2::Datastore::Model::FNamespacePtr> Items;
            ...
            if (Iterator.IsError()) return Iterator.Error();
            *Result = MakeShared<TArray<Gs2::Datastore::Model::FNamespacePtr>>(Items);
    ...
    Gs2::Core::Domain::CallbackID FGs2DatastoreDomain::SubscribeNamespaces(
        TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix
    )
    {
        const TWeakPtr<Gs2::Core::Domain::FGs2> WeakGs2 = this->Gs2;
        const auto QueryNamePrefix = NamePrefix;
        const auto Parent = Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheParentKey(
        TOptional<int32>()
    );
        return Gs2->Cache->ListSubscribeTyped(
            ...
            [Callback, WeakGs2](const TArray<FGs2ObjectPtr>& Values)
            {
                ...
                TArray<Gs2::Datastore::Model::FNamespacePtr> TypedValues;
                for (const auto& Value : Values) if (Value.IsValid()) TypedValues.Add(StaticCastSharedPtr<Gs2::Datastore::Model::FNamespace>(Value));
            ...
            [WeakGs2, Callback, QueryNamePrefix]()
            {
                ...
                const auto Domain = MakeShared<FGs2DatastoreDomain>(Owner);
    ...
    void FGs2DatastoreDomain::InvalidateNamespaces(const TOptional<FString> NamePrefix)
    {
    ...
    FGs2DatastoreDomain::FSubscribeNamespacesWithInitialCallTask::FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2DatastoreDomain>& Self, TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix) : Self(Self), Callback(Callback), QueryNamePrefix(NamePrefix) {}
    FGs2DatastoreDomain::FSubscribeNamespacesWithInitialCallTask::FSubscribeNamespacesWithInitialCallTask(const FSubscribeNamespacesWithInitialCallTask& From) : TGs2Future(From), Self(From.Self), Callback(From.Callback), QueryNamePrefix(From.QueryNamePrefix) {}
    Gs2::Core::Model::FGs2ErrorPtr FGs2DatastoreDomain::FSubscribeNamespacesWithInitialCallTask::Action(TSharedPtr<TSharedPtr<Gs2::Core::Domain::CallbackID>> Result)
    {
        const auto Task = Gs2::Core::Util::New<FAsyncTask<FCollectNamespacesTask>>(Self, TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)>(), QueryNamePrefix);
    ...
    TSharedPtr<FAsyncTask<FGs2DatastoreDomain::FSubscribeNamespacesWithInitialCallTask>> FGs2DatastoreDomain::SubscribeNamespacesWithInitialCall(TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix)
    {
