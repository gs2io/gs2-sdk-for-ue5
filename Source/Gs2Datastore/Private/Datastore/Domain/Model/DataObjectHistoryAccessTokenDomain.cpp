...
namespace Gs2::Datastore::Domain::Model
{
    ...
    void FDataObjectHistoryAccessTokenDomain::Invalidate()
    {
    ...
    FDataObjectHistoryAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FDataObjectHistoryAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDataObjectHistoryAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FDataObjectHistoryAccessTokenDomain::FSubscribeWithInitialCallTask>> FDataObjectHistoryAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Datastore::Model::FDataObjectHistoryPtr)> Callback
    )
    {
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryDataObjectName, QueryGeneration, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FDataObjectHistoryAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot,
