...
namespace Gs2::Datastore::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Datastore::Model::Cache::FNamespaceCache::Delete(
            Self->Gs2->Cache,
    ...
    FNamespaceDomain::FRestoreDataObjectTask::FRestoreDataObjectTask(
        const TSharedPtr<FNamespaceDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FNamespaceDomain::FRestoreDataObjectTask::Action(
    ...
    )
    {
        Request
            ->WithContextStack((!Request->GetContextStack().IsSet() || Request->GetContextStack()->IsEmpty()) ? Self->Gs2->DefaultContextStack : Request->GetContextStack())
            ->WithNamespaceName(Self->NamespaceName);
        const auto Future = Self->Client->RestoreDataObject(
            Request
        );
        Future->StartSynchronousTask();
        if (Future->GetTask().IsError())
    ...
    TSharedPtr<FAsyncTask<FNamespaceDomain::FRestoreDataObjectTask>> FNamespaceDomain::RestoreDataObject(
        Request::FRestoreDataObjectRequestPtr Request
    ) {
        return Gs2::Core::Util::New<FAsyncTask<FRestoreDataObjectTask>>(this->AsShared(), Request);
    }

    TSharedPtr<Gs2::Datastore::Domain::Model::FUserDomain> FNamespaceDomain::User(
        const FString UserId
    )
    {
        return MakeShared<Gs2::Datastore::Domain::Model::FUserDomain>(
            Gs2,
            Service,
            NamespaceName,
    ...
    TSharedPtr<Gs2::Datastore::Domain::Model::FUserAccessTokenDomain> FNamespaceDomain::AccessToken(
        Gs2::Auth::Model::FAccessTokenPtr AccessToken
    )
    {
        return MakeShared<Gs2::Datastore::Domain::Model::FUserAccessTokenDomain>(
            Gs2,
            Service,
            NamespaceName,
            AccessToken
    ...
    {
        const auto CacheParentKey = Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Datastore::Model::FNamespacePtr Value;
                const auto CacheHit = Gs2::Datastore::Model::Cache::FNamespaceCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Datastore::Model::Cache::FNamespaceCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    TOptional<int32>(),
                    [Self](Gs2::Datastore::Model::FNamespacePtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
                        const auto Future = Self->Get(
                            MakeShared<Gs2::Datastore::Request::FGetNamespaceRequest>()
                        );
                        Future->StartSynchronousTask();
    ...
    {
        const auto SubscriptionParentKey = Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheParentKey(

            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Datastore::Model::Cache::FNamespaceCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            {
                Callback(StaticCastSharedPtr<Gs2::Datastore::Model::FNamespace>(obj));
            },
