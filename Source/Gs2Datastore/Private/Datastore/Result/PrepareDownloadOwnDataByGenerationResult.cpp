...
{
    FPrepareDownloadOwnDataByGenerationResult::FPrepareDownloadOwnDataByGenerationResult():
        ItemValue(nullptr),
    ...
    FPrepareDownloadOwnDataByGenerationResult::FPrepareDownloadOwnDataByGenerationResult(
        const FPrepareDownloadOwnDataByGenerationResult& From
    ):
    ...
    TSharedPtr<FPrepareDownloadOwnDataByGenerationResult> FPrepareDownloadOwnDataByGenerationResult::WithItem(
    ...
    TSharedPtr<FPrepareDownloadOwnDataByGenerationResult> FPrepareDownloadOwnDataByGenerationResult::WithFileUrl(
    ...
    TSharedPtr<FPrepareDownloadOwnDataByGenerationResult> FPrepareDownloadOwnDataByGenerationResult::WithContentLength(
    ...
    TSharedPtr<Model::FDataObject> FPrepareDownloadOwnDataByGenerationResult::GetItem() const
    {
    ...
    TOptional<FString> FPrepareDownloadOwnDataByGenerationResult::GetFileUrl() const
    {
        return FileUrlValue;
    }

    TOptional<int64> FPrepareDownloadOwnDataByGenerationResult::GetContentLength() const
    {
        return ContentLengthValue;
    }

    FString FPrepareDownloadOwnDataByGenerationResult::GetContentLengthString() const
    {
    ...
    TSharedPtr<FPrepareDownloadOwnDataByGenerationResult> FPrepareDownloadOwnDataByGenerationResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPrepareDownloadOwnDataByGenerationResult>()
    ...
    TSharedPtr<FJsonObject> FPrepareDownloadOwnDataByGenerationResult::ToJson() const
    {
