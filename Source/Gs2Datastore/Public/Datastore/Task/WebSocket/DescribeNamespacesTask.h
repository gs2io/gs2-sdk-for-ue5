...
#include "Datastore/Request/DescribeNamespacesRequest.h"
#include "Datastore/Result/DescribeNamespacesResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
