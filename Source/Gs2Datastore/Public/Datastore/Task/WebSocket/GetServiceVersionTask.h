...
#include "Datastore/Request/GetServiceVersionRequest.h"
#include "Datastore/Result/GetServiceVersionResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
