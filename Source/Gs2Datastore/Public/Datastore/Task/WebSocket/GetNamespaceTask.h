...
#include "Datastore/Request/GetNamespaceRequest.h"
#include "Datastore/Result/GetNamespaceResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
