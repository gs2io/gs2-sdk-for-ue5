...
#include "Datastore/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Datastore/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
