...
#include "Datastore/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Datastore/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
