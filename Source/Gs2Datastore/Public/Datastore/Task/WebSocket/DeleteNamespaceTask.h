...
#include "Datastore/Request/DeleteNamespaceRequest.h"
#include "Datastore/Result/DeleteNamespaceResult.h"

namespace Gs2::Datastore::Task::WebSocket
{
    class GS2DATASTORE_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
