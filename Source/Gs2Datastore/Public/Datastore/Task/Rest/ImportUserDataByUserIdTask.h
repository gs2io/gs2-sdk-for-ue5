...
#include "Datastore/Request/ImportUserDataByUserIdRequest.h"
#include "Datastore/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
