...
#include "Datastore/Request/DumpUserDataByUserIdRequest.h"
#include "Datastore/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
