...
#include "Datastore/Result/CreateNamespaceResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
