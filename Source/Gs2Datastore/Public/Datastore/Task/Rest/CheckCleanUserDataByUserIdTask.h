...
#include "Datastore/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Datastore/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
