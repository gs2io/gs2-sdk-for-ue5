...
#include "Datastore/Result/UpdateNamespaceResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
