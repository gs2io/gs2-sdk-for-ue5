...
#include "Datastore/Request/GetNamespaceStatusRequest.h"
#include "Datastore/Result/GetNamespaceStatusResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
