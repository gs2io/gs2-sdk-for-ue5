...
#include "Datastore/Request/CheckImportUserDataByUserIdRequest.h"
#include "Datastore/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Datastore::Task::Rest
{
    class GS2DATASTORE_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
