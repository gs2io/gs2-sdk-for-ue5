...
namespace Gs2::Datastore::Request
{
    ...
    typedef TSharedPtr<FPrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest, ESPMode::ThreadSafe> FPrepareDownloadByUserIdAndDataObjectNameAndGenerationRequestPtr;
}