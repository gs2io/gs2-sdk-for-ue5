...
namespace Gs2::Datastore::Error
{
    class GS2DATASTORE_API FInvalidStatusError : public Core::Model::FBadRequestError
    {
    public:
        inline static const FGs2ErrorType TypeString = "FInvalidStatusError";
    ...
    typedef TSharedPtr<FInvalidStatusError, ESPMode::ThreadSafe> FInvalidStatusErrorPtr;
}