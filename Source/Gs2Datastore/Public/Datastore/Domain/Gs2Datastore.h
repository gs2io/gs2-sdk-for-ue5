...
namespace Gs2::Datastore::Domain
{
    ...
    public:
        ...
        class GS2DATASTORE_API FPrepareImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2DatastoreDomain>,
        ...
        class GS2DATASTORE_API FImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2DatastoreDomain>,
        ...
        class GS2DATASTORE_API FCheckImportUserDataTask final :
            public Gs2::Core::Util::TGs2Future<FGs2DatastoreDomain>,
        ...
        Gs2::Core::Domain::CallbackID SubscribeNamespaces(
            TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix = TOptional<FString>()
        );

        void InvalidateNamespaces(const TOptional<FString> NamePrefix = TOptional<FString>());

        class GS2DATASTORE_API FSubscribeNamespacesWithInitialCallTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Core::Domain::CallbackID>,
            public TSharedFromThis<FSubscribeNamespacesWithInitialCallTask>
        {
            const TSharedPtr<FGs2DatastoreDomain> Self;
            const TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback;
        const TOptional<FString> QueryNamePrefix;
        public:
            FSubscribeNamespacesWithInitialCallTask(const TSharedPtr<FGs2DatastoreDomain>& Self, TFunction<void(TArray<Gs2::Datastore::Model::FNamespacePtr>)> Callback,const TOptional<FString> NamePrefix);
