...
namespace Gs2::Datastore::Domain::Iterator
{
    ...
    class FDescribeDataObjectsIteratorLoadTask;

    class GS2DATASTORE_API FDescribeDataObjectsIterator :
        public Gs2::Core::Domain::Model::TGs2Iterator<Gs2::Datastore::Model::FDataObject, FDescribeDataObjectsIteratorLoadTask>
    {
        const Core::Domain::FCacheDatabasePtr Cache;
        const Gs2::Datastore::FGs2DatastoreRestClientPtr Client;

        friend FDescribeDataObjectsIteratorLoadTask;
        virtual TSharedPtr<FAsyncTask<FDescribeDataObjectsIteratorLoadTask>> Load() override;
...
public:
        ...
        {
            friend FDescribeDataObjectsIterator;
    ...
    {
        TSharedPtr<FDescribeDataObjectsIterator> Self;
