...
namespace Gs2::Datastore::Domain::Iterator
{
    ...
    class GS2DATASTORE_API FDescribeDataObjectsIterator :
        public TSharedFromThis<FDescribeDataObjectsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Datastore::Model::FDataObject>> Result) override;
        ...
        {
            TSharedRef<FDescribeDataObjectsIterator> Self;
            TSharedPtr<TArray<Gs2::Datastore::Model::FDataObjectPtr>> Range;
            TOptional<TArray<Gs2::Datastore::Model::FDataObjectPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDataObjectsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDataObjectsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDataObjectsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeDataObjectsIterator> FDescribeDataObjectsIteratorPtr;
}
