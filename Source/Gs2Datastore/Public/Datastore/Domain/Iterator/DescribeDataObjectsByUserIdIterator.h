...
namespace Gs2::Datastore::Domain::Iterator
{
    ...
    class GS2DATASTORE_API FDescribeDataObjectsByUserIdIterator :
        public TSharedFromThis<FDescribeDataObjectsByUserIdIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeDataObjectsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDataObjectsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDataObjectsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDataObjectsByUserIdIterator> Iterable)
            {
