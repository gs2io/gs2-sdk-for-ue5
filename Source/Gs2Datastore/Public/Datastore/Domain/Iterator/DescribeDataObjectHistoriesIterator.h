...
namespace Gs2::Datastore::Domain::Iterator
{
    ...
    class GS2DATASTORE_API FDescribeDataObjectHistoriesIterator :
        public TSharedFromThis<FDescribeDataObjectHistoriesIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeDataObjectHistoriesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeDataObjectHistoriesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeDataObjectHistoriesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeDataObjectHistoriesIterator> Iterable)
            {
