...
namespace Gs2::Datastore::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Datastore::Model::FNamespace>> Result) override;
        ...
        class GS2DATASTORE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Datastore::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Datastore::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
