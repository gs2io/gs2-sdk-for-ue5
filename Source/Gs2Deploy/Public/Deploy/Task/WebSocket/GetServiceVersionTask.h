...
#include "Deploy/Request/GetServiceVersionRequest.h"
#include "Deploy/Result/GetServiceVersionResult.h"

namespace Gs2::Deploy::Task::WebSocket
{
    class GS2DEPLOY_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
