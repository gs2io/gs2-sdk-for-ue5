...
{
    class GS2DEPLOY_API FDescribeOutputsTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeOutputsResult>
    {
    ...
    public:
        ...
        virtual Gs2::Core::Model::FGs2ErrorPtr Action(const TSharedPtr<Result::FDescribeOutputsResultPtr> Result) override;
    };
