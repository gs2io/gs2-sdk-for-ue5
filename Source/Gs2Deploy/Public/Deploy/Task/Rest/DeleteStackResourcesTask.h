...
{
    class GS2DEPLOY_API FDeleteStackResourcesTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteStackResourcesResult>
    {
        Core::Net::Rest::FGs2RestSessionPtr Session;
        Request::FDeleteStackResourcesRequestPtr Request;
    public:
        explicit FDeleteStackResourcesTask(
            const Core::Net::Rest::FGs2RestSessionPtr Session,
            const Request::FDeleteStackResourcesRequestPtr Request
        );
        FDeleteStackResourcesTask(
