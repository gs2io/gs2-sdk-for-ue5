...
namespace Gs2::Deploy::Domain::SpeculativeExecutor
{
    class GS2DEPLOY_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Deploy::Domain::FGs2DeployDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2DEPLOY_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Deploy::Domain::FGs2DeployDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2DEPLOY_API FCommitTask(
                const FCommitTask& From
            );

            GS2DEPLOY_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
