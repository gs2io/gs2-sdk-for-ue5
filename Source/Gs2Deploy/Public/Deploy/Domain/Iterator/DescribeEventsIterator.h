...
namespace Gs2::Deploy::Domain::Iterator
{
    ...
    class GS2DEPLOY_API FDescribeEventsIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Deploy::Model::FEvent>> Result) override;
        ...
        {
            TSharedRef<FDescribeEventsIterator> Self;
            TSharedPtr<TArray<Gs2::Deploy::Model::FEventPtr>> Range;
            TOptional<TArray<Gs2::Deploy::Model::FEventPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Deploy::Model::FEventPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeEventsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeEventsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeEventsIterator> Iterable)
            {
