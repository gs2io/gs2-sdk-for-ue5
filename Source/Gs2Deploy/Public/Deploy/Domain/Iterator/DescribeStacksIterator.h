...
namespace Gs2::Deploy::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Deploy::Model::FStack>> Result) override;
        ...
        {
            TSharedRef<FDescribeStacksIterator> Self;
            TSharedPtr<TArray<Gs2::Deploy::Model::FStackPtr>> Range;
            TOptional<TArray<Gs2::Deploy::Model::FStackPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStacksIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStacksIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStacksIterator> Iterable)
            {
