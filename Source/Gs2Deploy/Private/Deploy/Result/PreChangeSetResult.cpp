...
{
    FPreChangeSetResult::FPreChangeSetResult():
    ...
    FPreChangeSetResult::FPreChangeSetResult(
        const FPreChangeSetResult& From
    ):
    ...
    TSharedPtr<FPreChangeSetResult> FPreChangeSetResult::WithUploadToken(
    ...
    TSharedPtr<FPreChangeSetResult> FPreChangeSetResult::WithUploadUrl(
    ...
    TOptional<FString> FPreChangeSetResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreChangeSetResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreChangeSetResult> FPreChangeSetResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreChangeSetResult>()
    ...
    TSharedPtr<FJsonObject> FPreChangeSetResult::ToJson() const
    {
