...
{
    FPreUpdateStackResult::FPreUpdateStackResult():
    ...
    FPreUpdateStackResult::FPreUpdateStackResult(
        const FPreUpdateStackResult& From
    ):
    ...
    TSharedPtr<FPreUpdateStackResult> FPreUpdateStackResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateStackResult> FPreUpdateStackResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateStackResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateStackResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateStackResult> FPreUpdateStackResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateStackResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateStackResult::ToJson() const
    {
