...
{
    FPreCreateStackResult::FPreCreateStackResult():
    ...
    TSharedPtr<FPreCreateStackResult> FPreCreateStackResult::WithUploadToken(
    ...
    TSharedPtr<FPreCreateStackResult> FPreCreateStackResult::WithUploadUrl(
    ...
    TOptional<FString> FPreCreateStackResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreCreateStackResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreCreateStackResult> FPreCreateStackResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreCreateStackResult>()
    ...
    TSharedPtr<FJsonObject> FPreCreateStackResult::ToJson() const
    {
