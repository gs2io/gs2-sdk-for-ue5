...
namespace Gs2::Deploy::Request
{
    ...
    TSharedPtr<FDescribeEventsRequest> FDescribeEventsRequest::WithStackName(
    ...
    TSharedPtr<FDescribeEventsRequest> FDescribeEventsRequest::WithPageToken(
    ...
    TSharedPtr<FDescribeEventsRequest> FDescribeEventsRequest::WithLimit(
    ...
    TOptional<FString> FDescribeEventsRequest::GetStackName() const
    {
        return StackNameValue;
    }

    TOptional<FString> FDescribeEventsRequest::GetPageToken() const
    {
        return PageTokenValue;
    }

    TOptional<int32> FDescribeEventsRequest::GetLimit() const
    {
        return LimitValue;
    }

    FString FDescribeEventsRequest::GetLimitString() const
    {
        if (!LimitValue.IsSet())
        {
            return FString("null");
