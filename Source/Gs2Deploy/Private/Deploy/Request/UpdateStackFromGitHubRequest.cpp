...
{
    FUpdateStackFromGitHubRequest::FUpdateStackFromGitHubRequest():
    ...
    TSharedPtr<FUpdateStackFromGitHubRequest> FUpdateStackFromGitHubRequest::WithContextStack(
    ...
    TSharedPtr<FUpdateStackFromGitHubRequest> FUpdateStackFromGitHubRequest::WithStackName(
    ...
    TSharedPtr<FUpdateStackFromGitHubRequest> FUpdateStackFromGitHubRequest::WithDescription(
    ...
    TSharedPtr<FUpdateStackFromGitHubRequest> FUpdateStackFromGitHubRequest::WithCheckoutSetting(
    ...
    TOptional<FString> FUpdateStackFromGitHubRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FUpdateStackFromGitHubRequest::GetStackName() const
    {
        return StackNameValue;
    }

    TOptional<FString> FUpdateStackFromGitHubRequest::GetDescription() const
    {
        return DescriptionValue;
    }

    TSharedPtr<Model::FGitHubCheckoutSetting> FUpdateStackFromGitHubRequest::GetCheckoutSetting() const
    {
    ...
    TSharedPtr<FUpdateStackFromGitHubRequest> FUpdateStackFromGitHubRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FUpdateStackFromGitHubRequest>()
    ...
    TSharedPtr<FJsonObject> FUpdateStackFromGitHubRequest::ToJson() const
    {
