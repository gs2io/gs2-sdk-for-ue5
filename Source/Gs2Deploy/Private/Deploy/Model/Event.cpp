...
namespace Gs2::Deploy::Model::Cache
{
    ...
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::Deploy::Model::FEventPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::Deploy::Model::FEvent>(
    ...
    )
    {
        ...
        Gs2::Deploy::Model::FEventPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::Deploy::Model::FEvent>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::Deploy::Model::FEvent::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::Deploy::Model::FEvent::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentStackName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentEventName
    ...
    )
    {
        ...
        Gs2::Deploy::Model::FEventPtr CacheOwnerFetchedItem;
    ...
    )
    {
        ...
        return CacheSnapshot->ListSubscribeTyped(Gs2::Deploy::Model::FEvent::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentStackName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::Deploy::Model::FEventPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::Deploy::Model::FEvent>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::Deploy::Model::FEvent::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentStackName,
            CacheOwnerArgumentTimeOffset
