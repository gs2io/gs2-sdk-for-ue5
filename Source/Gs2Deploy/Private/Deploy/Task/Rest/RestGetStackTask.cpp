...
#include "Deploy/Task/Rest/GetStackTask.h"
...
namespace Gs2::Deploy::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetStackTask::Action(
        const TSharedPtr<Result::FGetStackResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStackResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
