...
#include "Deploy/Task/Rest/PreUpdateStackTask.h"
...
{
    FPreUpdateStackTask::FPreUpdateStackTask(
    ...
    Core::Model::FGs2ErrorPtr FPreUpdateStackTask::Action(
        const TSharedPtr<Result::FPreUpdateStackResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPreUpdateStackResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
