...
#include "Deploy/Task/Rest/UpdateStackTask.h"
...
{
    FUpdateStackTask::FUpdateStackTask(
    ...
    FUpdateStackTask::FUpdateStackTask(
        const FUpdateStackTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateStackTask::Action(
        const TSharedPtr<Result::FUpdateStackResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            {
                JsonRootObject->SetStringField(TEXT("template"), this->Request->GetTemplate().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateStackResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
