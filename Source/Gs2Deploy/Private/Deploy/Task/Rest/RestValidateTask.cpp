...
#include "Deploy/Task/Rest/ValidateTask.h"
...
namespace Gs2::Deploy::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FValidateTask::Action(
        const TSharedPtr<Result::FValidateResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FValidateResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
