...
#include "Deploy/Task/Rest/ForceDeleteStackTask.h"
...
{
    FForceDeleteStackTask::FForceDeleteStackTask(
    ...
    Core::Model::FGs2ErrorPtr FForceDeleteStackTask::Action(
        const TSharedPtr<Result::FForceDeleteStackResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FForceDeleteStackResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
