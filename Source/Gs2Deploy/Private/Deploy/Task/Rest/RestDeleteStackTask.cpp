...
#include "Deploy/Task/Rest/DeleteStackTask.h"
...
{
    FDeleteStackTask::FDeleteStackTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteStackTask::Action(
        const TSharedPtr<Result::FDeleteStackResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteStackResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
