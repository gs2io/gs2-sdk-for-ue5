...
#include "Deploy/Task/Rest/PreChangeSetTask.h"
...
{
    FPreChangeSetTask::FPreChangeSetTask(
    ...
    Core::Model::FGs2ErrorPtr FPreChangeSetTask::Action(
        const TSharedPtr<Result::FPreChangeSetResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPreChangeSetResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
