...
#include "Deploy/Task/Rest/DescribeEventsTask.h"
...
{
    FDescribeEventsTask::FDescribeEventsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeEventsTask::Action(
        const TSharedPtr<Result::FDescribeEventsResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeEventsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
