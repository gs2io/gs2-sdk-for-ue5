...
#include "Deploy/Task/Rest/DeleteStackEntityTask.h"
...
{
    FDeleteStackEntityTask::FDeleteStackEntityTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteStackEntityTask::Action(
        const TSharedPtr<Result::FDeleteStackEntityResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteStackEntityResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
