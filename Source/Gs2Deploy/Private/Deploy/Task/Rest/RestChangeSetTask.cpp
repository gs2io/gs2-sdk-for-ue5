...
#include "Deploy/Task/Rest/ChangeSetTask.h"
...
namespace Gs2::Deploy::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FChangeSetTask::Action(
        const TSharedPtr<Result::FChangeSetResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FChangeSetResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
