...
#include "Deploy/Task/Rest/DeleteStackResourcesTask.h"
...
{
    FDeleteStackResourcesTask::FDeleteStackResourcesTask(
    ...
    FDeleteStackResourcesTask::FDeleteStackResourcesTask(
        const FDeleteStackResourcesTask& From
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/stack/{stackName}/resources");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteStackResourcesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
