...
#include "Matchmaking/Task/WebSocket/UpdateCurrentModelMasterTask.h"
...
namespace Gs2::Matchmaking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("matchmaking"), TEXT("currentModelMaster"), TEXT("updateCurrentModelMaster"), ToCStr(RequestPayload->Payload()));
