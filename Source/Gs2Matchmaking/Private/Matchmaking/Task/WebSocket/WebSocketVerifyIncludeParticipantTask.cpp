...
#include "Matchmaking/Task/WebSocket/VerifyIncludeParticipantTask.h"
...
namespace Gs2::Matchmaking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("matchmaking"), TEXT("seasonGathering"), TEXT("verifyIncludeParticipant"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FVerifyIncludeParticipantResult::FromJson(WebSocketResult->Body());
