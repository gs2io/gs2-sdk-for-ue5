...
#include "Matchmaking/Task/WebSocket/GetSeasonModelMasterTask.h"
...
namespace Gs2::Matchmaking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("matchmaking"), TEXT("seasonModelMaster"), TEXT("getSeasonModelMaster"), ToCStr(RequestPayload->Payload()));
