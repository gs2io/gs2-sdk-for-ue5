...
#include "Matchmaking/Task/WebSocket/GetBallotByUserIdTask.h"
...
namespace Gs2::Matchmaking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("matchmaking"), TEXT("ballot"), TEXT("getBallotByUserId"), ToCStr(RequestPayload->Payload()));
