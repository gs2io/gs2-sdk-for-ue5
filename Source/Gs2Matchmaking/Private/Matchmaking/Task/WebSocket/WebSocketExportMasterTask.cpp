...
#include "Matchmaking/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Matchmaking::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, Log, TEXT("[%s:%s:%s] %s"), TEXT("matchmaking"), TEXT("currentRatingModelMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
