...
#include "Matchmaking/Task/Rest/CreateRatingModelMasterTask.h"
...
{
    FCreateRatingModelMasterTask::FCreateRatingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateRatingModelMasterTask::Action(
        const TSharedPtr<Result::FCreateRatingModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/rating");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateRatingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
