...
#include "Matchmaking/Task/Rest/CancelMatchmakingTask.h"
...
{
    FCancelMatchmakingTask::FCancelMatchmakingTask(
    ...
    Core::Model::FGs2ErrorPtr FCancelMatchmakingTask::Action(
        const TSharedPtr<Result::FCancelMatchmakingResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/user/me");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCancelMatchmakingResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
