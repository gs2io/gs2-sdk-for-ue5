...
#include "Matchmaking/Task/Rest/UpdateGatheringTask.h"
...
{
    FUpdateGatheringTask::FUpdateGatheringTask(
    ...
    FUpdateGatheringTask::FUpdateGatheringTask(
        const FUpdateGatheringTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateGatheringTask::Action(
        const TSharedPtr<Result::FUpdateGatheringResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateGatheringResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
