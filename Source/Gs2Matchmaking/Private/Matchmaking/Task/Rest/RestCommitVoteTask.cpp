...
#include "Matchmaking/Task/Rest/CommitVoteTask.h"
...
{
    FCommitVoteTask::FCommitVoteTask(
    ...
    Core::Model::FGs2ErrorPtr FCommitVoteTask::Action(
        const TSharedPtr<Result::FCommitVoteResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/vote/{ratingName}/{gatheringName}/action/vote/commit");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCommitVoteResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
