...
#include "Matchmaking/Task/Rest/PingByUserIdTask.h"
...
{
    FPingByUserIdTask::FPingByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FPingByUserIdTask::Action(
        const TSharedPtr<Result::FPingByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/user/{userId}/ping");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPingByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
