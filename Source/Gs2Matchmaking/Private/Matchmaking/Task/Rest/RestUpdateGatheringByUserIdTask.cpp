...
#include "Matchmaking/Task/Rest/UpdateGatheringByUserIdTask.h"
...
{
    FUpdateGatheringByUserIdTask::FUpdateGatheringByUserIdTask(
    ...
    FUpdateGatheringByUserIdTask::FUpdateGatheringByUserIdTask(
        const FUpdateGatheringByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FUpdateGatheringByUserIdTask::Action(
        const TSharedPtr<Result::FUpdateGatheringByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/user/{userId}");
            ...
            if (this->Request->GetAttributeRanges() != nullptr && this->Request->GetAttributeRanges().IsValid())
            {
                ...
                for (auto JsonObjectValue : *this->Request->GetAttributeRanges())
                {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateGatheringByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
