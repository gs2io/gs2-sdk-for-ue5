...
#include "Matchmaking/Task/Rest/UpdateSeasonModelMasterTask.h"
...
{
    FUpdateSeasonModelMasterTask::FUpdateSeasonModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateSeasonModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateSeasonModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/season/{seasonName}");
            ...
            if (this->Request->GetMaximumParticipants().IsSet())
            {
                JsonRootObject->SetNumberField(TEXT("maximumParticipants"), this->Request->GetMaximumParticipants().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateSeasonModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
