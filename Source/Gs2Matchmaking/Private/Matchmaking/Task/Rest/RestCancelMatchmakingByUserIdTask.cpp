...
#include "Matchmaking/Task/Rest/CancelMatchmakingByUserIdTask.h"
...
{
    FCancelMatchmakingByUserIdTask::FCancelMatchmakingByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCancelMatchmakingByUserIdTask::Action(
        const TSharedPtr<Result::FCancelMatchmakingByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCancelMatchmakingByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
