...
#include "Matchmaking/Task/Rest/EarlyCompleteTask.h"
...
{
    FEarlyCompleteTask::FEarlyCompleteTask(
    ...
    Core::Model::FGs2ErrorPtr FEarlyCompleteTask::Action(
        const TSharedPtr<Result::FEarlyCompleteResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/user/me/early");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FEarlyCompleteResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
