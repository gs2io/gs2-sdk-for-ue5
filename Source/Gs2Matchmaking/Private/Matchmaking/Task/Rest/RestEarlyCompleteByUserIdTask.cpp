...
#include "Matchmaking/Task/Rest/EarlyCompleteByUserIdTask.h"
...
{
    FEarlyCompleteByUserIdTask::FEarlyCompleteByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FEarlyCompleteByUserIdTask::Action(
        const TSharedPtr<Result::FEarlyCompleteByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/user/{userId}/early");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FEarlyCompleteByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
