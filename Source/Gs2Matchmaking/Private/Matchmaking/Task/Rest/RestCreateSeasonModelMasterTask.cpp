...
#include "Matchmaking/Task/Rest/CreateSeasonModelMasterTask.h"
...
{
    FCreateSeasonModelMasterTask::FCreateSeasonModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateSeasonModelMasterTask::Action(
        const TSharedPtr<Result::FCreateSeasonModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/season");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateSeasonModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
