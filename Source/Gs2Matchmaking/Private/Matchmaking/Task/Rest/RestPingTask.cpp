...
#include "Matchmaking/Task/Rest/PingTask.h"
...
namespace Gs2::Matchmaking::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FPingTask::Action(
        const TSharedPtr<Result::FPingResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/gathering/{gatheringName}/ping");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPingResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
