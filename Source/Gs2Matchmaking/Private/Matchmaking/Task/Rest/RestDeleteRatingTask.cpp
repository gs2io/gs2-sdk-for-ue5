...
#include "Matchmaking/Task/Rest/DeleteRatingTask.h"
...
{
    FDeleteRatingTask::FDeleteRatingTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteRatingTask::Action(
        const TSharedPtr<Result::FDeleteRatingResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRatingResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
