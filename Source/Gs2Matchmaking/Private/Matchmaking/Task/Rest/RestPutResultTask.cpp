...
#include "Matchmaking/Task/Rest/PutResultTask.h"
...
namespace Gs2::Matchmaking::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FPutResultTask::Action(
        const TSharedPtr<Result::FPutResultResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/rating/{ratingName}/vote");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPutResultResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
