...
#include "Matchmaking/Task/Rest/GetRatingByUserIdTask.h"
...
{
    FGetRatingByUserIdTask::FGetRatingByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRatingByUserIdTask::Action(
        const TSharedPtr<Result::FGetRatingByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/rating/{ratingName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRatingByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
