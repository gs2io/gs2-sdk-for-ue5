...
#include "Matchmaking/Task/Rest/GetRatingModelMasterTask.h"
...
{
    FGetRatingModelMasterTask::FGetRatingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FGetRatingModelMasterTask::Action(
        const TSharedPtr<Result::FGetRatingModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetRatingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
