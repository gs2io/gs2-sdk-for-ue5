...
#include "Matchmaking/Task/Rest/DeleteGatheringTask.h"
...
{
    FDeleteGatheringTask::FDeleteGatheringTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteGatheringTask::Action(
        const TSharedPtr<Result::FDeleteGatheringResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteGatheringResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
