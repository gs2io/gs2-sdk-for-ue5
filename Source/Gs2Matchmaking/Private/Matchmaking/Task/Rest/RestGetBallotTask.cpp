...
#include "Matchmaking/Task/Rest/GetBallotTask.h"
...
namespace Gs2::Matchmaking::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetBallotTask::Action(
        const TSharedPtr<Result::FGetBallotResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/vote/{ratingName}/{gatheringName}/ballot");
            ...
            Url = Url.Replace(
                TEXT("{gatheringName}"),
                !this->Request->GetGatheringName().IsSet() || this->Request->GetGatheringName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetGatheringName())
            );
            ...
            {
                JsonRootObject->SetNumberField(TEXT("numberOfPlayer"), this->Request->GetNumberOfPlayer().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBallotResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
