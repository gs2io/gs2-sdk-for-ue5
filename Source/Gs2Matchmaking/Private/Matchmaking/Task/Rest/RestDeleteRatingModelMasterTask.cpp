...
#include "Matchmaking/Task/Rest/DeleteRatingModelMasterTask.h"
...
{
    FDeleteRatingModelMasterTask::FDeleteRatingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteRatingModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteRatingModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteRatingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
