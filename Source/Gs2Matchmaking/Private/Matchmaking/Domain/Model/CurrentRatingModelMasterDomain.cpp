...
namespace Gs2::Matchmaking::Domain::Model
{
    ...
    )
    {
        ...
        TSharedPtr<Gs2::Matchmaking::Model::FCurrentRatingModelMaster> Value;
        auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::Matchmaking::Model::FCurrentRatingModelMaster>(
            Self->ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Gs2->Cache->TryGet<Gs2::Matchmaking::Model::FCurrentRatingModelMaster>(
                Self->ParentKey,
                Gs2::Matchmaking::Domain::Model::FCurrentRatingModelMasterDomain::CreateCacheKey(
                ),
                &Value
