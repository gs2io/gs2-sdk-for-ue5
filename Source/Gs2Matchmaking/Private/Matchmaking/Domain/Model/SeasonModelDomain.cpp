...
namespace Gs2::Matchmaking::Domain::Model
{
    ...
    )
    {
        ...
        Gs2::Matchmaking::Model::Cache::FSeasonModelCache::Put(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Matchmaking::Model::FSeasonModelPtr Value;
                const auto CacheHit = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->SeasonName,
                    TOptional<int32>(),
                    [Self](Gs2::Matchmaking::Model::FSeasonModelPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    {
        Gs2::Matchmaking::Model::Cache::FSeasonModelCache::Delete(
            Gs2->Cache,
    ...
    {
        const auto SubscriptionParentKey = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Matchmaking::Model::Cache::FSeasonModelCache::CreateCacheKey(
