...
namespace Gs2::Matchmaking::Domain::Model
{
    ...
    )
    {
        ...
        Future->EnsureCompletion();
              ...
              Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::Delete(
            Self->Gs2->Cache,
    ...
    {
        const auto CacheParentKey = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::CreateCacheParentKey(

            Self->NamespaceName,
            TOptional<int32>()
        );
        const auto CacheKey = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Matchmaking::Model::FRatingModelMasterPtr Value;
                const auto CacheHit = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::Fetch(
                    Self->Gs2->Cache,

                    Self->NamespaceName,
                    Self->RatingName,
                    TOptional<int32>(),
                    [Self](Gs2::Matchmaking::Model::FRatingModelMasterPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FRatingModelMasterDomain::Invalidate()
    {
        Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::Delete(
            Gs2->Cache,
    ...
    FRatingModelMasterDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FRatingModelMasterDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FRatingModelMasterDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FRatingModelMasterDomain::FSubscribeWithInitialCallTask>> FRatingModelMasterDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Matchmaking::Model::FRatingModelMasterPtr)> Callback
    )
    {
    ...
    {
        const auto SubscriptionParentKey = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::CreateCacheParentKey(

            NamespaceName,
            TOptional<int32>()
        );
        const auto SubscriptionCacheKey = Gs2::Matchmaking::Model::Cache::FRatingModelMasterCache::CreateCacheKey(
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryRatingName]()
            {
                ...
                const auto Domain = MakeShared<FRatingModelMasterDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryRatingName
