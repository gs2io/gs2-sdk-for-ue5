...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    FDescribeJoinedSeasonGatheringsIterator::FDescribeJoinedSeasonGatheringsIterator(
    ...
    FDescribeJoinedSeasonGatheringsIterator::FDescribeJoinedSeasonGatheringsIterator(
        const FDescribeJoinedSeasonGatheringsIterator& From
    ):
        Gs2(From.Gs2),
        Client(From.Client),
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeJoinedSeasonGatheringsIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FJoinedSeasonGathering>> Result)
    {
        ++Iterator;
    ...
    FDescribeJoinedSeasonGatheringsIterator::FIterator::FIterator(
        const TSharedRef<FDescribeJoinedSeasonGatheringsIterator> Iterable,
        FOneBeforeBegin
    ) :
        Self(Iterable),
        bLast(false),
    ...
    FDescribeJoinedSeasonGatheringsIterator::FIterator& FDescribeJoinedSeasonGatheringsIterator::FIterator::operator++()
    {
        ...
        if (!RangeIteratorOpt || (!*RangeIteratorOpt && !bLast))
        {
            ...
            const auto Request =
                MakeShared<Gs2::Matchmaking::Request::FDescribeJoinedSeasonGatheringsRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeJoinedSeasonGatherings(Request);
            ...
            if (Range.IsValid())
            {
                for (const auto& Item : *Range)
                {
                    ...
                    Gs2::Matchmaking::Model::Cache::FJoinedSeasonGatheringCache::Put(
                        Self->Gs2->Cache,
                        Request->GetNamespaceName(), CacheOwnerSnapshotUserId, Request->GetSeasonName(), TOptional<int64>(),
    ...
    FDescribeJoinedSeasonGatheringsIterator::FIterator FDescribeJoinedSeasonGatheringsIterator::OneBeforeBegin()
    {
        return FIterator::OneBeforeBeginOf(this->AsShared());
    }

    FDescribeJoinedSeasonGatheringsIterator::FIterator FDescribeJoinedSeasonGatheringsIterator::begin()
    {
        return FIterator::BeginOf(this->AsShared());
    }

    FDescribeJoinedSeasonGatheringsIterator::FIterator FDescribeJoinedSeasonGatheringsIterator::end()
    {
