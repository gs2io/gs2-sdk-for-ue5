...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    FDescribeRatingsByUserIdIterator::FIterator& FDescribeRatingsByUserIdIterator::FIterator::operator++()
    {
        ...
        {
            const auto ListParentKey = Gs2::Matchmaking::Model::Cache::FRatingCache::CreateCacheParentKey(
                Self->NamespaceName,
                Self->UserId,
                TOptional<int32>()
            );
            ...
            const auto Request =
                MakeShared<Gs2::Matchmaking::Request::FDescribeRatingsByUserIdRequest>()
                    ...
                    ->WithLimit(FetchSize)
            ;
            const auto Future = Self->Client->DescribeRatingsByUserId(Request);
            ...
            Range = R->GetItems().IsValid() ? R->GetItems() : MakeShared<TArray<Gs2::Matchmaking::Model::FRatingPtr>>();
