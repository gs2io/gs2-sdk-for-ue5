...
#include "Matchmaking/Result/DoMatchmakingByPlayerResult.h"

namespace Gs2::Matchmaking::Result
{
    FDoMatchmakingByPlayerResult::FDoMatchmakingByPlayerResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FDoMatchmakingByPlayerResult> FDoMatchmakingByPlayerResult::WithItem(
    ...
    TSharedPtr<FDoMatchmakingByPlayerResult> FDoMatchmakingByPlayerResult::WithMatchmakingContextToken(
    ...
    TSharedPtr<Model::FGathering> FDoMatchmakingByPlayerResult::GetItem() const
    {
    ...
    TOptional<FString> FDoMatchmakingByPlayerResult::GetMatchmakingContextToken() const
    {
        return MatchmakingContextTokenValue;
    }

    TSharedPtr<FDoMatchmakingByPlayerResult> FDoMatchmakingByPlayerResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FDoMatchmakingByPlayerResult>()
    ...
    TSharedPtr<FJsonObject> FDoMatchmakingByPlayerResult::ToJson() const
    {
