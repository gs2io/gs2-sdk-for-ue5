...
namespace Gs2::Matchmaking
{
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FGetServiceVersionTask>> FGs2MatchmakingRestClient::GetServiceVersion(
    ...
    TSharedPtr<FAsyncTask<Task::Rest::FPreUpdateCurrentModelMasterTask>> FGs2MatchmakingRestClient::PreUpdateCurrentModelMaster(
