...
namespace Gs2::Matchmaking::Request
{
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithEnableDisconnectDetection(
    ...
    TSharedPtr<FUpdateNamespaceRequest> FUpdateNamespaceRequest::WithDisconnectDetectionTimeoutSeconds(
    ...
    TOptional<FString> FUpdateNamespaceRequest::GetEnableDisconnectDetection() const
    {
        return EnableDisconnectDetectionValue;
    }

    TOptional<int32> FUpdateNamespaceRequest::GetDisconnectDetectionTimeoutSeconds() const
    {
        return DisconnectDetectionTimeoutSecondsValue;
    }

    FString FUpdateNamespaceRequest::GetDisconnectDetectionTimeoutSecondsString() const
    {
