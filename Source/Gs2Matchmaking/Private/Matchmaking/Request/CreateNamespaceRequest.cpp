...
namespace Gs2::Matchmaking::Request
{
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithEnableDisconnectDetection(
    ...
    TSharedPtr<FCreateNamespaceRequest> FCreateNamespaceRequest::WithDisconnectDetectionTimeoutSeconds(
    ...
    TOptional<FString> FCreateNamespaceRequest::GetEnableDisconnectDetection() const
    {
        return EnableDisconnectDetectionValue;
    }

    TOptional<int32> FCreateNamespaceRequest::GetDisconnectDetectionTimeoutSeconds() const
    {
        return DisconnectDetectionTimeoutSecondsValue;
    }

    FString FCreateNamespaceRequest::GetDisconnectDetectionTimeoutSecondsString() const
    {
