...
#include "Matchmaking/Request/CheckImportUserDataByUserIdRequest.h"
#include "Matchmaking/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::WebSocket
{
    class GS2MATCHMAKING_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
