...
#include "Matchmaking/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Matchmaking/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::WebSocket
{
    class GS2MATCHMAKING_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
