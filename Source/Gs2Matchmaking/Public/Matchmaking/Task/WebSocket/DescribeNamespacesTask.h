...
#include "Matchmaking/Request/DescribeNamespacesRequest.h"
#include "Matchmaking/Result/DescribeNamespacesResult.h"

namespace Gs2::Matchmaking::Task::WebSocket
{
    class GS2MATCHMAKING_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
