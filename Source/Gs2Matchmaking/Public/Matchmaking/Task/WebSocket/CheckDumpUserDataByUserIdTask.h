...
#include "Matchmaking/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Matchmaking/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::WebSocket
{
    class GS2MATCHMAKING_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
