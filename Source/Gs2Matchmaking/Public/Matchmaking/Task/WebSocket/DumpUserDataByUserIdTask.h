...
#include "Matchmaking/Request/DumpUserDataByUserIdRequest.h"
#include "Matchmaking/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::WebSocket
{
    class GS2MATCHMAKING_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
