...
#include "Matchmaking/Request/UpdateCurrentModelMasterRequest.h"
#include "Matchmaking/Result/UpdateCurrentModelMasterResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateCurrentModelMasterResult>
    {
