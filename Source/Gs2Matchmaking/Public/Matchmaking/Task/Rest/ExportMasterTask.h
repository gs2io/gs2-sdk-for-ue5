...
#include "Matchmaking/Result/ExportMasterResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FExportMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FExportMasterResult>
    {
