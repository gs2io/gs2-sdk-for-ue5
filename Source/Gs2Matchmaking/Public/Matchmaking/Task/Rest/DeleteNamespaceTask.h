...
#include "Matchmaking/Request/DeleteNamespaceRequest.h"
#include "Matchmaking/Result/DeleteNamespaceResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
