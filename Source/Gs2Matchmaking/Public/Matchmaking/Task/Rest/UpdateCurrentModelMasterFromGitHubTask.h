...
#include "Matchmaking/Request/UpdateCurrentModelMasterFromGitHubRequest.h"
#include "Matchmaking/Result/UpdateCurrentModelMasterFromGitHubResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FUpdateCurrentModelMasterFromGitHubTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateCurrentModelMasterFromGitHubResult>
    {
