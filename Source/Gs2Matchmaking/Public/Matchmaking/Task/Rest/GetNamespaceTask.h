...
#include "Matchmaking/Request/GetNamespaceRequest.h"
#include "Matchmaking/Result/GetNamespaceResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
