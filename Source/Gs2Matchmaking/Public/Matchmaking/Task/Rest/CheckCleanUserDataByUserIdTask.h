...
#include "Matchmaking/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Matchmaking/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
