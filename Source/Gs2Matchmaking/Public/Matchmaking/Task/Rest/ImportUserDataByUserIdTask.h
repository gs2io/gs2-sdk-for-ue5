...
#include "Matchmaking/Request/ImportUserDataByUserIdRequest.h"
#include "Matchmaking/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
