...
#include "Matchmaking/Request/GetServiceVersionRequest.h"
#include "Matchmaking/Result/GetServiceVersionResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
