...
#include "Matchmaking/Request/PreUpdateCurrentModelMasterRequest.h"
#include "Matchmaking/Result/PreUpdateCurrentModelMasterResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FPreUpdateCurrentModelMasterTask final : public Gs2::Core::Util::TGs2Future<Result::FPreUpdateCurrentModelMasterResult>
    {
