...
#include "Matchmaking/Request/GetNamespaceStatusRequest.h"
#include "Matchmaking/Result/GetNamespaceStatusResult.h"

namespace Gs2::Matchmaking::Task::Rest
{
    class GS2MATCHMAKING_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
