...
namespace Gs2::Matchmaking::Request
{
    ...
    class GS2MATCHMAKING_API FDescribeSeasonModelMastersRequest final : public TSharedFromThis<FDescribeSeasonModelMastersRequest>
    {
    ...
    typedef TSharedPtr<FDescribeSeasonModelMastersRequest, ESPMode::ThreadSafe> FDescribeSeasonModelMastersRequestPtr;
}