...
namespace Gs2::Matchmaking::Request
{
    ...
    class GS2MATCHMAKING_API FUpdateCurrentModelMasterRequest final : public TSharedFromThis<FUpdateCurrentModelMasterRequest>
    {
    ...
    typedef TSharedPtr<FUpdateCurrentModelMasterRequest, ESPMode::ThreadSafe> FUpdateCurrentModelMasterRequestPtr;
}