...
namespace Gs2::Matchmaking::Request
{
    ...
    class GS2MATCHMAKING_API FGetCurrentModelMasterRequest final : public TSharedFromThis<FGetCurrentModelMasterRequest>
    {
    ...
    typedef TSharedPtr<FGetCurrentModelMasterRequest, ESPMode::ThreadSafe> FGetCurrentModelMasterRequestPtr;
}