...
namespace Gs2::Matchmaking::Request
{
    ...
    class GS2MATCHMAKING_API FUpdateCurrentModelMasterFromGitHubRequest final : public TSharedFromThis<FUpdateCurrentModelMasterFromGitHubRequest>
    {
    ...
    typedef TSharedPtr<FUpdateCurrentModelMasterFromGitHubRequest, ESPMode::ThreadSafe> FUpdateCurrentModelMasterFromGitHubRequestPtr;
}