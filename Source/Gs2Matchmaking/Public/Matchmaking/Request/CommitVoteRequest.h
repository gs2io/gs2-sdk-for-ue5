...
namespace Gs2::Matchmaking::Request
{
    ...
    class GS2MATCHMAKING_API FCommitVoteRequest final : public TSharedFromThis<FCommitVoteRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FCommitVoteRequest> WithRatingName(const TOptional<FString> RatingName);
        TSharedPtr<FCommitVoteRequest> WithGatheringName(const TOptional<FString> GatheringName);
    ...
    typedef TSharedPtr<FCommitVoteRequest> FCommitVoteRequestPtr;
}