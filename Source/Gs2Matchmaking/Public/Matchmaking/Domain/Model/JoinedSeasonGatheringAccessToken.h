...
namespace Gs2::Matchmaking::Domain::Model
{
    ...
    class GS2MATCHMAKING_API FJoinedSeasonGatheringAccessTokenDomain:
        public TSharedFromThis<FJoinedSeasonGatheringAccessTokenDomain>
    {
    ...
    public:
        ...
        FJoinedSeasonGatheringAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Matchmaking::Domain::FGs2MatchmakingDomainPtr& Service,
        ...
        {
            const TSharedPtr<FJoinedSeasonGatheringAccessTokenDomain> Self;
            const TFunction<void(Gs2::Matchmaking::Model::FJoinedSeasonGatheringPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FJoinedSeasonGatheringAccessTokenDomain> FJoinedSeasonGatheringAccessTokenDomainPtr;
}
