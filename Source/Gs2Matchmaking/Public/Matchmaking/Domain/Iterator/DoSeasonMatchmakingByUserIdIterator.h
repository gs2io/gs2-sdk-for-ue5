...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDoSeasonMatchmakingByUserIdIterator :
        public TSharedFromThis<FDoSeasonMatchmakingByUserIdIterator>
    {
    ...
    public:
        FDoSeasonMatchmakingByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Matchmaking::FGs2MatchmakingRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> SeasonName,
        ...
        {
            TSharedRef<FDoSeasonMatchmakingByUserIdIterator> Self;
        ...
        public:
            FIterator(
                ...
                bEnd(Iterator.bEnd),
                MatchmakingContextToken(Iterator.MatchmakingContextToken),
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDoSeasonMatchmakingByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDoSeasonMatchmakingByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDoSeasonMatchmakingByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDoSeasonMatchmakingByUserIdIterator> FDoSeasonMatchmakingByUserIdIteratorPtr;
}
