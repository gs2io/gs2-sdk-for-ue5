...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeSeasonModelsIterator :
        public TSharedFromThis<FDescribeSeasonModelsIterator>
    {
    ...
    public:
        ...
        class GS2MATCHMAKING_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Matchmaking::Model::FSeasonModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FSeasonModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeSeasonModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FSeasonModelPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FSeasonModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Matchmaking::Model::FSeasonModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSeasonModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSeasonModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSeasonModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSeasonModelsIterator> FDescribeSeasonModelsIteratorPtr;
}
