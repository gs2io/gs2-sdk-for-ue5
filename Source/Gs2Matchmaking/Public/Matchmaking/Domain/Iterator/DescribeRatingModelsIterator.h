...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeRatingModelsIterator :
        public TSharedFromThis<FDescribeRatingModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FRatingModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeRatingModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FRatingModelPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FRatingModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Matchmaking::Model::FRatingModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRatingModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRatingModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRatingModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeRatingModelsIterator> FDescribeRatingModelsIteratorPtr;
}
