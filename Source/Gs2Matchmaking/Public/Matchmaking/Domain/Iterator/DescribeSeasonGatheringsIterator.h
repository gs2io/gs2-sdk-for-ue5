...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeSeasonGatheringsIterator :
        public TSharedFromThis<FDescribeSeasonGatheringsIterator>
    {
    ...
    public:
        FDescribeSeasonGatheringsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Matchmaking::FGs2MatchmakingRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> SeasonName,
        ...
        {
            TSharedRef<FDescribeSeasonGatheringsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSeasonGatheringsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSeasonGatheringsIterator> FDescribeSeasonGatheringsIteratorPtr;
}
