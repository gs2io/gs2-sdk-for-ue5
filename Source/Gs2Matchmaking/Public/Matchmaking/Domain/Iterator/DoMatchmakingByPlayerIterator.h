...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    public:
        ...
        {
            TSharedRef<FDoMatchmakingByPlayerIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDoMatchmakingByPlayerIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDoMatchmakingByPlayerIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDoMatchmakingByPlayerIterator> Iterable)
            {
