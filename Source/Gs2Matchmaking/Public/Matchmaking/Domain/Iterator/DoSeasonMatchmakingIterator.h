...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDoSeasonMatchmakingIterator :
        public TSharedFromThis<FDoSeasonMatchmakingIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDoSeasonMatchmakingIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDoSeasonMatchmakingIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDoSeasonMatchmakingIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDoSeasonMatchmakingIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDoSeasonMatchmakingIterator> FDoSeasonMatchmakingIteratorPtr;
}
