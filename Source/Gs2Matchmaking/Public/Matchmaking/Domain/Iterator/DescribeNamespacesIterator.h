...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FNamespace>> Result) override;
        ...
        class GS2MATCHMAKING_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
