...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeRatingsByUserIdIterator :
        public TSharedFromThis<FDescribeRatingsByUserIdIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FRating>> Result) override;
        ...
        {
            TSharedRef<FDescribeRatingsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FRatingPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FRatingPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRatingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRatingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRatingsByUserIdIterator> Iterable)
            {
