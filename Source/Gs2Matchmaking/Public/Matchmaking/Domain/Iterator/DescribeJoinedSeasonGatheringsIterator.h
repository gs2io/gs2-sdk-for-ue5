...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeJoinedSeasonGatheringsIterator :
        public TSharedFromThis<FDescribeJoinedSeasonGatheringsIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeJoinedSeasonGatheringsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeJoinedSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeJoinedSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeJoinedSeasonGatheringsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeJoinedSeasonGatheringsIterator> FDescribeJoinedSeasonGatheringsIteratorPtr;
}
