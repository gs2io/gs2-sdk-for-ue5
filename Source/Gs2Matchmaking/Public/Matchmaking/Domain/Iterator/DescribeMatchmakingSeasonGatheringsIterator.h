...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeMatchmakingSeasonGatheringsIterator :
        public TSharedFromThis<FDescribeMatchmakingSeasonGatheringsIterator>
    {
    ...
    public:
        FDescribeMatchmakingSeasonGatheringsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Matchmaking::FGs2MatchmakingRestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> SeasonName,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FSeasonGathering>> Result) override;
        ...
        {
            TSharedRef<FDescribeMatchmakingSeasonGatheringsIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FSeasonGatheringPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FSeasonGatheringPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMatchmakingSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMatchmakingSeasonGatheringsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMatchmakingSeasonGatheringsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeMatchmakingSeasonGatheringsIterator> FDescribeMatchmakingSeasonGatheringsIteratorPtr;
}
