...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    public:
        ...
        FDoMatchmakingByUserIdIterator(
            const FDoMatchmakingByUserIdIterator& From
        );
        ...
        {
            TSharedRef<FDoMatchmakingByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDoMatchmakingByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDoMatchmakingByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDoMatchmakingByUserIdIterator> Iterable)
            {
