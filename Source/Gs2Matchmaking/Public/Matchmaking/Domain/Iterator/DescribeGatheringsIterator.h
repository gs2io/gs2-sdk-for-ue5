...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeGatheringsIterator :
        public TSharedFromThis<FDescribeGatheringsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FGathering>> Result) override;
        ...
        {
            TSharedRef<FDescribeGatheringsIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FGatheringPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FGatheringPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGatheringsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGatheringsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGatheringsIterator> Iterable)
            {
