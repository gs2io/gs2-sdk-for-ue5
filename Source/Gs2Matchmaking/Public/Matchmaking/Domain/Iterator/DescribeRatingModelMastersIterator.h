...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDescribeRatingModelMastersIterator :
        public TSharedFromThis<FDescribeRatingModelMastersIterator>
    {
    ...
    public:
        ...
        FDescribeRatingModelMastersIterator(
            const FDescribeRatingModelMastersIterator& From
        );
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Matchmaking::Model::FRatingModelMaster>> Result) override;
        ...
        {
            TSharedRef<FDescribeRatingModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Matchmaking::Model::FRatingModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Matchmaking::Model::FRatingModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeRatingModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeRatingModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeRatingModelMastersIterator> Iterable)
            {
