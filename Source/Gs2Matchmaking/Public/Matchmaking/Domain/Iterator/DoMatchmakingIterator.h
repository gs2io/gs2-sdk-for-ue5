...
namespace Gs2::Matchmaking::Domain::Iterator
{
    ...
    class GS2MATCHMAKING_API FDoMatchmakingIterator :
        public TSharedFromThis<FDoMatchmakingIterator>
    {
    ...
    public:
        ...
        FDoMatchmakingIterator(
            const FDoMatchmakingIterator& From
        );
        ...
        {
            TSharedRef<FDoMatchmakingIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDoMatchmakingIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDoMatchmakingIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDoMatchmakingIterator> Iterable)
            {
