...
#include "Log/Request/GetNamespaceRequest.h"
#include "Log/Result/GetNamespaceResult.h"

namespace Gs2::Log::Task::Rest
{
    class GS2LOG_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
