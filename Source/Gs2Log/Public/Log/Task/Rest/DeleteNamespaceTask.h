...
#include "Log/Request/DeleteNamespaceRequest.h"
#include "Log/Result/DeleteNamespaceResult.h"

namespace Gs2::Log::Task::Rest
{
    class GS2LOG_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
