...
#include "Log/Request/GetServiceVersionRequest.h"
#include "Log/Result/GetServiceVersionResult.h"

namespace Gs2::Log::Task::WebSocket
{
    class GS2LOG_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
