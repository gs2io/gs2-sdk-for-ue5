...
#include "Log/Request/GetNamespaceStatusRequest.h"
#include "Log/Result/GetNamespaceStatusResult.h"

namespace Gs2::Log::Task::WebSocket
{
    class GS2LOG_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
