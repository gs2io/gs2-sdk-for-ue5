...
#include "Log/Request/DescribeNamespacesRequest.h"
#include "Log/Result/DescribeNamespacesResult.h"

namespace Gs2::Log::Task::WebSocket
{
    class GS2LOG_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
