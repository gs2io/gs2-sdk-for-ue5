...
namespace Gs2::Log::Domain::SpeculativeExecutor
{
    class GS2LOG_API FAcquireActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Log::Domain::FGs2LogDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FAcquireActionPtr AcquireAction;
            TBigInt<1024, false> Rate;

        public:
            GS2LOG_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Log::Domain::FGs2LogDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FAcquireActionPtr& AcquireAction,
            ...
            GS2LOG_API FCommitTask(
                const FCommitTask& From
            );

            GS2LOG_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
