...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FDescribeFacetModelsIterator :
        public TSharedFromThis<FDescribeFacetModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FFacetModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeFacetModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FFacetModelPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FFacetModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FFacetModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeFacetModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeFacetModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeFacetModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeFacetModelsIterator> FDescribeFacetModelsIteratorPtr;
}
