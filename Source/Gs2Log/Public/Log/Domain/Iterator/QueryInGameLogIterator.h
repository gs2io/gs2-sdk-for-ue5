...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryInGameLogIterator :
        public TSharedFromThis<FQueryInGameLogIterator>
    {
    ...
    public:
        FQueryInGameLogIterator(
            ...
            const TSharedPtr<TArray<TSharedPtr<Model::FInGameLogTag>>> Tags = nullptr,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FInGameLog>> Result) override;
        ...
        {
            TSharedRef<FQueryInGameLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FInGameLogPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FInGameLogPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FInGameLogPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryInGameLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryInGameLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryInGameLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryInGameLogIterator> FQueryInGameLogIteratorPtr;
}
