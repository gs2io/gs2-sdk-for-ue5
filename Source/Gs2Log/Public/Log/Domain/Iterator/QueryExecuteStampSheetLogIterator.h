...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryExecuteStampSheetLogIterator :
        public TSharedFromThis<FQueryExecuteStampSheetLogIterator>
    {
    ...
    public:
        FQueryExecuteStampSheetLogIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Log::FGs2LogRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FExecuteStampSheetLog>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FExecuteStampSheetLog>> Result) override;
        ...
        {
            TSharedRef<FQueryExecuteStampSheetLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FExecuteStampSheetLogPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FExecuteStampSheetLogPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FExecuteStampSheetLogPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryExecuteStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryExecuteStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryExecuteStampSheetLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryExecuteStampSheetLogIterator> FQueryExecuteStampSheetLogIteratorPtr;
}
