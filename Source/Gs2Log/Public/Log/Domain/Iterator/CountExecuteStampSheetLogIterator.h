...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FCountExecuteStampSheetLogIterator :
        public TSharedFromThis<FCountExecuteStampSheetLogIterator>
    {
    ...
    public:
        FCountExecuteStampSheetLogIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Log::FGs2LogRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        FCountExecuteStampSheetLogIterator(
            const FCountExecuteStampSheetLogIterator& From
        );

        class FIterator;

        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FExecuteStampSheetLogCount>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FExecuteStampSheetLogCount>> Result) override;
        ...
        {
            TSharedRef<FCountExecuteStampSheetLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FExecuteStampSheetLogCountPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FExecuteStampSheetLogCountPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FCountExecuteStampSheetLogIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Log::Model::FExecuteStampSheetLogCountPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FCountExecuteStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FCountExecuteStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FCountExecuteStampSheetLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FCountExecuteStampSheetLogIterator> FCountExecuteStampSheetLogIteratorPtr;
}
