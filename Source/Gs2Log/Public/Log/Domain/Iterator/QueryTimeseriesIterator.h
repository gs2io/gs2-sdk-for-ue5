...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryTimeseriesIterator :
        public TSharedFromThis<FQueryTimeseriesIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FTimeseriesPoint>> Result) override;
        ...
        {
            TSharedRef<FQueryTimeseriesIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FTimeseriesPointPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FTimeseriesPointPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FTimeseriesPointPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryTimeseriesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryTimeseriesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryTimeseriesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryTimeseriesIterator> FQueryTimeseriesIteratorPtr;
}
