...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FNamespace>> Result) override;
        ...
        class GS2LOG_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Log::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FNamespacePtr& Current()
            {
