...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryLogIterator :
        public TSharedFromThis<FQueryLogIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FLogEntry>> Result) override;
        ...
        {
            TSharedRef<FQueryLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FLogEntryPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FLogEntryPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FLogEntryPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryLogIterator> FQueryLogIteratorPtr;
}
