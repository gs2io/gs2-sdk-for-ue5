...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FDescribeLabelValuesIterator :
        public TSharedFromThis<FDescribeLabelValuesIterator>
    {
    ...
    public:
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FLabel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FLabel>> Result) override;
        ...
        {
            TSharedRef<FDescribeLabelValuesIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FLabelPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FLabelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FLabelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeLabelValuesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeLabelValuesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeLabelValuesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeLabelValuesIterator> FDescribeLabelValuesIteratorPtr;
}
