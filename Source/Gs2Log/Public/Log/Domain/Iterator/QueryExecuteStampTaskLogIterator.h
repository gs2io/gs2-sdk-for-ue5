...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryExecuteStampTaskLogIterator :
        public TSharedFromThis<FQueryExecuteStampTaskLogIterator>
    {
    ...
    public:
        FQueryExecuteStampTaskLogIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Log::FGs2LogRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FExecuteStampTaskLog>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FExecuteStampTaskLog>> Result) override;
        ...
        {
            TSharedRef<FQueryExecuteStampTaskLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FExecuteStampTaskLogPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FExecuteStampTaskLogPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FExecuteStampTaskLogPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryExecuteStampTaskLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryExecuteStampTaskLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryExecuteStampTaskLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryExecuteStampTaskLogIterator> FQueryExecuteStampTaskLogIteratorPtr;
}
