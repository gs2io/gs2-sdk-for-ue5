...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FDescribeMetricsIterator :
        public TSharedFromThis<FDescribeMetricsIterator>
    {
    ...
    public:
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FMetricModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FMetricModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeMetricsIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FMetricModelPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FMetricModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FMetricModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMetricsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMetricsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMetricsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeMetricsIterator> FDescribeMetricsIteratorPtr;
}
