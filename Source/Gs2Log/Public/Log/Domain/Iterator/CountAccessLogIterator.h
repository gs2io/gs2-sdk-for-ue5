...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FCountAccessLogIterator :
        public TSharedFromThis<FCountAccessLogIterator>
    {
    ...
    public:
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FAccessLogCount>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FAccessLogCount>> Result) override;
        ...
        {
            TSharedRef<FCountAccessLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FAccessLogCountPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FAccessLogCountPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FAccessLogCountPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FCountAccessLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FCountAccessLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FCountAccessLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FCountAccessLogIterator> FCountAccessLogIteratorPtr;
}
