...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FCountIssueStampSheetLogIterator :
        public TSharedFromThis<FCountIssueStampSheetLogIterator>
    {
    ...
    public:
        FCountIssueStampSheetLogIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Log::FGs2LogRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        FCountIssueStampSheetLogIterator(
            const FCountIssueStampSheetLogIterator& From
        );

        class FIterator;

        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FIssueStampSheetLogCount>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FIssueStampSheetLogCount>> Result) override;
        ...
        {
            TSharedRef<FCountIssueStampSheetLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FIssueStampSheetLogCountPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FIssueStampSheetLogCountPtr>::TIterator> RangeIteratorOpt;
            ...
            FIterator(
                const TSharedRef<FCountIssueStampSheetLogIterator> Iterable,
                FOneBeforeBegin
            );
        ...
        public:
            ...
            Gs2::Log::Model::FIssueStampSheetLogCountPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FCountIssueStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FCountIssueStampSheetLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FCountIssueStampSheetLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FCountIssueStampSheetLogIterator> FCountIssueStampSheetLogIteratorPtr;
}
