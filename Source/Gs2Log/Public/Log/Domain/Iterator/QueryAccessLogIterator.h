...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryAccessLogIterator :
        public TSharedFromThis<FQueryAccessLogIterator>
    {
    ...
    public:
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FAccessLog>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FAccessLog>> Result) override;
        ...
        {
            TSharedRef<FQueryAccessLogIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FAccessLogPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FAccessLogPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FAccessLogPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryAccessLogIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryAccessLogIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryAccessLogIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryAccessLogIterator> FQueryAccessLogIteratorPtr;
}
