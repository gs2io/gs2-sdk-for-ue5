...
namespace Gs2::Log::Domain::Iterator
{
    ...
    class GS2LOG_API FQueryAccessLogWithTelemetryIterator :
        public TSharedFromThis<FQueryAccessLogWithTelemetryIterator>
    {
    ...
    public:
        FQueryAccessLogWithTelemetryIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Log::FGs2LogRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        class GS2LOG_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FAccessLogWithTelemetry>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Log::Model::FAccessLogWithTelemetry>> Result) override;
        ...
        {
            TSharedRef<FQueryAccessLogWithTelemetryIterator> Self;
            TSharedPtr<TArray<Gs2::Log::Model::FAccessLogWithTelemetryPtr>> Range;
            TOptional<TArray<Gs2::Log::Model::FAccessLogWithTelemetryPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Log::Model::FAccessLogWithTelemetryPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FQueryAccessLogWithTelemetryIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FQueryAccessLogWithTelemetryIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FQueryAccessLogWithTelemetryIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FQueryAccessLogWithTelemetryIterator> FQueryAccessLogWithTelemetryIteratorPtr;
}
