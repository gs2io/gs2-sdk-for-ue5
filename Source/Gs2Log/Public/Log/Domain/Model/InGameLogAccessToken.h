...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FInGameLogAccessTokenDomain:
        public TSharedFromThis<FInGameLogAccessTokenDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FInGameLogAccessTokenDomain> Self;
            const TFunction<void(Gs2::Log::Model::FInGameLogPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FInGameLogAccessTokenDomain> FInGameLogAccessTokenDomainPtr;
}
