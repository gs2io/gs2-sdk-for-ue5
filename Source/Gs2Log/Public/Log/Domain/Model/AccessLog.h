...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FAccessLogDomain:
        public TSharedFromThis<FAccessLogDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FAccessLogDomain> Self;
            const TFunction<void(Gs2::Log::Model::FAccessLogPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FAccessLogDomain> FAccessLogDomainPtr;
}
