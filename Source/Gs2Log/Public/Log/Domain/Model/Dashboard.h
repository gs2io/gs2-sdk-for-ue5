...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FDashboardDomain:
        public TSharedFromThis<FDashboardDomain>
    {
    ...
    public:
        ...
        class GS2LOG_API FDuplicateTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Domain::Model::FDashboardDomain>,
            public TSharedFromThis<FDuplicateTask>
        {
            const TSharedPtr<FDashboardDomain> Self;
            const Request::FDuplicateDashboardRequestPtr Request;
        public:
            explicit FDuplicateTask(
                const TSharedPtr<FDashboardDomain>& Self,
                const Request::FDuplicateDashboardRequestPtr Request
            );
        ...
        friend FDuplicateTask;

        TSharedPtr<FAsyncTask<FDuplicateTask>> Duplicate(
        ...
        {
            const TSharedPtr<FDashboardDomain> Self;
            const TFunction<void(Gs2::Log::Model::FDashboardPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FDashboardDomain> FDashboardDomainPtr;
}
