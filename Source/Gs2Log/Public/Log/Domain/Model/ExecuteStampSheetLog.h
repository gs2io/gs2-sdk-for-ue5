...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FExecuteStampSheetLogDomain:
        public TSharedFromThis<FExecuteStampSheetLogDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FExecuteStampSheetLogDomain> Self;
            const TFunction<void(Gs2::Log::Model::FExecuteStampSheetLogPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FExecuteStampSheetLogDomain> FExecuteStampSheetLogDomainPtr;
}
