...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FMetricModelDomain:
        public TSharedFromThis<FMetricModelDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FMetricModelDomain> Self;
            const TFunction<void(Gs2::Log::Model::FMetricModelPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FMetricModelDomain> FMetricModelDomainPtr;
}
