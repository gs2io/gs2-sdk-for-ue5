...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FExecuteStampTaskLogDomain:
        public TSharedFromThis<FExecuteStampTaskLogDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FExecuteStampTaskLogDomain> Self;
            const TFunction<void(Gs2::Log::Model::FExecuteStampTaskLogPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FExecuteStampTaskLogDomain> FExecuteStampTaskLogDomainPtr;
}
