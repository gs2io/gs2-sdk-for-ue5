...
namespace Gs2::Log::Domain::Model
{
    ...
    class GS2LOG_API FFacetDomain:
        public TSharedFromThis<FFacetDomain>
    {
    ...
    public:
        ...
        class GS2LOG_API FModelTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Log::Model::FFacet>,
        ...
        {
            const TSharedPtr<FFacetDomain> Self;
            const TFunction<void(Gs2::Log::Model::FFacetPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FFacetDomain> FFacetDomainPtr;
}
