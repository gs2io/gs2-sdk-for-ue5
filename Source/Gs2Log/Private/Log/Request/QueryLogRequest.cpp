...
#include "Log/Request/QueryLogRequest.h"

namespace Gs2::Log::Request
{
    FQueryLogRequest::FQueryLogRequest():
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithContextStack(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithNamespaceName(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithBegin(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithEnd(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithQuery(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithPageToken(
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::WithLimit(
    ...
    TOptional<FString> FQueryLogRequest::GetContextStack() const
    {
        return ContextStackValue;
    }

    TOptional<FString> FQueryLogRequest::GetNamespaceName() const
    {
        return NamespaceNameValue;
    }

    TOptional<int64> FQueryLogRequest::GetBegin() const
    {
        return BeginValue;
    }

    FString FQueryLogRequest::GetBeginString() const
    {
        if (!BeginValue.IsSet())
        {
            return FString("null");
    ...
    TOptional<int64> FQueryLogRequest::GetEnd() const
    {
        return EndValue;
    }

    FString FQueryLogRequest::GetEndString() const
    {
        if (!EndValue.IsSet())
        {
            return FString("null");
    ...
    TOptional<FString> FQueryLogRequest::GetQuery() const
    {
        return QueryValue;
    }

    TOptional<FString> FQueryLogRequest::GetPageToken() const
    {
        return PageTokenValue;
    }

    TOptional<int32> FQueryLogRequest::GetLimit() const
    {
        return LimitValue;
    }

    FString FQueryLogRequest::GetLimitString() const
    {
        if (!LimitValue.IsSet())
        {
            return FString("null");
    ...
    TSharedPtr<FQueryLogRequest> FQueryLogRequest::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FQueryLogRequest>()
    ...
    TSharedPtr<FJsonObject> FQueryLogRequest::ToJson() const
    {
