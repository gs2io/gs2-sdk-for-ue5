...
namespace Gs2::Log::Request
{
    ...
    TSharedPtr<FJsonObject> FDescribeLabelValuesRequest::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("metricName"), MetricNameValue.GetValue());
        }
        if (LabelNamePrefixValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("labelNamePrefix"), LabelNamePrefixValue.GetValue());
        }
