...
#include "Log/Task/WebSocket/QueryMetricsTimeseriesTask.h"
...
namespace Gs2::Log::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("log"), TEXT("metricModel"), TEXT("queryMetricsTimeseries"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FQueryMetricsTimeseriesResult::FromJson(WebSocketResult->Body());
