...
#include "Log/Task/WebSocket/QueryInGameLogTask.h"
...
namespace Gs2::Log::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("log"), TEXT("inGameLog"), TEXT("queryInGameLog"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FQueryInGameLogResult::FromJson(WebSocketResult->Body());
