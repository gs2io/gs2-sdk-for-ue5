...
#include "Log/Task/Rest/DescribeLabelValuesTask.h"
...
{
    FDescribeLabelValuesTask::FDescribeLabelValuesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeLabelValuesTask::Action(
        const TSharedPtr<Result::FDescribeLabelValuesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/metrics/{metricName}/label");
            ...
            Url = Url.Replace(
                TEXT("{metricName}"),
                !this->Request->GetMetricName().IsSet() || this->Request->GetMetricName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetMetricName())
            );
            ...
            if (this->Request->GetLabelNamePrefix().IsSet()) {
                queryStrings.Add("labelNamePrefix=" + FGenericPlatformHttp::UrlEncode(this->Request->GetLabelNamePrefix().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeLabelValuesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
