...
#include "Log/Task/Rest/CountAccessLogTask.h"
...
{
    FCountAccessLogTask::FCountAccessLogTask(
    ...
    Core::Model::FGs2ErrorPtr FCountAccessLogTask::Action(
        const TSharedPtr<Result::FCountAccessLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/access/count");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCountAccessLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
