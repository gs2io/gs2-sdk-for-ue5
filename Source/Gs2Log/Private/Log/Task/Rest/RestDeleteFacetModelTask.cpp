...
#include "Log/Task/Rest/DeleteFacetModelTask.h"
...
{
    FDeleteFacetModelTask::FDeleteFacetModelTask(
    ...
    FDeleteFacetModelTask::FDeleteFacetModelTask(
        const FDeleteFacetModelTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDeleteFacetModelTask::Action(
        const TSharedPtr<Result::FDeleteFacetModelResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteFacetModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
