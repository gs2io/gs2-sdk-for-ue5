...
#include "Log/Task/Rest/GetLogTask.h"
...
namespace Gs2::Log::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetLogTask::Action(
        const TSharedPtr<Result::FGetLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/v2/query/{logRequestId}");
            ...
            Url = Url.Replace(
                TEXT("{logRequestId}"),
                !this->Request->GetLogRequestId().IsSet() || this->Request->GetLogRequestId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetLogRequestId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
