...
#include "Log/Task/Rest/CountIssueStampSheetLogTask.h"
...
{
    FCountIssueStampSheetLogTask::FCountIssueStampSheetLogTask(
    ...
    FCountIssueStampSheetLogTask::FCountIssueStampSheetLogTask(
        const FCountIssueStampSheetLogTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FCountIssueStampSheetLogTask::Action(
        const TSharedPtr<Result::FCountIssueStampSheetLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/issue/stamp/sheet/count");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCountIssueStampSheetLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
