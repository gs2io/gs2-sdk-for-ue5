...
#include "Log/Task/Rest/DuplicateDashboardTask.h"
...
{
    FDuplicateDashboardTask::FDuplicateDashboardTask(
    ...
    Core::Model::FGs2ErrorPtr FDuplicateDashboardTask::Action(
        const TSharedPtr<Result::FDuplicateDashboardResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/dashboard/{dashboardName}/copy");
            ...
            Url = Url.Replace(
                TEXT("{dashboardName}"),
                !this->Request->GetDashboardName().IsSet() || this->Request->GetDashboardName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetDashboardName())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDuplicateDashboardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
