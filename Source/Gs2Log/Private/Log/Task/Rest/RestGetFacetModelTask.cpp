...
#include "Log/Task/Rest/GetFacetModelTask.h"
...
{
    FGetFacetModelTask::FGetFacetModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetFacetModelTask::Action(
        const TSharedPtr<Result::FGetFacetModelResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetFacetModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
