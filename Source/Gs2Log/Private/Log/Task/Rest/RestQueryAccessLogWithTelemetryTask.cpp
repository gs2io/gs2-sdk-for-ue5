...
#include "Log/Task/Rest/QueryAccessLogWithTelemetryTask.h"
...
{
    FQueryAccessLogWithTelemetryTask::FQueryAccessLogWithTelemetryTask(
    ...
    Core::Model::FGs2ErrorPtr FQueryAccessLogWithTelemetryTask::Action(
        const TSharedPtr<Result::FQueryAccessLogWithTelemetryResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/access/telemetry");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FQueryAccessLogWithTelemetryResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
