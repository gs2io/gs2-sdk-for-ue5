...
#include "Log/Task/Rest/UpdateDashboardTask.h"
...
{
    FUpdateDashboardTask::FUpdateDashboardTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateDashboardTask::Action(
        const TSharedPtr<Result::FUpdateDashboardResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateDashboardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
