...
#include "Log/Task/Rest/CountExecuteStampSheetLogTask.h"
...
{
    FCountExecuteStampSheetLogTask::FCountExecuteStampSheetLogTask(
    ...
    Core::Model::FGs2ErrorPtr FCountExecuteStampSheetLogTask::Action(
        const TSharedPtr<Result::FCountExecuteStampSheetLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/execute/stamp/sheet/count");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCountExecuteStampSheetLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
