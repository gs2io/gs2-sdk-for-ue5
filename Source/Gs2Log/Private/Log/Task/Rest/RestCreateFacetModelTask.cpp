...
#include "Log/Task/Rest/CreateFacetModelTask.h"
...
{
    FCreateFacetModelTask::FCreateFacetModelTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateFacetModelTask::Action(
        const TSharedPtr<Result::FCreateFacetModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/facet");
            ...
            if (this->Request->GetField().IsSet())
            {
                JsonRootObject->SetStringField(TEXT("field"), this->Request->GetField().GetValue());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateFacetModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
