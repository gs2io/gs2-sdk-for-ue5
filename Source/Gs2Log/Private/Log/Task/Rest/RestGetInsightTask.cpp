...
#include "Log/Task/Rest/GetInsightTask.h"
...
{
    FGetInsightTask::FGetInsightTask(
    ...
    Core::Model::FGs2ErrorPtr FGetInsightTask::Action(
        const TSharedPtr<Result::FGetInsightResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetInsightResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
