...
#include "Log/Task/Rest/DeleteDashboardTask.h"
...
{
    FDeleteDashboardTask::FDeleteDashboardTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteDashboardTask::Action(
        const TSharedPtr<Result::FDeleteDashboardResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/dashboard/{dashboardName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteDashboardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
