...
#include "Log/Task/Rest/QueryAccessLogTask.h"
...
{
    FQueryAccessLogTask::FQueryAccessLogTask(
    ...
    Core::Model::FGs2ErrorPtr FQueryAccessLogTask::Action(
        const TSharedPtr<Result::FQueryAccessLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/access");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FQueryAccessLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
