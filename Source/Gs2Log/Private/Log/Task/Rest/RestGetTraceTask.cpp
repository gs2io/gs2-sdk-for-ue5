...
#include "Log/Task/Rest/GetTraceTask.h"
...
namespace Gs2::Log::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetTraceTask::Action(
        const TSharedPtr<Result::FGetTraceResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/v2/trace/{traceId}");
            ...
            Url = Url.Replace(
                TEXT("{traceId}"),
                !this->Request->GetTraceId().IsSet() || this->Request->GetTraceId().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetTraceId())
            );
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetTraceResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
