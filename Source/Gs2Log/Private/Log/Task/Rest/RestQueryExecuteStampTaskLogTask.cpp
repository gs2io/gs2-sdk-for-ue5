...
#include "Log/Task/Rest/QueryExecuteStampTaskLogTask.h"
...
{
    FQueryExecuteStampTaskLogTask::FQueryExecuteStampTaskLogTask(
    ...
    FQueryExecuteStampTaskLogTask::FQueryExecuteStampTaskLogTask(
        const FQueryExecuteStampTaskLogTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FQueryExecuteStampTaskLogTask::Action(
        const TSharedPtr<Result::FQueryExecuteStampTaskLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/execute/stamp/task");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FQueryExecuteStampTaskLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
