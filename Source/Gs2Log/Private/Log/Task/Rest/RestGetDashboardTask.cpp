...
#include "Log/Task/Rest/GetDashboardTask.h"
...
{
    FGetDashboardTask::FGetDashboardTask(
    ...
    Core::Model::FGs2ErrorPtr FGetDashboardTask::Action(
        const TSharedPtr<Result::FGetDashboardResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetDashboardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
