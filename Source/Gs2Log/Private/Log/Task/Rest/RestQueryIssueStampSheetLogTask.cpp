...
#include "Log/Task/Rest/QueryIssueStampSheetLogTask.h"
...
{
    FQueryIssueStampSheetLogTask::FQueryIssueStampSheetLogTask(
    ...
    Core::Model::FGs2ErrorPtr FQueryIssueStampSheetLogTask::Action(
        const TSharedPtr<Result::FQueryIssueStampSheetLogResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/log/issue/stamp/sheet");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FQueryIssueStampSheetLogResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
