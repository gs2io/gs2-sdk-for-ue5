...
namespace Gs2::Log::Domain::Model
{
    ...
    FUserAccessTokenDomain::FSendInGameLogTask::FSendInGameLogTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FUserAccessTokenDomain::FSendInGameLogTask::Action(
    ...
    TSharedPtr<FAsyncTask<FUserAccessTokenDomain::FSendInGameLogTask>> FUserAccessTokenDomain::SendInGameLog(
