...
namespace Gs2::Log::Domain::Model
{
    ...
    FInGameLogAccessTokenDomain::FInGameLogAccessTokenDomain(
    ...
    FInGameLogAccessTokenDomain::FInGameLogAccessTokenDomain(
        const FInGameLogAccessTokenDomain& From
    ):
        Gs2(From.Gs2),
    ...
    FString FInGameLogAccessTokenDomain::CreateCacheParentKey(
    ...
    FString FInGameLogAccessTokenDomain::CreateCacheKey(
        TOptional<FString> RequestId
    )
    {
        return FString("") +
    ...
    FInGameLogAccessTokenDomain::FModelTask::FModelTask(
        const TSharedPtr<FInGameLogAccessTokenDomain> Self
    ): Self(Self)
    {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FInGameLogAccessTokenDomain::FModelTask::Action(
    ...
    TSharedPtr<FAsyncTask<FInGameLogAccessTokenDomain::FModelTask>> FInGameLogAccessTokenDomain::Model() {
        return Gs2::Core::Util::New<FAsyncTask<FInGameLogAccessTokenDomain::FModelTask>>(this->AsShared());
    }

    void FInGameLogAccessTokenDomain::Invalidate()
    {
    ...
    FInGameLogAccessTokenDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FInGameLogAccessTokenDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FInGameLogAccessTokenDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FInGameLogAccessTokenDomain::FSubscribeWithInitialCallTask>> FInGameLogAccessTokenDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Log::Model::FInGameLogPtr)> Callback
    )
    {
    ...
    Gs2::Core::Domain::CallbackID FInGameLogAccessTokenDomain::Subscribe(
        TFunction<void(Gs2::Log::Model::FInGameLogPtr)> Callback
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryRequestId, SourceToken, RegisteredUserId, RegisteredTimeOffset]()
            {
                ...
                const auto Domain = MakeShared<FInGameLogAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    TokenSnapshot,
    ...
    void FInGameLogAccessTokenDomain::Unsubscribe(
