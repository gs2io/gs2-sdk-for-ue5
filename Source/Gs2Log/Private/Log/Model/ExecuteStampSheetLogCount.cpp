...
#include "Log/Model/ExecuteStampSheetLogCount.h"

namespace Gs2::Log::Model
{
    FExecuteStampSheetLogCount::FExecuteStampSheetLogCount():
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::WithService(
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::WithMethod(
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::WithUserId(
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::WithAction(
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::WithCount(
    ...
    TOptional<FString> FExecuteStampSheetLogCount::GetService() const
    {
        return ServiceValue;
    }
    TOptional<FString> FExecuteStampSheetLogCount::GetMethod() const
    {
        return MethodValue;
    }
    TOptional<FString> FExecuteStampSheetLogCount::GetUserId() const
    {
        return UserIdValue;
    }
    TOptional<FString> FExecuteStampSheetLogCount::GetAction() const
    {
        return ActionValue;
    }
    TOptional<int64> FExecuteStampSheetLogCount::GetCount() const
    {
        return CountValue;
    }

    FString FExecuteStampSheetLogCount::GetCountString() const
    {
        if (!CountValue.IsSet())
        {
            return FString("null");
    ...
    TSharedPtr<FExecuteStampSheetLogCount> FExecuteStampSheetLogCount::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FExecuteStampSheetLogCount>()
    ...
    TSharedPtr<FJsonObject> FExecuteStampSheetLogCount::ToJson() const
    {
    ...
    FString FExecuteStampSheetLogCount::TypeName = "ExecuteStampSheetLogCount";
}