...
namespace Gs2::Log::Model
{
    ...
    TSharedPtr<FJsonObject> FInsight::ToJson() const
    {
        ...
        {
            JsonRootObject->SetStringField(TEXT("insightId"), InsightIdValue.GetValue());
        }
        if (NameValue.IsSet())
        {
        ...
        if (HostValue.IsSet())
        {
            JsonRootObject->SetStringField(TEXT("host"), HostValue.GetValue());
        }
...
namespace Gs2::Log::Model::Cache
{
    ...
    FString FInsightCache::PutUserData(
        const Gs2::Core::Domain::FCacheDatabasePtr& Cache,
        TOptional<FString> NamespaceName,
        TOptional<FString> UserId,
        TOptional<int32> TimeOffset,
        const Gs2::Log::Model::FInsightPtr& Item
    )
    {
