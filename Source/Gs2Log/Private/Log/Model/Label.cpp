...
namespace Gs2::Log::Model
{
    ...
    TSharedPtr<FLabel> FLabel::WithKey(
    ...
    TSharedPtr<FLabel> FLabel::WithValue(
    ...
    TOptional<FString> FLabel::GetKey() const
    {
        return KeyValue;
    }
    TOptional<FString> FLabel::GetValue() const
    {
        return ValueValue;
    }

    TSharedPtr<FLabel> FLabel::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FLabel>()
    ...
    TSharedPtr<FJsonObject> FLabel::ToJson() const
    {
