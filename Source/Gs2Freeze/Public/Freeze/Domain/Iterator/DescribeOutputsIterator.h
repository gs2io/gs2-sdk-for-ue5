...
namespace Gs2::Freeze::Domain::Iterator
{
    ...
    class GS2FREEZE_API FDescribeOutputsIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Freeze::Model::FOutput>> Result) override;
        ...
        class GS2FREEZE_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Freeze::Model::FOutputPtr>> Range;
            TOptional<TArray<Gs2::Freeze::Model::FOutputPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Freeze::Model::FOutputPtr& Current()
            {
