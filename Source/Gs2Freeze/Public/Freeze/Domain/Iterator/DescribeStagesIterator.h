...
namespace Gs2::Freeze::Domain::Iterator
{
    ...
    class GS2FREEZE_API FDescribeStagesIterator :
        public TSharedFromThis<FDescribeStagesIterator>
    {
        const TSharedPtr<Core::Domain::FGs2> Gs2;
        const Gs2::Freeze::FGs2FreezeRestClientPtr Client;

    public:
        FDescribeStagesIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Freeze::FGs2FreezeRestClientPtr Client
        );
        ...
        class GS2FREEZE_API FIteratorNextTask :
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Freeze::Model::FStage>> Result) override;
        ...
        class GS2FREEZE_API FIterator
        {
            TSharedRef<FDescribeStagesIterator> Self;
            TSharedPtr<TArray<Gs2::Freeze::Model::FStagePtr>> Range;
            TOptional<TArray<Gs2::Freeze::Model::FStagePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Freeze::Model::FStagePtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeStagesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeStagesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeStagesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeStagesIterator> FDescribeStagesIteratorPtr;
}
