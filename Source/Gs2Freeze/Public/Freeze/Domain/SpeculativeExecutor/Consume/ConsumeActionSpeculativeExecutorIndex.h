...
{
    class GS2FREEZE_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
        ...
        public:
            GS2FREEZE_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Freeze::Domain::FGs2FreezeDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2FREEZE_API FCommitTask(
                const FCommitTask& From
            );

            GS2FREEZE_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
