...
#include "Freeze/Task/Rest/GetStageTask.h"
...
namespace Gs2::Freeze::Task::Rest
{
    ...
    Core::Model::FGs2ErrorPtr FGetStageTask::Action(
        const TSharedPtr<Result::FGetStageResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetStageResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
