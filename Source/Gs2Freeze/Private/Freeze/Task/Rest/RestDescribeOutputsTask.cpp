...
#include "Freeze/Task/Rest/DescribeOutputsTask.h"
...
{
    FDescribeOutputsTask::FDescribeOutputsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeOutputsTask::Action(
        const TSharedPtr<Result::FDescribeOutputsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{stageName}/progress/output");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeOutputsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
