...
#include "Freeze/Task/Rest/RollbackStageTask.h"
...
{
    FRollbackStageTask::FRollbackStageTask(
    ...
    FRollbackStageTask::FRollbackStageTask(
        const FRollbackStageTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FRollbackStageTask::Action(
        const TSharedPtr<Result::FRollbackStageResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FRollbackStageResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
