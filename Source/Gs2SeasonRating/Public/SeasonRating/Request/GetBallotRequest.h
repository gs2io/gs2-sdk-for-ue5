...
namespace Gs2::SeasonRating::Request
{
    ...
    class GS2SEASONRATING_API FGetBallotRequest final : public TSharedFromThis<FGetBallotRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetBallotRequest> WithSeasonName(const TOptional<FString> SeasonName);
        TSharedPtr<FGetBallotRequest> WithSessionName(const TOptional<FString> SessionName);
    ...
    typedef TSharedPtr<FGetBallotRequest> FGetBallotRequestPtr;
}