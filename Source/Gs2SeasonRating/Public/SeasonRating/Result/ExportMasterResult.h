...
{
    class GS2SEASONRATING_API FExportMasterResult final : public TSharedFromThis<FExportMasterResult>
    {
    ...
    public:
        ...
        TSharedPtr<FExportMasterResult> WithItem(const TSharedPtr<Model::FCurrentSeasonModelMaster> Item);
