...
namespace Gs2::SeasonRating::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SeasonRating::Model::FNamespace>> Result) override;
        ...
        class GS2SEASONRATING_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::SeasonRating::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::SeasonRating::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SeasonRating::Model::FNamespacePtr& Current()
            {
