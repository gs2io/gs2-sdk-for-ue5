...
namespace Gs2::SeasonRating::Domain::Iterator
{
    ...
    class GS2SEASONRATING_API FDescribeSeasonModelsIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SeasonRating::Model::FSeasonModel>> Result) override;
        ...
        class GS2SEASONRATING_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::SeasonRating::Model::FSeasonModelPtr>> Range;
            TOptional<TArray<Gs2::SeasonRating::Model::FSeasonModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SeasonRating::Model::FSeasonModelPtr& Current()
            {
