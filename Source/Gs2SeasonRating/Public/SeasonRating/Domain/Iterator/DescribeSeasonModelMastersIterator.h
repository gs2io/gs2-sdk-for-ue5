...
namespace Gs2::SeasonRating::Domain::Iterator
{
    ...
    class GS2SEASONRATING_API FDescribeSeasonModelMastersIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SeasonRating::Model::FSeasonModelMaster>> Result) override;
        ...
        class GS2SEASONRATING_API FIterator
        {
            TSharedRef<FDescribeSeasonModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::SeasonRating::Model::FSeasonModelMasterPtr>> Range;
            TOptional<TArray<Gs2::SeasonRating::Model::FSeasonModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SeasonRating::Model::FSeasonModelMasterPtr& Current()
            {
