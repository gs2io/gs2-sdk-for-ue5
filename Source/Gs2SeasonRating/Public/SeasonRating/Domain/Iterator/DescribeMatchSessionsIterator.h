...
namespace Gs2::SeasonRating::Domain::Iterator
{
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::SeasonRating::Model::FMatchSession>> Result) override;
        ...
        {
            TSharedRef<FDescribeMatchSessionsIterator> Self;
            TSharedPtr<TArray<Gs2::SeasonRating::Model::FMatchSessionPtr>> Range;
            TOptional<TArray<Gs2::SeasonRating::Model::FMatchSessionPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::SeasonRating::Model::FMatchSessionPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeMatchSessionsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeMatchSessionsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeMatchSessionsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeMatchSessionsIterator> FDescribeMatchSessionsIteratorPtr;
}
