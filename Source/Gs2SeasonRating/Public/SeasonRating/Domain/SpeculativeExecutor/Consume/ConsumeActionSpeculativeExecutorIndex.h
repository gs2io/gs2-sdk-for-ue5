...
namespace Gs2::SeasonRating::Domain::SpeculativeExecutor
{
    class GS2SEASONRATING_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::SeasonRating::Domain::FGs2SeasonRatingDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2SEASONRATING_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::SeasonRating::Domain::FGs2SeasonRatingDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2SEASONRATING_API FCommitTask(
                const FCommitTask& From
            );

            GS2SEASONRATING_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
