...
#include "SeasonRating/Request/DescribeNamespacesRequest.h"
#include "SeasonRating/Result/DescribeNamespacesResult.h"

namespace Gs2::SeasonRating::Task::Rest
{
    class GS2SEASONRATING_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
