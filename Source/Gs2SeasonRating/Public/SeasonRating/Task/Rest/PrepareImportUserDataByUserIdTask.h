...
#include "SeasonRating/Request/PrepareImportUserDataByUserIdRequest.h"
#include "SeasonRating/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::Rest
{
    class GS2SEASONRATING_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
