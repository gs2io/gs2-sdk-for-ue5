...
#include "SeasonRating/Request/GetNamespaceStatusRequest.h"
#include "SeasonRating/Result/GetNamespaceStatusResult.h"

namespace Gs2::SeasonRating::Task::Rest
{
    class GS2SEASONRATING_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
