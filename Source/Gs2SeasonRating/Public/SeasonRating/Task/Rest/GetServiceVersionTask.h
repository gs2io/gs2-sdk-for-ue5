...
#include "SeasonRating/Request/GetServiceVersionRequest.h"
#include "SeasonRating/Result/GetServiceVersionResult.h"

namespace Gs2::SeasonRating::Task::Rest
{
    class GS2SEASONRATING_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
