...
#include "SeasonRating/Request/CreateNamespaceRequest.h"
#include "SeasonRating/Result/CreateNamespaceResult.h"

namespace Gs2::SeasonRating::Task::Rest
{
    class GS2SEASONRATING_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
