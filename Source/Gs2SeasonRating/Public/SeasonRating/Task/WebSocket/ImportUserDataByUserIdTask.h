...
#include "SeasonRating/Request/ImportUserDataByUserIdRequest.h"
#include "SeasonRating/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
