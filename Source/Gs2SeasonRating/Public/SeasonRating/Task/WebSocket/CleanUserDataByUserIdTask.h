...
#include "SeasonRating/Request/CleanUserDataByUserIdRequest.h"
#include "SeasonRating/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
