...
#include "SeasonRating/Request/CheckDumpUserDataByUserIdRequest.h"
#include "SeasonRating/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
