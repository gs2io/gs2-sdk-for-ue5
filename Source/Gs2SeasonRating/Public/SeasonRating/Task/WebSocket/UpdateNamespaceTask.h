...
#include "SeasonRating/Request/UpdateNamespaceRequest.h"
#include "SeasonRating/Result/UpdateNamespaceResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FUpdateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FUpdateNamespaceResult>
    {
