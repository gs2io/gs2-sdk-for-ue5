...
#include "SeasonRating/Request/DumpUserDataByUserIdRequest.h"
#include "SeasonRating/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
