...
#include "SeasonRating/Request/GetNamespaceRequest.h"
#include "SeasonRating/Result/GetNamespaceResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
