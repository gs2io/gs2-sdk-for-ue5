...
#include "SeasonRating/Request/CheckImportUserDataByUserIdRequest.h"
#include "SeasonRating/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
