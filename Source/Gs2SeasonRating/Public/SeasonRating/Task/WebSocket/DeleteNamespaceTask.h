...
#include "SeasonRating/Request/DeleteNamespaceRequest.h"
#include "SeasonRating/Result/DeleteNamespaceResult.h"

namespace Gs2::SeasonRating::Task::WebSocket
{
    class GS2SEASONRATING_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
