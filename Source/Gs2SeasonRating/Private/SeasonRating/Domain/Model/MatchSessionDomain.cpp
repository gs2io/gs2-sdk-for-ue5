...
namespace Gs2::SeasonRating::Domain::Model
{
    ...
    FMatchSessionDomain::FCreateTask::FCreateTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FMatchSessionDomain::FCreateTask::Action(
    ...
    TSharedPtr<FAsyncTask<FMatchSessionDomain::FCreateTask>> FMatchSessionDomain::Create(
