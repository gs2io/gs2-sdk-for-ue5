...
#include "SeasonRating/Task/Rest/UpdateSeasonModelMasterTask.h"
    ...
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/rating/{seasonName}");
            ...
            if (this->Request->GetTiers() != nullptr && this->Request->GetTiers().IsValid())
            {
                TArray<TSharedPtr<FJsonValue>> v;
                for (auto JsonObjectValue : *this->Request->GetTiers())
                {
