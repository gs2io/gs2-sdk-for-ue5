...
#include "SeasonRating/Task/WebSocket/GetBallotByUserIdTask.h"
...
namespace Gs2::SeasonRating::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("seasonRating"), TEXT("ballot"), TEXT("getBallotByUserId"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FGetBallotByUserIdResult::FromJson(WebSocketResult->Body());
