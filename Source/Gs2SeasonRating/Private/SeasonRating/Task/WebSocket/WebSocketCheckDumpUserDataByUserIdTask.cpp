...
#include "SeasonRating/Task/WebSocket/CheckDumpUserDataByUserIdTask.h"
...
namespace Gs2::SeasonRating::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("seasonRating"), TEXT("namespace"), TEXT("checkDumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
