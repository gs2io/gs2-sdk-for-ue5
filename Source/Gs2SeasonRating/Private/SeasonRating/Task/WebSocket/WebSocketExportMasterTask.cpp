...
#include "SeasonRating/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::SeasonRating::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("seasonRating"), TEXT("currentSeasonModelMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
