...
#include "SeasonRating/Task/WebSocket/DumpUserDataByUserIdTask.h"
...
namespace Gs2::SeasonRating::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("seasonRating"), TEXT("namespace"), TEXT("dumpUserDataByUserId"), ToCStr(RequestPayload->Payload()));
