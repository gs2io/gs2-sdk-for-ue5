...
namespace Gs2::SeasonRating::Model::Cache
{
    ...
    )
    {
        ...
        if (CacheOwnerArgumentOutItem) *CacheOwnerArgumentOutItem = nullptr;
        Gs2::SeasonRating::Model::FSeasonModelMasterPtr CacheOwnerValue;
        const bool CacheOwnerFound = CacheSnapshot->TryGet<Gs2::SeasonRating::Model::FSeasonModelMaster>(
    ...
    )
    {
        ...
        Gs2::SeasonRating::Model::FSeasonModelMasterPtr CacheOwnerExisting;
        if (CacheSnapshot->TryGet<Gs2::SeasonRating::Model::FSeasonModelMaster>(CacheOwnerParentKey, CacheOwnerKey, &CacheOwnerExisting))
        {
        ...
        CacheSnapshot->Put(Gs2::SeasonRating::Model::FSeasonModelMaster::TypeName, CacheOwnerParentKey, CacheOwnerKey, CacheOwnerValue,
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->Delete(Gs2::SeasonRating::Model::FSeasonModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), CreateCacheKey(
            CacheOwnerArgumentSeasonName
    ...
    )
    {
        ...
        Gs2::SeasonRating::Model::FSeasonModelMasterPtr CacheOwnerFetchedItem;
    ...
    )
    {
        ...
        return CacheSnapshot->ListSubscribeTyped(Gs2::SeasonRating::Model::FSeasonModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
        ), [CacheOwnerArgumentCallback](const TArray<FGs2ObjectPtr>& CacheOwnerValues)
        {
            TArray<Gs2::SeasonRating::Model::FSeasonModelMasterPtr> CacheOwnerTypedValues;
            for (const auto& CacheOwnerValue : CacheOwnerValues) if (CacheOwnerValue) CacheOwnerTypedValues.Add(StaticCastSharedPtr<Gs2::SeasonRating::Model::FSeasonModelMaster>(CacheOwnerValue));
    ...
    )
    {
        const auto CacheSnapshot = CacheOwnerArgumentCache;
        if (!CacheSnapshot.IsValid()) return;
        CacheSnapshot->ListUnsubscribe(Gs2::SeasonRating::Model::FSeasonModelMaster::TypeName, CreateCacheParentKey(
            CacheOwnerArgumentNamespaceName,
            CacheOwnerArgumentTimeOffset
