...
#include "Ranking2/Task/Rest/VerifyClusterRankingScoreByUserIdTask.h"
...
{
    FVerifyClusterRankingScoreByUserIdTask::FVerifyClusterRankingScoreByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyClusterRankingScoreByUserIdTask::Action(
        const TSharedPtr<Result::FVerifyClusterRankingScoreByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/cluster/{rankingName}/{clusterName}/verify/{verifyType}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyClusterRankingScoreByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
