...
#include "Ranking2/Task/Rest/DescribeSubscribesByUserIdTask.h"
...
{
    FDescribeSubscribesByUserIdTask::FDescribeSubscribesByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSubscribesByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeSubscribesByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/subscribe/score");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSubscribesByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
