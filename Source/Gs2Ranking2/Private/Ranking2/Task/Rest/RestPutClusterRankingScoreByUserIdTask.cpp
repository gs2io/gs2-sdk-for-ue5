...
#include "Ranking2/Task/Rest/PutClusterRankingScoreByUserIdTask.h"
...
{
    FPutClusterRankingScoreByUserIdTask::FPutClusterRankingScoreByUserIdTask(
    ...
    FPutClusterRankingScoreByUserIdTask::FPutClusterRankingScoreByUserIdTask(
        const FPutClusterRankingScoreByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FPutClusterRankingScoreByUserIdTask::Action(
        const TSharedPtr<Result::FPutClusterRankingScoreByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPutClusterRankingScoreByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
