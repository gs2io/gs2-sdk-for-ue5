...
#include "Ranking2/Task/Rest/DescribeSubscribeRankingScoresTask.h"
...
{
    FDescribeSubscribeRankingScoresTask::FDescribeSubscribeRankingScoresTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSubscribeRankingScoresTask::Action(
        const TSharedPtr<Result::FDescribeSubscribeRankingScoresResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/score/subscribe");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSubscribeRankingScoresResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
