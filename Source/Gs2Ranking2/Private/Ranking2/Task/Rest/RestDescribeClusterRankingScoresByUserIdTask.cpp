...
#include "Ranking2/Task/Rest/DescribeClusterRankingScoresByUserIdTask.h"
...
{
    FDescribeClusterRankingScoresByUserIdTask::FDescribeClusterRankingScoresByUserIdTask(
    ...
    FDescribeClusterRankingScoresByUserIdTask::FDescribeClusterRankingScoresByUserIdTask(
        const FDescribeClusterRankingScoresByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDescribeClusterRankingScoresByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingScoresByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/cluster");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingScoresByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
