...
#include "Ranking2/Task/Rest/ReceiveClusterRankingReceivedRewardTask.h"
...
{
    FReceiveClusterRankingReceivedRewardTask::FReceiveClusterRankingReceivedRewardTask(
    ...
    Core::Model::FGs2ErrorPtr FReceiveClusterRankingReceivedRewardTask::Action(
        const TSharedPtr<Result::FReceiveClusterRankingReceivedRewardResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/cluster/reward/received/{rankingName}/{clusterName}/{season}/reward/receive");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReceiveClusterRankingReceivedRewardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
