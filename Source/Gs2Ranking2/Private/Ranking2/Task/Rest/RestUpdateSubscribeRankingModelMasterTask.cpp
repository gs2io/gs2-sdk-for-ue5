...
#include "Ranking2/Task/Rest/UpdateSubscribeRankingModelMasterTask.h"
...
{
    FUpdateSubscribeRankingModelMasterTask::FUpdateSubscribeRankingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FUpdateSubscribeRankingModelMasterTask::Action(
        const TSharedPtr<Result::FUpdateSubscribeRankingModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/subscribe/{rankingName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FUpdateSubscribeRankingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
