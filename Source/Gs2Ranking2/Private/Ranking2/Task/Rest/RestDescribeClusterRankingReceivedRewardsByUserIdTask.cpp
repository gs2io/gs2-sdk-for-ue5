...
#include "Ranking2/Task/Rest/DescribeClusterRankingReceivedRewardsByUserIdTask.h"
...
{
    FDescribeClusterRankingReceivedRewardsByUserIdTask::FDescribeClusterRankingReceivedRewardsByUserIdTask(
    ...
    FDescribeClusterRankingReceivedRewardsByUserIdTask::FDescribeClusterRankingReceivedRewardsByUserIdTask(
        const FDescribeClusterRankingReceivedRewardsByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FDescribeClusterRankingReceivedRewardsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingReceivedRewardsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/cluster/reward/received");
            ...
            if (this->Request->GetRankingName().IsSet()) {
                queryStrings.Add("rankingName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetRankingName().GetValue()));
            }
            if (this->Request->GetClusterName().IsSet()) {
                queryStrings.Add("clusterName=" + FGenericPlatformHttp::UrlEncode(this->Request->GetClusterName().GetValue()));
            }
            if (this->Request->GetSeason().IsSet()) {
                queryStrings.Add("season=" + this->Request->GetSeasonString());
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingReceivedRewardsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
