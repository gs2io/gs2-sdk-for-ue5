...
#include "Ranking2/Task/Rest/DescribeGlobalRankingReceivedRewardsByUserIdTask.h"
...
{
    FDescribeGlobalRankingReceivedRewardsByUserIdTask::FDescribeGlobalRankingReceivedRewardsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeGlobalRankingReceivedRewardsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeGlobalRankingReceivedRewardsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/global/reward/received");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeGlobalRankingReceivedRewardsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
