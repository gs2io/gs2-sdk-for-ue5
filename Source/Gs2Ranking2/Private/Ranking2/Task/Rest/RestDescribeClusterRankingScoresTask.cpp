...
#include "Ranking2/Task/Rest/DescribeClusterRankingScoresTask.h"
...
{
    FDescribeClusterRankingScoresTask::FDescribeClusterRankingScoresTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeClusterRankingScoresTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingScoresResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/score/cluster");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingScoresResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
