...
#include "Ranking2/Task/Rest/DescribeGlobalRankingReceivedRewardsTask.h"
...
{
    FDescribeGlobalRankingReceivedRewardsTask::FDescribeGlobalRankingReceivedRewardsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeGlobalRankingReceivedRewardsTask::Action(
        const TSharedPtr<Result::FDescribeGlobalRankingReceivedRewardsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/global/reward/received");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeGlobalRankingReceivedRewardsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
