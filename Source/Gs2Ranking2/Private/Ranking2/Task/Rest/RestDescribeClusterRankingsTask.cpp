...
#include "Ranking2/Task/Rest/DescribeClusterRankingsTask.h"
...
{
    FDescribeClusterRankingsTask::FDescribeClusterRankingsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeClusterRankingsTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/cluster/{rankingName}/{clusterName}/user/me");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
