...
#include "Ranking2/Task/Rest/CreateGlobalRankingModelMasterTask.h"
...
{
    FCreateGlobalRankingModelMasterTask::FCreateGlobalRankingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateGlobalRankingModelMasterTask::Action(
        const TSharedPtr<Result::FCreateGlobalRankingModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/global");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateGlobalRankingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
