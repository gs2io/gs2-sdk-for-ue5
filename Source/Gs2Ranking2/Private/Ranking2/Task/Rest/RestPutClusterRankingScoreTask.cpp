...
#include "Ranking2/Task/Rest/PutClusterRankingScoreTask.h"
...
{
    FPutClusterRankingScoreTask::FPutClusterRankingScoreTask(
    ...
    Core::Model::FGs2ErrorPtr FPutClusterRankingScoreTask::Action(
        const TSharedPtr<Result::FPutClusterRankingScoreResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FPutClusterRankingScoreResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
