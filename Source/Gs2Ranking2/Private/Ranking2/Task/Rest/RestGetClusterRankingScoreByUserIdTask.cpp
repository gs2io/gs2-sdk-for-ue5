...
#include "Ranking2/Task/Rest/GetClusterRankingScoreByUserIdTask.h"
...
{
    FGetClusterRankingScoreByUserIdTask::FGetClusterRankingScoreByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetClusterRankingScoreByUserIdTask::Action(
        const TSharedPtr<Result::FGetClusterRankingScoreByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/cluster/{rankingName}/{clusterName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingScoreByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
