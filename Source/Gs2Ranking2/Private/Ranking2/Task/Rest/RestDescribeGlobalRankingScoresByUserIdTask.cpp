...
#include "Ranking2/Task/Rest/DescribeGlobalRankingScoresByUserIdTask.h"
...
{
    FDescribeGlobalRankingScoresByUserIdTask::FDescribeGlobalRankingScoresByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeGlobalRankingScoresByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeGlobalRankingScoresByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/global");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeGlobalRankingScoresByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
