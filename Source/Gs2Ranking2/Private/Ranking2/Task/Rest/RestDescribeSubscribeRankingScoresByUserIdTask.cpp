...
#include "Ranking2/Task/Rest/DescribeSubscribeRankingScoresByUserIdTask.h"
...
{
    FDescribeSubscribeRankingScoresByUserIdTask::FDescribeSubscribeRankingScoresByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSubscribeRankingScoresByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeSubscribeRankingScoresByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/subscribe");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSubscribeRankingScoresByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
