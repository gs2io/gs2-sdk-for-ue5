...
#include "Ranking2/Task/Rest/GetClusterRankingReceivedRewardTask.h"
...
{
    FGetClusterRankingReceivedRewardTask::FGetClusterRankingReceivedRewardTask(
    ...
    Core::Model::FGs2ErrorPtr FGetClusterRankingReceivedRewardTask::Action(
        const TSharedPtr<Result::FGetClusterRankingReceivedRewardResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/cluster/reward/received/{rankingName}/{clusterName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingReceivedRewardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
