...
#include "Ranking2/Task/Rest/CreateClusterRankingReceivedRewardTask.h"
...
{
    FCreateClusterRankingReceivedRewardTask::FCreateClusterRankingReceivedRewardTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateClusterRankingReceivedRewardTask::Action(
        const TSharedPtr<Result::FCreateClusterRankingReceivedRewardResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateClusterRankingReceivedRewardResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
