...
#include "Ranking2/Task/Rest/ReceiveClusterRankingReceivedRewardByUserIdTask.h"
...
{
    FReceiveClusterRankingReceivedRewardByUserIdTask::FReceiveClusterRankingReceivedRewardByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FReceiveClusterRankingReceivedRewardByUserIdTask::Action(
        const TSharedPtr<Result::FReceiveClusterRankingReceivedRewardByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/cluster/reward/received/{rankingName}/{clusterName}/{season}/reward/receive");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FReceiveClusterRankingReceivedRewardByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
