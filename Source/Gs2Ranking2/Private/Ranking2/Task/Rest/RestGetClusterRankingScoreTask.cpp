...
#include "Ranking2/Task/Rest/GetClusterRankingScoreTask.h"
...
{
    FGetClusterRankingScoreTask::FGetClusterRankingScoreTask(
    ...
    FGetClusterRankingScoreTask::FGetClusterRankingScoreTask(
        const FGetClusterRankingScoreTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetClusterRankingScoreTask::Action(
        const TSharedPtr<Result::FGetClusterRankingScoreResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/score/cluster/{rankingName}/{clusterName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingScoreResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
