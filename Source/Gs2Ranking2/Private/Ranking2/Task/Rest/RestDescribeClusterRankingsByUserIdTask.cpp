...
#include "Ranking2/Task/Rest/DescribeClusterRankingsByUserIdTask.h"
...
{
    FDescribeClusterRankingsByUserIdTask::FDescribeClusterRankingsByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeClusterRankingsByUserIdTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingsByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/cluster/{rankingName}/{clusterName}/user/{userId}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingsByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
