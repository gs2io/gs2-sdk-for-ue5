...
#include "Ranking2/Task/Rest/VerifyClusterRankingScoreTask.h"
...
{
    FVerifyClusterRankingScoreTask::FVerifyClusterRankingScoreTask(
    ...
    Core::Model::FGs2ErrorPtr FVerifyClusterRankingScoreTask::Action(
        const TSharedPtr<Result::FVerifyClusterRankingScoreResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FVerifyClusterRankingScoreResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
