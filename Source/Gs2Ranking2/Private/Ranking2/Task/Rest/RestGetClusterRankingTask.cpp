...
#include "Ranking2/Task/Rest/GetClusterRankingTask.h"
...
{
    FGetClusterRankingTask::FGetClusterRankingTask(
    ...
    Core::Model::FGs2ErrorPtr FGetClusterRankingTask::Action(
        const TSharedPtr<Result::FGetClusterRankingResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/cluster/{rankingName}/{clusterName}/user/me/rank");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
