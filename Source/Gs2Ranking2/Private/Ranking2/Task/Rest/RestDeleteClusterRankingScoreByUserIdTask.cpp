...
#include "Ranking2/Task/Rest/DeleteClusterRankingScoreByUserIdTask.h"
...
{
    FDeleteClusterRankingScoreByUserIdTask::FDeleteClusterRankingScoreByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteClusterRankingScoreByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteClusterRankingScoreByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/score/cluster/{rankingName}/{clusterName}/{season}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteClusterRankingScoreByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
