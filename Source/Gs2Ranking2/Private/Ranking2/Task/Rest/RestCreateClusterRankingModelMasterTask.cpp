...
#include "Ranking2/Task/Rest/CreateClusterRankingModelMasterTask.h"
...
{
    FCreateClusterRankingModelMasterTask::FCreateClusterRankingModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateClusterRankingModelMasterTask::Action(
        const TSharedPtr<Result::FCreateClusterRankingModelMasterResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/master/cluster");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateClusterRankingModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
