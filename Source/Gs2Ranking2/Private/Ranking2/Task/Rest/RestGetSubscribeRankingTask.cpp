...
#include "Ranking2/Task/Rest/GetSubscribeRankingTask.h"
...
{
    FGetSubscribeRankingTask::FGetSubscribeRankingTask(
    ...
    Core::Model::FGs2ErrorPtr FGetSubscribeRankingTask::Action(
        const TSharedPtr<Result::FGetSubscribeRankingResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/subscribe/{rankingName}/user/me/rank");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSubscribeRankingResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
