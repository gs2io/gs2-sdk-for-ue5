...
#include "Ranking2/Task/Rest/GetClusterRankingByUserIdTask.h"
...
{
    FGetClusterRankingByUserIdTask::FGetClusterRankingByUserIdTask(
    ...
    FGetClusterRankingByUserIdTask::FGetClusterRankingByUserIdTask(
        const FGetClusterRankingByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetClusterRankingByUserIdTask::Action(
        const TSharedPtr<Result::FGetClusterRankingByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/cluster/{rankingName}/{clusterName}/user/{userId}/rank");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
