...
#include "Ranking2/Task/Rest/CreateClusterRankingReceivedRewardByUserIdTask.h"
...
{
    FCreateClusterRankingReceivedRewardByUserIdTask::FCreateClusterRankingReceivedRewardByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FCreateClusterRankingReceivedRewardByUserIdTask::Action(
        const TSharedPtr<Result::FCreateClusterRankingReceivedRewardByUserIdResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FCreateClusterRankingReceivedRewardByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
