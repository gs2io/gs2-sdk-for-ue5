...
#include "Ranking2/Task/Rest/GetSubscribeRankingByUserIdTask.h"
...
{
    FGetSubscribeRankingByUserIdTask::FGetSubscribeRankingByUserIdTask(
    ...
    FGetSubscribeRankingByUserIdTask::FGetSubscribeRankingByUserIdTask(
        const FGetSubscribeRankingByUserIdTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetSubscribeRankingByUserIdTask::Action(
        const TSharedPtr<Result::FGetSubscribeRankingByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/ranking/subscribe/{rankingName}/user/{userId}/rank");
            ...
            if (this->Request->GetScorerUserId().IsSet()) {
                queryStrings.Add("scorerUserId=" + FGenericPlatformHttp::UrlEncode(this->Request->GetScorerUserId().GetValue()));
            }
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetSubscribeRankingByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
