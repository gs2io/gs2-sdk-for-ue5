...
#include "Ranking2/Task/Rest/DeleteClusterRankingReceivedRewardByUserIdTask.h"
...
{
    FDeleteClusterRankingReceivedRewardByUserIdTask::FDeleteClusterRankingReceivedRewardByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteClusterRankingReceivedRewardByUserIdTask::Action(
        const TSharedPtr<Result::FDeleteClusterRankingReceivedRewardByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/cluster/reward/received/{rankingName}/{clusterName}/{season}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteClusterRankingReceivedRewardByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
