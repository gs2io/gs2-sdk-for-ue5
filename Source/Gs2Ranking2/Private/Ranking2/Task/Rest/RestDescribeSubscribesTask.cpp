...
#include "Ranking2/Task/Rest/DescribeSubscribesTask.h"
...
{
    FDescribeSubscribesTask::FDescribeSubscribesTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeSubscribesTask::Action(
        const TSharedPtr<Result::FDescribeSubscribesResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/subscribe/score");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeSubscribesResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
