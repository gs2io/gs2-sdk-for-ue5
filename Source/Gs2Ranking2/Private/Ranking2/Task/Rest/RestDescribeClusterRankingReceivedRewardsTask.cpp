...
#include "Ranking2/Task/Rest/DescribeClusterRankingReceivedRewardsTask.h"
...
{
    FDescribeClusterRankingReceivedRewardsTask::FDescribeClusterRankingReceivedRewardsTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeClusterRankingReceivedRewardsTask::Action(
        const TSharedPtr<Result::FDescribeClusterRankingReceivedRewardsResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/cluster/reward/received");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeClusterRankingReceivedRewardsResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
