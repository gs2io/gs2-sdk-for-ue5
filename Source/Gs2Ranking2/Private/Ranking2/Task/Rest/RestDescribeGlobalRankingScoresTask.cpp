...
#include "Ranking2/Task/Rest/DescribeGlobalRankingScoresTask.h"
...
{
    FDescribeGlobalRankingScoresTask::FDescribeGlobalRankingScoresTask(
    ...
    Core::Model::FGs2ErrorPtr FDescribeGlobalRankingScoresTask::Action(
        const TSharedPtr<Result::FDescribeGlobalRankingScoresResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/me/score/global");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDescribeGlobalRankingScoresResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
