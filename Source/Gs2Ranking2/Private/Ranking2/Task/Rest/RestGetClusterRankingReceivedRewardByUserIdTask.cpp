...
#include "Ranking2/Task/Rest/GetClusterRankingReceivedRewardByUserIdTask.h"
...
{
    FGetClusterRankingReceivedRewardByUserIdTask::FGetClusterRankingReceivedRewardByUserIdTask(
    ...
    Core::Model::FGs2ErrorPtr FGetClusterRankingReceivedRewardByUserIdTask::Action(
        const TSharedPtr<Result::FGetClusterRankingReceivedRewardByUserIdResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/user/{userId}/cluster/reward/received/{rankingName}/{clusterName}");
            ...
            Url = Url.Replace(
                TEXT("{clusterName}"),
                !this->Request->GetClusterName().IsSet() || this->Request->GetClusterName().GetValue().Len() == 0 ?
                    TEXT("null") : ToCStr(*this->Request->GetClusterName())
            );
            Url = Url.Replace(
                TEXT("{userId}"),
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetClusterRankingReceivedRewardByUserIdResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
