...
#include "Ranking2/Task/WebSocket/CreateSubscribeRankingModelMasterTask.h"
...
namespace Gs2::Ranking2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking2"), TEXT("subscribeRankingModelMaster"), TEXT("createSubscribeRankingModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FCreateSubscribeRankingModelMasterResult::FromJson(WebSocketResult->Body());
