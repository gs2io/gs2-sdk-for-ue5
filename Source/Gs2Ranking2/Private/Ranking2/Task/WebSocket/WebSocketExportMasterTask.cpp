...
#include "Ranking2/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Ranking2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking2"), TEXT("currentRankingMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
