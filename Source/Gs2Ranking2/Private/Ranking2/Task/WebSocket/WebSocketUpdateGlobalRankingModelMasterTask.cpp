...
#include "Ranking2/Task/WebSocket/UpdateGlobalRankingModelMasterTask.h"
...
namespace Gs2::Ranking2::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("ranking2"), TEXT("globalRankingModelMaster"), TEXT("updateGlobalRankingModelMaster"), ToCStr(RequestPayload->Payload()));
        ...
        *Result = Result::FUpdateGlobalRankingModelMasterResult::FromJson(WebSocketResult->Body());
