...
namespace Gs2::Ranking2::Result
{
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardResult> FReceiveClusterRankingReceivedRewardResult::WithAtomicCommit(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardResult> FReceiveClusterRankingReceivedRewardResult::WithTransaction(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardResult> FReceiveClusterRankingReceivedRewardResult::WithTransactionResult(
    ...
    TOptional<bool> FReceiveClusterRankingReceivedRewardResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReceiveClusterRankingReceivedRewardResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReceiveClusterRankingReceivedRewardResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReceiveClusterRankingReceivedRewardResult::GetTransactionResult() const
    {
