...
{
    FReceiveGlobalRankingReceivedRewardByUserIdResult::FReceiveGlobalRankingReceivedRewardByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithItem(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithAcquireActions(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FGlobalRankingModel> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FAcquireAction>>> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetAcquireActions() const
    {
    ...
    TOptional<FString> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FReceiveGlobalRankingReceivedRewardByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReceiveGlobalRankingReceivedRewardByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardByUserIdResult> FReceiveGlobalRankingReceivedRewardByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FReceiveGlobalRankingReceivedRewardByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FReceiveGlobalRankingReceivedRewardByUserIdResult::ToJson() const
    {
