...
#include "Ranking2/Result/ReceiveClusterRankingReceivedRewardByUserIdResult.h"

namespace Gs2::Ranking2::Result
{
    FReceiveClusterRankingReceivedRewardByUserIdResult::FReceiveClusterRankingReceivedRewardByUserIdResult():
        ItemValue(nullptr),
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithItem(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithAcquireActions(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithTransactionId(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithStampSheet(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithStampSheetEncryptionKeyId(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithAutoRunStampSheet(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithAtomicCommit(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithTransaction(
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::WithTransactionResult(
    ...
    TSharedPtr<Model::FClusterRankingModel> FReceiveClusterRankingReceivedRewardByUserIdResult::GetItem() const
    {
    ...
    TSharedPtr<TArray<TSharedPtr<Model::FAcquireAction>>> FReceiveClusterRankingReceivedRewardByUserIdResult::GetAcquireActions() const
    {
    ...
    TOptional<FString> FReceiveClusterRankingReceivedRewardByUserIdResult::GetTransactionId() const
    {
        return TransactionIdValue;
    }

    TOptional<FString> FReceiveClusterRankingReceivedRewardByUserIdResult::GetStampSheet() const
    {
        return StampSheetValue;
    }

    TOptional<FString> FReceiveClusterRankingReceivedRewardByUserIdResult::GetStampSheetEncryptionKeyId() const
    {
        return StampSheetEncryptionKeyIdValue;
    }

    TOptional<bool> FReceiveClusterRankingReceivedRewardByUserIdResult::GetAutoRunStampSheet() const
    {
        return AutoRunStampSheetValue;
    }

    FString FReceiveClusterRankingReceivedRewardByUserIdResult::GetAutoRunStampSheetString() const
    {
    ...
    TOptional<bool> FReceiveClusterRankingReceivedRewardByUserIdResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReceiveClusterRankingReceivedRewardByUserIdResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReceiveClusterRankingReceivedRewardByUserIdResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReceiveClusterRankingReceivedRewardByUserIdResult::GetTransactionResult() const
    {
    ...
    TSharedPtr<FReceiveClusterRankingReceivedRewardByUserIdResult> FReceiveClusterRankingReceivedRewardByUserIdResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FReceiveClusterRankingReceivedRewardByUserIdResult>()
    ...
    TSharedPtr<FJsonObject> FReceiveClusterRankingReceivedRewardByUserIdResult::ToJson() const
    {
