...
namespace Gs2::Ranking2::Result
{
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardResult> FReceiveGlobalRankingReceivedRewardResult::WithAtomicCommit(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardResult> FReceiveGlobalRankingReceivedRewardResult::WithTransaction(
    ...
    TSharedPtr<FReceiveGlobalRankingReceivedRewardResult> FReceiveGlobalRankingReceivedRewardResult::WithTransactionResult(
    ...
    TOptional<bool> FReceiveGlobalRankingReceivedRewardResult::GetAtomicCommit() const
    {
        return AtomicCommitValue;
    }

    FString FReceiveGlobalRankingReceivedRewardResult::GetAtomicCommitString() const
    {
    ...
    TOptional<FString> FReceiveGlobalRankingReceivedRewardResult::GetTransaction() const
    {
        return TransactionValue;
    }

    TSharedPtr<Gs2::Core::Model::FTransactionResult> FReceiveGlobalRankingReceivedRewardResult::GetTransactionResult() const
    {
