...
namespace Gs2::Ranking2::Request
{
    ...
    TSharedPtr<FGetSubscribeByUserIdRequest> FGetSubscribeByUserIdRequest::WithRankingName(
    ...
    TOptional<FString> FGetSubscribeByUserIdRequest::GetRankingName() const
    {
