...
namespace Gs2::Ranking2::Request
{
    ...
    TSharedPtr<FCreateSubscribeRankingModelMasterRequest> FCreateSubscribeRankingModelMasterRequest::WithScoreTtlDays(
    ...
    TOptional<int32> FCreateSubscribeRankingModelMasterRequest::GetScoreTtlDays() const
    {
        return ScoreTtlDaysValue;
    }

    FString FCreateSubscribeRankingModelMasterRequest::GetScoreTtlDaysString() const
    {
