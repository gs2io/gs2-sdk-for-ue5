...
namespace Gs2::Ranking2::Request
{
    ...
    TSharedPtr<FCreateClusterRankingModelMasterRequest> FCreateClusterRankingModelMasterRequest::WithScoreTtlDays(
    ...
    TOptional<int32> FCreateClusterRankingModelMasterRequest::GetScoreTtlDays() const
    {
        return ScoreTtlDaysValue;
    }

    FString FCreateClusterRankingModelMasterRequest::GetScoreTtlDaysString() const
    {
