...
{
    FString FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor::Action() {
        return "Gs2Ranking2:ReceiveClusterRankingReceivedRewardByUserId";
    }

    FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor::FCommitTask::FCommitTask(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Ranking2::Request::FReceiveClusterRankingReceivedRewardByUserIdRequestPtr& Request
    ):
        Domain(Domain),
        Service(Service),
    ...
    TSharedPtr<FAsyncTask<FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor::FCommitTask>> FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor::Execute(
        const Gs2::Core::Domain::FGs2Ptr& Domain,
        const Gs2::Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
        const Gs2::Ranking2::Request::FReceiveClusterRankingReceivedRewardByUserIdRequestPtr& Request
