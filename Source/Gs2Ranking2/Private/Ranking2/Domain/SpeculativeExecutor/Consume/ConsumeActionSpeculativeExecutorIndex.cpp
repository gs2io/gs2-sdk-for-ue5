...
#include "Ranking2/Domain/SpeculativeExecutor/Consume/ConsumeActionSpeculativeExecutorIndex.h"
...
namespace Gs2::Ranking2::Domain::SpeculativeExecutor
{
    ...
    )
    {
        ...
        if (FCreateGlobalRankingReceivedRewardByUserIdSpeculativeExecutor::Action() == NewConsumeAction->GetAction()) {
