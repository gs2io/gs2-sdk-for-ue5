...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    Gs2::Core::Model::FGs2ErrorPtr FDescribeSubscribesByUserIdIterator::FIteratorNextTask::Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FSubscribeUser>> Result)
    {
        ++Iterator;
