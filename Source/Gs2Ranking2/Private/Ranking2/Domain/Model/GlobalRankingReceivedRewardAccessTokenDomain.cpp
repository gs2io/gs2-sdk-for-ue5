...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    )
    {
        ...
        return Gs2->Cache->Subscribe(
            ...
            [WeakGs2, WeakService, RegisteredParentKey, QueryNamespaceName, QueryRankingName, QuerySeason, SourceToken, RegisteredUserId]()
            {
                ...
                const auto Domain = MakeShared<FGlobalRankingReceivedRewardAccessTokenDomain>(
                    Owner,
                    WeakService.Pin(),
                    QueryNamespaceName,
                    QueryRankingName,
