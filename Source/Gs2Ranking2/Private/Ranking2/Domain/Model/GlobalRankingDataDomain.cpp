...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    FGlobalRankingDataDomain::FGetGlobalRankingTask::FGetGlobalRankingTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FGlobalRankingDataDomain::FGetGlobalRankingTask::Action(
    ...
    TSharedPtr<FAsyncTask<FGlobalRankingDataDomain::FGetGlobalRankingTask>> FGlobalRankingDataDomain::GetGlobalRanking(
