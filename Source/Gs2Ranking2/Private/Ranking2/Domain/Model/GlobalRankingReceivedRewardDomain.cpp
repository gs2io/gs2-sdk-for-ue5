...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    {
        const auto CacheParentKey = Gs2::Ranking2::Model::Cache::FGlobalRankingReceivedRewardCache::CreateCacheParentKey(
        ...
        const auto CacheKey = Gs2::Ranking2::Model::Cache::FGlobalRankingReceivedRewardCache::CreateCacheKey(
        ...
        return Self->Gs2->Cache->ExecuteWithKeyLock(
            ...
            {
                Gs2::Ranking2::Model::FGlobalRankingReceivedRewardPtr Value;
                const auto CacheHit = Gs2::Ranking2::Model::Cache::FGlobalRankingReceivedRewardCache::TryGet(
                    Self->Gs2->Cache,
                ...
                const auto Error = Gs2::Ranking2::Model::Cache::FGlobalRankingReceivedRewardCache::Fetch(
                    Self->Gs2->Cache,
                    ...
                    Self->UserId,
                    TOptional<int32>(),
                    [Self](Gs2::Ranking2::Model::FGlobalRankingReceivedRewardPtr* OutItem) -> Gs2::Core::Model::FGs2ErrorPtr
                    {
    ...
    void FGlobalRankingReceivedRewardDomain::Invalidate()
    {
        Gs2::Ranking2::Model::Cache::FGlobalRankingReceivedRewardCache::Delete(
            Gs2->Cache,
    ...
    FGlobalRankingReceivedRewardDomain::FSubscribeWithInitialCallTask::FSubscribeWithInitialCallTask(
        const TSharedPtr<FGlobalRankingReceivedRewardDomain>& Self,
    ...
    Gs2::Core::Model::FGs2ErrorPtr FGlobalRankingReceivedRewardDomain::FSubscribeWithInitialCallTask::Action(
    ...
    TSharedPtr<FAsyncTask<FGlobalRankingReceivedRewardDomain::FSubscribeWithInitialCallTask>> FGlobalRankingReceivedRewardDomain::SubscribeWithInitialCall(
        TFunction<void(Gs2::Ranking2::Model::FGlobalRankingReceivedRewardPtr)> Callback
    )
    {
