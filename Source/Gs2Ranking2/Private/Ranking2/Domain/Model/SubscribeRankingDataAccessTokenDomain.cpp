...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    FSubscribeRankingDataAccessTokenDomain::FSubscribeRankingDataAccessTokenDomain(
    ...
    FSubscribeRankingDataAccessTokenDomain::FGetSubscribeRankingTask::FGetSubscribeRankingTask(
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSubscribeRankingDataAccessTokenDomain::FGetSubscribeRankingTask::Action(
    ...
    )
    {
        ...
        const auto Future = Self->Client->GetSubscribeRanking(
            Request
        );
    ...
    TSharedPtr<FAsyncTask<FSubscribeRankingDataAccessTokenDomain::FGetSubscribeRankingTask>> FSubscribeRankingDataAccessTokenDomain::GetSubscribeRanking(
    ...
    FString FSubscribeRankingDataAccessTokenDomain::CreateCacheParentKey(
    ...
    FString FSubscribeRankingDataAccessTokenDomain::CreateCacheKey(
        TOptional<FString> ScorerUserId
    )
    {
        return FString("") +
    ...
    FSubscribeRankingDataAccessTokenDomain::FModelTask::FModelTask(
        const TSharedPtr<FSubscribeRankingDataAccessTokenDomain> Self
    ): Self(Self)
    {
    ...
    Gs2::Core::Model::FGs2ErrorPtr FSubscribeRankingDataAccessTokenDomain::FModelTask::Action(
    ...
    TSharedPtr<FAsyncTask<FSubscribeRankingDataAccessTokenDomain::FModelTask>> FSubscribeRankingDataAccessTokenDomain::Model() {
        return Gs2::Core::Util::New<FAsyncTask<FSubscribeRankingDataAccessTokenDomain::FModelTask>>(this->AsShared());
    }

    Gs2::Core::Domain::CallbackID FSubscribeRankingDataAccessTokenDomain::Subscribe(
    ...
    void FSubscribeRankingDataAccessTokenDomain::Unsubscribe(
