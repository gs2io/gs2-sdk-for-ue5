...
namespace Gs2::Ranking2::Request
{
    ...
    class GS2RANKING2_API FGetSubscribeRequest final : public TSharedFromThis<FGetSubscribeRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FGetSubscribeRequest> WithRankingName(const TOptional<FString> RankingName);
    ...
    typedef TSharedPtr<FGetSubscribeRequest> FGetSubscribeRequestPtr;
}