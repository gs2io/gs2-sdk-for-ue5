...
namespace Gs2::Ranking2::Request
{
    ...
    public:
        ...
        TSharedPtr<FUpdateClusterRankingModelMasterRequest> WithScoreTtlDays(const TOptional<int32> ScoreTtlDays);
    ...
    typedef TSharedPtr<FUpdateClusterRankingModelMasterRequest, ESPMode::ThreadSafe> FUpdateClusterRankingModelMasterRequestPtr;
}