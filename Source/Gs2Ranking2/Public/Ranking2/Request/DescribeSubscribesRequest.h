...
namespace Gs2::Ranking2::Request
{
    ...
    class GS2RANKING2_API FDescribeSubscribesRequest final : public TSharedFromThis<FDescribeSubscribesRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FDescribeSubscribesRequest> WithRankingName(const TOptional<FString> RankingName);
    ...
    typedef TSharedPtr<FDescribeSubscribesRequest, ESPMode::ThreadSafe> FDescribeSubscribesRequestPtr;
}