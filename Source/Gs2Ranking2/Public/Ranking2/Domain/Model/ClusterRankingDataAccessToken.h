...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FClusterRankingDataAccessTokenDomain:
        public TSharedFromThis<FClusterRankingDataAccessTokenDomain>
    {
    ...
    public:
        ...
        FClusterRankingDataAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        ...
        TSharedPtr<FAsyncTask<FClusterRankingDataAccessTokenDomain::FSubscribeWithInitialCallTask>> SubscribeWithInitialCall(
    ...
    typedef TSharedPtr<FClusterRankingDataAccessTokenDomain> FClusterRankingDataAccessTokenDomainPtr;
}
