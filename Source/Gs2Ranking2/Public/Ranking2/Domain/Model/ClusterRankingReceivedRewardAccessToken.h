...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FClusterRankingReceivedRewardAccessTokenDomain:
        public TSharedFromThis<FClusterRankingReceivedRewardAccessTokenDomain>
    {
    ...
    public:
        ...
        FClusterRankingReceivedRewardAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
    ...
    typedef TSharedPtr<FClusterRankingReceivedRewardAccessTokenDomain> FClusterRankingReceivedRewardAccessTokenDomainPtr;
}
