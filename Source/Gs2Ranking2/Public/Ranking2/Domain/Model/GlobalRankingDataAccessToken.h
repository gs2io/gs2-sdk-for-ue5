...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FGlobalRankingDataAccessTokenDomain:
        public TSharedFromThis<FGlobalRankingDataAccessTokenDomain>
    {
    ...
    public:
        ...
        FGlobalRankingDataAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        ...
        TSharedPtr<FAsyncTask<FGlobalRankingDataAccessTokenDomain::FSubscribeWithInitialCallTask>> SubscribeWithInitialCall(
    ...
    typedef TSharedPtr<FGlobalRankingDataAccessTokenDomain> FGlobalRankingDataAccessTokenDomainPtr;
}
