...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FGlobalRankingDataDomain:
        public TSharedFromThis<FGlobalRankingDataDomain>
    {
    ...
    typedef TSharedPtr<FGlobalRankingDataDomain> FGlobalRankingDataDomainPtr;
}
