...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FClusterRankingScoreDomain:
        public TSharedFromThis<FClusterRankingScoreDomain>
    {
    ...
    typedef TSharedPtr<FClusterRankingScoreDomain> FClusterRankingScoreDomainPtr;
}
