...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FClusterRankingDataDomain:
        public TSharedFromThis<FClusterRankingDataDomain>
    {
    ...
    typedef TSharedPtr<FClusterRankingDataDomain> FClusterRankingDataDomainPtr;
}
