...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FSubscribeRankingScoreDomain:
        public TSharedFromThis<FSubscribeRankingScoreDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FSubscribeRankingScoreDomain> Self;
            const TFunction<void(Gs2::Ranking2::Model::FSubscribeRankingScorePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FSubscribeRankingScoreDomain> FSubscribeRankingScoreDomainPtr;
}
