...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FGlobalRankingScoreAccessTokenDomain:
        public TSharedFromThis<FGlobalRankingScoreAccessTokenDomain>
    {
    ...
    public:
        ...
        FGlobalRankingScoreAccessTokenDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        ...
        {
            const TSharedPtr<FGlobalRankingScoreAccessTokenDomain> Self;
            const TFunction<void(Gs2::Ranking2::Model::FGlobalRankingScorePtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FGlobalRankingScoreAccessTokenDomain> FGlobalRankingScoreAccessTokenDomainPtr;
}
