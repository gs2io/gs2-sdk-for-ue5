...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FSubscribeRankingModelDomain:
        public TSharedFromThis<FSubscribeRankingModelDomain>
    {
    ...
    typedef TSharedPtr<FSubscribeRankingModelDomain> FSubscribeRankingModelDomainPtr;
}
