...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FSubscribeRankingDataDomain:
        public TSharedFromThis<FSubscribeRankingDataDomain>
    {
    ...
    public:
        ...
        {
            const TSharedPtr<FSubscribeRankingDataDomain> Self;
            const TFunction<void(Gs2::Ranking2::Model::FSubscribeRankingDataPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FSubscribeRankingDataDomain> FSubscribeRankingDataDomainPtr;
}
