...
namespace Gs2::Ranking2::Domain::Model
{
    ...
    class GS2RANKING2_API FClusterRankingReceivedRewardDomain:
        public TSharedFromThis<FClusterRankingReceivedRewardDomain>
    {
    ...
    public:
        ...
        FClusterRankingReceivedRewardDomain(
            const Core::Domain::FGs2Ptr& Gs2,
            const Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
        ...
        class GS2RANKING2_API FCreateTask final :
            public Gs2::Core::Util::TGs2Future<Gs2::Ranking2::Domain::Model::FClusterRankingReceivedRewardDomain>,
        ...
        {
            const TSharedPtr<FClusterRankingReceivedRewardDomain> Self;
            const TFunction<void(Gs2::Ranking2::Model::FClusterRankingReceivedRewardPtr)> Callback;
        public:
    ...
    typedef TSharedPtr<FClusterRankingReceivedRewardDomain> FClusterRankingReceivedRewardDomainPtr;
}
