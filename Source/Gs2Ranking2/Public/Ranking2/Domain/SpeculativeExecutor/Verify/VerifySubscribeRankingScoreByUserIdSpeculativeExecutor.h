...
namespace Gs2::Ranking2::Domain::SpeculativeExecutor
{
    ...
    class GS2RANKING2_API FVerifySubscribeRankingScoreByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Ranking2::Request::FVerifySubscribeRankingScoreByUserIdRequestPtr Rate(
            const Gs2::Ranking2::Request::FVerifySubscribeRankingScoreByUserIdRequestPtr& Request,
            const double Rate
        );
