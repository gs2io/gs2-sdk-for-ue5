...
namespace Gs2::Ranking2::Domain::SpeculativeExecutor
{
    ...
    class GS2RANKING2_API FVerifyClusterRankingScoreByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Ranking2::Request::FVerifyClusterRankingScoreByUserIdRequestPtr Rate(
            const Gs2::Ranking2::Request::FVerifyClusterRankingScoreByUserIdRequestPtr& Request,
            const double Rate
        );
