...
namespace Gs2::Ranking2::Domain::SpeculativeExecutor
{
    ...
    class GS2RANKING2_API FVerifyGlobalRankingScoreByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Ranking2::Request::FVerifyGlobalRankingScoreByUserIdRequestPtr Rate(
            const Gs2::Ranking2::Request::FVerifyGlobalRankingScoreByUserIdRequestPtr& Request,
            const double Rate
        );
