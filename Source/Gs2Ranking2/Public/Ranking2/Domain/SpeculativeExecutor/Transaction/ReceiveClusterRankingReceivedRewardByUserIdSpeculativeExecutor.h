...
{
    class GS2RANKING2_API FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor
    {
    public:
        ...
        static TSharedPtr<FAsyncTask<FReceiveClusterRankingReceivedRewardByUserIdSpeculativeExecutor::FCommitTask>> Execute(
            const Gs2::Core::Domain::FGs2Ptr& Domain,
            const Gs2::Ranking2::Domain::FGs2Ranking2DomainPtr& Service,
            const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
            const Gs2::Ranking2::Request::FReceiveClusterRankingReceivedRewardByUserIdRequestPtr& Request
