...
namespace Gs2::Ranking2::Domain::SpeculativeExecutor
{
    ...
    class GS2RANKING2_API FCreateClusterRankingReceivedRewardByUserIdSpeculativeExecutor
    {
    ...
    public:
        ...
        static Gs2::Ranking2::Request::FCreateClusterRankingReceivedRewardByUserIdRequestPtr Rate(
            const Gs2::Ranking2::Request::FCreateClusterRankingReceivedRewardByUserIdRequestPtr& Request,
            const double Rate
        );
