...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeGlobalRankingModelsIterator :
        public TSharedFromThis<FDescribeGlobalRankingModelsIterator>
    {
    ...
    public:
        FDescribeGlobalRankingModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        class GS2RANKING2_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Ranking2::Model::FGlobalRankingModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FGlobalRankingModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeGlobalRankingModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FGlobalRankingModelPtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FGlobalRankingModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Ranking2::Model::FGlobalRankingModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalRankingModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalRankingModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalRankingModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGlobalRankingModelsIterator> FDescribeGlobalRankingModelsIteratorPtr;
}
