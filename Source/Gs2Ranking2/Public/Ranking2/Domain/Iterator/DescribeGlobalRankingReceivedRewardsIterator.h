...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeGlobalRankingReceivedRewardsIterator :
        public TSharedFromThis<FDescribeGlobalRankingReceivedRewardsIterator>
    {
    ...
    public:
        FDescribeGlobalRankingReceivedRewardsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        {
            TSharedRef<FDescribeGlobalRankingReceivedRewardsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalRankingReceivedRewardsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalRankingReceivedRewardsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalRankingReceivedRewardsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGlobalRankingReceivedRewardsIterator> FDescribeGlobalRankingReceivedRewardsIteratorPtr;
}
