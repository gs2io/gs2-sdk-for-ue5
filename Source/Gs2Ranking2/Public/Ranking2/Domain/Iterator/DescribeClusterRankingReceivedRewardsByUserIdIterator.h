...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeClusterRankingReceivedRewardsByUserIdIterator :
        public TSharedFromThis<FDescribeClusterRankingReceivedRewardsByUserIdIterator>
    {
    ...
    public:
        FDescribeClusterRankingReceivedRewardsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        {
            TSharedRef<FDescribeClusterRankingReceivedRewardsByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeClusterRankingReceivedRewardsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeClusterRankingReceivedRewardsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeClusterRankingReceivedRewardsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeClusterRankingReceivedRewardsByUserIdIterator> FDescribeClusterRankingReceivedRewardsByUserIdIteratorPtr;
}
