...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribesIterator :
        public TSharedFromThis<FDescribeSubscribesIterator>
    {
    ...
    public:
        ...
        {
            TSharedRef<FDescribeSubscribesIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribesIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribesIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribesIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscribesIterator> FDescribeSubscribesIteratorPtr;
}
