...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeClusterRankingScoresByUserIdIterator :
        public TSharedFromThis<FDescribeClusterRankingScoresByUserIdIterator>
    {
    ...
    public:
        FDescribeClusterRankingScoresByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        {
            TSharedRef<FDescribeClusterRankingScoresByUserIdIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeClusterRankingScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeClusterRankingScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeClusterRankingScoresByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeClusterRankingScoresByUserIdIterator> FDescribeClusterRankingScoresByUserIdIteratorPtr;
}
