...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribeRankingScoresIterator :
        public TSharedFromThis<FDescribeSubscribeRankingScoresIterator>
    {
    ...
    public:
        FDescribeSubscribeRankingScoresIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        {
            TSharedRef<FDescribeSubscribeRankingScoresIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribeRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribeRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribeRankingScoresIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscribeRankingScoresIterator> FDescribeSubscribeRankingScoresIteratorPtr;
}
