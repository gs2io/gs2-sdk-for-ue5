...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribeRankingModelsIterator :
        public TSharedFromThis<FDescribeSubscribeRankingModelsIterator>
    {
    ...
    public:
        FDescribeSubscribeRankingModelsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName
        );
        ...
        class GS2RANKING2_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Ranking2::Model::FSubscribeRankingModel>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FSubscribeRankingModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeSubscribeRankingModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FSubscribeRankingModelPtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FSubscribeRankingModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Ranking2::Model::FSubscribeRankingModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribeRankingModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribeRankingModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribeRankingModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscribeRankingModelsIterator> FDescribeSubscribeRankingModelsIteratorPtr;
}
