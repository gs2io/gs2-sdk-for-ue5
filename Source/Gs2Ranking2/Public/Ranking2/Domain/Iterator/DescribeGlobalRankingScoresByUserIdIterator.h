...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeGlobalRankingScoresByUserIdIterator :
        public TSharedFromThis<FDescribeGlobalRankingScoresByUserIdIterator>
    {
    ...
    public:
        FDescribeGlobalRankingScoresByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FGlobalRankingScore>> Result) override;
        ...
        {
            TSharedRef<FDescribeGlobalRankingScoresByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FGlobalRankingScorePtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FGlobalRankingScorePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalRankingScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalRankingScoresByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalRankingScoresByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGlobalRankingScoresByUserIdIterator> FDescribeGlobalRankingScoresByUserIdIteratorPtr;
}
