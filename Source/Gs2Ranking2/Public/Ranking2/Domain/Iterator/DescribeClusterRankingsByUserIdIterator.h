...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeClusterRankingsByUserIdIterator :
        public TSharedFromThis<FDescribeClusterRankingsByUserIdIterator>
    {
    ...
    public:
        FDescribeClusterRankingsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        class GS2RANKING2_API FIteratorNextTask :
            public Gs2::Core::Util::TGs2Future<Gs2::Ranking2::Model::FClusterRankingData>
        {
        private:
            FIterator& Iterator;
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FClusterRankingData>> Result) override;
        ...
        {
            TSharedRef<FDescribeClusterRankingsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FClusterRankingDataPtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FClusterRankingDataPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Ranking2::Model::FClusterRankingDataPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeClusterRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeClusterRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeClusterRankingsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeClusterRankingsByUserIdIterator> FDescribeClusterRankingsByUserIdIteratorPtr;
}
