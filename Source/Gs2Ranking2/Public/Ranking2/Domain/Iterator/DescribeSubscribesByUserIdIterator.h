...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribesByUserIdIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FSubscribeUser>> Result) override;
        ...
        {
            TSharedRef<FDescribeSubscribesByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FSubscribeUserPtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FSubscribeUserPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Ranking2::Model::FSubscribeUserPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribesByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribesByUserIdIterator> Iterable)
            {
