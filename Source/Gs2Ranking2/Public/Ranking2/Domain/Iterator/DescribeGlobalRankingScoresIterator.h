...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeGlobalRankingScoresIterator :
        public TSharedFromThis<FDescribeGlobalRankingScoresIterator>
    {
    ...
    public:
        FDescribeGlobalRankingScoresIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        {
            TSharedRef<FDescribeGlobalRankingScoresIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalRankingScoresIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGlobalRankingScoresIterator> FDescribeGlobalRankingScoresIteratorPtr;
}
