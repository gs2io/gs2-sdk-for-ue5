...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeClusterRankingScoresIterator :
        public TSharedFromThis<FDescribeClusterRankingScoresIterator>
    {
    ...
    public:
        FDescribeClusterRankingScoresIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FClusterRankingScore>> Result) override;
        ...
        {
            TSharedRef<FDescribeClusterRankingScoresIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FClusterRankingScorePtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FClusterRankingScorePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeClusterRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeClusterRankingScoresIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeClusterRankingScoresIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeClusterRankingScoresIterator> FDescribeClusterRankingScoresIteratorPtr;
}
