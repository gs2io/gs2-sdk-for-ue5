...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribeRankingsIterator :
        public TSharedFromThis<FDescribeSubscribeRankingsIterator>
    {
    ...
    public:
        FDescribeSubscribeRankingsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        {
            TSharedRef<FDescribeSubscribeRankingsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribeRankingsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribeRankingsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribeRankingsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscribeRankingsIterator> FDescribeSubscribeRankingsIteratorPtr;
}
