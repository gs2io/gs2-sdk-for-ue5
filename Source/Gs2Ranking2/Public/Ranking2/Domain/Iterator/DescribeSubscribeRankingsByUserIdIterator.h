...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeSubscribeRankingsByUserIdIterator :
        public TSharedFromThis<FDescribeSubscribeRankingsByUserIdIterator>
    {
    ...
    public:
        FDescribeSubscribeRankingsByUserIdIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const TOptional<FString> UserId,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Ranking2::Model::FSubscribeRankingData>> Result) override;
        ...
        {
            TSharedRef<FDescribeSubscribeRankingsByUserIdIterator> Self;
            TSharedPtr<TArray<Gs2::Ranking2::Model::FSubscribeRankingDataPtr>> Range;
            TOptional<TArray<Gs2::Ranking2::Model::FSubscribeRankingDataPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Ranking2::Model::FSubscribeRankingDataPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeSubscribeRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeSubscribeRankingsByUserIdIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeSubscribeRankingsByUserIdIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeSubscribeRankingsByUserIdIterator> FDescribeSubscribeRankingsByUserIdIteratorPtr;
}
