...
namespace Gs2::Ranking2::Domain::Iterator
{
    ...
    class GS2RANKING2_API FDescribeGlobalRankingsIterator :
        public TSharedFromThis<FDescribeGlobalRankingsIterator>
    {
    ...
    public:
        FDescribeGlobalRankingsIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Ranking2::FGs2Ranking2RestClientPtr Client,
            const TOptional<FString> NamespaceName,
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken,
        ...
        {
            TSharedRef<FDescribeGlobalRankingsIterator> Self;
        ...
        public:
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeGlobalRankingsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeGlobalRankingsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeGlobalRankingsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeGlobalRankingsIterator> FDescribeGlobalRankingsIteratorPtr;
}
