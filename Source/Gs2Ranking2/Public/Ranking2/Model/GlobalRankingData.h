...
{
    class GS2RANKING2_API FGlobalRankingData final : public FGs2Object, public TSharedFromThis<FGlobalRankingData>
    {
    ...
    public:
        ...
        TSharedPtr<FGlobalRankingData> WithInvertUpdatedAt(const TOptional<int64> InvertUpdatedAt);
