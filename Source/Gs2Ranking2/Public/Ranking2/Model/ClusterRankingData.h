...
{
    class GS2RANKING2_API FClusterRankingData final : public FGs2Object, public TSharedFromThis<FClusterRankingData>
    {
    ...
    public:
        ...
        TSharedPtr<FClusterRankingData> WithInvertCreatedAt(const TOptional<int64> InvertCreatedAt);
