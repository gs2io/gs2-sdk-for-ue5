...
#include "Ranking2/Request/DescribeNamespacesRequest.h"
#include "Ranking2/Result/DescribeNamespacesResult.h"

namespace Gs2::Ranking2::Task::Rest
{
    class GS2RANKING2_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
