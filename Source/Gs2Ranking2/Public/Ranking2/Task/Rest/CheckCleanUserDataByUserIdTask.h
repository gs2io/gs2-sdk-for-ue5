...
#include "Ranking2/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Ranking2/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Ranking2::Task::Rest
{
    class GS2RANKING2_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
