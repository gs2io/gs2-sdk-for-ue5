...
#include "Ranking2/Request/GetNamespaceStatusRequest.h"
#include "Ranking2/Result/GetNamespaceStatusResult.h"

namespace Gs2::Ranking2::Task::Rest
{
    class GS2RANKING2_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
