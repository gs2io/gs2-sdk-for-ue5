...
#include "Ranking2/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Ranking2/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Ranking2::Task::Rest
{
    class GS2RANKING2_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
