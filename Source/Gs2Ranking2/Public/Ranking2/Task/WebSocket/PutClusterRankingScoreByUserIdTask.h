...
{
    class GS2RANKING2_API FPutClusterRankingScoreByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPutClusterRankingScoreByUserIdResult>
    {
        Core::Net::WebSocket::FGs2WebSocketSessionPtr Session;
        Request::FPutClusterRankingScoreByUserIdRequestPtr Request;
    public:
        explicit FPutClusterRankingScoreByUserIdTask(
            const Core::Net::WebSocket::FGs2WebSocketSessionPtr Session,
            const Request::FPutClusterRankingScoreByUserIdRequestPtr Request
        );
        FPutClusterRankingScoreByUserIdTask(
