...
#include "Ranking2/Request/CreateNamespaceRequest.h"
#include "Ranking2/Result/CreateNamespaceResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FCreateNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FCreateNamespaceResult>
    {
