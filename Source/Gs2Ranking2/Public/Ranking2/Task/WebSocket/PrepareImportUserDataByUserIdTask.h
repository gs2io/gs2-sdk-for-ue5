...
#include "Ranking2/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Ranking2/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
