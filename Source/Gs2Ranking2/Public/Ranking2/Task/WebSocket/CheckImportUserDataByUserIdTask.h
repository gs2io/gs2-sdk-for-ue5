...
#include "Ranking2/Request/CheckImportUserDataByUserIdRequest.h"
#include "Ranking2/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
