...
#include "Ranking2/Request/GetNamespaceRequest.h"
#include "Ranking2/Result/GetNamespaceResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
