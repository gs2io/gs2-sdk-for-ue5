...
#include "Ranking2/Request/DumpUserDataByUserIdRequest.h"
#include "Ranking2/Result/DumpUserDataByUserIdResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FDumpUserDataByUserIdResult>
    {
