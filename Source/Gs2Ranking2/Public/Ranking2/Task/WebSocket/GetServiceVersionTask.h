...
#include "Ranking2/Request/GetServiceVersionRequest.h"
#include "Ranking2/Result/GetServiceVersionResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
