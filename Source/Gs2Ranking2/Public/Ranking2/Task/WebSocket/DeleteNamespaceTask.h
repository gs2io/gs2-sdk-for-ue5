...
#include "Ranking2/Request/DeleteNamespaceRequest.h"
#include "Ranking2/Result/DeleteNamespaceResult.h"

namespace Gs2::Ranking2::Task::WebSocket
{
    class GS2RANKING2_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
