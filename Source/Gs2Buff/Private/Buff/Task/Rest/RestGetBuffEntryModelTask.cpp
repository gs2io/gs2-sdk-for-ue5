...
#include "Buff/Task/Rest/GetBuffEntryModelTask.h"
...
{
    FGetBuffEntryModelTask::FGetBuffEntryModelTask(
    ...
    Core::Model::FGs2ErrorPtr FGetBuffEntryModelTask::Action(
        const TSharedPtr<Result::FGetBuffEntryModelResultPtr> Result
    )
    {
        ...
        FString ResponseBody;
        {
            ...
            auto Url = Core::FGs2Constant::EndpointHost
                ...
                .Append("/{namespaceName}/model/{buffEntryName}");
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBuffEntryModelResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
