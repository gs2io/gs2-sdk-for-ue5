...
#include "Buff/Task/Rest/DeleteBuffEntryModelMasterTask.h"
...
{
    FDeleteBuffEntryModelMasterTask::FDeleteBuffEntryModelMasterTask(
    ...
    Core::Model::FGs2ErrorPtr FDeleteBuffEntryModelMasterTask::Action(
        const TSharedPtr<Result::FDeleteBuffEntryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FDeleteBuffEntryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
