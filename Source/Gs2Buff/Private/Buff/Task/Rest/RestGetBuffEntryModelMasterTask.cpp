...
#include "Buff/Task/Rest/GetBuffEntryModelMasterTask.h"
...
{
    FGetBuffEntryModelMasterTask::FGetBuffEntryModelMasterTask(
    ...
    FGetBuffEntryModelMasterTask::FGetBuffEntryModelMasterTask(
        const FGetBuffEntryModelMasterTask& From
    ): TGs2Future(From), Session(From.Session), Request(From.Request)
    {
    }

    Core::Model::FGs2ErrorPtr FGetBuffEntryModelMasterTask::Action(
        const TSharedPtr<Result::FGetBuffEntryModelMasterResultPtr> Result
    )
    {
        ...
        if (ResponseCode / 100 == 2)
        {
                ...
                FJsonSerializer::Deserialize(JsonReader, JsonRootObject))
            {
                ...
                *Result = Result::FGetBuffEntryModelMasterResult::FromJson(JsonRootObject);
                return nullptr;
            }
            const auto Details = MakeShared<TArray<TSharedPtr<Core::Model::FGs2ErrorDetail>>>();
