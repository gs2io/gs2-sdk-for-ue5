...
#include "Buff/Task/WebSocket/ExportMasterTask.h"
...
namespace Gs2::Buff::Task::WebSocket
{
    ...
    )
    {
        ...
        UE_LOG(Gs2Log, VeryVerbose, TEXT("[%s:%s:%s] %s"), TEXT("buff"), TEXT("currentBuffMaster"), TEXT("exportMaster"), ToCStr(RequestPayload->Payload()));
