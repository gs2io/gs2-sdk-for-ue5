...
namespace Gs2::Buff::Domain::Model
{
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            ...
            {
                const auto ParentKey = FString("buff:Namespace");
                const auto Key = Gs2::Buff::Domain::Model::FNamespaceDomain::CreateCacheKey(
    ...
    )
    {
        ...
        if (ResultModel != nullptr) {
            
            {
                ...
                Self->Gs2->Cache->Delete(Gs2::Buff::Model::FNamespace::TypeName, ParentKey, Key);
            }
        }
        auto Domain = Self;
    ...
    )
    {
        return Gs2->Cache->ListSubscribe(
            Gs2::Buff::Model::FBuffEntryModelMaster::TypeName,
            Gs2::Buff::Domain::Model::FNamespaceDomain::CreateCacheParentKey(
                NamespaceName,
                "BuffEntryModelMaster"
            ),
            Callback
    ...
    )
    {
        ...
        TSharedPtr<Gs2::Buff::Model::FNamespace> Value;
        auto bCacheHit = Self->Gs2->Cache->TryGet<Gs2::Buff::Model::FNamespace>(
            ParentKey,
        ...
        if (!bCacheHit) {
            ...
            Self->Gs2->Cache->TryGet<Gs2::Buff::Model::FNamespace>(
                ParentKey,
                Gs2::Buff::Domain::Model::FNamespaceDomain::CreateCacheKey(
                    Self->NamespaceName
                ),
