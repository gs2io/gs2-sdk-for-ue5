...
{
    FPreUpdateCurrentBuffMasterResult::FPreUpdateCurrentBuffMasterResult():
    ...
    TSharedPtr<FPreUpdateCurrentBuffMasterResult> FPreUpdateCurrentBuffMasterResult::WithUploadToken(
    ...
    TSharedPtr<FPreUpdateCurrentBuffMasterResult> FPreUpdateCurrentBuffMasterResult::WithUploadUrl(
    ...
    TOptional<FString> FPreUpdateCurrentBuffMasterResult::GetUploadToken() const
    {
        return UploadTokenValue;
    }

    TOptional<FString> FPreUpdateCurrentBuffMasterResult::GetUploadUrl() const
    {
        return UploadUrlValue;
    }

    TSharedPtr<FPreUpdateCurrentBuffMasterResult> FPreUpdateCurrentBuffMasterResult::FromJson(const TSharedPtr<FJsonObject> Data)
    {
        if (Data == nullptr) {
            return nullptr;
        }
        return MakeShared<FPreUpdateCurrentBuffMasterResult>()
    ...
    TSharedPtr<FJsonObject> FPreUpdateCurrentBuffMasterResult::ToJson() const
    {
