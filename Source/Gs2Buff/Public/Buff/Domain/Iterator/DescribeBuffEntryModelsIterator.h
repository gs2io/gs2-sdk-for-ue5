...
namespace Gs2::Buff::Domain::Iterator
{
    ...
    class GS2BUFF_API FDescribeBuffEntryModelsIterator :
        public TSharedFromThis<FDescribeBuffEntryModelsIterator>
    {
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Buff::Model::FBuffEntryModel>> Result) override;
        ...
        {
            TSharedRef<FDescribeBuffEntryModelsIterator> Self;
            TSharedPtr<TArray<Gs2::Buff::Model::FBuffEntryModelPtr>> Range;
            TOptional<TArray<Gs2::Buff::Model::FBuffEntryModelPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Buff::Model::FBuffEntryModelPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBuffEntryModelsIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBuffEntryModelsIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBuffEntryModelsIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBuffEntryModelsIterator> FDescribeBuffEntryModelsIteratorPtr;
}
