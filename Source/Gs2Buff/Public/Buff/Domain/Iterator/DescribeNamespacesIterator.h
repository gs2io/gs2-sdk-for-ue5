...
namespace Gs2::Buff::Domain::Iterator
{
    ...
    class GS2BUFF_API FDescribeNamespacesIterator :
    ...
    public:
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Buff::Model::FNamespace>> Result) override;
        ...
        class GS2BUFF_API FIterator
        {
            ...
            TSharedPtr<TArray<Gs2::Buff::Model::FNamespacePtr>> Range;
            TOptional<TArray<Gs2::Buff::Model::FNamespacePtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Buff::Model::FNamespacePtr& Current()
            {
