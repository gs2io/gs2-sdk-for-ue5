...
namespace Gs2::Buff::Domain::Iterator
{
    ...
    class GS2BUFF_API FDescribeBuffEntryModelMastersIterator :
        public TSharedFromThis<FDescribeBuffEntryModelMastersIterator>
    {
    ...
    public:
        FDescribeBuffEntryModelMastersIterator(
            const TSharedPtr<Core::Domain::FGs2> Gs2,
            const Gs2::Buff::FGs2BuffRestClientPtr Client,
            const TOptional<FString> NamespaceName,
        ...
        public:
            ...
            virtual Gs2::Core::Model::FGs2ErrorPtr Action(TSharedPtr<TSharedPtr<Gs2::Buff::Model::FBuffEntryModelMaster>> Result) override;
        ...
        class GS2BUFF_API FIterator
        {
            TSharedRef<FDescribeBuffEntryModelMastersIterator> Self;
            TSharedPtr<TArray<Gs2::Buff::Model::FBuffEntryModelMasterPtr>> Range;
            TOptional<TArray<Gs2::Buff::Model::FBuffEntryModelMasterPtr>::TIterator> RangeIteratorOpt;
        ...
        public:
            ...
            Gs2::Buff::Model::FBuffEntryModelMasterPtr& Current()
            {
            ...
            static FIterator OneBeforeBeginOf(const TSharedRef<FDescribeBuffEntryModelMastersIterator> Iterable)
            {
                return FIterator(Iterable, FOneBeforeBegin());
            }

            static FIterator BeginOf(const TSharedRef<FDescribeBuffEntryModelMastersIterator> Iterable)
            {
                return FIterator(Iterable);
            }

            static FIterator EndOf(const TSharedRef<FDescribeBuffEntryModelMastersIterator> Iterable)
            {
    ...
    typedef TSharedPtr<FDescribeBuffEntryModelMastersIterator> FDescribeBuffEntryModelMastersIteratorPtr;
}
