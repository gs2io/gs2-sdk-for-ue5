...
namespace Gs2::Buff::Domain::SpeculativeExecutor
{
    class GS2BUFF_API FConsumeActionSpeculativeExecutorIndex
    {
    public:
            ...
            public TSharedFromThis<FCommitTask>
        {
            ...
            const Gs2::Buff::Domain::FGs2BuffDomainPtr Service;
            const Gs2::Auth::Model::FAccessTokenPtr AccessToken;
            const Gs2::Core::Model::FConsumeActionPtr ConsumeAction;
            TBigInt<1024, false> Rate;

        public:
            GS2BUFF_API explicit FCommitTask(
                const Gs2::Core::Domain::FGs2Ptr& Domain,
                const Gs2::Buff::Domain::FGs2BuffDomainPtr& Service,
                const Gs2::Auth::Model::FAccessTokenPtr& AccessToken,
                const Gs2::Core::Model::FConsumeActionPtr& ConsumeAction,
            ...
            GS2BUFF_API FCommitTask(
                const FCommitTask& From
            );

            GS2BUFF_API virtual Gs2::Core::Model::FGs2ErrorPtr Action(
