...
#include "Buff/Request/CleanUserDataByUserIdRequest.h"
#include "Buff/Result/CleanUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCleanUserDataByUserIdResult>
    {
