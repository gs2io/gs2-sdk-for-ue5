...
#include "Buff/Request/CheckCleanUserDataByUserIdRequest.h"
#include "Buff/Result/CheckCleanUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FCheckCleanUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckCleanUserDataByUserIdResult>
    {
