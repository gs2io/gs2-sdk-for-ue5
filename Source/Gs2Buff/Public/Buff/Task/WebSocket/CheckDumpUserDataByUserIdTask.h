...
#include "Buff/Request/CheckDumpUserDataByUserIdRequest.h"
#include "Buff/Result/CheckDumpUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FCheckDumpUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckDumpUserDataByUserIdResult>
    {
