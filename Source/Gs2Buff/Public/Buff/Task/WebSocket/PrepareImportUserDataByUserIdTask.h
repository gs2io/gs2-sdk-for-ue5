...
#include "Buff/Request/PrepareImportUserDataByUserIdRequest.h"
#include "Buff/Result/PrepareImportUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FPrepareImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FPrepareImportUserDataByUserIdResult>
    {
