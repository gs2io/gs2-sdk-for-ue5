...
#include "Buff/Request/GetNamespaceRequest.h"
#include "Buff/Result/GetNamespaceResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FGetNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceResult>
    {
