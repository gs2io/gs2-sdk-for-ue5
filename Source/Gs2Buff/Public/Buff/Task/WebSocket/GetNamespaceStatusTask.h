...
#include "Buff/Request/GetNamespaceStatusRequest.h"
#include "Buff/Result/GetNamespaceStatusResult.h"

namespace Gs2::Buff::Task::WebSocket
{
    class GS2BUFF_API FGetNamespaceStatusTask final : public Gs2::Core::Util::TGs2Future<Result::FGetNamespaceStatusResult>
    {
