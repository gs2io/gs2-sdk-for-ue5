...
#include "Buff/Request/GetServiceVersionRequest.h"
#include "Buff/Result/GetServiceVersionResult.h"

namespace Gs2::Buff::Task::Rest
{
    class GS2BUFF_API FGetServiceVersionTask final : public Gs2::Core::Util::TGs2Future<Result::FGetServiceVersionResult>
    {
