...
#include "Buff/Request/ImportUserDataByUserIdRequest.h"
#include "Buff/Result/ImportUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::Rest
{
    class GS2BUFF_API FImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FImportUserDataByUserIdResult>
    {
