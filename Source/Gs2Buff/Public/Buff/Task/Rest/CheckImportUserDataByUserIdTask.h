...
#include "Buff/Request/CheckImportUserDataByUserIdRequest.h"
#include "Buff/Result/CheckImportUserDataByUserIdResult.h"

namespace Gs2::Buff::Task::Rest
{
    class GS2BUFF_API FCheckImportUserDataByUserIdTask final : public Gs2::Core::Util::TGs2Future<Result::FCheckImportUserDataByUserIdResult>
    {
