...
#include "Buff/Request/DescribeNamespacesRequest.h"
#include "Buff/Result/DescribeNamespacesResult.h"

namespace Gs2::Buff::Task::Rest
{
    class GS2BUFF_API FDescribeNamespacesTask final : public Gs2::Core::Util::TGs2Future<Result::FDescribeNamespacesResult>
    {
