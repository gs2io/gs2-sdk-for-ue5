...
#include "Buff/Request/DeleteNamespaceRequest.h"
#include "Buff/Result/DeleteNamespaceResult.h"

namespace Gs2::Buff::Task::Rest
{
    class GS2BUFF_API FDeleteNamespaceTask final : public Gs2::Core::Util::TGs2Future<Result::FDeleteNamespaceResult>
    {
