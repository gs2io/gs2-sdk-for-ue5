...
{
    class FApplyBuffRequest;

    class GS2BUFF_API FApplyBuffRequest final : public TSharedFromThis<FApplyBuffRequest>
    {
    ...
    typedef TSharedPtr<FApplyBuffRequest, ESPMode::ThreadSafe> FApplyBuffRequestPtr;
}