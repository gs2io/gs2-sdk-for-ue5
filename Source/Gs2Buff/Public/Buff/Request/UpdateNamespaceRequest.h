...
namespace Gs2::Buff::Request
{
    ...
    class GS2BUFF_API FUpdateNamespaceRequest final : public TSharedFromThis<FUpdateNamespaceRequest>
    {
    ...
    public:
        ...
        TSharedPtr<FUpdateNamespaceRequest> WithApplyBuffScript(const TSharedPtr<Model::FScriptSetting> ApplyBuffScript);
